...
## Важные ограничения (Copilot review)
...
- **all_tests_with_owner_and_mute**: Изменение PRIMARY KEY (добавлен build_type) требует миграции таблицы. См. MUTE_V4_DESIGN.md.
