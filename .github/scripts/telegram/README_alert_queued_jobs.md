...
**Defaults:** PR-check — 1 h (08:00–20:00 UTC), 3 h (20:00–08:00 UTC); Postmerge — 6 h fixed; legacy Postcommit_* — 6 h fixed. Other constants: API URL, timeouts, max jobs per message, dashboard link.
