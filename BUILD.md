...
- [Yatool](https://github.com/yandex/yatool) is a primary multilanguage build/test system being used for [YDB development](https://ydb.tech/docs/development/build-ya). You need to use Yatool and follow the [YDB development](https://ydb.tech/docs/development/suggest-change) process to make contributions to the YDB project.
...
You can use native Yatool build for x86_64 under Linux Ubuntu 18+.
