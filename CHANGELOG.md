...
* 35563:YQ-4849 supported precomputes in streaming queries: Supported precomputes in streaming queries, for example:
...
`$r` - is precompute [#35563](https://github.com/ydb-platform/ydb/pull/35563) ([YDBot](https://github.com/ydbot))
...
* 35704:YQ-5161 fixed race with PQ / Solomon gateway: Fault fixes:
...
* Added retries for scheme shard tablet pipe destruction in streaming queries [#35704](https://github.com/ydb-platform/ydb/pull/35704) ([YDBot](https://github.com/ydbot))
* 35578:YQ-5157 fixed failing after unsuccessful lease update: Fixed streaming query failing after unsuccessful lease update [#35578](https://github.com/ydb-platform/ydb/pull/35578) ([YDBot](https://github.com/ydbot))
