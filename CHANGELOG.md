...
* 17157:Fixed the display of table tablets implementing secondary indexes. On the Tablets tab, when selecting a secondary index in the table schema, the correct list of tablets is now displayed. #17103 [#17157](https://github.com/ydb-platform/ydb/pull/17157) ([Alexey Efimov](https://github.com/adameat))
