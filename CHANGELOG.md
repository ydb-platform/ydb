...
* 19994:Added memory limits for columnar tables to the [Memory Controller](https://ydb.tech/docs/en/reference/configuration/#memory-controller) configuration. [#19994](https://github.com/ydb-platform/ydb/pull/19994) ([Vladilen](https://github.com/Vladilen))
...
* 20195:Improved algorithm of the new scheduler. [#20195](https://github.com/ydb-platform/ydb/pull/20195) ([Ivan](https://github.com/abyss7))
