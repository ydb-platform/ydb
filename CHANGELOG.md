...
* 17362:Added support for [Google Breakpad](https://chromium.googlesource.com/breakpad/breakpad) in YDB. Now you can set a minidumps path using an environment variable.
