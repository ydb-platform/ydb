...
IF (USE_SYSTEM_PYTHON)
    IF (OS_LINUX)
        IF (ARCH_ARM64 OR ARCH_AARCH64)
            ...
            ELSEIF (_SYSTEM_PYTHON38)
                DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON38_LINUX_ARM64})
            ELSE()
        ...
        ELSEIF (ARCH_X86_64)
            ...
            ELSEIF (_SYSTEM_PYTHON311)
                DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON311_LINUX})
            ELSEIF (_SYSTEM_PYTHON312)
                DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON312_LINUX})
            ELSE()
                ENABLE(PYTHON_NOT_FOUND)
            ENDIF()
        ELSE()
    ...
    ELSEIF (OS_DARWIN)
        ...
        ELSE()
            IF (ARCH_X86_64)
                ...
                ELSEIF (_SYSTEM_PYTHON311)
                    DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON311_DARWIN})
                ELSEIF (_SYSTEM_PYTHON312)
                    DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON312_DARWIN})
                ELSE()
                    ENABLE(PYTHON_NOT_FOUND)
                ENDIF()
            ELSEIF(ARCH_ARM64)
                ...
                ELSEIF(_SYSTEM_PYTHON311)
                    DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON311_DARWIN_ARM64})
                ELSEIF(_SYSTEM_PYTHON312)
                    DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON312_DARWIN_ARM64})
                ELSE()
                    ENABLE(PYTHON_NOT_FOUND)
                ENDIF()
            ELSE()
    ...
    ELSEIF (OS_WINDOWS)
        IF (ARCH_X86_64)
            ...
            ELSEIF (_SYSTEM_PYTHON311)
                DECLARE_EXTERNAL_RESOURCE(EXTERNAL_PYTHON ${PYTHON311_WINDOWS})
            ELSE()
                ENABLE(PYTHON_NOT_FOUND)
            ENDIF()
        ELSE()
