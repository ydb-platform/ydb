...
void aggr_memory_rhi_ht(TFileInput& fi, TFileOutput& fo, ui64 rowCount, ui32 keyCount, ui64 cardinality) {
    ...
    TRHIndirectHashTable ht(buffer, prefixSize, keyCount, slotSize);
    ...
    Cerr << "Collision Swaps: " << ht.CollisionSwapCount << Endl;
