...
#ifndef DB_Crypto_Cipher_INCLUDED
#define DB_Crypto_Cipher_INCLUDED
...
namespace Crypto
{
    ...
    class Crypto_API Cipher : public DBPoco::RefCountedObject
    ...
    ///     DBPoco::FileOutputStream sink("encrypted.dat");
    ///     CryptoOutputStream encryptor(sink, pCipher->createEncryptor());
    ///
    ///     DBPoco::FileInputStream source("source.txt");
    ///     DBPoco::StreamCopier::copyStream(source, encryptor);
    ///
    ...
    {
    public:
        typedef DBPoco::AutoPtr<Cipher> Ptr;
...
#endif // DB_Crypto_Cipher_INCLUDED
