...
#ifndef DB_Crypto_CipherKeyImpl_INCLUDED
#define DB_Crypto_CipherKeyImpl_INCLUDED
...
namespace Crypto
{
    ...
    public:
        ...
        typedef DBPoco::AutoPtr<CipherKeyImpl> Ptr;
    ...
    {
        DB_poco_assert(key.size() == static_cast<ByteVec::size_type>(keySize()));
        _key = key;
    }
...
#endif // DB_Crypto_CipherKeyImpl_INCLUDED
