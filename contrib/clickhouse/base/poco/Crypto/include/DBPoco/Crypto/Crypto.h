...
#ifndef DB_Crypto_Crypto_INCLUDED
#define DB_Crypto_Crypto_INCLUDED


#define DB_POCO_EXTERNAL_OPENSSL_DEFAULT 1
#define DB_POCO_EXTERNAL_OPENSSL_SLPRO 2
...
#endif // DB_Crypto_Crypto_INCLUDED
