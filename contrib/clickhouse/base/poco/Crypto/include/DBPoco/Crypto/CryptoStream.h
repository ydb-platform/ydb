...
#ifndef DB_Crypto_CryptoStream_INCLUDED
#define DB_Crypto_CryptoStream_INCLUDED
...
namespace Crypto
{
    ...
    class Crypto_API CryptoStreamBuf : public DBPoco::BufferedStreamBuf
    ...
    private:
        ...
        DBPoco::Buffer<unsigned char> _buffer;
...
#endif // DB_Crypto_CryptoStream_INCLUDED
