...
#ifndef DB_Crypto_ECKeyImplImpl_INCLUDED
#define DB_Crypto_ECKeyImplImpl_INCLUDED
...
namespace Crypto
{
    ...
    {
    public:
        typedef DBPoco::AutoPtr<ECKeyImpl> Ptr;
...
#endif // DB_Crypto_ECKeyImplImpl_INCLUDED
