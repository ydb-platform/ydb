...
#ifndef DB_Crypto_X509Certificate_INCLUDED
#define DB_Crypto_X509Certificate_INCLUDED
...
namespace Crypto
{
    ...
    public:
        ...
        DBPoco::DateTime validFrom() const;
        /// Returns the date and time the certificate is valid from.

        DBPoco::DateTime expiresOn() const;
...
#endif // DB_Crypto_X509Certificate_INCLUDED
