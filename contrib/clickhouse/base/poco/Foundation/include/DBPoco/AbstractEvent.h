...
#ifndef DB_Foundation_AbstractFoundation_INCLUDED
#define DB_Foundation_AbstractFoundation_INCLUDED
...
///
///     #include "DBPoco/PriorityEvent.h"
///     #include "DBPoco/PriorityDelegate.h"
///
...
///     {
///     public:
///         DBPoco::BasicEvent<int> dataChanged;
///
///         MyData();
///         ...
///         void setData(int i);
...
public:
    ...
    /// to the caller.
    {
        DBPoco::ScopedLockWithUnlock<TMutex> lock(_mutex);
...
#endif // DB_Foundation_AbstractFoundation_INCLUDED
