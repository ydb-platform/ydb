...
#ifndef DB_Foundation_Activity_INCLUDED
#define DB_Foundation_Activity_INCLUDED


#include "DBPoco/Event.h"
#include "DBPoco/Foundation.h"
#include "DBPoco/Mutex.h"
#include "DBPoco/RunnableAdapter.h"
...
public:
    ...
    Activity(C * pOwner, Callback method) : _pOwner(pOwner), _runnable(*pOwner, method), _stopped(true), _running(false), _done(false)
...
#endif // DB_Foundation_Activity_INCLUDED
