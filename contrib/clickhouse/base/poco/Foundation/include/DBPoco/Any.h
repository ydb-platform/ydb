...
#ifndef DB_Foundation_Any_INCLUDED
#define DB_Foundation_Any_INCLUDED
...
template <typename PlaceholderT, unsigned int SizeV = DB_POCO_SMALL_OBJECT_SIZE>
union Placeholder
/// ValueHolder union (used by DBPoco::Any and DBPoco::Dynamic::Var for small
/// object optimization, when enabled).
///
/// If Holder<Type> fits into DB_POCO_SMALL_OBJECT_SIZE bytes of storage,
...
/// larger - [DB_POCO_SMALL_OBJECT_SIZE + 1], additional byte value indicating
...
public:
    ...
    {
        char buf[DB_POCO_SMALL_OBJECT_SIZE] = {0};
        return 0 == std::memcmp(_valueHolder.holder, buf, DB_POCO_SMALL_OBJECT_SIZE);
    }
...
private:
    ...
    public:
        ...
        {
            if ((sizeof(Holder<ValueType>) <= DB_POCO_SMALL_OBJECT_SIZE))
            {
