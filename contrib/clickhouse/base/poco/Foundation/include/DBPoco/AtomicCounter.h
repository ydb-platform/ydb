...
#ifndef DB_Foundation_AtomicCounter_INCLUDED
#define DB_Foundation_AtomicCounter_INCLUDED


#include "DBPoco/Foundation.h"
#if DB_POCO_OS == DB_POCO_OS_WINDOWS_NT
#    error #include "DBPoco/UnWindows.h"
#elif DB_POCO_OS == DB_POCO_OS_MAC_OS_X
...
#            ifndef DB_POCO_HAVE_STD_ATOMICS
#                define DB_POCO_HAVE_STD_ATOMICS
#            endif
#        else
...
#    if !defined(DB_POCO_HAVE_GCC_ATOMICS) && !defined(POCO_NO_GCC_ATOMICS)
#        define DB_POCO_HAVE_GCC_ATOMICS
#    endif
...
#ifdef DB_POCO_HAVE_STD_ATOMICS
#    include <atomic>
#endif
...
private:
#if defined(DB_POCO_HAVE_STD_ATOMICS)
    typedef std::atomic<int> ImplType;
#elif DB_POCO_OS == DB_POCO_OS_WINDOWS_NT
    typedef volatile LONG ImplType;
#elif DB_POCO_OS == DB_POCO_OS_MAC_OS_X
    typedef int32_t ImplType;
#elif defined(DB_POCO_HAVE_GCC_ATOMICS)
...
#endif // DB_Foundation_AtomicCounter_INCLUDED
