...
#ifndef DB_Foundation_BinaryReader_INCLUDED
#define DB_Foundation_BinaryReader_INCLUDED
...
public:
    ...
    /// to the currently set global encoding (see DBPoco::TextEncoding::global()).
...
#endif // DB_Foundation_BinaryReader_INCLUDED
