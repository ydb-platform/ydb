...
#ifndef DB_Foundation_BinaryWriter_INCLUDED
#define DB_Foundation_BinaryWriter_INCLUDED
...
public:
    ...
    /// (see DBPoco::TextEncoding::global()) to the specified encoding.
    ...
    {
        DBPoco::UInt32 size(static_cast<DBPoco::UInt32>(value.size()));
...
#endif // DB_Foundation_BinaryWriter_INCLUDED
