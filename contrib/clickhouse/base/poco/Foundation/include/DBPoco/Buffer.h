...
#ifndef DB_Foundation_Buffer_INCLUDED
#define DB_Foundation_Buffer_INCLUDED
...
public:
    ...
    {
        if (!_ownMem)
            throw DBPoco::InvalidAccessException("Cannot resize buffer which does not own its storage.");
...
#endif // DB_Foundation_Buffer_INCLUDED
