...
#ifndef DB_Foundation_Checksum_INCLUDED
#define DB_Foundation_Checksum_INCLUDED
...
inline DBPoco::UInt32 Checksum::checksum() const
{
    return _value;
}
...
#endif // DB_Foundation_Checksum_INCLUDED
