...
#ifndef DB_Foundation_DefaultStrategy_INCLUDED
#define DB_Foundation_DefaultStrategy_INCLUDED


#include <vector>
#include "DBPoco/NotificationStrategy.h"
...
#endif // DB_Foundation_DefaultStrategy_INCLUDED
