...
#ifndef DB_Foundation_Struct_INCLUDED
#define DB_Foundation_Struct_INCLUDED
...
namespace Dynamic
{
    ...
    public:
        ...
        typedef typename DBPoco::SharedPtr<Struct<K>> Ptr;
    ...
    public:
        ...
        void convert(DBPoco::DateTime &) const { throw BadCastException("Struct -> DBPoco::DateTime"); }

        void convert(DBPoco::LocalDateTime &) const { throw BadCastException("Struct -> DBPoco::LocalDateTime"); }

        void convert(DBPoco::Timestamp &) const { throw BadCastException("Struct -> DBPoco::Timestamp"); }
...
#endif // DB_Foundation_Struct_INCLUDED
