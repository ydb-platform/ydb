...
#ifndef DB_Foundation_Var_INCLUDED
#define DB_Foundation_Var_INCLUDED


#include <typeinfo>
#include "DBPoco/Dynamic/VarHolder.h"
#include "DBPoco/Dynamic/VarIterator.h"
...
namespace Dynamic
{
    ...
    public:
        ...
        typedef DBPoco::Dynamic::VarIterator Iterator;
    ...
    inline DBPoco::Int8 operator+(const DBPoco::Int8 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::Int8
    {
        return other + da.convert<DBPoco::Int8>();
    }


    inline DBPoco::Int8 operator-(const DBPoco::Int8 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::Int8
    {
        return other - da.convert<DBPoco::Int8>();
    }
    ...
    inline DBPoco::Int8 operator*(const DBPoco::Int8 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::Int8
    {
        return other * da.convert<DBPoco::Int8>();
    }
    ...
    inline DBPoco::Int8 operator/(const DBPoco::Int8 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::Int8
    {
        return other / da.convert<DBPoco::Int8>();
    }


    inline DBPoco::Int8 operator+=(DBPoco::Int8 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::Int8
    {
        return other += da.convert<DBPoco::Int8>();
    }
    ...
    inline DBPoco::Int8 operator-=(DBPoco::Int8 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::Int8
    {
        return other -= da.convert<DBPoco::Int8>();
    }
    ...
    inline DBPoco::Int8 operator*=(DBPoco::Int8 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::Int8
    {
        return other *= da.convert<DBPoco::Int8>();
    }
    ...
    inline DBPoco::Int8 operator/=(DBPoco::Int8 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::Int8
    {
        return other /= da.convert<DBPoco::Int8>();
    }


    inline bool operator==(const DBPoco::Int8 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::Int8>();
    ...
    inline bool operator!=(const DBPoco::Int8 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::Int8>();
    ...
    inline bool operator<(const DBPoco::Int8 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::Int8>();
    ...
    inline bool operator<=(const DBPoco::Int8 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::Int8>();
    ...
    inline bool operator>(const DBPoco::Int8 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::Int8>();
    ...
    inline bool operator>=(const DBPoco::Int8 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::Int8>();
    ...
    inline DBPoco::UInt8 operator+(const DBPoco::UInt8 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::UInt8
    {
        return other + da.convert<DBPoco::UInt8>();
    }


    inline DBPoco::UInt8 operator-(const DBPoco::UInt8 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::UInt8
    {
        return other - da.convert<DBPoco::UInt8>();
    }
    ...
    inline DBPoco::UInt8 operator*(const DBPoco::UInt8 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::UInt8
    {
        return other * da.convert<DBPoco::UInt8>();
    }
    ...
    inline DBPoco::UInt8 operator/(const DBPoco::UInt8 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::UInt8
    {
        return other / da.convert<DBPoco::UInt8>();
    }


    inline DBPoco::UInt8 operator+=(DBPoco::UInt8 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::UInt8
    {
        return other += da.convert<DBPoco::UInt8>();
    }
    ...
    inline DBPoco::UInt8 operator-=(DBPoco::UInt8 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::UInt8
    {
        return other -= da.convert<DBPoco::UInt8>();
    }
    ...
    inline DBPoco::UInt8 operator*=(DBPoco::UInt8 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::UInt8
    {
        return other *= da.convert<DBPoco::UInt8>();
    }
    ...
    inline DBPoco::UInt8 operator/=(DBPoco::UInt8 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::UInt8
    {
        return other /= da.convert<DBPoco::UInt8>();
    }


    inline bool operator==(const DBPoco::UInt8 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::UInt8>();
    ...
    inline bool operator!=(const DBPoco::UInt8 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::UInt8>();
    ...
    inline bool operator<(const DBPoco::UInt8 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::UInt8>();
    ...
    inline bool operator<=(const DBPoco::UInt8 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::UInt8>();
    ...
    inline bool operator>(const DBPoco::UInt8 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::UInt8>();
    ...
    inline bool operator>=(const DBPoco::UInt8 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::UInt8>();
    ...
    inline DBPoco::Int16 operator+(const DBPoco::Int16 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::Int16
    {
        return other + da.convert<DBPoco::Int16>();
    }


    inline DBPoco::Int16 operator-(const DBPoco::Int16 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::Int16
    {
        return other - da.convert<DBPoco::Int16>();
    }
    ...
    inline DBPoco::Int16 operator*(const DBPoco::Int16 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::Int16
    {
        return other * da.convert<DBPoco::Int16>();
    }
    ...
    inline DBPoco::Int16 operator/(const DBPoco::Int16 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::Int16
    {
        return other / da.convert<DBPoco::Int16>();
    }


    inline DBPoco::Int16 operator+=(DBPoco::Int16 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::Int16
    {
        return other += da.convert<DBPoco::Int16>();
    }
    ...
    inline DBPoco::Int16 operator-=(DBPoco::Int16 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::Int16
    {
        return other -= da.convert<DBPoco::Int16>();
    }
    ...
    inline DBPoco::Int16 operator*=(DBPoco::Int16 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::Int16
    {
        return other *= da.convert<DBPoco::Int16>();
    }
    ...
    inline DBPoco::Int16 operator/=(DBPoco::Int16 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::Int16
    {
        return other /= da.convert<DBPoco::Int16>();
    }


    inline bool operator==(const DBPoco::Int16 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::Int16>();
    ...
    inline bool operator!=(const DBPoco::Int16 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::Int16>();
    ...
    inline bool operator<(const DBPoco::Int16 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::Int16>();
    ...
    inline bool operator<=(const DBPoco::Int16 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::Int16>();
    ...
    inline bool operator>(const DBPoco::Int16 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::Int16>();
    ...
    inline bool operator>=(const DBPoco::Int16 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::Int16>();
    ...
    inline DBPoco::UInt16 operator+(const DBPoco::UInt16 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::UInt16
    {
        return other + da.convert<DBPoco::UInt16>();
    }


    inline DBPoco::UInt16 operator-(const DBPoco::UInt16 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::UInt16
    {
        return other - da.convert<DBPoco::UInt16>();
    }
    ...
    inline DBPoco::UInt16 operator*(const DBPoco::UInt16 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::UInt16
    {
        return other * da.convert<DBPoco::UInt16>();
    }
    ...
    inline DBPoco::UInt16 operator/(const DBPoco::UInt16 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::UInt16
    {
        return other / da.convert<DBPoco::UInt16>();
    }


    inline DBPoco::UInt16 operator+=(DBPoco::UInt16 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::UInt16
    {
        return other += da.convert<DBPoco::UInt16>();
    }
    ...
    inline DBPoco::UInt16 operator-=(DBPoco::UInt16 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::UInt16
    {
        return other -= da.convert<DBPoco::UInt16>();
    }
    ...
    inline DBPoco::UInt16 operator*=(DBPoco::UInt16 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::UInt16
    {
        return other *= da.convert<DBPoco::UInt16>();
    }
    ...
    inline DBPoco::UInt16 operator/=(DBPoco::UInt16 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::UInt16
    {
        return other /= da.convert<DBPoco::UInt16>();
    }


    inline bool operator==(const DBPoco::UInt16 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::UInt16>();
    ...
    inline bool operator!=(const DBPoco::UInt16 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::UInt16>();
    ...
    inline bool operator<(const DBPoco::UInt16 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::UInt16>();
    ...
    inline bool operator<=(const DBPoco::UInt16 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::UInt16>();
    ...
    inline bool operator>(const DBPoco::UInt16 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::UInt16>();
    ...
    inline bool operator>=(const DBPoco::UInt16 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::UInt16>();
    ...
    inline DBPoco::Int32 operator+(const DBPoco::Int32 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::Int32
    {
        return other + da.convert<DBPoco::Int32>();
    }


    inline DBPoco::Int32 operator-(const DBPoco::Int32 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::Int32
    {
        return other - da.convert<DBPoco::Int32>();
    }
    ...
    inline DBPoco::Int32 operator*(const DBPoco::Int32 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::Int32
    {
        return other * da.convert<DBPoco::Int32>();
    }
    ...
    inline DBPoco::Int32 operator/(const DBPoco::Int32 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::Int32
    {
        return other / da.convert<DBPoco::Int32>();
    }


    inline DBPoco::Int32 operator+=(DBPoco::Int32 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::Int32
    {
        return other += da.convert<DBPoco::Int32>();
    }
    ...
    inline DBPoco::Int32 operator-=(DBPoco::Int32 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::Int32
    {
        return other -= da.convert<DBPoco::Int32>();
    }
    ...
    inline DBPoco::Int32 operator*=(DBPoco::Int32 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::Int32
    {
        return other *= da.convert<DBPoco::Int32>();
    }
    ...
    inline DBPoco::Int32 operator/=(DBPoco::Int32 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::Int32
    {
        return other /= da.convert<DBPoco::Int32>();
    }


    inline bool operator==(const DBPoco::Int32 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::Int32>();
    ...
    inline bool operator!=(const DBPoco::Int32 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::Int32>();
    ...
    inline bool operator<(const DBPoco::Int32 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::Int32>();
    ...
    inline bool operator<=(const DBPoco::Int32 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::Int32>();
    ...
    inline bool operator>(const DBPoco::Int32 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::Int32>();
    ...
    inline bool operator>=(const DBPoco::Int32 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::Int32>();
    ...
    inline DBPoco::UInt32 operator+(const DBPoco::UInt32 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::UInt32
    {
        return other + da.convert<DBPoco::UInt32>();
    }


    inline DBPoco::UInt32 operator-(const DBPoco::UInt32 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::UInt32
    {
        return other - da.convert<DBPoco::UInt32>();
    }
    ...
    inline DBPoco::UInt32 operator*(const DBPoco::UInt32 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::UInt32
    {
        return other * da.convert<DBPoco::UInt32>();
    }
    ...
    inline DBPoco::UInt32 operator/(const DBPoco::UInt32 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::UInt32
    {
        return other / da.convert<DBPoco::UInt32>();
    }


    inline DBPoco::UInt32 operator+=(DBPoco::UInt32 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::UInt32
    {
        return other += da.convert<DBPoco::UInt32>();
    }
    ...
    inline DBPoco::UInt32 operator-=(DBPoco::UInt32 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::UInt32
    {
        return other -= da.convert<DBPoco::UInt32>();
    }
    ...
    inline DBPoco::UInt32 operator*=(DBPoco::UInt32 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::UInt32
    {
        return other *= da.convert<DBPoco::UInt32>();
    }
    ...
    inline DBPoco::UInt32 operator/=(DBPoco::UInt32 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::UInt32
    {
        return other /= da.convert<DBPoco::UInt32>();
    }


    inline bool operator==(const DBPoco::UInt32 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::UInt32>();
    ...
    inline bool operator!=(const DBPoco::UInt32 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::UInt32>();
    ...
    inline bool operator<(const DBPoco::UInt32 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::UInt32>();
    ...
    inline bool operator<=(const DBPoco::UInt32 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::UInt32>();
    ...
    inline bool operator>(const DBPoco::UInt32 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::UInt32>();
    ...
    inline bool operator>=(const DBPoco::UInt32 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::UInt32>();
    ...
    inline DBPoco::Int64 operator+(const DBPoco::Int64 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::Int64
    {
        return other + da.convert<DBPoco::Int64>();
    }


    inline DBPoco::Int64 operator-(const DBPoco::Int64 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::Int64
    {
        return other - da.convert<DBPoco::Int64>();
    }
    ...
    inline DBPoco::Int64 operator*(const DBPoco::Int64 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::Int64
    {
        return other * da.convert<DBPoco::Int64>();
    }
    ...
    inline DBPoco::Int64 operator/(const DBPoco::Int64 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::Int64
    {
        return other / da.convert<DBPoco::Int64>();
    }


    inline DBPoco::Int64 operator+=(DBPoco::Int64 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::Int64
    {
        return other += da.convert<DBPoco::Int64>();
    }
    ...
    inline DBPoco::Int64 operator-=(DBPoco::Int64 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::Int64
    {
        return other -= da.convert<DBPoco::Int64>();
    }
    ...
    inline DBPoco::Int64 operator*=(DBPoco::Int64 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::Int64
    {
        return other *= da.convert<DBPoco::Int64>();
    }
    ...
    inline DBPoco::Int64 operator/=(DBPoco::Int64 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::Int64
    {
        return other /= da.convert<DBPoco::Int64>();
    }


    inline bool operator==(const DBPoco::Int64 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::Int64>();
    ...
    inline bool operator!=(const DBPoco::Int64 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::Int64>();
    ...
    inline bool operator<(const DBPoco::Int64 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::Int64>();
    ...
    inline bool operator<=(const DBPoco::Int64 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::Int64>();
    ...
    inline bool operator>(const DBPoco::Int64 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::Int64>();
    ...
    inline bool operator>=(const DBPoco::Int64 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::Int64>();
    ...
    inline DBPoco::UInt64 operator+(const DBPoco::UInt64 & other, const Var & da)
    /// Addition operator for adding Var to DBPoco::UInt64
    {
        return other + da.convert<DBPoco::UInt64>();
    }


    inline DBPoco::UInt64 operator-(const DBPoco::UInt64 & other, const Var & da)
    /// Subtraction operator for subtracting Var from DBPoco::UInt64
    {
        return other - da.convert<DBPoco::UInt64>();
    }
    ...
    inline DBPoco::UInt64 operator*(const DBPoco::UInt64 & other, const Var & da)
    /// Multiplication operator for multiplying Var with DBPoco::UInt64
    {
        return other * da.convert<DBPoco::UInt64>();
    }
    ...
    inline DBPoco::UInt64 operator/(const DBPoco::UInt64 & other, const Var & da)
    /// Division operator for dividing Var with DBPoco::UInt64
    {
        return other / da.convert<DBPoco::UInt64>();
    }


    inline DBPoco::UInt64 operator+=(DBPoco::UInt64 & other, const Var & da)
    /// Addition assignment operator for adding Var to DBPoco::UInt64
    {
        return other += da.convert<DBPoco::UInt64>();
    }
    ...
    inline DBPoco::UInt64 operator-=(DBPoco::UInt64 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from DBPoco::UInt64
    {
        return other -= da.convert<DBPoco::UInt64>();
    }
    ...
    inline DBPoco::UInt64 operator*=(DBPoco::UInt64 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with DBPoco::UInt64
    {
        return other *= da.convert<DBPoco::UInt64>();
    }
    ...
    inline DBPoco::UInt64 operator/=(DBPoco::UInt64 & other, const Var & da)
    /// Division assignment operator for dividing Var with DBPoco::UInt64
    {
        return other /= da.convert<DBPoco::UInt64>();
    }


    inline bool operator==(const DBPoco::UInt64 & other, const Var & da)
    /// Equality operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<DBPoco::UInt64>();
    ...
    inline bool operator!=(const DBPoco::UInt64 & other, const Var & da)
    /// Inequality operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<DBPoco::UInt64>();
    ...
    inline bool operator<(const DBPoco::UInt64 & other, const Var & da)
    /// Less than operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<DBPoco::UInt64>();
    ...
    inline bool operator<=(const DBPoco::UInt64 & other, const Var & da)
    /// Less than or equal operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<DBPoco::UInt64>();
    ...
    inline bool operator>(const DBPoco::UInt64 & other, const Var & da)
    /// Greater than operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<DBPoco::UInt64>();
    ...
    inline bool operator>=(const DBPoco::UInt64 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with DBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<DBPoco::UInt64>();
...
#endif // DB_Foundation_Var_INCLUDED
