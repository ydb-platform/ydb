...
#ifndef DB_Foundation_DynamicFactory_INCLUDED
#define DB_Foundation_DynamicFactory_INCLUDED
...
public:
    ...
    /// and the instantiator is deleted.
    {
        DB_poco_check_ptr(pAbstractFactory);
...
#endif // DB_Foundation_DynamicFactory_INCLUDED
