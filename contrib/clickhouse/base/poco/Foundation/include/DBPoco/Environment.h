...
#ifndef DB_Foundation_Environment_INCLUDED
#define DB_Foundation_Environment_INCLUDED
...
public:
    ...
    static DBPoco::UInt32 libraryVersion();
    ...
    static DBPoco::Int32 os();
    /// Return the operating system as defined
    /// in the include Foundation/Platform.h (DB_POCO_OS)

    static DBPoco::Int32 arch();
    /// Return the underlying cpu architecture that runs this operating system
    /// as defined in Foundation/Platform (DB_POCO_ARCH)
...
#endif // DB_Foundation_Environment_INCLUDED
