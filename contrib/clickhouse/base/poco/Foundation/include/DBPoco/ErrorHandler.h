...
#ifndef DB_Foundation_ErrorHandler_INCLUDED
#define DB_Foundation_ErrorHandler_INCLUDED
...
public:
    ...
    /// Called when a DBPoco::Exception (or a subclass)
    ...
    /// DBPoco::Exception nor a std::exception caused
...
#endif // DB_Foundation_ErrorHandler_INCLUDED
