...
#ifndef DB_Foundation_ExpireStrategy_INCLUDED
#define DB_Foundation_ExpireStrategy_INCLUDED


#include <map>
#include <set>
#include "DBPoco/AbstractStrategy.h"
...
#endif // DB_Foundation_ExpireStrategy_INCLUDED
