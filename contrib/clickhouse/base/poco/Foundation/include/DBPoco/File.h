...
#ifndef DB_Foundation_File_INCLUDED
#define DB_Foundation_File_INCLUDED
...
///
/// On Windows, if compiled with UTF-8 support (DB_POCO_WIN32_UTF8)
...
#endif // DB_Foundation_File_INCLUDED
