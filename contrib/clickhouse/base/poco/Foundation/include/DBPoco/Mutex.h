...
#ifndef DB_Foundation_Mutex_INCLUDED
#define DB_Foundation_Mutex_INCLUDED
...
{
public:
    typedef DBPoco::ScopedLock<Mutex> ScopedLock;
...
{
public:
    typedef DBPoco::ScopedLock<FastMutex> ScopedLock;
...
{
public:
    typedef DBPoco::ScopedLock<NullMutex> ScopedLock;
...
#endif // DB_Foundation_Mutex_INCLUDED
