...
#ifndef DB_Foundation_NestedDiagnosticContext_INCLUDED
#define DB_Foundation_NestedDiagnosticContext_INCLUDED
...
/// at the end.
/// The DB_poco_ndc(info) macro augments the information with a
...
// helper macros
//
#define DB_poco_ndc(func) DBPoco::NDCScope _theNdcScope(#func, __LINE__, __FILE__)


#if defined(_DEBUG)
#    define DB_poco_ndc_dbg(func) DBPoco::NDCScope _theNdcScope(#    func, __LINE__, __FILE__)
#else
#    define DB_poco_ndc_dbg(func)
#endif
...
#endif // DB_Foundation_NestedDiagnosticContext_INCLUDED
