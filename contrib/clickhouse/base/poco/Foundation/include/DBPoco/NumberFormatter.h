...
#ifndef DB_Foundation_NumberFormatter_INCLUDED
#define DB_Foundation_NumberFormatter_INCLUDED
...
public:
    ...
    static const unsigned NF_MAX_FLT_STRING_LEN = DB_POCO_MAX_FLT_STRING_LEN;
...
#endif // DB_Foundation_NumberFormatter_INCLUDED
