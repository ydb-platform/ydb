...
#ifndef DB_Foundation_NumberParser_INCLUDED
#define DB_Foundation_NumberParser_INCLUDED
...
/// in the string. DBPoco::trim() or DBPoco::trimInPlace()
...
#endif // DB_Foundation_NumberParser_INCLUDED
