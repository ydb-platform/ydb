...
#ifndef DB_Foundation_NumericString_INCLUDED
#define DB_Foundation_NumericString_INCLUDED
...
#define DB_POCO_MAX_INT_STRING_LEN 65
// value from strtod.cc (double_conversion::kMaxSignificantDecimalDigits)
#define DB_POCO_MAX_FLT_STRING_LEN 780

#define DB_POCO_FLT_INF "inf"
#define DB_POCO_FLT_NAN "nan"
#define DB_POCO_FLT_EXP 'e'
...
/// Formatted string has at least [width] total length.
{
    ...
    size = ptr - result;
    DB_poco_assert_dbg(size <= ptr.span());
    DB_poco_assert_dbg((-1 == width) || (size >= std::size_t(width)));
    *ptr-- = '\0';
...
{
    char res[DB_POCO_MAX_INT_STRING_LEN] = {0};
    std::size_t size = DB_POCO_MAX_INT_STRING_LEN;
...
#endif // DB_Foundation_NumericString_INCLUDED
