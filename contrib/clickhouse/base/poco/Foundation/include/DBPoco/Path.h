...
#ifndef DB_Foundation_Path_INCLUDED
#define DB_Foundation_Path_INCLUDED
...
public:
    ...
    /// (DB_POCO_WIN32_UTF8), this function converts a string (usually containing a path)
...
#endif // DB_Foundation_Path_INCLUDED
