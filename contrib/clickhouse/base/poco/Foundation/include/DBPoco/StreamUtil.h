...
#ifndef DB_Foundation_StreamUtil_INCLUDED
#define DB_Foundation_StreamUtil_INCLUDED
...
// the DB_poco_ios_init macro defined below.
//
...
#if defined(POCO_IOS_INIT_HACK)
#    define DB_poco_ios_init(buf)
#else
#    define DB_poco_ios_init(buf) do {                         \
    init(buf);                                              \
...
#endif // DB_Foundation_StreamUtil_INCLUDED
