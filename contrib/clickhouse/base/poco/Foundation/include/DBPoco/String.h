...
#ifndef DB_Foundation_String_INCLUDED
#define DB_Foundation_String_INCLUDED
...
{
    DB_poco_check_ptr(from);
    DB_poco_check_ptr(to);
...
#endif // DB_Foundation_String_INCLUDED
