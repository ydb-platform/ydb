...
#ifndef DB_Foundation_ThreadPool_INCLUDED
#define DB_Foundation_ThreadPool_INCLUDED
...
public:
    explicit ThreadPool(
        ...
        int maxCapacity = 16,
        int idleTime = 60,
        int stackSize = DB_POCO_THREAD_STACK_SIZE,
...
#endif // DB_Foundation_ThreadPool_INCLUDED
