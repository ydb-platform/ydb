...
#ifndef DB_Foundation_UTF32Encoding_INCLUDED
#define DB_Foundation_UTF32Encoding_INCLUDED
...
protected:
	static int safeToInt(DBPoco::UInt32 value)
	{
		if (value <= 0x10FFFF)
...
#endif // DB_Foundation_UTF32Encoding_INCLUDED
