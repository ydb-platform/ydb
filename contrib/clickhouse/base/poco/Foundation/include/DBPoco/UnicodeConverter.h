...
#ifndef DB_Foundation_UnicodeConverter_INCLUDED
#define DB_Foundation_UnicodeConverter_INCLUDED
...
public:
    ...
    {
        T utfStr;
        DBPoco::UnicodeConverter::convert(pChar, utfStr);
        return utfStr;
    }
    ...
    {
        T utfStr;
        DBPoco::UnicodeConverter::convert(str, utfStr);
        return utfStr;
    }
...
#endif // DB_Foundation_UnicodeConverter_INCLUDED
