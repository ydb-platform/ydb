...
#include "DBPoco/Environment_UNIX.h"
...
#elif defined(DB_POCO_OS_FAMILY_BSD)
	unsigned count;
...
// nodeIdImpl
//
#if defined(DB_POCO_OS_FAMILY_BSD) || DB_POCO_OS == DB_POCO_OS_QNX
//
// BSD variants
//
#include <ifaddrs.h>
...
#elif defined(__CYGWIN__) || DB_POCO_OS == DB_POCO_OS_LINUX || DB_POCO_OS == DB_POCO_OS_ANDROID
//
// Linux, Cygwin
//
#include <sys/ioctl.h>
