...
#ifndef DB_JSON_Array_INCLUDED
#define DB_JSON_Array_INCLUDED
...
namespace JSON
{
    ...
    /// convert Array to DBPoco::Dynamic::Array. Conversion requires copying and therefore
    /// has performance penalty; the benefit is in improved syntax, eg:
    ///
    ///    // use pointers to avoid copying
    ///    using namespace DBPoco::JSON;
    ...
    ///
    ///    // copy/convert to DBPoco::Dynamic::Array
    ///    DBPoco::Dynamic::Array da = *arr;
    ///    i = da[0]["test"];     // i == 0
    ///    i = da[1]["test1"][1]; // i == 2
    ///    i = da[1]["test2"];    // i == 4
    /// ----
    ...
    public:
        ...
        operator const DBPoco::Dynamic::Array &() const;
        /// Conversion operator to Dynamic::Array.

        static DBPoco::Dynamic::Array makeArray(const JSON::Array::Ptr & arr);
    ...
    private:
        ...
        typedef SharedPtr<DBPoco::Dynamic::Array> ArrayPtr;
