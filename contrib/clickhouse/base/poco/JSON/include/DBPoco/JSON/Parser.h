...
#ifndef DB_JSON_JSONParser_INCLUDED
#define DB_JSON_JSONParser_INCLUDED
...
#include "DBPoco/JSON/ParserImpl.h"
...
namespace JSON
{
    ...
    /// or an Array. Therefore the result of parse() is a DBPoco::Dynamic::Var
    /// containing a DBPoco::SharedPtr to an Object or Array instance.
    ///
    /// Example:
    ///
    ///    std::string json = "{ \"name\" : \"Franky\", \"children\" : [ \"Jonas\", \"Ellen\" ] }";
...
#endif // DB_JSON_JSONParser_INCLUDED
