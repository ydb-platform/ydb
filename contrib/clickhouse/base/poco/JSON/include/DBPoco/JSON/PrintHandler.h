...
#ifndef DB_JSON_PrintHandler_INCLUDED
#define DB_JSON_PrintHandler_INCLUDED
...
namespace JSON
{
    ...
    public:
        ...
        PrintHandler(unsigned indent = 0, int options = DBPoco::JSON_WRAP_STRINGS);
        /// Creates the PrintHandler.

        PrintHandler(std::ostream & out, unsigned indent = 0, int options = DBPoco::JSON_WRAP_STRINGS);
        /// Creates the PrintHandler.
...
#endif // DB_JSON_PrintHandler_INCLUDED
