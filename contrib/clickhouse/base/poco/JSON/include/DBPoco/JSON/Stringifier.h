...
#ifndef DB_JSON_JSONStringifier_INCLUDED
#define DB_JSON_JSONStringifier_INCLUDED
...
namespace JSON
{
    ...
    {
    public:
        static void condense(const Dynamic::Var & any, std::ostream & out, int options = DBPoco::JSON_WRAP_STRINGS);
        ...
        static void stringify(
            const Dynamic::Var & any, std::ostream & out, unsigned int indent = 0, int step = -1, int options = DBPoco::JSON_WRAP_STRINGS);
        ...
        static void formatString(const std::string & value, std::ostream & out, int options = DBPoco::JSON_WRAP_STRINGS);
...
#endif // DB_JSON_JSONStringifier_INCLUDED
