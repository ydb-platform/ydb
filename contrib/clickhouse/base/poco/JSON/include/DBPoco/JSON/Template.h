...
#ifndef DB_JSON_JSONTemplate_INCLUDED
#define DB_JSON_JSONTemplate_INCLUDED
...
namespace JSON
{
    ...
    DB_POCO_DECLARE_EXCEPTION(JSON_API, JSONTemplateException, DBPoco::Exception)
    ...
    /// is used.
    ///
    ///  A query is passed to DBPoco::JSON::Query to get the value.
    {
    public:
...
#endif // DB_JSON_JSONTemplate_INCLUDED
