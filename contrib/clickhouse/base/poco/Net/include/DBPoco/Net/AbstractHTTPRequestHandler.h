...
#ifndef DB_Net_AbstractHTTPRequestHandler_INCLUDED
#define DB_Net_AbstractHTTPRequestHandler_INCLUDED
...
#endif // DB_Net_AbstractHTTPRequestHandler_INCLUDED
