...
#ifndef DB_Net_FTPClientSession_INCLUDED
#define DB_Net_FTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        FTPClientSession(
            const std::string & host, DBPoco::UInt16 port = FTP_PORT, const std::string & username = "", const std::string & password = "");
        ...
        void open(const std::string & host, DBPoco::UInt16 port, const std::string & username = "", const std::string & password = "");
...
#endif // DB_Net_FTPClientSession_INCLUDED
