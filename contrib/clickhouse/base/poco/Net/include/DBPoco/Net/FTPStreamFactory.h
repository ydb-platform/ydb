...
#ifndef DB_Net_FTPStreamFactory_INCLUDED
#define DB_Net_FTPStreamFactory_INCLUDED
...
namespace Net
{
    ...
    class Net_API FTPStreamFactory : public DBPoco::URIStreamFactory
    ...
    protected:
        ...
        static void getUserInfo(const DBPoco::URI & uri, std::string & username, std::string & password);
        static void getPathAndType(const DBPoco::URI & uri, std::string & path, char & type);
...
#endif // DB_Net_FTPStreamFactory_INCLUDED
