...
#ifndef DB_Net_HTTPClientSession_INCLUDED
#define DB_Net_HTTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        HTTPClientSession(const std::string & host, DBPoco::UInt16 port = HTTPSession::HTTP_PORT);
        /// Creates a HTTPClientSession using the given host and port.

        HTTPClientSession(const std::string & host, DBPoco::UInt16 port, const ProxyConfig & proxyConfig);
        ...
        void setPort(DBPoco::UInt16 port);
        ...
        void setProxy(
            ...
            DBPoco::UInt16 port = HTTPSession::HTTP_PORT,
        ...
        void setProxyPort(DBPoco::UInt16 port);
        ...
        DBPoco::UInt16 getProxyPort() const;
        ...
        DBPoco::Timespan getKeepAliveTimeout() const;
        ...
        /// in a DBPoco::Net::MessageException being thrown.
        ///
        /// In case a network or server failure happens
        ...
        const DBPoco::Timestamp & getLastRequest() const;
    ...
    protected:
        ...
        void setLastRequest(DBPoco::Timestamp time);
    ...
    private:
        ...
        DBPoco::Timestamp _lastRequest;
        bool _reconnect;
        bool _mustReconnect;
        bool _expectResponseBody;
        bool _responseReceived;
        DBPoco::SharedPtr<std::ostream> _pRequestStream;
        DBPoco::SharedPtr<std::istream> _pResponseStream;
    ...
    inline DBPoco::UInt16 HTTPClientSession::getPort() const
    {
        return _port;
    }
    ...
    inline DBPoco::UInt16 HTTPClientSession::getProxyPort() const
    {
    ...
    inline DBPoco::Timespan HTTPClientSession::getKeepAliveTimeout() const
    {
        return _keepAliveTimeout;
    }

    inline const DBPoco::Timestamp & HTTPClientSession::getLastRequest() const
    {
        return _lastRequest;
    }
...
#endif // DB_Net_HTTPClientSession_INCLUDED
