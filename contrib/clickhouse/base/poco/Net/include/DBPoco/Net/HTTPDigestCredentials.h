...
#ifndef DB_Net_HTTPDigestCredentials_INCLUDED
#define DB_Net_HTTPDigestCredentials_INCLUDED
...
namespace Net
{
    ...
    private:
        ...
        static DBPoco::FastMutex _nonceMutex;
    };
...
#endif // DB_Net_HTTPDigestCredentials_INCLUDED
