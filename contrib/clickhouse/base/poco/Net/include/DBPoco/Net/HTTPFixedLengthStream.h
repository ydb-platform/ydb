...
#ifndef DB_Net_HTTPFixedLengthStream_INCLUDED
#define DB_Net_HTTPFixedLengthStream_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        typedef DBPoco::Int64 ContentLength;
...
#endif // DB_Net_HTTPFixedLengthStream_INCLUDED
