...
#ifndef DB_Net_HTTPRequest_INCLUDED
#define DB_Net_HTTPRequest_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void setHost(const std::string & host, DBPoco::UInt16 port);
        /// Sets the value of the Host header field.
        ///
...
#endif // DB_Net_HTTPRequest_INCLUDED
