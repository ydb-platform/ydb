...
#ifndef DB_Net_HTTPServer_INCLUDED
#define DB_Net_HTTPServer_INCLUDED
...
namespace Net
{
    ...
    public:
        HTTPServer(
            HTTPRequestHandlerFactory::Ptr pFactory, DBPoco::UInt16 portNumber = 80, HTTPServerParams::Ptr pParams = new HTTPServerParams);
...
#endif // DB_Net_HTTPServer_INCLUDED
