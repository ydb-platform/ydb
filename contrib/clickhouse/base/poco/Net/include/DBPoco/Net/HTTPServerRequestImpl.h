...
#ifndef DB_Net_HTTPServerRequestImpl_INCLUDED
#define DB_Net_HTTPServerRequestImpl_INCLUDED
...
namespace Net
{
    ...
    private:
        ...
        DBPoco::AutoPtr<HTTPServerParams> _pParams;
...
#endif // DB_Net_HTTPServerRequestImpl_INCLUDED
