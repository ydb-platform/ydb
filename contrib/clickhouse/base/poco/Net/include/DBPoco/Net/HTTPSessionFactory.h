...
#ifndef DB_Net_HTTPSessionFactoryMgr_INCLUDED
#define DB_Net_HTTPSessionFactoryMgr_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        HTTPSessionFactory(const std::string & proxyHost, DBPoco::UInt16 proxyPort);
        ...
        void setProxy(const std::string & proxyHost, DBPoco::UInt16 proxyPort);
    ...
    inline DBPoco::UInt16 HTTPSessionFactory::proxyPort() const
    {
        return _proxyPort;
    }
...
#endif // DB_Net_HTTPSessionFactoryMgr_INCLUDED
