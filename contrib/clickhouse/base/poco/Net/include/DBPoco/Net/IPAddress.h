...
#ifndef DB_Net_IPAddress_INCLUDED
#define DB_Net_IPAddress_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        IPAddress(const void * addr, DB_poco_socklen_t length);
        /// Creates an IPAddress from a native internet address.
        /// A pointer to a in_addr or a in6_addr structure may be
        /// passed.

        IPAddress(const void * addr, DB_poco_socklen_t length, DBPoco::UInt32 scope);
        /// Creates an IPAddress from a native internet address.
        /// A pointer to a in_addr or a in6_addr structure may be
    ...
    private:
        typedef DBPoco::Net::Impl::IPAddressImpl Impl;
        ...
        void newIPv6(const void * hostAddr, DBPoco::UInt32 scope);
    ...
    {
        _pImpl = new DBPoco::Net::Impl::IPv4AddressImpl;
    }


    inline void IPAddress::newIPv4(const void * hostAddr)
    {
        _pImpl = new DBPoco::Net::Impl::IPv4AddressImpl(hostAddr);
    }


    inline void IPAddress::newIPv4(unsigned prefix)
    {
        _pImpl = new DBPoco::Net::Impl::IPv4AddressImpl(prefix);
    }
    ...
    {
        _pImpl = new DBPoco::Net::Impl::IPv6AddressImpl;
    }


    inline void IPAddress::newIPv6(const void * hostAddr)
    {
        _pImpl = new DBPoco::Net::Impl::IPv6AddressImpl(hostAddr);
    }


    inline void IPAddress::newIPv6(const void * hostAddr, DBPoco::UInt32 scope)
    {
        _pImpl = new DBPoco::Net::Impl::IPv6AddressImpl(hostAddr, scope);
    }


    inline void IPAddress::newIPv6(unsigned prefix)
    {
        _pImpl = new DBPoco::Net::Impl::IPv6AddressImpl(prefix);
    }
...
Net_API DBPoco::BinaryWriter & operator<<(DBPoco::BinaryWriter & writer, const DBPoco::Net::IPAddress & value);
Net_API DBPoco::BinaryReader & operator>>(DBPoco::BinaryReader & reader, DBPoco::Net::IPAddress & value);
Net_API std::ostream & operator<<(std::ostream & ostr, const DBPoco::Net::IPAddress & addr);


#endif // DB_Net_IPAddress_INCLUDED
