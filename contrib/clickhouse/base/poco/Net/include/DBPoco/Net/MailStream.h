...
#ifndef DB_Net_MailStream_INCLUDED
#define DB_Net_MailStream_INCLUDED
...
namespace Net
{
    ...
    class Net_API MailStreamBuf : public DBPoco::UnbufferedStreamBuf
...
#endif // DB_Net_MailStream_INCLUDED
