...
#ifndef DB_Net_MultipartReader_INCLUDED
#define DB_Net_MultipartReader_INCLUDED
...
namespace Net
{
    ...
    class Net_API MultipartStreamBuf : public DBPoco::BufferedStreamBuf
...
#endif // DB_Net_MultipartReader_INCLUDED
