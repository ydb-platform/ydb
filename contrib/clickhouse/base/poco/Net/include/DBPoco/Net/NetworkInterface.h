...
#ifndef DB_Net_NetworkInterface_INCLUDED
#define DB_Net_NetworkInterface_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        typedef DBPoco::Tuple<IPAddress, IPAddress, IPAddress> AddressTuple;
    ...
    private:
        ...
        static DBPoco::FastMutex _mutex;
    };
...
Net_API std::ostream & operator<<(std::ostream & ostr, const DBPoco::Net::NetworkInterface::MACAddress & addr);


#endif // DB_POCO_NET_HAS_INTERFACE


#endif // DB_Net_NetworkInterface_INCLUDED
