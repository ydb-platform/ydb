...
#ifndef DB_Net_POP3ClientSession_INCLUDED
#define DB_Net_POP3ClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        POP3ClientSession(const std::string & host, DBPoco::UInt16 port = POP3_PORT);
...
#endif // DB_Net_POP3ClientSession_INCLUDED
