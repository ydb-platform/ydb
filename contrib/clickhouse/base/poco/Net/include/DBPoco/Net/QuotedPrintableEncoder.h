...
#ifndef DB_Net_QuotedPrintableEncoder_INCLUDED
#define DB_Net_QuotedPrintableEncoder_INCLUDED
...
namespace Net
{
    ...
    class Net_API QuotedPrintableEncoderBuf : public DBPoco::UnbufferedStreamBuf
...
#endif // DB_Net_QuotedPrintableEncoder_INCLUDED
