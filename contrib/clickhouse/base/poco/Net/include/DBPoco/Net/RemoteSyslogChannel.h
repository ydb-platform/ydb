...
#ifndef DB_Net_RemoteSyslogChannel_INCLUDED
#define DB_Net_RemoteSyslogChannel_INCLUDED
...
namespace Net
{
    ...
    class Net_API RemoteSyslogChannel : public DBPoco::Channel
...
#endif // DB_Net_RemoteSyslogChannel_INCLUDED
