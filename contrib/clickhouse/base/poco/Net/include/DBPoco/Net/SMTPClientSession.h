...
#ifndef DB_Net_SMTPClientSession_INCLUDED
#define DB_Net_SMTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        SMTPClientSession(const std::string & host, DBPoco::UInt16 port = SMTP_PORT);
    ...
    protected:
        ...
        void loginUsingCRAM(const std::string & username, const std::string & method, DBPoco::DigestEngine & hmac);
...
#endif // DB_Net_SMTPClientSession_INCLUDED
