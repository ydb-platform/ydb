...
#ifndef DB_Net_SocketAddressImpl_INCLUDED
#define DB_Net_SocketAddressImpl_INCLUDED
...
namespace Net
{
    namespace Impl
    {
        ...
        class Net_API SocketAddressImpl : public DBPoco::RefCountedObject
        {
        public:
        ...
        inline DB_poco_socklen_t IPv4SocketAddressImpl::length() const
        {
            return sizeof(_addr);
        }
        ...
        inline DB_poco_socklen_t IPv6SocketAddressImpl::length() const
        {
            return sizeof(_addr);
        }
        ...
        {
            throw DBPoco::InvalidAccessException("local socket address does not have host IP address");
        }


        inline UInt16 LocalSocketAddressImpl::port() const
        {
            throw DBPoco::InvalidAccessException("local socket address does not have port number");
        }


        inline DB_poco_socklen_t LocalSocketAddressImpl::length() const
        {
...
#endif // DB_Net_SocketAddressImpl_INCLUDED
