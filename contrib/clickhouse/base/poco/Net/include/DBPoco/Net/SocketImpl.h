...
#ifndef DB_Net_SocketImpl_INCLUDED
#define DB_Net_SocketImpl_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketImpl : public DBPoco::RefCountedObject
    ...
    public:
        ...
        /// a DBPoco::NotImplementedException will be thrown.
        ...
        virtual bool poll(const DBPoco::Timespan & timeout, int mode);
        ...
        bool pollImpl(DBPoco::Timespan & timeout, int mode);
        /// Modifies `timeout`
        ...
        virtual void setRawOption(int level, int option, const void * value, DB_poco_socklen_t length);
        /// Sets the socket option specified by level and option
        /// to the given time value.
        ...
        void getOption(int level, int option, DBPoco::Timespan & value);
        /// Returns the value of the socket option
        /// specified by level and option.
        ...
        virtual void getRawOption(int level, int option, void * value, DB_poco_socklen_t & length);
        /// Returns the value of the socket option
        /// specified by level and option.
        ...
        void ioctl(DB_poco_ioctl_request_t request, int & arg);
        /// A wrapper for the ioctl system call.

        void ioctl(DB_poco_ioctl_request_t request, void * arg);
        /// A wrapper for the ioctl system call.

#if defined(DB_POCO_OS_FAMILY_UNIX)
        int fcntl(DB_poco_fcntl_request_t request);
        /// A wrapper for the fcntl system call.

        int fcntl(DB_poco_fcntl_request_t request, long arg);
        /// A wrapper for the fcntl system call.
#endif
    ...
    protected:
        ...
        SocketImpl(DB_poco_socket_t sockfd);
        ...
        void reset(DB_poco_socket_t fd = DB_POCO_INVALID_SOCKET);
    ...
    protected:
        ...
        DB_poco_socket_t _sockfd;
        DBPoco::Timespan _recvTimeout;
        DBPoco::Timespan _sndTimeout;
        bool _blocking;
    ...
    // inlines
    //
    inline DB_poco_socket_t SocketImpl::sockfd() const
    {
        return _sockfd;
    }
    ...
    {
        return _sockfd != DB_POCO_INVALID_SOCKET;
    }
...
#endif // DB_Net_SocketImpl_INCLUDED
