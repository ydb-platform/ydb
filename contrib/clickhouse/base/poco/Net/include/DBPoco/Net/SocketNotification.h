...
#ifndef DB_Net_SocketNotification_INCLUDED
#define DB_Net_SocketNotification_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketNotification : public DBPoco::Notification
...
#endif // DB_Net_SocketNotification_INCLUDED
