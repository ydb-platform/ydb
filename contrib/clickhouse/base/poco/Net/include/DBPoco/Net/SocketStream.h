...
#ifndef DB_Net_SocketStream_INCLUDED
#define DB_Net_SocketStream_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketStreamBuf : public DBPoco::BufferedBidirectionalStreamBuf
...
#endif // DB_Net_SocketStream_INCLUDED
