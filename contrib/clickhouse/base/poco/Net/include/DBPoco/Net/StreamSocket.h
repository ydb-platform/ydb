...
#ifndef DB_Net_StreamSocket_INCLUDED
#define DB_Net_StreamSocket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        int sendBytes(DBPoco::FIFOBuffer & buffer);
        /// Sends the contents of the given buffer through
        ...
        int receiveBytes(DBPoco::FIFOBuffer & buffer);
        /// Receives data from the socket and stores it
...
#endif // DB_Net_StreamSocket_INCLUDED
