...
#include "DBPoco/Net/MailMessage.h"
#include "DBPoco/Net/MediaType.h"
...
#include "DBPoco/Net/StringPartSource.h"
#include "DBPoco/Net/QuotedPrintableEncoder.h"
...
namespace
{
	...
	public:
		...
		{
			std::string tmp;
			DBPoco::StreamCopier::copyToString(stream, tmp);
			if (_pMsg)
			{
...
void MailMessage::setDate(const DBPoco::Timestamp& dateTime)
{
	set(HEADER_DATE, DateTimeFormatter::format(dateTime, DateTimeFormat::RFC1123_FORMAT));
}

	
DBPoco::Timestamp MailMessage::getDate() const
{
