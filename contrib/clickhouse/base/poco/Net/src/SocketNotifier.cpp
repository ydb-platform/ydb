...
void SocketNotifier::addObserver(SocketReactor* pReactor, const DBPoco::AbstractObserver& observer)
{
...
void SocketNotifier::removeObserver(SocketReactor* pReactor, const DBPoco::AbstractObserver& observer)
{
