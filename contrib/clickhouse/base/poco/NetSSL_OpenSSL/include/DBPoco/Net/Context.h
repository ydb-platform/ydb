...
#ifndef DB_NetSSL_Context_INCLUDED
#define DB_NetSSL_Context_INCLUDED
...
namespace Net
{
    ...
    class NetSSL_API Context : public DBPoco::RefCountedObject
    ...
    {
    public:
        typedef DBPoco::AutoPtr<Context> Ptr;
        ...
        void useCertificate(const DBPoco::Crypto::X509Certificate & certificate);
        ...
        void addChainCertificate(const DBPoco::Crypto::X509Certificate & certificate);
        /// Adds a certificate for certificate chain validation.

        void addCertificateAuthority(const DBPoco::Crypto::X509Certificate & certificate);
        /// Add one trusted certification authority to be used by the Context.

        void usePrivateKey(const DBPoco::Crypto::RSAKey & key);
...
#endif // DB_NetSSL_Context_INCLUDED
