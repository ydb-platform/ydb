...
#ifndef DB_NetSSL_HTTPSClientSession_INCLUDED
#define DB_NetSSL_HTTPSClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        HTTPSClientSession(const std::string & host, DBPoco::UInt16 port = HTTPS_PORT);
        ...
        HTTPSClientSession(const std::string & host, DBPoco::UInt16 port, Context::Ptr pContext);
        /// Creates a HTTPSClientSession using the given host and port,
        /// using the given SSL context.

        HTTPSClientSession(const std::string & host, DBPoco::UInt16 port, Context::Ptr pContext, Session::Ptr pSession);
        /// Creates a HTTPSClientSession using the given host and port,
        /// using the given SSL context.
        ///
        /// The given Session is reused, if possible (client session
...
#endif // DB_Net_HTTPSClientSession_INCLUDED
