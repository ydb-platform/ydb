...
#ifndef DB_NetSSL_InvalidCertificateHandler_INCLUDED
#define DB_NetSSL_InvalidCertificateHandler_INCLUDED
...
namespace Net
{
    ...
    ///    ...
    ///    DB_POCO_REGISTER_CHFACTORY(My_API, MyGuiHandler)
    ///
    ...
    ///
    /// or in case one uses DBPoco::Util::Application one can rely on an XML configuration and put the following entry
    ...
    ///    </invalidCertificateHandler>
    ///
    /// Note that the name of the InvalidCertificateHandler must be same as the one provided to the DB_POCO_REGISTER_CHFACTORY macro.
    {
    public:
...
#endif // DB_NetSSL_InvalidCertificateHandler_INCLUDED
