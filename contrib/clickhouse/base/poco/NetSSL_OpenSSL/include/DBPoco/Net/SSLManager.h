...
#ifndef DB_NetSSL_SSLManager_INCLUDED
#define DB_NetSSL_SSLManager_INCLUDED
...
namespace Net
{
    ...
    /// case, a DBPoco::Util::Application instance must be available and the required
    ...
    {
    public:
        typedef DBPoco::SharedPtr<PrivateKeyPassphraseHandler> PrivateKeyPassphraseHandlerPtr;
        typedef DBPoco::SharedPtr<InvalidCertificateHandler> InvalidCertificateHandlerPtr;

        DBPoco::BasicEvent<VerificationErrorArgs> ServerVerificationError;
        /// Fired whenever a certificate verification error is detected by the server during a handshake.

        DBPoco::BasicEvent<VerificationErrorArgs> ClientVerificationError;
        /// Fired whenever a certificate verification error is detected by the client during a handshake.

        DBPoco::BasicEvent<std::string> PrivateKeyPassphraseRequired;
    ...
    protected:
        ...
        static DBPoco::Util::AbstractConfiguration & appConfig();
    ...
    private:
        ...
        friend class DBPoco::SingletonHolder<SSLManager>;
...
#endif // DB_NetSSL_SSLManager_INCLUDED
