...
#ifndef DB_Net_SecureSMTPClientSession_INCLUDED
#define DB_Net_SecureSMTPClientSession_INCLUDED


#include "DBPoco/Net/Context.h"
#include "DBPoco/Net/NetSSL.h"
#include "DBPoco/Net/SMTPClientSession.h"
...
namespace Net
{
    ...
    public:
        ...
        SecureSMTPClientSession(const std::string & host, DBPoco::UInt16 port = SMTP_PORT);
...
#endif // DB_Net_SecureSMTPClientSession_INCLUDED
