...
#ifndef DB_NetSSL_SecureServerSocket_INCLUDED
#define DB_NetSSL_SecureServerSocket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        SecureServerSocket(DBPoco::UInt16 port, int backlog = 64);
        /// Creates a server socket using the default server SSL context,
        ...
        SecureServerSocket(DBPoco::UInt16 port, int backlog, Context::Ptr pContext);
        /// Creates a server socket using the given SSL context, binds it
...
#endif // DB_NetSSL_SecureServerSocket_INCLUDED
