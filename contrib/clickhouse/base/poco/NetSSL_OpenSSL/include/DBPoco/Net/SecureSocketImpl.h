...
#ifndef DB_NetSSL_SecureSocketImpl_INCLUDED
#define DB_NetSSL_SecureSocketImpl_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        SecureSocketImpl(DBPoco::AutoPtr<SocketImpl> pSocketImpl, Context::Ptr pContext);
        ...
        void connect(const SocketAddress & address, const DBPoco::Timespan & timeout, bool performHandshake);
    ...
    protected:
        ...
        bool mustRetry(int rc, DBPoco::Timespan & remaining_time);
        ...
        ///
        /// Can also throw a DBPoco::TimeoutException if the socket does
    ...
    private:
        ...
        DBPoco::AutoPtr<SocketImpl> _pSocket;
        ...
        DBPoco::Timespan getMaxTimeoutOrLimit();
    ...
    // inlines
    //
    inline DB_poco_socket_t SecureSocketImpl::sockfd()
    {
...
#endif // DB_NetSSL_SecureSocketImpl_INCLUDED
