...
void SecureStreamSocketImpl::setSendTimeout(const DBPoco::Timespan& timeout)
{
    underlying_socket->setSendTimeout(timeout);
    _sndTimeout = underlying_socket->getSendTimeout();
}

void SecureStreamSocketImpl::setReceiveTimeout(const DBPoco::Timespan& timeout)
{
...
{
	throw DBPoco::InvalidAccessException("Cannot acceptConnection() on a SecureStreamSocketImpl");
}
...
void SecureStreamSocketImpl::connect(const SocketAddress& address, const DBPoco::Timespan& timeout)
{
...
{
	throw DBPoco::InvalidAccessException("Cannot bind() a SecureStreamSocketImpl");
}

	
void SecureStreamSocketImpl::listen(int backlog)
{
	throw DBPoco::InvalidAccessException("Cannot listen() on a SecureStreamSocketImpl");
}
...
{
	throw DBPoco::InvalidAccessException("Cannot sendTo() on a SecureStreamSocketImpl");
}


int SecureStreamSocketImpl::receiveFrom(void* buffer, int length, SocketAddress& address, int flags)
{
	throw DBPoco::InvalidAccessException("Cannot receiveFrom() on a SecureStreamSocketImpl");
}


void SecureStreamSocketImpl::sendUrgent(unsigned char data)
{
	throw DBPoco::InvalidAccessException("Cannot sendUrgent() on a SecureStreamSocketImpl");
}
