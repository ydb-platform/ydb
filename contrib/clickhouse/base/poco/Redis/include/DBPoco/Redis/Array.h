...
#ifndef DB_Redis_Array_INCLUDED
#define DB_Redis_Array_INCLUDED
...
namespace Redis
{
    ...
    public:
        ...
        /// to the template type. A DBPoco::BadCastException will be thrown when the
        /// the conversion fails. An DBPoco::InvalidArgumentException will be thrown
        /// when the index is out of range. When the array is a Null array
        /// a DBPoco::NullValueException is thrown.
        {
            if (_elements.isNull())
        ...
        /// Returns the type of the element. This can throw a DBPoco::NullValueException
        /// when this array is a Null array. An DBPoco::InvalidArgumentException will
