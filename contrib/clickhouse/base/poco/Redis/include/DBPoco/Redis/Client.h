...
#ifndef DB_Redis_Client_INCLUDED
#define DB_Redis_Client_INCLUDED
...
namespace Redis
{
    ...
    /// implemented as a typedef for DBPoco::Nullable<std::string>. This is
    ...
    public:
        ...
        ///
        /// A DBPoco::BadCastException will be thrown when the reply couldn't be
...
#endif // DB_Redis_Client_INCLUDED
