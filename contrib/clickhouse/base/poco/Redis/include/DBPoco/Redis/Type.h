...
#ifndef DB_Redis_Type_INCLUDED
#define DB_Redis_Type_INCLUDED


#include "DBPoco/LineEndingConverter.h"
#include "DBPoco/Nullable.h"
#include "DBPoco/NumberFormatter.h"
#include "DBPoco/NumberParser.h"
#include "DBPoco/Redis/Redis.h"
#include "DBPoco/Redis/RedisStream.h"
...
namespace Redis
{
    ...
    struct RedisTypeTraits<Int64>
    {
        ...
        static std::string toString(const Int64 & value) { return marker + NumberFormatter::format(value) + "\r\n"; }
    ...
    struct RedisTypeTraits<std::string>
    {
        ...
        static std::string toString(const std::string & value) { return marker + value + LineEnding::NEWLINE_CRLF; }

        static void read(RedisInputStream & input, std::string & value) { value = input.getline(); }
    };
