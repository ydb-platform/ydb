...
#ifndef DB_Util_LayeredConfiguration_INCLUDED
#define DB_Util_LayeredConfiguration_INCLUDED
...
namespace Util
{
    ...
    {
    public:
        typedef DBPoco::AutoPtr<AbstractConfiguration> ConfigPtr;
...
#endif // DB_Util_LayeredConfiguration_INCLUDED
