...
#ifndef DB_Util_LoggingConfigurator_INCLUDED
#define DB_Util_LoggingConfigurator_INCLUDED
...
namespace Util
{
    ...
    private:
        ...
        DBPoco::Formatter * createFormatter(AbstractConfiguration * pConfig);
        DBPoco::Channel * createChannel(AbstractConfiguration * pConfig);
...
#endif // DB_Util_LoggingConfigurator_INCLUDED
