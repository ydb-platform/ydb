...
#ifndef DB_Util_Subsystem_INCLUDED
#define DB_Util_Subsystem_INCLUDED
...
namespace Util
{
    ...
    class Util_API Subsystem : public DBPoco::RefCountedObject
...
#endif // DB_Util_Subsystem_INCLUDED
