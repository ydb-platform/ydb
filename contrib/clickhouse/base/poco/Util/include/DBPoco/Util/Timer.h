...
#ifndef DB_Util_Timer_INCLUDED
#define DB_Util_Timer_INCLUDED
...
namespace Util
{
    ...
    class Util_API Timer : protected DBPoco::Runnable
    ...
    public:
        ...
        explicit Timer(DBPoco::Thread::Priority priority);
        ...
        void schedule(TimerTask::Ptr pTask, DBPoco::Timestamp time);
        ...
        void schedule(TimerTask::Ptr pTask, DBPoco::Clock clock);
        /// Schedules a task for execution at the specified time.
        ///
        /// If the time lies in the past, the task is executed
        /// immediately.
        ...
        void schedule(TimerTask::Ptr pTask, DBPoco::Timestamp time, long interval);
        /// Schedules a task for periodic execution.
        ///
        ...
        void schedule(TimerTask::Ptr pTask, DBPoco::Clock clock, long interval);
        /// Schedules a task for periodic execution.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically with
        ...
        void scheduleAtFixedRate(TimerTask::Ptr pTask, DBPoco::Timestamp time, long interval);
        /// Schedules a task for periodic execution at a fixed rate.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically
        ...
        void scheduleAtFixedRate(TimerTask::Ptr pTask, DBPoco::Clock clock, long interval);
        /// Schedules a task for periodic execution at a fixed rate.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically
