...
#ifndef DB_DOM_Document_INCLUDED
#define DB_DOM_Document_INCLUDED


#include "DBPoco/AutoReleasePool.h"
#include "DBPoco/DOM/AbstractContainerNode.h"
#include "DBPoco/DOM/DocumentEvent.h"
#include "DBPoco/DOM/Element.h"
#include "DBPoco/XML/NamePool.h"
...
namespace XML
{
    ...
    {
    public:
        using AutoReleasePool = DBPoco::AutoReleasePool<DOMObject>;
...
#endif // DB_DOM_Document_INCLUDED
