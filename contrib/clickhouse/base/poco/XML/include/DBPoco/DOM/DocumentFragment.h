...
#ifndef DB_DOM_DocumentFragment_INCLUDED
#define DB_DOM_DocumentFragment_INCLUDED


#include "DBPoco/DOM/AbstractContainerNode.h"
...
#endif // DB_DOM_DocumentFragment_INCLUDED
