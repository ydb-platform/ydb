...
#ifndef DB_DOM_Event_INCLUDED
#define DB_DOM_Event_INCLUDED
...
namespace XML
{
    ...
    inline DBPoco::UInt64 Event::timeStamp() const
    {
        return 0;
    }
