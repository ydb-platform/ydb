...
#ifndef DB_DOM_Node_INCLUDED
#define DB_DOM_Node_INCLUDED


#include "DBPoco/DOM/EventTarget.h"
...
namespace XML
{
    ...
    public:
        ...
        // Extensions
        using NSMap = DBPoco::XML::NamespaceSupport;
