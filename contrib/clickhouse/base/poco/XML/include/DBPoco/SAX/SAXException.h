...
#ifndef DB_SAX_SAXException_INCLUDED
#define DB_SAX_SAXException_INCLUDED
...
namespace XML
{
    ...
    DB_POCO_DECLARE_EXCEPTION(XML_API, SAXException, XMLException)
    ...
    DB_POCO_DECLARE_EXCEPTION(XML_API, SAXNotRecognizedException, SAXException)
    ...
    DB_POCO_DECLARE_EXCEPTION(XML_API, SAXNotSupportedException, SAXException)
    ...
    public:
        ...
        SAXParseException(const std::string & msg, const Locator & loc, const DBPoco::Exception & exc);
        /// Wrap an existing exception in a SAXParseException.

        SAXParseException(
            const std::string & msg, const XMLString & publicId, const XMLString & systemId, int lineNumber, int columnNumber);
    ...
    protected:
        static std::string
        buildMessage(const std::string & msg, const XMLString & publicId, const XMLString & systemId, int lineNumber, int columnNumber);
...
#endif // DB_SAX_SAXException_INCLUDED
