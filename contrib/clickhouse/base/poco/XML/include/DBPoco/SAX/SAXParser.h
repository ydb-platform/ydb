...
#ifndef DB_SAX_SAXParser_INCLUDED
#define DB_SAX_SAXParser_INCLUDED


#include "DBPoco/SAX/XMLReader.h"
#include "DBPoco/XML/ParserEngine.h"
...
namespace XML
{
    ...
    public:
        ...
        void addEncoding(const XMLString & name, DBPoco::TextEncoding * pEncoding);
...
#endif // DB_SAX_SAXParser_INCLUDED
