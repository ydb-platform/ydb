...
#ifndef DB_XML_ParserEngine_INCLUDED
#define DB_XML_ParserEngine_INCLUDED
...
namespace XML
{
    ...
    public:
        ...
        void setBillionLaughsAttackProtectionActivationThreshold(DBPoco::UInt64 activationThresholdBytes);
    ...
    private:
        typedef std::map<XMLString, DBPoco::TextEncoding *> EncodingMap;
        ...
        DBPoco::UInt64 _activationThresholdBytes;
...
#endif // DB_XML_ParserEngine_INCLUDED
