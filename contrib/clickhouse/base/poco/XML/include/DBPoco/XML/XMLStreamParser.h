...
#ifndef DB_XML_XMLStreamParser_INCLUDED
#define DB_XML_XMLStreamParser_INCLUDED
...
#include "DBPoco/XML/Content.h"
#include "DBPoco/XML/QName.h"
#include "DBPoco/XML/ValueTraits.h"
...
namespace XML
{
    ...
    inline DBPoco::UInt64 XMLStreamParser::line() const
    {
        return _line;
    }


    inline DBPoco::UInt64 XMLStreamParser::column() const
    {
        return _column;
    }
    ...
    {
        nextExpect(e, qn);
        DB_poco_assert(e == EV_START_ELEMENT);
        content(c);
    }
    ...
    {
        DB_poco_assert(_parserState == state_next);
...
#endif // DB_XML_XMLStreamParser_INCLUDED
