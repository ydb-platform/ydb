...
#ifndef DB_XML_XMLWriter_INCLUDED
#define DB_XML_XMLWriter_INCLUDED
...
#include "DBPoco/StreamConverter.h"
...
namespace XML
{
    ...
    public:
        ...
        XMLWriter(XMLByteOutputStream & str, int options, const std::string & encodingName, DBPoco::TextEncoding & textEncoding);
        /// Creates the XMLWriter and sets the specified options.
        ///
        ...
        XMLWriter(XMLByteOutputStream & str, int options, const std::string & encodingName, DBPoco::TextEncoding * pTextEncoding);
        /// Creates the XMLWriter and sets the specified options.
        ///
        /// The encoding is reflected in the XML declaration.
        /// The caller is responsible for that the given encodingName matches with
    ...
    private:
        ...
        DBPoco::OutputStreamConverter * _pTextConverter;
        DBPoco::TextEncoding * _pInEncoding;
        DBPoco::TextEncoding * _pOutEncoding;
        int _options;
...
#endif // DB_XML_XMLWriter_INCLUDED
