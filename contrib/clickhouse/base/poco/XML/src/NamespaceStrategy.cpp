...
#include "DBPoco/XML/NamespaceStrategy.h"
#include "DBPoco/SAX/AttributesImpl.h"
...
{
	DB_poco_assert_dbg (name && atts && pContentHandler);
...
{
	DB_poco_assert_dbg (name && pContentHandler);
