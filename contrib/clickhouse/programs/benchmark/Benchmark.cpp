...
class Benchmark : public DBPoco::Util::Application
{
public:
    ...
    void initialize(DBPoco::Util::Application & self [[maybe_unused]]) override
    {
...
private:
    ...
    void execute(Query & query, size_t connection_index)
    {
        ...
        if (!query_id.empty())
            ...
            executor.setQueryId(query_id_prefix + "_" + DBPoco::UUIDGenerator().createRandom().toString());
