...
#if USE_BUZZHOUSE
#   error #include <Client/BuzzHouse/Generator/ExternalIntegrations.h>
#   error #include <Client/BuzzHouse/Generator/FuzzConfig.h>
#endif
...
void Client::parseConnectionsCredentials(DBPoco::Util::AbstractConfiguration & config, const std::string & connection_name)
{
...
DBPoco::Util::LayeredConfiguration & Client::getClientConfiguration()
{
    return config();
}

void Client::initialize(DBPoco::Util::Application & self)
{
