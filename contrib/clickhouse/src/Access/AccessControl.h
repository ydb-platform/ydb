...
public:
    ...
    void setupFromMainConfig(const DBPoco::Util::AbstractConfiguration & config_, const String & config_path_,
    ...
    void setUsersConfig(const DBPoco::Util::AbstractConfiguration & users_config_);

    /// Adds UsersConfigAccessStorage.
    void addUsersConfigStorage(const String & storage_name_,
                               const DBPoco::Util::AbstractConfiguration & users_config_,
                               bool allow_backup_);
    ...
    void addLDAPStorage(const String & storage_name_, const DBPoco::Util::AbstractConfiguration & config_, const String & prefix_);
    ...
    void addStoragesFromUserDirectoriesConfig(const DBPoco::Util::AbstractConfiguration & config,
                                              const String & key,
    ...
    void addStoragesFromMainConfig(const DBPoco::Util::AbstractConfiguration & config,
    ...
    AuthResult authenticate(const Credentials & credentials, const DBPoco::Net::IPAddress & address, const ClientInfo & client_info) const;
    ...
    void setExternalAuthenticatorsConfig(const DBPoco::Util::AbstractConfiguration & config);
    ...
    std::shared_ptr<const EnabledQuota> getEnabledQuota(
        ...
        const std::shared_ptr<DBPoco::Net::IPAddress> & address,
