...
DBPoco::URI CatBoostLibraryBridgeHelper::getPingURI() const
{
...
DBPoco::URI CatBoostLibraryBridgeHelper::getMainURI() const
{
    auto uri = createBaseURI();
...
DBPoco::URI CatBoostLibraryBridgeHelper::createRequestURI(const String & method) const
{
    auto uri = getMainURI();
