...
void ConnectionEstablisherAsync::processAsyncEvent(int fd, DBPoco::Timespan socket_timeout, AsyncEventTimeoutType type, const std::string & description, uint32_t events)
{
    socket_fd = fd;
