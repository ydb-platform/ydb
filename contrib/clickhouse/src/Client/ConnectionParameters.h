...
struct ConnectionParameters
{
    ...
    ConnectionParameters(const DBPoco::Util::AbstractConfiguration & config_, const Host & host_, const Database & database_);
    ConnectionParameters(const DBPoco::Util::AbstractConfiguration & config_, const Host & host_, const Database & database_, std::optional<UInt16> port_);
