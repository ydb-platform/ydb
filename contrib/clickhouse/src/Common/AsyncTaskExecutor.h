...
protected:
    ...
    virtual void processAsyncEvent(int fd, DBPoco::Timespan timeout, AsyncEventTimeoutType timeout_type, const std::string & fd_description, uint32_t async_events) = 0;
