...
private:
    ...
    static void decryptRecursive(DBPoco::XML::Node * config_root);
    ...
    static bool hasNodeWithAttribute(DBPoco::XML::Node * config_root, const std::string & attribute_name);
    ...
    static bool hasNodeWithNameAndChildNodeWithAttribute(DBPoco::XML::Node * config_root, const std::string & node_name, const std::string & attribute_name);
