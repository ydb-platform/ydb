...
struct ResourceGuardSessionDataHooks : public DBPoco::Net::IHTTPSessionDataHooks
{
...
private:
    ...
    public:
        ...
        std::ostream & sendRequest(DBPoco::Net::HTTPRequest & request, UInt64 * connect_time, UInt64 * first_byte_time) override
        {
            auto idle = idleTime();
