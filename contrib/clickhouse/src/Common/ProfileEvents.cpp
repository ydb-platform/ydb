...
void incrementForLogMessage(DBPoco::Message::Priority priority)
{
    switch (priority)
    {
        case DBPoco::Message::PRIO_TEST: increment(LogTest); break;
        case DBPoco::Message::PRIO_TRACE: increment(LogTrace); break;
        case DBPoco::Message::PRIO_DEBUG: increment(LogDebug); break;
        case DBPoco::Message::PRIO_INFORMATION: increment(LogInfo); break;
        case DBPoco::Message::PRIO_WARNING: increment(LogWarning); break;
        case DBPoco::Message::PRIO_ERROR: increment(LogError); break;
        case DBPoco::Message::PRIO_FATAL: increment(LogFatal); break;
        default: break;
    }
}
