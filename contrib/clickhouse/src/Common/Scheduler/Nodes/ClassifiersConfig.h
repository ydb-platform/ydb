...
struct ClassifierDescription : std::unordered_map<String, String>
{
    ...
    ClassifierDescription(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix);
};
...
public:
    ...
    explicit ClassifiersConfig(const DBPoco::Util::AbstractConfiguration & config);
