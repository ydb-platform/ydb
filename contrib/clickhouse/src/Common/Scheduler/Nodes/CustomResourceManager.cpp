...
CustomResourceManager::State::State(EventQueue * event_queue, const DBPoco::Util::AbstractConfiguration & config)
    : classifiers(config)
{
...
CustomResourceManager::State::Node::Node(const String & name, EventQueue * event_queue, const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
...
void CustomResourceManager::updateConfiguration(const DBPoco::Util::AbstractConfiguration & config)
{
