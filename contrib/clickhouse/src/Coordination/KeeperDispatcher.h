...
public:
    ...
    void initialize(const DBPoco::Util::AbstractConfiguration & config, bool standalone_keeper, bool start_async, const MultiVersion<Macros>::Version & macros);
    ...
    void updateConfiguration(const DBPoco::Util::AbstractConfiguration & config, const MultiVersion<Macros>::Version & macros);
