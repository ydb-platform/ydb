...
private:
    ...
    void launchRaftServer(const DBPoco::Util::AbstractConfiguration & config, bool enable_ipv6);
...
public:
    ...
    void startup(const DBPoco::Util::AbstractConfiguration & config, bool enable_ipv6 = true);
    ...
    ClusterUpdateActions getRaftConfigurationDiff(const DBPoco::Util::AbstractConfiguration & config);
