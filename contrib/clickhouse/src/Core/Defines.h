...
static constexpr auto DEFAULT_QUERY_RESULT_CACHE_MAX_ENTRIES = size_t(1024);
static constexpr auto DEFAULT_QUERY_RESULT_CACHE_MAX_ENTRY_SIZE_IN_BYTES = 1_MiB;
static constexpr auto DEFAULT_QUERY_RESULT_CACHE_MAX_ENTRY_SIZE_IN_ROWS = size_t(30'000'000);
...
static constexpr auto DEFAULT_REMOVE_SHARED_RECURSIVE_FILE_LIMIT = size_t(1000);
