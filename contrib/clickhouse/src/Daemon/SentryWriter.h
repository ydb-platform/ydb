...
namespace DBPoco { namespace Util { class LayeredConfiguration; }}
...
public:
    ...
    static void initializeInstance(DBPoco::Util::LayeredConfiguration & config);
...
private:
    ...
    explicit SentryWriter(DBPoco::Util::LayeredConfiguration & config);
