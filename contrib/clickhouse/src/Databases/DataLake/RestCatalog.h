...
private:
    ...
    DBPoco::URI::QueryParameters createParentNamespaceParams(const std::string & base_namespace) const;
    ...
    static void parseCatalogConfigurationSettings(const DBPoco::JSON::Object::Ptr & object, Config & result);
};
