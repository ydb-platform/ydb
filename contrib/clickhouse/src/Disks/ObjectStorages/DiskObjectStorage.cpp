...
void DiskObjectStorage::setLastModified(const String & path, const DBPoco::Timestamp & timestamp)
{
    auto transaction = createObjectStorageTransaction();
...
DBPoco::Timestamp DiskObjectStorage::getLastModified(const String & path) const
{
...
void DiskObjectStorage::applyNewSettings(
    const DBPoco::Util::AbstractConfiguration & config, ContextPtr context_, const String & /*config_prefix*/, const DisksMap & disk_map)
{
