...
public:
    ...
    virtual void setLastModified(const std::string & /* path */, const DBPoco::Timestamp & /* timestamp */)
    {
        throwNotImplemented();
    }
...
public:
    ...
    virtual DBPoco::Timestamp getLastModified(const std::string & path) const = 0;

    virtual std::optional<DBPoco::Timestamp> getLastModifiedIfExists(const std::string & path) const
    {
