...
{
    SetLastModifiedOperation(const std::string & path_, DBPoco::Timestamp new_timestamp_, IDisk & disk_);
...
private:
    std::string path;
    DBPoco::Timestamp new_timestamp;
    DBPoco::Timestamp old_timestamp;
    IDisk & disk;
};
