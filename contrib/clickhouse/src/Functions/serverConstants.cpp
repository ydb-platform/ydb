...
namespace
{
    ...
    public:
        ...
        explicit FunctionGetOSKernelVersion(ContextPtr context) : FunctionServerConstantBase(DBPoco::Environment::osName() + " " + DBPoco::Environment::osVersion(), context->isDistributed()) {}
