...
ReadBufferFromPocoSocketChunked::ReadBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, size_t buf_size)
    : ReadBufferFromPocoSocketChunked(socket_, ProfileEvents::end(), buf_size)
{}

ReadBufferFromPocoSocketChunked::ReadBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, const ProfileEvents::Event & read_event_, size_t buf_size)
