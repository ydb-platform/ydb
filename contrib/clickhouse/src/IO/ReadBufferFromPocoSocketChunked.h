...
public:
    ...
    explicit ReadBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, size_t buf_size = DBMS_DEFAULT_BUFFER_SIZE);
    explicit ReadBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, const ProfileEvents::Event & read_event_, size_t buf_size = DBMS_DEFAULT_BUFFER_SIZE);
    ...
    DBPoco::Net::SocketAddress peerAddress() { return peer_address; }
    DBPoco::Net::SocketAddress ourAddress() { return our_address; }
...
protected:
    ...
    DBPoco::Net::SocketAddress our_address;
