...
HTTPHeaderEntries getHTTPHeaders(const std::string & config_elem, const DBPoco::Util::AbstractConfiguration & config, const std::string header_key)
{
    HTTPHeaderEntries headers;
    DBPoco::Util::AbstractConfiguration::Keys subconfig_keys;
...
ServerSideEncryptionKMSConfig getSSEKMSConfig(const std::string & config_elem, const DBPoco::Util::AbstractConfiguration & config)
{
