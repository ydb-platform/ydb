...
TimeoutSetter::TimeoutSetter(DBPoco::Net::StreamSocket & socket_,
...
TimeoutSetter::TimeoutSetter(DBPoco::Net::StreamSocket & socket_, DBPoco::Timespan timeout_, bool limit_max_timeout)
