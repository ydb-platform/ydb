...
WriteBufferFromPocoSocket::WriteBufferFromPocoSocket(DBPoco::Net::Socket & socket_, size_t buf_size)
...
WriteBufferFromPocoSocket::WriteBufferFromPocoSocket(DBPoco::Net::Socket & socket_, const ProfileEvents::Event & write_event_, size_t buf_size)
