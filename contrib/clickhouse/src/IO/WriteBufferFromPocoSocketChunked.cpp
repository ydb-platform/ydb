...
WriteBufferFromPocoSocketChunked::WriteBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, size_t buf_size)
    : WriteBufferFromPocoSocketChunked(socket_, ProfileEvents::end(), buf_size)
{}

WriteBufferFromPocoSocketChunked::WriteBufferFromPocoSocketChunked(DBPoco::Net::Socket & socket_, const ProfileEvents::Event & write_event_, size_t buf_size)
