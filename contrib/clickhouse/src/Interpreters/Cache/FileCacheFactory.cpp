...
void FileCacheFactory::loadDefaultCaches(const DBPoco::Util::AbstractConfiguration & config)
{
    DBPoco::Util::AbstractConfiguration::Keys cache_names;
    config.keys(FILECACHE_DEFAULT_CONFIG_PATH, cache_names);
    auto * log = &DBPoco::Logger::get("FileCacheFactory");
