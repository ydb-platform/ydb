...
public:
    ...
    std::shared_ptr<DBPoco::Net::SocketAddress> current_address;

    /// When query_kind == INITIAL_QUERY, these values are equal to current.
    String initial_user;
    String initial_query_id;
    std::shared_ptr<DBPoco::Net::SocketAddress> initial_address;
    ...
    std::optional<DBPoco::Net::SocketAddress> getLastForwardedFor() const;
