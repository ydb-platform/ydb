...
bool EmbeddedDictionaries::reloadImpl(const bool throw_on_error, const bool force_reload)
{
    ...
    DictionaryReloader<RegionsHierarchies> reload_regions_hierarchies = [=] (const DBPoco::Util::AbstractConfiguration & config)
    {
    ...
    DictionaryReloader<RegionsNames> reload_regions_names = [=] (const DBPoco::Util::AbstractConfiguration & config)
    {
