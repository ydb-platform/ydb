...
public:
    ...
    struct ObjectConfig
    {
        DBPoco::AutoPtr<DBPoco::Util::AbstractConfiguration> config;
...
protected:
    virtual LoadableMutablePtr createObject(const String & name, const DBPoco::Util::AbstractConfiguration & config, const String & key_in_config, const String & repository_name) const = 0;

    /// Returns whether the object must be reloaded after a specified change in its configuration.
    virtual bool doesConfigChangeRequiresReloadingObject(const DBPoco::Util::AbstractConfiguration & /* old_config */, const String & /* old_key_in_config */,
                                                         const DBPoco::Util::AbstractConfiguration & /* new_config */, const String & /* new_key_in_config */) const { return true; /* always reload */ }
    ...
    virtual void updateObjectFromConfigWithoutReloading(
        IExternalLoadable & /* object */, const DBPoco::Util::AbstractConfiguration & /* config */, const String & /* key_in_config */) const {}
