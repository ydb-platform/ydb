...
namespace DBPoco::Net { class SocketAddress; }
...
public:
    ...
    void authenticate(const String & user_name, const String & password, const DBPoco::Net::SocketAddress & address, const Strings & external_roles_ = {});
    ...
    void authenticate(const Credentials & credentials_, const DBPoco::Net::SocketAddress & address_, const Strings & external_roles_ = {});
    ...
    void onAuthenticationFailure(const std::optional<String> & user_name, const DBPoco::Net::SocketAddress & address_, const Exception & e);
    ...
    void setHTTPClientInfo(const DBPoco::Net::HTTPRequest & request);
