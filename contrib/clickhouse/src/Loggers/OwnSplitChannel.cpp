...
void OwnSplitChannel::log(const DBPoco::Message & msg)
{
    if (!isLoggingEnabled())
        return;
...
void OwnSplitChannel::tryLogSplit(const DBPoco::Message & msg)
{
...
void OwnSplitChannel::logSplit(const DBPoco::Message & msg)
{
...
void OwnSplitChannel::addChannel(DBPoco::AutoPtr<DBPoco::Channel> channel, const std::string & name)
{
