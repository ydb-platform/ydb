...
{
    ostr << (settings.hilite ? hilite_keyword : "") << DBPoco::toUpper(first) << " " << (settings.hilite ? hilite_none : "");
...
{
    ostr << (settings.hilite ? hilite_keyword : "") << DBPoco::toUpper(name) << (settings.hilite ? hilite_none : "") << (has_brackets ? "(" : "");
