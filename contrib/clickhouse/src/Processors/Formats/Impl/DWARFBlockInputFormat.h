...
#error #include <llvm/DebugInfo/DWARF/DWARFDebugAbbrev.h>
#error #include <llvm/DebugInfo/DWARF/DWARFDataExtractor.h>
#error #include <llvm/DebugInfo/DWARF/DWARFContext.h>
#error #include <llvm/DebugInfo/DWARF/DWARFUnit.h>
