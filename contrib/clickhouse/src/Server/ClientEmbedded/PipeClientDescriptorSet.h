...
public:
    ...
    {
        pipe_in.close(DBPoco::Pipe::CLOSE_WRITE);
        pipe_out.close(DBPoco::Pipe::CLOSE_READ);
        pipe_err.close(DBPoco::Pipe::CLOSE_READ);
    }
...
private:
    DBPoco::Pipe pipe_in;
    DBPoco::Pipe pipe_out;
    DBPoco::Pipe pipe_err;
