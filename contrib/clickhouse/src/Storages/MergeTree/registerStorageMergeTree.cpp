    ...
    const ContextPtr & local_context)
{
    ...
    if (has_valid_arguments)
    {
        ...
        {
            LOG_WARNING(
                &DBPoco::Logger::get("registerStorageMergeTree"),
        ...
        {
            LOG_WARNING(&DBPoco::Logger::get("registerStorageMergeTree"), "Replacing user-provided ZooKeeper path and replica name ({}, {}) "
