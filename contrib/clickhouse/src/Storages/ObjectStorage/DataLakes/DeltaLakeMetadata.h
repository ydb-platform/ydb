...
public:
    ...
    static DataTypePtr getFieldType(const DBPoco::JSON::Object::Ptr & field, const String & type_key, bool is_nullable);
    static DataTypePtr getSimpleTypeByName(const String & type_name);
    static DataTypePtr getFieldValue(const DBPoco::JSON::Object::Ptr & field, const String & type_key, bool is_nullable);
