...
std::pair<Int32, DBPoco::JSON::Object::Ptr>
parseTableSchemaFromManifestFile(const avro::DataFileReaderBase & manifest_file_reader, const String & manifest_file_name)
{
    ...
    // const DBPoco::JSON::Object::Ptr & schema_object = json.extract<DBPoco::JSON::Object::Ptr>();
...
std::pair<DBPoco::JSON::Object::Ptr, Int32> parseTableSchemaV2Method(const DBPoco::JSON::Object::Ptr & metadata_object)
{
...
std::pair<DBPoco::JSON::Object::Ptr, Int32> parseTableSchemaV1Method(const DBPoco::JSON::Object::Ptr & metadata_object)
{
    ...
    DBPoco::JSON::Object::Ptr schema = metadata_object->getObject("schema");
    if (!metadata_object->has("schema"))
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "Cannot parse Iceberg table schema: 'schema-id' field is missing in schema");
...
Int32 IcebergMetadata::parseTableSchema(
    const DBPoco::JSON::Object::Ptr & metadata_object, IcebergSchemaProcessor & schema_processor, LoggerPtr metadata_logger)
{
...
static std::pair<Int32, String> getLatestOrExplicitMetadataFileAndVersion(const ObjectStoragePtr & object_storage, const StorageObjectStorage::Configuration & configuration, DBPoco::Logger * log)
{
...
DBPoco::JSON::Object::Ptr IcebergMetadata::readJSON(const String & metadata_file_path, const ContextPtr & local_context) const
{
    ...
    return json.extract<DBPoco::JSON::Object::Ptr>();
}
...
std::optional<String> IcebergMetadata::getRelevantManifestList(const DBPoco::JSON::Object::Ptr & metadata)
{
    auto configuration_ptr = configuration.lock();

    auto snapshots = metadata->get("snapshots").extract<DBPoco::JSON::Array::Ptr>();
