...
public:
    ...
    IcebergMetadata(
        ...
        const DBPoco::JSON::Object::Ptr & object);
    ...
    static Int32
    parseTableSchema(const DBPoco::JSON::Object::Ptr & metadata_object, IcebergSchemaProcessor & schema_processor, LoggerPtr metadata_logger);
...
private:
    ...
    std::optional<String> getRelevantManifestList(const DBPoco::JSON::Object::Ptr & metadata);

    DBPoco::JSON::Object::Ptr readJSON(const String & metadata_file_path, const ContextPtr & local_context) const;
