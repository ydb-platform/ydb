    ...
    DB::ContextPtr context)
{
    ...
    // DBPoco::Dynamic::Var partition_spec_json = parser.parse(partition_spec_json_string);
    // const DBPoco::JSON::Array::Ptr & partition_specification = partition_spec_json.extract<DBPoco::JSON::Array::Ptr>();
