...
bool operator==(const DBPoco::JSON::Object & first, const DBPoco::JSON::Object & second)
{
    return equals(first, second);
}

bool operator==(const DBPoco::JSON::Array & first, const DBPoco::JSON::Array & second)
{
    return equals(first, second);
}

bool schemasAreIdentical(const DBPoco::JSON::Object & first, const DBPoco::JSON::Object & second)
{
...
void IcebergSchemaProcessor::addIcebergTableSchema(DBPoco::JSON::Object::Ptr schema_ptr)
{
    ...
    else
    {
        ...
        auto fields = schema_ptr->get("fields").extract<DBPoco::JSON::Array::Ptr>();
...
DataTypePtr
IcebergSchemaProcessor::getComplexTypeFromObject(const DBPoco::JSON::Object::Ptr & type, String & current_full_name, bool is_subfield_of_root)
{
...
DataTypePtr IcebergSchemaProcessor::getFieldType(
    const DBPoco::JSON::Object::Ptr & field, const String & type_key, bool required, String & current_full_name, bool is_subfield_of_root)
{
...
std::shared_ptr<ActionsDAG> IcebergSchemaProcessor::getSchemaTransformationDag(
    const DBPoco::JSON::Object::Ptr & old_schema, const DBPoco::JSON::Object::Ptr & new_schema, Int32 old_id, Int32 new_id)
{
    std::unordered_map<size_t, std::pair<DBPoco::JSON::Object::Ptr, const ActionsDAG::Node *>> old_schema_entries;
    auto old_schema_fields = old_schema->get("fields").extract<DBPoco::JSON::Array::Ptr>();
    ...
    auto new_schema_fields = new_schema->get("fields").extract<DBPoco::JSON::Array::Ptr>();
