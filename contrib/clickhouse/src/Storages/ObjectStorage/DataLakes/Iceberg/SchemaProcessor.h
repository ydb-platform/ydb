...
public:
    void addIcebergTableSchema(DBPoco::JSON::Object::Ptr schema_ptr);
...
private:
    std::unordered_map<Int32, DBPoco::JSON::Object::Ptr> iceberg_table_schemas_by_ids;
    ...
    NamesAndTypesList getSchemaType(const DBPoco::JSON::Object::Ptr & schema);
    DataTypePtr getComplexTypeFromObject(const DBPoco::JSON::Object::Ptr & type, String & current_full_name, bool is_subfield_of_root);
    DataTypePtr getFieldType(
        const DBPoco::JSON::Object::Ptr & field,
    ...
    const Node * getDefaultNodeForField(const DBPoco::JSON::Object::Ptr & field);
