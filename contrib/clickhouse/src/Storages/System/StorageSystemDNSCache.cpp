...
static DataTypePtr getIPFamilyEnumType()
{
    ...
    DataTypeEnum8::Values
        {
            {"IPv4",           static_cast<Int8>(DBPoco::Net::AddressFamily::IPv4)},
            {"IPv6",           static_cast<Int8>(DBPoco::Net::AddressFamily::IPv6)},
            {"UNIX_LOCAL",     static_cast<Int8>(DBPoco::Net::AddressFamily::UNIX_LOCAL)},
        });
}
