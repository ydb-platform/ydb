...
/*
   Now we support in Arcadia just static build with BDB on Windows. Compile
   time definititions needs to be properly set to compile BDB as a DLL and
   link with its import lib.
*/
#if 0 && defined(DB_WIN32) && defined(_MSC_VER) && \
