...
static Status ValidateGatherDimensionNumbers(
  ...
  if (!c_is_sorted(dim_numbers.output_window_dims())) {
    return InvalidArgument(
        ...
        ::tensorflow::str_util::Join(dim_numbers.output_window_dims(), ", ").c_str());
  }
  ...
  if (c_adjacent_find(sorted_gather_dims_to_operand_dims) !=
    ...
    return InvalidArgument(
        ...
        "got: %s.",
        ::tensorflow::str_util::Join(dim_numbers.gather_dims_to_operand_dims(), ", ").c_str());
  }
  ...
  if (!c_is_sorted(dim_numbers.elided_window_dims())) {
    return InvalidArgument(
        ...
        ::tensorflow::str_util::Join(dim_numbers.elided_window_dims(), ", ").c_str());
  }
...
/*static*/ StatusOr<Shape> ShapeInference::InferGatherShape(
  ...
  if (window_bounds.size() !=
    ...
    return InvalidArgument(
        ...
        window_bounds.size(),
        ::tensorflow::str_util::Join(gather_dim_numbers.output_window_dims(), ",").c_str(),
        ::tensorflow::str_util::Join(gather_dim_numbers.elided_window_dims(), ",").c_str());
  }
