...
// somov@: This file should be compiled as .cc without CUDA, and as .cu with CUDA
// and GOOGLE_CUDA define. While this mode not implemented compile it as CPU version
// even if build CUDA.
#undef GOOGLE_CUDA
