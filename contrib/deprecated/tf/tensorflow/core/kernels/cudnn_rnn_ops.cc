 ...
 public:
  ...
  string ToString() const {
    std::vector<string> fields = {
        IntToString<10>(num_layers_),
        IntToString<10>(input_size_),
        IntToString<10>(num_units_),
        IntToString<10>(seq_length_),
        IntToString<10>(batch_size_),
        IntToString<10>(dir_count_),
        IntToString<10>(static_cast<int>(has_dropout_)),
        IntToString<10>(static_cast<int>(is_training_)),
        IntToString<10>(static_cast<int>(rnn_mode_)),
        IntToString<10>(static_cast<int>(rnn_input_mode_)),
        IntToString<10>(static_cast<int>(dtype_))};
