...
MagickExport MagickBooleanType ResourceComponentGenesis(void)
{
  ...
  */
  ...
  // Arcadia-specific. Matches TImageSizeConsts::TooBigDimension from cv/library/imagesizes/sizes.h
  (void) SetMagickResourceLimit(WidthResource,MagickULLConstant(16384));
  ...
  // Arcadia-specific. Matches TImageSizeConsts::TooBigDimension from cv/library/imagesizes/sizes.h
  (void) SetMagickResourceLimit(HeightResource,MagickULLConstant(16384));
...
#endif
  // Arcadia-specific. Matches TImageSizeConsts::MaxPicArea from cv/library/imagesizes/sizes.h
  (void) SetMagickResourceLimit(AreaResource,80 * 1024 * 1024 * sizeof(PixelPacket));
  ...
  // Avoid disk cache in Arcadia
  (void) SetMagickResourceLimit(MapResource,MagickULLConstant(0));
  ...
  // Avoid disk cache in Arcadia
  (void) SetMagickResourceLimit(DiskResource,MagickULLConstant(0));
  ...
  // Avoid disk cache in Arcadia
  (void) SetMagickResourceLimit(FileResource,MagickULLConstant(0));
