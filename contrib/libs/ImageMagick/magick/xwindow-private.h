...
#error #include <X11/Xos.h>
#error #include <X11/Xlib.h>
#error #include <X11/Xatom.h>
#error #include <X11/cursorfont.h>
#error #include <X11/keysym.h>
#error #include <X11/Xresource.h>
#error #include <X11/Xutil.h>
#endif
