...
struct CompactTransposeMapVisitor {
  ...
  Status CompactTransposeMapImpl() {
    ...
    using arrow20::compute::Take;
    using arrow20::compute::TakeOptions;
    ...
    ARROW_ASSIGN_OR_RAISE(std::shared_ptr<arrow20::Array> compacted_dict_indices,
...
class DictionaryUnifierImpl : public DictionaryUnifier {
 public:
  ...
  Status GetResult(std::shared_ptr<DataType>* out_type,
    ...
    *out_type = arrow20::dictionary(index_type, value_type_);
