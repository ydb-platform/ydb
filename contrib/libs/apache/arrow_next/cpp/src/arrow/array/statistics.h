...
struct ARROW_EXPORT ArrayStatistics {
  ...
  /// arrow20::binary and \ref arrow20::large_utf8, `array_type` is
  /// returned. \ref arrow20::utf8 is returned otherwise.
  ///
  /// If \ref ValueType isn't `std::string`, `array_type` isn't used.
  ///
  /// \param array_type The Arrow type of the associated array.
  ///
  /// \return \ref arrow20::null if the minimum value is `std::nullopt`,
  ...
  /// \param array_type The Arrow type of the associated array.
  ///
  /// \return \ref arrow20::null if the maximum value is `std::nullopt`,
