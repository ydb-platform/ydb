...
using arrow20_vendored::date::ceil;
using arrow20_vendored::date::days;
using arrow20_vendored::date::floor;
using arrow20_vendored::date::hh_mm_ss;
using arrow20_vendored::date::local_days;
using arrow20_vendored::date::local_time;
using arrow20_vendored::date::locate_zone;
using arrow20_vendored::date::Monday;
using arrow20_vendored::date::months;
using arrow20_vendored::date::round;
using arrow20_vendored::date::Sunday;
using arrow20_vendored::date::sys_time;
using arrow20_vendored::date::trunc;
using arrow20_vendored::date::weekday;
using arrow20_vendored::date::weeks;
using arrow20_vendored::date::year;
using arrow20_vendored::date::year_month_day;
using arrow20_vendored::date::year_month_weekday;
using arrow20_vendored::date::years;
using arrow20_vendored::date::zoned_time;
using arrow20_vendored::date::literals::dec;
using arrow20_vendored::date::literals::jan;
using arrow20_vendored::date::literals::last;
using arrow20_vendored::date::literals::mon;
using arrow20_vendored::date::literals::sun;
using arrow20_vendored::date::literals::thu;
using arrow20_vendored::date::literals::wed;
...
struct Week {
  ...
  Localizer localizer_;
  arrow20_vendored::date::weekday wd_;
  arrow20_vendored::date::days days_offset_;
...
struct Strptime {
  ...
  static Status Exec(KernelContext* ctx, const ExecSpan& batch, ExecResult* out) {
    ...
    if (self.error_is_null) {
      ...
      arrow20::internal::BitmapWriter out_writer(out_span->buffers[0].data,
      ...
      if (in.buffers[0].data != nullptr) {
        ::arrow20::internal::CopyBitmap(in.buffers[0].data, in.offset, in.length,
...
struct AssumeTimezone {
  ...
  template <typename T, typename Arg0>
  T get_local_time(Arg0 arg, const arrow20_vendored::date::choose choose,
  ...
  T Call(KernelContext*, Arg0 arg, Status* st) const {
    try {
    ...
    } catch (const arrow20_vendored::date::nonexistent_local_time& e) {
      switch (options.nonexistent) {
        ...
        case AssumeTimezoneOptions::Nonexistent::NONEXISTENT_EARLIEST: {
          return get_local_time<T, Arg0>(arg, arrow20_vendored::date::choose::latest, tz_) -
                 1;
        }
    ...
    } catch (const arrow20_vendored::date::ambiguous_local_time& e) {
      switch (options.ambiguous) {
        ...
        case AssumeTimezoneOptions::Ambiguous::AMBIGUOUS_EARLIEST: {
          return get_local_time<T, Arg0>(arg, arrow20_vendored::date::choose::earliest,
                                         tz_);
        }
