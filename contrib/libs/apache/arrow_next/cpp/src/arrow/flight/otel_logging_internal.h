...
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/flight/otel_logging.h"
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/util/logger.h"

namespace arrow20::flight::internal {
...
#  define ARROW_FLIGHT_OTELLOG_CLIENT(LEVEL, ...)                                  \
    ARROW_LOGGER_CALL(::arrow20::flight::internal::GetOtelGrpcClientLogger(), LEVEL, \
                      __VA_ARGS__)
#  define ARROW_FLIGHT_OTELLOG_SERVER(LEVEL, ...)                                  \
    ARROW_LOGGER_CALL(::arrow20::flight::internal::GetOtelGrpcServerLogger(), LEVEL, \
                      __VA_ARGS__)
#  define ARROW_FLIGHT_OTELLOG_SQL_CLIENT(LEVEL, ...)                             \
    ARROW_LOGGER_CALL(::arrow20::flight::internal::GetOtelSqlClientLogger(), LEVEL, \
                      __VA_ARGS__)
#  define ARROW_FLIGHT_OTELLOG_SQL_SERVER(LEVEL, ...)                             \
    ARROW_LOGGER_CALL(::arrow20::flight::internal::GetOtelSqlServerLogger(), LEVEL, \
                      __VA_ARGS__)
