...
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/testing/gtest_util.h"
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/testing/process.h"
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/testing/util.h"
...
class ARROW_FLIGHT_EXPORT TestServer {
 public:
  explicit TestServer(const std::string& executable_name)
      : executable_name_(executable_name), port_(::arrow20::GetListenPort()) {}
...
class ARROW_FLIGHT_EXPORT NumberingStream : public FlightDataStream {
 public:
  ...
  arrow20::Result<FlightPayload> GetSchemaPayload() override;
  arrow20::Result<FlightPayload> Next() override;
...
ARROW_FLIGHT_EXPORT
arrow20::Result<std::shared_ptr<RecordBatch>> VeryLargeBatch();
