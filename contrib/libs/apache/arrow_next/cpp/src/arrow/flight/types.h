...
class ARROW_FLIGHT_EXPORT FlightStatusDetail : public arrow20::StatusDetail {
 public:
  ...
  /// nullptr otherwise
  static std::shared_ptr<FlightStatusDetail> UnwrapStatus(const arrow20::Status& status);
...
struct BaseType {
 ...
 public:
  ...
  inline arrow20::Result<std::string> SerializeToString() const {
    std::string out;
    ARROW_RETURN_NOT_OK(self().SelfT::SerializeToString(&out));
    return out;
  }

  inline static arrow20::Result<T> Deserialize(std::string_view serialized) {
    T out;
    ARROW_RETURN_NOT_OK(SelfT::Deserialize(serialized, &out));
    return out;
  }

  inline arrow20::Result<std::shared_ptr<Buffer>> SerializeToBuffer() const {
    std::string out;
    ARROW_RETURN_NOT_OK(self().SelfT::SerializeToString(&out));
...
struct ARROW_FLIGHT_EXPORT BasicAuth : public internal::BaseType<BasicAuth> {
  ...
  arrow20::Status SerializeToString(std::string* out) const;
  ...
  static arrow20::Status Deserialize(std::string_view serialized, BasicAuth* out);
};
...
struct ARROW_FLIGHT_EXPORT ActionType : public internal::BaseType<ActionType> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, ActionType* out);
...
struct ARROW_FLIGHT_EXPORT Criteria : public internal::BaseType<Criteria> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, Criteria* out);
};
...
struct ARROW_FLIGHT_EXPORT Action : public internal::BaseType<Action> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, Action* out);
};
...
struct ARROW_FLIGHT_EXPORT Result : public internal::BaseType<Result> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, Result* out);
};
...
struct ARROW_FLIGHT_EXPORT SchemaResult : public internal::BaseType<SchemaResult> {
 public:
  ...
  static arrow20::Result<std::unique_ptr<SchemaResult>> Make(const Schema& schema);

  /// \brief return schema
  /// \param[in,out] dictionary_memo for dictionary bookkeeping, will
  /// be modified
  /// \return Arrow result with the reconstructed Schema
  arrow20::Result<std::shared_ptr<Schema>> GetSchema(
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, SchemaResult* out);
...
struct ARROW_FLIGHT_EXPORT FlightDescriptor
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, FlightDescriptor* out);
...
class ARROW_FLIGHT_EXPORT FlightInfo
 ...
 public:
  ...
  static arrow20::Result<FlightInfo> Make(const Schema& schema,
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized,
...
struct ARROW_FLIGHT_EXPORT Ticket : public internal::BaseType<Ticket> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, Ticket* out);
};
...
struct ARROW_FLIGHT_EXPORT Location : public internal::BaseType<Location> {
 public:
  ...
  static arrow20::Result<Location> Parse(const std::string& uri_string);
  ...
  static arrow20::Result<Location> ForGrpcTcp(const std::string& host, const int port);
  ...
  /// \param[in] port The port
  /// \return Arrow result with the resulting location
  static arrow20::Result<Location> ForGrpcTls(const std::string& host, const int port);

  /// \brief Initialize a location for a domain socket-based Flight
  /// service
  /// \param[in] path The path to the domain socket
  /// \return Arrow result with the resulting location
  static arrow20::Result<Location> ForGrpcUnix(const std::string& path);

  /// \brief Initialize a location based on a URI scheme
  static arrow20::Result<Location> ForScheme(const std::string& scheme,
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, Location* out);

 private:
  friend class FlightClient;
  friend class FlightServerBase;
  std::shared_ptr<arrow20::util::Uri> uri_;
};
...
struct ARROW_FLIGHT_EXPORT FlightEndpoint : public internal::BaseType<FlightEndpoint> {
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, FlightEndpoint* out);
};
...
struct ARROW_FLIGHT_EXPORT CloseSessionRequest
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, CloseSessionRequest* out);
};
...
struct ARROW_FLIGHT_EXPORT CloseSessionResult
  ...
  ///
  /// Use `Deserialize(serialized)` if you want a Result-returning version.
  static arrow20::Status Deserialize(std::string_view serialized, CloseSessionResult* out);
};
...
class ARROW_FLIGHT_EXPORT FlightListing {
 public:
  ...
  /// are none left.
  virtual arrow20::Result<std::unique_ptr<FlightInfo>> Next() = 0;
};
...
class ARROW_FLIGHT_EXPORT ResultStream {
 public:
  ...
  virtual arrow20::Result<std::unique_ptr<Result>> Next() = 0;
...
class ARROW_FLIGHT_EXPORT SimpleFlightListing : public FlightListing {
 public:
  ...
  arrow20::Result<std::unique_ptr<FlightInfo>> Next() override;
...
class ARROW_FLIGHT_EXPORT SimpleResultStream : public ResultStream {
 public:
  ...
  arrow20::Result<std::unique_ptr<Result>> Next() override;
