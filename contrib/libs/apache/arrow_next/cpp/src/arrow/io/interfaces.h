...
struct ARROW_EXPORT IOContext {
  ...
  explicit IOContext(MemoryPool* pool, ::arrow20::internal::Executor* executor,
  ...
  explicit IOContext(::arrow20::internal::Executor* executor,
                     StopToken stop_token = StopToken::Unstoppable(),
                     int64_t external_id = -1)
  ...
  ::arrow20::internal::Executor* executor() const { return executor_; }
