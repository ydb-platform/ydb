...
class ARROW_EXPORT Reader {
 public:
  ...
  /// \brief Read all columns from the file as an arrow20::Table.
  ///
  ...
  /// \brief Read only the specified columns from the file as an arrow20::Table.
  ///
...
struct ARROW_EXPORT WriteProperties {
  ...
  int compression_level = ::arrow20::util::kUseDefaultCompressionLevel;
};
