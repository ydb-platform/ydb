...
using RecordBatchReader = ::arrow20::RecordBatchReader;
...
class ARROW_EXPORT RecordBatchFileReader
 ...
 public:
  ...
  virtual Result<AsyncGenerator<std::shared_ptr<RecordBatch>>> GetRecordBatchGenerator(
      ...
      arrow20::internal::Executor* executor = NULLPTR) = 0;

  /// \brief Collect all batches as a vector of record batches
  Result<RecordBatchVector> ToRecordBatches();

  /// \brief Collect all batches and concatenate as arrow20::Table
...
class ARROW_EXPORT Listener {
 public:
  ...
  ///
  /// The default implementation just returns arrow20::Status::OK().
  ///
  /// \return Status
  ///
  /// \see StreamDecoder
...
class ARROW_EXPORT StreamDecoder {
 public:
  ...
  ///     continue;
  ///   }
  ///   std::shared_ptr<arrow20::Buffer> chunk(buffer.release());
...
/// \brief Read arrow20::Tensor as encapsulated IPC message in file
///
...
/// \brief EXPERIMENTAL: Read arrow20::Tensor from IPC message
///
...
/// \brief EXPERIMENTAL: Read arrow20::SparseTensor as encapsulated IPC message in file
///
/// \param[in] file an InputStream pointed at the start of the message
...
/// \brief EXPERIMENTAL: Read arrow20::SparseTensor from IPC message
///
/// \param[in] message a Message containing the tensor metadata and body
/// \return the read sparse tensor
ARROW_EXPORT
...
/// \brief EXPERIMENTAL: Read arrow20::SparseTensorFormat::type from a metadata
...
/// \brief EXPERIMENTAL: Read arrow20::SparseTensor from an IpcPayload
