...
#include "contrib/libs/apache/arrow_next/cpp/src/arrow/ipc/dictionary.h"  // IWYU pragma: export
...
/// arrow20::ipc::GetRecordBatchSize to compute how much space is required
ARROW_EXPORT
...
/// \brief EXPERIMENTAL: Convert arrow20::Tensor to a Message with minimal memory
/// allocation
///
/// \param[in] tensor the Tensor to write
...
/// \brief Write arrow20::Tensor as a contiguous message.
///
...
/// \brief EXPERIMENTAL: Convert arrow20::SparseTensor to a Message with minimal memory
/// allocation
///
/// The message is written out as followed:
/// \code
...
/// \brief EXPERIMENTAL: Write arrow20::SparseTensor as a contiguous message. The metadata,
