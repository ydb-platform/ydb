...
///
/// ```
///   arrow20::Result<Foo> result = CalculateFoo();
///   if (result.ok()) {
...
///
/// ```
///   arrow20::Result<std::unique_ptr<Foo>> result = CalculateFoo();
///   if (result.ok()) {
...
///
/// ```
///   arrow20::Status CalculateFoo(int *output);
/// ```
///
/// This function may instead be written as:
///
/// ```
///   arrow20::Result<int> CalculateFoo();
/// ```
template <class T>
