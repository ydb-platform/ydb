...
#define ARROW_RETURN_NOT_OK(status)                                   \
  do {                                                                \
    ::arrow20::Status __s = ::arrow20::internal::GenericToStatus(status); \
...
#define RETURN_NOT_OK_ELSE(s, else_)                            \
  do {                                                          \
    ::arrow20::Status _s = ::arrow20::internal::GenericToStatus(s); \
    if (!_s.ok()) {                                             \
      else_;                                                    \
      return _s;                                                \
    }                                                           \
