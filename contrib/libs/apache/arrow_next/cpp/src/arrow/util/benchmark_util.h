...
// Benchmark 1.8.0 or later.
 ...
 public:
  std::shared_ptr<::arrow20::ProxyMemoryPool> memory_pool;
...
class BenchmarkMemoryTracker {
 public:
  ...
  ::arrow20::MemoryPool* memory_pool() const { return manager_.memory_pool.get(); }

 protected:
  ::arrow20::MemoryPoolMemoryManager manager_;
};
