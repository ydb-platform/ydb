...
inline uint64_t ReadLittleEndianWord(const uint8_t* buffer, int bytes_remaining) {
  ...
  return arrow20::bit_util::FromLittleEndian(le_value);
}
...
inline bool BitWriter::PutValue(uint64_t v, int num_bits) {
  ...
  if (ARROW_PREDICT_FALSE(bit_offset_ >= 64)) {
    ...
    buffered_values_ = arrow20::bit_util::ToLittleEndian(buffered_values_);
...
inline void BitWriter::Flush(bool align) {
  ...
  auto buffered_values = arrow20::bit_util::ToLittleEndian(buffered_values_);
...
inline bool BitWriter::PutAligned(T val, int num_bytes) {
  ...
  val = arrow20::bit_util::ToLittleEndian(val);
...
inline bool BitReader::GetAligned(int num_bytes, T* v) {
  ...
  if constexpr (std::is_same_v<T, bool>) {
    ...
    *v = arrow20::bit_util::FromLittleEndian(*v);
  }
  byte_offset_ += num_bytes;
...
inline bool BitWriter::PutZigZagVlqInt(int32_t v) {
  uint32_t u_v = ::arrow20::util::SafeCopy<uint32_t>(v);
...
inline bool BitReader::GetZigZagVlqInt(int32_t* v) {
  ...
  u = (u >> 1) ^ (~(u & 1) + 1);
  *v = ::arrow20::util::SafeCopy<int32_t>(u);
  return true;
}
...
inline bool BitWriter::PutZigZagVlqInt(int64_t v) {
  uint64_t u_v = ::arrow20::util::SafeCopy<uint64_t>(v);
...
inline bool BitReader::GetZigZagVlqInt(int64_t* v) {
  ...
  if (!GetVlqInt(&u)) return false;
  u = (u >> 1) ^ (~(u & 1) + 1);
  *v = ::arrow20::util::SafeCopy<int64_t>(u);
  return true;
}
