...
#  define ARROW_LOG_INTERNAL(level) ::arrow20::util::ArrowLog(__FILE__, __LINE__, level)
#  define ARROW_LOG(level) ARROW_LOG_INTERNAL(::arrow20::util::ArrowLogLevel::ARROW_##level)
...
#  define ARROW_CHECK_OR_LOG(condition, level) \
    ...
    ? ARROW_IGNORE_EXPR(0)                     \
    : ::arrow20::util::Voidify() & ARROW_LOG(level) << " Check failed: " #condition " "
...
#  ifdef NDEBUG
#    define ARROW_DFATAL ::arrow20::util::ArrowLogLevel::ARROW_WARNING
...
#    define ARROW_DCHECK(condition)               \
      ...
      while (false) ::arrow20::util::detail::NullLog()
...
#  else
#    define ARROW_DFATAL ::arrow20::util::ArrowLogLevel::ARROW_FATAL
