...
struct MultipathLevelBuilderResult {
  ...
  /// visited via a DFS).
  std::shared_ptr<::arrow20::Array> leaf_array;
...
class PARQUET_EXPORT MultipathLevelBuilder {
 public:
  ...
  using CallbackFunction =
      std::function<::arrow20::Status(const MultipathLevelBuilderResult&)>;
  ...
  static ::arrow20::Status Write(const ::arrow20::Array& array, bool array_field_nullable,
  ...
  ///   the array column as nullable (as determined by its type's parent
  ///   field).
  static ::arrow20::Result<std::unique_ptr<MultipathLevelBuilder>> Make(
      const ::arrow20::Array& array, bool array_field_nullable);
  ...
  virtual ::arrow20::Status Write(int leaf_index, ArrowWriteContext* context,
