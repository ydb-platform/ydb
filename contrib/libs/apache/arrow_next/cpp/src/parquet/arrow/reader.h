...
/// `FileReader::RowGroup(i)->Column(j)->Read` and receive an `arrow20::Column`
/// instance.
///
...
class PARQUET_EXPORT FileReader {
 public:
  ...
  static ::arrow20::Status Make(::arrow20::MemoryPool* pool,
  ...
  // fully-materialized arrow20::Array instances
  //
  // Returns error status if the column of interest is not flat.
  // The indicated column index is relative to the schema
  virtual ::arrow20::Status GetColumn(int i, std::unique_ptr<ColumnReader>* out) = 0;

  /// \brief Return arrow schema for all the columns.
  virtual ::arrow20::Status GetSchema(std::shared_ptr<::arrow20::Schema>* out) = 0;
  ...
  virtual ::arrow20::Status ReadColumn(int i,
                                     std::shared_ptr<::arrow20::ChunkedArray>* out) = 0;

  /// \brief Return a RecordBatchReader of all row groups and columns.
  ///
  /// \deprecated Deprecated in 19.0.0. Use arrow20::Result version instead.
  ARROW_DEPRECATED("Deprecated in 19.0.0. Use arrow20::Result version instead.")
  ::arrow20::Status GetRecordBatchReader(std::unique_ptr<::arrow20::RecordBatchReader>* out);

  /// \brief Return a RecordBatchReader of all row groups and columns.
  virtual ::arrow20::Result<std::unique_ptr<::arrow20::RecordBatchReader>>
  ...
  /// \deprecated Deprecated in 19.0.0. Use arrow20::Result version instead.
  ARROW_DEPRECATED("Deprecated in 19.0.0. Use arrow20::Result version instead.")
  virtual ::arrow20::Status GetRecordBatchReader(
      const std::vector<int>& row_group_indices,
      std::unique_ptr<::arrow20::RecordBatchReader>* out);
  ...
  /// \returns error Status if either row_group_indices or column_indices
  ///     contains an invalid index
  ::arrow20::Status GetRecordBatchReader(const std::vector<int>& row_group_indices,
                                       const std::vector<int>& column_indices,
                                       std::shared_ptr<::arrow20::RecordBatchReader>* out);
  ::arrow20::Status GetRecordBatchReader(const std::vector<int>& row_group_indices,
                                       std::shared_ptr<::arrow20::RecordBatchReader>* out);
  ::arrow20::Status GetRecordBatchReader(std::shared_ptr<::arrow20::RecordBatchReader>* out);
  ...
  ///     invalid index
  virtual ::arrow20::Result<
      std::function<::arrow20::Future<std::shared_ptr<::arrow20::RecordBatch>>()>>
  GetRecordBatchGenerator(std::shared_ptr<FileReader> reader,
                          const std::vector<int> row_group_indices,
                          const std::vector<int> column_indices,
                          ::arrow20::internal::Executor* cpu_executor = NULLPTR,
                          int64_t rows_to_readahead = 0) = 0;

  /// Read all columns into a Table
  virtual ::arrow20::Status ReadTable(std::shared_ptr<::arrow20::Table>* out) = 0;
  ...
  virtual ::arrow20::Status ReadTable(const std::vector<int>& column_indices,
                                    std::shared_ptr<::arrow20::Table>* out) = 0;

  virtual ::arrow20::Status ReadRowGroup(int i, const std::vector<int>& column_indices,
                                       std::shared_ptr<::arrow20::Table>* out) = 0;

  virtual ::arrow20::Status ReadRowGroup(int i, std::shared_ptr<::arrow20::Table>* out) = 0;

  virtual ::arrow20::Status ReadRowGroups(const std::vector<int>& row_groups,
                                        const std::vector<int>& column_indices,
                                        std::shared_ptr<::arrow20::Table>* out) = 0;
  ...
  virtual ::arrow20::Status ScanContents(std::vector<int> columns,
...
class ColumnChunkReader {
 public:
  ...
  virtual ::arrow20::Status Read(std::shared_ptr<::arrow20::ChunkedArray>* out) = 0;
};
...
class PARQUET_EXPORT ColumnReader {
 public:
  ...
  virtual ::arrow20::Status NextBatch(int64_t batch_size,
                                    std::shared_ptr<::arrow20::ChunkedArray>* out) = 0;
};
...
class PARQUET_EXPORT FileReaderBuilder {
 public:
  ...
  ::arrow20::Status Open(std::shared_ptr<::arrow20::io::RandomAccessFile> file,
                       const ReaderProperties& properties = default_reader_properties(),
                       std::shared_ptr<FileMetaData> metadata = NULLPTR);

  /// Create FileReaderBuilder from file path and optional properties / metadata
  ::arrow20::Status OpenFile(const std::string& path, bool memory_map = false,
  ...
  FileReaderBuilder* memory_pool(::arrow20::MemoryPool* pool);
  ...
  ::arrow20::Status Build(std::unique_ptr<FileReader>* out);
  ::arrow20::Result<std::unique_ptr<FileReader>> Build();
...
ARROW_DEPRECATED("Deprecated in 19.0.0. Use arrow20::Result version instead.")
PARQUET_EXPORT
::arrow20::Status OpenFile(std::shared_ptr<::arrow20::io::RandomAccessFile>,
                         ::arrow20::MemoryPool* allocator,
...
/// Advanced settings are supported through the FileReaderBuilder class.
PARQUET_EXPORT
::arrow20::Result<std::unique_ptr<FileReader>> OpenFile(
    std::shared_ptr<::arrow20::io::RandomAccessFile>, ::arrow20::MemoryPool* allocator);

/// @}

PARQUET_EXPORT
::arrow20::Status StatisticsAsScalars(const Statistics& Statistics,
...
PARQUET_EXPORT
::arrow20::Status FuzzReader(const uint8_t* data, int64_t size);
