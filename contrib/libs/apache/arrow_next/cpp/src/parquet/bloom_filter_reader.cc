...
class RowGroupBloomFilterReaderImpl final : public RowGroupBloomFilterReader {
 public:
  RowGroupBloomFilterReaderImpl(std::shared_ptr<::arrow20::io::RandomAccessFile> input,
 ...
 private:
  ...
  std::shared_ptr<::arrow20::io::RandomAccessFile> input_;
...
std::unique_ptr<BloomFilter> RowGroupBloomFilterReaderImpl::GetColumnBloomFilter(int i) {
  ...
  auto stream = ::arrow20::io::RandomAccessFile::GetStream(
...
class BloomFilterReaderImpl final : public BloomFilterReader {
 public:
  BloomFilterReaderImpl(std::shared_ptr<::arrow20::io::RandomAccessFile> input,
...
std::unique_ptr<BloomFilterReader> BloomFilterReader::Make(
    std::shared_ptr<::arrow20::io::RandomAccessFile> input,
