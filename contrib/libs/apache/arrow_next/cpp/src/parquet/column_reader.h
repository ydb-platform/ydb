...
class PARQUET_EXPORT LevelDecoder {
 ...
 private:
  ...
  std::unique_ptr<::arrow20::util::RleDecoder> rle_decoder_;
  std::unique_ptr<::arrow20::bit_util::BitReader> bit_packed_decoder_;
  int16_t max_level_;
};
...
class PARQUET_EXPORT RecordReader {
 ...
 protected:
  ...
  std::shared_ptr<::arrow20::ResizableBuffer> values_;
  ...
  std::shared_ptr<::arrow20::ResizableBuffer> valid_bits_;
  ...
  std::shared_ptr<::arrow20::ResizableBuffer> def_levels_;
  /// \brief Buffer for repetition levels. Only populated for repeated
  /// fields.
  std::shared_ptr<::arrow20::ResizableBuffer> rep_levels_;
...
class BinaryRecordReader : virtual public RecordReader {
 public:
  virtual std::vector<std::shared_ptr<::arrow20::Array>> GetBuilderChunks() = 0;
};
...
class DictionaryRecordReader : virtual public RecordReader {
 public:
  virtual std::shared_ptr<::arrow20::ChunkedArray> GetResult() = 0;
};
