...
class PARQUET_EXPORT LevelEncoder {
 ...
 private:
  ...
  std::unique_ptr<::arrow20::util::RleEncoder> rle_encoder_;
  std::unique_ptr<::arrow20::bit_util::BitWriter> bit_packed_encoder_;
};
...
class PARQUET_EXPORT ColumnWriter {
 public:
  ...
  virtual ::arrow20::Status WriteArrow(const int16_t* def_levels, const int16_t* rep_levels,
