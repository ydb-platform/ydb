...
using arrow20::internal::SafeSignedSubtract;
using arrow20::util::SafeLoad;
using arrow20::util::SafeLoadAs;

template <typename T>
using ArrowPoolVector = std::vector<T, ::arrow20::stl::allocator<T>>;
...
class PlainEncoder : public EncoderImpl, virtual public TypedEncoder<DType> {
 public:
  ...
  void Put(const ::arrow20::Array& values) override;

  void PutSpaced(const T* src, int num_values, const uint8_t* valid_bits,
                 int64_t valid_bits_offset) override {
    if (valid_bits != NULLPTR) {
      PARQUET_ASSIGN_OR_THROW(auto buffer, ::arrow20::AllocateBuffer(num_values * sizeof(T),
                                                                   this->memory_pool()));
      T* data = buffer->template mutable_data_as<T>();
      int num_valid_values = ::arrow20::util::internal::SpacedCompress<T>(
 ...
 protected:
  ...
  void PutBinaryArray(const ArrayType& array) {
    ...
    PARQUET_THROW_NOT_OK(::arrow20::VisitArraySpanInline<typename ArrayType::TypeClass>(
        *array.data(),
...
template <typename ArrayType>
void DirectPutImpl(const ::arrow20::Array& values, ::arrow20::BufferBuilder* sink) {
...
template <>
void PlainEncoder<Int32Type>::Put(const ::arrow20::Array& values) {
  DirectPutImpl<::arrow20::Int32Array>(values, &sink_);
}

template <>
void PlainEncoder<Int64Type>::Put(const ::arrow20::Array& values) {
  DirectPutImpl<::arrow20::Int64Array>(values, &sink_);
}

template <>
void PlainEncoder<Int96Type>::Put(const ::arrow20::Array& values) {
  ParquetException::NYI("direct put to Int96");
}

template <>
void PlainEncoder<FloatType>::Put(const ::arrow20::Array& values) {
  DirectPutImpl<::arrow20::FloatArray>(values, &sink_);
}

template <>
void PlainEncoder<DoubleType>::Put(const ::arrow20::Array& values) {
  DirectPutImpl<::arrow20::DoubleArray>(values, &sink_);
}

template <typename DType>
void PlainEncoder<DType>::Put(const ::arrow20::Array& values) {
  ParquetException::NYI("direct put of " + values.type()->ToString());
}

void AssertBaseBinary(const ::arrow20::Array& values) {
  if (!::arrow20::is_base_binary_like(values.type_id())) {
    throw ParquetException("Only BaseBinaryArray and subclasses supported");
  }
}

template <>
inline void PlainEncoder<ByteArrayType>::Put(const ::arrow20::Array& values) {
  AssertBaseBinary(values);

  if (::arrow20::is_binary_like(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::BinaryArray&>(values));
  } else {
    DCHECK(::arrow20::is_large_binary_like(values.type_id()));
    PutBinaryArray(checked_cast<const ::arrow20::LargeBinaryArray&>(values));
  }
}

void AssertFixedSizeBinary(const ::arrow20::Array& values, int type_length) {
  if (!::arrow20::is_fixed_size_binary(values.type_id())) {
    throw ParquetException("Only FixedSizeBinaryArray and subclasses supported");
  }
  if (checked_cast<const ::arrow20::FixedSizeBinaryType&>(*values.type()).byte_width() !=
      type_length) {
...
template <>
inline void PlainEncoder<FLBAType>::Put(const ::arrow20::Array& values) {
  AssertFixedSizeBinary(values, descr_->type_length());
  const auto& data = checked_cast<const ::arrow20::FixedSizeBinaryArray&>(values);
...
class PlainEncoder<BooleanType> : public EncoderImpl, virtual public BooleanEncoder {
 public:
  ...
  void Put(const ::arrow20::Array& values) override {
    if (values.type_id() != ::arrow20::Type::BOOL) {
      throw ParquetException("direct put to boolean from " + values.type()->ToString() +
                             " not supported");
    }
    const auto& data = checked_cast<const ::arrow20::BooleanArray&>(values);
 ...
 private:
  ::arrow20::TypedBufferBuilder<bool> sink_;
...
int64_t PlainEncoder<BooleanType>::EstimatedDataEncodedSize() {
  return ::arrow20::bit_util::BytesForBits(sink_.length());
}
...
struct DictEncoderTraits {
  ...
  using MemoTableType = ::arrow20::internal::ScalarMemoTable<c_type>;
};

template <>
struct DictEncoderTraits<ByteArrayType> {
  using MemoTableType = ::arrow20::internal::BinaryMemoTable<::arrow20::BinaryBuilder>;
};
...
int RlePreserveBufferSize(int num_values, int bit_width) {
  ...
  return ::arrow20::util::RleEncoder::MaxBufferSize(bit_width, num_values) +
         ::arrow20::util::RleEncoder::MinBufferSize(bit_width);
}
 ...
 public:
  ...
  explicit DictEncoderImpl(const ColumnDescriptor* desc, MemoryPool* pool)
      : EncoderImpl(desc, Encoding::RLE_DICTIONARY, pool),
        buffered_indices_(::arrow20::stl::allocator<int32_t>(pool)),
  ...
  int WriteIndices(uint8_t* buffer, int buffer_len) override {
    ...
    *buffer = static_cast<uint8_t>(bit_width());
    ...
    ::arrow20::util::RleEncoder encoder(buffer, buffer_len, bit_width());
  ...
  void PutSpaced(const T* src, int num_values, const uint8_t* valid_bits,
                 int64_t valid_bits_offset) override {
    ::arrow20::internal::VisitSetBitRunsVoid(valid_bits, valid_bits_offset, num_values,
  ...
  void Put(const ::arrow20::Array& values) override;
  void PutDictionary(const ::arrow20::Array& values) override;

  template <typename ArrowType, typename T = typename ArrowType::c_type>
  void PutIndicesTyped(const ::arrow20::Array& data) {
  ...
  void PutIndices(const ::arrow20::Array& data) override {
    switch (data.type()->id()) {
      case ::arrow20::Type::UINT8:
      case ::arrow20::Type::INT8:
        return PutIndicesTyped<::arrow20::UInt8Type>(data);
      case ::arrow20::Type::UINT16:
      case ::arrow20::Type::INT16:
        return PutIndicesTyped<::arrow20::UInt16Type>(data);
      case ::arrow20::Type::UINT32:
      case ::arrow20::Type::INT32:
        return PutIndicesTyped<::arrow20::UInt32Type>(data);
      case ::arrow20::Type::UINT64:
      case ::arrow20::Type::INT64:
        return PutIndicesTyped<::arrow20::UInt64Type>(data);
      default:
...
template <>
void DictEncoderImpl<Int96Type>::Put(const ::arrow20::Array& values) {
  ParquetException::NYI("Direct put to Int96");
}

template <>
void DictEncoderImpl<Int96Type>::PutDictionary(const ::arrow20::Array& values) {
  ParquetException::NYI("Direct put to Int96");
}

template <typename DType>
void DictEncoderImpl<DType>::Put(const ::arrow20::Array& values) {
  using ArrayType = typename ::arrow20::CTypeTraits<typename DType::c_type>::ArrayType;
...
template <>
void DictEncoderImpl<FLBAType>::Put(const ::arrow20::Array& values) {
...
template <>
void DictEncoderImpl<ByteArrayType>::Put(const ::arrow20::Array& values) {
  AssertBaseBinary(values);
  if (::arrow20::is_binary_like(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::BinaryArray&>(values));
  } else {
...
template <typename DType>
void AssertCanPutDictionary(DictEncoderImpl<DType>* encoder, const ::arrow20::Array& dict) {
...
template <typename DType>
void DictEncoderImpl<DType>::PutDictionary(const ::arrow20::Array& values) {
...
template <>
void DictEncoderImpl<FLBAType>::PutDictionary(const ::arrow20::Array& values) {
  AssertFixedSizeBinary(values, type_length_);
  AssertCanPutDictionary(this, values);
...
template <>
void DictEncoderImpl<ByteArrayType>::PutDictionary(const ::arrow20::Array& values) {
  AssertBaseBinary(values);
  AssertCanPutDictionary(this, values);

  if (::arrow20::is_binary_like(values.type_id())) {
    PutBinaryDictionaryArray(checked_cast<const ::arrow20::BinaryArray&>(values));
  } else {
    DCHECK(::arrow20::is_large_binary_like(values.type_id()));
    PutBinaryDictionaryArray(checked_cast<const ::arrow20::LargeBinaryArray&>(values));
  }
}
...
class ByteStreamSplitEncoderBase : public EncoderImpl,
 ...
 public:
  ...
  std::shared_ptr<Buffer> FlushValues() override {
    ...
    ::arrow20::util::internal::ByteStreamSplitEncode(
...
class ByteStreamSplitEncoder<FLBAType> : public ByteStreamSplitEncoderBase<FLBAType> {
 public:
  ...
  using ArrowType = ::arrow20::FixedSizeBinaryArray;
...
class DeltaBitPackEncoder : public EncoderImpl, virtual public TypedEncoder<DType> {
 ...
 public:
  ...
  explicit DeltaBitPackEncoder(const ColumnDescriptor* descr, MemoryPool* pool,
      ...
      : EncoderImpl(descr, Encoding::DELTA_BINARY_PACKED, pool),
        ...
        deltas_(values_per_block, ::arrow20::stl::allocator<T>(pool)),
        bits_buffer_(
 ...
 private:
  ...
  ::arrow20::BufferBuilder sink_;
  ::arrow20::bit_util::BitWriter bit_writer_;
};
...
template <>
void DeltaBitPackEncoder<Int32Type>::Put(const ::arrow20::Array& values) {
  const ::arrow20::ArrayData& data = *values.data();
  if (values.type_id() != ::arrow20::Type::INT32) {
...
template <>
void DeltaBitPackEncoder<Int64Type>::Put(const ::arrow20::Array& values) {
  const ::arrow20::ArrayData& data = *values.data();
  if (values.type_id() != ::arrow20::Type::INT64) {
 ...
 public:
  explicit DeltaLengthByteArrayEncoder(const ColumnDescriptor* descr, MemoryPool* pool)
      : EncoderImpl(descr, Encoding::DELTA_LENGTH_BYTE_ARRAY,
                    pool = ::arrow20::default_memory_pool()),
        sink_(pool),
...
void DeltaLengthByteArrayEncoder::Put(const ::arrow20::Array& values) {
  AssertBaseBinary(values);
  if (::arrow20::is_binary_like(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::BinaryArray&>(values));
  } else {
    ...
    if (valid_bits != nullptr) {
      if (buffer_ == nullptr) {
        PARQUET_ASSIGN_OR_THROW(buffer_,
                                ::arrow20::AllocateResizableBuffer(num_values * sizeof(T),
                                                                 this->memory_pool()));
      } else {
...
template <typename DType>
void DeltaByteArrayEncoder<DType>::Put(const ::arrow20::Array& values) {
  if (::arrow20::is_binary_like(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::BinaryArray&>(values));
  } else if (::arrow20::is_large_binary_like(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::LargeBinaryArray&>(values));
  } else if (::arrow20::is_fixed_size_binary(values.type_id())) {
    PutBinaryArray(checked_cast<const ::arrow20::FixedSizeBinaryArray&>(values));
  } else {
    throw ParquetException("Only BaseBinaryArray and subclasses supported");
  }
}
...
class RleBooleanEncoder final : public EncoderImpl, virtual public BooleanEncoder {
 public:
  explicit RleBooleanEncoder(const ColumnDescriptor* descr, ::arrow20::MemoryPool* pool)
      : EncoderImpl(descr, Encoding::RLE, pool),
        buffered_append_values_(::arrow20::stl::allocator<T>(pool)) {}
  ...
  void Put(const ::arrow20::Array& values) override {
    ...
    const auto& boolean_array = checked_cast<const ::arrow20::BooleanArray&>(values);
    if (values.null_count() == 0) {
      ...
      PARQUET_THROW_NOT_OK(::arrow20::VisitArraySpanInline<::arrow20::BooleanType>(
          *boolean_array.data(),
          [&](bool value) {
...
std::shared_ptr<Buffer> RleBooleanEncoder::FlushValues() {
  ...
  ::arrow20::util::RleEncoder encoder(buffer->mutable_data() + kRleLengthInBytes,
  ...
  encoder.Flush();
  ::arrow20::util::SafeStore(buffer->mutable_data(),
                           ::arrow20::bit_util::ToLittleEndian(encoder.len()));
