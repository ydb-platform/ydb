...
struct EncodingTraits<BooleanType> {
  ...
  using ArrowType = ::arrow20::BooleanType;
  using Accumulator = ::arrow20::BooleanBuilder;
...
struct EncodingTraits<Int32Type> {
  ...
  using ArrowType = ::arrow20::Int32Type;
  using Accumulator = ::arrow20::NumericBuilder<::arrow20::Int32Type>;
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::Int32Type>;
};
...
struct EncodingTraits<Int64Type> {
  ...
  using ArrowType = ::arrow20::Int64Type;
  using Accumulator = ::arrow20::NumericBuilder<::arrow20::Int64Type>;
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::Int64Type>;
};
...
struct EncodingTraits<FloatType> {
  ...
  using ArrowType = ::arrow20::FloatType;
  using Accumulator = ::arrow20::NumericBuilder<::arrow20::FloatType>;
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::FloatType>;
};
...
struct EncodingTraits<DoubleType> {
  ...
  using ArrowType = ::arrow20::DoubleType;
  using Accumulator = ::arrow20::NumericBuilder<::arrow20::DoubleType>;
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::DoubleType>;
};
...
struct EncodingTraits<ByteArrayType> {
  ...
  using ArrowType = ::arrow20::BinaryType;
  /// \brief Internal helper class for decoding BYTE_ARRAY data where we can
  /// overflow the capacity of a single arrow20::BinaryArray
  struct Accumulator {
    std::unique_ptr<::arrow20::BinaryBuilder> builder;
    std::vector<std::shared_ptr<::arrow20::Array>> chunks;
  };
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::BinaryType>;
};
...
struct EncodingTraits<FLBAType> {
  ...
  using ArrowType = ::arrow20::FixedSizeBinaryType;
  using Accumulator = ::arrow20::FixedSizeBinaryBuilder;
  using DictAccumulator = ::arrow20::Dictionary32Builder<::arrow20::FixedSizeBinaryType>;
};
...
class Encoder {
 public:
  ...
  virtual void Put(const ::arrow20::Array& values) = 0;
...
class DictEncoder : virtual public TypedEncoder<DType> {
 public:
  ...
  /// supported
  virtual void PutIndices(const ::arrow20::Array& indices) = 0;
  ...
  virtual void PutDictionary(const ::arrow20::Array& values) = 0;
};
...
class DictDecoder : virtual public TypedDecoder<DType> {
 public:
  ...
  virtual void InsertDictionary(::arrow20::ArrayBuilder* builder) = 0;
  ...
  virtual int DecodeIndicesSpaced(int num_values, int null_count,
                                  ...
                                  ::arrow20::ArrayBuilder* builder) = 0;

  /// \brief Decode only dictionary indices (no nulls)
  ///
  /// \warning Remember to reset the builder each time the dict decoder is initialized
  /// with a new dictionary page
  virtual int DecodeIndices(int num_values, ::arrow20::ArrayBuilder* builder) = 0;
