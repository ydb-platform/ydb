...
class PARQUET_EXPORT AesEncryptor {
 public:
  ...
  int32_t Encrypt(::arrow20::util::span<const uint8_t> plaintext,
                  ::arrow20::util::span<const uint8_t> key,
                  ::arrow20::util::span<const uint8_t> aad,
                  ::arrow20::util::span<uint8_t> ciphertext);

  /// Encrypts plaintext footer, in order to compute footer signature (tag).
  int32_t SignedFooterEncrypt(::arrow20::util::span<const uint8_t> footer,
                              ::arrow20::util::span<const uint8_t> key,
                              ::arrow20::util::span<const uint8_t> aad,
                              ::arrow20::util::span<const uint8_t> nonce,
                              ::arrow20::util::span<uint8_t> encrypted_footer);
