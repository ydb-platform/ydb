...
#include "contrib/libs/apache/arrow_next/cpp/src/parquet/encryption/file_system_key_material_store.h"
...
#include "contrib/libs/apache/arrow_next/cpp/src/parquet/encryption/key_toolkit_internal.h"
...
class PARQUET_EXPORT FileKeyUnwrapper : public DecryptionKeyRetriever {
 ...
 private:
  ...
  std::shared_ptr<::arrow20::util::ConcurrentMap<std::string, std::string>> kek_per_kek_id_;
