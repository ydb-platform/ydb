...
#include "contrib/libs/apache/arrow_next/cpp/src/parquet/encryption/key_encryption_key.h"
#include "contrib/libs/apache/arrow_next/cpp/src/parquet/encryption/key_toolkit.h"
...
class PARQUET_EXPORT FileKeyWrapper {
 ...
 private:
  ...
  std::shared_ptr<::arrow20::util::ConcurrentMap<std::string, KeyEncryptionKey>>
