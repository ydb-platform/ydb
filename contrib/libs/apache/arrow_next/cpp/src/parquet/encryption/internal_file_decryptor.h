...
class PARQUET_EXPORT Decryptor {
 public:
  ...
  ::arrow20::MemoryPool* pool() { return pool_; }
  ...
  int32_t Decrypt(::arrow20::util::span<const uint8_t> ciphertext,
                  ::arrow20::util::span<uint8_t> plaintext);
...
class InternalFileDecryptor {
 public:
  ...
  ::arrow20::MemoryPool* pool() const { return pool_; }
