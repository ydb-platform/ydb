...
#include "contrib/libs/apache/arrow_next/cpp/src/parquet/encryption/two_level_cache_with_expiration.h"
...
class PARQUET_EXPORT KeyToolkit {
 ...
 private:
  ...
  mutable ::arrow20::util::Mutex last_cache_clean_for_key_rotation_time_mutex_;
