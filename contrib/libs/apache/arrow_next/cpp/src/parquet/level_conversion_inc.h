...
int64_t DefLevelsBatchToBitmap(const int16_t* def_levels, const int64_t batch_size,
                               ...
                               ::arrow20::internal::FirstTimeBitmapWriter* writer) {
  ...
  if (has_repeated_parent) {
    ...
    int64_t selected_count = ::arrow20::bit_util::PopCount(present_bitmap);
    ...
    return ::arrow20::bit_util::PopCount(selected_bits);
  } else {
    ...
    return ::arrow20::bit_util::PopCount(defined_bitmap);
  }
}
