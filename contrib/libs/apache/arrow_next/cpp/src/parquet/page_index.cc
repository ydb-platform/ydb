...
class RowGroupPageIndexReaderImpl : public RowGroupPageIndexReader {
 public:
  RowGroupPageIndexReaderImpl(::arrow20::io::RandomAccessFile* input,
 ...
 private:
  static void CheckReadRangeOrThrow(
      ...
      const std::optional<::arrow20::io::ReadRange>& index_read_range,
      int32_t row_group_ordinal) {
 ...
 private:
  ...
  ::arrow20::io::RandomAccessFile* input_;
  ...
  std::shared_ptr<::arrow20::Buffer> column_index_buffer_;
  std::shared_ptr<::arrow20::Buffer> offset_index_buffer_;
};

class PageIndexReaderImpl : public PageIndexReader {
 public:
  PageIndexReaderImpl(::arrow20::io::RandomAccessFile* input,
  ...
  void WillNeed(const std::vector<int32_t>& row_group_indices,
    ...
    std::vector<::arrow20::io::ReadRange> read_ranges;
...
class ColumnIndexBuilderImpl final : public ColumnIndexBuilder {
 public:
  ...
  void WriteTo(::arrow20::io::OutputStream* sink, Encryptor* encryptor) const override {
    if (state_ == BuilderState::kFinished) {
...
RowGroupIndexReadRange PageIndexReader::DeterminePageIndexRangesInRowGroup(
  ...
  auto merge_range = [](const std::optional<IndexLocation>& index_location,
    ...
    if (index_location.has_value()) {
      int64_t index_end = 0;
      if (index_location->offset < 0 || index_location->length <= 0 ||
          ::arrow20::internal::AddWithOverflow(index_location->offset,
...
std::unique_ptr<ColumnIndex> ColumnIndex::Make(const ColumnDescriptor& descr,
  ...
  ::arrow20::Unreachable("Cannot make ColumnIndex of an unknown type");
  return nullptr;
}
...
std::unique_ptr<ColumnIndexBuilder> ColumnIndexBuilder::Make(
  ...
  ::arrow20::Unreachable("Cannot make ColumnIndexBuilder of an unknown type");
  return nullptr;
}
