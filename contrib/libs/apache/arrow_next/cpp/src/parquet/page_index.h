...
struct RowGroupIndexReadRange {
  ...
  std::optional<::arrow20::io::ReadRange> column_index = std::nullopt;
  ...
  std::optional<::arrow20::io::ReadRange> offset_index = std::nullopt;
};
...
class PARQUET_EXPORT PageIndexReader {
 public:
  ...
  static std::shared_ptr<PageIndexReader> Make(
      ::arrow20::io::RandomAccessFile* input, std::shared_ptr<FileMetaData> file_metadata,
      const ReaderProperties& properties,
...
class PARQUET_EXPORT ColumnIndexBuilder {
 public:
  ...
  virtual void WriteTo(::arrow20::io::OutputStream* sink,
