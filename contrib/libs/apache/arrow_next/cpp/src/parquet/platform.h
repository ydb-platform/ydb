...
using Buffer = ::arrow20::Buffer;
using Codec = ::arrow20::util::Codec;
using CodecOptions = ::arrow20::util::CodecOptions;
using Compression = ::arrow20::Compression;
using MemoryPool = ::arrow20::MemoryPool;
using MutableBuffer = ::arrow20::MutableBuffer;
using ResizableBuffer = ::arrow20::ResizableBuffer;
using ResizableBuffer = ::arrow20::ResizableBuffer;
using ArrowInputFile = ::arrow20::io::RandomAccessFile;
using ArrowInputStream = ::arrow20::io::InputStream;
using ArrowOutputStream = ::arrow20::io::OutputStream;
...
PARQUET_EXPORT
std::shared_ptr<::arrow20::io::BufferOutputStream> CreateOutputStream(
    ::arrow20::MemoryPool* pool = ::arrow20::default_memory_pool());

PARQUET_EXPORT
std::shared_ptr<ResizableBuffer> AllocateBuffer(
    ::arrow20::MemoryPool* pool = ::arrow20::default_memory_pool(), int64_t size = 0);
