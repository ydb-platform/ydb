...
class PARQUET_EXPORT ReaderProperties {
 public:
  explicit ReaderProperties(MemoryPool* pool = ::arrow20::default_memory_pool())
      : pool_(pool) {}
...
class PARQUET_EXPORT ColumnProperties {
 public:
  ...
  int compression_level() const {
    if (!codec_options_) {
      return ::arrow20::util::kUseDefaultCompressionLevel;
    }
  ...
  class Builder {
   public:
    ...
    Builder* codec_options(
        const std::shared_ptr<::arrow20::util::CodecOptions>& codec_options) {
...
// Default number of rows to read when using ::arrow20::RecordBatchReader
...
class PARQUET_EXPORT ArrowReaderProperties {
 public:
  explicit ArrowReaderProperties(bool use_threads = kArrowDefaultUseThreads)
      : use_threads_(use_threads),
        ...
        pre_buffer_(true),
        cache_options_(::arrow20::io::CacheOptions::LazyDefaults()),
        coerce_int96_timestamp_unit_(::arrow20::TimeUnit::NANO),
  ...
  void set_cache_options(::arrow20::io::CacheOptions options) { cache_options_ = options; }
  /// Return the options for read coalescing.
  const ::arrow20::io::CacheOptions& cache_options() const { return cache_options_; }

  /// Set execution context for read coalescing.
  void set_io_context(const ::arrow20::io::IOContext& ctx) { io_context_ = ctx; }
  /// Return the execution context used for read coalescing.
  const ::arrow20::io::IOContext& io_context() const { return io_context_; }

  /// Set timestamp unit to use for deprecated INT96-encoded timestamps
  /// (default is NANO).
  void set_coerce_int96_timestamp_unit(::arrow20::TimeUnit::type unit) {
    coerce_int96_timestamp_unit_ = unit;
  }

  ::arrow20::TimeUnit::type coerce_int96_timestamp_unit() const {
  ...
  /// extension types at read time, if such exist. Currently only arrow20::extension::json()
  /// extension type is supported. Columns whose LogicalType is JSON will be interpreted
  /// as arrow20::extension::json(), with storage type inferred from the serialized Arrow
 ...
 private:
  ...
  int64_t batch_size_;
  bool pre_buffer_;
  ::arrow20::io::IOContext io_context_;
  ::arrow20::io::CacheOptions cache_options_;
  ::arrow20::TimeUnit::type coerce_int96_timestamp_unit_;
 ...
 public:
  ...
  class Builder {
   public:
    Builder()
        : write_timestamps_as_int96_(false),
          ...
          coerce_timestamps_unit_(::arrow20::TimeUnit::SECOND),
    ...
    Builder* coerce_timestamps(::arrow20::TimeUnit::type unit) {
    ...
    Builder* set_executor(::arrow20::internal::Executor* executor) {
      executor_ = executor;
      return this;
    }
   ...
   private:
    ...
    ::arrow20::TimeUnit::type coerce_timestamps_unit_;
  ...
  ::arrow20::TimeUnit::type coerce_timestamps_unit() const {
  ...
  ::arrow20::internal::Executor* executor() const;

 private:
  explicit ArrowWriterProperties(bool write_nanos_as_int96,
                                 bool coerce_timestamps_enabled,
                                 ::arrow20::TimeUnit::type coerce_timestamps_unit,
                                 ...
                                 ::arrow20::internal::Executor* executor)
  ...
  const ::arrow20::TimeUnit::type coerce_timestamps_unit_;
...
struct ArrowWriteContext {
  ...
  template <typename T>
  ::arrow20::Status GetScratchData(const int64_t num_values, T** out) {
