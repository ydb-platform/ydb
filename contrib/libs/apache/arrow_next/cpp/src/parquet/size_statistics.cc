...
void MergeLevelHistogram(::arrow20::util::span<int64_t> histogram,
                         ::arrow20::util::span<const int64_t> other) {
...
void UpdateLevelHistogram(::arrow20::util::span<const int16_t> levels,
                          ::arrow20::util::span<int64_t> histogram) {
