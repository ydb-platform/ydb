...
class LogicalType::Impl {
 public:
  virtual bool is_applicable(parquet20::Type::type primitive_type,
...
bool LogicalType::is_applicable(parquet20::Type::type primitive_type,
...
class LogicalType::Impl::SimpleApplicable : public virtual LogicalType::Impl::Applicable {
 public:
  bool is_applicable(parquet20::Type::type primitive_type,
                     int32_t primitive_length = -1) const override {
    return primitive_type == type_;
  }

 protected:
  explicit SimpleApplicable(parquet20::Type::type t) : type_(t) {}

 private:
  parquet20::Type::type type_;
};
...
class LogicalType::Impl::TypeLengthApplicable
 ...
 protected:
  TypeLengthApplicable(parquet20::Type::type t, int32_t l) : type_(t), length_(l) {}
 ...
 private:
  String()
      : LogicalType::Impl(LogicalType::Type::STRING, SortOrder::UNSIGNED),
        ...
        LogicalType::Impl::SimpleApplicable(parquet20::Type::BYTE_ARRAY) {}
};
...
bool LogicalType::Impl::Decimal::is_applicable(parquet20::Type::type primitive_type,
                                               int32_t primitive_length) const {
  bool ok = false;
 ...
 private:
  Date()
      : LogicalType::Impl(LogicalType::Type::DATE, SortOrder::SIGNED),
        ...
        LogicalType::Impl::SimpleApplicable(parquet20::Type::INT32) {}
};
...
bool LogicalType::Impl::Time::is_applicable(parquet20::Type::type primitive_type,
                                            int32_t primitive_length) const {
  return (primitive_type == parquet20::Type::INT32 &&
          unit_ == LogicalType::TimeUnit::MILLIS) ||
         (primitive_type == parquet20::Type::INT64 &&
 ...
 private:
  Timestamp(bool adjusted, LogicalType::TimeUnit::unit unit, bool is_from_converted_type,
      ...
      : LogicalType::Impl(LogicalType::Type::TIMESTAMP, SortOrder::SIGNED),
        LogicalType::Impl::SimpleApplicable(parquet20::Type::INT64),
        adjusted_(adjusted),
        unit_(unit),
 ...
 private:
  Interval()
      : LogicalType::Impl(LogicalType::Type::INTERVAL, SortOrder::UNKNOWN),
        ...
        LogicalType::Impl::TypeLengthApplicable(parquet20::Type::FIXED_LEN_BYTE_ARRAY, 12) {
  }
};
...
bool LogicalType::Impl::Int::is_applicable(parquet20::Type::type primitive_type,
                                           int32_t primitive_length) const {
  return (primitive_type == parquet20::Type::INT32 && width_ <= 32) ||
         (primitive_type == parquet20::Type::INT64 && width_ == 64);
}
 ...
 private:
  UUID()
      : LogicalType::Impl(LogicalType::Type::UUID, SortOrder::UNSIGNED),
        LogicalType::Impl::TypeLengthApplicable(parquet20::Type::FIXED_LEN_BYTE_ARRAY, 16) {
  }
};
 ...
 private:
  Float16()
      : LogicalType::Impl(LogicalType::Type::FLOAT16, SortOrder::SIGNED),
        LogicalType::Impl::TypeLengthApplicable(parquet20::Type::FIXED_LEN_BYTE_ARRAY, 2) {}
};
