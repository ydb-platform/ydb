...
namespace SQS
{
const size_t SQSEndpointRules::RulesBlobStrLen = 3679;
const size_t SQSEndpointRules::RulesBlobSize = 3680;

using RulesBlobT = Aws::Array<const char, SQSEndpointRules::RulesBlobSize>;
...
'/','/','s','q','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
const char* SQSEndpointRules::GetRulesBlob()
{
