...
1. Compile c-ares with both ASAN and fuzzing support.  We want an optimized
...
1. Build the fuzz test itself linked against our fuzzing-enabled build:
...
1. Run the fuzzer, its better if you can provide seed input but it does pretty
