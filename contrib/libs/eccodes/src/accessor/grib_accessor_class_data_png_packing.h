...
{
public:
    grib_accessor_data_png_packing_t() :
        grib_accessor_values_t() { class_name_ = "data_png_packing"; }
    grib_accessor* create_empty_accessor() override { return new grib_accessor_data_png_packing_t{}; }
