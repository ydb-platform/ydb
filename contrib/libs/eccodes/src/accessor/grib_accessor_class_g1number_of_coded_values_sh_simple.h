...
{
public:
    grib_accessor_g1number_of_coded_values_sh_simple_t() :
        grib_accessor_long_t() { class_name_ = "g1number_of_coded_values_sh_simple"; }
    grib_accessor* create_empty_accessor() override { return new grib_accessor_g1number_of_coded_values_sh_simple_t{}; }
