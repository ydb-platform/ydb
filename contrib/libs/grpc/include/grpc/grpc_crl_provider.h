...
class Crl {
 public:
  static y_absl::StatusOr<std::unique_ptr<Crl>> Parse(
      y_absl::string_view crl_string);
  virtual ~Crl() = default;
  virtual y_absl::string_view Issuer() = 0;
};
...
class CertificateInfo {
 public:
  ...
  virtual y_absl::string_view Issuer() const = 0;
};
