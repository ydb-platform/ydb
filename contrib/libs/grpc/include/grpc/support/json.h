...
class Json {
 public:
  ...
  static Json FromNumber(const TString& str) {
    Json json;
  ...
  static Json FromNumber(const char* str) {
    Json json;
    json.value_ = NumberValue{TString(str)};
    return json;
  }
  static Json FromNumber(TString&& str) {
    Json json;
  ...
  static Json FromNumber(int32_t value) {
    Json json;
    json.value_ = NumberValue{y_absl::StrCat(value)};
    return json;
  }
  ...
  static Json FromString(const TString& str) {
    Json json;
    json.value_ = str;
    return json;
  }
  static Json FromString(const char* str) {
    Json json;
    json.value_ = TString(str);
    return json;
  }
  static Json FromString(TString&& str) {
    Json json;
 ...
 private:
  ...
  using Value = y_absl::variant<y_absl::monostate,  // kNull
                              bool,             // kBoolean
                              NumberValue,      // kNumber
                              TString,      // kString
                              Object,           // kObject
