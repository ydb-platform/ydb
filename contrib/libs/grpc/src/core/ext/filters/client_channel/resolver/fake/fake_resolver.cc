...
class FakeResolver : public Resolver {
 ...
 private:
  ...
  y_absl::optional<Result> next_result_;
...
bool FakeResolverResponseGenerator::WaitForResolverSet(y_absl::Duration timeout) {
  MutexLock lock(&mu_);
  if (resolver_ == nullptr) {
    CondVar condition;
...
class FakeResolverFactory : public ResolverFactory {
 public:
  y_absl::string_view scheme() const override { return "fake"; }
