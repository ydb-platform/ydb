...
class XdsClusterAttribute
 ...
 public:
  ...
  explicit XdsClusterAttribute(y_absl::string_view cluster) : cluster_(cluster) {}

  y_absl::string_view cluster() const { return cluster_; }
  void set_cluster(y_absl::string_view cluster) { cluster_ = cluster; }

 private:
  UniqueTypeName type() const override { return TypeName(); }

  y_absl::string_view cluster_;
};
...
class XdsRouteStateAttribute
 ...
 public:
  ...
  virtual bool HasClusterForRoute(y_absl::string_view cluster_name) const = 0;
  UniqueTypeName type() const override { return TypeName(); }
};
}  // namespace grpc_core
