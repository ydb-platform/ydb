...
y_absl::string_view XdsHttpStatefulSessionFilter::ConfigProtoName() const {
  return "envoy.extensions.filters.http.stateful_session.v3.StatefulSession";
}

y_absl::string_view XdsHttpStatefulSessionFilter::OverrideConfigProtoName()
    const {
...
Json::Object ValidateStatefulSession(
  ...
  y_absl::string_view* serialized_session_state =
