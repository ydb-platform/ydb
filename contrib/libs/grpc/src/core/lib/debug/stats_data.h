...
struct GlobalStats {
  ...
  GlobalStats();
  static const y_absl::string_view counter_name[static_cast<int>(Counter::COUNT)];
  static const y_absl::string_view
      histogram_name[static_cast<int>(Histogram::COUNT)];
  static const y_absl::string_view counter_doc[static_cast<int>(Counter::COUNT)];
  static const y_absl::string_view
