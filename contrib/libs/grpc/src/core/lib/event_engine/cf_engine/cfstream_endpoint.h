...
class CFStreamEndpointImpl
 ...
 public:
  void Connect(y_absl::AnyInvocable<void(y_absl::Status)> on_connect,
               EventEngine::ResolvedAddress addr);
  bool CancelConnect(y_absl::Status status);

 private:
  void DoWrite(y_absl::AnyInvocable<void(y_absl::Status)> on_writable,
               SliceBuffer* data);
  void DoRead(y_absl::AnyInvocable<void(y_absl::Status)> on_read,
              SliceBuffer* buffer);
