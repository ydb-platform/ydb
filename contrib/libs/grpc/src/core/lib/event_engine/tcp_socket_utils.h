...
// not a wildcard ipv6 or ipv6 address. Otherwise returns y_absl::nullopt
y_absl::optional<int> ResolvedAddressIsWildcard(
...
// recognized.
y_absl::StatusOr<TString> ResolvedAddressToString(
    const EventEngine::ResolvedAddress& resolved_addr);
...
y_absl::StatusOr<TString> ResolvedAddressToURI(
...
y_absl::StatusOr<EventEngine::ResolvedAddress> URIToResolvedAddress(
    TString address_str);
