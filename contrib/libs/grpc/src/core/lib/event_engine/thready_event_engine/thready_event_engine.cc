...
void ThreadyEventEngine::Asynchronously(y_absl::AnyInvocable<void()> fn) {
...
ThreadyEventEngine::CreateListener(
  ...
  return impl_->CreateListener(
      ...
      [this,
       on_shutdown = std::move(on_shutdown)](y_absl::Status status) mutable {
...
EventEngine::ConnectionHandle ThreadyEventEngine::Connect(
  ...
  return impl_->Connect(
      [this, on_connect = std::move(on_connect)](
          y_absl::StatusOr<std::unique_ptr<Endpoint>> c) mutable {
        Asynchronously(
...
void ThreadyEventEngine::Run(y_absl::AnyInvocable<void()> closure) {
...
void ThreadyEventEngine::ThreadyDNSResolver::LookupHostname(
  ...
  return impl_->LookupHostname(
      [this, on_resolve = std::move(on_resolve)](
          y_absl::StatusOr<std::vector<ResolvedAddress>> addresses) mutable {
...
void ThreadyEventEngine::ThreadyDNSResolver::LookupSRV(
  ...
  return impl_->LookupSRV(
      [this, on_resolve = std::move(on_resolve)](
          y_absl::StatusOr<std::vector<SRVRecord>> records) mutable {
...
void ThreadyEventEngine::ThreadyDNSResolver::LookupTXT(
  ...
  return impl_->LookupTXT(
      [this, on_resolve = std::move(on_resolve)](
          y_absl::StatusOr<std::vector<TString>> record) mutable {
