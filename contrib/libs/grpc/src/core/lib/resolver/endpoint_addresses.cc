...
TString EndpointAddresses::ToString() const {
  std::vector<TString> addr_strings;
  ...
  std::vector<TString> parts = {
      y_absl::StrCat("addrs=[", y_absl::StrJoin(addr_strings, ", "), "]")};
...
TString EndpointAddressSet::ToString() const {
  std::vector<TString> parts;
