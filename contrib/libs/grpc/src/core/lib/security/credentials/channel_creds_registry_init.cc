...
class GoogleDefaultChannelCredsFactory : public ChannelCredsFactory<> {
 public:
  y_absl::string_view type() const override { return Type(); }
 ...
 private:
  ...
  static y_absl::string_view Type() { return "google_default"; }
};
 ...
 private:
  ...
  class TlsConfig : public ChannelCredsConfig {
   public:
    ...
    const TString& certificate_file() const { return certificate_file_; }
    const TString& private_key_file() const { return private_key_file_; }
    const TString& ca_certificate_file() const {
   ...
   private:
    ...
    TString certificate_file_;
    TString private_key_file_;
    TString ca_certificate_file_;
    Duration refresh_interval_ = kDefaultRefreshInterval;
  };

  static y_absl::string_view Type() { return "tls"; }
};
...
class InsecureChannelCredsFactory : public ChannelCredsFactory<> {
 ...
 private:
  ...
  static y_absl::string_view Type() { return "insecure"; }
};
...
class FakeChannelCredsFactory : public ChannelCredsFactory<> {
 ...
 private:
  ...
  static y_absl::string_view Type() { return "fake"; }
};
