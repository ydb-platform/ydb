...
class DirectoryReloaderCrlProvider
 ...
 public:
  DirectoryReloaderCrlProvider(
      std::chrono::seconds duration, std::function<void(y_absl::Status)> callback,
 ...
 private:
  ...
  y_absl::Status Update();
  Duration refresh_duration_;
  std::function<void(::y_absl::Status)> reload_error_callback_;
  std::shared_ptr<grpc_event_engine::experimental::EventEngine> event_engine_;
  std::shared_ptr<DirectoryReader> crl_directory_;
  // guards the crls_ map
  Mutex mu_;
  y_absl::flat_hash_map<::TString, ::std::shared_ptr<Crl>> crls_
