...
#if HAVE_WEBCODECS
#error #include "plugins/decoder_webcodecs.h"
#endif
...
#if HAVE_KVAZAAR
#error #include "plugins/encoder_kvazaar.h"
#endif

#if HAVE_UVG266
#error #include "plugins/encoder_uvg266.h"
#endif

#if HAVE_VVDEC
#error #include "plugins/decoder_vvdec.h"
#endif

#if HAVE_VVENC
#error #include "plugins/encoder_vvenc.h"
#endif
...
#if HAVE_RAV1E
#error #include "plugins/encoder_rav1e.h"
#endif

#if HAVE_DAV1D
#error #include "plugins/decoder_dav1d.h"
#endif

#if HAVE_SvtEnc
#error #include "plugins/encoder_svt.h"
#endif

#if HAVE_FFMPEG_DECODER
#error #include "plugins/decoder_ffmpeg.h"
#endif

#if WITH_UNCOMPRESSED_CODEC
#error #include "plugins/encoder_uncompressed.h"
#error #include "plugins/decoder_uncompressed.h"
#endif

#if HAVE_JPEG_DECODER
#error #include "plugins/decoder_jpeg.h"
#endif

#if HAVE_JPEG_ENCODER
#error #include "plugins/encoder_jpeg.h"
#endif

#if HAVE_X264
#error #include "plugins/encoder_x264.h"
#endif

#if HAVE_OpenH264_DECODER
#error #include "plugins/decoder_openh264.h"
#endif

#if HAVE_OPENJPEG_ENCODER
#error #include "plugins/encoder_openjpeg.h"
#endif

#if HAVE_OPENJPEG_DECODER
#error #include "plugins/decoder_openjpeg.h"
#endif

#include "plugins/encoder_mask.h"

#if HAVE_OPENJPH_ENCODER
#error #include "plugins/encoder_openjph.h"
#endif
