...
#define CONFIGURE_ARGS " '--prefix=/var/empty/postgresql-18.3' '--with-openssl' '--with-libxml' '--with-icu' '--sysconfdir=/etc' '--libdir=$(lib)/lib' '--with-system-tzdata=/var/empty/tzdata-2024a/share/zoneinfo' '--enable-debug' '--with-systemd' '--with-ossp-uuid' '--with-lz4' '--with-zstd' '--with-gssapi' '--with-pam' '--without-gssapi' '--build=x86_64-unknown-linux-gnu' 'build_alias=x86_64-unknown-linux-gnu' 'CC=gcc' 'CXX=g++' 'PKG_CONFIG=pkg-config' 'PKG_CONFIG_PATH=/var/empty/libxcrypt-4.4.36/lib/pkgconfig:/var/empty/zlib-1.3.1-dev/lib/pkgconfig:/var/empty/readline-8.2p10-dev/lib/pkgconfig:/var/empty/ncurses-6.4-dev/lib/pkgconfig:/var/empty/openssl-3.0.13-dev/lib/pkgconfig:/var/empty/libxml2-2.12.7-dev/lib/pkgconfig:/var/empty/icu4c-73.2-dev/lib/pkgconfig:/var/empty/lz4-1.9.4-dev/lib/pkgconfig:/var/empty/zstd-1.5.6-dev/lib/pkgconfig:/var/empty/systemd-255.6-dev/lib/pkgconfig:/var/empty/systemd-255.6-dev/share/pkgconfig:/var/empty/libkrb5-1.21.2-dev/lib/pkgconfig:/var/empty/linux-pam-1.6.1/lib/pkgconfig:/var/empty/libossp-uuid-1.6.2/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 18.3 on x86_64-unknown-linux-gnu, compiled by gcc (GCC) 13.2.0, 64-bit"
