...
#ifdef USE_RAWSPEED
#error #include <RawSpeed/StdAfx.h>
#error #include <RawSpeed/FileMap.h>
#error #include <RawSpeed/RawParser.h>
#error #include <RawSpeed/RawDecoder.h>
#error #include <RawSpeed/CameraMetaData.h>
#error #include <RawSpeed/ColorFilterArray.h>

#error #include "../../RawSpeed/rawspeed_xmldata.cpp"
