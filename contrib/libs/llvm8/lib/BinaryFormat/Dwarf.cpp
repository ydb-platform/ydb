...
const char llvm::dwarf::EnumTraits<Attribute>::Type[] = "AT";
const char llvm::dwarf::EnumTraits<Form>::Type[] = "FORM";
const char llvm::dwarf::EnumTraits<Index>::Type[] = "IDX";
const char llvm::dwarf::EnumTraits<Tag>::Type[] = "TAG";
