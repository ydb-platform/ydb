...
} cudnnReduceTensorOp_t CUDNN_DEPRECATED;
 ...
 *  convolution mode
 */
typedef enum { CUDNN_CONVOLUTION = 0, CUDNN_CROSS_CORRELATION = 1 } cudnnConvolutionMode_t CUDNN_DEPRECATED;
