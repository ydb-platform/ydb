...
DEFINE_ncclDevFunc(ReduceScatter_SumPostDiv_u8_COLLNET_DIRECT_SIMPLE, ncclFuncReduceScatter, FuncSumPostDiv, uint8_t, NCCL_ALGO_COLLNET_DIRECT, NCCL_PROTO_SIMPLE)
DEFINE_ncclDevFunc(ReduceScatter_SumPostDiv_u8_PAT_SIMPLE, ncclFuncReduceScatter, FuncSumPostDiv, uint8_t, NCCL_ALGO_PAT, NCCL_PROTO_SIMPLE)
