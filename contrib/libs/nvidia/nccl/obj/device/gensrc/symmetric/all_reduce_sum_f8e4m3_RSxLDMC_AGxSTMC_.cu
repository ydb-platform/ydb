...
#include "symmetric/all_reduce.cuh"
  ...
  __global__ void ncclSymDevKernel_AllReduce_RSxLDMC_AGxSTMC_sum_f8e4m3(ncclSymDevArgs NCCL_GRID_CONSTANT const args) {
      ...
      ncclSymRun_AllReduce_RSxLDMC_AGxSTMC<FuncSum, __nv_fp8_e4m3>(&args);
    #endif
  }
#endif
