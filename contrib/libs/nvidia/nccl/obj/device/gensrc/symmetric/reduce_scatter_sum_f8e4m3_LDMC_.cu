...
#include "symmetric/reduce_scatter.cuh"
  ...
  __global__ void ncclSymDevKernel_ReduceScatter_LDMC_sum_f8e4m3(ncclSymDevArgs NCCL_GRID_CONSTANT const args) {
      ...
      ncclSymRun_ReduceScatter_LDMC<FuncSum, __nv_fp8_e4m3>(&args);
    #endif
  }
#endif
