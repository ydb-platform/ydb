...
#define DATE "built on: Wed Oct 20 13:54:14 2021 UTC" 
...
static const char compiler_flags[] = {
    ...
    'e','t','=','p','o','w','e','r','p','c','6','4','l','e','-','l', 
    'i','n','u','x','-','g','n','u',' ','-','m','c','p','u','=','p', 
    'o','w','e','r','8',' ','-','m','t','u','n','e','=','p','o','w', 
    'e','r','8',' ','-','m','a','l','t','i','v','e','c',' ','-','-', 
    's','y','s','r','o','o','t','=','/','h','o','m','e','/','h','e', 
    'r','e','t','i','c','/','.','y','a','/','t','o','o','l','s','/', 
    'v','4','/','2','3','3','2','1','7','6','5','1',' ','-','f','P', 
