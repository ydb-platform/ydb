...
/**
  ...
  the same instrumentation (e.g. it is an ID generated by an external source that captured the
  crash). It MAY come from a source external to the instrumentation such that it can be used to look
  up additional data from other sources as well as facilitate deduplication.
 */
static constexpr const char *kAppCrashId = "app.crash.id";
