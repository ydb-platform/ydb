...
class PrefixMatcher {
 public:
  ...
  TString GlobalReplace(std::string_view w, std::string_view out) const;
...
class Normalizer {
 ...
 private:
  ...
  static TString EncodePrecompiledCharsMap(std::string_view trie_blob,
                                               std::string_view normalized);

  // Decodes blob into trie_blob and normalized string.
  static util::Status DecodePrecompiledCharsMap(std::string_view blob,
                                                std::string_view *trie_blob,
                                                std::string_view *normalized,
                                                TString *buffer = nullptr);
  ...
  TString precompiled_charsmap_buffer_;
#endif
