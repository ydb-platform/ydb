...
#define SVN_BINDIR "/nix/store/1d1l4qnn3gdaf9x5970dbxv9g8c4h24h-subversion-1.10.0/bin"

/* Defined to the config.guess name of the build system */
#define SVN_BUILD_HOST "x86_64-apple-darwin15.6.0"

/* Defined to the config.guess name of the build target */
#define SVN_BUILD_TARGET "x86_64-apple-darwin15.6.0"
...
#define SVN_LOCALE_DIR "/nix/store/1d1l4qnn3gdaf9x5970dbxv9g8c4h24h-subversion-1.10.0/share/locale"
