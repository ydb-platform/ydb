...
/**
 * Similar to svn_repos_authz_read3(), but optimized for working with single
 * user only (in tunnel mode, for an instance).
 */
svn_error_t *
svn_repos_authz_read3_single(svn_authz_t **authz_p,
                             const char *path,
                             const char *groups_path,
                             svn_boolean_t must_exist,
                             svn_repos_t *repos_hint,
