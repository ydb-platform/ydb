                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  SVN_ERR(authz_read(&authz->full, &authz->authz_id, path, groups_path,
                     must_exist, repos_hint, NULL, result_pool, scratch_pool));
                             ...
                             apr_pool_t *scratch_pool)
{
  ...
  SVN_ERR(authz_read(&authz->full, &authz->authz_id, path, groups_path,
                     must_exist, repos_hint, single_user,
                     result_pool, scratch_pool));
                      ...
                      svn_stream_t *groups_stream, apr_pool_t *pool)
{
  ...
  SVN_ERR(svn_authz__parse(&authz->full, stream, groups_stream, NULL,
                           pool, scratch_pool));
