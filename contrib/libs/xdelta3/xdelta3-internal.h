...
int xd3_whole_state_init (xd3_stream *stream);
void xd3_swap_whole_state (xd3_whole_state *a, xd3_whole_state *b);
int xd3_merge_input_output (xd3_stream *stream, xd3_whole_state *source);
int xd3_emit_run (xd3_stream *stream, usize_t pos, usize_t size, uint8_t *run_c);
