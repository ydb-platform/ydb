 ...
 */
export declare function datetime(value: unknown, format?: string): string;
...
export declare function get_value(type: PlaceholderType, name: string, data_source: ColumnarDataSource, index: Index | null, vars: Vars): unknown;
export declare function replace_placeholders_html(input: string, data_source: ColumnarDataSource, index: Index | null, formatters?: Formatters, special_vars?: Vars): Node[];
