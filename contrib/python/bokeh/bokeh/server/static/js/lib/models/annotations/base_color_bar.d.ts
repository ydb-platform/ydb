...
export declare namespace BaseColorBar {
    ...
    type Mixins = mixins.MajorLabelText & mixins.TitleText & mixins.MajorTickLine & mixins.MinorTickLine & mixins.BorderLine & mixins.BarLine & mixins.BackgroundFill & mixins.BackgroundHatch;
