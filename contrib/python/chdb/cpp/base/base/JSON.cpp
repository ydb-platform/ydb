...
CHDB_POCO_IMPLEMENT_EXCEPTION(JSONException, CHDBPoco::Exception, "JSONException") // NOLINT(cert-err60-cpp, modernize-use-noexcept, hicpp-use-noexcept)
            ...
            case '\\':
                ...
                switch (*s)
                {
                    ...
                    case 'u':
                    {
                        ...
                        try
                        {
                            unicode = CHDBPoco::NumberParser::parseHex(hex);
                        }
                        catch (const CHDBPoco::SyntaxException &)
                        {
