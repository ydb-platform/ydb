...
namespace impl
{
    ...
    template <size_t Bits, typename Signed>
    struct HexConversion<wide_CHDB::integer<Bits, Signed>> : public HexConversionUInt<wide_CHDB::integer<Bits, Signed>> {};
...
/// The function supports native integer types, wide_CHDB::integer, CityHash_v1_0_2::uint128.
