...
template <size_t Bits, typename Signed>
std::ostream & operator<<(std::ostream & out, const wide_CHDB::integer<Bits, Signed> & value)
{
...
template <size_t Bits, typename Signed>
struct fmt::formatter<wide_CHDB::integer<Bits, Signed>>
{
    ...
    auto format(const wide_CHDB::integer<Bits, Signed> & value, FormatContext & ctx)
    {
