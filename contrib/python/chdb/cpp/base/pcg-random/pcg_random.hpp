 ...
 * rather than:
 *
 *      pcg_detail_CHDB::engine<
 *          uint32_t,                                           // Output Type
 *          uint64_t,                                           // State Type
 *          pcg_detail_CHDB::xsh_rr_mixin<uint32_t, uint64_t>, true, // Output Func
 *          pcg_detail_CHDB::specific_stream<uint64_t>,              // Stream Kind
 *          pcg_detail_CHDB::default_multiplier<uint64_t>            // LCG Mult
 *      > myRNG;
 *
 */
...
namespace pcg_detail_CHDB {

using namespace pcg_extras_CHDB;
...
public:
    ...
    friend ::DB_CHDB::PcgSerializer;
    friend ::DB_CHDB::PcgDeserializer;
};
...
using namespace pcg_detail_CHDB;
...
using ext_std8 = pcg_detail_CHDB::extended<table_pow2, advance_pow2, BaseRNG,
                          oneseq_rxs_m_xs_8_8, kdd>;

template <bitcount_t table_pow2, bitcount_t advance_pow2,
          typename BaseRNG, bool kdd = true>
using ext_std16 = pcg_detail_CHDB::extended<table_pow2, advance_pow2, BaseRNG,
                           oneseq_rxs_m_xs_16_16, kdd>;

template <bitcount_t table_pow2, bitcount_t advance_pow2,
          typename BaseRNG, bool kdd = true>
using ext_std32 = pcg_detail_CHDB::extended<table_pow2, advance_pow2, BaseRNG,
                           oneseq_rxs_m_xs_32_32, kdd>;

template <bitcount_t table_pow2, bitcount_t advance_pow2,
          typename BaseRNG, bool kdd = true>
using ext_std64 = pcg_detail_CHDB::extended<table_pow2, advance_pow2, BaseRNG,
