...
#ifndef CHDB_Crypto_Cipher_INCLUDED
#define CHDB_Crypto_Cipher_INCLUDED
...
namespace Crypto
{
    ...
    class Crypto_API Cipher : public CHDBPoco::RefCountedObject
    ...
    ///     CHDBPoco::FileOutputStream sink("encrypted.dat");
    ///     CryptoOutputStream encryptor(sink, pCipher->createEncryptor());
    ///
    ///     CHDBPoco::FileInputStream source("source.txt");
    ///     CHDBPoco::StreamCopier::copyStream(source, encryptor);
    ///
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<Cipher> Ptr;
...
#endif // CHDB_Crypto_Cipher_INCLUDED
