...
#ifndef CHDB_Crypto_CipherKeyImpl_INCLUDED
#define CHDB_Crypto_CipherKeyImpl_INCLUDED
...
namespace Crypto
{
    ...
    public:
        ...
        typedef CHDBPoco::AutoPtr<CipherKeyImpl> Ptr;
    ...
    {
        CHDB_poco_assert(key.size() == static_cast<ByteVec::size_type>(keySize()));
        _key = key;
    }
...
#endif // CHDB_Crypto_CipherKeyImpl_INCLUDED
