...
#ifndef CHDB_Crypto_Crypto_INCLUDED
#define CHDB_Crypto_Crypto_INCLUDED


#define CHDB_POCO_EXTERNAL_OPENSSL_DEFAULT 1
#define CHDB_POCO_EXTERNAL_OPENSSL_SLPRO 2
...
#endif // CHDB_Crypto_Crypto_INCLUDED
