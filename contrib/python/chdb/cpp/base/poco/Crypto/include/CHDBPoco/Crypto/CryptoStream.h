...
#ifndef CHDB_Crypto_CryptoStream_INCLUDED
#define CHDB_Crypto_CryptoStream_INCLUDED
...
namespace Crypto
{
    ...
    class Crypto_API CryptoStreamBuf : public CHDBPoco::BufferedStreamBuf
    ...
    private:
        ...
        CHDBPoco::Buffer<unsigned char> _buffer;
...
#endif // CHDB_Crypto_CryptoStream_INCLUDED
