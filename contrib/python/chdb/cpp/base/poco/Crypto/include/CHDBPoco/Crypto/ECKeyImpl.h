...
#ifndef CHDB_Crypto_ECKeyImplImpl_INCLUDED
#define CHDB_Crypto_ECKeyImplImpl_INCLUDED
...
namespace Crypto
{
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<ECKeyImpl> Ptr;
...
#endif // CHDB_Crypto_ECKeyImplImpl_INCLUDED
