...
#ifndef CHDB_Crypto_RSADigestEngine_INCLUDED
#define CHDB_Crypto_RSADigestEngine_INCLUDED
...
namespace Crypto
{
    ...
    class Crypto_API RSADigestEngine : public CHDBPoco::DigestEngine
...
#endif // CHDB_Crypto_RSADigestEngine_INCLUDED
