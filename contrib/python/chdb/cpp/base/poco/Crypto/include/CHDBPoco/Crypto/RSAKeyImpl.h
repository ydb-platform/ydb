...
#ifndef CHDB_Crypto_RSAKeyImplImpl_INCLUDED
#define CHDB_Crypto_RSAKeyImplImpl_INCLUDED
...
namespace Crypto
{
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<RSAKeyImpl> Ptr;
...
#endif // CHDB_Crypto_RSAKeyImplImpl_INCLUDED
