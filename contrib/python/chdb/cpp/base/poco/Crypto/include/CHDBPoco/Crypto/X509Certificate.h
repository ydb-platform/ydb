...
#ifndef CHDB_Crypto_X509Certificate_INCLUDED
#define CHDB_Crypto_X509Certificate_INCLUDED
...
namespace Crypto
{
    ...
    public:
        ...
        CHDBPoco::DateTime validFrom() const;
        /// Returns the date and time the certificate is valid from.

        CHDBPoco::DateTime expiresOn() const;
...
#endif // CHDB_Crypto_X509Certificate_INCLUDED
