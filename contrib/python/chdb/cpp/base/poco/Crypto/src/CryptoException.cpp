...
CHDB_POCO_IMPLEMENT_EXCEPTION(CryptoException, Exception, "Crypto Exception")
...
OpenSSLException::OpenSSLException(const std::string& msg, const CHDBPoco::Exception& exc, int otherCode): CryptoException(msg, exc, otherCode)
{
	setExtMessage();
}
...
CHDBPoco::Exception* OpenSSLException::clone() const
{
...
{
	CHDBPoco::UInt64 e = static_cast<CHDBPoco::UInt64>(ERR_get_error());
	char buf[128] = { 0 };
