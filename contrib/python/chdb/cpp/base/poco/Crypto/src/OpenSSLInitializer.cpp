...
using CHDBPoco::RandomInputStream;
using CHDBPoco::Thread;
...
CHDBPoco::FastMutex* OpenSSLInitializer::_mutexes(0);
CHDBPoco::AtomicCounter OpenSSLInitializer::_rc;
...
void OpenSSLInitializer::initialize()
{
	if (++_rc == 1)
	{
		...
		_mutexes = new CHDBPoco::FastMutex[nMutexes];
...
unsigned long OpenSSLInitializer::id()
{
	...
	return (unsigned long) CHDBPoco::Thread::currentTid();
}
