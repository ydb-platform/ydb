...
#ifndef CHDB_Data_AbstractBinder_INCLUDED
#define CHDB_Data_AbstractBinder_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        virtual void bind(std::size_t pos, const CHDBPoco::Int8 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int8.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 list.

        virtual void bind(std::size_t pos, const CHDBPoco::UInt8 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt8.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 list.

        virtual void bind(std::size_t pos, const CHDBPoco::Int16 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int16.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 list.

        virtual void bind(std::size_t pos, const CHDBPoco::UInt16 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt16.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 list.

        virtual void bind(std::size_t pos, const CHDBPoco::Int32 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int32.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 list.

        virtual void bind(std::size_t pos, const CHDBPoco::UInt32 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt32.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 list.

        virtual void bind(std::size_t pos, const CHDBPoco::Int64 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int64.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 list.

        virtual void bind(std::size_t pos, const CHDBPoco::UInt64 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt64.

        virtual void bind(std::size_t pos, const std::vector<CHDBPoco::UInt64> & val, Direction dir = PD_IN);
        /// Binds an UInt64 vector.

        virtual void bind(std::size_t pos, const std::deque<CHDBPoco::UInt64> & val, Direction dir = PD_IN);
        /// Binds an UInt64 deque.

        virtual void bind(std::size_t pos, const std::list<CHDBPoco::UInt64> & val, Direction dir = PD_IN);
        ...
        void bind(std::size_t pos, const CHDBPoco::Dynamic::Var & val, Direction dir = PD_IN);
        /// Binds a Var.
...
#endif // CHDB_Data_AbstractBinder_INCLUDED
