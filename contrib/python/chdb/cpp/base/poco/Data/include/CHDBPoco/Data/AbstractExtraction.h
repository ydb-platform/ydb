...
#ifndef CHDB_Data_AbstractExtraction_INCLUDED
#define CHDB_Data_AbstractExtraction_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        AbstractExtraction(CHDBPoco::UInt32 limit = Limit::LIMIT_UNLIMITED, CHDBPoco::UInt32 position = 0, bool bulk = false);
        ...
        CHDBPoco::UInt32 position() const;
        ...
        void setLimit(CHDBPoco::UInt32 limit);
        /// Sets the limit.

        CHDBPoco::UInt32 getLimit() const;
        /// Gets the limit.
        ...
        bool isValueNull(const CHDBPoco::UTF16String & str, bool deflt);
    ...
    private:
        ...
        CHDBPoco::UInt32 _limit;
        CHDBPoco::UInt32 _position;
        bool _bulk;
    ...
    inline void AbstractExtraction::setLimit(CHDBPoco::UInt32 limit)
    {
        _limit = limit;
    }


    inline CHDBPoco::UInt32 AbstractExtraction::getLimit() const
    {
        return _limit;
    }
    ...
    inline CHDBPoco::UInt32 AbstractExtraction::position() const
    {
        return _position;
    }
    ...
    inline bool AbstractExtraction::isValueNull(const CHDBPoco::UTF16String & str, bool deflt)
    {
        return isStringNull(str, deflt);
    }
...
#endif // CHDB_Data_AbstractExtraction_INCLUDED
