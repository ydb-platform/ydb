...
#ifndef CHDB_Data_AbstractExtractor_INCLUDED
#define CHDB_Data_AbstractExtractor_INCLUDED
...
#include <string>
#include <vector>
#include "CHDBPoco/Data/Constants.h"
...
namespace Data
{
    ...
    public:
        ...
        virtual bool extract(std::size_t pos, CHDBPoco::Int8 & val) = 0;
        /// Extracts an Int8. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::Int8> & val);
        /// Extracts an Int8 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::Int8> & val);
        /// Extracts an Int8 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::Int8> & val);
        /// Extracts an Int8 list.

        virtual bool extract(std::size_t pos, CHDBPoco::UInt8 & val) = 0;
        /// Extracts an UInt8. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::UInt8> & val);
        /// Extracts an UInt8 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::UInt8> & val);
        /// Extracts an UInt8 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::UInt8> & val);
        /// Extracts an UInt8 list.

        virtual bool extract(std::size_t pos, CHDBPoco::Int16 & val) = 0;
        /// Extracts an Int16. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::Int16> & val);
        /// Extracts an Int16 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::Int16> & val);
        /// Extracts an Int16 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::Int16> & val);
        /// Extracts an Int16 list.

        virtual bool extract(std::size_t pos, CHDBPoco::UInt16 & val) = 0;
        /// Extracts an UInt16. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::UInt16> & val);
        /// Extracts an UInt16 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::UInt16> & val);
        /// Extracts an UInt16 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::UInt16> & val);
        /// Extracts an UInt16 list.

        virtual bool extract(std::size_t pos, CHDBPoco::Int32 & val) = 0;
        /// Extracts an Int32. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::Int32> & val);
        /// Extracts an Int32 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::Int32> & val);
        /// Extracts an Int32 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::Int32> & val);
        /// Extracts an Int32 list.

        virtual bool extract(std::size_t pos, CHDBPoco::UInt32 & val) = 0;
        /// Extracts an UInt32. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::UInt32> & val);
        /// Extracts an UInt32 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::UInt32> & val);
        /// Extracts an UInt32 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::UInt32> & val);
        /// Extracts an UInt32 list.

        virtual bool extract(std::size_t pos, CHDBPoco::Int64 & val) = 0;
        /// Extracts an Int64. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::Int64> & val);
        /// Extracts an Int64 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::Int64> & val);
        /// Extracts an Int64 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::Int64> & val);
        /// Extracts an Int64 list.

        virtual bool extract(std::size_t pos, CHDBPoco::UInt64 & val) = 0;
        /// Extracts an UInt64. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::UInt64> & val);
        /// Extracts an UInt64 vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::UInt64> & val);
        /// Extracts an UInt64 deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::UInt64> & val);
        ...
        virtual bool extract(std::size_t pos, CHDBPoco::Dynamic::Var & val) = 0;
        /// Extracts a Var. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<CHDBPoco::Dynamic::Var> & val);
        /// Extracts a Var vector.

        virtual bool extract(std::size_t pos, std::deque<CHDBPoco::Dynamic::Var> & val);
        /// Extracts a Var deque.

        virtual bool extract(std::size_t pos, std::list<CHDBPoco::Dynamic::Var> & val);
        /// Extracts a Var list.
...
#endif // CHDB_Data_AbstractExtractor_INCLUDED
