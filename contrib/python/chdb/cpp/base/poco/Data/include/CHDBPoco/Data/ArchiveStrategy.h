...
#ifndef CHDB_Data_ArchiveStrategy_INCLUDED
#define CHDB_Data_ArchiveStrategy_INCLUDED
...
namespace Data
{
    ...
    protected:
        typedef CHDBPoco::SharedPtr<Session> SessionPtr;
        typedef CHDBPoco::SharedPtr<Statement> StatementPtr;
    ...
    private:
        ...
        CHDBPoco::Dynamic::Var _archiveCount;
    };
...
#endif // CHDB_Data_ArchiveStrategy_INCLUDED
