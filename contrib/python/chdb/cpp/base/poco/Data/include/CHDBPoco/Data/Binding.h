...
#ifndef CHDB_Data_Binding_INCLUDED
#define CHDB_Data_Binding_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        {
            CHDB_poco_assert_dbg(!getBinder().isNull());
    ...
    namespace Keywords
    {
        ...
        /// Convenience function for a more compact Binding creation.
        {
            ...
            CHDB_poco_static_assert(!IsConst<T>::VALUE);
        ...
        /// This function differs from use() in its value copy semantics.
        {
            return CHDBPoco::Data::Keywords::bind(t, "");
        }
...
#endif // CHDB_Data_Binding_INCLUDED
