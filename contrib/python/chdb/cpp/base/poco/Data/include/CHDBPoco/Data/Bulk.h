...
#ifndef CHDB_Data_Bulk_INCLUDED
#define CHDB_Data_Bulk_INCLUDED


#include "CHDBPoco/Data/Limit.h"
#include "CHDBPoco/Void.h"
...
namespace Data
{
    ...
    inline CHDBPoco::UInt32 Bulk::size() const
    {
        return _limit.value();
    }
