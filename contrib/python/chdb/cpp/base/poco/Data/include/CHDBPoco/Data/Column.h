...
#ifndef CHDB_Data_Column_INCLUDED
#define CHDB_Data_Column_INCLUDED
...
namespace Data
{
    ...
    public:
        typedef C Container;
        typedef CHDBPoco::SharedPtr<C> ContainerPtr;
    ...
    public:
        ...
        typedef CHDBPoco::SharedPtr<Container> ContainerPtr;
...
#endif // CHDB_Data_Column_INCLUDED
