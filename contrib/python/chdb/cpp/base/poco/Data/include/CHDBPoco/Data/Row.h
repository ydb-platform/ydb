...
#ifndef CHDB_Data_Row_INCLUDED
#define CHDB_Data_Row_INCLUDED
...
#include "CHDBPoco/Data/RowFormatter.h"
...
namespace Data
{
    ...
    public:
        ...
        CHDBPoco::Dynamic::Var & get(std::size_t col);
        /// Returns the reference to data value at column location.

        CHDBPoco::Dynamic::Var & operator[](std::size_t col);
        /// Returns the reference to data value at column location.
    ...
    inline CHDBPoco::Dynamic::Var & Row::operator[](std::size_t col)
    {
        return get(col);
    }


    inline CHDBPoco::Dynamic::Var & Row::operator[](const std::string & name)
    {
