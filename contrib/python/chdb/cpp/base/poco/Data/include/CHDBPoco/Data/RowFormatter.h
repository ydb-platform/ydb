...
#ifndef CHDB_Data_RowFormatter_INCLUDED
#define CHDB_Data_RowFormatter_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        typedef std::vector<CHDBPoco::Dynamic::Var> ValueVec;
...
#endif // CHDB_Data_RowFormatter_INCLUDED
