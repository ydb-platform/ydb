...
#ifndef CHDB_Data_SQLChannel_INCLUDED
#define CHDB_Data_SQLChannel_INCLUDED
...
namespace Data
{
    ...
    class Data_API SQLChannel : public CHDBPoco::Channel
    ...
    private:
        ...
        typedef CHDBPoco::Message::Priority Priority;
        typedef CHDBPoco::SharedPtr<ArchiveStrategy> StrategyPtr;
...
#endif // CHDB_Data_SQLChannel_INCLUDED
