...
#ifndef CHDB_Data_Session_INCLUDED
#define CHDB_Data_Session_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        static const CHDBPoco::UInt32 TRANSACTION_READ_UNCOMMITTED = 0x00000001L;
        static const CHDBPoco::UInt32 TRANSACTION_READ_COMMITTED = 0x00000002L;
        static const CHDBPoco::UInt32 TRANSACTION_REPEATABLE_READ = 0x00000004L;
        static const CHDBPoco::UInt32 TRANSACTION_SERIALIZABLE = 0x00000008L;

        Session(CHDBPoco::AutoPtr<SessionImpl> ptrImpl);
        /// Creates the Session.
        ...
        bool hasTransactionIsolation(CHDBPoco::UInt32 ti);
        /// Returns true iff the transaction isolation level corresponding
        /// to the supplied bitmask is supported.

        bool isTransactionIsolation(CHDBPoco::UInt32 ti);
        ...
        CHDBPoco::Any getProperty(const std::string & name) const;
    ...
    inline void Session::setTransactionIsolation(CHDBPoco::UInt32 ti)
    {
        _pImpl->setTransactionIsolation(ti);
    }


    inline CHDBPoco::UInt32 Session::getTransactionIsolation()
    {
        return _pImpl->getTransactionIsolation();
    }


    inline bool Session::hasTransactionIsolation(CHDBPoco::UInt32 ti)
    {
        return _pImpl->hasTransactionIsolation(ti);
    }


    inline bool Session::isTransactionIsolation(CHDBPoco::UInt32 ti)
    {
    ...
    inline void Session::setProperty(const std::string & name, const CHDBPoco::Any & value)
    {
        _pImpl->setProperty(name, value);
    }


    inline CHDBPoco::Any Session::getProperty(const std::string & name) const
    {
...
{
template <>
inline void swap<CHDBPoco::Data::Session>(CHDBPoco::Data::Session & s1, CHDBPoco::Data::Session & s2)
...
#endif // CHDB_Data_Session_INCLUDED
