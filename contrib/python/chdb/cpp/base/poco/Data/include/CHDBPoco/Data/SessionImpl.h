...
#ifndef CHDB_Data_SessionImpl_INCLUDED
#define CHDB_Data_SessionImpl_INCLUDED
...
namespace Data
{
    ...
    class Data_API SessionImpl : public CHDBPoco::RefCountedObject
    ...
    public:
        ...
        virtual void setTransactionIsolation(CHDBPoco::UInt32) = 0;
        /// Sets the transaction isolation level.

        virtual CHDBPoco::UInt32 getTransactionIsolation() = 0;
        /// Returns the transaction isolation level.

        virtual bool hasTransactionIsolation(CHDBPoco::UInt32) = 0;
        /// Returns true iff the transaction isolation level corresponding
        /// to the supplied bitmask is supported.

        virtual bool isTransactionIsolation(CHDBPoco::UInt32) = 0;
        ...
        virtual void setProperty(const std::string & name, const CHDBPoco::Any & value) = 0;
        ...
        virtual CHDBPoco::Any getProperty(const std::string & name) = 0;
...
#endif // CHDB_Data_SessionImpl_INCLUDED
