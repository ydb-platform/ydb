...
#ifndef CHDB_Data_SessionPool_INCLUDED
#define CHDB_Data_SessionPool_INCLUDED
...
namespace Data
{
    ...
    protected:
        ...
        typedef CHDBPoco::AutoPtr<PooledSessionHolder> PooledSessionHolderPtr;
        typedef CHDBPoco::AutoPtr<PooledSessionImpl> PooledSessionImplPtr;
        typedef std::list<PooledSessionHolderPtr> SessionList;
        typedef CHDBPoco::HashMap<std::string, bool> FeatureMap;
        typedef CHDBPoco::HashMap<std::string, CHDBPoco::Any> PropertyMap;
        ...
        void onJanitorTimer(CHDBPoco::Timer &);

    private:
        typedef std::pair<std::string, CHDBPoco::Any> PropertyPair;
...
#endif // CHDB_Data_SessionPool_INCLUDED
