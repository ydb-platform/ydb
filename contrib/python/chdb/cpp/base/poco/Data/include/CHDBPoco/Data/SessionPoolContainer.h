...
#ifndef CHDB_Data_SessionPoolContainer_INCLUDED
#define CHDB_Data_SessionPoolContainer_INCLUDED
...
namespace Data
{
    ...
    private:
        typedef std::map<std::string, AutoPtr<SessionPool>, CHDBPoco::CILess> SessionPoolMap;
...
#endif // CHDB_Data_SessionPoolContainer_INCLUDED
