...
#ifndef CHDB_Data_Statement_INCLUDED
#define CHDB_Data_Statement_INCLUDED


#include <algorithm>
#include "CHDBPoco/ActiveMethod.h"
#include "CHDBPoco/ActiveResult.h"
#include "CHDBPoco/Data/Binding.h"
#include "CHDBPoco/Data/Bulk.h"
#include "CHDBPoco/Data/Data.h"
#include "CHDBPoco/Data/Range.h"
#include "CHDBPoco/Data/Row.h"
#include "CHDBPoco/Data/SimpleRowFormatter.h"
#include "CHDBPoco/Data/StatementImpl.h"
...
namespace Data
{
    ...
    public:
        ...
        Statement & operator,(CHDBPoco::UInt8 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::Int8 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::UInt16 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::Int16 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::UInt32 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::Int32 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
        ...
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
#endif
        Statement & operator,(CHDBPoco::UInt64 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(CHDBPoco::Int64 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
    ...
    inline Statement &Statement::operator,(CHDBPoco::UInt8 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::Int8 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::UInt16 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::Int16 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::UInt32 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::Int32 value)
    {
        return commaPODImpl(value);
    }
    ...
    inline Statement &Statement::operator,(CHDBPoco::UInt64 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(CHDBPoco::Int64 value)
    {
        return commaPODImpl(value);
    }
...
{
template <>
inline void swap<CHDBPoco::Data::Statement>(CHDBPoco::Data::Statement & s1, CHDBPoco::Data::Statement & s2)
...
#endif // CHDB_Data_Statement_INCLUDED
