...
#ifndef CHDB_Data_StatementImpl_INCLUDED
#define CHDB_Data_StatementImpl_INCLUDED
...
#include "CHDBPoco/Data/Column.h"
...
namespace Data
{
    ...
    {
    public:
        typedef CHDBPoco::SharedPtr<StatementImpl> Ptr;
    ...
    private:
        ...
        SharedPtr<InternalExtraction<C>> createExtract(const MetaColumn & mc)
        {
            ...
            return new InternalExtraction<C>(*pData, pCol, CHDBPoco::UInt32(currentDataSet()));
        }
        ...
        SharedPtr<InternalBulkExtraction<C>> createBulkExtract(const MetaColumn & mc)
        {
            ...
            return new InternalBulkExtraction<C>(
                *pData, pCol, static_cast<CHDBPoco::UInt32>(getExtractionLimit()), Position(static_cast<CHDBPoco::UInt32>(currentDataSet())));
        }
    ...
    {
        CHDB_poco_assert(_curDataSet < _extractors.size());
...
#endif // CHDB_Data_StatementImpl_INCLUDED
