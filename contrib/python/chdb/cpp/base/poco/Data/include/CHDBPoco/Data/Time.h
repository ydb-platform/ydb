...
#ifndef CHDB_Data_Time_INCLUDED
#define CHDB_Data_Time_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        Time & operator=(const CHDBPoco::Dynamic::Var & var);
...
namespace Dynamic
{
    ...
    template <>
    class VarHolderImpl<CHDBPoco::Data::Time> : public VarHolder
    {
    public:
        VarHolderImpl(const CHDBPoco::Data::Time & val) : _val(val) { }

        ~VarHolderImpl() { }

        const std::type_info & type() const { return typeid(CHDBPoco::Data::Time); }

        void convert(CHDBPoco::Timestamp & val) const
        {
            CHDBPoco::DateTime dt;
            dt.assign(dt.year(), dt.month(), dt.day(), _val.hour(), _val.minute(), _val.second());
            val = dt.timestamp();
        }

        void convert(CHDBPoco::DateTime & val) const
        {
            CHDBPoco::DateTime dt;
            dt.assign(dt.year(), dt.month(), dt.day(), _val.hour(), _val.minute(), _val.second());
            val = dt;
        ...
        void convert(CHDBPoco::LocalDateTime & val) const
        {
            CHDBPoco::LocalDateTime ldt;
        ...
        const CHDBPoco::Data::Time & value() const { return _val; }

    private:
        VarHolderImpl();
        CHDBPoco::Data::Time _val;
    };
