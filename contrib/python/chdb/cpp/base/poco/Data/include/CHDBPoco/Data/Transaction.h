...
#ifndef CHDB_Data_Transaction_INCLUDED
#define CHDB_Data_Transaction_INCLUDED
...
namespace Data
{
    ...
    {
    public:
        Transaction(CHDBPoco::Data::Session & session, CHDBPoco::Logger * pLogger = 0);
        /// Creates the Transaction and starts it, using the given database session and logger.

        Transaction(CHDBPoco::Data::Session & session, bool start);
        ...
        template <typename T>
        Transaction(CHDBPoco::Data::Session & rSession, T & t, CHDBPoco::Logger * pLogger = 0) : _rSession(rSession), _pLogger(pLogger)
        ...
        void setIsolation(CHDBPoco::UInt32 ti);
        /// Sets the transaction isolation level.

        CHDBPoco::UInt32 getIsolation();
        /// Returns the transaction isolation level.

        bool hasIsolation(CHDBPoco::UInt32 ti);
        /// Returns true iff the transaction isolation level corresponding
        /// to the supplied bitmask is supported.

        bool isIsolation(CHDBPoco::UInt32 ti);
        ...
        void setLogger(CHDBPoco::Logger * pLogger);
    ...
    inline void Transaction::setIsolation(CHDBPoco::UInt32 ti)
    {
        _rSession.setTransactionIsolation(ti);
    }


    inline CHDBPoco::UInt32 Transaction::getIsolation()
    {
        return _rSession.getTransactionIsolation();
    }


    inline bool Transaction::hasIsolation(CHDBPoco::UInt32 ti)
    {
        return _rSession.isTransactionIsolation(ti);
    }


    inline bool Transaction::isIsolation(CHDBPoco::UInt32 ti)
    {
        return _rSession.isTransactionIsolation(ti);
    }


    inline void Transaction::setLogger(CHDBPoco::Logger * pLogger)
    {
        _pLogger = pLogger;
    }
...
#endif // CHDB_Data_Transaction_INCLUDED
