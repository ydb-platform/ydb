...
#include "CHDBPoco/Data/Transaction.h"
...
Transaction::Transaction(CHDBPoco::Data::Session& rSession, CHDBPoco::Logger* pLogger):
	_rSession(rSession),
	_pLogger(pLogger)
{
	begin();
...
Transaction::Transaction(CHDBPoco::Data::Session& rSession, bool start):
	_rSession(rSession),
	_pLogger(0)
{
	if (start) begin();
