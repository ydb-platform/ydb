...
#ifndef CHDB_Foundation_AbstractFoundation_INCLUDED
#define CHDB_Foundation_AbstractFoundation_INCLUDED
...
///
///     #include "CHDBPoco/PriorityEvent.h"
///     #include "CHDBPoco/PriorityDelegate.h"
///
...
///     {
///     public:
///         CHDBPoco::BasicEvent<int> dataChanged;
///
///         MyData();
///         ...
///         void setData(int i);
...
public:
    ...
    /// to the caller.
    {
        CHDBPoco::ScopedLockWithUnlock<TMutex> lock(_mutex);
...
#endif // CHDB_Foundation_AbstractFoundation_INCLUDED
