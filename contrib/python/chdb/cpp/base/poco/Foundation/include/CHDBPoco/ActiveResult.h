...
#ifndef CHDB_Foundation_ActiveResult_INCLUDED
#define CHDB_Foundation_ActiveResult_INCLUDED
...
{
public:
    ActiveResultHolder() : _pData(0), _pExc(0), _event(false)
...
{
public:
    ActiveResultHolder() : _pExc(0), _event(false)
    /// Creates an ActiveResultHolder.
    {
    }
...
protected:
    ~ActiveResultHolder() { delete _pExc; }
...
public:
    ...
    void data(ResultType * pValue) { _pHolder->data(pValue); }
...
#endif // CHDB_Foundation_ActiveResult_INCLUDED
