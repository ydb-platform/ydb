...
#ifndef CHDB_Foundation_AlignOf_INCLUDED
#define CHDB_Foundation_AlignOf_INCLUDED
...
#    include <type_traits>
#    define CHDB_POCO_HAVE_ALIGNMENT
...
#                define CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(x) \
                    template <> \
...
#        ifdef CHDB_POCO_HAVE_ALIGNMENT
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(16);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(32);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(64);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(128);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(512);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1024);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2048);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4096);
CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8192);

#            undef CHDB_POCO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT
#        endif // CHDB_POCO_HAVE_ALIGNMENT


// CHDB_POCO_HAVE_ALIGNMENT will be defined on the pre-C++11 platforms/compilers where
...
// #undef CHDB_POCO_HAVE_ALIGNMENT
...
private:
    CHDBPoco::AlignedCharArrayImpl<AlignOf<AlignerImpl>::Alignment> _nonceMember;
};
...
#endif // CHDB_Foundation_AlignOf_INCLUDED
