...
#ifndef CHDB_Foundation_Any_INCLUDED
#define CHDB_Foundation_Any_INCLUDED
...
template <typename PlaceholderT, unsigned int SizeV = CHDB_POCO_SMALL_OBJECT_SIZE>
union Placeholder
/// ValueHolder union (used by CHDBPoco::Any and CHDBPoco::Dynamic::Var for small
/// object optimization, when enabled).
///
/// If Holder<Type> fits into CHDB_POCO_SMALL_OBJECT_SIZE bytes of storage,
...
/// larger - [CHDB_POCO_SMALL_OBJECT_SIZE + 1], additional byte value indicating
...
public:
    ...
    {
        char buf[CHDB_POCO_SMALL_OBJECT_SIZE] = {0};
        return 0 == std::memcmp(_valueHolder.holder, buf, CHDB_POCO_SMALL_OBJECT_SIZE);
    }
...
private:
    ...
    public:
        ...
        {
            if ((sizeof(Holder<ValueType>) <= CHDB_POCO_SMALL_OBJECT_SIZE))
            {
