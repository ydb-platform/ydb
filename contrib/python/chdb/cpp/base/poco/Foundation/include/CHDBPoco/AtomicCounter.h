...
#ifndef CHDB_Foundation_AtomicCounter_INCLUDED
#define CHDB_Foundation_AtomicCounter_INCLUDED


#include "CHDBPoco/Foundation.h"
#if CHDB_POCO_OS == CHDB_POCO_OS_WINDOWS_NT
#    error #include "CHDBPoco/UnWindows.h"
...
#            ifndef CHDB_POCO_HAVE_STD_ATOMICS
#                define CHDB_POCO_HAVE_STD_ATOMICS
#            endif
#        else
...
#    if !defined(CHDB_POCO_HAVE_GCC_ATOMICS) && !defined(POCO_NO_GCC_ATOMICS)
#        define CHDB_POCO_HAVE_GCC_ATOMICS
#    endif
...
#ifdef CHDB_POCO_HAVE_STD_ATOMICS
#    include <atomic>
#endif
...
#endif // CHDB_Foundation_AtomicCounter_INCLUDED
