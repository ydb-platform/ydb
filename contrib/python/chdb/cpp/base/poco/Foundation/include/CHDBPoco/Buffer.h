...
#ifndef CHDB_Foundation_Buffer_INCLUDED
#define CHDB_Foundation_Buffer_INCLUDED
...
public:
    ...
    {
        if (!_ownMem)
            throw CHDBPoco::InvalidAccessException("Cannot resize buffer which does not own its storage.");
...
#endif // CHDB_Foundation_Buffer_INCLUDED
