...
#ifndef CHDB_Foundation_ByteOrder_INCLUDED
#define CHDB_Foundation_ByteOrder_INCLUDED
...
#        define CHDB_POCO_HAVE_GCC_BYTESWAP 1
#    endif
#endif
...
#elif defined(CHDB_POCO_HAVE_GCC_BYTESWAP)
...
//
#define CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, type) \
    inline type ByteOrder::op(type value) \
    { \
        return value; \
    }
#define CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, type) \
    inline type ByteOrder::op(type value) \
    { \
...
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP(op) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, Int16) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, UInt16) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, Int32) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, UInt32) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, Int64) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP_(op, UInt64)
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP(op) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, Int16) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, UInt16) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, Int32) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, UInt32) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, Int64) \
        CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP_(op, UInt64)


#if defined(CHDB_POCO_ARCH_BIG_ENDIAN)
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_BIG CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_LIT CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP
#else
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_BIG CHDB_POCO_IMPLEMENT_BYTEORDER_FLIP
#    define CHDB_POCO_IMPLEMENT_BYTEORDER_LIT CHDB_POCO_IMPLEMENT_BYTEORDER_NOOP
#endif


CHDB_POCO_IMPLEMENT_BYTEORDER_BIG(toBigEndian)
CHDB_POCO_IMPLEMENT_BYTEORDER_BIG(fromBigEndian)
CHDB_POCO_IMPLEMENT_BYTEORDER_BIG(toNetwork)
CHDB_POCO_IMPLEMENT_BYTEORDER_BIG(fromNetwork)
CHDB_POCO_IMPLEMENT_BYTEORDER_LIT(toLittleEndian)
CHDB_POCO_IMPLEMENT_BYTEORDER_LIT(fromLittleEndian)


} // namespace CHDBPoco


#endif // CHDB_Foundation_ByteOrder_INCLUDED
