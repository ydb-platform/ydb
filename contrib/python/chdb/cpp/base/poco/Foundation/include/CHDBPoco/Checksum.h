...
#ifndef CHDB_Foundation_Checksum_INCLUDED
#define CHDB_Foundation_Checksum_INCLUDED
...
public:
    ...
    CHDBPoco::UInt32 checksum() const;
...
inline CHDBPoco::UInt32 Checksum::checksum() const
{
    return _value;
}
...
#endif // CHDB_Foundation_Checksum_INCLUDED
