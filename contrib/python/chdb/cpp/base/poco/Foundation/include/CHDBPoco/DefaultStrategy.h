...
#ifndef CHDB_Foundation_DefaultStrategy_INCLUDED
#define CHDB_Foundation_DefaultStrategy_INCLUDED


#include <vector>
#include "CHDBPoco/NotificationStrategy.h"
...
#endif // CHDB_Foundation_DefaultStrategy_INCLUDED
