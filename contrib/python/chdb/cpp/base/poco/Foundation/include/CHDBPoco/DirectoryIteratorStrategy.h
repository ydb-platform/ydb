...
#ifndef CHDB_Foundation_RecursiveDirectoryIteratorStrategy_INCLUDED
#define CHDB_Foundation_RecursiveDirectoryIteratorStrategy_INCLUDED
...
protected:
    bool isFiniteDepth();
    bool isDirectory(CHDBPoco::File & file);
...
#endif // CHDB_Foundation_RecursiveDirectoryIteratorStrategy_INCLUDED
