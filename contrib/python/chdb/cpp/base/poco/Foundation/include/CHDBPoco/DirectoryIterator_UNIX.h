...
#ifndef CHDB_Foundation_DirectoryIterator_UNIX_INCLUDED
#define CHDB_Foundation_DirectoryIterator_UNIX_INCLUDED
...
#endif // CHDB_Foundation_DirectoryIterator_UNIX_INCLUDED
