...
#ifndef CHDB_Foundation_Struct_INCLUDED
#define CHDB_Foundation_Struct_INCLUDED
...
namespace Dynamic
{
    ...
    public:
        ...
        typedef typename CHDBPoco::SharedPtr<Struct<K>> Ptr;
    ...
    public:
        ...
        void convert(CHDBPoco::DateTime &) const { throw BadCastException("Struct -> CHDBPoco::DateTime"); }

        void convert(CHDBPoco::LocalDateTime &) const { throw BadCastException("Struct -> CHDBPoco::LocalDateTime"); }

        void convert(CHDBPoco::Timestamp &) const { throw BadCastException("Struct -> CHDBPoco::Timestamp"); }
...
#endif // CHDB_Foundation_Struct_INCLUDED
