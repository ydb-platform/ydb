...
#ifndef CHDB_Foundation_Var_INCLUDED
#define CHDB_Foundation_Var_INCLUDED
...
namespace Dynamic
{
    ...
    public:
        ...
        typedef CHDBPoco::Dynamic::VarIterator Iterator;
    ...
    inline CHDBPoco::Int8 operator+(const CHDBPoco::Int8 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::Int8
    {
        return other + da.convert<CHDBPoco::Int8>();
    }


    inline CHDBPoco::Int8 operator-(const CHDBPoco::Int8 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::Int8
    {
        return other - da.convert<CHDBPoco::Int8>();
    }
    ...
    inline CHDBPoco::Int8 operator*(const CHDBPoco::Int8 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::Int8
    {
        return other * da.convert<CHDBPoco::Int8>();
    }
    ...
    inline CHDBPoco::Int8 operator/(const CHDBPoco::Int8 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::Int8
    {
        return other / da.convert<CHDBPoco::Int8>();
    }


    inline CHDBPoco::Int8 operator+=(CHDBPoco::Int8 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::Int8
    {
        return other += da.convert<CHDBPoco::Int8>();
    }
    ...
    inline CHDBPoco::Int8 operator-=(CHDBPoco::Int8 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::Int8
    {
        return other -= da.convert<CHDBPoco::Int8>();
    }
    ...
    inline CHDBPoco::Int8 operator*=(CHDBPoco::Int8 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::Int8
    {
        return other *= da.convert<CHDBPoco::Int8>();
    }
    ...
    inline CHDBPoco::Int8 operator/=(CHDBPoco::Int8 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::Int8
    {
        return other /= da.convert<CHDBPoco::Int8>();
    }


    inline bool operator==(const CHDBPoco::Int8 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::Int8>();
    ...
    inline bool operator!=(const CHDBPoco::Int8 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::Int8>();
    ...
    inline bool operator<(const CHDBPoco::Int8 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::Int8>();
    ...
    inline bool operator<=(const CHDBPoco::Int8 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::Int8>();
    ...
    inline bool operator>(const CHDBPoco::Int8 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::Int8>();
    ...
    inline bool operator>=(const CHDBPoco::Int8 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::Int8
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::Int8>();
    ...
    inline CHDBPoco::UInt8 operator+(const CHDBPoco::UInt8 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::UInt8
    {
        return other + da.convert<CHDBPoco::UInt8>();
    }


    inline CHDBPoco::UInt8 operator-(const CHDBPoco::UInt8 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::UInt8
    {
        return other - da.convert<CHDBPoco::UInt8>();
    }
    ...
    inline CHDBPoco::UInt8 operator*(const CHDBPoco::UInt8 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::UInt8
    {
        return other * da.convert<CHDBPoco::UInt8>();
    }
    ...
    inline CHDBPoco::UInt8 operator/(const CHDBPoco::UInt8 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::UInt8
    {
        return other / da.convert<CHDBPoco::UInt8>();
    }


    inline CHDBPoco::UInt8 operator+=(CHDBPoco::UInt8 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::UInt8
    {
        return other += da.convert<CHDBPoco::UInt8>();
    }
    ...
    inline CHDBPoco::UInt8 operator-=(CHDBPoco::UInt8 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::UInt8
    {
        return other -= da.convert<CHDBPoco::UInt8>();
    }
    ...
    inline CHDBPoco::UInt8 operator*=(CHDBPoco::UInt8 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::UInt8
    {
        return other *= da.convert<CHDBPoco::UInt8>();
    }
    ...
    inline CHDBPoco::UInt8 operator/=(CHDBPoco::UInt8 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::UInt8
    {
        return other /= da.convert<CHDBPoco::UInt8>();
    }


    inline bool operator==(const CHDBPoco::UInt8 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::UInt8>();
    ...
    inline bool operator!=(const CHDBPoco::UInt8 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::UInt8>();
    ...
    inline bool operator<(const CHDBPoco::UInt8 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::UInt8>();
    ...
    inline bool operator<=(const CHDBPoco::UInt8 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::UInt8>();
    ...
    inline bool operator>(const CHDBPoco::UInt8 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::UInt8>();
    ...
    inline bool operator>=(const CHDBPoco::UInt8 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::UInt8
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::UInt8>();
    ...
    inline CHDBPoco::Int16 operator+(const CHDBPoco::Int16 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::Int16
    {
        return other + da.convert<CHDBPoco::Int16>();
    }


    inline CHDBPoco::Int16 operator-(const CHDBPoco::Int16 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::Int16
    {
        return other - da.convert<CHDBPoco::Int16>();
    }
    ...
    inline CHDBPoco::Int16 operator*(const CHDBPoco::Int16 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::Int16
    {
        return other * da.convert<CHDBPoco::Int16>();
    }
    ...
    inline CHDBPoco::Int16 operator/(const CHDBPoco::Int16 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::Int16
    {
        return other / da.convert<CHDBPoco::Int16>();
    }


    inline CHDBPoco::Int16 operator+=(CHDBPoco::Int16 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::Int16
    {
        return other += da.convert<CHDBPoco::Int16>();
    }
    ...
    inline CHDBPoco::Int16 operator-=(CHDBPoco::Int16 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::Int16
    {
        return other -= da.convert<CHDBPoco::Int16>();
    }
    ...
    inline CHDBPoco::Int16 operator*=(CHDBPoco::Int16 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::Int16
    {
        return other *= da.convert<CHDBPoco::Int16>();
    }
    ...
    inline CHDBPoco::Int16 operator/=(CHDBPoco::Int16 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::Int16
    {
        return other /= da.convert<CHDBPoco::Int16>();
    }


    inline bool operator==(const CHDBPoco::Int16 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::Int16>();
    ...
    inline bool operator!=(const CHDBPoco::Int16 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::Int16>();
    ...
    inline bool operator<(const CHDBPoco::Int16 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::Int16>();
    ...
    inline bool operator<=(const CHDBPoco::Int16 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::Int16>();
    ...
    inline bool operator>(const CHDBPoco::Int16 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::Int16>();
    ...
    inline bool operator>=(const CHDBPoco::Int16 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::Int16
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::Int16>();
    ...
    inline CHDBPoco::UInt16 operator+(const CHDBPoco::UInt16 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::UInt16
    {
        return other + da.convert<CHDBPoco::UInt16>();
    }


    inline CHDBPoco::UInt16 operator-(const CHDBPoco::UInt16 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::UInt16
    {
        return other - da.convert<CHDBPoco::UInt16>();
    }
    ...
    inline CHDBPoco::UInt16 operator*(const CHDBPoco::UInt16 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::UInt16
    {
        return other * da.convert<CHDBPoco::UInt16>();
    }
    ...
    inline CHDBPoco::UInt16 operator/(const CHDBPoco::UInt16 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::UInt16
    {
        return other / da.convert<CHDBPoco::UInt16>();
    }


    inline CHDBPoco::UInt16 operator+=(CHDBPoco::UInt16 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::UInt16
    {
        return other += da.convert<CHDBPoco::UInt16>();
    }
    ...
    inline CHDBPoco::UInt16 operator-=(CHDBPoco::UInt16 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::UInt16
    {
        return other -= da.convert<CHDBPoco::UInt16>();
    }
    ...
    inline CHDBPoco::UInt16 operator*=(CHDBPoco::UInt16 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::UInt16
    {
        return other *= da.convert<CHDBPoco::UInt16>();
    }
    ...
    inline CHDBPoco::UInt16 operator/=(CHDBPoco::UInt16 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::UInt16
    {
        return other /= da.convert<CHDBPoco::UInt16>();
    }


    inline bool operator==(const CHDBPoco::UInt16 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::UInt16>();
    ...
    inline bool operator!=(const CHDBPoco::UInt16 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::UInt16>();
    ...
    inline bool operator<(const CHDBPoco::UInt16 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::UInt16>();
    ...
    inline bool operator<=(const CHDBPoco::UInt16 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::UInt16>();
    ...
    inline bool operator>(const CHDBPoco::UInt16 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::UInt16>();
    ...
    inline bool operator>=(const CHDBPoco::UInt16 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::UInt16
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::UInt16>();
    ...
    inline CHDBPoco::Int32 operator+(const CHDBPoco::Int32 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::Int32
    {
        return other + da.convert<CHDBPoco::Int32>();
    }


    inline CHDBPoco::Int32 operator-(const CHDBPoco::Int32 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::Int32
    {
        return other - da.convert<CHDBPoco::Int32>();
    }
    ...
    inline CHDBPoco::Int32 operator*(const CHDBPoco::Int32 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::Int32
    {
        return other * da.convert<CHDBPoco::Int32>();
    }
    ...
    inline CHDBPoco::Int32 operator/(const CHDBPoco::Int32 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::Int32
    {
        return other / da.convert<CHDBPoco::Int32>();
    }


    inline CHDBPoco::Int32 operator+=(CHDBPoco::Int32 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::Int32
    {
        return other += da.convert<CHDBPoco::Int32>();
    }
    ...
    inline CHDBPoco::Int32 operator-=(CHDBPoco::Int32 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::Int32
    {
        return other -= da.convert<CHDBPoco::Int32>();
    }
    ...
    inline CHDBPoco::Int32 operator*=(CHDBPoco::Int32 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::Int32
    {
        return other *= da.convert<CHDBPoco::Int32>();
    }
    ...
    inline CHDBPoco::Int32 operator/=(CHDBPoco::Int32 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::Int32
    {
        return other /= da.convert<CHDBPoco::Int32>();
    }


    inline bool operator==(const CHDBPoco::Int32 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::Int32>();
    ...
    inline bool operator!=(const CHDBPoco::Int32 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::Int32>();
    ...
    inline bool operator<(const CHDBPoco::Int32 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::Int32>();
    ...
    inline bool operator<=(const CHDBPoco::Int32 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::Int32>();
    ...
    inline bool operator>(const CHDBPoco::Int32 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::Int32>();
    ...
    inline bool operator>=(const CHDBPoco::Int32 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::Int32
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::Int32>();
    ...
    inline CHDBPoco::UInt32 operator+(const CHDBPoco::UInt32 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::UInt32
    {
        return other + da.convert<CHDBPoco::UInt32>();
    }


    inline CHDBPoco::UInt32 operator-(const CHDBPoco::UInt32 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::UInt32
    {
        return other - da.convert<CHDBPoco::UInt32>();
    }
    ...
    inline CHDBPoco::UInt32 operator*(const CHDBPoco::UInt32 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::UInt32
    {
        return other * da.convert<CHDBPoco::UInt32>();
    }
    ...
    inline CHDBPoco::UInt32 operator/(const CHDBPoco::UInt32 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::UInt32
    {
        return other / da.convert<CHDBPoco::UInt32>();
    }


    inline CHDBPoco::UInt32 operator+=(CHDBPoco::UInt32 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::UInt32
    {
        return other += da.convert<CHDBPoco::UInt32>();
    }
    ...
    inline CHDBPoco::UInt32 operator-=(CHDBPoco::UInt32 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::UInt32
    {
        return other -= da.convert<CHDBPoco::UInt32>();
    }
    ...
    inline CHDBPoco::UInt32 operator*=(CHDBPoco::UInt32 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::UInt32
    {
        return other *= da.convert<CHDBPoco::UInt32>();
    }
    ...
    inline CHDBPoco::UInt32 operator/=(CHDBPoco::UInt32 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::UInt32
    {
        return other /= da.convert<CHDBPoco::UInt32>();
    }


    inline bool operator==(const CHDBPoco::UInt32 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::UInt32>();
    ...
    inline bool operator!=(const CHDBPoco::UInt32 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::UInt32>();
    ...
    inline bool operator<(const CHDBPoco::UInt32 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::UInt32>();
    ...
    inline bool operator<=(const CHDBPoco::UInt32 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::UInt32>();
    ...
    inline bool operator>(const CHDBPoco::UInt32 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::UInt32>();
    ...
    inline bool operator>=(const CHDBPoco::UInt32 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::UInt32
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::UInt32>();
    ...
    inline CHDBPoco::Int64 operator+(const CHDBPoco::Int64 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::Int64
    {
        return other + da.convert<CHDBPoco::Int64>();
    }


    inline CHDBPoco::Int64 operator-(const CHDBPoco::Int64 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::Int64
    {
        return other - da.convert<CHDBPoco::Int64>();
    }
    ...
    inline CHDBPoco::Int64 operator*(const CHDBPoco::Int64 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::Int64
    {
        return other * da.convert<CHDBPoco::Int64>();
    }
    ...
    inline CHDBPoco::Int64 operator/(const CHDBPoco::Int64 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::Int64
    {
        return other / da.convert<CHDBPoco::Int64>();
    }


    inline CHDBPoco::Int64 operator+=(CHDBPoco::Int64 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::Int64
    {
        return other += da.convert<CHDBPoco::Int64>();
    }
    ...
    inline CHDBPoco::Int64 operator-=(CHDBPoco::Int64 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::Int64
    {
        return other -= da.convert<CHDBPoco::Int64>();
    }
    ...
    inline CHDBPoco::Int64 operator*=(CHDBPoco::Int64 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::Int64
    {
        return other *= da.convert<CHDBPoco::Int64>();
    }
    ...
    inline CHDBPoco::Int64 operator/=(CHDBPoco::Int64 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::Int64
    {
        return other /= da.convert<CHDBPoco::Int64>();
    }


    inline bool operator==(const CHDBPoco::Int64 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::Int64>();
    ...
    inline bool operator!=(const CHDBPoco::Int64 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::Int64>();
    ...
    inline bool operator<(const CHDBPoco::Int64 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::Int64>();
    ...
    inline bool operator<=(const CHDBPoco::Int64 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::Int64>();
    ...
    inline bool operator>(const CHDBPoco::Int64 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::Int64>();
    ...
    inline bool operator>=(const CHDBPoco::Int64 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::Int64
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::Int64>();
    ...
    inline CHDBPoco::UInt64 operator+(const CHDBPoco::UInt64 & other, const Var & da)
    /// Addition operator for adding Var to CHDBPoco::UInt64
    {
        return other + da.convert<CHDBPoco::UInt64>();
    }


    inline CHDBPoco::UInt64 operator-(const CHDBPoco::UInt64 & other, const Var & da)
    /// Subtraction operator for subtracting Var from CHDBPoco::UInt64
    {
        return other - da.convert<CHDBPoco::UInt64>();
    }
    ...
    inline CHDBPoco::UInt64 operator*(const CHDBPoco::UInt64 & other, const Var & da)
    /// Multiplication operator for multiplying Var with CHDBPoco::UInt64
    {
        return other * da.convert<CHDBPoco::UInt64>();
    }
    ...
    inline CHDBPoco::UInt64 operator/(const CHDBPoco::UInt64 & other, const Var & da)
    /// Division operator for dividing Var with CHDBPoco::UInt64
    {
        return other / da.convert<CHDBPoco::UInt64>();
    }


    inline CHDBPoco::UInt64 operator+=(CHDBPoco::UInt64 & other, const Var & da)
    /// Addition assignment operator for adding Var to CHDBPoco::UInt64
    {
        return other += da.convert<CHDBPoco::UInt64>();
    }
    ...
    inline CHDBPoco::UInt64 operator-=(CHDBPoco::UInt64 & other, const Var & da)
    /// Subtraction assignment operator for subtracting Var from CHDBPoco::UInt64
    {
        return other -= da.convert<CHDBPoco::UInt64>();
    }
    ...
    inline CHDBPoco::UInt64 operator*=(CHDBPoco::UInt64 & other, const Var & da)
    /// Multiplication assignment operator for multiplying Var with CHDBPoco::UInt64
    {
        return other *= da.convert<CHDBPoco::UInt64>();
    }
    ...
    inline CHDBPoco::UInt64 operator/=(CHDBPoco::UInt64 & other, const Var & da)
    /// Division assignment operator for dividing Var with CHDBPoco::UInt64
    {
        return other /= da.convert<CHDBPoco::UInt64>();
    }


    inline bool operator==(const CHDBPoco::UInt64 & other, const Var & da)
    /// Equality operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other == da.convert<CHDBPoco::UInt64>();
    ...
    inline bool operator!=(const CHDBPoco::UInt64 & other, const Var & da)
    /// Inequality operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return true;
        return other != da.convert<CHDBPoco::UInt64>();
    ...
    inline bool operator<(const CHDBPoco::UInt64 & other, const Var & da)
    /// Less than operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other < da.convert<CHDBPoco::UInt64>();
    ...
    inline bool operator<=(const CHDBPoco::UInt64 & other, const Var & da)
    /// Less than or equal operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other <= da.convert<CHDBPoco::UInt64>();
    ...
    inline bool operator>(const CHDBPoco::UInt64 & other, const Var & da)
    /// Greater than operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other > da.convert<CHDBPoco::UInt64>();
    ...
    inline bool operator>=(const CHDBPoco::UInt64 & other, const Var & da)
    /// Greater than or equal operator for comparing Var with CHDBPoco::UInt64
    {
        if (da.isEmpty())
            return false;
        return other >= da.convert<CHDBPoco::UInt64>();
...
#endif // CHDB_POCO_LONG_IS_64_BIT
...
#endif // CHDB_Foundation_Var_INCLUDED
