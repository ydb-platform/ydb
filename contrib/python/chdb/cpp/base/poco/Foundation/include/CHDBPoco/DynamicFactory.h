...
#ifndef CHDB_Foundation_DynamicFactory_INCLUDED
#define CHDB_Foundation_DynamicFactory_INCLUDED
...
public:
    ...
    /// and the instantiator is deleted.
    {
        CHDB_poco_check_ptr(pAbstractFactory);
...
#endif // CHDB_Foundation_DynamicFactory_INCLUDED
