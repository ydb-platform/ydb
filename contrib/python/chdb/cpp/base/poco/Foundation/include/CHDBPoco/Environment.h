...
#ifndef CHDB_Foundation_Environment_INCLUDED
#define CHDB_Foundation_Environment_INCLUDED
...
public:
    ...
    static CHDBPoco::UInt32 libraryVersion();
    ...
    static CHDBPoco::Int32 os();
    /// Return the operating system as defined
    /// in the include Foundation/Platform.h (CHDB_POCO_OS)

    static CHDBPoco::Int32 arch();
    /// Return the underlying cpu architecture that runs this operating system
    /// as defined in Foundation/Platform (CHDB_POCO_ARCH)
...
#endif // CHDB_Foundation_Environment_INCLUDED
