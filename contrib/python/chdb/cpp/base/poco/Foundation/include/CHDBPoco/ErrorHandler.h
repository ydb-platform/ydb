...
#ifndef CHDB_Foundation_ErrorHandler_INCLUDED
#define CHDB_Foundation_ErrorHandler_INCLUDED
...
public:
    ...
    /// Called when a CHDBPoco::Exception (or a subclass)
    ...
    /// CHDBPoco::Exception nor a std::exception caused
...
#endif // CHDB_Foundation_ErrorHandler_INCLUDED
