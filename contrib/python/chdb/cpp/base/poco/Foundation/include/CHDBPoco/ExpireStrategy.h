...
#ifndef CHDB_Foundation_ExpireStrategy_INCLUDED
#define CHDB_Foundation_ExpireStrategy_INCLUDED


#include <map>
#include <set>
#include "CHDBPoco/AbstractStrategy.h"
...
#endif // CHDB_Foundation_ExpireStrategy_INCLUDED
