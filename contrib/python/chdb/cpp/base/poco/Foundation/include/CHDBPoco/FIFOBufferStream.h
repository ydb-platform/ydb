...
#ifndef CHDB_Foundation_FIFOBufferStream_INCLUDED
#define CHDB_Foundation_FIFOBufferStream_INCLUDED


#include <istream>
#include <ostream>
#include "CHDBPoco/BufferedBidirectionalStreamBuf.h"
...
{
public:
    CHDBPoco::BasicEvent<bool> & readable;
    CHDBPoco::BasicEvent<bool> & writable;
...
#endif // CHDB_Foundation_FIFOBufferStream_INCLUDED
