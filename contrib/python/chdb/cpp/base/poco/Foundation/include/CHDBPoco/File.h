...
#ifndef CHDB_Foundation_File_INCLUDED
#define CHDB_Foundation_File_INCLUDED
...
///
/// On Windows, if compiled with UTF-8 support (CHDB_POCO_WIN32_UTF8)
...
#endif // CHDB_Foundation_File_INCLUDED
