...
#ifndef CHDB_Foundation_HMACEngine_INCLUDED
#define CHDB_Foundation_HMACEngine_INCLUDED
...
public:
    ...
    {
        CHDB_poco_check_ptr(passphrase);
...
#endif // CHDB_Foundation_HMACEngine_INCLUDED
