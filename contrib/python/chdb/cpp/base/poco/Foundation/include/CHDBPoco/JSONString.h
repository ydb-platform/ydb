...
#ifndef CHDB_Foundation_JSONString_INCLUDED
#define CHDB_Foundation_JSONString_INCLUDED
...
///
/// void CHDBPoco::toJSON(const std::string&, std::ostream&, int)
...
/// This function is deprecated, please use
///
/// std::string CHDBPoco::toJSON(const std::string&, int)
...
#endif // CHDB_Foundation_JSONString_INCLUDED
