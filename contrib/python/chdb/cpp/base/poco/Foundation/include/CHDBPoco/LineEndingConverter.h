...
#ifndef CHDB_Foundation_LineEndingConverter_INCLUDED
#define CHDB_Foundation_LineEndingConverter_INCLUDED
...
#endif // CHDB_Foundation_LineEndingConverter_INCLUDED
