...
#ifndef CHDB_Foundation_Logger_INCLUDED
#define CHDB_Foundation_Logger_INCLUDED
...
/// Variants of these macros that allow message formatting with CHDBPoco::format()
/// are also available. Up to four arguments are supported.
///
/// Examples:
///     CHDB_poco_warning(logger, "This is a warning");
///     CHDB_poco_information_f2(logger, "An informational message with args: %d, %d", 1, 2);
{
public:
...
// convenience macros
//
#define CHDB_poco_fatal(logger, msg) \
    if ((logger).fatal()) \
        (logger).fatal(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_fatal_f1(logger, fmt, arg1) \
    if ((logger).fatal()) \
        (logger).fatal(CHDBPoco::format((fmt), arg1), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_fatal_f2(logger, fmt, arg1, arg2) \
    if ((logger).fatal()) \
        (logger).fatal(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_fatal_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).fatal()) \
        (logger).fatal(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_fatal_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).fatal()) \
        (logger).fatal(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_critical(logger, msg) \
    if ((logger).critical()) \
        (logger).critical(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_critical_f1(logger, fmt, arg1) \
    if ((logger).critical()) \
        (logger).critical(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_critical_f2(logger, fmt, arg1, arg2) \
    if ((logger).critical()) \
        (logger).critical(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_critical_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).critical()) \
        (logger).critical(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_critical_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).critical()) \
        (logger).critical(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_error(logger, msg) \
    if ((logger).error()) \
        (logger).error(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_error_f1(logger, fmt, arg1) \
    if ((logger).error()) \
        (logger).error(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_error_f2(logger, fmt, arg1, arg2) \
    if ((logger).error()) \
        (logger).error(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_error_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).error()) \
        (logger).error(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_error_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).error()) \
        (logger).error(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_warning(logger, msg) \
    if ((logger).warning()) \
        (logger).warning(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_warning_f1(logger, fmt, arg1) \
    if ((logger).warning()) \
        (logger).warning(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_warning_f2(logger, fmt, arg1, arg2) \
    if ((logger).warning()) \
        (logger).warning(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_warning_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).warning()) \
        (logger).warning(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_warning_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).warning()) \
        (logger).warning(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_notice(logger, msg) \
    if ((logger).notice()) \
        (logger).notice(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_notice_f1(logger, fmt, arg1) \
    if ((logger).notice()) \
        (logger).notice(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_notice_f2(logger, fmt, arg1, arg2) \
    if ((logger).notice()) \
        (logger).notice(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_notice_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).notice()) \
        (logger).notice(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_notice_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).notice()) \
        (logger).notice(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_information(logger, msg) \
    if ((logger).information()) \
        (logger).information(msg, __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_information_f1(logger, fmt, arg1) \
    if ((logger).information()) \
        (logger).information(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_information_f2(logger, fmt, arg1, arg2) \
    if ((logger).information()) \
        (logger).information(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_information_f3(logger, fmt, arg1, arg2, arg3) \
    if ((logger).information()) \
        (logger).information(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
    else \
        (void)0

#define CHDB_poco_information_f4(logger, fmt, arg1, arg2, arg3, arg4) \
    if ((logger).information()) \
        (logger).information(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
    else \
        (void)0

#if defined(_DEBUG) || defined(CHDB_POCO_LOG_DEBUG)
#    define CHDB_poco_debug(logger, msg) \
        if ((logger).debug()) \
            (logger).debug(msg, __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_debug_f1(logger, fmt, arg1) \
        if ((logger).debug()) \
            (logger).debug(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_debug_f2(logger, fmt, arg1, arg2) \
        if ((logger).debug()) \
            (logger).debug(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_debug_f3(logger, fmt, arg1, arg2, arg3) \
        if ((logger).debug()) \
            (logger).debug(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_debug_f4(logger, fmt, arg1, arg2, arg3, arg4) \
        if ((logger).debug()) \
            (logger).debug(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_trace(logger, msg) \
        if ((logger).trace()) \
            (logger).trace(msg, __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_trace_f1(logger, fmt, arg1) \
        if ((logger).trace()) \
            (logger).trace(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_trace_f2(logger, fmt, arg1, arg2) \
        if ((logger).trace()) \
            (logger).trace(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_trace_f3(logger, fmt, arg1, arg2, arg3) \
        if ((logger).trace()) \
            (logger).trace(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_trace_f4(logger, fmt, arg1, arg2, arg3, arg4) \
        if ((logger).trace()) \
            (logger).trace(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_test(logger, msg) \
        if ((logger).test()) \
            (logger).test(msg, __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_test_f1(logger, fmt, arg1) \
        if ((logger).test()) \
            (logger).test(CHDBPoco::format((fmt), (arg1)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_test_f2(logger, fmt, arg1, arg2) \
        if ((logger).test()) \
            (logger).test(CHDBPoco::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_test_f3(logger, fmt, arg1, arg2, arg3) \
        if ((logger).test()) \
            (logger).test(CHDBPoco::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); \
        else \
            (void)0

#    define CHDB_poco_test_f4(logger, fmt, arg1, arg2, arg3, arg4) \
        if ((logger).test()) \
            (logger).test(CHDBPoco::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); \
        else \
            (void)0
#else
#    define CHDB_poco_debug(logger, msg)
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_FATAL);
}
...
inline void Logger::fatal(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_FATAL);
}
...
inline void Logger::fatal(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_FATAL);
}
...
inline void Logger::fatal(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_FATAL);
}
...
inline void Logger::fatal(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_FATAL);
}
...
inline void Logger::fatal(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_FATAL);
}
...
inline void Logger::critical(
    const std::string & fmt, const Any & value1, const Any & value2, const Any & value3, const Any & value4, const Any & value5)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_CRITICAL);
}
...
inline void Logger::critical(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_CRITICAL);
}
...
inline void Logger::critical(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_CRITICAL);
}
...
inline void Logger::critical(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_CRITICAL);
}
...
inline void Logger::critical(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_CRITICAL);
}
...
inline void Logger::critical(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_CRITICAL);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_ERROR);
}
...
inline void Logger::error(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_ERROR);
}
...
inline void Logger::error(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_ERROR);
}
...
inline void Logger::error(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_ERROR);
}
...
inline void Logger::error(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_ERROR);
}
...
inline void Logger::error(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_ERROR);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_WARNING);
}
...
inline void Logger::warning(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_WARNING);
}
...
inline void Logger::warning(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_WARNING);
}
...
inline void Logger::warning(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_WARNING);
}
...
inline void Logger::warning(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_WARNING);
}
...
inline void Logger::warning(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_WARNING);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_NOTICE);
}
...
inline void Logger::notice(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_NOTICE);
}
...
inline void Logger::notice(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_NOTICE);
}
...
inline void Logger::notice(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_NOTICE);
}
...
inline void Logger::notice(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_NOTICE);
}
...
inline void Logger::notice(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_NOTICE);
}
...
inline void Logger::information(
    const std::string & fmt, const Any & value1, const Any & value2, const Any & value3, const Any & value4, const Any & value5)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_INFORMATION);
}
...
inline void Logger::information(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_INFORMATION);
}
...
inline void Logger::information(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_INFORMATION);
}
...
inline void Logger::information(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_INFORMATION);
}
...
inline void Logger::information(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_INFORMATION);
}
...
inline void Logger::information(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_INFORMATION);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_DEBUG);
}
...
inline void Logger::debug(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_DEBUG);
}
...
inline void Logger::debug(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_DEBUG);
}
...
inline void Logger::debug(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_DEBUG);
}
...
inline void Logger::debug(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_DEBUG);
}
...
inline void Logger::debug(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_DEBUG);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_TRACE);
}
...
inline void Logger::trace(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_TRACE);
}
...
inline void Logger::trace(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_TRACE);
}
...
inline void Logger::trace(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_TRACE);
}
...
inline void Logger::trace(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_TRACE);
}
...
inline void Logger::trace(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_TRACE);
}
...
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_TEST);
}
...
inline void Logger::test(
    ...
    const Any & value6)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_TEST);
}
...
inline void Logger::test(
    ...
    const Any & value7)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_TEST);
}
...
inline void Logger::test(
    ...
    const Any & value8)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_TEST);
}
...
inline void Logger::test(
    ...
    const Any & value9)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_TEST);
}
...
inline void Logger::test(
    ...
    const Any & value10)
{
    log(CHDBPoco::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_TEST);
}
...
#endif // CHDB_Foundation_Logger_INCLUDED
