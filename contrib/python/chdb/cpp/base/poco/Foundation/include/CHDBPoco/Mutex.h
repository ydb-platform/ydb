...
#ifndef CHDB_Foundation_Mutex_INCLUDED
#define CHDB_Foundation_Mutex_INCLUDED
...
#    include "CHDBPoco/Mutex_POSIX.h"
...
{
public:
    typedef CHDBPoco::ScopedLock<Mutex> ScopedLock;
...
{
public:
    typedef CHDBPoco::ScopedLock<FastMutex> ScopedLock;
...
{
public:
    typedef CHDBPoco::ScopedLock<NullMutex> ScopedLock;
...
#endif // CHDB_Foundation_Mutex_INCLUDED
