...
#ifndef CHDB_Foundation_NamedMutex_INCLUDED
#define CHDB_Foundation_NamedMutex_INCLUDED


#include "CHDBPoco/Foundation.h"
#include "CHDBPoco/ScopedLock.h"


#if   CHDB_POCO_OS == CHDB_POCO_OS_ANDROID
#    error #include "CHDBPoco/NamedMutex_Android.h"
#elif defined(CHDB_POCO_OS_FAMILY_UNIX)
#    include "CHDBPoco/NamedMutex_UNIX.h"
#endif
...
{
public:
    typedef CHDBPoco::ScopedLock<NamedMutex> ScopedLock;
...
#endif // CHDB_Foundation_NamedMutex_INCLUDED
