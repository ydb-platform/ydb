...
#ifndef CHDB_Foundation_NestedDiagnosticContext_INCLUDED
#define CHDB_Foundation_NestedDiagnosticContext_INCLUDED
...
/// at the end.
/// The CHDB_poco_ndc(info) macro augments the information with a
...
// helper macros
//
#define CHDB_poco_ndc(func) CHDBPoco::NDCScope _theNdcScope(#func, __LINE__, __FILE__)


#if defined(_DEBUG)
#    define CHDB_poco_ndc_dbg(func) CHDBPoco::NDCScope _theNdcScope(#    func, __LINE__, __FILE__)
#else
#    define CHDB_poco_ndc_dbg(func)
#endif
...
#endif // CHDB_Foundation_NestedDiagnosticContext_INCLUDED
