...
#ifndef CHDB_Foundation_NumberFormatter_INCLUDED
#define CHDB_Foundation_NumberFormatter_INCLUDED
...
public:
    ...
    static const unsigned NF_MAX_FLT_STRING_LEN = CHDB_POCO_MAX_FLT_STRING_LEN;
...
#    ifdef CHDB_POCO_LONG_IS_64_BIT
...
#    else // ifndef CHDB_POCO_LONG_IS_64_BIT
...
#    endif // ifdef CHDB_POCO_LONG_IS_64_BIT
...
{
    char buffer[CHDB_POCO_MAX_FLT_STRING_LEN];
    floatToStr(buffer, CHDB_POCO_MAX_FLT_STRING_LEN, value);
...
{
    char buffer[CHDB_POCO_MAX_FLT_STRING_LEN];
    floatToFixedStr(buffer, CHDB_POCO_MAX_FLT_STRING_LEN, value, precision);
    return std::string(buffer);
}
...
{
    char buffer[CHDB_POCO_MAX_FLT_STRING_LEN];
    doubleToStr(buffer, CHDB_POCO_MAX_FLT_STRING_LEN, value);
    return std::string(buffer);
}
...
{
    char buffer[CHDB_POCO_MAX_FLT_STRING_LEN];
    doubleToFixedStr(buffer, CHDB_POCO_MAX_FLT_STRING_LEN, value, precision);
    return std::string(buffer);
}
...
#endif // CHDB_Foundation_NumberFormatter_INCLUDED
