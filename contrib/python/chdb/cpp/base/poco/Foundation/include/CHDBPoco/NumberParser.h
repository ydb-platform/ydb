...
#ifndef CHDB_Foundation_NumberParser_INCLUDED
#define CHDB_Foundation_NumberParser_INCLUDED
...
/// in the string. CHDBPoco::trim() or CHDBPoco::trimInPlace()
...
#endif // CHDB_Foundation_NumberParser_INCLUDED
