...
#ifndef CHDB_Foundation_NumericString_INCLUDED
#define CHDB_Foundation_NumericString_INCLUDED
...
#define CHDB_POCO_MAX_INT_STRING_LEN 65
// value from strtod.cc (double_conversion::kMaxSignificantDecimalDigits)
#define CHDB_POCO_MAX_FLT_STRING_LEN 780

#define CHDB_POCO_FLT_INF "inf"
#define CHDB_POCO_FLT_NAN "nan"
#define CHDB_POCO_FLT_EXP 'e'
...
/// Formatted string has at least [width] total length.
{
    ...
    size = ptr - result;
    CHDB_poco_assert_dbg(size <= ptr.span());
    CHDB_poco_assert_dbg((-1 == width) || (size >= std::size_t(width)));
    *ptr-- = '\0';
...
{
    char res[CHDB_POCO_MAX_INT_STRING_LEN] = {0};
    std::size_t size = CHDB_POCO_MAX_INT_STRING_LEN;
...
#endif // CHDB_Foundation_NumericString_INCLUDED
