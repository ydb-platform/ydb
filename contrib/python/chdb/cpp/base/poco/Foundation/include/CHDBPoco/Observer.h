...
#ifndef CHDB_Foundation_Observer_INCLUDED
#define CHDB_Foundation_Observer_INCLUDED


#include "CHDBPoco/AbstractObserver.h"
...
public:
    ...
    {
        CHDBPoco::Mutex::ScopedLock lock(_mutex);
...
#endif // CHDB_Foundation_Observer_INCLUDED
