...
#ifndef CHDB_Foundation_Path_INCLUDED
#define CHDB_Foundation_Path_INCLUDED
...
public:
    ...
    /// (CHDB_POCO_WIN32_UTF8), this function converts a string (usually containing a path)
...
#endif // CHDB_Foundation_Path_INCLUDED
