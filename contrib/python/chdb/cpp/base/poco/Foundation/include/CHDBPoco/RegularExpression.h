...
#ifndef CHDB_Foundation_RegularExpression_INCLUDED
#define CHDB_Foundation_RegularExpression_INCLUDED
...
protected:
    ...
    substOne(std::string & subject, std::string::size_type offset, const std::string & replacement, int options) const;
...
#endif // CHDB_Foundation_RegularExpression_INCLUDED
