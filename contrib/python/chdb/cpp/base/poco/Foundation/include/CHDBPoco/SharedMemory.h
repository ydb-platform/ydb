...
#ifndef CHDB_Foundation_SharedMemory_INCLUDED
#define CHDB_Foundation_SharedMemory_INCLUDED
...
} // namespace CHDBPoco::Poco


#endif // CHDB_Foundation_SharedMemory_INCLUDED
