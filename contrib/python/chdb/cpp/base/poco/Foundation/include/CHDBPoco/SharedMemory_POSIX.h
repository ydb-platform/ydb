...
#ifndef CHDB_Foundation_SharedMemoryImpl_INCLUDED
#define CHDB_Foundation_SharedMemoryImpl_INCLUDED


#include "CHDBPoco/Foundation.h"
#include "CHDBPoco/RefCountedObject.h"
#include "CHDBPoco/SharedMemory.h"
...
public:
    ...
    SharedMemoryImpl(const CHDBPoco::File & file, SharedMemory::AccessMode mode, const void * addrHint);
...
#endif // CHDB_Foundation_SharedMemoryImpl_INCLUDED
