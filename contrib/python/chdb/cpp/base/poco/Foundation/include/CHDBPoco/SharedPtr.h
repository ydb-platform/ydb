...
#ifndef CHDB_Foundation_SharedPtr_INCLUDED
#define CHDB_Foundation_SharedPtr_INCLUDED
...
private:
    ...
    void release()
    {
        CHDB_poco_assert_dbg(_pCounter);
...
#endif // CHDB_Foundation_SharedPtr_INCLUDED
