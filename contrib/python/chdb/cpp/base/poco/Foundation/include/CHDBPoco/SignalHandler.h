...
#ifndef CHDB_Foundation_SignalHandler_INCLUDED
#define CHDB_Foundation_SignalHandler_INCLUDED
...
/// from the stack.
///
/// The CHDB_poco_throw_on_signal macro creates an instance of SignalHandler
...
///     try
///     {
///          CHDB_poco_throw_on_signal;
///          ...
///     }
///     catch (CHDBPoco::SignalException&)
///     {
///         ...
///     }
///
...
#        define CHDB_poco_throw_on_signal \
            CHDBPoco::SignalHandler _poco_signalHandler; \
...
#endif // CHDB_POCO_OS_FAMILY_UNIX


#endif // CHDB_Foundation_SignalHandler_INCLUDED
