...
#ifndef CHDB_Foundation_StreamUtil_INCLUDED
#define CHDB_Foundation_StreamUtil_INCLUDED
...
// the CHDB_poco_ios_init macro defined below.
//
...
#if defined(POCO_IOS_INIT_HACK)
#    define CHDB_poco_ios_init(buf)
#else
#    define CHDB_poco_ios_init(buf) do {                         \
    init(buf);                                              \
...
#endif // CHDB_Foundation_StreamUtil_INCLUDED
