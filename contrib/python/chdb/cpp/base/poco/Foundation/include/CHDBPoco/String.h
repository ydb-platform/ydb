...
#ifndef CHDB_Foundation_String_INCLUDED
#define CHDB_Foundation_String_INCLUDED
...
{
    CHDB_poco_check_ptr(from);
    CHDB_poco_check_ptr(to);
...
#endif // CHDB_Foundation_String_INCLUDED
