...
#ifndef CHDB_Foundation_Thread_POSIX_INCLUDED
#define CHDB_Foundation_Thread_POSIX_INCLUDED
...
#include <limits.h>
#if !defined(CHDB_POCO_NO_SYS_SELECT_H)
...
private:
    ...
    struct ThreadData : public RefCountedObject
    {
        ThreadData()
            ...
            , policy(SCHED_OTHER)
            , done(false)
            , stackSize(CHDB_POCO_THREAD_STACK_SIZE)
            , started(false)
            , joined(false)
        {
        }
...
#endif // CHDB_Foundation_Thread_POSIX_INCLUDED
