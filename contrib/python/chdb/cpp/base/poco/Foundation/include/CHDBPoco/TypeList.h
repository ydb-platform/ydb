...
#ifndef CHDB_Foundation_TypeList_INCLUDED
#define CHDB_Foundation_TypeList_INCLUDED


#include "CHDBPoco/Foundation.h"
#include "CHDBPoco/MetaProgramming.h"
...
/// Compile Time List of Types
{
    ...
    bool operator==(const TypeList & tl) const { return tl.head == head && tl.tail == tail; }

    bool operator!=(const TypeList & tl) const { return !(*this == tl); }
...
#endif // CHDB_Foundation_TypeList_INCLUDED
