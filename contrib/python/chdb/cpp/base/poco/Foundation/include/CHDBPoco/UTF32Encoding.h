...
#ifndef CHDB_Foundation_UTF32Encoding_INCLUDED
#define CHDB_Foundation_UTF32Encoding_INCLUDED
...
protected:
	static int safeToInt(CHDBPoco::UInt32 value)
	{
		if (value <= 0x10FFFF)
...
#endif // CHDB_Foundation_UTF32Encoding_INCLUDED
