...
#ifndef CHDB_Foundation_UTFString_INCLUDED
#define CHDB_Foundation_UTFString_INCLUDED
...
struct UTF16CharTraits
{
    ...
    {
        CHDB_poco_assert(s2 < s1 || s2 >= s1 + n);
        char_type * r = s1;
        for (; n; --n, ++s1, ++s2)
            assign(*s1, *s2);
        return r;
...
//#if defined(CHDB_POCO_ENABLE_CPP11) //TODO
//	typedef char16_t       UTF16Char;
//	typedef std::u16string UTF16String;
//	typedef char32_t       UTF32Char;
//	typedef std::u32string UTF32String;
//#else
#ifdef CHDB_POCO_NO_WSTRING
typedef CHDBPoco::UInt16 UTF16Char;
...
typedef wchar_t UTF32Char;
typedef std::wstring UTF32String;
#    endif //CHDB_POCO_OS_FAMILY_WINDOWS
#endif //CHDB_POCO_NO_WSTRING
...
#endif // CHDB_Foundation_UTFString_INCLUDED
