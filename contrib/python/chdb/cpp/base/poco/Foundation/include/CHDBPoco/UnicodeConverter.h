...
#ifndef CHDB_Foundation_UnicodeConverter_INCLUDED
#define CHDB_Foundation_UnicodeConverter_INCLUDED
...
public:
    ...
    {
        T utfStr;
        CHDBPoco::UnicodeConverter::convert(pChar, utfStr);
        return utfStr;
    }
    ...
    {
        T utfStr;
        CHDBPoco::UnicodeConverter::convert(str, utfStr);
        return utfStr;
    }
...
#endif // CHDB_Foundation_UnicodeConverter_INCLUDED
