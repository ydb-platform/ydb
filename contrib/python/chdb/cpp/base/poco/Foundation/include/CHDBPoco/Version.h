...
#ifndef CHDB_Foundation_Version_INCLUDED
#define CHDB_Foundation_Version_INCLUDED
...
//      Bx: beta releases
//
#define CHDB_POCO_VERSION 0x01090300

#define CHDB_POCO_CLICKHOUSE_PATCH 1

#endif // CHDB_Foundation_Version_INCLUDED
