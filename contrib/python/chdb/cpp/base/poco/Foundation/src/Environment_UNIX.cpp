...
#include "CHDBPoco/Environment_UNIX.h"
...
#elif defined(CHDB_POCO_OS_FAMILY_BSD)
	unsigned count;
...
// nodeIdImpl
//
#if defined(CHDB_POCO_OS_FAMILY_BSD) || CHDB_POCO_OS == CHDB_POCO_OS_QNX
//
// BSD variants
//
#include <ifaddrs.h>
...
#elif defined(__CYGWIN__) || CHDB_POCO_OS == CHDB_POCO_OS_LINUX || CHDB_POCO_OS == CHDB_POCO_OS_ANDROID
//
// Linux, Cygwin
//
#include <sys/ioctl.h>
