...
#include "CHDBPoco/Event_POSIX.h"
#include <time.h>
#include <sys/time.h>
...
//
#ifndef CHDB_POCO_HAVE_MONOTONIC_PTHREAD_COND_TIMEDWAIT
		...
		#define CHDB_POCO_HAVE_MONOTONIC_PTHREAD_COND_TIMEDWAIT 1
	#endif
#endif


#ifndef CHDB_POCO_HAVE_CLOCK_GETTIME
			...
			#define CHDB_POCO_HAVE_CLOCK_GETTIME
		#endif
	#endif
#endif
...
#if defined(CHDB_POCO_HAVE_MONOTONIC_PTHREAD_COND_TIMEDWAIT)
...
#elif defined(CHDB_POCO_HAVE_CLOCK_GETTIME)
