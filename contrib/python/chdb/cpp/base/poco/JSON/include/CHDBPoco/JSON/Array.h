...
#ifndef CHDB_JSON_Array_INCLUDED
#define CHDB_JSON_Array_INCLUDED
...
namespace JSON
{
    ...
    /// convert Array to CHDBPoco::Dynamic::Array. Conversion requires copying and therefore
    /// has performance penalty; the benefit is in improved syntax, eg:
    ///
    ///    // use pointers to avoid copying
    ///    using namespace CHDBPoco::JSON;
    ...
    ///
    ///    // copy/convert to CHDBPoco::Dynamic::Array
    ///    CHDBPoco::Dynamic::Array da = *arr;
    ///    i = da[0]["test"];     // i == 0
    ///    i = da[1]["test1"][1]; // i == 2
    ///    i = da[1]["test2"];    // i == 4
    /// ----
    ...
    public:
        ...
        operator const CHDBPoco::Dynamic::Array &() const;
        /// Conversion operator to Dynamic::Array.

        static CHDBPoco::Dynamic::Array makeArray(const JSON::Array::Ptr & arr);
    ...
    private:
        ...
        typedef SharedPtr<CHDBPoco::Dynamic::Array> ArrayPtr;
...
namespace Dynamic
{
    ...
    public:
        ...
        const std::type_info & type() const { return typeid(JSON::Array::Ptr); }
        ...
        void convert(DateTime & /*val*/) const { throw BadCastException("Cannot convert Array to DateTime"); }

        void convert(LocalDateTime & /*ldt*/) const { throw BadCastException("Cannot convert Array to LocalDateTime"); }

        void convert(Timestamp & /*ts*/) const { throw BadCastException("Cannot convert Array to Timestamp"); }

        VarHolder * clone(Placeholder<VarHolder> * pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

        const JSON::Array::Ptr & value() const { return _val; }
    ...
    public:
        ...
        const std::type_info & type() const { return typeid(JSON::Array); }
        ...
        const JSON::Array & value() const { return _val; }
...
#endif // CHDB_JSON_Array_INCLUDED
