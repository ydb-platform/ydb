...
#ifndef CHDB_JSON_Object_INCLUDED
#define CHDB_JSON_Object_INCLUDED
...
namespace JSON
{
    ...
    ///
    ///    // copy/convert to CHDBPoco::DynamicStruct
    ///    CHDBPoco::DynamicStruct ds = *object;
    ...
    public:
        ...
        template <typename T>
        CHDBPoco::Nullable<T> getNullableValue(const std::string & key) const
        /// Retrieves the property with the given name and will
        /// try to convert the value to the given template type.
        ///
        /// The convert<T> method of Var is called
        ...
        static CHDBPoco::DynamicStruct makeStruct(const Object::Ptr & obj);
        /// Utility function for creation of struct.

        operator const CHDBPoco::DynamicStruct &() const;
        /// Cast operator to CHDBPoco::DynamiStruct.
    ...
    private:
        ...
        typedef CHDBPoco::DynamicStruct::Ptr StructPtr;
        ...
        {
            int options = CHDBPoco::JSON_WRAP_STRINGS;
            options |= _escapeUnicode ? CHDBPoco::JSON_ESCAPE_UNICODE : 0;
    ...
    inline const Dynamic::Var & Object::getValue(KeyList::const_iterator & it) const
    {
        ...
        if (itv != _values.end())
            ...
            throw CHDBPoco::NotFoundException();
    }
...
#endif // CHDB_JSON_Object_INCLUDED
