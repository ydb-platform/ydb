...
#ifndef CHDB_JSON_ParseHandler_INCLUDED
#define CHDB_JSON_ParseHandler_INCLUDED
...
namespace JSON
{
    ...
    private:
        void setValue(const CHDBPoco::Dynamic::Var & value);
...
#endif // CHDB_JSON_ParseHandler_INCLUDED
