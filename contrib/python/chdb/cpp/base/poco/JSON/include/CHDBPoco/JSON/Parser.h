...
#ifndef CHDB_JSON_JSONParser_INCLUDED
#define CHDB_JSON_JSONParser_INCLUDED
...
#include "CHDBPoco/JSON/ParserImpl.h"
...
namespace JSON
{
    ...
    /// or an Array. Therefore the result of parse() is a CHDBPoco::Dynamic::Var
    /// containing a CHDBPoco::SharedPtr to an Object or Array instance.
    ///
    /// Example:
    ///
    ///    std::string json = "{ \"name\" : \"Franky\", \"children\" : [ \"Jonas\", \"Ellen\" ] }";
...
#endif // CHDB_JSON_JSONParser_INCLUDED
