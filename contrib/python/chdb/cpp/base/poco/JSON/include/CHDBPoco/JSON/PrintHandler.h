...
#ifndef CHDB_JSON_PrintHandler_INCLUDED
#define CHDB_JSON_PrintHandler_INCLUDED
...
namespace JSON
{
    ...
    public:
        ...
        PrintHandler(unsigned indent = 0, int options = CHDBPoco::JSON_WRAP_STRINGS);
        /// Creates the PrintHandler.

        PrintHandler(std::ostream & out, unsigned indent = 0, int options = CHDBPoco::JSON_WRAP_STRINGS);
        /// Creates the PrintHandler.
...
#endif // CHDB_JSON_PrintHandler_INCLUDED
