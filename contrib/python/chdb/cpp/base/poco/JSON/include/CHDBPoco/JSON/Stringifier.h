...
#ifndef CHDB_JSON_JSONStringifier_INCLUDED
#define CHDB_JSON_JSONStringifier_INCLUDED
...
namespace JSON
{
    ...
    {
    public:
        static void condense(const Dynamic::Var & any, std::ostream & out, int options = CHDBPoco::JSON_WRAP_STRINGS);
        ...
        static void stringify(
            const Dynamic::Var & any, std::ostream & out, unsigned int indent = 0, int step = -1, int options = CHDBPoco::JSON_WRAP_STRINGS);
        ...
        static void formatString(const std::string & value, std::ostream & out, int options = CHDBPoco::JSON_WRAP_STRINGS);
...
#endif // CHDB_JSON_JSONStringifier_INCLUDED
