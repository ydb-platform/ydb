...
#ifndef CHDB_JSON_JSONTemplate_INCLUDED
#define CHDB_JSON_JSONTemplate_INCLUDED
...
namespace JSON
{
    ...
    CHDB_POCO_DECLARE_EXCEPTION(JSON_API, JSONTemplateException, CHDBPoco::Exception)
    ...
    /// is used.
    ///
    ///  A query is passed to CHDBPoco::JSON::Query to get the value.
    {
    public:
...
#endif // CHDB_JSON_JSONTemplate_INCLUDED
