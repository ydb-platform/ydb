...
#ifndef CHDB_JSON_JSONTemplateCache_INCLUDED
#define CHDB_JSON_JSONTemplateCache_INCLUDED


#include <map>
#include <vector>
#include "CHDBPoco/JSON/JSON.h"
#include "CHDBPoco/JSON/Template.h"
...
#endif // CHDB_JSON_JSONTemplateCache_INCLUDED
