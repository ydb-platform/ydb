...
#ifndef CHDB_Net_AbstractHTTPRequestHandler_INCLUDED
#define CHDB_Net_AbstractHTTPRequestHandler_INCLUDED
...
namespace Net
{
    ...
    {
        CHDB_poco_check_ptr(_pResponse);
...
#endif // CHDB_Net_AbstractHTTPRequestHandler_INCLUDED
