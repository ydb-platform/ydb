...
#ifndef CHDB_Net_FTPStreamFactory_INCLUDED
#define CHDB_Net_FTPStreamFactory_INCLUDED
...
namespace Net
{
    ...
    class Net_API FTPStreamFactory : public CHDBPoco::URIStreamFactory
    ...
    public:
        ...
        std::istream * open(const CHDBPoco::URI & uri);
    ...
    protected:
        ...
        static void getUserInfo(const CHDBPoco::URI & uri, std::string & username, std::string & password);
        static void getPathAndType(const CHDBPoco::URI & uri, std::string & path, char & type);
...
#endif // CHDB_Net_FTPStreamFactory_INCLUDED
