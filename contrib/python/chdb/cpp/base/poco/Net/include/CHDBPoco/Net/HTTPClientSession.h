...
#ifndef CHDB_Net_HTTPClientSession_INCLUDED
#define CHDB_Net_HTTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        HTTPClientSession(const std::string & host, CHDBPoco::UInt16 port = HTTPSession::HTTP_PORT);
        /// Creates a HTTPClientSession using the given host and port.

        HTTPClientSession(const std::string & host, CHDBPoco::UInt16 port, const ProxyConfig & proxyConfig);
        ...
        void setPort(CHDBPoco::UInt16 port);
        ...
        void setProxy(
            ...
            CHDBPoco::UInt16 port = HTTPSession::HTTP_PORT,
        ...
        void setProxyPort(CHDBPoco::UInt16 port);
        ...
        CHDBPoco::UInt16 getProxyPort() const;
        ...
        void setKeepAliveTimeout(const CHDBPoco::Timespan & timeout);
        /// Sets the connection timeout for HTTP connections.

        CHDBPoco::Timespan getKeepAliveTimeout() const;
        ...
        /// in a CHDBPoco::Net::MessageException being thrown.
        ///
        /// In case a network or server failure happens
        ...
        const CHDBPoco::Timestamp & getLastRequest() const;
    ...
    protected:
        ...
        void setLastRequest(CHDBPoco::Timestamp time);
    ...
    private:
        ...
        CHDBPoco::Timestamp _lastRequest;
        bool _reconnect;
        bool _mustReconnect;
        bool _expectResponseBody;
        bool _responseReceived;
        CHDBPoco::SharedPtr<std::ostream> _pRequestStream;
        CHDBPoco::SharedPtr<std::istream> _pResponseStream;
    ...
    inline CHDBPoco::UInt16 HTTPClientSession::getPort() const
    {
        return _port;
    }
    ...
    inline CHDBPoco::UInt16 HTTPClientSession::getProxyPort() const
    {
    ...
    inline CHDBPoco::Timespan HTTPClientSession::getKeepAliveTimeout() const
    {
        return _keepAliveTimeout;
    }

    inline const CHDBPoco::Timestamp & HTTPClientSession::getLastRequest() const
    {
        return _lastRequest;
    }
...
#endif // CHDB_Net_HTTPClientSession_INCLUDED
