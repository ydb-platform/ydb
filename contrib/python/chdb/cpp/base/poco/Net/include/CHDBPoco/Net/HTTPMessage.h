...
#ifndef CHDB_Net_HTTPMessage_INCLUDED
#define CHDB_Net_HTTPMessage_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void setContentLength64(CHDBPoco::Int64 length);
        /// Sets the Content-Length header.
        ///
        /// If length is UNKNOWN_CONTENT_LENGTH, removes
        /// the Content-Length header.
        ...
        CHDBPoco::Int64 getContentLength64() const;
        /// Returns the content length for this message,
        /// which may be UNKNOWN_CONTENT_LENGTH if
        /// no Content-Length header is present.
        ///
...
#endif // CHDB_Net_HTTPMessage_INCLUDED
