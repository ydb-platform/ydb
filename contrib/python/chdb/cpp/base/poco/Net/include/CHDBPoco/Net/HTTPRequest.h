...
#ifndef CHDB_Net_HTTPRequest_INCLUDED
#define CHDB_Net_HTTPRequest_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void setHost(const std::string & host, CHDBPoco::UInt16 port);
        /// Sets the value of the Host header field.
        ///
...
#endif // CHDB_Net_HTTPRequest_INCLUDED
