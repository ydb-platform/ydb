...
#ifndef CHDB_Net_HTTPRequestHandlerFactory_INCLUDED
#define CHDB_Net_HTTPRequestHandlerFactory_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef CHDBPoco::SharedPtr<HTTPRequestHandlerFactory> Ptr;
    ...
    protected:
        CHDBPoco::BasicEvent<const bool> serverStopped;
...
#endif // CHDB_Net_HTTPRequestHandlerFactory_INCLUDED
