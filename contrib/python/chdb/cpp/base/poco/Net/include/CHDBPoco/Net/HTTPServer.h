...
#ifndef CHDB_Net_HTTPServer_INCLUDED
#define CHDB_Net_HTTPServer_INCLUDED
...
namespace Net
{
    ...
    public:
        HTTPServer(
            HTTPRequestHandlerFactory::Ptr pFactory, CHDBPoco::UInt16 portNumber = 80, HTTPServerParams::Ptr pParams = new HTTPServerParams);
...
#endif // CHDB_Net_HTTPServer_INCLUDED
