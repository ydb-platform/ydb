...
#ifndef CHDB_Net_HTTPServerParams_INCLUDED
#define CHDB_Net_HTTPServerParams_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<HTTPServerParams> Ptr;
        ...
        const CHDBPoco::Timespan & getKeepAliveTimeout() const;
        /// Returns the connection timeout for HTTP connections.
    ...
    inline const CHDBPoco::Timespan & HTTPServerParams::getTimeout() const
    {
        return _timeout;
    }
    ...
    inline const CHDBPoco::Timespan & HTTPServerParams::getKeepAliveTimeout() const
    {
...
#endif // CHDB_Net_HTTPServerParams_INCLUDED
