...
#ifndef CHDB_Net_HTTPServerRequestImpl_INCLUDED
#define CHDB_Net_HTTPServerRequestImpl_INCLUDED


#include <istream>
#include "CHDBPoco/AutoPtr.h"
#include "CHDBPoco/Net/HTTPServerRequest.h"
...
namespace Net
{
    ...
    private:
        ...
        CHDBPoco::AutoPtr<HTTPServerParams> _pParams;
...
#endif // CHDB_Net_HTTPServerRequestImpl_INCLUDED
