...
#ifndef CHDB_Net_HTTPSessionFactoryMgr_INCLUDED
#define CHDB_Net_HTTPSessionFactoryMgr_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        HTTPSessionFactory(const std::string & proxyHost, CHDBPoco::UInt16 proxyPort);
        ...
        void setProxy(const std::string & proxyHost, CHDBPoco::UInt16 proxyPort);
    ...
    inline CHDBPoco::UInt16 HTTPSessionFactory::proxyPort() const
    {
        return _proxyPort;
    }
...
#endif // CHDB_Net_HTTPSessionFactoryMgr_INCLUDED
