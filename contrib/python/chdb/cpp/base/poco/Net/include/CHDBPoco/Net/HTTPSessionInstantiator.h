...
#ifndef CHDB_Net_HTTPSessionInstantiator_INCLUDED
#define CHDB_Net_HTTPSessionInstantiator_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        virtual HTTPClientSession * createClientSession(const CHDBPoco::URI & uri);
    ...
    protected:
        void setProxy(const std::string & host, CHDBPoco::UInt16 port);
        ...
        CHDBPoco::UInt16 proxyPort() const;
    ...
    inline CHDBPoco::UInt16 HTTPSessionInstantiator::proxyPort() const
    {
        return _proxyPort;
    }
...
#endif // CHDB_Net_HTTPSessionInstantiator_INCLUDED
