...
#ifndef CHDB_Net_ICMPPacket_INCLUDED
#define CHDB_Net_ICMPPacket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        CHDBPoco::UInt16 sequence() const;
        ...
        std::string errorDescription(CHDBPoco::UInt8 * buffer, int length);
...
#endif // CHDB_Net_ICMPPacket_INCLUDED
