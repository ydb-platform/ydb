...
#ifndef CHDB_Net_ICMPPacketImpl_INCLUDED
#define CHDB_Net_ICMPPacketImpl_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        const CHDBPoco::UInt8 * packet(bool init = true);
        ...
        virtual struct timeval time(CHDBPoco::UInt8 * buffer = 0, int length = 0) const = 0;
        ...
        virtual std::string errorDescription(CHDBPoco::UInt8 * buffer, int length) = 0;
        ...
        static const CHDBPoco::UInt16 MAX_SEQ_VALUE;

    protected:
        CHDBPoco::UInt16 nextSequence();
        ...
        CHDBPoco::UInt16 checksum(CHDBPoco::UInt16 * addr, CHDBPoco::Int32 len);
        /// Calculates the checksum for supplied buffer.

    private:
        CHDBPoco::UInt16 _seq;
        CHDBPoco::UInt8 * _pPacket;
        int _dataSize;
    };
    ...
    // inlines
    //
    inline CHDBPoco::UInt16 ICMPPacketImpl::sequence() const
    {
        return _seq;
    }


    inline CHDBPoco::UInt16 ICMPPacketImpl::nextSequence()
    {
        return ++_seq;
    }
...
#endif // CHDB_Net_ICMPPacketImpl_INCLUDED
