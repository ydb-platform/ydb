...
#ifndef CHDB_Net_IPAddress_INCLUDED
#define CHDB_Net_IPAddress_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        IPAddress(const void * addr, CHDB_poco_socklen_t length);
        /// Creates an IPAddress from a native internet address.
        /// A pointer to a in_addr or a in6_addr structure may be
        /// passed.

        IPAddress(const void * addr, CHDB_poco_socklen_t length, CHDBPoco::UInt32 scope);
        /// Creates an IPAddress from a native internet address.
        /// A pointer to a in_addr or a in6_addr structure may be
    ...
    private:
        typedef CHDBPoco::Net::Impl::IPAddressImpl Impl;
        ...
        void newIPv6(const void * hostAddr, CHDBPoco::UInt32 scope);
    ...
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv4AddressImpl;
    }


    inline void IPAddress::newIPv4(const void * hostAddr)
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv4AddressImpl(hostAddr);
    }


    inline void IPAddress::newIPv4(unsigned prefix)
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv4AddressImpl(prefix);
    }
    ...
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv6AddressImpl;
    }


    inline void IPAddress::newIPv6(const void * hostAddr)
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv6AddressImpl(hostAddr);
    }


    inline void IPAddress::newIPv6(const void * hostAddr, CHDBPoco::UInt32 scope)
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv6AddressImpl(hostAddr, scope);
    }


    inline void IPAddress::newIPv6(unsigned prefix)
    {
        _pImpl = new CHDBPoco::Net::Impl::IPv6AddressImpl(prefix);
    }
...
Net_API CHDBPoco::BinaryWriter & operator<<(CHDBPoco::BinaryWriter & writer, const CHDBPoco::Net::IPAddress & value);
Net_API CHDBPoco::BinaryReader & operator>>(CHDBPoco::BinaryReader & reader, CHDBPoco::Net::IPAddress & value);
Net_API std::ostream & operator<<(std::ostream & ostr, const CHDBPoco::Net::IPAddress & addr);


#endif // CHDB_Net_IPAddress_INCLUDED
