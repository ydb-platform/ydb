...
#ifndef CHDB_Net_IPAddressImpl_INCLUDED
#define CHDB_Net_IPAddressImpl_INCLUDED
...
namespace Net
{
    namespace Impl
    {
        ...
        class IPAddressImpl : public CHDBPoco::RefCountedObject
        {
        public:
            ...
            virtual CHDBPoco::UInt32 scope() const = 0;
        ...
        public:
            ...
            IPv6AddressImpl(const void * addr, CHDBPoco::UInt32 scope);
...
#endif // CHDB_Net_IPAddressImpl_INCLUDED
