...
#ifndef CHDB_Net_MailMessage_INCLUDED
#define CHDB_Net_MailMessage_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void setDate(const CHDBPoco::Timestamp & dateTime);
        /// Sets the Date header to the given date/time value.

        CHDBPoco::Timestamp getDate() const;
...
#endif // CHDB_Net_MailMessage_INCLUDED
