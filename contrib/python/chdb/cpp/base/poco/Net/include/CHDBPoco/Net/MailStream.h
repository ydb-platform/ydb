...
#ifndef CHDB_Net_MailStream_INCLUDED
#define CHDB_Net_MailStream_INCLUDED
...
namespace Net
{
    ...
    class Net_API MailStreamBuf : public CHDBPoco::UnbufferedStreamBuf
...
#endif // CHDB_Net_MailStream_INCLUDED
