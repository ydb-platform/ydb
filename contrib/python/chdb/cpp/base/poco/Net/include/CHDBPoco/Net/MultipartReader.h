...
#ifndef CHDB_Net_MultipartReader_INCLUDED
#define CHDB_Net_MultipartReader_INCLUDED
...
namespace Net
{
    ...
    class Net_API MultipartStreamBuf : public CHDBPoco::BufferedStreamBuf
...
#endif // CHDB_Net_MultipartReader_INCLUDED
