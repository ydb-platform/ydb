...
#ifndef CHDB_Net_NameValueCollection_INCLUDED
#define CHDB_Net_NameValueCollection_INCLUDED


#include <cstddef>
#include "CHDBPoco/ListMap.h"
...
namespace Net
{
    ...
    {
    public:
        typedef CHDBPoco::ListMap<std::string, std::string> HeaderMap;
...
#endif // CHDB_Net_NameValueCollection_INCLUDED
