...
#ifndef CHDB_Net_NetworkInterface_INCLUDED
#define CHDB_Net_NetworkInterface_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        typedef CHDBPoco::Tuple<IPAddress, IPAddress, IPAddress> AddressTuple;
    ...
    private:
        ...
        static CHDBPoco::FastMutex _mutex;
    };
...
Net_API std::ostream & operator<<(std::ostream & ostr, const CHDBPoco::Net::NetworkInterface::MACAddress & addr);


#endif // CHDB_POCO_NET_HAS_INTERFACE


#endif // CHDB_Net_NetworkInterface_INCLUDED
