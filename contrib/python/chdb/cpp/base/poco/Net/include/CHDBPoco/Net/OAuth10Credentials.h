...
#ifndef CHDB_Net_OAuth10Credentials_INCLUDED
#define CHDB_Net_OAuth10Credentials_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void authenticate(HTTPRequest & request, const CHDBPoco::URI & uri, SignatureMethod method = SIGN_HMAC_SHA1);
        /// Adds an OAuth 1.0A Authentication header to the given request, using
        /// the given signature method.

        void authenticate(
            HTTPRequest & request, const CHDBPoco::URI & uri, const CHDBPoco::Net::HTMLForm & params, SignatureMethod method = SIGN_HMAC_SHA1);
        /// Adds an OAuth 1.0A Authentication header to the given request, using
        /// the given signature method.

        bool verify(const HTTPRequest & request, const CHDBPoco::URI & uri);
        ...
        bool verify(const HTTPRequest & request, const CHDBPoco::URI & uri, const CHDBPoco::Net::HTMLForm & params);
        /// Verifies the signature of the given request.
        ///
        /// The consumer key, consumer secret, token and token secret must have been set.
        ///
    ...
    protected:
        void signPlaintext(CHDBPoco::Net::HTTPRequest & request) const;
        /// Signs the given HTTP request according to OAuth 1.0A PLAINTEXT signature method.

        void signHMACSHA1(CHDBPoco::Net::HTTPRequest & request, const std::string & uri, const CHDBPoco::Net::HTMLForm & params) const;
        ...
        std::string createSignature(
            const CHDBPoco::Net::HTTPRequest & request,
            const std::string & uri,
            const CHDBPoco::Net::HTMLForm & params,
...
#endif // CHDB_Net_OAuth10Credentials_INCLUDED
