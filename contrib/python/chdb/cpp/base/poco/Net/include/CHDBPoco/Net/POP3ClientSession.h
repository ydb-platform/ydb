...
#ifndef CHDB_Net_POP3ClientSession_INCLUDED
#define CHDB_Net_POP3ClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        POP3ClientSession(const std::string & host, CHDBPoco::UInt16 port = POP3_PORT);
...
#endif // CHDB_Net_POP3ClientSession_INCLUDED
