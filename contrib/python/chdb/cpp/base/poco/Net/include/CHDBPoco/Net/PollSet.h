...
#ifndef CHDB_Net_PollSet_INCLUDED
#define CHDB_Net_PollSet_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        typedef std::map<CHDBPoco::Net::Socket, int> SocketModeMap;
        ...
        void add(const CHDBPoco::Net::Socket & socket, int mode);
        ...
        void remove(const CHDBPoco::Net::Socket & socket);
        /// Removes the given socket from the set.

        void update(const CHDBPoco::Net::Socket & socket, int mode);
        /// Updates the mode of the given socket.

        void clear();
        /// Removes all sockets from the PollSet.

        SocketModeMap poll(const CHDBPoco::Timespan & timeout);
...
#endif // CHDB_Net_PollSet_INCLUDED
