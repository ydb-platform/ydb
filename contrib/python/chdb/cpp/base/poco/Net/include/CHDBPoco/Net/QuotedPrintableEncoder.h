...
#ifndef CHDB_Net_QuotedPrintableEncoder_INCLUDED
#define CHDB_Net_QuotedPrintableEncoder_INCLUDED
...
namespace Net
{
    ...
    class Net_API QuotedPrintableEncoderBuf : public CHDBPoco::UnbufferedStreamBuf
...
#endif // CHDB_Net_QuotedPrintableEncoder_INCLUDED
