...
#ifndef CHDB_Net_RemoteSyslogChannel_INCLUDED
#define CHDB_Net_RemoteSyslogChannel_INCLUDED
...
namespace Net
{
    ...
    class Net_API RemoteSyslogChannel : public CHDBPoco::Channel
...
#endif // CHDB_Net_RemoteSyslogChannel_INCLUDED
