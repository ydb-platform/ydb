...
#ifndef CHDB_Net_SMTPClientSession_INCLUDED
#define CHDB_Net_SMTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        SMTPClientSession(const std::string & host, CHDBPoco::UInt16 port = SMTP_PORT);
    ...
    protected:
        ...
        void loginUsingCRAM(const std::string & username, const std::string & method, CHDBPoco::DigestEngine & hmac);
...
#endif // CHDB_Net_SMTPClientSession_INCLUDED
