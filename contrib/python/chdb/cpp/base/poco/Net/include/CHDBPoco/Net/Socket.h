...
#ifndef CHDB_Net_Socket_INCLUDED
#define CHDB_Net_Socket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        static int select(SocketList & readList, SocketList & writeList, SocketList & exceptList, const CHDBPoco::Timespan & timeout);
        ...
        bool poll(const CHDBPoco::Timespan & timeout, int mode) const;
        ...
        void getOption(int level, int option, CHDBPoco::Timespan & value) const;
        /// Returns the value of the socket option
        /// specified by level and option.
    ...
    inline bool Socket::poll(const CHDBPoco::Timespan & timeout, int mode) const
    {
    ...
    inline void Socket::setSendTimeout(const CHDBPoco::Timespan & timeout)
    {
        _pImpl->setSendTimeout(timeout);
    }


    inline CHDBPoco::Timespan Socket::getSendTimeout() const
    {
        return _pImpl->getSendTimeout();
    }


    inline void Socket::setReceiveTimeout(const CHDBPoco::Timespan & timeout)
    {
        _pImpl->setReceiveTimeout(timeout);
    }


    inline CHDBPoco::Timespan Socket::getReceiveTimeout() const
    {
    ...
    inline void Socket::setOption(int level, int option, const CHDBPoco::Timespan & value)
    {
        _pImpl->setOption(level, option, value);
    }
    ...
    inline void Socket::getOption(int level, int option, CHDBPoco::Timespan & value) const
    {
        _pImpl->getOption(level, option, value);
    }
    ...
    inline CHDB_poco_socket_t Socket::sockfd() const
    {
...
#endif // CHDB_Net_Socket_INCLUDED
