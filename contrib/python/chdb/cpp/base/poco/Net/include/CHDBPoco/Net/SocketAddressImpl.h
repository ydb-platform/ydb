...
#ifndef CHDB_Net_SocketAddressImpl_INCLUDED
#define CHDB_Net_SocketAddressImpl_INCLUDED
...
namespace Net
{
    namespace Impl
    {
        ...
        class Net_API SocketAddressImpl : public CHDBPoco::RefCountedObject
        {
        public:
            ...
            virtual CHDB_poco_socklen_t length() const = 0;
        ...
        public:
            ...
            UInt16 port() const;
            CHDB_poco_socklen_t length() const;
        ...
        inline CHDB_poco_socklen_t IPv4SocketAddressImpl::length() const
        {
            return sizeof(_addr);
        }
        ...
        inline CHDB_poco_socklen_t IPv6SocketAddressImpl::length() const
        {
            return sizeof(_addr);
        }
        ...
        {
            throw CHDBPoco::InvalidAccessException("local socket address does not have host IP address");
        }


        inline UInt16 LocalSocketAddressImpl::port() const
        {
            throw CHDBPoco::InvalidAccessException("local socket address does not have port number");
        }


        inline CHDB_poco_socklen_t LocalSocketAddressImpl::length() const
        {
...
#endif // CHDB_Net_SocketAddressImpl_INCLUDED
