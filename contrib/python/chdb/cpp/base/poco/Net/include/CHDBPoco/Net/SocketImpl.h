...
#ifndef CHDB_Net_SocketImpl_INCLUDED
#define CHDB_Net_SocketImpl_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketImpl : public CHDBPoco::RefCountedObject
    ...
    public:
        ...
        /// a CHDBPoco::NotImplementedException will be thrown.
        ...
        virtual bool poll(const CHDBPoco::Timespan & timeout, int mode);
        ...
        bool pollImpl(CHDBPoco::Timespan & timeout, int mode);
        /// Modifies `timeout`
        ...
        void setOption(int level, int option, const CHDBPoco::Timespan & value);
        /// Sets the socket option specified by level and option
        ...
        virtual void setRawOption(int level, int option, const void * value, CHDB_poco_socklen_t length);
        /// Sets the socket option specified by level and option
        /// to the given time value.
        ...
        void getOption(int level, int option, CHDBPoco::Timespan & value);
        /// Returns the value of the socket option
        /// specified by level and option.
        ...
        virtual void getRawOption(int level, int option, void * value, CHDB_poco_socklen_t & length);
        /// Returns the value of the socket option
        /// specified by level and option.
        ...
        CHDB_poco_socket_t sockfd() const;
        /// Returns the socket descriptor for the
        /// underlying native socket.

        void ioctl(CHDB_poco_ioctl_request_t request, int & arg);
        /// A wrapper for the ioctl system call.

        void ioctl(CHDB_poco_ioctl_request_t request, void * arg);
        /// A wrapper for the ioctl system call.

#if defined(CHDB_POCO_OS_FAMILY_UNIX)
        int fcntl(CHDB_poco_fcntl_request_t request);
        /// A wrapper for the fcntl system call.

        int fcntl(CHDB_poco_fcntl_request_t request, long arg);
        /// A wrapper for the fcntl system call.
#endif
    ...
    protected:
        ...
        SocketImpl(CHDB_poco_socket_t sockfd);
        ...
        void reset(CHDB_poco_socket_t fd = CHDB_POCO_INVALID_SOCKET);
    ...
    protected:
        ...
        CHDB_poco_socket_t _sockfd;
        CHDBPoco::Timespan _recvTimeout;
        CHDBPoco::Timespan _sndTimeout;
        bool _blocking;
    ...
    // inlines
    //
    inline CHDB_poco_socket_t SocketImpl::sockfd() const
    {
        return _sockfd;
    }
    ...
    {
        return _sockfd != CHDB_POCO_INVALID_SOCKET;
    }
...
#endif // CHDB_Net_SocketImpl_INCLUDED
