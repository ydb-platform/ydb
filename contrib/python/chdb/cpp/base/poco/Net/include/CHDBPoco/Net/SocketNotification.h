...
#ifndef CHDB_Net_SocketNotification_INCLUDED
#define CHDB_Net_SocketNotification_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketNotification : public CHDBPoco::Notification
...
#endif // CHDB_Net_SocketNotification_INCLUDED
