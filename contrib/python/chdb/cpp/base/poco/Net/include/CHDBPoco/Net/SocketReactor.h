...
#ifndef CHDB_Net_SocketReactor_INCLUDED
#define CHDB_Net_SocketReactor_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketReactor : public CHDBPoco::Runnable
    ...
    public:
        ...
        explicit SocketReactor(const CHDBPoco::Timespan & timeout);
        ...
        const CHDBPoco::Timespan & getTimeout() const;
        /// Returns the timeout.

        void addEventHandler(const Socket & socket, const CHDBPoco::AbstractObserver & observer);
        /// Registers an event handler with the SocketReactor.
        ///
        /// Usage:
        ///     CHDBPoco::Observer<MyEventHandler, SocketNotification> obs(*this, &MyEventHandler::handleMyEvent);
        ///     reactor.addEventHandler(obs);

        bool hasEventHandler(const Socket & socket, const CHDBPoco::AbstractObserver & observer);
        /// Returns true if the observer is registered with SocketReactor for the given socket.

        void removeEventHandler(const Socket & socket, const CHDBPoco::AbstractObserver & observer);
    ...
    private:
        typedef CHDBPoco::AutoPtr<SocketNotifier> NotifierPtr;
        typedef CHDBPoco::AutoPtr<SocketNotification> NotificationPtr;
...
#endif // CHDB_Net_SocketReactor_INCLUDED
