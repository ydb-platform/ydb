...
#ifndef CHDB_Net_SocketStream_INCLUDED
#define CHDB_Net_SocketStream_INCLUDED
...
namespace Net
{
    ...
    class Net_API SocketStreamBuf : public CHDBPoco::BufferedBidirectionalStreamBuf
...
#endif // CHDB_Net_SocketStream_INCLUDED
