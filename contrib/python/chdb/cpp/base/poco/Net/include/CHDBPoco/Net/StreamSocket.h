...
#ifndef CHDB_Net_StreamSocket_INCLUDED
#define CHDB_Net_StreamSocket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        int sendBytes(CHDBPoco::FIFOBuffer & buffer);
        /// Sends the contents of the given buffer through
        ...
        int receiveBytes(CHDBPoco::FIFOBuffer & buffer);
        /// Receives data from the socket and stores it
...
#endif // CHDB_Net_StreamSocket_INCLUDED
