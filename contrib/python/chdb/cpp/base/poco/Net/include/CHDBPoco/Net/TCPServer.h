...
#ifndef CHDB_Net_TCPServer_INCLUDED
#define CHDB_Net_TCPServer_INCLUDED
...
namespace Net
{
    ...
    class Net_API TCPServerConnectionFilter : public CHDBPoco::RefCountedObject
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<TCPServerConnectionFilter> Ptr;
    ...
    class Net_API TCPServer : public CHDBPoco::Runnable
    ...
    {
    public:
        TCPServer(TCPServerConnectionFactory::Ptr pFactory, CHDBPoco::UInt16 portNumber = 0, TCPServerParams::Ptr pParams = 0);
        ...
        TCPServer(
            ...
            CHDBPoco::ThreadPool & threadPool,
    ...
    inline CHDBPoco::UInt16 TCPServer::port() const
    {
...
#endif // CHDB_Net_TCPServer_INCLUDED
