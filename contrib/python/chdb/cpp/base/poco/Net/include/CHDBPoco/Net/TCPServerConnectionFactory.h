...
#ifndef CHDB_Net_TCPServerConnectionFactory_INCLUDED
#define CHDB_Net_TCPServerConnectionFactory_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef CHDBPoco::SharedPtr<TCPServerConnectionFactory> Ptr;
...
#endif // CHDB_Net_TCPServerConnectionFactory_INCLUDED
