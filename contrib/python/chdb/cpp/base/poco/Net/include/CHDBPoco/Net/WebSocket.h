...
#ifndef CHDB_Net_WebSocket_INCLUDED
#define CHDB_Net_WebSocket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        /// otherwise a CHDBPoco::InvalidArgumentException will be thrown.
        ...
        /// Assignment operator.
        ///
        /// The other socket must be a WebSocket, otherwise a CHDBPoco::InvalidArgumentException
        /// will be thrown.
        ...
        void shutdown(CHDBPoco::UInt16 statusCode, const std::string & statusMessage = "");
        /// Sends a Close control frame to the server end of
        /// the connection to initiate an orderly shutdown
        /// of the connection.
        ...
        int receiveFrame(CHDBPoco::Buffer<char> & buffer, int & flags);
        /// Receives a frame from the socket and stores it
...
#endif // CHDB_Net_WebSocket_INCLUDED
