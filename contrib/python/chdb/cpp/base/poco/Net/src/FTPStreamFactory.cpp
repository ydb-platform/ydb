...
#include "CHDBPoco/Net/FTPStreamFactory.h"
...
{
	CHDB_poco_assert (uri.getScheme() == "ftp");
...
void FTPStreamFactory::getPathAndType(const CHDBPoco::URI& uri, std::string& path, char& type)
{
	path = uri.getPath();
	type = 'i';
