...
#include "CHDBPoco/Net/HTTPServer.h"
...
HTTPServer::HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, CHDBPoco::UInt16 portNumber, HTTPServerParams::Ptr pParams):
...
HTTPServer::HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, CHDBPoco::ThreadPool& threadPool, const ServerSocket& socket, HTTPServerParams::Ptr pParams):
