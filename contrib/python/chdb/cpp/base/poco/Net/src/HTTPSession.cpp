...
void HTTPSession::setTimeout(const CHDBPoco::Timespan& timeout)
{
	setTimeout(timeout, timeout, timeout);
}


void HTTPSession::setTimeout(const CHDBPoco::Timespan& connectionTimeout, const CHDBPoco::Timespan& sendTimeout, const CHDBPoco::Timespan& receiveTimeout)
{
     try
     {
...
void HTTPSession::setException(const CHDBPoco::Exception& exc)
{
	delete _pException;
...
void HTTPSession::attachSessionData(const CHDBPoco::Any& data)
{
	_data = data;
}


void HTTPSession::drainBuffer(CHDBPoco::Buffer<char>& buffer)
{
