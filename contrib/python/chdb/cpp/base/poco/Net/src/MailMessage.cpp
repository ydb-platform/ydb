...
#include "CHDBPoco/Net/MailMessage.h"
#include "CHDBPoco/Net/MediaType.h"
#include "CHDBPoco/Net/MultipartReader.h"
#include "CHDBPoco/Net/MultipartWriter.h"
#include "CHDBPoco/Net/PartSource.h"
#include "CHDBPoco/Net/PartHandler.h"
#include "CHDBPoco/Net/StringPartSource.h"
#include "CHDBPoco/Net/QuotedPrintableEncoder.h"
...
namespace
{
	...
	public:
		...
		{
			std::string tmp;
			CHDBPoco::StreamCopier::copyToString(stream, tmp);
			if (_pMsg)
			{
...
void MailMessage::setDate(const CHDBPoco::Timestamp& dateTime)
{
	set(HEADER_DATE, DateTimeFormatter::format(dateTime, DateTimeFormat::RFC1123_FORMAT));
}

	
CHDBPoco::Timestamp MailMessage::getDate() const
{
