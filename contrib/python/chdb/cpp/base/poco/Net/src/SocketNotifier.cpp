...
void SocketNotifier::addObserver(SocketReactor* pReactor, const CHDBPoco::AbstractObserver& observer)
{
...
void SocketNotifier::removeObserver(SocketReactor* pReactor, const CHDBPoco::AbstractObserver& observer)
{
