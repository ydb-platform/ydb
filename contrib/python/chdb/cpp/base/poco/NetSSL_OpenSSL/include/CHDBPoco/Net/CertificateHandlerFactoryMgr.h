...
#ifndef CHDB_NetSSL_CertificateHandlerFactoryMgr_INCLUDED
#define CHDB_NetSSL_CertificateHandlerFactoryMgr_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef std::map<std::string, CHDBPoco::SharedPtr<CertificateHandlerFactory>> FactoriesMap;
...
#endif // CHDB_NetSSL_CertificateHandlerFactoryMgr_INCLUDED
