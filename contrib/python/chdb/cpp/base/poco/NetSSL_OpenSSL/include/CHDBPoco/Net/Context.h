...
#ifndef CHDB_NetSSL_Context_INCLUDED
#define CHDB_NetSSL_Context_INCLUDED
...
namespace Net
{
    ...
    class NetSSL_API Context : public CHDBPoco::RefCountedObject
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<Context> Ptr;
        ...
        void useCertificate(const CHDBPoco::Crypto::X509Certificate & certificate);
        ...
        void addChainCertificate(const CHDBPoco::Crypto::X509Certificate & certificate);
        /// Adds a certificate for certificate chain validation.

        void addCertificateAuthority(const CHDBPoco::Crypto::X509Certificate & certificate);
        /// Add one trusted certification authority to be used by the Context.

        void usePrivateKey(const CHDBPoco::Crypto::RSAKey & key);
...
#endif // CHDB_NetSSL_Context_INCLUDED
