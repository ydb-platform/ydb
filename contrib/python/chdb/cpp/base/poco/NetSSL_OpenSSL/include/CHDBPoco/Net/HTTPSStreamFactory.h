...
#ifndef CHDB_NetSSL_HTTPSStreamFactory_INCLUDED
#define CHDB_NetSSL_HTTPSStreamFactory_INCLUDED
...
namespace Net
{
    ...
    class NetSSL_API HTTPSStreamFactory : public CHDBPoco::URIStreamFactory
    ...
    public:
        ...
        HTTPSStreamFactory(const std::string & proxyHost, CHDBPoco::UInt16 proxyPort = HTTPSession::HTTP_PORT);
        /// Creates the HTTPSStreamFactory.
        ///
...
#endif // CHDB_Net_HTTPSStreamFactory_INCLUDED
