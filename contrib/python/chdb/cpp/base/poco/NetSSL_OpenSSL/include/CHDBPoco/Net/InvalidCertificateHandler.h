...
#ifndef CHDB_NetSSL_InvalidCertificateHandler_INCLUDED
#define CHDB_NetSSL_InvalidCertificateHandler_INCLUDED


#include "CHDBPoco/Net/NetSSL.h"
#include "CHDBPoco/Net/VerificationErrorArgs.h"
...
namespace Net
{
    ...
    ///    ...
    ///    CHDB_POCO_REGISTER_CHFACTORY(My_API, MyGuiHandler)
    ///
    ...
    ///
    /// or in case one uses CHDBPoco::Util::Application one can rely on an XML configuration and put the following entry
    ...
    ///    </invalidCertificateHandler>
    ///
    /// Note that the name of the InvalidCertificateHandler must be same as the one provided to the CHDB_POCO_REGISTER_CHFACTORY macro.
    {
    public:
...
#endif // CHDB_NetSSL_InvalidCertificateHandler_INCLUDED
