...
#ifndef CHDB_NetSSL_NetSSL_INCLUDED
#define CHDB_NetSSL_NetSSL_INCLUDED
...
namespace Net
{
    ...
    /// libraries, by calling CHDBPoco::Crypto::OpenSSLInitializer::initialize().
    ///
    /// Should be called before using any class from the NetSSL library.
    /// The NetSSL will be initialized automatically, through
    /// CHDBPoco::Crypto::OpenSSLInitializer instances or similar mechanisms
    ...
    /// CHDBPoco::Crypto::OpenSSLInitializer::uninitialize() and
...
#endif // CHDB_NetSSL_NetSSL_INCLUDED
