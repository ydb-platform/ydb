...
#ifndef CHDB_NetSSL_PrivateKeyFactory_INCLUDED
#define CHDB_NetSSL_PrivateKeyFactory_INCLUDED
...
namespace Net
{
    ...
    ///     CHDB_POCO_REGISTER_KEYFACTORY(namespace, PrivateKeyPassphraseHandlerName)
    ...
    template <typename T>
    class PrivateKeyFactoryImpl : public CHDBPoco::Net::PrivateKeyFactory
    {
    public:
...
// CHDBPoco::Net::SSLManager::instance().privateKeyFactoryMgr().setFactory(name, new CHDBPoco::Net::PrivateKeyFactoryImpl<MyKeyHandler>());
#define CHDB_POCO_REGISTER_KEYFACTORY(API, PKCLS) \
    static CHDBPoco::Net::PrivateKeyFactoryRegistrar aRegistrar(std::string(#PKCLS), new CHDBPoco::Net::PrivateKeyFactoryImpl<PKCLS>());


#endif // CHDB_NetSSL_PrivateKeyFactory_INCLUDED
