...
#ifndef CHDB_NetSSL_PrivateKeyFactoryMgr_INCLUDED
#define CHDB_NetSSL_PrivateKeyFactoryMgr_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef std::map<std::string, CHDBPoco::SharedPtr<PrivateKeyFactory>> FactoriesMap;
...
#endif // CHDB_NetSSL_PrivateKeyFactoryMgr_INCLUDED
