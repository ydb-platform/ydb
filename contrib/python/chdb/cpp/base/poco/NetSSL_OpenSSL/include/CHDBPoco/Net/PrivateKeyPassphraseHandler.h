...
#ifndef CHDB_NetSSL_PrivateKeyPassphraseHandler_INCLUDED
#define CHDB_NetSSL_PrivateKeyPassphraseHandler_INCLUDED
...
namespace Net
{
    ...
    ///    ...
    ///    CHDB_POCO_REGISTER_KEYFACTORY(My_API, MyGuiHandler)
    ///
    ...
    ///
    /// or in case one's application extends CHDBPoco::Util::Application one can use an XML configuration and put the following entry
    ...
    ///    </privateKeyPassphraseHandler>
    ///
    /// Note that the name of the passphrase handler must be same as the one provided to the CHDB_POCO_REGISTER_KEYFACTORY macro.
    {
    public:
...
#endif // CHDB_NetSSL_PrivateKeyPassphraseHandler_INCLUDED
