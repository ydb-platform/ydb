...
#ifndef CHDB_NetSSL_SSLManager_INCLUDED
#define CHDB_NetSSL_SSLManager_INCLUDED
...
namespace Net
{
    ...
    /// case, a CHDBPoco::Util::Application instance must be available and the required
    ...
    {
    public:
        typedef CHDBPoco::SharedPtr<PrivateKeyPassphraseHandler> PrivateKeyPassphraseHandlerPtr;
        typedef CHDBPoco::SharedPtr<InvalidCertificateHandler> InvalidCertificateHandlerPtr;

        CHDBPoco::BasicEvent<VerificationErrorArgs> ServerVerificationError;
        /// Fired whenever a certificate verification error is detected by the server during a handshake.

        CHDBPoco::BasicEvent<VerificationErrorArgs> ClientVerificationError;
        /// Fired whenever a certificate verification error is detected by the client during a handshake.

        CHDBPoco::BasicEvent<std::string> PrivateKeyPassphraseRequired;
    ...
    protected:
        ...
        static CHDBPoco::Util::AbstractConfiguration & appConfig();
    ...
    private:
        ...
        friend class CHDBPoco::SingletonHolder<SSLManager>;
...
#endif // CHDB_NetSSL_SSLManager_INCLUDED
