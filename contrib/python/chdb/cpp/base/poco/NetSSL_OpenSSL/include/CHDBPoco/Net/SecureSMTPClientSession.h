...
#ifndef CHDB_Net_SecureSMTPClientSession_INCLUDED
#define CHDB_Net_SecureSMTPClientSession_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        SecureSMTPClientSession(const std::string & host, CHDBPoco::UInt16 port = SMTP_PORT);
...
#endif // CHDB_Net_SecureSMTPClientSession_INCLUDED
