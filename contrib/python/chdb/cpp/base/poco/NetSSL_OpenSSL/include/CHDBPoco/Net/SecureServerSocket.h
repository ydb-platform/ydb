...
#ifndef CHDB_NetSSL_SecureServerSocket_INCLUDED
#define CHDB_NetSSL_SecureServerSocket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        SecureServerSocket(CHDBPoco::UInt16 port, int backlog = 64);
        /// Creates a server socket using the default server SSL context,
        ...
        SecureServerSocket(CHDBPoco::UInt16 port, int backlog, Context::Ptr pContext);
        /// Creates a server socket using the given SSL context, binds it
...
#endif // CHDB_NetSSL_SecureServerSocket_INCLUDED
