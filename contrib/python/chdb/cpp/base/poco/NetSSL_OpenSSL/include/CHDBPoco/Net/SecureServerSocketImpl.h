...
#ifndef CHDB_NetSSL_SecureServerSocketImpl_INCLUDED
#define CHDB_NetSSL_SecureServerSocketImpl_INCLUDED


#include "CHDBPoco/Net/Context.h"
#include "CHDBPoco/Net/NetSSL.h"
#include "CHDBPoco/Net/SecureSocketImpl.h"
...
namespace Net
{
    ...
    public:
        ...
        ///
        /// Throws a CHDBPoco::InvalidAccessException.

        void connect(const SocketAddress & address, const CHDBPoco::Timespan & timeout);
        /// Not supported by this kind of socket.
        ///
        /// Throws a CHDBPoco::InvalidAccessException.
...
#endif // CHDB_NetSSL_SecureServerSocketImpl_INCLUDED
