...
#ifndef CHDB_NetSSL_SecureSocketImpl_INCLUDED
#define CHDB_NetSSL_SecureSocketImpl_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        SecureSocketImpl(CHDBPoco::AutoPtr<SocketImpl> pSocketImpl, Context::Ptr pContext);
        ...
        void connect(const SocketAddress & address, const CHDBPoco::Timespan & timeout, bool performHandshake);
    ...
    protected:
        ...
        bool mustRetry(int rc, CHDBPoco::Timespan & remaining_time);
        ...
        ///
        /// Can also throw a CHDBPoco::TimeoutException if the socket does
    ...
    private:
        ...
        CHDBPoco::AutoPtr<SocketImpl> _pSocket;
        ...
        CHDBPoco::Timespan getMaxTimeoutOrLimit();
    ...
    // inlines
    //
    inline CHDB_poco_socket_t SecureSocketImpl::sockfd()
    {
...
#endif // CHDB_NetSSL_SecureSocketImpl_INCLUDED
