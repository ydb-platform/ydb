...
#ifndef CHDB_NetSSL_SecureStreamSocketImpl_INCLUDED
#define CHDB_NetSSL_SecureStreamSocketImpl_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        void setSendTimeout(const CHDBPoco::Timespan & timeout);
        void setReceiveTimeout(const CHDBPoco::Timespan & timeout);
...
#endif // CHDB_NetSSL_SecureStreamSocketImpl_INCLUDED
