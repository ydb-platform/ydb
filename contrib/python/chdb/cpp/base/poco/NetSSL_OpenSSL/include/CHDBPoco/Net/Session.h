...
#ifndef CHDB_NetSSL_Session_INCLUDED
#define CHDB_NetSSL_Session_INCLUDED
...
namespace Net
{
    ...
    class NetSSL_API Session : public CHDBPoco::RefCountedObject
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<Session> Ptr;
...
#endif // CHDB_NetSSL_Session_INCLUDED
