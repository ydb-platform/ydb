...
#ifndef CHDB_NetSSL_X509Certificate_INCLUDED
#define CHDB_NetSSL_X509Certificate_INCLUDED
...
namespace Net
{
    ...
    class NetSSL_API X509Certificate : public CHDBPoco::Crypto::X509Certificate
    /// This class extends CHDBPoco::Crypto::X509Certificate with the
    ...
    public:
        ...
        X509Certificate(const CHDBPoco::Crypto::X509Certificate & cert);
        /// Creates the certificate by copying another one.

        X509Certificate & operator=(const CHDBPoco::Crypto::X509Certificate & cert);
        ...
        static bool verify(const CHDBPoco::Crypto::X509Certificate & cert, const std::string & hostName);
        /// Verifies the validity of the certificate against the host name.
        ///
        /// For this check to be successful, the certificate must contain
        /// a domain name that matches the domain name
...
#endif // CHDB_NetSSL_X509Certificate_INCLUDED
