...
#include "CHDBPoco/Net/PrivateKeyFactoryMgr.h"
#include "CHDBPoco/Net/KeyFileHandler.h"
#include "CHDBPoco/Net/KeyConsoleHandler.h"
...
{
	bool success = _factories.insert(make_pair(name, CHDBPoco::SharedPtr<PrivateKeyFactory>(pFactory))).second;
	if (!success)
		delete pFactory;
