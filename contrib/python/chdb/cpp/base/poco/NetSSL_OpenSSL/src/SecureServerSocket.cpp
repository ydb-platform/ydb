...
#include "CHDBPoco/Net/SecureServerSocket.h"
...
SecureServerSocket::SecureServerSocket(CHDBPoco::UInt16 port, int backlog): 
	ServerSocket(new SecureServerSocketImpl(SSLManager::instance().defaultServerContext()), true)
{
...
SecureServerSocket::SecureServerSocket(CHDBPoco::UInt16 port, int backlog, Context::Ptr pContext): 
	ServerSocket(new SecureServerSocketImpl(pContext), true)
{
	IPAddress wildcardAddr;
	SocketAddress address(wildcardAddr, port);
