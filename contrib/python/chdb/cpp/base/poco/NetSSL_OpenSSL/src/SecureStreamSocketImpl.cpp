...
void SecureStreamSocketImpl::setSendTimeout(const CHDBPoco::Timespan& timeout)
{
    underlying_socket->setSendTimeout(timeout);
    _sndTimeout = underlying_socket->getSendTimeout();
}

void SecureStreamSocketImpl::setReceiveTimeout(const CHDBPoco::Timespan& timeout)
{
...
{
	throw CHDBPoco::InvalidAccessException("Cannot acceptConnection() on a SecureStreamSocketImpl");
}
...
void SecureStreamSocketImpl::connect(const SocketAddress& address, const CHDBPoco::Timespan& timeout)
{
...
{
	throw CHDBPoco::InvalidAccessException("Cannot bind() a SecureStreamSocketImpl");
}

	
void SecureStreamSocketImpl::listen(int backlog)
{
	throw CHDBPoco::InvalidAccessException("Cannot listen() on a SecureStreamSocketImpl");
}
...
{
	throw CHDBPoco::InvalidAccessException("Cannot sendTo() on a SecureStreamSocketImpl");
}


int SecureStreamSocketImpl::receiveFrom(void* buffer, int length, SocketAddress& address, int flags)
{
	throw CHDBPoco::InvalidAccessException("Cannot receiveFrom() on a SecureStreamSocketImpl");
}


void SecureStreamSocketImpl::sendUrgent(unsigned char data)
{
	throw CHDBPoco::InvalidAccessException("Cannot sendUrgent() on a SecureStreamSocketImpl");
}
