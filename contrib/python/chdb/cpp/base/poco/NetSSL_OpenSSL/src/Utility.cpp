...
{
	std::string mode = CHDBPoco::toLower(vMode);
	...
	if (mode == "none")
		...
		throw CHDBPoco::InvalidArgumentException("Invalid verification mode. Should be relaxed, strict or once but got", vMode);
