...
#ifndef CHDB_Redis_Array_INCLUDED
#define CHDB_Redis_Array_INCLUDED
...
namespace Redis
{
    ...
    public:
        ...
        /// to the template type. A CHDBPoco::BadCastException will be thrown when the
        /// the conversion fails. An CHDBPoco::InvalidArgumentException will be thrown
        /// when the index is out of range. When the array is a Null array
        /// a CHDBPoco::NullValueException is thrown.
        {
            if (_elements.isNull())
                throw NullValueException();

            if (pos >= _elements.value().size())
        ...
        /// Returns the type of the element. This can throw a CHDBPoco::NullValueException
        /// when this array is a Null array. An CHDBPoco::InvalidArgumentException will
...
#endif // CHDB_Redis_Array_INCLUDED
