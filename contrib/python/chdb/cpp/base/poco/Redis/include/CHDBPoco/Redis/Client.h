...
#ifndef CHDB_Redis_Client_INCLUDED
#define CHDB_Redis_Client_INCLUDED
...
namespace Redis
{
    ...
    /// implemented as a typedef for CHDBPoco::Nullable<std::string>. This is
    ...
    public:
        ...
        ///
        /// A CHDBPoco::BadCastException will be thrown when the reply couldn't be
...
#endif // CHDB_Redis_Client_INCLUDED
