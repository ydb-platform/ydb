...
#ifndef CHDB_Redis_Command_INCLUDED
#define CHDB_Redis_Command_INCLUDED
...
namespace Redis
{
    ...
    public:
        ...
        set(const std::string & key,
            ...
            bool overwrite = true,
            const CHDBPoco::Timespan & expireTime = 0,
            bool create = true);
        /// Creates and returns a SET command to set the key with a value.

        static Command
        set(const std::string & key, Int64 value, bool overwrite = true, const CHDBPoco::Timespan & expireTime = 0, bool create = true);
        /// Creates and returns a SET command to set the key with a value.
...
#endif // CHDB_Redis_Command_INCLUDED
