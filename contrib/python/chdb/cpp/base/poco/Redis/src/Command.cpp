...
Command Command::set(const std::string& key, const std::string& value, bool overwrite, const CHDBPoco::Timespan& expireTime, bool create)
{
	Command cmd("SET");
...
Command Command::set(const std::string& key, Int64 value, bool overwrite, const CHDBPoco::Timespan& expireTime, bool create)
{
