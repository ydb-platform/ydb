...
#ifndef CHDB_Util_AbstractConfiguration_INCLUDED
#define CHDB_Util_AbstractConfiguration_INCLUDED
...
namespace Util
{
    ...
    class Util_API AbstractConfiguration : public CHDBPoco::RefCountedObject
    ...
    public:
        ...
        CHDBPoco::BasicEvent<KeyValue> propertyChanging;
        ...
        CHDBPoco::BasicEvent<const KeyValue> propertyChanged;
        /// Fired after a property value has been changed
        /// or a property has been created.

        CHDBPoco::BasicEvent<const std::string> propertyRemoving;
        ...
        CHDBPoco::BasicEvent<const std::string> propertyRemoved;
    ...
    protected:
        ...
        /// implementation throws a CHDBPoco::NotImplementedException.
...
#endif // CHDB_Util_AbstractConfiguration_INCLUDED
