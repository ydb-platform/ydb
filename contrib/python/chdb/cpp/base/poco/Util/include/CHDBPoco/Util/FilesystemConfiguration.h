...
#ifndef CHDB_Util_FilesystemConfiguration_INCLUDED
#define CHDB_Util_FilesystemConfiguration_INCLUDED
...
namespace Util
{
    ...
    protected:
        ...
        CHDBPoco::Path keyToPath(const std::string & key) const;
...
#endif // CHDB_Util_FilesystemConfiguration_INCLUDED
