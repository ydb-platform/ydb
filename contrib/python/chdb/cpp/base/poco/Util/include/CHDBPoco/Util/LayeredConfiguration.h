...
#ifndef CHDB_Util_LayeredConfiguration_INCLUDED
#define CHDB_Util_LayeredConfiguration_INCLUDED
...
namespace Util
{
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<AbstractConfiguration> ConfigPtr;
...
#endif // CHDB_Util_LayeredConfiguration_INCLUDED
