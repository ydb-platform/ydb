...
#ifndef CHDB_Util_LoggingConfigurator_INCLUDED
#define CHDB_Util_LoggingConfigurator_INCLUDED
...
namespace Util
{
    ...
    private:
        ...
        CHDBPoco::Formatter * createFormatter(AbstractConfiguration * pConfig);
        CHDBPoco::Channel * createChannel(AbstractConfiguration * pConfig);
...
#endif // CHDB_Util_LoggingConfigurator_INCLUDED
