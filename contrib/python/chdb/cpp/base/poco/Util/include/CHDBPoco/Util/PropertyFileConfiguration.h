...
#ifndef CHDB_Util_PropertyFileConfiguration_INCLUDED
#define CHDB_Util_PropertyFileConfiguration_INCLUDED
...
#endif // CHDB_Util_PropertyFileConfiguration_INCLUDED
