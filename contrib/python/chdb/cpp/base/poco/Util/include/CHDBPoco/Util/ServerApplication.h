...
#ifndef CHDB_Util_ServerApplication_INCLUDED
#define CHDB_Util_ServerApplication_INCLUDED
...
namespace Util
{
    ...
    ///   }
    ///
    /// The CHDB_POCO_SERVER_MAIN macro can be used to implement main(argc, argv).
    /// If POCO has been built with CHDB_POCO_WIN32_UTF8, CHDB_POCO_SERVER_MAIN supports
...
#    if CHDB_POCO_OS == CHDB_POCO_OS_ANDROID
        static CHDBPoco::Event _terminate;
#    endif
#endif
    };
...
//
#    define CHDB_POCO_SERVER_MAIN(App) \
        int main(int argc, char ** argv) \
        { \
            try \
            { \
            ...
            { \
                ...
                return CHDBPoco::Util::Application::EXIT_SOFTWARE; \
            } \
        }


#endif // CHDB_Util_ServerApplication_INCLUDED
