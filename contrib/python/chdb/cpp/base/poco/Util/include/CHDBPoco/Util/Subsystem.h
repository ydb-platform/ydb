...
#ifndef CHDB_Util_Subsystem_INCLUDED
#define CHDB_Util_Subsystem_INCLUDED
...
namespace Util
{
    ...
    class Util_API Subsystem : public CHDBPoco::RefCountedObject
...
#endif // CHDB_Util_Subsystem_INCLUDED
