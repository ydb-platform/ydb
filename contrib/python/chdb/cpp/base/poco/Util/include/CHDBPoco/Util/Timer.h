...
#ifndef CHDB_Util_Timer_INCLUDED
#define CHDB_Util_Timer_INCLUDED


#include "CHDBPoco/Runnable.h"
#include "CHDBPoco/Thread.h"
#include "CHDBPoco/TimedNotificationQueue.h"
#include "CHDBPoco/Util/TimerTask.h"
...
namespace Util
{
    ...
    class Util_API Timer : protected CHDBPoco::Runnable
    ...
    public:
        ...
        explicit Timer(CHDBPoco::Thread::Priority priority);
        ...
        void schedule(TimerTask::Ptr pTask, CHDBPoco::Timestamp time);
        ...
        void schedule(TimerTask::Ptr pTask, CHDBPoco::Clock clock);
        /// Schedules a task for execution at the specified time.
        ///
        /// If the time lies in the past, the task is executed
        /// immediately.
        ...
        void schedule(TimerTask::Ptr pTask, CHDBPoco::Timestamp time, long interval);
        /// Schedules a task for periodic execution.
        ///
        ...
        void schedule(TimerTask::Ptr pTask, CHDBPoco::Clock clock, long interval);
        /// Schedules a task for periodic execution.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically with
        ...
        void scheduleAtFixedRate(TimerTask::Ptr pTask, CHDBPoco::Timestamp time, long interval);
        /// Schedules a task for periodic execution at a fixed rate.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically
        ...
        void scheduleAtFixedRate(TimerTask::Ptr pTask, CHDBPoco::Clock clock, long interval);
        /// Schedules a task for periodic execution at a fixed rate.
        ///
        /// The task is first executed at the given time.
        /// Subsequently, the task is executed periodically
...
#endif // CHDB_Util_Timer_INCLUDED
