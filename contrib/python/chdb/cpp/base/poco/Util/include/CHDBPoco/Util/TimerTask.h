...
#ifndef CHDB_Util_TimerTask_INCLUDED
#define CHDB_Util_TimerTask_INCLUDED
...
namespace Util
{
    ...
    class Util_API TimerTask : public CHDBPoco::RefCountedObject, public CHDBPoco::Runnable
    ...
    {
    public:
        typedef CHDBPoco::AutoPtr<TimerTask> Ptr;
        ...
        /// An attempt to do so results in a CHDBPoco::Util::IllegalStateException being thrown.

        bool isCancelled() const;
        /// Returns true iff the TimerTask has been cancelled by a call
        /// to cancel().

        CHDBPoco::Timestamp lastExecution() const;
    ...
    private:
        ...
        CHDBPoco::Timestamp _lastExecution;
        bool _isCancelled;
    ...
    inline CHDBPoco::Timestamp TimerTask::lastExecution() const
    {
...
#endif // CHDB_Util_TimerTask_INCLUDED
