...
#ifndef CHDB_Util_Validator_INCLUDED
#define CHDB_Util_Validator_INCLUDED
...
namespace Util
{
    ...
    class Util_API Validator : public CHDBPoco::RefCountedObject
...
#endif // CHDB_Util_Validator_INCLUDED
