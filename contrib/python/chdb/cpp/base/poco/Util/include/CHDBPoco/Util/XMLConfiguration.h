...
#ifndef CHDB_Util_XMLConfiguration_INCLUDED
#define CHDB_Util_XMLConfiguration_INCLUDED
...
namespace Util
{
    ...
    public:
        ...
        XMLConfiguration(CHDBPoco::XML::InputSource * pInputSource);
        /// Creates an XMLConfiguration and loads the XML document from
        /// the given InputSource.

        XMLConfiguration(CHDBPoco::XML::InputSource * pInputSource, char delim);
        /// Creates an XMLConfiguration and loads the XML document from
        ...
        XMLConfiguration(const CHDBPoco::XML::Document * pDocument);
        /// Creates the XMLConfiguration using the given XML document.

        XMLConfiguration(const CHDBPoco::XML::Document * pDocument, char delim);
        /// Creates the XMLConfiguration using the given XML document.
        /// Uses the given delimiter char instead of the default '.'.

        XMLConfiguration(const CHDBPoco::XML::Node * pNode);
        /// Creates the XMLConfiguration using the given XML node.

        XMLConfiguration(const CHDBPoco::XML::Node * pNode, char delim);
        /// Creates the XMLConfiguration using the given XML node.
        /// Uses the given delimiter char instead of the default '.'.

        void load(CHDBPoco::XML::InputSource * pInputSource);
        /// Loads the XML document containing the configuration data
        /// from the given InputSource.

        void load(CHDBPoco::XML::InputSource * pInputSource, unsigned long namePoolSize);
        /// Loads the XML document containing the configuration data
        ...
        void load(const CHDBPoco::XML::Document * pDocument);
        /// Loads the XML document containing the configuration data
        /// from the given XML document.

        void load(const CHDBPoco::XML::Node * pNode);
        /// Loads the XML document containing the configuration data
        ...
        void save(CHDBPoco::XML::DOMWriter & writer, const std::string & path) const;
        /// Writes the XML document containing the configuration data
        /// to the file given by path, using the given DOMWriter.
        ///
        /// This can be used to use a DOMWriter with custom options.

        void save(CHDBPoco::XML::DOMWriter & writer, std::ostream & str) const;
        /// Writes the XML document containing the configuration data
        /// to the given stream.
        ///
        /// This can be used to use a DOMWriter with custom options.
    ...
    private:
        const CHDBPoco::XML::Node * findNode(const std::string & key) const;
        CHDBPoco::XML::Node * findNode(const std::string & key);
        CHDBPoco::XML::Node * findNode(
            std::string::const_iterator & it, const std::string::const_iterator & end, CHDBPoco::XML::Node * pNode, bool create = false) const;
        static CHDBPoco::XML::Node * findElement(const std::string & name, CHDBPoco::XML::Node * pNode, bool create);
        static CHDBPoco::XML::Node * findElement(int index, CHDBPoco::XML::Node * pNode, bool create);
        static CHDBPoco::XML::Node * findElement(const std::string & attr, const std::string & value, CHDBPoco::XML::Node * pNode);
        static CHDBPoco::XML::Node * findAttribute(const std::string & name, CHDBPoco::XML::Node * pNode, bool create);

        CHDBPoco::XML::AutoPtr<CHDBPoco::XML::Node> _pRoot;
        CHDBPoco::XML::AutoPtr<CHDBPoco::XML::Document> _pDocument;
        char _delim;
    };
...
#endif // CHDB_Util_XMLConfiguration_INCLUDED
