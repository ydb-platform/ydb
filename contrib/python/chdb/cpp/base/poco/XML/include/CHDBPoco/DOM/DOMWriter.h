...
#ifndef CHDB_DOM_DOMWriter_INCLUDED
#define CHDB_DOM_DOMWriter_INCLUDED
...
namespace XML
{
    ...
    public:
        ...
        void setEncoding(const std::string & encodingName, CHDBPoco::TextEncoding & textEncoding);
        ...
        /// using a standard file output stream (CHDBPoco::FileOutputStream).

    private:
        std::string _encodingName;
        CHDBPoco::TextEncoding * _pTextEncoding;
        int _options;
        std::string _newLine;
        std::string _indent;
    };
...
#endif // CHDB_DOM_DOMWriter_INCLUDED
