...
#ifndef CHDB_DOM_Document_INCLUDED
#define CHDB_DOM_Document_INCLUDED


#include "CHDBPoco/AutoReleasePool.h"
#include "CHDBPoco/DOM/AbstractContainerNode.h"
#include "CHDBPoco/DOM/DocumentEvent.h"
#include "CHDBPoco/DOM/Element.h"
#include "CHDBPoco/XML/NamePool.h"
...
namespace XML
{
    ...
    {
    public:
        using AutoReleasePool = CHDBPoco::AutoReleasePool<DOMObject>;
        ...
        // Extensions
        Entity *
        createEntity(const XMLString & name, const XMLString & publicId, const XMLString & systemId, const XMLString & notationName) const;
...
#endif // CHDB_DOM_Document_INCLUDED
