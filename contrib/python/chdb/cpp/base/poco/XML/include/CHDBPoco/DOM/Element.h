...
#ifndef CHDB_DOM_Element_INCLUDED
#define CHDB_DOM_Element_INCLUDED


#include "CHDBPoco/DOM/AbstractContainerNode.h"
...
namespace XML
{
    ...
    public:
        ...
        Element *
        getElementByIdNS(const XMLString & elementId, const XMLString & idAttributeURI, const XMLString & idAttributeLocalName) const;
...
#endif // CHDB_DOM_Element_INCLUDED
