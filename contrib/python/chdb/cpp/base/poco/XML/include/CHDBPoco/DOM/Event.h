...
#ifndef CHDB_DOM_Event_INCLUDED
#define CHDB_DOM_Event_INCLUDED
...
namespace XML
{
    ...
    public:
        ...
        CHDBPoco::UInt64 timeStamp() const;
    ...
    inline CHDBPoco::UInt64 Event::timeStamp() const
    {
        return 0;
    }
