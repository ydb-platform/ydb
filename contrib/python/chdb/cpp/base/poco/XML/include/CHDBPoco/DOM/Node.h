...
#ifndef CHDB_DOM_Node_INCLUDED
#define CHDB_DOM_Node_INCLUDED


#include "CHDBPoco/DOM/EventTarget.h"
...
namespace XML
{
    ...
    public:
        ...
        // Extensions
        using NSMap = CHDBPoco::XML::NamespaceSupport;
