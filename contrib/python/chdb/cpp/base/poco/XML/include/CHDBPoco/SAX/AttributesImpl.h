...
#ifndef CHDB_SAX_AttributesImpl_INCLUDED
#define CHDB_SAX_AttributesImpl_INCLUDED


#include <vector>
#include "CHDBPoco/SAX/Attributes.h"
...
namespace XML
{
    ...
    {
        CHDB_poco_assert(0 <= i && i < static_cast<int>(_attributes.size()));
...
#endif // CHDB_SAX_AttributesImpl_INCLUDED
