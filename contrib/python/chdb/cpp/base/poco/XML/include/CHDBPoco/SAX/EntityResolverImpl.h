...
#ifndef CHDB_SAX_EntityResolverImpl_INCLUDED
#define CHDB_SAX_EntityResolverImpl_INCLUDED
...
namespace XML
{
    ...
    /// interpreted as a filesystem path and a CHDBPoco::FileInputStream
    /// is opened for it.
    {
    public:
        EntityResolverImpl();
        ...
        EntityResolverImpl(const CHDBPoco::URIStreamOpener & opener);
        ...
        /// a local filesystem path and a CHDBPoco::FileInputStream is opened for it.
    ...
    private:
        ...
        const CHDBPoco::URIStreamOpener & _opener;
    };
...
#endif // CHDB_SAX_EntityResolverImpl_INCLUDED
