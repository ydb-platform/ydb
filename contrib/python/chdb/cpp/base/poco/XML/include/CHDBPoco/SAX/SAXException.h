...
#ifndef CHDB_SAX_SAXException_INCLUDED
#define CHDB_SAX_SAXException_INCLUDED
...
namespace XML
{
    ...
    CHDB_POCO_DECLARE_EXCEPTION(XML_API, SAXException, XMLException)
    ...
    CHDB_POCO_DECLARE_EXCEPTION(XML_API, SAXNotRecognizedException, SAXException)
    ...
    CHDB_POCO_DECLARE_EXCEPTION(XML_API, SAXNotSupportedException, SAXException)
    ...
    public:
        ...
        SAXParseException(const std::string & msg, const Locator & loc, const CHDBPoco::Exception & exc);
...
#endif // CHDB_SAX_SAXException_INCLUDED
