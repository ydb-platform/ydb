...
#ifndef CHDB_SAX_SAXParser_INCLUDED
#define CHDB_SAX_SAXParser_INCLUDED


#include "CHDBPoco/SAX/XMLReader.h"
#include "CHDBPoco/XML/ParserEngine.h"
...
namespace XML
{
    ...
    public:
        ...
        void addEncoding(const XMLString & name, CHDBPoco::TextEncoding * pEncoding);
...
#endif // CHDB_SAX_SAXParser_INCLUDED
