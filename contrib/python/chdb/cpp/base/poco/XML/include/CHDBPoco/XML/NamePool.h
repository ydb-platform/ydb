...
#ifndef CHDB_XML_NamePool_INCLUDED
#define CHDB_XML_NamePool_INCLUDED
...
#ifndef CHDB_POCO_XML_NAMEPOOL_DEFAULT_SIZE
#    define CHDB_POCO_XML_NAMEPOOL_DEFAULT_SIZE 509
#endif
...
namespace XML
{
    ...
    {
    public:
        NamePool(unsigned long size = CHDB_POCO_XML_NAMEPOOL_DEFAULT_SIZE);
...
#endif // CHDB_XML_NamePool_INCLUDED
