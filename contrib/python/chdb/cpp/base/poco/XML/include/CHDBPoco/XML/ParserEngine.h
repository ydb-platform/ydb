...
#ifndef CHDB_XML_ParserEngine_INCLUDED
#define CHDB_XML_ParserEngine_INCLUDED
...
namespace XML
{
    ...
    public:
        ...
        void setBillionLaughsAttackProtectionActivationThreshold(CHDBPoco::UInt64 activationThresholdBytes);
    ...
    protected:
        ...
        static void handleStartDoctypeDecl(
            void * userData, const XML_Char * doctypeName, const XML_Char * systemId, const XML_Char * publicId, int hasInternalSubset);
        ...
        static void handleExternalParsedEntityDecl(
            void * userData, const XML_Char * entityName, const XML_Char * base, const XML_Char * systemId, const XML_Char * publicId);
        static void handleInternalParsedEntityDecl(
            void * userData, const XML_Char * entityName, const XML_Char * replacementText, int replacementTextLength);
    ...
    private:
        typedef std::map<XMLString, CHDBPoco::TextEncoding *> EncodingMap;
        ...
        CHDBPoco::UInt64 _activationThresholdBytes;
...
#endif // CHDB_XML_ParserEngine_INCLUDED
