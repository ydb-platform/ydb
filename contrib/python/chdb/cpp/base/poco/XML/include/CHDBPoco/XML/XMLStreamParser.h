...
#ifndef CHDB_XML_XMLStreamParser_INCLUDED
#define CHDB_XML_XMLStreamParser_INCLUDED
...
#include "CHDBPoco/XML/Content.h"
#include "CHDBPoco/XML/QName.h"
#include "CHDBPoco/XML/ValueTraits.h"
#if defined(POCO_UNBUNDLED_EXPAT)
#    error #include <expat.h>
#else
#    include "CHDBPoco/XML/expat.h"
#endif
#include <cstddef>
#include <iosfwd>
#include <map>
...
namespace XML
{
    ...
    inline CHDBPoco::UInt64 XMLStreamParser::line() const
    {
        return _line;
    }


    inline CHDBPoco::UInt64 XMLStreamParser::column() const
    {
        return _column;
    }
    ...
    {
        nextExpect(e, qn);
        CHDB_poco_assert(e == EV_START_ELEMENT);
        content(c);
    }
    ...
    {
        CHDB_poco_assert(_parserState == state_next);
...
#endif // CHDB_XML_XMLStreamParser_INCLUDED
