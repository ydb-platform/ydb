...
#ifndef CHDB_XML_XMLWriter_INCLUDED
#define CHDB_XML_XMLWriter_INCLUDED
...
#include "CHDBPoco/SAX/NamespaceSupport.h"
#include "CHDBPoco/StreamConverter.h"
#include "CHDBPoco/TextEncoding.h"
#include "CHDBPoco/XML/Name.h"
#include "CHDBPoco/XML/XML.h"
#include "CHDBPoco/XML/XMLStream.h"
...
namespace XML
{
    ...
    public:
        ...
        XMLWriter(XMLByteOutputStream & str, int options, const std::string & encodingName, CHDBPoco::TextEncoding & textEncoding);
        /// Creates the XMLWriter and sets the specified options.
        ///
        ...
        XMLWriter(XMLByteOutputStream & str, int options, const std::string & encodingName, CHDBPoco::TextEncoding * pTextEncoding);
        /// Creates the XMLWriter and sets the specified options.
        ///
        /// The encoding is reflected in the XML declaration.
        /// The caller is responsible for that the given encodingName matches with
        ...
        void
        startElement(const XMLString & namespaceURI, const XMLString & localName, const XMLString & qname, const Attributes & attributes);
        ...
        void
        emptyElement(const XMLString & namespaceURI, const XMLString & localName, const XMLString & qname, const Attributes & attributes);
    ...
    protected:
        ...
        void writeStartElement(
            const XMLString & namespaceURI, const XMLString & localName, const XMLString & qname, const Attributes & attributes);
    ...
    private:
        struct Namespace
        {
            Namespace(const XMLString & thePrefix, const XMLString & theNamespaceURI) : prefix(thePrefix), namespaceURI(theNamespaceURI) { }
        ...
        CHDBPoco::OutputStreamConverter * _pTextConverter;
        CHDBPoco::TextEncoding * _pInEncoding;
        CHDBPoco::TextEncoding * _pOutEncoding;
        int _options;
...
#endif // CHDB_XML_XMLWriter_INCLUDED
