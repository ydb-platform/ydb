...
#include "CHDBPoco/SAX/Locator.h"
#include <typeinfo>
#include <sstream>
...
CHDB_POCO_IMPLEMENT_EXCEPTION(SAXException, XMLException, "SAX Exception")
CHDB_POCO_IMPLEMENT_EXCEPTION(SAXNotRecognizedException, SAXException, "Unrecognized SAX feature or property identifier")
CHDB_POCO_IMPLEMENT_EXCEPTION(SAXNotSupportedException, SAXException, "Unsupported SAX feature or property identifier")
...
SAXParseException::SAXParseException(const std::string& msg, const Locator& loc, const CHDBPoco::Exception& exc):
...
SAXParseException::SAXParseException(const std::string& msg, const XMLString& publicId, const XMLString& systemId, int lineNumber, int columnNumber, const CHDBPoco::Exception& exc):
...
CHDBPoco::Exception* SAXParseException::clone() const
{
