...
XMLStreamParserException::XMLStreamParserException(const std::string& n, CHDBPoco::UInt64 l, CHDBPoco::UInt64 c, const std::string& d):
	_name(n),
	_line(l),
	_column(c),
	_description(d)
...
CHDBPoco::UInt64 XMLStreamParserException::line() const
{
	return _line;
}


CHDBPoco::UInt64 XMLStreamParserException::column() const
{
	return _column;
}
