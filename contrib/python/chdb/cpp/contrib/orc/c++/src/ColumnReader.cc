...
namespace orc_chdb {
  ...
  class BooleanColumnReader : public ColumnReader {
   private:
    std::unique_ptr<orc_chdb::ByteRleDecoder> rle;
  ...
  class IntegerColumnReader : public ColumnReader {
   protected:
    std::unique_ptr<orc_chdb::RleDecoder> rle;
  ...
  class TimestampColumnReader : public ColumnReader {
   private:
    std::unique_ptr<orc_chdb::RleDecoder> secondsRle;
    std::unique_ptr<orc_chdb::RleDecoder> nanoRle;
