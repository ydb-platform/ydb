...
CHDBPoco::Util::LayeredConfiguration & LocalServer::getClientConfiguration()
{
    return config();
}
...
void LocalServer::initialize(CHDBPoco::Util::Application & self)
{
    CHDBPoco::Util::Application::initialize(self);
...
static ConfigurationPtr getConfigurationFromXMLString(const char * xml_data)
{
    ...
    CHDBPoco::XML::InputSource input_source{ss};
    return {new CHDBPoco::Util::XMLConfiguration{&input_source}};
}
...
try
{
    ...
    if (!is_interactive && !is_background)
    {
        ...
        CHDBPoco::ErrorHandler::set(&error_handler);
    }
...
void LocalServer::processConfig()
{
    ...
    {
        auto poco_logs_level = CHDBPoco::Logger::parseLevel(level);
        CHDBPoco::Logger::root().setLevel(poco_logs_level);
        CHDBPoco::AutoPtr<OwnPatternFormatter> pf = new OwnPatternFormatter;
        CHDBPoco::AutoPtr<OwnFormattingChannel> log = new OwnFormattingChannel(pf, new CHDBPoco::SimpleFileChannel(server_logs_file));
        CHDBPoco::Logger::root().setChannel(log);
    }
    else
    {
...
//     catch (const DB_CHDB::Exception & e)
//     {
//         std::cerr << DB_CHDB::getExceptionMessage(e, false) << std::endl;
//         auto code = DB_CHDB::getCurrentExceptionCode();
//         return code ? code : 1;
//     }
//     catch (const boost::program_options::error & e)
//     {
//         std::cerr << "Bad arguments: " << e.what() << std::endl;
//         return DB_CHDB::ErrorCodes::BAD_ARGUMENTS;
//     }
//     catch (...)
//     {
//         std::cerr << DB_CHDB::getCurrentExceptionMessage(true) << '\n';
//         auto code = DB_CHDB::getCurrentExceptionCode();
//         return code ? code : 1;
//     }
// }
