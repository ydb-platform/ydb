...
#include <CHDBPoco/AccessExpireCache.h>
...
private:
    ...
    CHDBPoco::AccessExpireCache<ContextAccess::Params, std::shared_ptr<const ContextAccess>> cache;
    std::mutex mutex;
};
...
{
public:
    void setPasswordComplexityRulesFromConfig(const CHDBPoco::Util::AbstractConfiguration & config_)
    {
        std::lock_guard lock{mutex};
        ...
        {
            CHDBPoco::Util::AbstractConfiguration::Keys password_complexity;
...
void AccessControl::setUpFromMainConfig(const CHDBPoco::Util::AbstractConfiguration & config_, const String & config_path_,
...
void AccessControl::setUsersConfig(const CHDBPoco::Util::AbstractConfiguration & users_config_)
{
...
void AccessControl::addUsersConfigStorage(const String & storage_name_, const CHDBPoco::Util::AbstractConfiguration & users_config_, bool allow_backup_)
{
...
void AccessControl::addLDAPStorage(const String & storage_name_, const CHDBPoco::Util::AbstractConfiguration & config_, const String & prefix_)
{
...
AuthResult AccessControl::authenticate(const Credentials & credentials, const CHDBPoco::Net::IPAddress & address, const String & forwarded_address) const
{
...
void AccessControl::setExternalAuthenticatorsConfig(const CHDBPoco::Util::AbstractConfiguration & config)
{
...
void AccessControl::setPasswordComplexityRulesFromConfig(const CHDBPoco::Util::AbstractConfiguration & config_)
{
...
std::shared_ptr<const EnabledQuota> AccessControl::getAuthenticationQuota(
    const String & user_name, const CHDBPoco::Net::IPAddress & address, const std::string & forwarded_address) const
{
