...
public:
    ...
    void setUpFromMainConfig(const CHDBPoco::Util::AbstractConfiguration & config_, const String & config_path_,
    ...
    void setUsersConfig(const CHDBPoco::Util::AbstractConfiguration & users_config_);

    /// Adds UsersConfigAccessStorage.
    void addUsersConfigStorage(const String & storage_name_,
                               const CHDBPoco::Util::AbstractConfiguration & users_config_,
                               bool allow_backup_);
    ...
    void addLDAPStorage(const String & storage_name_, const CHDBPoco::Util::AbstractConfiguration & config_, const String & prefix_);
    ...
    void addStoragesFromUserDirectoriesConfig(const CHDBPoco::Util::AbstractConfiguration & config,
                                              const String & key,
    ...
    void addStoragesFromMainConfig(const CHDBPoco::Util::AbstractConfiguration & config,
    ...
    AuthResult authenticate(const Credentials & credentials, const CHDBPoco::Net::IPAddress & address, const String & forwarded_address) const;
