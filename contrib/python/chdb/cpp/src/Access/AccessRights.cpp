...
private:
    AccessFlags getAllGrantableFlags() const { return ::DB_CHDB::getAllGrantableFlags(level); }
    AccessFlags getChildAllGrantableFlags() const { return ::DB_CHDB::getAllGrantableFlags(static_cast<Level>(level == Level::MAX ? level : (level + 1))); }
    ...
    {
        auto grantable_flags = ::DB_CHDB::getAllGrantableFlags(static_cast<Level>(full_name.size()));
