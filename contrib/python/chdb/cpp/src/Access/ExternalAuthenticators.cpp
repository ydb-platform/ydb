...
void parseLDAPSearchParams(LDAPClient::SearchParams & params, const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix)
{
...
void parseLDAPServer(LDAPClient::Params & params, const CHDBPoco::Util::AbstractConfiguration & config, const String & name)
{
    if (name.empty())
...
void parseKerberosParams(GSSAcceptorContext::Params & params, const CHDBPoco::Util::AbstractConfiguration & config)
{
...
HTTPAuthClientParams parseHTTPAuthParams(const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix)
{
    ...
    http_auth_params.timeouts = ConnectionTimeouts()
        .withConnectionTimeout(CHDBPoco::Timespan(connection_timeout_ms * 1000))
        .withReceiveTimeout(CHDBPoco::Timespan(receive_timeout_ms * 1000))
        .withSendTimeout(CHDBPoco::Timespan(send_timeout_ms * 1000));
...
void ExternalAuthenticators::setConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, LoggerPtr log)
{
    std::lock_guard lock(mutex);
    resetImpl();
    ...
    CHDBPoco::Util::AbstractConfiguration::Keys http_auth_server_names;
    ...
    CHDBPoco::Util::AbstractConfiguration::Keys ldap_server_names;
