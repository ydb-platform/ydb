...
public:
    void reset();
    void setConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, LoggerPtr log);
...
void parseLDAPRoleSearchParams(LDAPClient::RoleSearchParams & params, const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix);
