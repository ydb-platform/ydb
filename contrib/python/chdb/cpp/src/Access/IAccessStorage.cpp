...
bool IAccessStorage::insert(const DB_CHDB::UUID & id, const DB_CHDB::AccessEntityPtr & entity, bool replace_if_exists, bool throw_if_exists)
{
...
bool IAccessStorage::isAddressAllowed(const User & user, const CHDBPoco::Net::IPAddress & address) const
{
...
{
    static CHDBPoco::UUIDGenerator generator;
    UUID id;
...
void IAccessStorage::throwAddressNotAllowed(const CHDBPoco::Net::IPAddress & address)
{
