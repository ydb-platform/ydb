...
protected:
    ...
    virtual bool isAddressAllowed(const User & user, const CHDBPoco::Net::IPAddress & address) const;
    ...
    [[noreturn]] static void throwAddressNotAllowed(const CHDBPoco::Net::IPAddress & address);
