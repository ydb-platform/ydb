...
public:
    ...
    explicit LDAPAccessStorage(const String & storage_name_, AccessControl & access_control_, const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix);
...
private: // IAccessStorage implementations.
    ...
    void setConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix);
