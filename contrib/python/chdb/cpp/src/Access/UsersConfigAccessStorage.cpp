...
namespace
{
        ...
        bool allow_plaintext_password)
    {
        ...
        else if (has_ssh_keys)
        {
            ...
            CHDBPoco::Util::AbstractConfiguration::Keys entries;
    ...
    std::vector<AccessEntityPtr> parseUsers(
        ...
        bool allow_plaintext_password)
    {
        CHDBPoco::Util::AbstractConfiguration::Keys user_names;
    ...
    QuotaPtr parseQuota(const CHDBPoco::Util::AbstractConfiguration & config, const String & quota_name, const std::vector<UUID> & user_ids)
    {
        ...
        CHDBPoco::Util::AbstractConfiguration::Keys interval_keys;
    ...
    std::vector<AccessEntityPtr> parseQuotas(const CHDBPoco::Util::AbstractConfiguration & config)
    {
        CHDBPoco::Util::AbstractConfiguration::Keys user_names;
        config.keys("users", user_names);
        ...
        CHDBPoco::Util::AbstractConfiguration::Keys quota_names;
    ...
    std::vector<AccessEntityPtr> parseRowPolicies(const CHDBPoco::Util::AbstractConfiguration & config, bool users_without_row_policies_can_read_rows)
    {
        ...
        for (const String & user_name : user_names)
        {
            ...
            if (config.has(databases_config))
            {
                CHDBPoco::Util::AbstractConfiguration::Keys database_keys;
                ...
                for (const String & database_key : database_keys)
                {
                    ...
                    CHDBPoco::Util::AbstractConfiguration::Keys table_keys;
    ...
    SettingsProfileElements parseSettingsConstraints(const CHDBPoco::Util::AbstractConfiguration & config,
                                                     ...
                                                     const AccessControl & access_control)
    {
        ...
        for (const String & setting_name : keys)
        {
            ...
            CHDBPoco::Util::AbstractConfiguration::Keys constraint_types;
    ...
    std::vector<AccessEntityPtr> parseSettingsProfiles(
        ...
        const AccessControl & access_control)
    {
        CHDBPoco::Util::AbstractConfiguration::Keys profile_names;
...
void UsersConfigAccessStorage::setConfig(const CHDBPoco::Util::AbstractConfiguration & config)
{
    std::lock_guard lock{load_mutex};
    path.clear();
...
void UsersConfigAccessStorage::parseFromConfig(const CHDBPoco::Util::AbstractConfiguration & config)
{
    try
    {
    ...
    const zkutil::GetZooKeeper & get_zookeeper_function)
{
    ...
    config_reloader = std::make_unique<ConfigReloader>(
        ...
        std::make_shared<CHDBPoco::Event>(),
        [&](CHDBPoco::AutoPtr<CHDBPoco::Util::AbstractConfiguration> new_config, bool /*initial_loading*/)
        {
