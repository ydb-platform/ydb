...
LinearModelData::LinearModelData(
    ...
    std::shared_ptr<DB_CHDB::IGradientComputer> gradient_computer_,
    std::shared_ptr<DB_CHDB::IWeightsUpdater> weights_updater_)
...
void LinearModelData::merge(const DB_CHDB::LinearModelData & rhs)
{
