...
template <typename T>
void SingleValueDataNumeric<T>::write(DB_CHDB::WriteBuffer & buf, const DB_CHDB::ISerialization & serialization) const
{
    return memory.get().write(buf, serialization);
}

template <typename T>
void SingleValueDataNumeric<T>::read(DB_CHDB::ReadBuffer & buf, const DB_CHDB::ISerialization & serialization, DB_CHDB::Arena * arena)
{
    return memory.get().read(buf, serialization, arena);
}

template <typename T>
bool SingleValueDataNumeric<T>::isEqualTo(const DB_CHDB::IColumn & column, size_t index) const
{
    return memory.get().isEqualTo(column, index);
}

template <typename T>
bool SingleValueDataNumeric<T>::isEqualTo(const DB_CHDB::SingleValueDataBase & to) const
{
...
template <typename T>
void SingleValueDataNumeric<T>::set(const DB_CHDB::IColumn & column, size_t row_num, DB_CHDB::Arena * arena)
{
    return memory.get().set(column, row_num, arena);
}

template <typename T>
void SingleValueDataNumeric<T>::set(const DB_CHDB::SingleValueDataBase & to, DB_CHDB::Arena * arena)
{
...
template <typename T>
bool SingleValueDataNumeric<T>::setIfSmaller(const DB_CHDB::SingleValueDataBase & to, DB_CHDB::Arena * arena)
{
...
template <typename T>
bool SingleValueDataNumeric<T>::setIfGreater(const DB_CHDB::SingleValueDataBase & to, DB_CHDB::Arena * arena)
{
...
template <typename T>
bool SingleValueDataNumeric<T>::setIfSmaller(const DB_CHDB::IColumn & column, size_t row_num, DB_CHDB::Arena * arena)
{
    return memory.get().setIfSmaller(column, row_num, arena);
}

template <typename T>
bool SingleValueDataNumeric<T>::setIfGreater(const DB_CHDB::IColumn & column, size_t row_num, DB_CHDB::Arena * arena)
{
    return memory.get().setIfGreater(column, row_num, arena);
}

template <typename T>
void SingleValueDataNumeric<T>::setSmallest(const DB_CHDB::IColumn & column, size_t row_begin, size_t row_end, DB_CHDB::Arena * arena)
{
    return memory.get().setSmallest(column, row_begin, row_end, arena);
}

template <typename T>
void SingleValueDataNumeric<T>::setGreatest(const DB_CHDB::IColumn & column, size_t row_begin, size_t row_end, DB_CHDB::Arena * arena)
{
...
void SingleValueDataString::insertResultInto(DB_CHDB::IColumn & to) const
{
    if (has())
...
bool SingleValueDataString::isEqualTo(const DB_CHDB::IColumn & column, size_t row_num) const
{
    return has()
...
bool SingleValueDataGeneric::isEqualTo(const DB_CHDB::SingleValueDataBase & other) const
{
    auto const & to = assert_cast<const Self &>(other);
    return has() && to.has() && to.value == value;
}
