...
template <typename T, bool compare_aliases, bool compare_types>
struct std::hash<DB_CHDB::QueryTreeNodeWithHash<T, compare_aliases, compare_types>>
{
    size_t operator()(const DB_CHDB::QueryTreeNodeWithHash<T, compare_aliases, compare_types> & node_with_hash) const
    {
