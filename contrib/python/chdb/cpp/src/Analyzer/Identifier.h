...
template <>
struct std::hash<DB_CHDB::Identifier>
{
    size_t operator()(const DB_CHDB::Identifier & identifier) const
    {
...
template <>
struct std::hash<DB_CHDB::IdentifierView>
{
    size_t operator()(const DB_CHDB::IdentifierView & identifier) const
    {
...
template <>
struct fmt::formatter<DB_CHDB::Identifier>
{
    ...
    auto format(const DB_CHDB::Identifier & identifier, FormatContext & ctx)
    {
...
template <>
struct fmt::formatter<DB_CHDB::IdentifierView>
{
    constexpr static auto parse(format_parse_context & ctx)
    {
        const auto * it = ctx.begin();
    ...
    template <typename FormatContext>
    auto format(const DB_CHDB::IdentifierView & identifier_view, FormatContext & ctx)
    {
