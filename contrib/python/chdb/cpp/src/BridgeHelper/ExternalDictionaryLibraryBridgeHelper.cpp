...
CHDBPoco::URI ExternalDictionaryLibraryBridgeHelper::getPingURI() const
{
...
CHDBPoco::URI ExternalDictionaryLibraryBridgeHelper::getMainURI() const
{
    auto uri = createBaseURI();
...
CHDBPoco::URI ExternalDictionaryLibraryBridgeHelper::createRequestURI(const String & method) const
{
    auto uri = getMainURI();
...
bool ExternalDictionaryLibraryBridgeHelper::executeRequest(const CHDBPoco::URI & uri, ReadWriteBufferFromHTTP::OutStreamCallback out_stream_callback) const
{
...
QueryPipeline ExternalDictionaryLibraryBridgeHelper::loadBase(const CHDBPoco::URI & uri, ReadWriteBufferFromHTTP::OutStreamCallback out_stream_callback)
{
