...
protected:
    CHDBPoco::URI getPingURI() const override;

    CHDBPoco::URI getMainURI() const override;

    bool bridgeHandShake() override;

    QueryPipeline loadBase(const CHDBPoco::URI & uri, ReadWriteBufferFromHTTP::OutStreamCallback out_stream_callback = {});

    bool executeRequest(const CHDBPoco::URI & uri, ReadWriteBufferFromHTTP::OutStreamCallback out_stream_callback = {}) const;
...
private:
    ...
    CHDBPoco::URI createRequestURI(const String & method) const;
