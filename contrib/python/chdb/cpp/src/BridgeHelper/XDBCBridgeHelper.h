...
public:
    ...
    virtual CHDBPoco::URI getColumnsInfoURI() const = 0;
...
private:
    using Configuration = CHDBPoco::Util::AbstractConfiguration;

    LoggerPtr log;
    std::string connection_string;
    bool use_connection_pooling;
    CHDBPoco::Timespan http_timeout;
...
protected:
    ...
    CHDBPoco::URI getColumnsInfoURI() const override
    {
        auto uri = createBaseURI();
