...
public:
    ...
    CHDBPoco::Net::Socket * getSocket() { return socket.get(); }
...
private:
    ...
    std::optional<CHDBPoco::Net::SocketAddress> current_resolved_address;
    ...
    std::optional<CHDBPoco::Net::SocketAddress> getResolvedAddress() const;
    ...
    std::unique_ptr<CHDBPoco::Net::StreamSocket> socket;
    ...
    void sendAddendum();
    void receiveHello(const CHDBPoco::Timespan & handshake_timeout);
