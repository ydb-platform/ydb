                                                       ...
                                                       bool /*force_connected*/)
{
    if (nested_pools.empty())
        throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::ALL_CONNECTION_TRIES_FAILED,
    ...
    bool skip_read_only_replicas)
{
    if (nested_pools.empty())
        throw DB_CHDB::Exception(
            DB_CHDB::ErrorCodes::ALL_CONNECTION_TRIES_FAILED,
            "Cannot get connection from ConnectionPoolWithFailover cause nested pools are empty");
    ...
    {
        throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::LOGICAL_ERROR, "Unknown pool allocation mode");
    }
