 ...
 * @exception Throws DB_CHDB::Exception if URI has valid scheme (clickhouse:), but invalid internals.
*/
...
// Throws DB_CHDB::Exception with BAD_ARGUMENTS if the given command line argument
