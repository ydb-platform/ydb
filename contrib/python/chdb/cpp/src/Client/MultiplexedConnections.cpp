...
MultiplexedConnections::ReplicaState & MultiplexedConnections::getReplicaForReading()
{
    ...
    CHDBPoco::Net::Socket::SocketList read_list;
    ...
    if (read_list.empty())
    {
        CHDBPoco::Net::Socket::SocketList write_list;
        CHDBPoco::Net::Socket::SocketList except_list;
