...
public:
    ...
    CHDBPoco::Timespan getTimeout() const { return timeout; }

    void setTimeout(const CHDBPoco::Timespan & timeout_)
    {
...
private:
    ...
    void processAsyncEvent(int fd, CHDBPoco::Timespan socket_timeout, AsyncEventTimeoutType, const std::string &, uint32_t) override;
