...
public:
    ...
    static Ptr create(const ColumnPtr & local_discriminators_, const DB_CHDB::ColumnPtr & offsets_, const Columns & variants_) { return create(local_discriminators_, offsets_, variants_, {}); }
    static Ptr create(const ColumnPtr & local_discriminators_, const DB_CHDB::ColumnPtr & offsets_, const Columns & variants_, const std::vector<Discriminator> & local_to_global_discriminators_);
