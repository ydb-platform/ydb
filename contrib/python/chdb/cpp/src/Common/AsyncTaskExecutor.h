...
using AsyncCallback = std::function<void(int, CHDBPoco::Timespan, AsyncEventTimeoutType, const std::string &, uint32_t)>;
...
protected:
    ...
    virtual void processAsyncEvent(int fd, CHDBPoco::Timespan timeout, AsyncEventTimeoutType timeout_type, const std::string & fd_description, uint32_t async_events) = 0;
...
String getSocketTimeoutExceededMessageByTimeoutType(AsyncEventTimeoutType type, CHDBPoco::Timespan timeout, const String & socket_description);
