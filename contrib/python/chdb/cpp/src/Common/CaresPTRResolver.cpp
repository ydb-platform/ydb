...
namespace DB_CHDB
{
    ...
    struct AresChannelRAII
    {
        AresChannelRAII()
        {
            ...
            {
                throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::DNS_ERROR, "Failed to initialize c-ares channel");
            }
        }
    ...
    CaresPTRResolver::CaresPTRResolver(CaresPTRResolver::provider_token)
    {
        ...
        {
            throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::DNS_ERROR, "Failed to initialize c-ares");
        }
    }
    ...
    std::unordered_set<std::string> CaresPTRResolver::resolve(const std::string & ip)
    {
        ...
        {
            throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::DNS_ERROR, "Failed to complete reverse DNS query for IP {}", ip);
        }
