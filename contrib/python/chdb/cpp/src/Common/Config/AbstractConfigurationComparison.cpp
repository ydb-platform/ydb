...
namespace
{
    ...
    {
        // Copied from CHDBPoco::Util::ConfigurationView::translateKey():
        String result = key;
    ...
    bool isSameConfigurationImpl(const CHDBPoco::Util::AbstractConfiguration & left, const String & left_key,
                                 const CHDBPoco::Util::AbstractConfiguration & right, const String & right_key,
                                 const std::unordered_set<std::string_view> * ignore_keys)
    {
        ...
        CHDBPoco::Util::AbstractConfiguration::Keys left_subkeys;
        CHDBPoco::Util::AbstractConfiguration::Keys right_subkeys;
...
bool isSameConfiguration(const CHDBPoco::Util::AbstractConfiguration & left, const CHDBPoco::Util::AbstractConfiguration & right)
{
    return isSameConfiguration(left, String(), right, String());
}

bool isSameConfiguration(const CHDBPoco::Util::AbstractConfiguration & left, const CHDBPoco::Util::AbstractConfiguration & right, const String & key)
{
    return isSameConfiguration(left, key, right, key);
}

bool isSameConfiguration(const CHDBPoco::Util::AbstractConfiguration & left, const String & left_key,
                         const CHDBPoco::Util::AbstractConfiguration & right, const String & right_key,
                         const std::unordered_set<std::string_view> & ignore_keys)
{
...
bool isSameConfigurationWithMultipleKeys(const CHDBPoco::Util::AbstractConfiguration & left, const CHDBPoco::Util::AbstractConfiguration & right, const String & root, const String & name)
{
    if (&left == &right)
        return true;
