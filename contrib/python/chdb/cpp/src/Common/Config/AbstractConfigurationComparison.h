...
namespace DB_CHDB
{
    ...
    bool isSameConfiguration(const CHDBPoco::Util::AbstractConfiguration & left,
                             const CHDBPoco::Util::AbstractConfiguration & right);
    ...
    bool isSameConfigurationWithMultipleKeys(const CHDBPoco::Util::AbstractConfiguration & left,
                                             const CHDBPoco::Util::AbstractConfiguration & right,
    ...
    inline bool operator==(const CHDBPoco::Util::AbstractConfiguration & left, const CHDBPoco::Util::AbstractConfiguration & right)
    {
