...
{
    if (auto * thread_memory_tracker = DB_CHDB::CurrentThread::getMemoryTracker())
    ...
    if (DB_CHDB::MainThreadStatus::get())
...
AllocationTrace CurrentMemoryTracker::allocImpl(Int64 size, bool throw_if_memory_exceeded)
{
    ...
    if (unlikely(memory_tracker_always_throw_logical_error_on_allocation))
    {
        ...
        throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::LOGICAL_ERROR, "Memory tracker: allocations not allowed.");
    }
#endif
