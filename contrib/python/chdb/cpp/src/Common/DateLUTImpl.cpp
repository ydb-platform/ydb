    ...
    : time_zone(time_zone_)
{
    ...
    if (!cctz::load_time_zone(time_zone, &cctz_time_zone))
        throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::BAD_ARGUMENTS, "Cannot load time zone {}", time_zone_);
...
unsigned int DateLUTImpl::toMillisecond(const DB_CHDB::DateTime64 & datetime, Int64 scale_multiplier) const
{
    ...
    auto components = DB_CHDB::DecimalUtils::splitWithScaleMultiplier(datetime, scale_multiplier);
