...
namespace
{
    const char * getProxyHost(DB_CHDB::ProxyConfiguration::Protocol protocol)
    {
        /*
...
ProxyConfiguration EnvironmentProxyConfigurationResolver::resolve()
{
    ...
    static const CHDBPoco::URI http_proxy_uri(http_proxy_host ? http_proxy_host : "");
    static const CHDBPoco::URI https_proxy_uri(https_proxy_host ? https_proxy_host : "");
