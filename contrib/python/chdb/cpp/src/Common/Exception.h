...
class Exception : public CHDBPoco::Exception
{
public:
...
public:
    ...
    Exception(CreateFromPocoTag, const CHDBPoco::Exception & exc);
    Exception(CreateFromSTDTag, const std::exception & exc);

    Exception * clone() const override { return new Exception(*this); }
    void rethrow() const override { throw *this; } // NOLINT
    const char * name() const noexcept override { return "DB_CHDB::Exception"; }
...
private:
    ...
    const char * className() const noexcept override { return "DB_CHDB::Exception"; }
...
private:
    ...
    const char * name() const noexcept override { return "DB_CHDB::ErrnoException"; }
    const char * className() const noexcept override { return "DB_CHDB::ErrnoException"; }
};
...
void tryLogCurrentException(CHDBPoco::Logger * logger, const std::string & start_of_message = "");
...
/** Prints current exception in canonical format.
  * with_stacktrace - prints stack trace for DB_CHDB::Exception.
  * check_embedded_stacktrace - if DB_CHDB::Exception has embedded stacktrace then
