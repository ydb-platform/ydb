...
void FailPointInjection::enableFromGlobalConfig(const CHDBPoco::Util::AbstractConfiguration & config)
{
    String root_key = "fail_points_active";

    CHDBPoco::Util::AbstractConfiguration::Keys fail_point_names;
