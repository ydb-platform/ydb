...
public:
    ...
    boost::context::stack_context allocate() const
    {
        ...
        if (MAP_FAILED == vp)
            throw DB_CHDB::ErrnoException(DB_CHDB::ErrorCodes::CANNOT_ALLOCATE_MEMORY, "FiberStack: Cannot mmap {}.", ReadableSize(num_bytes));
        ...
        {
            ::munmap(vp, num_bytes);
            throw DB_CHDB::ErrnoException(DB_CHDB::ErrorCodes::CANNOT_ALLOCATE_MEMORY, "FiberStack: cannot protect guard page");
        }
