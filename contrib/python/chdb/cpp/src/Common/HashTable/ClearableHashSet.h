...
struct ClearableHashSetState
{
    ...
    void write(DB_CHDB::WriteBuffer & wb) const         { DB_CHDB::writeBinary(version, wb); }
    void writeText(DB_CHDB::WriteBuffer & wb) const     { DB_CHDB::writeText(version, wb); }

    /// Deserialization, in binary and text form.
    void read(DB_CHDB::ReadBuffer & rb)                 { DB_CHDB::readBinary(version, rb); }
    void readText(DB_CHDB::ReadBuffer & rb)             { DB_CHDB::readText(version, rb); }
};
