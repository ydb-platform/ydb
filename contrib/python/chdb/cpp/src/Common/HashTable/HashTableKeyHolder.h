...
inline StringRef & ALWAYS_INLINE keyHolderGetKey(DB_CHDB::ArenaKeyHolder & holder)
{
    return holder.key;
}

inline void ALWAYS_INLINE keyHolderPersistKey(DB_CHDB::ArenaKeyHolder & holder)
{
...
inline void ALWAYS_INLINE keyHolderDiscardKey(DB_CHDB::ArenaKeyHolder &)
{
}
...
inline StringRef & ALWAYS_INLINE keyHolderGetKey(DB_CHDB::SerializedKeyHolder & holder)
{
    return holder.key;
}

inline void ALWAYS_INLINE keyHolderPersistKey(DB_CHDB::SerializedKeyHolder &)
{
}

inline void ALWAYS_INLINE keyHolderDiscardKey(DB_CHDB::SerializedKeyHolder & holder)
{
