...
public:
    ...
    void write(DB_CHDB::WriteBuffer & wb) const { zeroValue()->write(wb); }
    void writeText(DB_CHDB::WriteBuffer & wb) const { zeroValue()->writeText(wb); }
    void read(DB_CHDB::ReadBuffer & rb) { zeroValue()->read(rb); }
    void readText(DB_CHDB::ReadBuffer & rb) { zeroValue()->readText(rb); }
