...
void hilbertIntervalToHyperrectangles2D(UInt64 first, UInt64 last, F && callback)
{
    ...
    {
        auto interval1 = DB_CHDB::FunctionHilbertDecode2DWIthLookupTableImpl<3>::decode(range.begin);
        auto interval2 = DB_CHDB::FunctionHilbertDecode2DWIthLookupTableImpl<3>::decode(range.end);
