...
Macros::Macros(const CHDBPoco::Util::AbstractConfiguration & config, const String & root_key, CHDBPoco::Logger * log)
{
...
Macros::Macros(const CHDBPoco::Util::AbstractConfiguration & config, const String & root_key, LoggerPtr log)
