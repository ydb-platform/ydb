...
public:
    Macros() = default;
    Macros(const CHDBPoco::Util::AbstractConfiguration & config, const String & key, LoggerPtr log = nullptr);
    Macros(const CHDBPoco::Util::AbstractConfiguration & config, const String & key, CHDBPoco::Logger * log = nullptr);
