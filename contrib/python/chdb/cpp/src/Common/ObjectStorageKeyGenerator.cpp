...
class GeneratorWithTemplate : public DB_CHDB::IObjectStorageKeysGenerator
{
public:
    ...
    DB_CHDB::ObjectStorageKey generate(const String &, bool /* is_directory */, const std::optional<String> & /* key_prefix */) const override
    {
        return DB_CHDB::ObjectStorageKey::createAsAbsolute(re_gen.generate());
    }

private:
    String key_template;
    DB_CHDB::RandomStringGeneratorByRegexp re_gen;
};


class GeneratorWithPrefix : public DB_CHDB::IObjectStorageKeysGenerator
{
public:
    ...
    DB_CHDB::ObjectStorageKey generate(const String &, bool /* is_directory */, const std::optional<String> & /* key_prefix */) const override
    {
        ...
        String key = fmt::format("{}/{}",
                                 DB_CHDB::getRandomASCIIString(key_name_prefix_size),
                                 DB_CHDB::getRandomASCIIString(key_name_total_size - key_name_prefix_size));

        /// what ever key_prefix value is, consider that key as relative
        return DB_CHDB::ObjectStorageKey::createAsRelative(key_prefix, key);
    }
...
class GeneratorAsIsWithPrefix : public DB_CHDB::IObjectStorageKeysGenerator
{
public:
