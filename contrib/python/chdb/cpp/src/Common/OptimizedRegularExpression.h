...
private:
    ...
    std::string required_substring;
    std::optional<DB_CHDB::ASCIICaseSensitiveStringSearcher> case_sensitive_substring_searcher;
    std::optional<DB_CHDB::ASCIICaseInsensitiveStringSearcher> case_insensitive_substring_searcher;
