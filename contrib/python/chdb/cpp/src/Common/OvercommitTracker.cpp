...
OvercommitTracker::OvercommitTracker(DB_CHDB::ProcessList * process_list_)
...
UserOvercommitTracker::UserOvercommitTracker(DB_CHDB::ProcessList * process_list_, DB_CHDB::ProcessListForUser * user_process_list_)
...
GlobalOvercommitTracker::GlobalOvercommitTracker(DB_CHDB::ProcessList * process_list_)
    : OvercommitTracker(process_list_)
{
}
