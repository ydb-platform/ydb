...
protected:
    explicit OvercommitTracker(DB_CHDB::ProcessList * process_list_);
    ...
    // of queries.
    DB_CHDB::ProcessList * process_list;
private:
...
{
    explicit UserOvercommitTracker(DB_CHDB::ProcessList * process_list_, DB_CHDB::ProcessListForUser * user_process_list_);
...
private:
    DB_CHDB::ProcessListForUser * user_process_list;
};

struct GlobalOvercommitTracker : OvercommitTracker
{
    explicit GlobalOvercommitTracker(DB_CHDB::ProcessList * process_list_);
