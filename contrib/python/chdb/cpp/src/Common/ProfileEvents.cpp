...
{
    DB_CHDB::CurrentThread::getProfileEvents().increment(event, amount);
}

void incrementNoTrace(Event event, Count amount)
{
    DB_CHDB::CurrentThread::getProfileEvents().incrementNoTrace(event, amount);
}
...
void Counters::increment(Event event, Count amount)
{
    ...
    if (unlikely(send_to_trace_log))
        DB_CHDB::TraceSender::send(DB_CHDB::TraceType::ProfileEvent, StackTrace(), {.event = event, .increment = amount});
}
...
void incrementForLogMessage(CHDBPoco::Message::Priority priority)
{
    switch (priority)
    {
        case CHDBPoco::Message::PRIO_TEST: increment(LogTest); break;
        case CHDBPoco::Message::PRIO_TRACE: increment(LogTrace); break;
        case CHDBPoco::Message::PRIO_DEBUG: increment(LogDebug); break;
        case CHDBPoco::Message::PRIO_INFORMATION: increment(LogInfo); break;
        case CHDBPoco::Message::PRIO_WARNING: increment(LogWarning); break;
        case CHDBPoco::Message::PRIO_ERROR: increment(LogError); break;
        case CHDBPoco::Message::PRIO_FATAL: increment(LogFatal); break;
        default: break;
    }
}
