...
namespace CHDBPoco { class URI; }
namespace CHDBPoco { namespace Util { class AbstractConfiguration; } }
 ...
 */
public:
    void checkURL(const CHDBPoco::URI & uri) const; /// If URL not allowed in config.xml throw UNACCEPTABLE_URL Exception
