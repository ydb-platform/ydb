...
std::string RemoteProxyHostFetcherImpl::fetch(const CHDBPoco::URI & endpoint, const ConnectionTimeouts & timeouts)
{
    auto request = CHDBPoco::Net::HTTPRequest(CHDBPoco::Net::HTTPRequest::HTTP_GET, endpoint.getPath(), CHDBPoco::Net::HTTPRequest::HTTP_1_1);
    ...
    CHDBPoco::StreamCopier::copyToString(response_body_stream, proxy_host);
