...
inline const CHDBPoco::Util::AbstractConfiguration & emptyConfig()
{
    static CHDBPoco::AutoPtr<CHDBPoco::Util::XMLConfiguration> config = new CHDBPoco::Util::XMLConfiguration();
    return *config;
}
...
struct SchedulerNodeInfo
{
    ...
    explicit SchedulerNodeInfo(const CHDBPoco::Util::AbstractConfiguration & config = emptyConfig(), const String & config_prefix = {})
    {
...
{
public:
    explicit ISchedulerNode(EventQueue * event_queue_, const CHDBPoco::Util::AbstractConfiguration & config = emptyConfig(), const String & config_prefix = {})
