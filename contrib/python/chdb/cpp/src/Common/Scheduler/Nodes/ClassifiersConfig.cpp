...
ClassifierDescription::ClassifierDescription(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
{
...
ClassifiersConfig::ClassifiersConfig(const CHDBPoco::Util::AbstractConfiguration & config)
{
    CHDBPoco::Util::AbstractConfiguration::Keys keys;
