...
{
    ClassifierDescription(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix);
};
...
public:
    ...
    explicit ClassifiersConfig(const CHDBPoco::Util::AbstractConfiguration & config);
