...
public:
    ...
    void updateConfiguration(const CHDBPoco::Util::AbstractConfiguration & config) override;
...
private:
    ...
    struct State
    {
        ...
        State() = default;
        explicit State(EventQueue * event_queue, const CHDBPoco::Util::AbstractConfiguration & config);
    };
