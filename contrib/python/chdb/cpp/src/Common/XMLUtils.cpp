...
using namespace CHDBPoco::XML;

using XMLDocumentPtr = CHDBPoco::AutoPtr<Document>;
...
Node * getRootNode(Document * document)
{
    ...
    throw CHDBPoco::Exception("No root node in document");
}


/// This class is used to access protected parseXXX static methods from AbstractConfiguration
class ParseHelper : private CHDBPoco::Util::AbstractConfiguration
{
public:
    ParseHelper() = delete;

    using CHDBPoco::Util::AbstractConfiguration::parseInt;
    using CHDBPoco::Util::AbstractConfiguration::parseUInt;
    using CHDBPoco::Util::AbstractConfiguration::parseInt64;
    using CHDBPoco::Util::AbstractConfiguration::parseUInt64;
    using CHDBPoco::Util::AbstractConfiguration::parseBool;
        ...
        const ValueType & default_value, const ParseFunction & parse_function)
    {
        ...
        if (!value_node)
        {
            if constexpr (ReturnDefault)
                ...
                throw CHDBPoco::NotFoundException(path);
        }
