...
struct ZooKeeperArgs
{
    ...
    ZooKeeperArgs(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_name);
    ...
    DB_CHDB::GetPriorityForLoadBalancing get_priority_load_balancing;

private:
    void initFromKeeperServerSection(const CHDBPoco::Util::AbstractConfiguration & config);
    void initFromKeeperSection(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_name);
};
