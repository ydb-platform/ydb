...
inline To assert_cast(From && from)
{
    ...
    {
        throw DB_CHDB::Exception::createDeprecated(e.what(), DB_CHDB::ErrorCodes::LOGICAL_ERROR);
    }

    throw DB_CHDB::Exception(DB_CHDB::ErrorCodes::LOGICAL_ERROR, "Bad cast from type {} to {}",
