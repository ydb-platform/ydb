...
namespace DB_CHDB
{
     ...
     */
    bool isLocalAddress(const CHDBPoco::Net::SocketAddress & address, UInt16 clickhouse_port);
    bool isLocalAddress(const CHDBPoco::Net::SocketAddress & address);
    bool isLocalAddress(const CHDBPoco::Net::IPAddress & address);
