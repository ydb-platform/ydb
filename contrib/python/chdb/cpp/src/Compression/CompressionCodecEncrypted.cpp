...
void CompressionCodecEncrypted::Configuration::loadImpl(
    const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix, EncryptionMethod method, std::unique_ptr<Params> & new_params)
{
...
bool CompressionCodecEncrypted::Configuration::tryLoad(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
{
...
void CompressionCodecEncrypted::Configuration::load(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
{
    /// Try to create new parameters and fill them from config.
...
bool CompressionCodecEncrypted::Configuration::tryLoad(const CHDBPoco::Util::AbstractConfiguration & config [[maybe_unused]], const String & config_prefix [[maybe_unused]])
{
    return false;
}

/// if encryption is disabled, print warning about this.
void CompressionCodecEncrypted::Configuration::load(const CHDBPoco::Util::AbstractConfiguration & config [[maybe_unused]], const String & config_prefix [[maybe_unused]])
{
