...
{
    void loadFromConfig(const String & config_elem, const CHDBPoco::Util::AbstractConfiguration & config);
};
...
struct KeeperConfigurationAndSettings
{
    ...
    static std::shared_ptr<KeeperConfigurationAndSettings> loadFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, bool standalone_keeper_);
};
