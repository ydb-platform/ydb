...
public:
    ...
    void initialize(const CHDBPoco::Util::AbstractConfiguration & config, KeeperDispatcher * dispatcher_);
    ...
    void updateKeeperMemorySoftLimit(const CHDBPoco::Util::AbstractConfiguration & config);
...
private:
    ...
    void initializeFeatureFlags(const CHDBPoco::Util::AbstractConfiguration & config);
    void initializeDisks(const CHDBPoco::Util::AbstractConfiguration & config);

    Storage getRocksDBPathFromConfig(const CHDBPoco::Util::AbstractConfiguration & config) const;
    Storage getLogsPathFromConfig(const CHDBPoco::Util::AbstractConfiguration & config) const;
    Storage getSnapshotsPathFromConfig(const CHDBPoco::Util::AbstractConfiguration & config) const;
    Storage getStatePathFromConfig(const CHDBPoco::Util::AbstractConfiguration & config) const;
