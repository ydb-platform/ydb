...
public:
    ...
    void initialize(const CHDBPoco::Util::AbstractConfiguration & config, bool standalone_keeper, bool start_async, const MultiVersion<Macros>::Version & macros);
    ...
    void updateConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, const MultiVersion<Macros>::Version & macros);
