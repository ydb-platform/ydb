...
private:
    ...
    void launchRaftServer(const CHDBPoco::Util::AbstractConfiguration & config, bool enable_ipv6);
...
public:
    ...
    void startup(const CHDBPoco::Util::AbstractConfiguration & config, bool enable_ipv6 = true);
    ...
    ClusterUpdateActions getRaftConfigurationDiff(const CHDBPoco::Util::AbstractConfiguration & config);
