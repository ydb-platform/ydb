...
private:
    ...
    static inline const std::unordered_map<LogsLevel, CHDBPoco::Message::Priority> LEVELS =
    {
        {LogsLevel::test, CHDBPoco::Message::Priority::PRIO_TEST},
        {LogsLevel::trace, CHDBPoco::Message::Priority::PRIO_TRACE},
        {LogsLevel::debug, CHDBPoco::Message::Priority::PRIO_DEBUG},
        {LogsLevel::information, CHDBPoco::Message::PRIO_INFORMATION},
        {LogsLevel::warning, CHDBPoco::Message::PRIO_WARNING},
        {LogsLevel::error, CHDBPoco::Message::PRIO_ERROR},
        {LogsLevel::fatal, CHDBPoco::Message::PRIO_FATAL}
    };
