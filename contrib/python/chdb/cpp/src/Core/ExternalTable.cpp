...
void ExternalTablesHandler::handlePart(const CHDBPoco::Net::MessageHeader & header, ReadBuffer & stream)
{
    ...
    CHDBPoco::Net::NameValueCollection content;
    std::string label;
    CHDBPoco::Net::MessageHeader::splitParameters(header.get("Content-Disposition"), label, content);
