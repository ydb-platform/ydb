...
public:
    ...
    virtual void authenticate(
        ...
        std::shared_ptr<PacketEndpoint> packet_endpoint, bool is_secure_connection, const CHDBPoco::Net::SocketAddress & address) = 0;
};
...
public:
    ...
    void authenticate(
        const String & user_name, Session & session, std::optional<String> auth_response,
        std::shared_ptr<PacketEndpoint> packet_endpoint, bool /* is_secure_connection */, const CHDBPoco::Net::SocketAddress & address) override;
