...
void MySQLClient::connect()
{
    ...
    const CHDBPoco::Timespan connection_timeout(10'000'000'000);
    const CHDBPoco::Timespan receive_timeout(5'000'000'000);
    const CHDBPoco::Timespan send_timeout(5'000'000'000);
...
{
    replication.setChecksumSignatureLength(CHDBPoco::toUpper(binlog_checksum) == "NONE" ? 0 : 4);
}
