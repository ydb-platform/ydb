...
/** Set the settings from the profile (in the server configuration, many settings can be listed in one profile).
    ...
    */
void Settings::setProfile(const String & profile_name, const CHDBPoco::Util::AbstractConfiguration & config)
{
...
void Settings::loadSettingsFromConfig(const String & path, const CHDBPoco::Util::AbstractConfiguration & config)
{
    if (!config.has(path))
...
void Settings::checkNoSettingNamesAtTopLevel(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_path)
{
