...
struct Settings : public BaseSettings<SettingsTraits>, public IHints<2>
{
     ...
     */
    void setProfile(const String & profile_name, const CHDBPoco::Util::AbstractConfiguration & config);

    /// Load settings from configuration file, at "path" prefix in configuration.
    void loadSettingsFromConfig(const String & path, const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    static void checkNoSettingNamesAtTopLevel(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_path);
