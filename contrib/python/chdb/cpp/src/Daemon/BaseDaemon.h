...
#include <CHDBPoco/Util/ServerApplication.h>
...
class BaseDaemon : public CHDBPoco::Util::ServerApplication, public Loggers
{
...
public:
    ...
    void initialize(CHDBPoco::Util::Application &) override;

    void reloadConfiguration();

    /// Process command line parameters
    void defineOptions(CHDBPoco::Util::OptionSet & new_options) override;
    ...
    {
        return dynamic_cast<BaseDaemon &>(CHDBPoco::Util::Application::instance());
    }
...
protected:
    ...
    std::optional<DB_CHDB::StatusFile> pid_file;
    ...
    DB_CHDB::ConfigProcessor::LoadedConfig loaded_config;
    CHDBPoco::Util::AbstractConfiguration * last_configuration = nullptr;
...
std::optional<std::reference_wrapper<Daemon>> BaseDaemon::tryGetInstance()
{
    ...
    try
    {
        ptr = dynamic_cast<Daemon *>(&CHDBPoco::Util::Application::instance());
    }
    catch (const CHDBPoco::NullPointerException &) /// NOLINT(bugprone-empty-catch)
    {
