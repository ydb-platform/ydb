...
namespace CHDBPoco { namespace Util { class LayeredConfiguration; }}
...
public:
    ...
    static void initializeInstance(CHDBPoco::Util::LayeredConfiguration & config);
...
private:
    ...
    explicit SentryWriter(CHDBPoco::Util::LayeredConfiguration & config);
