...
std::unique_ptr<ISerialization::SubstreamData> DataTypeArray::getDynamicSubcolumnData(std::string_view subcolumn_name, const DB_CHDB::IDataType::SubstreamData & data, bool throw_if_null) const
{
