...
std::unique_ptr<IDataType::SubstreamData> DataTypeDynamic::getDynamicSubcolumnData(std::string_view subcolumn_name, const DB_CHDB::IDataType::SubstreamData & data, bool throw_if_null) const
{
