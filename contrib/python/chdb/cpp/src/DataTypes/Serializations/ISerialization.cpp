...
template <typename F>
bool tryDeserializeText(const F deserialize, DB_CHDB::IColumn & column)
{
...
bool ISerialization::tryDeserializeTextCSV(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    return tryDeserializeText([&](DB_CHDB::IColumn & my_column) { deserializeTextCSV(my_column, istr, settings); }, column);
}

bool ISerialization::tryDeserializeTextEscaped(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    return tryDeserializeText([&](DB_CHDB::IColumn & my_column) { deserializeTextEscaped(my_column, istr, settings); }, column);
}

bool ISerialization::tryDeserializeTextJSON(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    return tryDeserializeText([&](DB_CHDB::IColumn & my_column) { deserializeTextJSON(my_column, istr, settings); }, column);
}

bool ISerialization::tryDeserializeTextQuoted(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    return tryDeserializeText([&](DB_CHDB::IColumn & my_column) { deserializeTextQuoted(my_column, istr, settings); }, column);
}

bool ISerialization::tryDeserializeWholeText(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    return tryDeserializeText([&](DB_CHDB::IColumn & my_column) { deserializeWholeText(my_column, istr, settings); }, column);
}
...
void ISerialization::serializeTextMarkdown(
    const DB_CHDB::IColumn & column, size_t row_num, DB_CHDB::WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings) const
{
...
bool ISerialization::isEphemeralSubcolumn(const DB_CHDB::ISerialization::SubstreamPath & path, size_t prefix_len)
{
    if (prefix_len == 0 || prefix_len > path.size())
        return false;
