...
bool SerializationCustomSimpleText::tryDeserializeText(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, bool whole) const
{
    try
    {
