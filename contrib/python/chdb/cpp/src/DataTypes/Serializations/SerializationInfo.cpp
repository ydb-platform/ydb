...
CHDBPoco::JSON::Object SerializationInfo::toJSON() const
{
    CHDBPoco::JSON::Object object;
...
void SerializationInfo::fromJSON(const CHDBPoco::JSON::Object & object)
{
...
void SerializationInfoByName::writeJSON(WriteBuffer & out) const
{
    ...
    CHDBPoco::JSON::Array column_infos;
    ...
    CHDBPoco::JSON::Stringifier::stringify(object, oss);
    ...
    const NamesAndTypesList & columns, const Settings & settings, ReadBuffer & in)
{
    ...
    auto object = parser.parse(json_str).extract<CHDBPoco::JSON::Object::Ptr>();
    ...
    if (object->has(KEY_COLUMNS))
    {
        ...
        {
            auto elem_object = elem.extract<CHDBPoco::JSON::Object::Ptr>();
