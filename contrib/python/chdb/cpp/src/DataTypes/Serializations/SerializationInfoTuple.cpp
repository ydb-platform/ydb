...
CHDBPoco::JSON::Object SerializationInfoTuple::toJSON() const
{
    auto object = SerializationInfo::toJSON();
    CHDBPoco::JSON::Array subcolumns;
    for (const auto & elem : elems)
...
void SerializationInfoTuple::fromJSON(const CHDBPoco::JSON::Object & object)
{
