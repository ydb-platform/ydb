...
void SerializationNullable::serializeNullEscaped(DB_CHDB::WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings)
{
    writeString(settings.tsv.null_representation, ostr);
}

bool SerializationNullable::tryDeserializeNullEscaped(DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings)
{
...
void SerializationNullable::serializeNullRaw(DB_CHDB::WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings)
{
    writeString(settings.tsv.null_representation, ostr);
}

bool SerializationNullable::tryDeserializeNullRaw(DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings)
{
    return checkString(settings.tsv.null_representation, istr);
}
...
ReturnType  deserializeTextEscapedAndRawImpl(IColumn & column, ReadBuffer & istr, const FormatSettings & settings, const SerializationPtr & nested_serialization, bool & is_null)
{
    ...
    auto deserialize_nested_with_check = [&deserialize_nested, &nested_serialization, &settings, &null_representation, &istr] (IColumn & nested_column, ReadBuffer & buf_)
    {
        ...
        if (null_representation.find('\t') != std::string::npos || null_representation.find('\n') != std::string::npos)
            throw DB_CHDB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA, "TSV custom null representation "
        ...
        throw DB_CHDB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA, "Error while parsing \"{}{}\" as Nullable"
...
void SerializationNullable::serializeNullQuoted(DB_CHDB::WriteBuffer & ostr)
{
    writeCString("NULL", ostr);
}

bool SerializationNullable::tryDeserializeNullQuoted(DB_CHDB::ReadBuffer & istr)
{
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextQuoted(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextQuoted(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedWholeText(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedWholeText(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
void SerializationNullable::serializeNullCSV(DB_CHDB::WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings)
{
    writeString(settings.csv.null_representation, ostr);
}

bool SerializationNullable::tryDeserializeNullCSV(DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings)
{
...
ReturnType deserializeTextCSVImpl(IColumn & column, ReadBuffer & istr, const FormatSettings & settings, const SerializationPtr & nested_serialization, bool & is_null)
{
    ...
    auto deserialize_nested_with_check = [&deserialize_nested, &nested_serialization, &settings, &null_representation, &istr] (IColumn & nested_column, ReadBuffer & buf_)
    {
        ...
        if (null_representation.find(settings.csv.delimiter) != std::string::npos || null_representation.find('\r') != std::string::npos
            ...
            throw DB_CHDB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA, "CSV custom null representation containing "
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextCSV(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextCSV(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
void SerializationNullable::serializeNullText(DB_CHDB::WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings)
{
...
bool SerializationNullable::tryDeserializeNullText(DB_CHDB::ReadBuffer & istr)
{
...
void SerializationNullable::serializeNullJSON(DB_CHDB::WriteBuffer & ostr)
{
    writeCString("null", ostr);
}

bool SerializationNullable::tryDeserializeNullJSON(DB_CHDB::ReadBuffer & istr)
{
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextJSON(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextJSON(DB_CHDB::IColumn & nested_column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, const DB_CHDB::SerializationPtr & nested_serialization)
{
    bool is_null;
...
void SerializationNullable::serializeNullXML(DB_CHDB::WriteBuffer & ostr)
{
    writeCString("\\N", ostr);
}
