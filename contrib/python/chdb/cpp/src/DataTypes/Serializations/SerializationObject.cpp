...
void SerializationObject::serializeBinary(const Field & field, WriteBuffer & ostr, const DB_CHDB::FormatSettings & settings) const
{
...
SerializationPtr SerializationObject::TypedPathSubcolumnCreator::create(const DB_CHDB::SerializationPtr & prev) const
{
