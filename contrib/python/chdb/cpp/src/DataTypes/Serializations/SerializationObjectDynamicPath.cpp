...
SerializationObjectDynamicPath::SerializationObjectDynamicPath(
    const DB_CHDB::SerializationPtr & nested_, const String & path_, const String & path_subcolumn_, size_t max_dynamic_types_)
...
void SerializationObjectDynamicPath::enumerateStreams(
    DB_CHDB::ISerialization::EnumerateStreamsSettings & settings,
    const DB_CHDB::ISerialization::StreamCallback & callback,
    const DB_CHDB::ISerialization::SubstreamData & data) const
{
