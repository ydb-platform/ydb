...
void SerializationTuple::deserializeText(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, bool whole) const
{
    deserializeTextImpl(column, istr, settings, whole);
}

bool SerializationTuple::tryDeserializeText(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings, bool whole) const
{
...
void SerializationTuple::deserializeTextJSON(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
    deserializeTextJSONImpl(column, istr, settings);
}

bool SerializationTuple::tryDeserializeTextJSON(DB_CHDB::IColumn & column, DB_CHDB::ReadBuffer & istr, const DB_CHDB::FormatSettings & settings) const
{
