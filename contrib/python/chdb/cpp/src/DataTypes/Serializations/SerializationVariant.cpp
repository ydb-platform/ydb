...
void SerializationVariant::serializeBinaryBulkWithMultipleStreams(
    const DB_CHDB::IColumn & column,
    size_t offset,
    size_t limit,
    DB_CHDB::ISerialization::SerializeBinaryBulkSettings & settings,
    DB_CHDB::ISerialization::SerializeBinaryBulkStatePtr & state) const
{
...
std::vector<size_t> SerializationVariant::deserializeCompactDiscriminators(
    DB_CHDB::ColumnPtr & discriminators_column,
    size_t limit,
    ReadBuffer * stream,
...
void SerializationVariant::readDiscriminatorsGranuleStart(DeserializeBinaryBulkStateVariantDiscriminators & state, DB_CHDB::ReadBuffer * stream)
{
    UInt64 granule_size;
...
void SerializationVariant::addVariantElementToPath(DB_CHDB::ISerialization::SubstreamPath & path, size_t i) const
{
...
std::vector<size_t> SerializationVariant::getVariantsDeserializeTextOrder(const DB_CHDB::DataTypes & variant_types)
{
...
bool SerializationVariant::tryDeserializeTextEscapedImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
...
bool SerializationVariant::tryDeserializeTextRawImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
    auto check_for_null = [&](ReadBuffer & buf)
    {
...
bool SerializationVariant::tryDeserializeTextQuotedImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
    auto check_for_null = [&](ReadBuffer & buf)
    {
...
bool SerializationVariant::tryDeserializeTextCSVImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
    auto check_for_null = [&](ReadBuffer & buf)
    {
...
bool SerializationVariant::tryDeserializeWholeTextImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
    auto check_for_null = [&](ReadBuffer & buf)
    {
...
bool SerializationVariant::tryDeserializeTextJSONImpl(DB_CHDB::IColumn & column, const String & field, const DB_CHDB::FormatSettings & settings) const
{
    auto check_for_null = [&](ReadBuffer & buf)
    {
