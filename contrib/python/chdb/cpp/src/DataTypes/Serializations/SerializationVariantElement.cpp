...
void SerializationVariantElement::addVariantToPath(DB_CHDB::ISerialization::SubstreamPath & path) const
{
...
void SerializationVariantElement::removeVariantFromPath(DB_CHDB::ISerialization::SubstreamPath & path) const
{
    path.pop_back();
    path.pop_back();
}
...
ColumnPtr SerializationVariantElement::VariantSubcolumnCreator::create(const DB_CHDB::ColumnPtr & prev) const
{
