...
void SerializationVariantElementNullMap::enumerateStreams(
    ...
    const DB_CHDB::ISerialization::SubstreamData &) const
{
...
DataTypePtr SerializationVariantElementNullMap::VariantNullMapSubcolumnCreator::create(const DB_CHDB::DataTypePtr &) const
{
    return std::make_shared<DataTypeUInt8>();
}

SerializationPtr SerializationVariantElementNullMap::VariantNullMapSubcolumnCreator::create(const DB_CHDB::SerializationPtr &) const
{
    return std::make_shared<SerializationVariantElementNullMap>(variant_element_name, global_variant_discriminator);
}

ColumnPtr SerializationVariantElementNullMap::VariantNullMapSubcolumnCreator::create(const DB_CHDB::ColumnPtr &) const
{
