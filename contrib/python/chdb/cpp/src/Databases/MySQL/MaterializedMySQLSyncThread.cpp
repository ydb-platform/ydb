...
static bool shouldReconnectOnException(const std::exception_ptr & e)
{
    ...
    catch (const CHDBPoco::Net::ConnectionResetException &) {} /// NOLINT
    catch (const CHDBPoco::Net::ConnectionRefusedException &) {} /// NOLINT
    catch (const DB_CHDB::NetException &) {} /// NOLINT
