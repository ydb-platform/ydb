...
ContextMutablePtr copyContextAndApplySettingsFromDictionaryConfig(const ContextPtr & context, const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix);
