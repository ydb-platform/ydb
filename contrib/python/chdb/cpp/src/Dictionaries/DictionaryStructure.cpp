...
DictionaryTypedSpecialAttribute makeDictionaryTypedSpecialAttribute(
    const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, const std::string & default_type)
{
...
DictionaryStructure::DictionaryStructure(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
{
...
static void checkAttributeKeys(const CHDBPoco::Util::AbstractConfiguration::Keys & keys)
{
    ...
    bool complex_key_attributes)
{
    ...
    for (const auto & config_elem : config_elems)
    {
        ...
        CHDBPoco::Util::AbstractConfiguration::Keys attribute_keys;
...
void DictionaryStructure::parseRangeConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & structure_prefix)
{
