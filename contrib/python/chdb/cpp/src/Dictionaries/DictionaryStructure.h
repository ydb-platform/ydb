...
struct DictionaryStructure final
{
    ...
    DictionaryStructure(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix);
...
private:
    ...
    void parseRangeConfiguration(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & structure_prefix);
