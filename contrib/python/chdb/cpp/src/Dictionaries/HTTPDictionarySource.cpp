...
{
    CHDBPoco::URI uri(configuration.url);
...
void HTTPDictionarySource::getUpdateFieldAndDate(CHDBPoco::URI & uri)
{
...
void registerDictionarySourceHTTP(DictionarySourceFactory & factory)
{
    auto create_table_source = [=](const DictionaryStructure & dict_struct,
        ...
        if (created_from_ddl)
        {
            context->getRemoteHostFilter().checkURL(CHDBPoco::URI(configuration.url));
