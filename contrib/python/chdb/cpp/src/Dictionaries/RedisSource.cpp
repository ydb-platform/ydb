...
namespace DB_CHDB
{
    ...
    namespace
    {
        ...
        void insertValue(IColumn & column, const ValueType type, const CHDBPoco::Redis::BulkString & bulk_string)
        {
    ...
    Chunk RedisSource::generate()
    {
        ...
        if (storage_type == RedisStorageType::HASH_MAP)
        {
            ...
            for (; cursor < keys.size(); ++cursor)
            {
                ...
                CHDBPoco::Redis::Command command_for_values("HMGET");
        ...
        {
            CHDBPoco::Redis::Command command_for_values("MGET");
