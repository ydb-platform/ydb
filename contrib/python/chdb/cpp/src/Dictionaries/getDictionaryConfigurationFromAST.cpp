...
getDictionaryConfigurationFromAST(const ASTCreateQuery & query, ContextPtr context, const std::string & database_)
{
    ...
    AutoPtr<CHDBPoco::XML::Document> xml_document(new CHDBPoco::XML::Document());
    AutoPtr<CHDBPoco::XML::Element> document_root(xml_document->createElement("dictionaries"));
    xml_document->appendChild(document_root);
    AutoPtr<CHDBPoco::XML::Element> current_dictionary(xml_document->createElement("dictionary"));
    document_root->appendChild(current_dictionary);
    AutoPtr<CHDBPoco::Util::XMLConfiguration> conf(new CHDBPoco::Util::XMLConfiguration());

    AutoPtr<CHDBPoco::XML::Element> name_element(xml_document->createElement("name"));
    current_dictionary->appendChild(name_element);
    AutoPtr<Text> name(xml_document->createTextNode(dictionary_name));
    name_element->appendChild(name);

    AutoPtr<CHDBPoco::XML::Element> database_element(xml_document->createElement("database"));
    ...
    {
        AutoPtr<CHDBPoco::XML::Element> uuid_element(xml_document->createElement("uuid"));
...
getInfoIfClickHouseDictionarySource(DictionaryConfigurationPtr & config, ContextPtr global_context)
{
    ...
    catch (const CHDBPoco::Net::DNSException &)
    {
