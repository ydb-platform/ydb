...
namespace
{
    ...
    void getKeysFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix,
    ...
    String getCurrentKeyFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix,
    ...
    Algorithm getCurrentAlgorithmFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
    ...
    void getDiskAndPathFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix, const DisksMap & map,
...
DiskEncrypted::DiskEncrypted(
    const String & name_, const CHDBPoco::Util::AbstractConfiguration & config_, const String & config_prefix_, const DisksMap & map_)
...
DiskEncrypted::DiskEncrypted(const String & name_, std::unique_ptr<const DiskEncryptedSettings> settings_,
                             const CHDBPoco::Util::AbstractConfiguration & config_, const String & config_prefix_)
