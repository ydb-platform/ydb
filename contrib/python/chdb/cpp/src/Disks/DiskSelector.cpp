...
void DiskSelector::initialize(
    const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix, ContextPtr context, DiskValidator disk_validator)
{
...
DiskSelectorPtr DiskSelector::updateFromConfig(
    const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix, ContextPtr context) const
{
    assertInitialized();
