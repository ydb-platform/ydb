...
std::unique_ptr<SeekableReadBuffer> ReadBufferFromWebServer::initialize()
{
    ...
    connection_timeouts.withConnectionTimeout(std::max<CHDBPoco::Timespan>(settings.http_connection_timeout, CHDBPoco::Timespan(20, 0)));
    connection_timeouts.withReceiveTimeout(std::max<CHDBPoco::Timespan>(settings.http_receive_timeout, CHDBPoco::Timespan(20, 0)));
