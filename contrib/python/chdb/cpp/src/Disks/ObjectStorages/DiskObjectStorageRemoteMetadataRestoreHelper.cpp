...
void DiskObjectStorageRemoteMetadataRestoreHelper::restore(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, ContextPtr context)
{
