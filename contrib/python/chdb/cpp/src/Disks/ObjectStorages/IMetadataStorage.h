...
public:
    ...
    virtual void setLastModified(const std::string & /* path */, const CHDBPoco::Timestamp & /* timestamp */)
    {
        throwNotImplemented();
    }
...
public:
    ...
    virtual CHDBPoco::Timestamp getLastModified(const std::string & path) const = 0;
