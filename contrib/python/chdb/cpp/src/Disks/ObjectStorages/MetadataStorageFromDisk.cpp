...
CHDBPoco::Timestamp MetadataStorageFromDisk::getLastModified(const std::string & path) const
{
...
void MetadataStorageFromDiskTransaction::setLastModified(const std::string & path, const CHDBPoco::Timestamp & timestamp)
{
