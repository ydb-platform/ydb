...
public:
    ...
    CHDBPoco::Timestamp getLastModified(const std::string & path) const override;
...
public:
    ...
    void setLastModified(const std::string & path, const CHDBPoco::Timestamp & timestamp) override;
