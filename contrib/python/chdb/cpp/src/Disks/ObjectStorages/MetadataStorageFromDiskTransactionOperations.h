...
{
    SetLastModifiedOperation(const std::string & path_, CHDBPoco::Timestamp new_timestamp_, IDisk & disk_);
...
private:
    std::string path;
    CHDBPoco::Timestamp new_timestamp;
    CHDBPoco::Timestamp old_timestamp;
    IDisk & disk;
};
