...
bool isPlainStorage(ObjectStorageType type, const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
{
    return isCompatibleWithMetadataStorage(type, config, config_prefix, MetadataStorageType::Plain);
}

bool isPlainRewritableStorage(ObjectStorageType type, const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
{
...
ObjectStoragePtr createObjectStorage(
    ObjectStorageType type, const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, Args &&... args)
{
    ...
    else if (isPlainRewritableStorage(type, config, config_prefix))
    {
        ...
        auto metadata_storage_metrics = DB_CHDB::MetadataStorageMetrics::create<BaseObjectStorage, MetadataStorageType::PlainRewritable>();
...
S3::URI getS3URI(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, const ContextPtr & context)
{
...
void registerS3PlainRewritableObjectStorage(ObjectStorageFactory & factory)
{
    ...
    factory.registerObjectStorageType(
           ...
           bool skip_access_check) -> ObjectStoragePtr
        {
            ...
            auto metadata_storage_metrics = DB_CHDB::MetadataStorageMetrics::create<S3ObjectStorage, MetadataStorageType::PlainRewritable>();
