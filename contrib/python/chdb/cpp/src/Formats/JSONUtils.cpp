...
namespace JSONUtils
{
    ...
    fileSegmentationEngineJSONEachRowImpl(ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t min_rows, size_t max_rows)
    {
    ...
    std::pair<bool, size_t> fileSegmentationEngineJSONEachRow(
        ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t max_rows)
    {
    ...
    std::pair<bool, size_t> fileSegmentationEngineJSONCompactEachRow(
        ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t min_rows, size_t max_rows)
    {
