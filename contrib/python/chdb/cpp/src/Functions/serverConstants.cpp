...
namespace
{
    ...
    public:
        ...
        explicit FunctionGetOSKernelVersion(ContextPtr context) : FunctionServerConstantBase(CHDBPoco::Environment::osName() + " " + CHDBPoco::Environment::osVersion(), context->isDistributed()) {}
