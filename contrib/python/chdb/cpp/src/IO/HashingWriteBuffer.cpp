...
void IHashingBuffer<Buffer>::calculateHash(DB_CHDB::BufferBase::Position data, size_t len)
{
    if (len)
    {
...
template class IHashingBuffer<DB_CHDB::ReadBuffer>;
template class IHashingBuffer<DB_CHDB::WriteBuffer>;
