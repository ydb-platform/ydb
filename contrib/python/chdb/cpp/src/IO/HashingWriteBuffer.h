...
public:
    ...
    void append(DB_CHDB::BufferBase::Position data)
    {
    ...
    void calculateHash(DB_CHDB::BufferBase::Position data, size_t len);
...
public:
    explicit HashingWriteBuffer(
        ...
        : IHashingBuffer<DB_CHDB::WriteBuffer>(block_size_), out(out_)
    {
