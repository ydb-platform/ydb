...
ReadBufferFromPocoSocket::ReadBufferFromPocoSocket(CHDBPoco::Net::Socket & socket_, size_t buf_size)
...
ReadBufferFromPocoSocket::ReadBufferFromPocoSocket(CHDBPoco::Net::Socket & socket_, const ProfileEvents::Event & read_event_, size_t buf_size)
...
bool ReadBufferFromPocoSocket::poll(size_t timeout_microseconds) const
{
    ...
    Stopwatch watch;
    bool res = socket.poll(timeout_microseconds, CHDBPoco::Net::Socket::SELECT_READ | CHDBPoco::Net::Socket::SELECT_ERROR);
    ProfileEvents::increment(ProfileEvents::NetworkReceiveElapsedMicroseconds, watch.elapsedMicroseconds());
    return res;
}
