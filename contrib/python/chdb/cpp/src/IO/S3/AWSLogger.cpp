...
const std::pair<DB_CHDB::LogsLevel, CHDBPoco::Message::Priority> & convertLogLevel(Aws::Utils::Logging::LogLevel log_level)
{
    ...
    static const std::unordered_map<Aws::Utils::Logging::LogLevel, std::pair<DB_CHDB::LogsLevel, CHDBPoco::Message::Priority>> mapping =
    {
        {Aws::Utils::Logging::LogLevel::Off, {DB_CHDB::LogsLevel::none, CHDBPoco::Message::PRIO_INFORMATION}},
        {Aws::Utils::Logging::LogLevel::Fatal, {DB_CHDB::LogsLevel::information, CHDBPoco::Message::PRIO_INFORMATION}},
        {Aws::Utils::Logging::LogLevel::Error, {DB_CHDB::LogsLevel::information, CHDBPoco::Message::PRIO_INFORMATION}},
        {Aws::Utils::Logging::LogLevel::Warn, {DB_CHDB::LogsLevel::information, CHDBPoco::Message::PRIO_INFORMATION}},
        {Aws::Utils::Logging::LogLevel::Info, {DB_CHDB::LogsLevel::information, CHDBPoco::Message::PRIO_INFORMATION}},
        {Aws::Utils::Logging::LogLevel::Debug, {DB_CHDB::LogsLevel::debug, CHDBPoco::Message::PRIO_TEST}},
        {Aws::Utils::Logging::LogLevel::Trace, {DB_CHDB::LogsLevel::trace, CHDBPoco::Message::PRIO_TEST}},
    };
