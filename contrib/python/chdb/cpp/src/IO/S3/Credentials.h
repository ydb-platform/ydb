...
{
public:
    SSOCredentialsProvider(DB_CHDB::S3::PocoHTTPClientConfiguration aws_client_configuration_, uint64_t expiration_window_seconds_);
...
private:
    ...
    DB_CHDB::S3::PocoHTTPClientConfiguration aws_client_configuration;
    uint64_t expiration_window_seconds;
    LoggerPtr logger;
