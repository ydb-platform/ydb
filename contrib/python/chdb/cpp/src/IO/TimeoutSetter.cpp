...
TimeoutSetter::TimeoutSetter(CHDBPoco::Net::StreamSocket & socket_,
...
TimeoutSetter::TimeoutSetter(CHDBPoco::Net::StreamSocket & socket_, CHDBPoco::Timespan timeout_, bool limit_max_timeout)
