...
void WriteBufferFromPocoSocket::socketSendBytes(const char * ptr, size_t size)
{
    ...
    while (bytes_written < size)
    {
        ...
        catch (const CHDBPoco::Net::NetException & e)
        {
        ...
        catch (const CHDBPoco::TimeoutException &)
        {
        ...
        catch (const CHDBPoco::IOException & e)
        {
            throw NetException(ErrorCodes::NETWORK_ERROR, "{}, while writing to socket ({} -> {})", e.displayText(),
                               our_address.toString(), peer_address.toString());
        }
...
WriteBufferFromPocoSocket::WriteBufferFromPocoSocket(CHDBPoco::Net::Socket & socket_, size_t buf_size)
...
WriteBufferFromPocoSocket::WriteBufferFromPocoSocket(CHDBPoco::Net::Socket & socket_, const ProfileEvents::Event & write_event_, size_t buf_size)
