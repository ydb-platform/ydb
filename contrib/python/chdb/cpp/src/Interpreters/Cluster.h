...
{
public:
    Cluster(const CHDBPoco::Util::AbstractConfiguration & config,
    ...
    static CHDBPoco::Timespan saturate(CHDBPoco::Timespan v, CHDBPoco::Timespan limit);
...
{
public:
    Clusters(const CHDBPoco::Util::AbstractConfiguration & config, const Settings & settings, MultiVersion<Macros>::Version macros, const String & config_prefix = "remote_servers");
    ...
    void updateClusters(const CHDBPoco::Util::AbstractConfiguration & new_config, const Settings & settings, const String & config_prefix, CHDBPoco::Util::AbstractConfiguration * old_config = nullptr);
