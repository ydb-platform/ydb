...
namespace CHDBPoco::Net { class IPAddress; }
namespace zkutil
{
    class ZooKeeper;
...
protected:
    ...
    IHostContextPtr host_context;  /// Arbitrary object that may used to attach some host specific information to query context,
                                   ...
                                   /// to be customized in HTTP and TCP servers by overloading the customizeContext(DB_CHDB::ContextPtr)
                                   /// methods.
...
public:
    ...
    using ConfigurationPtr = CHDBPoco::AutoPtr<CHDBPoco::Util::AbstractConfiguration>;

    /// Global application configuration settings.
    void setConfig(const ConfigurationPtr & config);
    const CHDBPoco::Util::AbstractConfiguration & getConfigRef() const;

    AccessControl & getAccessControl();
    const AccessControl & getAccessControl() const;

    /// Sets external authenticators config (LDAP, Kerberos).
    void setExternalAuthenticatorsConfig(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void setHTTPClientInfo(const CHDBPoco::Net::HTTPRequest & request);
    ...
    void setCurrentAddress(const CHDBPoco::Net::SocketAddress & current_address);
    void setInitialUserName(const String & initial_user_name);
    void setInitialAddress(const CHDBPoco::Net::SocketAddress & initial_address);
    ...
    void tryCreateEmbeddedDictionaries(const CHDBPoco::Util::AbstractConfiguration & config) const;
    void loadOrReloadDictionaries(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void loadOrReloadUserDefinedExecutableFunctions(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateInterserverCredentials(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void setRemoteHostFilter(const CHDBPoco::Util::AbstractConfiguration & config);
    const RemoteHostFilter & getRemoteHostFilter() const;

    /// Storage of forbidden HTTP headers from config.xml
    void setHTTPHeaderFilter(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateKeeperConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateUncompressedCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateMarkCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateIndexUncompressedCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateIndexMarkCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateMMappedFileCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateQueryCacheConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void updateStorageConfiguration(const CHDBPoco::Util::AbstractConfiguration & config);
    ...
    void setDefaultProfiles(const CHDBPoco::Util::AbstractConfiguration & config);
...
struct HTTPContext : public IHTTPContext
{
    ...
    CHDBPoco::Timespan getReceiveTimeout() const override;

    CHDBPoco::Timespan getSendTimeout() const override;
