...
{
public:
    DDLWorker(int pool_size_, const std::string & zk_root_dir, ContextPtr context_, const CHDBPoco::Util::AbstractConfiguration * config, const String & prefix,
...
protected:
    ...
    std::shared_ptr<CHDBPoco::Event> queue_updated_event = std::make_shared<CHDBPoco::Event>();
    std::shared_ptr<CHDBPoco::Event> cleanup_event = std::make_shared<CHDBPoco::Event>();
