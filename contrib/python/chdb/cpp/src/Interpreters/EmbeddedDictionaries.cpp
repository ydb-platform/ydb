...
bool EmbeddedDictionaries::reloadImpl(const bool throw_on_error, const bool force_reload)
{
    ...
    DictionaryReloader<RegionsHierarchies> reload_regions_hierarchies = [=, this] (const CHDBPoco::Util::AbstractConfiguration & config)
    {
    ...
    DictionaryReloader<RegionsNames> reload_regions_names = [=, this] (const CHDBPoco::Util::AbstractConfiguration & config)
    {
