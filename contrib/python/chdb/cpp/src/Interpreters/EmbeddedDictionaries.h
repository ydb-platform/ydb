...
namespace CHDBPoco { class Logger; namespace Util { class AbstractConfiguration; } }
...
private:
    ...
    using DictionaryReloader = std::function<std::unique_ptr<Dictionary>(const CHDBPoco::Util::AbstractConfiguration & config)>;
