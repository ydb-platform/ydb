...
ExternalLoader::LoadableMutablePtr ExternalDictionariesLoader::createObject(
        const std::string & name, const CHDBPoco::Util::AbstractConfiguration & config,
...
bool ExternalDictionariesLoader::doesConfigChangeRequiresReloadingObject(const CHDBPoco::Util::AbstractConfiguration & old_config, const String & old_key_in_config,
                                                                         const CHDBPoco::Util::AbstractConfiguration & new_config, const String & new_key_in_config) const
{
...
void ExternalDictionariesLoader::updateObjectFromConfigWithoutReloading(IExternalLoadable & object, const CHDBPoco::Util::AbstractConfiguration & config, const String & key_in_config) const
{
...
DictionaryStructure
ExternalDictionariesLoader::getDictionaryStructure(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & key_in_config)
{
