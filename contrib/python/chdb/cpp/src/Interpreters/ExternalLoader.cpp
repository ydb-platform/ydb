...
private:
    struct FileInfo
    {
        std::optional<CHDBPoco::Timestamp> last_update_time;
        bool in_use = true; // Whether the `FileInfo` should be destroyed because the correspondent file is deleted.
        CHDBPoco::AutoPtr<CHDBPoco::Util::AbstractConfiguration> file_contents; // Parsed contents of the file.
                                 ...
                                 bool check_no_errors) const
{
    ...
    if (result.exception)
    {
        ...
        {
            /// This will create a copy for CHDBPoco::Exception and DB_CHDB::Exception
            e.rethrow();
        }
        catch (...)
        {
            throw DB_CHDB::Exception(ErrorCodes::DICTIONARIES_WAS_NOT_LOADED,
