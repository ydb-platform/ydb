...
namespace DB_CHDB
{
using LoadablesConfigurationPtr = CHDBPoco::AutoPtr<CHDBPoco::Util::AbstractConfiguration>;
...
public:
    ...
    virtual std::optional<CHDBPoco::Timestamp> getUpdateTime(const std::string & /* path */) { return {}; }
