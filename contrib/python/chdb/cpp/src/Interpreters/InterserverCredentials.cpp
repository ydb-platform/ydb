...
InterserverCredentials::make(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & root_tag)
{
    ...
    const std::string & root_tag)
{
    ...
    CHDBPoco::Util::AbstractConfiguration::Keys old_users;
