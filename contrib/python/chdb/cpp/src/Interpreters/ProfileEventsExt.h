...
void dumpToMapColumn(const Counters::Snapshot & counters, DB_CHDB::IColumn * column, bool nonzero_only = true);

void getProfileEvents(
    const String & host_name,
    DB_CHDB::InternalProfileEventsQueuePtr profile_queue,
    DB_CHDB::Block & block,
...
extern std::shared_ptr<DB_CHDB::DataTypeEnum8> TypeEnum;
