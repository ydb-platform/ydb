...
namespace CHDBPoco::Net { class SocketAddress; }
...
public:
    ...
    void authenticate(const String & user_name, const String & password, const CHDBPoco::Net::SocketAddress & address);
    void authenticate(const Credentials & credentials_, const CHDBPoco::Net::SocketAddress & address_);
    ...
    void onAuthenticationFailure(const std::optional<String> & user_name, const CHDBPoco::Net::SocketAddress & address_, const Exception & e);
