...
struct StorageID
{
    ...
    static StorageID fromDictionaryConfig(const CHDBPoco::Util::AbstractConfiguration & config,
...
{
    template <>
    struct formatter<DB_CHDB::StorageID>
    {
        ...
        auto format(const DB_CHDB::StorageID & storage_id, FormatContext & ctx)
        {
