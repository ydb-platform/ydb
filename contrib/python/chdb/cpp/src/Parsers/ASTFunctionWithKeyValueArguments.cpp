...
{
    settings.ostr << (settings.hilite ? hilite_keyword : "") << CHDBPoco::toUpper(first) << " " << (settings.hilite ? hilite_none : "");
...
{
    settings.ostr << (settings.hilite ? hilite_keyword : "") << CHDBPoco::toUpper(name) << (settings.hilite ? hilite_none : "") << (has_brackets ? "(" : "");
