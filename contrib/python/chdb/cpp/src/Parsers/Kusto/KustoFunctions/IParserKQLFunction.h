...
public:
    ...
    static String getArgument(const String & function_name, DB_CHDB::IParser::Pos & pos, ArgumentState argument_state = ArgumentState::Parsed);
    static std::vector<std::string> getArguments(
        const String & function_name,
        DB_CHDB::IParser::Pos & pos,
    ...
    getOptionalArgument(const String & function_name, DB_CHDB::IParser::Pos & pos, ArgumentState argument_state = ArgumentState::Parsed);
    static String
