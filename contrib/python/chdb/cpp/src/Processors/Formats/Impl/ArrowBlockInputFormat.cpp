...
static std::shared_ptr<arrow20::RecordBatchReader> createStreamReader(ReadBuffer & in)
{
    auto options = arrow20::ipc::IpcReadOptions::Defaults();
    options.memory_pool = ArrowMemoryPool::instance();
    auto stream_reader_status = arrow20::ipc::RecordBatchStreamReader::Open(std::make_unique<ArrowInputStreamFromReadBuffer>(in), options);
...
static std::shared_ptr<arrow20::ipc::RecordBatchFileReader> createFileReader(ReadBuffer & in, const FormatSettings & format_settings, std::atomic<int> & is_stopped)
{
    ...
    auto options = arrow20::ipc::IpcReadOptions::Defaults();
    options.memory_pool = ArrowMemoryPool::instance();
    auto file_reader_status = arrow20::ipc::RecordBatchFileReader::Open(arrow_file, options);
