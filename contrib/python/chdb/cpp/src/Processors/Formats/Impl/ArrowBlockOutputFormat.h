...
namespace arrow20 { class Schema; }
namespace arrow20::ipc { class RecordBatchWriter; }
...
private:
    ...
    void prepareWriter(const std::shared_ptr<arrow20::Schema> & schema);

    bool stream;
    const FormatSettings format_settings;
    std::shared_ptr<ArrowBufferedOutputStream> arrow_ostream;
    std::shared_ptr<arrow20::ipc::RecordBatchWriter> writer;
