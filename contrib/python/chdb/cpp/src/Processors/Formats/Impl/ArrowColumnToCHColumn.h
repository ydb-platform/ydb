...
public:
    ...
    Chunk arrowTableToCHChunk(const std::shared_ptr<arrow20::Table> & table, size_t num_rows, BlockMissingValues * block_missing_values = nullptr);
...
private:
    struct ArrowColumn
    {
        ...
        std::shared_ptr<arrow20::Field> field;
    };
