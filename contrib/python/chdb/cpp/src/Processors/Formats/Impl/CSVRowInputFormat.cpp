...
bool CSVFormatReader::readFieldImpl(ReadBuffer & istr, DB_CHDB::IColumn & column, const DB_CHDB::DataTypePtr & type, const DB_CHDB::SerializationPtr & serialization)
{
...
bool CSVFormatReader::readFieldOrDefault(DB_CHDB::IColumn & column, const DB_CHDB::DataTypePtr & type, const DB_CHDB::SerializationPtr & serialization)
{
    String field;
    readCSVField(field, *buf, format_settings.csv);
...
std::pair<bool, size_t> fileSegmentationEngineCSVImpl(ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t min_rows, size_t max_rows, const FormatSettings & settings)
{
...
void registerFileSegmentationEngineCSV(FormatFactory & factory)
{
    auto register_func = [&](const String & format_name, bool, bool)
    {
        ...
        {
            return [settings] (ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t max_rows)
            {
