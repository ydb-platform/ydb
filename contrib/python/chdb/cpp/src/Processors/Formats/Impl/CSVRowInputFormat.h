...
public:
    ...
    bool readFieldImpl(ReadBuffer & istr, DB_CHDB::IColumn & column, const DB_CHDB::DataTypePtr & type, const DB_CHDB::SerializationPtr & serialization);
    bool readFieldOrDefault(DB_CHDB::IColumn & column, const DB_CHDB::DataTypePtr & type, const DB_CHDB::SerializationPtr & serialization);
