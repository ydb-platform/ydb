...
public:
    ...
    void visit(ASTPtr & ast, bool force_nullable)
    {
        ...
        if (auto * function = ast->as<ASTFunction>())
            ...
            throw DB_CHDB::Exception(ErrorCodes::SYNTAX_ERROR, "Identifier in constant expression");
        else
            throw DB_CHDB::Exception(ErrorCodes::SYNTAX_ERROR, "Syntax error in constant expression");
    }
