...
JSONRowInputFormat::JSONRowInputFormat(std::unique_ptr<PeekableReadBuffer> buf, const DB_CHDB::Block & header_, DB_CHDB::IRowInputFormat::Params params_, const DB_CHDB::FormatSettings & format_settings_)
...
void JSONRowInputFormat::setReadBuffer(DB_CHDB::ReadBuffer & in_)
{
...
JSONRowSchemaReader::JSONRowSchemaReader(std::unique_ptr<PeekableReadBuffer> buf, const DB_CHDB::FormatSettings & format_settings_, bool fallback_to_json_each_row_)
