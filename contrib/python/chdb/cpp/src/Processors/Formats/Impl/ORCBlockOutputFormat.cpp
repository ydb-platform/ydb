...
orc_chdb::CompressionKind getORCCompression(FormatSettings::ORCCompression method)
{
    if (method == FormatSettings::ORCCompression::NONE)
        return orc_chdb::CompressionKind::CompressionKind_NONE;

#if USE_SNAPPY
    if (method == FormatSettings::ORCCompression::SNAPPY)
        return orc_chdb::CompressionKind::CompressionKind_SNAPPY;
#endif

    if (method == FormatSettings::ORCCompression::ZSTD)
        return orc_chdb::CompressionKind::CompressionKind_ZSTD;

    if (method == FormatSettings::ORCCompression::LZ4)
        return orc_chdb::CompressionKind::CompressionKind_LZ4;

    if (method == FormatSettings::ORCCompression::ZLIB)
        return orc_chdb::CompressionKind::CompressionKind_ZLIB;
...
std::unique_ptr<orc_chdb::Type> ORCBlockOutputFormat::getORCType(const DataTypePtr & type)
{
    switch (type->getTypeId())
    {
        ...
        {
            if (isBool(type))
                return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::BOOLEAN);
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::BYTE);
        }
        ...
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::SHORT);
        }
        case TypeIndex::UInt32: [[fallthrough]];
        case TypeIndex::IPv4: [[fallthrough]];
        case TypeIndex::Int32:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::INT);
        }
        case TypeIndex::UInt64: [[fallthrough]];
        case TypeIndex::Int64:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::LONG);
        }
        case TypeIndex::Float32:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::FLOAT);
        }
        case TypeIndex::Float64:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::DOUBLE);
        }
        case TypeIndex::Date32: [[fallthrough]];
        case TypeIndex::Date:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::DATE);
        }
        case TypeIndex::DateTime: [[fallthrough]];
        case TypeIndex::DateTime64:
        {
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::TIMESTAMP);
        }
        ...
        case TypeIndex::Decimal256:
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::BINARY);
        case TypeIndex::FixedString: [[fallthrough]];
        case TypeIndex::String:
        {
            if (format_settings.orc.output_string_as_string)
                return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::STRING);
            return orc_chdb::createPrimitiveType(orc_chdb::TypeKind::BINARY);
        }
        case TypeIndex::IPv6:
        {
        ...
        case TypeIndex::Array:
        {
            ...
            return orc_chdb::createListType(getORCType(array_type->getNestedType()));
        }
        case TypeIndex::Decimal32:
        {
            const auto * decimal_type = assert_cast<const DataTypeDecimal<Decimal32> *>(type.get());
            return orc_chdb::createDecimalType(decimal_type->getPrecision(), decimal_type->getScale());
        }
        ...
        case TypeIndex::Tuple:
        {
            ...
            auto struct_type = orc_chdb::createStructType();
...
void ORCBlockOutputFormat::writeNumbers(
        orc_chdb::ColumnVectorBatch & orc_column,
...
void ORCBlockOutputFormat::writeStrings(
        ...
        const PaddedPODArray<UInt8> * /*null_bytemap*/)
{
    orc_chdb::StringVectorBatch & string_orc_column = dynamic_cast<orc_chdb::StringVectorBatch &>(orc_column);
...
{
    orc_chdb::TimestampVectorBatch & timestamp_orc_column = dynamic_cast<orc_chdb::TimestampVectorBatch &>(orc_column);
    ...
    const PaddedPODArray<UInt8> * null_bytemap)
{
    ...
    switch (type->getTypeId())
    {
        ...
        case TypeIndex::Int8:
        {
            ...
            writeNumbers<Int8, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const Int8 & value){ return Int64(Int8(value)); });
            break;
        }
        case TypeIndex::UInt8:
        {
            writeNumbers<UInt8, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const UInt8 & value){ return Int64(Int8(value)); });
            break;
        }
        case TypeIndex::Enum16: [[fallthrough]];
        case TypeIndex::Int16:
        {
            writeNumbers<Int16, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const Int16 & value){ return value; });
            break;
        }
        case TypeIndex::Date: [[fallthrough]];
        case TypeIndex::UInt16:
        {
            writeNumbers<UInt16, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const UInt16 & value){ return Int64(Int16(value)); });
            break;
        }
        case TypeIndex::Date32: [[fallthrough]];
        case TypeIndex::Int32:
        {
            writeNumbers<Int32, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const Int32 & value){ return value; });
            break;
        }
        case TypeIndex::UInt32:
        {
            writeNumbers<UInt32, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const UInt32 & value){ return Int64(Int32(value)); });
            break;
        }
        case TypeIndex::IPv4:
        {
            writeNumbers<IPv4, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const IPv4 & value){ return Int64(Int32(value.toUnderType())); });
            break;
        }
        case TypeIndex::Int64:
        {
            writeNumbers<Int64, orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const Int64 & value){ return value; });
            break;
        }
        case TypeIndex::UInt64:
        {
            writeNumbers<UInt64,orc_chdb::LongVectorBatch>(orc_column, column, null_bytemap, [](const UInt64 & value){ return value; });
            break;
        }
        ...
        case TypeIndex::Float32:
        {
            writeNumbers<Float32, orc_chdb::DoubleVectorBatch>(orc_column, column, null_bytemap, [](const Float32 & value){ return value; });
            break;
        }
        case TypeIndex::Float64:
        {
            writeNumbers<Float64, orc_chdb::DoubleVectorBatch>(orc_column, column, null_bytemap, [](const Float64 & value){ return value; });
            break;
        }
        ...
        case TypeIndex::Decimal32: {
            writeDecimals<Decimal32, orc_chdb::Decimal64VectorBatch>(
                    orc_column,
                    column,
                    type,
                    null_bytemap,
        ...
        case TypeIndex::Decimal64:
        {
            writeDecimals<Decimal64, orc_chdb::Decimal64VectorBatch>(
                    orc_column,
                    column,
                    type,
                    null_bytemap,
        ...
        case TypeIndex::Decimal128:
        {
            writeDecimals<Decimal128, orc_chdb::Decimal128VectorBatch>(
                    orc_column,
                    column,
                    type,
                    null_bytemap,
                    [](Int128 value){ return orc_chdb::Int128(value >> 64, (value << 64) >> 64); });
            break;
        }
        case TypeIndex::Decimal256:
        {
        ...
        case TypeIndex::Array:
        {
            orc_chdb::ListVectorBatch & list_orc_column = dynamic_cast<orc_chdb::ListVectorBatch &>(orc_column);
            ...
            orc_chdb::ColumnVectorBatch & nested_orc_column = *list_orc_column.elements;
            writeColumn(nested_orc_column, list_column.getData(), nested_type, nullptr);
            break;
        }
        case TypeIndex::Tuple:
        {
            orc_chdb::StructVectorBatch & struct_orc_column = dynamic_cast<orc_chdb::StructVectorBatch &>(orc_column);
        ...
        case TypeIndex::Map:
        {
            orc_chdb::MapVectorBatch & map_orc_column = dynamic_cast<orc_chdb::MapVectorBatch &>(orc_column);
            ...
            orc_chdb::ColumnVectorBatch & keys_orc_column = *map_orc_column.keys;
            auto key_type = map_type.getKeyType();
            writeColumn(keys_orc_column, *nested_columns[0], key_type, nullptr);

            orc_chdb::ColumnVectorBatch & values_orc_column = *map_orc_column.elements;
...
void ORCBlockOutputFormat::consume(Chunk chunk)
{
    ...
    std::unique_ptr<orc_chdb::ColumnVectorBatch> batch = writer->createRowBatch(chunk.getNumRows());
    orc_chdb::StructVectorBatch & root = dynamic_cast<orc_chdb::StructVectorBatch &>(*batch);
...
void ORCBlockOutputFormat::prepareWriter()
{
    ...
    schema = orc_chdb::createStructType();
    ...
    writer = orc_chdb::createWriter(*schema, &output_stream, options);
}
