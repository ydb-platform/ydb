...
private:
    ...
    std::unique_ptr<parquet20::ColumnChunkMetaData> col_chunk_meta;
    std::unique_ptr<parquet20::PageReader> parquet_page_reader;
    ...
    void readPage();
    void readPageV1(const parquet20::DataPageV1 & page);
    void readPageV2(const parquet20::DataPageV2 & page);
