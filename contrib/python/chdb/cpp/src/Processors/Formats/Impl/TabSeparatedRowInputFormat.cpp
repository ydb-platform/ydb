...
static std::pair<bool, size_t> fileSegmentationEngineTabSeparatedImpl(ReadBuffer & in, DB_CHDB::Memory<> & memory, bool is_raw, size_t min_bytes, size_t min_rows, size_t max_rows)
{
...
void registerFileSegmentationEngineTabSeparated(FormatFactory & factory)
{
    for (bool is_raw : {false, true})
    {
        auto register_func = [&](const String & format_name, bool, bool)
        {
            ...
            factory.registerFileSegmentationEngine(format_name, [is_raw](ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t max_rows)
            {
    ...
    factory.registerFileSegmentationEngine("TSKV", [](ReadBuffer & in, DB_CHDB::Memory<> & memory, size_t min_bytes, size_t max_rows)
    {
