...
void registerOutputFormatTemplate(FormatFactory & factory)
{
            ...
            const FormatSettings & settings)
    {
        ...
        else
        {
            ...
            if (!settings.template_settings.resultset_format_template.empty())
            {
                throw Exception(DB_CHDB::ErrorCodes::INVALID_TEMPLATE_FORMAT, "Expected either format_template_resultset or format_template_resultset_format, but not both");
            }
        }
        ...
        else
        {
            ...
            {
                throw Exception(DB_CHDB::ErrorCodes::INVALID_TEMPLATE_FORMAT, "Expected either format_template_row or format_template_row_format, but not both");
            }
        }
