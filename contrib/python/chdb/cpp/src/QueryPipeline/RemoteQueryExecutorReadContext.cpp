...
void RemoteQueryExecutorReadContext::processAsyncEvent(int fd, CHDBPoco::Timespan socket_timeout, AsyncEventTimeoutType type, const std::string & description, uint32_t events)
{
    connection_fd = fd;
...
{
    /// connection_fd is closed by CHDBPoco::Net::Socket or Epoll
    if (pipe_fd[0] != -1)
    {
