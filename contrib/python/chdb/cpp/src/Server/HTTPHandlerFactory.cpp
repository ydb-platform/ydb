...
createHTTPHandlerFactory(IServer & server, const CHDBPoco::Util::AbstractConfiguration & config, const std::string & name, AsynchronousMetrics & async_metrics)
{
...
HTTPRequestHandlerFactoryPtr createHandlerFactory(IServer & server, const CHDBPoco::Util::AbstractConfiguration & config, AsynchronousMetrics & async_metrics, const std::string & name)
{
    ...
    query_handler->addFilter([](const auto & request)
        {
            ...
            bool is_get_or_head_request = request.getMethod() == CHDBPoco::Net::HTTPRequest::HTTP_GET
            ...
            bool is_post_or_options_request = request.getMethod() == CHDBPoco::Net::HTTPRequest::HTTP_POST
