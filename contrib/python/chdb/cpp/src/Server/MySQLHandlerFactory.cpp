    ...
    , write_event(write_event_)
{
    ...
    try
    {
        CHDBPoco::Net::SSLManager::instance().defaultServerContext();
    }
    catch (...)
    {
...
{
    const CHDBPoco::Util::LayeredConfiguration & config = CHDBPoco::Util::Application::instance().config();
...
CHDBPoco::Net::TCPServerConnection * MySQLHandlerFactory::createConnection(const CHDBPoco::Net::StreamSocket & socket, TCPServer & tcp_server)
{
