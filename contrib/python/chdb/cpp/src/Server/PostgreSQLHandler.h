 ...
 */
class PostgreSQLHandler : public CHDBPoco::Net::TCPServerConnection
{
public:
    PostgreSQLHandler(
...
private:
...
#if USE_SSL
    std::shared_ptr<CHDBPoco::Net::SecureStreamSocket> ss;
#endif
    ...
    void changeIO(CHDBPoco::Net::StreamSocket & socket);
