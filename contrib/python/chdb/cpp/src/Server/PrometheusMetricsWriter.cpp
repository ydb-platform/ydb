...
template <typename T>
void writeOutLine(DB_CHDB::WriteBuffer & wb, T && val)
{
    DB_CHDB::writeText(std::forward<T>(val), wb);
    DB_CHDB::writeChar('\n', wb);
}

template <typename T, typename... TArgs>
void writeOutLine(DB_CHDB::WriteBuffer & wb, T && val, TArgs &&... args)
{
    DB_CHDB::writeText(std::forward<T>(val), wb);
...
void writeEvent(DB_CHDB::WriteBuffer & wb, ProfileEvents::Event event)
{
...
void writeMetric(DB_CHDB::WriteBuffer & wb, size_t metric)
{
...
void writeAsyncMetrics(DB_CHDB::WriteBuffer & wb, const DB_CHDB::AsynchronousMetricValues & values)
{
