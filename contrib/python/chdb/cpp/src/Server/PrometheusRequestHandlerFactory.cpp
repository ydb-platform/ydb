...
namespace
{
    ...
    void parseCommonConfig(const CHDBPoco::Util::AbstractConfiguration & config, PrometheusRequestHandlerConfig & res)
    {
    ...
    /// <events>true</events>
    /// <errors>true</errors>
    PrometheusRequestHandlerConfig parseExposeMetricsConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
    ...
    QualifiedTableName parseTableNameFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
    ...
    PrometheusRequestHandlerConfig parseRemoteWriteConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
        PrometheusRequestHandlerConfig res;
    ...
    /// <table>db.time_series_table_name</table>
    PrometheusRequestHandlerConfig parseRemoteReadConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
        PrometheusRequestHandlerConfig res;
    ...
    /// <table>db.time_series_table_name</table>
    PrometheusRequestHandlerConfig parseHandlerConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
