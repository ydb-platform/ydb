...
class TCPHandler : public CHDBPoco::Net::TCPServerConnection
{
public:
...
private:
    ...
    CHDBPoco::Timespan sleep_in_send_tables_status;
    UInt64 unknown_packet_in_send_data = 0;
    CHDBPoco::Timespan sleep_after_receiving_query;
    ...
    CHDBPoco::Net::SocketAddress getClientAddress(const ClientInfo & client_info);
};
