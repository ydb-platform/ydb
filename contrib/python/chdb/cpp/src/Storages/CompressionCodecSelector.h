...
private:
    struct Element
    {
        ...
        Element(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
        {
...
public:
    ...
    CompressionCodecSelector(const CHDBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
    {
