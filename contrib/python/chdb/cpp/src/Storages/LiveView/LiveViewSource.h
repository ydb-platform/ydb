        ...
        {
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        UInt64 timestamp_usec = static_cast<UInt64>(CHDBPoco::Timestamp().epochMicroseconds());
                        ...
                        {
                            // heartbeat
                            last_event_timestamp_usec = static_cast<UInt64>(CHDBPoco::Timestamp().epochMicroseconds());
                            return { getPort().getHeader(), true };
                        }
                    }
                }
