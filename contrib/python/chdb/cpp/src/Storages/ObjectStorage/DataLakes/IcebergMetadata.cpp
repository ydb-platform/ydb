...
IcebergMetadata::IcebergMetadata(
    ...
    DB_CHDB::ContextPtr context_,
    Int32 metadata_version_,
    Int32 format_version_,
    String manifest_list_file_,
    Int32 current_schema_id_,
    DB_CHDB::NamesAndTypesList schema_)
...
DataTypePtr getFieldType(const CHDBPoco::JSON::Object::Ptr & field, const String & type_key, bool required);
...
std::pair<NamesAndTypesList, Int32> parseTableSchema(const CHDBPoco::JSON::Object::Ptr & metadata_object, int format_version, bool ignore_schema_evolution)
{
    CHDBPoco::JSON::Object::Ptr schema;
    ...
    if (format_version == 2)
    {
        ...
        auto schemas = metadata_object->get("schemas").extract<CHDBPoco::JSON::Array::Ptr>();
        if (schemas->size() == 0)
    ...
    else
    {
        ...
        if (!ignore_schema_evolution && metadata_object->has("schemas") && metadata_object->get("schemas").extract<CHDBPoco::JSON::Array::Ptr>()->size() > 1)
            throw Exception(ErrorCodes::UNSUPPORTED_METHOD,
    ...
    auto fields = schema->get("fields").extract<CHDBPoco::JSON::Array::Ptr>();
    for (size_t i = 0; i != fields->size(); ++i)
    {
    ...
    ContextPtr local_context)
{
    ...
    CHDBPoco::JSON::Parser parser; /// For some reason base/base/JSON.h can not parse this json file
    ...
    auto snapshots = object->get("snapshots").extract<CHDBPoco::JSON::Array::Ptr>();
...
Strings IcebergMetadata::getDataFiles() const
{
    ...
    for (const auto & manifest_file : manifest_files)
    {
        ...
        // CHDBPoco::Dynamic::Var json = parser.parse(schema_json_string);
        // CHDBPoco::JSON::Object::Ptr schema_object = json.extract<CHDBPoco::JSON::Object::Ptr>();
