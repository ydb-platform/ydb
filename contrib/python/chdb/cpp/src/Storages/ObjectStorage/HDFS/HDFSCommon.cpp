...
void HDFSBuilderWrapper::loadFromConfig(
    const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix, [[maybe_unused]] bool isUser)
{
...
HDFSBuilderWrapper createHDFSBuilder(const String & uri_str, const CHDBPoco::Util::AbstractConfiguration & config)
{
    const CHDBPoco::URI uri(uri_str);
