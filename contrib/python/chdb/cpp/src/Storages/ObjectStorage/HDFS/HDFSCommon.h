...
friend HDFSBuilderWrapper createHDFSBuilder(const String & uri_str, const CHDBPoco::Util::AbstractConfiguration &);
...
private:
    void loadFromConfig(const CHDBPoco::Util::AbstractConfiguration & config, const String & prefix, bool isUser = false);
...
HDFSBuilderWrapper createHDFSBuilder(const String & uri_str, const CHDBPoco::Util::AbstractConfiguration &);
