...
public:
    ...
    ReadFromObjectStorageStep(
        ...
        const std::optional<DB_CHDB::FormatSettings> & format_settings_,
        bool distributed_processing_,
...
private:
    ...
    const std::optional<DB_CHDB::FormatSettings> format_settings;
    const String name;
...
{
    return DB_CHDB::prepareReadingFromFormat(requested_columns, storage_snapshot, supports_subset_of_columns);
}
