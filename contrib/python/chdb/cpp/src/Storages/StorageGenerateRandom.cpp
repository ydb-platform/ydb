    ...
    ContextPtr context)
{
    ...
    switch (idx)
    {
        ...
        case TypeIndex::Decimal32:
        {
            ...
            Int32 range = common_CHDB::exp10_i32(decimal_type.getPrecision());
            for (size_t i = 0; i != limit; ++i)
        ...
        case TypeIndex::Decimal64:
        {
            ...
            data.resize(limit);
            /// Generate numbers from range [-10^P + 1, 10^P - 1]
            Int64 range = common_CHDB::exp10_i64(decimal_type.getPrecision());
            for (size_t i = 0; i != limit; ++i)
        ...
        case TypeIndex::Decimal128:
        {
            ...
            data.resize(limit);
            /// Generate numbers from range [-10^P + 1, 10^P - 1]
            Int128 range = common_CHDB::exp10_i128(decimal_type.getPrecision());
            for (size_t i = 0; i != limit; ++i)
        ...
        case TypeIndex::Decimal256:
        {
            ...
            data.resize(limit);
            /// Generate numbers from range [-10^P + 1, 10^P - 1]
            Int256 range = common_CHDB::exp10_i256(decimal_type.getPrecision());
            for (size_t i = 0; i != limit; ++i)
    ...
    size_t num_streams)
{
    ...
    if (preferred_block_size_bytes)
    {
        ...
        if (common_CHDB::mulOverflow(max_block_size, estimated_row_size_bytes, estimated_block_size_bytes))
