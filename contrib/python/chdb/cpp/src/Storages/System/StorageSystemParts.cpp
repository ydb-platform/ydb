...
std::string_view getRemovalStateDescription(DB_CHDB::DataPartRemovalState state)
{
    switch (state)
    {
    case DB_CHDB::DataPartRemovalState::NOT_ATTEMPTED:
        return "Cleanup thread hasn't seen this part yet";
    case DB_CHDB::DataPartRemovalState::VISIBLE_TO_TRANSACTIONS:
        return "Part maybe visible for transactions";
    case DB_CHDB::DataPartRemovalState::NON_UNIQUE_OWNERSHIP:
        return "Part ownership is not unique";
    case DB_CHDB::DataPartRemovalState::NOT_REACHED_REMOVAL_TIME:
        return "Part hasn't reached removal time yet";
    case DB_CHDB::DataPartRemovalState::HAS_SKIPPED_MUTATION_PARENT:
        return "Waiting mutation parent to be removed";
    case DB_CHDB::DataPartRemovalState::EMPTY_PART_COVERS_OTHER_PARTS:
        return "Waiting for covered parts to be removed first";
    case DB_CHDB::DataPartRemovalState::REMOVED:
