...
void StorageSystemUsers::fillData(MutableColumns & res_columns, ContextPtr context, const ActionsDAG::Node *, std::vector<UInt8>) const
{
                       ...
                       const String default_database)
    {
        ...
        {
            CHDBPoco::JSON::Object auth_params_json;
            ...
            {
                CHDBPoco::JSON::Array::Ptr common_names = new CHDBPoco::JSON::Array();
                CHDBPoco::JSON::Array::Ptr subject_alt_names = new CHDBPoco::JSON::Array();
            ...
            CHDBPoco::JSON::Stringifier::stringify(auth_params_json, oss);
