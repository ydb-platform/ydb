...
(() => {
  ...
  var ListSortable = class {
    ...
    async onStart(evt) {
      var _a, _b, _c, _d;
      evt.oldIndex;
      const firstOrder = (_b = (_a = this.tableBody.querySelector("tr:first-child")) == null ? void 0 : _a.querySelector(".handle")) == null ? void 0 : _b.getAttribute("order");
      const lastOrder = (_d = (_c = this.tableBody.querySelector("tr:last-child")) == null ? void 0 : _c.querySelector(".handle")) == null ? void 0 : _d.getAttribute("order");
    ...
    async onEnd(evt) {
      ...
      if (firstChild === 0) {
        ...
        order = (_a = this.tableBody.querySelector(`tr:nth-child(${firstChild}) .handle`)) == null ? void 0 : _a.getAttribute("order");
        if (!order)
          return;
        order = parseInt(order) + this.orderDirection;
      }
      const updatedItems = /* @__PURE__ */ new Map();
      for (let row of updatedRows) {
        const pk = (_b = row.querySelector(".handle")) == null ? void 0 : _b.getAttribute("pk");
        if (pk) {
          (_c = row.querySelector(".handle")) == null ? void 0 : _c.setAttribute("order", String(order));
    ...
    resetActions() {
      ...
      actionsEls.forEach((elem2) => {
        ...
        sortable_esm_default.utils.deselect(tableRow);
        tableRow == null ? void 0 : tableRow.classList.remove("selected");
        elem2.checked = false;
      });
    ...
    get headers() {
      ...
      const inputElement = (_a = this.tableBody.closest("form")) == null ? void 0 : _a.querySelector('input[name="csrfmiddlewaretoken"]');
      if (inputElement) {
  ...
  var ActionForm = class {
    ...
    actionChanged() {
      ...
      switch ((_a = this.selectElement) == null ? void 0 : _a.value) {
