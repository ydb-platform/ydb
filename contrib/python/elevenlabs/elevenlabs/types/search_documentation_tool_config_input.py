...
class SearchDocumentationToolConfigInput(UncheckedBaseModel):
    """
    ...
    source_configs: typing.Optional[typing.List[SourceRetrievalConfig]] = pydantic.Field(default=None)
    """
