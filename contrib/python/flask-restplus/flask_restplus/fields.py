...
class Raw(object):
    ...
    def __init__(self, default=None, attribute=None, title=None, description=None,
                 required=None, readonly=None, example=None, mask=None, allow_null_in_schema=False,
                 **kwargs):
        ...
        self.mask = mask
        self.allow_null_in_schema = allow_null_in_schema
    ...
    def schema(self):
        if self.allow_null_in_schema:
            type_ = [self.__schema_type__, 'null']
        else:
            type_ = self.__schema_type__
