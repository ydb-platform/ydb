...
class RawModel(ModelBase):
    ...
    def __init__(self, name, *args, **kwargs):
        ...
        self.__allow_null_in_schema__ = kwargs.pop('allow_null_in_schema', False)
    ...
    def _schema(self):
        ...
        return not_none({
            ...
            'type': ['object', 'null'] if self.__allow_null_in_schema__ else 'object',
        })
    ...
    def __deepcopy__(self, memo):
        obj = self.__class__(
            ...
            mask=self.__mask__,
            allow_null_in_schema=self.__allow_null_in_schema__
        )
