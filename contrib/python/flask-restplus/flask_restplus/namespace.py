...
class Namespace(object):
    ...
    def model(self, name=None, model=None, mask=None, allow_null_in_schema=False, **kwargs):
        '''
        Register a model
        ...
        model = cls(name, model, mask=mask, allow_null_in_schema=allow_null_in_schema)
