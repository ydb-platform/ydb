...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v20.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The type of the attribute.
        attribute (google.ads.googleads.v20.common.types.AudienceInsightsAttribute):
        ...
        viewer_share (float):
            ...
            1. This field is not populated in every
                response.
        youtube_channel_metadata (google.ads.googleads.v20.common.types.YouTubeChannelAttributeMetadata):
            Special metadata for a YouTube channel.

            This field is a member of `oneof`_ ``dimension_metadata``.
        youtube_video_metadata (google.ads.googleads.v20.common.types.YouTubeVideoAttributeMetadata):
            Special metadata for a YouTube video.

            This field is a member of `oneof`_ ``dimension_metadata``.
        lineup_attribute_metadata (google.ads.googleads.v20.common.types.LineupAttributeMetadata):
            Special metadata for a YouTube Lineup.

            This field is a member of `oneof`_ ``dimension_metadata``.
        location_attribute_metadata (google.ads.googleads.v20.common.types.LocationAttributeMetadata):
            Special metadata for a Location.

            This field is a member of `oneof`_ ``dimension_metadata``.
        user_interest_attribute_metadata (google.ads.googleads.v20.common.types.UserInterestAttributeMetadata):
            Special metadata for a User Interest.

            This field is a member of `oneof`_ ``dimension_metadata``.
        knowledge_graph_attribute_metadata (google.ads.googleads.v20.common.types.KnowledgeGraphAttributeMetadata):
...
class AudienceInsightsAttribute(proto.Message):
    ...
    Attributes:
        age_range (google.ads.googleads.v20.common.types.AgeRangeInfo):
            An audience attribute defined by an age
            range.

            This field is a member of `oneof`_ ``attribute``.
        gender (google.ads.googleads.v20.common.types.GenderInfo):
            An audience attribute defined by a gender.

            This field is a member of `oneof`_ ``attribute``.
        location (google.ads.googleads.v20.common.types.LocationInfo):
            An audience attribute defined by a geographic
            location.

            This field is a member of `oneof`_ ``attribute``.
        user_interest (google.ads.googleads.v20.common.types.UserInterestInfo):
            An Affinity or In-Market audience.

            This field is a member of `oneof`_ ``attribute``.
        entity (google.ads.googleads.v20.common.types.AudienceInsightsEntity):
            An audience attribute defined by interest in
            a topic represented by a Knowledge Graph entity.

            This field is a member of `oneof`_ ``attribute``.
        category (google.ads.googleads.v20.common.types.AudienceInsightsCategory):
            An audience attribute defined by interest in
            a Product & Service category.

            This field is a member of `oneof`_ ``attribute``.
        lineup (google.ads.googleads.v20.common.types.AudienceInsightsLineup):
            A YouTube Lineup.

            This field is a member of `oneof`_ ``attribute``.
        parental_status (google.ads.googleads.v20.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).

            This field is a member of `oneof`_ ``attribute``.
        income_range (google.ads.googleads.v20.common.types.IncomeRangeInfo):
        ...
        youtube_channel (google.ads.googleads.v20.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``attribute``.
        youtube_video (google.ads.googleads.v20.common.types.YouTubeVideoInfo):
            A YouTube video.

            This field is a member of `oneof`_ ``attribute``.
        device (google.ads.googleads.v20.common.types.DeviceInfo):
...
class LineupAttributeMetadata(proto.Message):
    ...
    Attributes:
        inventory_country (google.ads.googleads.v20.common.types.LocationInfo):
        ...
        sample_channels (MutableSequence[google.ads.googleads.v20.common.types.LineupAttributeMetadata.SampleChannel]):
