...
from google.ads.googleads.v20.enums.types import asset_field_type
from google.ads.googleads.v20.enums.types import asset_performance_label
from google.ads.googleads.v20.enums.types import asset_source
from google.ads.googleads.v20.enums.types import policy_approval_status
from google.ads.googleads.v20.enums.types import policy_review_status
from google.ads.googleads.v20.enums.types import served_asset_field_type
...
class AdGroupAdAssetView(proto.Message):
    ...
    Attributes:
        ...
        field_type (google.ads.googleads.v20.enums.types.AssetFieldTypeEnum.AssetFieldType):
        ...
        policy_summary (google.ads.googleads.v20.resources.types.AdGroupAdAssetPolicySummary):
            Output only. Policy information for the ad
            group ad asset.
        performance_label (google.ads.googleads.v20.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            Output only. Performance of an asset linkage.
        pinned_field (google.ads.googleads.v20.enums.types.ServedAssetFieldTypeEnum.ServedAssetFieldType):
            Output only. Pinned field.
        source (google.ads.googleads.v20.enums.types.AssetSourceEnum.AssetSource):
...
class AdGroupAdAssetPolicySummary(proto.Message):
    ...
    Attributes:
        ...
        review_status (google.ads.googleads.v20.enums.types.PolicyReviewStatusEnum.PolicyReviewStatus):
            Output only. Where in the review process this
            ad group ad asset is.
        approval_status (google.ads.googleads.v20.enums.types.PolicyApprovalStatusEnum.PolicyApprovalStatus):
