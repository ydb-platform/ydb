...
from google.ads.googleads.v20.enums.types import asset_link_primary_status
from google.ads.googleads.v20.enums.types import (
    asset_link_primary_status_reason,
)
from google.ads.googleads.v20.enums.types import asset_link_status
...
class AdGroupAsset(proto.Message):
    ...
    Attributes:
        ...
        source (google.ads.googleads.v20.enums.types.AssetSourceEnum.AssetSource):
            ...
            link.
        status (google.ads.googleads.v20.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
            Status of the ad group asset.
        primary_status (google.ads.googleads.v20.enums.types.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus):
        ...
        primary_status_details (MutableSequence[google.ads.googleads.v20.common.types.AssetLinkPrimaryStatusDetails]):
            Output only. Provides the details of the
            primary status and its associated reasons.
        primary_status_reasons (MutableSequence[google.ads.googleads.v20.enums.types.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason]):
