...
from google.ads.googleads.v20.enums.types import asset_set_asset_status
...
class AssetSetAsset(proto.Message):
    ...
    Attributes:
        ...
        asset (str):
            ...
            asset is linking to.
        status (google.ads.googleads.v20.enums.types.AssetSetAssetStatusEnum.AssetSetAssetStatus):
