...
from google.ads.googleads.v20.common.types import audiences
from google.ads.googleads.v20.enums.types import audience_scope
from google.ads.googleads.v20.enums.types import audience_status
...
class Audience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v20.enums.types.AudienceStatusEnum.AudienceStatus):
        ...
        dimensions (MutableSequence[google.ads.googleads.v20.common.types.AudienceDimension]):
            Positive dimensions specifying the audience
            composition.
        exclusion_dimension (google.ads.googleads.v20.common.types.AudienceExclusionDimension):
            Negative dimension specifying the audience
            composition.
        scope (google.ads.googleads.v20.enums.types.AudienceScopeEnum.AudienceScope):
