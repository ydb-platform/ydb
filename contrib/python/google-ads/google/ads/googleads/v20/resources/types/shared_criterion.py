...
class SharedCriterion(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v20.enums.types.CriterionTypeEnum.CriterionType):
        ...
        youtube_channel (google.ads.googleads.v20.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        placement (google.ads.googleads.v20.common.types.PlacementInfo):
            Immutable. Placement.

            This field is a member of `oneof`_ ``criterion``.
        mobile_app_category (google.ads.googleads.v20.common.types.MobileAppCategoryInfo):
            Immutable. Mobile App Category.

            This field is a member of `oneof`_ ``criterion``.
        mobile_application (google.ads.googleads.v20.common.types.MobileApplicationInfo):
            Immutable. Mobile application.

            This field is a member of `oneof`_ ``criterion``.
        brand (google.ads.googleads.v20.common.types.BrandInfo):
            Immutable. Brand.

            This field is a member of `oneof`_ ``criterion``.
        webpage (google.ads.googleads.v20.common.types.WebpageInfo):
            Immutable. Webpage.
