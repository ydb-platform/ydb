...
class UserInterest(proto.Message):
    ...
    Attributes:
        ...
        taxonomy_type (google.ads.googleads.v20.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType):
        ...
        availabilities (MutableSequence[google.ads.googleads.v20.common.types.CriterionCategoryAvailability]):
