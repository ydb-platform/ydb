    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.AdGroupAssetSetService",
...
class AdGroupAssetSetServiceGrpcAsyncIOTransport(
    AdGroupAssetSetServiceTransport
):
    """gRPC AsyncIO backend transport for AdGroupAssetSetService.
    ...
    def mutate_ad_group_asset_sets(
        ...
        Returns:
            Callable[[~.MutateAdGroupAssetSetsRequest],
                    Awaitable[~.MutateAdGroupAssetSetsResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_asset_sets: self._wrap_method(
                self.mutate_ad_group_asset_sets,
