    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.AdGroupCriterionCustomizerService",
...
class AdGroupCriterionCustomizerServiceGrpcTransport(
    ...
    """gRPC backend transport for AdGroupCriterionCustomizerService.
        ...
        if "mutate_ad_group_criterion_customizers" not in self._stubs:
            self._stubs["mutate_ad_group_criterion_customizers"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.AdGroupCriterionCustomizerService/MutateAdGroupCriterionCustomizers",
...
__all__ = ("AdGroupCriterionCustomizerServiceGrpcTransport",)
