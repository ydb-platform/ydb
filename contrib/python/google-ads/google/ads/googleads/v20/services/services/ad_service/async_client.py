...
class AdServiceAsyncClient:
    ...
    _client: AdServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = AdServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = AdServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = AdServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AdServiceClient._DEFAULT_UNIVERSE

    ad_path = staticmethod(AdServiceClient.ad_path)
    parse_ad_path = staticmethod(AdServiceClient.parse_ad_path)
    common_billing_account_path = staticmethod(
        AdServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        AdServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(AdServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        AdServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        AdServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        AdServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(AdServiceClient.common_project_path)
    ...
    parse_common_location_path = staticmethod(
        AdServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AdServiceAsyncClient: The constructed client.
        """
        sa_info_func = (
            AdServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(AdServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            AdServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(AdServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return AdServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = AdServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AdServiceTransport, Callable[..., AdServiceTransport]]
        ] = "grpc_asyncio",
        client_options: Optional[ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the ad service async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AdServiceTransport,Callable[..., AdServiceTransport]]]):
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v20.services.AdServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v20.services.AdService",
    ...
    async def mutate_ads(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.MutateAdsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v20.services.types.AdOperation]`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateAdsResponse:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.mutate_ads
        ]
