...
from google.ads.googleads.v20.services.types import asset_group_service
...
class AssetGroupServiceTransport(abc.ABC):
    """Abstract transport class for AssetGroupService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_asset_groups: gapic_v1.method.wrap_method(
                self.mutate_asset_groups,
    ...
    def mutate_asset_groups(
        ...
        Union[
            ...
            Awaitable[asset_group_service.MutateAssetGroupsResponse],
        ],
    ]:
        raise NotImplementedError()
