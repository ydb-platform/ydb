...
class AudienceInsightsServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            AudienceInsightsServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            AudienceInsightsServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            AudienceInsightsServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            AudienceInsightsServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v20.services.AudienceInsightsServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.GenerateInsightsFinderReportRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            baseline_audience (:class:`google.ads.googleads.v20.services.types.BasicInsightsAudience`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            specific_audience (:class:`google.ads.googleads.v20.services.types.BasicInsightsAudience`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateInsightsFinderReportResponse:
    ...
    async def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.ListAudienceInsightsAttributesRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            dimensions (:class:`MutableSequence[google.ads.googleads.v20.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.ListAudienceInsightsAttributesResponse:
    ...
    async def list_insights_eligible_dates(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.ListInsightsEligibleDatesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.ListInsightsEligibleDatesResponse:
                Response message for
                   [AudienceInsightsService.ListInsightsEligibleDates][google.ads.googleads.v20.services.AudienceInsightsService.ListInsightsEligibleDates].
    ...
    async def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.GenerateAudienceCompositionInsightsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            audience (:class:`google.ads.googleads.v20.services.types.InsightsAudience`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateAudienceCompositionInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateAudienceCompositionInsights][google.ads.googleads.v20.services.AudienceInsightsService.GenerateAudienceCompositionInsights].
    ...
    async def generate_suggested_targeting_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.GenerateSuggestedTargetingInsightsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateSuggestedTargetingInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateSuggestedTargetingInsights][google.ads.googleads.v20.services.AudienceInsightsService.GenerateSuggestedTargetingInsights].
    ...
    async def generate_audience_overlap_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.GenerateAudienceOverlapInsightsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            country_location (:class:`google.ads.googleads.v20.common.types.LocationInfo`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            primary_attribute (:class:`google.ads.googleads.v20.common.types.AudienceInsightsAttribute`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateAudienceOverlapInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateAudienceOverlapInsights][google.ads.googleads.v20.services.AudienceInsightsService.GenerateAudienceOverlapInsights].
    ...
    async def generate_targeting_suggestion_metrics(
        ...
        *,
        customer_id: Optional[str] = None,
        audiences: Optional[
            MutableSequence[audience_insights_service.BasicInsightsAudience]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.GenerateTargetingSuggestionMetricsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            audiences (:class:`MutableSequence[google.ads.googleads.v20.services.types.BasicInsightsAudience]`):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateTargetingSuggestionMetricsResponse:
                Response message for
                   [AudienceInsightsService.GenerateTargetingSuggestionMetrics][google.ads.googleads.v20.services.AudienceInsightsService.GenerateTargetingSuggestionMetrics].
