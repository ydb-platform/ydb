...
class AudienceInsightsServiceTransport(abc.ABC):
    """Abstract transport class for AudienceInsightsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_insights_finder_report: gapic_v1.method.wrap_method(
                self.generate_insights_finder_report,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_audience_insights_attributes: gapic_v1.method.wrap_method(
                self.list_audience_insights_attributes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_insights_eligible_dates: gapic_v1.method.wrap_method(
            ...
            self.generate_targeting_suggestion_metrics: gapic_v1.method.wrap_method(
