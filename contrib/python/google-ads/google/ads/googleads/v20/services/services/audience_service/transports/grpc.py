...
from .base import AudienceServiceTransport, DEFAULT_CLIENT_INFO
...
class AudienceServiceGrpcTransport(AudienceServiceTransport):
    """gRPC backend transport for AudienceService.
    ...
    def mutate_audiences(
        ...
        r"""Return a callable for the mutate audiences method over gRPC.
        ...
        Returns:
            Callable[[~.MutateAudiencesRequest],
        ...
        if "mutate_audiences" not in self._stubs:
            self._stubs["mutate_audiences"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v20.services.AudienceService/MutateAudiences",
                request_serializer=audience_service.MutateAudiencesRequest.serialize,
                response_deserializer=audience_service.MutateAudiencesResponse.deserialize,
            )
        return self._stubs["mutate_audiences"]
...
__all__ = ("AudienceServiceGrpcTransport",)
