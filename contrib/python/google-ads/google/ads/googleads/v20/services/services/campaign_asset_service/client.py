...
from .transports.grpc_asyncio import CampaignAssetServiceGrpcAsyncIOTransport
...
class CampaignAssetServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CampaignAssetServiceTransport]]
...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignAssetServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = CampaignAssetServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CampaignAssetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CampaignAssetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignAssetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,CampaignAssetServiceTransport,Callable[..., CampaignAssetServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CampaignAssetServiceTransport constructor.
        ...
        ) = CampaignAssetServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignAssetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CampaignAssetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignAssetServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CampaignAssetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignAssetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignAssetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignAssetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignAssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.CampaignAssetService",
    ...
    def mutate_campaign_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.CampaignAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateCampaignAssetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_assets
        ]
