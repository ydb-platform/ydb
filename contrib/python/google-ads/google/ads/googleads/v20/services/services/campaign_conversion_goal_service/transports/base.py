...
class CampaignConversionGoalServiceTransport(abc.ABC):
    """Abstract transport class for CampaignConversionGoalService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_conversion_goals: gapic_v1.method.wrap_method(
                self.mutate_campaign_conversion_goals,
...
__all__ = ("CampaignConversionGoalServiceTransport",)
