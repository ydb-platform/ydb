...
from google.ads.googleads.v20.services.types import campaign_group_service
import google.rpc.status_pb2 as status_pb2  # type: ignore
from .transports.base import CampaignGroupServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import CampaignGroupServiceGrpcTransport
from .transports.grpc_asyncio import CampaignGroupServiceGrpcAsyncIOTransport


class CampaignGroupServiceClientMeta(type):
    """Metaclass for the CampaignGroupService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CampaignGroupServiceTransport]]
    _transport_registry["grpc"] = CampaignGroupServiceGrpcTransport
...
class CampaignGroupServiceClient(metaclass=CampaignGroupServiceClientMeta):
    ...
    def transport(self) -> CampaignGroupServiceTransport:
        ...
        Returns:
            CampaignGroupServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignGroupServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CampaignGroupServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CampaignGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignGroupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the campaign group service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CampaignGroupServiceTransport,Callable[..., CampaignGroupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CampaignGroupServiceTransport constructor.
        ...
        ) = CampaignGroupServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignGroupServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(
            transport, CampaignGroupServiceTransport
        )
        if transport_provided:
            # transport is a CampaignGroupServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(CampaignGroupServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignGroupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignGroupServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignGroupServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignGroupServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.CampaignGroupService",
    ...
    def mutate_campaign_groups(
        ...
        *,
        ...
        r"""Creates, updates, or removes campaign groups.
        Operation statuses are returned.

        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                whose campaign groups are being
                modified.
            ...
            operations (MutableSequence[google.ads.googleads.v20.services.types.CampaignGroupOperation]):
                ...
                perform on individual campaign groups.
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateCampaignGroupsResponse:
                Response message for campaign group
                mutate.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_groups
        ]
