...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.CampaignOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateCampaignsResponse:
    ...
    def enable_p_max_brand_guidelines(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.EnablePMaxBrandGuidelinesRequest, dict]):
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.EnableOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.EnablePMaxBrandGuidelinesResponse:
