...
class ContentCreatorInsightsServiceTransport(abc.ABC):
    """Abstract transport class for ContentCreatorInsightsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_creator_insights: gapic_v1.method.wrap_method(
                self.generate_creator_insights,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_trending_insights: gapic_v1.method.wrap_method(
