...
class ConversionAdjustmentUploadServiceGrpcTransport(
    ...
    """gRPC backend transport for ConversionAdjustmentUploadService.
        ...
        if "upload_conversion_adjustments" not in self._stubs:
            self._stubs["upload_conversion_adjustments"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ConversionAdjustmentUploadService/UploadConversionAdjustments",
...
__all__ = ("ConversionAdjustmentUploadServiceGrpcTransport",)
