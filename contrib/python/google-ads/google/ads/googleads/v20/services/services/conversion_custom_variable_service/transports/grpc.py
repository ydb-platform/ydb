    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.ConversionCustomVariableService",
        ...
        if "mutate_conversion_custom_variables" not in self._stubs:
            self._stubs["mutate_conversion_custom_variables"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ConversionCustomVariableService/MutateConversionCustomVariables",
