...
from .transports.grpc import ConversionValueRuleSetServiceGrpcTransport
...
class ConversionValueRuleSetServiceClientMeta(type):
    """Metaclass for the ConversionValueRuleSetService client.
...
class ConversionValueRuleSetServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConversionValueRuleSetServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ConversionValueRuleSetServiceTransport:
        ...
        Returns:
            ConversionValueRuleSetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionValueRuleSetServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                ConversionValueRuleSetServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = ConversionValueRuleSetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ConversionValueRuleSetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the conversion value rule set service client.
        ...
        ) = ConversionValueRuleSetServiceClient._read_environment_variables()
        self._client_cert_source = (
            ConversionValueRuleSetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ConversionValueRuleSetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionValueRuleSetServiceTransport
        )
        if transport_provided:
            # transport is a ConversionValueRuleSetServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                ConversionValueRuleSetServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionValueRuleSetServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.ConversionValueRuleSetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.ConversionValueRuleSetService",
    ...
    def mutate_conversion_value_rule_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateConversionValueRuleSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.ConversionValueRuleSetOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateConversionValueRuleSetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_conversion_value_rule_sets
        ]
