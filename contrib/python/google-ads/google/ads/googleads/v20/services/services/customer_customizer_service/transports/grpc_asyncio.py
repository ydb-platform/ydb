...
class CustomerCustomizerServiceGrpcAsyncIOTransport(
    CustomerCustomizerServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerCustomizerService.
    ...
    def mutate_customer_customizers(
        ...
        Returns:
            Callable[[~.MutateCustomerCustomizersRequest],
                    Awaitable[~.MutateCustomerCustomizersResponse]]:
        ...
        if "mutate_customer_customizers" not in self._stubs:
            self._stubs["mutate_customer_customizers"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.CustomerCustomizerService/MutateCustomerCustomizers",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_customizers: self._wrap_method(
...
__all__ = ("CustomerCustomizerServiceGrpcAsyncIOTransport",)
