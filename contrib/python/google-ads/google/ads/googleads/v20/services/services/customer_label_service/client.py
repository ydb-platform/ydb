...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CustomerLabelServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.CustomerLabelService",
    ...
    def mutate_customer_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCustomerLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateCustomerLabelsResponse:
