...
from google.ads.googleads.v20.services.types import customer_label_service
...
class CustomerLabelServiceTransport(abc.ABC):
    """Abstract transport class for CustomerLabelService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_labels: gapic_v1.method.wrap_method(
