...
class CustomerUserAccessServiceClient(
    metaclass=CustomerUserAccessServiceClientMeta
):
    ...
    def transport(self) -> CustomerUserAccessServiceTransport:
        ...
        Returns:
            CustomerUserAccessServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomerUserAccessServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CustomerUserAccessServiceClient._DEFAULT_UNIVERSE
            )
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CustomerUserAccessServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CustomerUserAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerUserAccessServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the customer user access service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CustomerUserAccessServiceTransport,Callable[..., CustomerUserAccessServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CustomerUserAccessServiceTransport constructor.
        ...
        ) = CustomerUserAccessServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerUserAccessServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomerUserAccessServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomerUserAccessServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CustomerUserAccessServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerUserAccessServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerUserAccessServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomerUserAccessServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CustomerUserAccessServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.CustomerUserAccessService",
    ...
    def mutate_customer_user_access(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCustomerUserAccessRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateCustomerUserAccessResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_customer_user_access
        ]
