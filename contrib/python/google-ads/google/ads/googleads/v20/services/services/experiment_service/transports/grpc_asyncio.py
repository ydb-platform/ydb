    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.ExperimentService",
...
class ExperimentServiceGrpcAsyncIOTransport(ExperimentServiceTransport):
    """gRPC AsyncIO backend transport for ExperimentService.
    ...
    def mutate_experiments(
        ...
        Returns:
            Callable[[~.MutateExperimentsRequest],
                    Awaitable[~.MutateExperimentsResponse]]:
        ...
        if "mutate_experiments" not in self._stubs:
            self._stubs["mutate_experiments"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ExperimentService/MutateExperiments",
    ...
    def end_experiment(
        ...
        if "end_experiment" not in self._stubs:
            self._stubs["end_experiment"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v20.services.ExperimentService/EndExperiment",
    ...
    def list_experiment_async_errors(
        ...
        Returns:
            Callable[[~.ListExperimentAsyncErrorsRequest],
                    Awaitable[~.ListExperimentAsyncErrorsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "list_experiment_async_errors" not in self._stubs:
            self._stubs["list_experiment_async_errors"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ExperimentService/ListExperimentAsyncErrors",
    ...
    def graduate_experiment(
        ...
        if "graduate_experiment" not in self._stubs:
            self._stubs["graduate_experiment"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ExperimentService/GraduateExperiment",
    ...
    def schedule_experiment(
        ...
        if "schedule_experiment" not in self._stubs:
            self._stubs["schedule_experiment"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ExperimentService/ScheduleExperiment",
    ...
    def promote_experiment(
        ...
        if "promote_experiment" not in self._stubs:
            self._stubs["promote_experiment"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ExperimentService/PromoteExperiment",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_experiments: self._wrap_method(
                self.mutate_experiments,
                default_timeout=None,
                client_info=client_info,
            ),
            self.end_experiment: self._wrap_method(
                self.end_experiment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_experiment_async_errors: self._wrap_method(
                self.list_experiment_async_errors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.graduate_experiment: self._wrap_method(
                self.graduate_experiment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.schedule_experiment: self._wrap_method(
                self.schedule_experiment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.promote_experiment: self._wrap_method(
