    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.GoogleAdsFieldService",
...
class GoogleAdsFieldServiceGrpcAsyncIOTransport(GoogleAdsFieldServiceTransport):
    """gRPC AsyncIO backend transport for GoogleAdsFieldService.
    ...
    def get_google_ads_field(
        ...
        Returns:
            Callable[[~.GetGoogleAdsFieldRequest],
                    Awaitable[~.GoogleAdsField]]:
        ...
        if "get_google_ads_field" not in self._stubs:
            self._stubs["get_google_ads_field"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.GoogleAdsFieldService/GetGoogleAdsField",
                    request_serializer=google_ads_field_service.GetGoogleAdsFieldRequest.serialize,
                    response_deserializer=google_ads_field.GoogleAdsField.deserialize,
                )
            )
        return self._stubs["get_google_ads_field"]
    ...
    def search_google_ads_fields(
        ...
        Returns:
            Callable[[~.SearchGoogleAdsFieldsRequest],
                    Awaitable[~.SearchGoogleAdsFieldsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "search_google_ads_fields" not in self._stubs:
            self._stubs["search_google_ads_fields"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.GoogleAdsFieldService/SearchGoogleAdsFields",
                    request_serializer=google_ads_field_service.SearchGoogleAdsFieldsRequest.serialize,
                    response_deserializer=google_ads_field_service.SearchGoogleAdsFieldsResponse.deserialize,
                )
            )
        return self._stubs["search_google_ads_fields"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.get_google_ads_field: self._wrap_method(
                self.get_google_ads_field,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_google_ads_fields: self._wrap_method(
