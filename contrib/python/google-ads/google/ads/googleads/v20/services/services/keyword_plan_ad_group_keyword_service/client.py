...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            KeywordPlanAdGroupKeywordServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                KeywordPlanAdGroupKeywordServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = KeywordPlanAdGroupKeywordServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = KeywordPlanAdGroupKeywordServiceClient._read_environment_variables()
        self._client_cert_source = (
            KeywordPlanAdGroupKeywordServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            KeywordPlanAdGroupKeywordServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, KeywordPlanAdGroupKeywordServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                KeywordPlanAdGroupKeywordServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanAdGroupKeywordServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.KeywordPlanAdGroupKeywordServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.KeywordPlanAdGroupKeywordService",
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.KeywordPlanAdGroupKeywordOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
