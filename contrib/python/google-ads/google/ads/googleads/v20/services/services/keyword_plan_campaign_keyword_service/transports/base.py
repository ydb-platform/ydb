...
class KeywordPlanCampaignKeywordServiceTransport(abc.ABC):
    """Abstract transport class for KeywordPlanCampaignKeywordService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_keyword_plan_campaign_keywords: gapic_v1.method.wrap_method(
...
__all__ = ("KeywordPlanCampaignKeywordServiceTransport",)
