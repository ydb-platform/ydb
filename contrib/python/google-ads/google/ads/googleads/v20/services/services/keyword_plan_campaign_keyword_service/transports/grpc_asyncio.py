...
class KeywordPlanCampaignKeywordServiceGrpcAsyncIOTransport(
    KeywordPlanCampaignKeywordServiceTransport
):
    """gRPC AsyncIO backend transport for KeywordPlanCampaignKeywordService.
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        Returns:
            Callable[[~.MutateKeywordPlanCampaignKeywordsRequest],
                    Awaitable[~.MutateKeywordPlanCampaignKeywordsResponse]]:
        ...
        if "mutate_keyword_plan_campaign_keywords" not in self._stubs:
            self._stubs["mutate_keyword_plan_campaign_keywords"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords",
                    request_serializer=keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsRequest.serialize,
                    response_deserializer=keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsResponse.deserialize,
                )
            )
        return self._stubs["mutate_keyword_plan_campaign_keywords"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.mutate_keyword_plan_campaign_keywords: self._wrap_method(
