...
from google.ads.googleads.v20.services.types import label_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.LabelService",
...
class LabelServiceGrpcTransport(LabelServiceTransport):
    """gRPC backend transport for LabelService.
    ...
    def mutate_labels(
        ...
        if "mutate_labels" not in self._stubs:
            self._stubs["mutate_labels"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v20.services.LabelService/MutateLabels",
