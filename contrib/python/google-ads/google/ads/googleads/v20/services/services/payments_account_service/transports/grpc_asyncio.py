...
from google.ads.googleads.v20.services.types import payments_account_service
from .base import PaymentsAccountServiceTransport, DEFAULT_CLIENT_INFO
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.PaymentsAccountService",
...
class PaymentsAccountServiceGrpcAsyncIOTransport(
    PaymentsAccountServiceTransport
):
    """gRPC AsyncIO backend transport for PaymentsAccountService.
    ...
    def list_payments_accounts(
        ...
        r"""Return a callable for the list payments accounts method over gRPC.
        ...
        Returns:
            Callable[[~.ListPaymentsAccountsRequest],
                    Awaitable[~.ListPaymentsAccountsResponse]]:
        ...
        if "list_payments_accounts" not in self._stubs:
            self._stubs["list_payments_accounts"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.PaymentsAccountService/ListPaymentsAccounts",
                    request_serializer=payments_account_service.ListPaymentsAccountsRequest.serialize,
                    response_deserializer=payments_account_service.ListPaymentsAccountsResponse.deserialize,
                )
            )
        return self._stubs["list_payments_accounts"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.list_payments_accounts: self._wrap_method(
...
__all__ = ("PaymentsAccountServiceGrpcAsyncIOTransport",)
