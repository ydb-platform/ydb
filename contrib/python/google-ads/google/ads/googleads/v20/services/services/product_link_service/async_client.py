...
class ProductLinkServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ProductLinkServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            ProductLinkServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ProductLinkServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            ProductLinkServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v20.services.ProductLinkServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def create_product_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.CreateProductLinkRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            product_link (:class:`google.ads.googleads.v20.resources.types.ProductLink`):
    ...
    async def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.RemoveProductLinkRequest, dict]]):
                The request object. Request message for
