...
from google.ads.googleads.v20.services.types import product_link_service
from .transports.base import ProductLinkServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ProductLinkServiceGrpcTransport
from .transports.grpc_asyncio import ProductLinkServiceGrpcAsyncIOTransport


class ProductLinkServiceClientMeta(type):
    """Metaclass for the ProductLinkService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ProductLinkServiceTransport]]
    _transport_registry["grpc"] = ProductLinkServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = ProductLinkServiceGrpcAsyncIOTransport
...
class ProductLinkServiceClient(metaclass=ProductLinkServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProductLinkServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ProductLinkServiceTransport:
        ...
        Returns:
            ProductLinkServiceTransport: The transport used by the client
                instance.
        """
    ...
    def parse_product_link_path(path: str) -> Dict[str, str]:
        """Parses a product_link path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/productLinks/(?P<product_link_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ProductLinkServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ProductLinkServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ProductLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ProductLinkServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the product link service client.
        ...
        ) = ProductLinkServiceClient._read_environment_variables()
        self._client_cert_source = (
            ProductLinkServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = ProductLinkServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ProductLinkServiceTransport)
        if transport_provided:
            # transport is a ProductLinkServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(ProductLinkServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ProductLinkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ProductLinkServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ProductLinkServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.ProductLinkServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.ProductLinkService",
    ...
    def create_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.CreateProductLinkRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            product_link (google.ads.googleads.v20.resources.types.ProductLink):
        ...
        Returns:
            google.ads.googleads.v20.services.types.CreateProductLinkResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_product_link
        ]
    ...
    def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.RemoveProductLinkRequest, dict]):
                The request object. Request message for
                [ProductLinkService.RemoveProductLink][google.ads.googleads.v20.services.ProductLinkService.RemoveProductLink].
            customer_id (str):
        ...
        Returns:
            google.ads.googleads.v20.services.types.RemoveProductLinkResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.remove_product_link
        ]
