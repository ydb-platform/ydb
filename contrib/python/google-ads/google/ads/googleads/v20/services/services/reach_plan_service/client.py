...
from .transports.grpc_asyncio import ReachPlanServiceGrpcAsyncIOTransport
...
class ReachPlanServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = ReachPlanServiceGrpcAsyncIOTransport
...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ReachPlanServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ReachPlanServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ReachPlanServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = ReachPlanServiceClient._read_environment_variables()
        ...
        transport_provided = isinstance(transport, ReachPlanServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ReachPlanServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ReachPlanServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ReachPlanServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ReachPlanServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.ReachPlanServiceClient`.",
                    extra=(
                        {
    ...
    def generate_conversion_rates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.GenerateConversionRatesRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateConversionRatesResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.generate_conversion_rates
        ]
    ...
    def list_plannable_locations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.ListPlannableLocationsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.ListPlannableLocationsResponse:
    ...
    def list_plannable_products(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.ListPlannableProductsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.ListPlannableProductsResponse:
    ...
    def generate_reach_forecast(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.GenerateReachForecastRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_duration (google.ads.googleads.v20.services.types.CampaignDuration):
                Required. Campaign duration.
                This corresponds to the ``campaign_duration`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            planned_products (MutableSequence[google.ads.googleads.v20.services.types.PlannedProduct]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateReachForecastResponse:
    ...
    def list_plannable_user_lists(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.ListPlannableUserListsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.ListPlannableUserListsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_plannable_user_lists
        ]
