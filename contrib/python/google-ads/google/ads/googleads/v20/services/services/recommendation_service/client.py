...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            RecommendationServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = (
            RecommendationServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, RecommendationServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RecommendationServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                if isinstance(transport, str) or transport is None
                    ...
                    Callable[..., RecommendationServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.RecommendationServiceClient`.",
                    extra=(
                        {
    ...
    def apply_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.ApplyRecommendationRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.ApplyRecommendationOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.ApplyRecommendationResponse:
    ...
    def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.DismissRecommendationRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.DismissRecommendationResponse:
                Response message for
                   [RecommendationService.DismissRecommendation][google.ads.googleads.v20.services.RecommendationService.DismissRecommendation].
    ...
    def generate_recommendations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.GenerateRecommendationsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            recommendation_types (MutableSequence[google.ads.googleads.v20.enums.types.RecommendationTypeEnum.RecommendationType]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.GenerateRecommendationsResponse:
                Response message for
                   [RecommendationService.GenerateRecommendations][google.ads.googleads.v20.services.RecommendationService.GenerateRecommendations].
