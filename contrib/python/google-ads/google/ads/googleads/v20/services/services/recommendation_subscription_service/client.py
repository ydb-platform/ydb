...
from .transports.grpc import RecommendationSubscriptionServiceGrpcTransport
...
class RecommendationSubscriptionServiceClientMeta(type):
    """Metaclass for the RecommendationSubscriptionService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RecommendationSubscriptionServiceTransport]]
    _transport_registry["grpc"] = RecommendationSubscriptionServiceGrpcTransport
...
class RecommendationSubscriptionServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RecommendationSubscriptionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> RecommendationSubscriptionServiceTransport:
        ...
        Returns:
            RecommendationSubscriptionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            RecommendationSubscriptionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RecommendationSubscriptionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the recommendation subscription service client.
        ...
        (
            ...
            RecommendationSubscriptionServiceClient._read_environment_variables()
        )
        ...
        self._universe_domain = (
            RecommendationSubscriptionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, RecommendationSubscriptionServiceTransport
        )
        if transport_provided:
            # transport is a RecommendationSubscriptionServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                RecommendationSubscriptionServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RecommendationSubscriptionServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.RecommendationSubscriptionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.RecommendationSubscriptionService",
    ...
    def mutate_recommendation_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateRecommendationSubscriptionRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.RecommendationSubscriptionOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_recommendation_subscription
        ]
