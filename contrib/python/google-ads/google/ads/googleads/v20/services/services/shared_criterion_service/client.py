...
from google.ads.googleads.v20.services.types import shared_criterion_service
...
from .transports.grpc_asyncio import SharedCriterionServiceGrpcAsyncIOTransport
...
class SharedCriterionServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[SharedCriterionServiceTransport]]
...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            SharedCriterionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                SharedCriterionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SharedCriterionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = SharedCriterionServiceClient._read_environment_variables()
        self._client_cert_source = (
            SharedCriterionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            SharedCriterionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, SharedCriterionServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(SharedCriterionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SharedCriterionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                SharedCriterionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., SharedCriterionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.SharedCriterionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.SharedCriterionService",
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateSharedCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.SharedCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateSharedCriteriaResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_shared_criteria
        ]
