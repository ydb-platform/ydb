...
class SmartCampaignSuggestServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.SmartCampaignSuggestServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.SmartCampaignSuggestService",
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.SuggestSmartCampaignBudgetOptionsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.SuggestSmartCampaignBudgetOptionsResponse:
    ...
    def suggest_smart_campaign_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.SuggestSmartCampaignAdRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.SuggestSmartCampaignAdResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestSmartCampaignAd][google.ads.googleads.v20.services.SmartCampaignSuggestService.SuggestSmartCampaignAd].
    ...
    def suggest_keyword_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.SuggestKeywordThemesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v20.services.types.SuggestKeywordThemesResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestKeywordThemes][google.ads.googleads.v20.services.SmartCampaignSuggestService.SuggestKeywordThemes].
