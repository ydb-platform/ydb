...
class ThirdPartyAppAnalyticsLinkServiceGrpcAsyncIOTransport(
    ThirdPartyAppAnalyticsLinkServiceTransport
):
    """gRPC AsyncIO backend transport for ThirdPartyAppAnalyticsLinkService.
    ...
    def regenerate_shareable_link_id(
        ...
        r"""Return a callable for the regenerate shareable link id method over gRPC.

        Regenerate ThirdPartyAppAnalyticsLink.shareable_link_id that
        should be provided to the third party when setting up app
        analytics.
        ...
        Returns:
            Callable[[~.RegenerateShareableLinkIdRequest],
        ...
        if "regenerate_shareable_link_id" not in self._stubs:
            self._stubs["regenerate_shareable_link_id"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId",
                    request_serializer=third_party_app_analytics_link_service.RegenerateShareableLinkIdRequest.serialize,
                    response_deserializer=third_party_app_analytics_link_service.RegenerateShareableLinkIdResponse.deserialize,
                )
            )
        return self._stubs["regenerate_shareable_link_id"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.regenerate_shareable_link_id: self._wrap_method(
...
__all__ = ("ThirdPartyAppAnalyticsLinkServiceGrpcAsyncIOTransport",)
