    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.UserListService",
...
class UserListServiceGrpcTransport(UserListServiceTransport):
    ...
    def mutate_user_lists(
        ...
        if "mutate_user_lists" not in self._stubs:
            self._stubs["mutate_user_lists"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v20.services.UserListService/MutateUserLists",
