...
from google.ads.googleads.v20.resources.types import ad_group_criterion_label
...
class MutateAdGroupCriterionLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v20.services.types.AdGroupCriterionLabelOperation]):
...
class AdGroupCriterionLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.resources.types.AdGroupCriterionLabel):
...
class MutateAdGroupCriterionLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateAdGroupCriterionLabelResult]):
