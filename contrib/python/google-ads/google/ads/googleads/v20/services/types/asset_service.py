...
from google.ads.googleads.v20.resources.types import asset as gagr_asset
...
class MutateAssetsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (MutableSequence[google.ads.googleads.v20.services.types.AssetOperation]):
...
class AssetOperation(proto.Message):
    ...
    are YoutubeVideoAsset, MediaBundleAsset, ImageAsset,
    LeadFormAsset, LocationAsset, and ImageAsset. TextAsset can be
    created with an Ad inline, but it can also be created apart from
    an Ad like other assets.
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.Asset):
            Create operation: No resource name is
            expected for the new asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.Asset):
...
class MutateAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateAssetResult]):
...
class MutateAssetResult(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            operations.
        asset (google.ads.googleads.v20.resources.types.Asset):
