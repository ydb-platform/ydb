...
class MutateCampaignSharedSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v20.services.types.CampaignSharedSetOperation]):
...
class CampaignSharedSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.resources.types.CampaignSharedSet):
    ...
    create: gagr_campaign_shared_set.CampaignSharedSet = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateCampaignSharedSetResult]):
...
class MutateCampaignSharedSetResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_shared_set (google.ads.googleads.v20.resources.types.CampaignSharedSet):
