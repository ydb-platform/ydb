...
from google.ads.googleads.v20.resources.types import customer_lifecycle_goal
...
class ConfigureCustomerLifecycleGoalsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        operation (google.ads.googleads.v20.services.types.CustomerLifecycleGoalOperation):
...
class CustomerLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.CustomerLifecycleGoal):
            Create operation: Create a new customer
            lifecycle goal.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.CustomerLifecycleGoal):
...
class ConfigureCustomerLifecycleGoalsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v20.services.types.ConfigureCustomerLifecycleGoalsResult):
