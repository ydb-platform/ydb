...
class YearMonthRange(proto.Message):
    ...
    Attributes:
        start (google.ads.googleads.v21.common.types.YearMonth):
            The inclusive start year month.
        end (google.ads.googleads.v21.common.types.YearMonth):
...
class YearMonth(proto.Message):
    ...
    Attributes:
        ...
        month (google.ads.googleads.v21.enums.types.MonthOfYearEnum.MonthOfYear):
