...
from google.ads.googleads.v21.enums.types import account_budget_proposal_type
from google.ads.googleads.v21.enums.types import account_budget_status
...
class AccountBudget(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v21.enums.types.AccountBudgetStatusEnum.AccountBudgetStatus):
        ...
        pending_proposal (google.ads.googleads.v21.resources.types.AccountBudget.PendingAccountBudgetProposal):
        ...
        proposed_end_time_type (google.ads.googleads.v21.enums.types.TimeTypeEnum.TimeType):
        ...
        approved_end_time_type (google.ads.googleads.v21.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_spending_limit_type (google.ads.googleads.v21.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        approved_spending_limit_type (google.ads.googleads.v21.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        adjusted_spending_limit_type (google.ads.googleads.v21.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
    ...
    class PendingAccountBudgetProposal(proto.Message):
        ...
        Attributes:
            ...
            proposal_type (google.ads.googleads.v21.enums.types.AccountBudgetProposalTypeEnum.AccountBudgetProposalType):
            ...
            end_time_type (google.ads.googleads.v21.enums.types.TimeTypeEnum.TimeType):
            ...
            spending_limit_type (google.ads.googleads.v21.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        account_budget_proposal: str = proto.Field(
            proto.STRING,
            number=12,
            optional=True,
        )
        ...
        spending_limit_micros: int = proto.Field(
            proto.INT64,
            number=16,
    ...
    proposed_start_date_time: str = proto.Field(
        proto.STRING,
        number=26,
        optional=True,
    )
    approved_start_date_time: str = proto.Field(
        proto.STRING,
        number=27,
        optional=True,
    )
    total_adjustments_micros: int = proto.Field(
        proto.INT64,
        number=33,
    )
    amount_served_micros: int = proto.Field(
        proto.INT64,
        number=34,
    )
    purchase_order_number: str = proto.Field(
    ...
    pending_proposal: PendingAccountBudgetProposal = proto.Field(
        proto.MESSAGE,
        number=22,
        message=PendingAccountBudgetProposal,
    )
    proposed_end_date_time: str = proto.Field(
        proto.STRING,
        number=28,
        oneof="proposed_end_time",
    )
    proposed_end_time_type: time_type.TimeTypeEnum.TimeType = proto.Field(
        proto.ENUM,
        number=9,
        oneof="proposed_end_time",
        enum=time_type.TimeTypeEnum.TimeType,
    )
    approved_end_date_time: str = proto.Field(
        proto.STRING,
        number=29,
        oneof="approved_end_time",
    )
    approved_end_time_type: time_type.TimeTypeEnum.TimeType = proto.Field(
        proto.ENUM,
        number=11,
        oneof="approved_end_time",
        enum=time_type.TimeTypeEnum.TimeType,
    )
    proposed_spending_limit_micros: int = proto.Field(
        proto.INT64,
        number=30,
    ...
    approved_spending_limit_micros: int = proto.Field(
        proto.INT64,
        number=31,
    ...
    adjusted_spending_limit_micros: int = proto.Field(
        proto.INT64,
        number=32,
