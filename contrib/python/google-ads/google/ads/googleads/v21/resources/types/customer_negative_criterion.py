...
class CustomerNegativeCriterion(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v21.enums.types.CriterionTypeEnum.CriterionType):
        ...
        mobile_application (google.ads.googleads.v21.common.types.MobileApplicationInfo):
            Immutable. MobileApplication.

            This field is a member of `oneof`_ ``criterion``.
        mobile_app_category (google.ads.googleads.v21.common.types.MobileAppCategoryInfo):
            Immutable. MobileAppCategory.

            This field is a member of `oneof`_ ``criterion``.
        placement (google.ads.googleads.v21.common.types.PlacementInfo):
            Immutable. Placement.
        ...
        youtube_channel (google.ads.googleads.v21.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        negative_keyword_list (google.ads.googleads.v21.common.types.NegativeKeywordListInfo):
        ...
        ip_block (google.ads.googleads.v21.common.types.IpBlockInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        placement_list (google.ads.googleads.v21.common.types.PlacementListInfo):
