...
class AccountBudgetProposalServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AccountBudgetProposalServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                AccountBudgetProposalServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = AccountBudgetProposalServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AccountBudgetProposalServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AccountBudgetProposalServiceClient._read_environment_variables()
        self._client_cert_source = (
            AccountBudgetProposalServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AccountBudgetProposalServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AccountBudgetProposalServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                AccountBudgetProposalServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AccountBudgetProposalServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AccountBudgetProposalServiceClient.get_transport_class(
                    transport
                )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AccountBudgetProposalServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAccountBudgetProposalRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAccountBudgetProposalResponse:
