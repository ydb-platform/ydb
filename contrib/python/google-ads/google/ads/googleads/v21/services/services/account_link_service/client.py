...
from google.ads.googleads.v21.services.types import account_link_service
...
class AccountLinkServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AccountLinkServiceTransport]]
    _transport_registry["grpc"] = AccountLinkServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = AccountLinkServiceGrpcAsyncIOTransport
...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AccountLinkServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AccountLinkServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AccountLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AccountLinkServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AccountLinkServiceClient._read_environment_variables()
        self._client_cert_source = (
            AccountLinkServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AccountLinkServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AccountLinkServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AccountLinkServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AccountLinkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AccountLinkServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AccountLinkServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AccountLinkServiceClient`.",
                    extra=(
                        {
    ...
    def create_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.CreateAccountLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAccountLinkRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v21.services.types.AccountLinkOperation):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAccountLinkResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_account_link
        ]
