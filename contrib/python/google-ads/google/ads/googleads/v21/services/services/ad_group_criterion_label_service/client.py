...
class AdGroupCriterionLabelServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdGroupCriterionLabelServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                AdGroupCriterionLabelServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = (
                AdGroupCriterionLabelServiceClient.DEFAULT_MTLS_ENDPOINT
            )
        else:
            api_endpoint = AdGroupCriterionLabelServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupCriterionLabelServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,AdGroupCriterionLabelServiceTransport,Callable[..., AdGroupCriterionLabelServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AdGroupCriterionLabelServiceTransport constructor.
        ...
        ) = AdGroupCriterionLabelServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupCriterionLabelServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AdGroupCriterionLabelServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupCriterionLabelServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                AdGroupCriterionLabelServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupCriterionLabelServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupCriterionLabelServiceClient.get_transport_class(
                    transport
                )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AdGroupCriterionLabelServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_criterion_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAdGroupCriterionLabelsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.AdGroupCriterionLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAdGroupCriterionLabelsResponse:
