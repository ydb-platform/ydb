...
from .transports.grpc_asyncio import AdGroupServiceGrpcAsyncIOTransport
...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def transport(self) -> AdGroupServiceTransport:
        ...
        Returns:
            AdGroupServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AdGroupServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = AdGroupServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = AdGroupServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AdGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the ad group service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AdGroupServiceTransport,Callable[..., AdGroupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AdGroupServiceTransport constructor.
        ...
        ) = AdGroupServiceClient._read_environment_variables()
        self._client_cert_source = AdGroupServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, AdGroupServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdGroupServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AdGroupServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AdGroupServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_groups(
        self,
        request: Optional[
            Union[ad_group_service.MutateAdGroupsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        operations: Optional[
            MutableSequence[ad_group_service.AdGroupOperation]
        ] = None,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAdGroupsRequest, dict]):
                The request object. Request message for
                [AdGroupService.MutateAdGroups][google.ads.googleads.v21.services.AdGroupService.MutateAdGroups].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.AdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAdGroupsResponse:
