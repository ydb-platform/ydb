...
class AssetGroupListingGroupFilterServiceTransport(abc.ABC):
    """Abstract transport class for AssetGroupListingGroupFilterService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_asset_group_listing_group_filters: gapic_v1.method.wrap_method(
                self.mutate_asset_group_listing_group_filters,
...
__all__ = ("AssetGroupListingGroupFilterServiceTransport",)
