...
from .transports.base import AssetSetAssetServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import AssetSetAssetServiceGrpcTransport
from .transports.grpc_asyncio import AssetSetAssetServiceGrpcAsyncIOTransport


class AssetSetAssetServiceClientMeta(type):
    """Metaclass for the AssetSetAssetService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AssetSetAssetServiceTransport]]
...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def transport(self) -> AssetSetAssetServiceTransport:
        ...
        Returns:
            AssetSetAssetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AssetSetAssetServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = AssetSetAssetServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = AssetSetAssetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AssetSetAssetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AssetSetAssetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the asset set asset service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AssetSetAssetServiceTransport,Callable[..., AssetSetAssetServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AssetSetAssetServiceTransport constructor.
        ...
        ) = AssetSetAssetServiceClient._read_environment_variables()
        self._client_cert_source = (
            AssetSetAssetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AssetSetAssetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AssetSetAssetServiceTransport
        )
        if transport_provided:
            # transport is a AssetSetAssetServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(AssetSetAssetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AssetSetAssetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AssetSetAssetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AssetSetAssetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AssetSetAssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v21.services.AssetSetAssetService",
    ...
    def mutate_asset_set_assets(
        self,
        request: Optional[
            Union[asset_set_asset_service.MutateAssetSetAssetsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        operations: Optional[
            MutableSequence[asset_set_asset_service.AssetSetAssetOperation]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> asset_set_asset_service.MutateAssetSetAssetsResponse:
        r"""Creates, updates or removes asset set assets.
        Operation statuses are returned.

        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAssetSetAssetsRequest, dict]):
                The request object. Request message for
                [AssetSetAssetService.MutateAssetSetAssets][google.ads.googleads.v21.services.AssetSetAssetService.MutateAssetSetAssets].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.AssetSetAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAssetSetAssetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_asset_set_assets
        ]
