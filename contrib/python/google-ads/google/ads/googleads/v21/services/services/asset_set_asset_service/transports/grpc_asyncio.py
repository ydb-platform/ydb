...
class AssetSetAssetServiceGrpcAsyncIOTransport(AssetSetAssetServiceTransport):
    """gRPC AsyncIO backend transport for AssetSetAssetService.
    ...
    def mutate_asset_set_assets(
        ...
        Returns:
            Callable[[~.MutateAssetSetAssetsRequest],
                    Awaitable[~.MutateAssetSetAssetsResponse]]:
        ...
        if "mutate_asset_set_assets" not in self._stubs:
            self._stubs["mutate_asset_set_assets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.AssetSetAssetService/MutateAssetSetAssets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_asset_set_assets: self._wrap_method(
...
__all__ = ("AssetSetAssetServiceGrpcAsyncIOTransport",)
