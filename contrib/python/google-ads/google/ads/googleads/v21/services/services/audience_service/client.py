...
from .transports.grpc import AudienceServiceGrpcTransport
from .transports.grpc_asyncio import AudienceServiceGrpcAsyncIOTransport


class AudienceServiceClientMeta(type):
    """Metaclass for the AudienceService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AudienceServiceTransport]]
    _transport_registry["grpc"] = AudienceServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = AudienceServiceGrpcAsyncIOTransport
...
class AudienceServiceClient(metaclass=AudienceServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AudienceServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AudienceServiceTransport:
        ...
        Returns:
            AudienceServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AudienceServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AudienceServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AudienceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AudienceServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the audience service client.
        ...
        ) = AudienceServiceClient._read_environment_variables()
        self._client_cert_source = (
            AudienceServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AudienceServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AudienceServiceTransport)
        if transport_provided:
            # transport is a AudienceServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(AudienceServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AudienceServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AudienceServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AudienceServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AudienceServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_audiences(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAudiencesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.AudienceOperation]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAudiencesResponse:
        ...
        rpc = self._transport._wrapped_methods[self._transport.mutate_audiences]
