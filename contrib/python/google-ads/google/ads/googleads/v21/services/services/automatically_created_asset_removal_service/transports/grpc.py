...
class AutomaticallyCreatedAssetRemovalServiceGrpcTransport(
    AutomaticallyCreatedAssetRemovalServiceTransport
):
    """gRPC backend transport for AutomaticallyCreatedAssetRemovalService.
        ...
        if "remove_campaign_automatically_created_asset" not in self._stubs:
            self._stubs["remove_campaign_automatically_created_asset"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.AutomaticallyCreatedAssetRemovalService/RemoveCampaignAutomaticallyCreatedAsset",
...
__all__ = ("AutomaticallyCreatedAssetRemovalServiceGrpcTransport",)
