...
from google.ads.googleads.v21.services.services.batch_job_service import pagers
from google.ads.googleads.v21.services.types import batch_job_service
...
class BatchJobServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v21.services.BatchJobServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v21.services.BatchJobService",
    ...
    async def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.MutateBatchJobRequest, dict]]):
                The request object. Request message for
                [BatchJobService.MutateBatchJob][google.ads.googleads.v21.services.BatchJobService.MutateBatchJob].
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v21.services.types.BatchJobOperation`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateBatchJobResponse:
    ...
    async def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.ListBatchJobResultsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v21.services.services.batch_job_service.pagers.ListBatchJobResultsAsyncPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v21.services.BatchJobService.ListBatchJobResults].
    ...
    async def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.RunBatchJobRequest, dict]]):
                The request object. Request message for
                [BatchJobService.RunBatchJob][google.ads.googleads.v21.services.BatchJobService.RunBatchJob].
            resource_name (:class:`str`):
                Required. The resource name of the
                BatchJob to run.
    ...
    async def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.AddBatchJobOperationsRequest, dict]]):
                The request object. Request message for
                [BatchJobService.AddBatchJobOperations][google.ads.googleads.v21.services.BatchJobService.AddBatchJobOperations].
            resource_name (:class:`str`):
                Required. The resource name of the
                batch job.
            ...
            sequence_token (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`MutableSequence[google.ads.googleads.v21.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.AddBatchJobOperationsResponse:
                Response message for
                   [BatchJobService.AddBatchJobOperations][google.ads.googleads.v21.services.BatchJobService.AddBatchJobOperations].
