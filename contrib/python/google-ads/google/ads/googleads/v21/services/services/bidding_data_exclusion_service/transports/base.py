...
class BiddingDataExclusionServiceTransport(abc.ABC):
    """Abstract transport class for BiddingDataExclusionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_bidding_data_exclusions: gapic_v1.method.wrap_method(
                self.mutate_bidding_data_exclusions,
...
__all__ = ("BiddingDataExclusionServiceTransport",)
