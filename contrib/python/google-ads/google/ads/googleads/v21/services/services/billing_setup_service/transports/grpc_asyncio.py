...
from google.ads.googleads.v21.services.types import billing_setup_service
...
class BillingSetupServiceGrpcAsyncIOTransport(BillingSetupServiceTransport):
    """gRPC AsyncIO backend transport for BillingSetupService.
    ...
    def mutate_billing_setup(
        ...
        Returns:
            Callable[[~.MutateBillingSetupRequest],
                    Awaitable[~.MutateBillingSetupResponse]]:
        ...
        if "mutate_billing_setup" not in self._stubs:
            self._stubs["mutate_billing_setup"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.BillingSetupService/MutateBillingSetup",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_billing_setup: self._wrap_method(
...
__all__ = ("BillingSetupServiceGrpcAsyncIOTransport",)
