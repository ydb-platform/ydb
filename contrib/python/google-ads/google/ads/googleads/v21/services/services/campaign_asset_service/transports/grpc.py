...
from .base import CampaignAssetServiceTransport, DEFAULT_CLIENT_INFO
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.CampaignAssetService",
...
class CampaignAssetServiceGrpcTransport(CampaignAssetServiceTransport):
    """gRPC backend transport for CampaignAssetService.
    ...
    def mutate_campaign_assets(
        ...
        r"""Return a callable for the mutate campaign assets method over gRPC.

        Creates, updates, or removes campaign assets. Operation statuses
        are returned.
        ...
        Returns:
            Callable[[~.MutateCampaignAssetsRequest],
        ...
        if "mutate_campaign_assets" not in self._stubs:
            self._stubs["mutate_campaign_assets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.CampaignAssetService/MutateCampaignAssets",
                    request_serializer=campaign_asset_service.MutateCampaignAssetsRequest.serialize,
                    response_deserializer=campaign_asset_service.MutateCampaignAssetsResponse.deserialize,
                )
            )
        return self._stubs["mutate_campaign_assets"]
...
__all__ = ("CampaignAssetServiceGrpcTransport",)
