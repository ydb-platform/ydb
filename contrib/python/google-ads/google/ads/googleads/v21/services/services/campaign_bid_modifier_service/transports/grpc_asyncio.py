...
class CampaignBidModifierServiceGrpcAsyncIOTransport(
    CampaignBidModifierServiceTransport
):
    """gRPC AsyncIO backend transport for CampaignBidModifierService.
    ...
    def mutate_campaign_bid_modifiers(
        ...
        Returns:
            Callable[[~.MutateCampaignBidModifiersRequest],
                    Awaitable[~.MutateCampaignBidModifiersResponse]]:
        ...
        if "mutate_campaign_bid_modifiers" not in self._stubs:
            self._stubs["mutate_campaign_bid_modifiers"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.CampaignBidModifierService/MutateCampaignBidModifiers",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_bid_modifiers: self._wrap_method(
...
__all__ = ("CampaignBidModifierServiceGrpcAsyncIOTransport",)
