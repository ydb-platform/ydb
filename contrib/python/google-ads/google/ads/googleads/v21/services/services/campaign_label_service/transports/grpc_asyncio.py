...
class CampaignLabelServiceGrpcAsyncIOTransport(CampaignLabelServiceTransport):
    """gRPC AsyncIO backend transport for CampaignLabelService.
    ...
    def mutate_campaign_labels(
        ...
        Returns:
            Callable[[~.MutateCampaignLabelsRequest],
                    Awaitable[~.MutateCampaignLabelsResponse]]:
        ...
        if "mutate_campaign_labels" not in self._stubs:
            self._stubs["mutate_campaign_labels"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_labels: self._wrap_method(
...
__all__ = ("CampaignLabelServiceGrpcAsyncIOTransport",)
