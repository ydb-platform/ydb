...
from google.ads.googleads.v21.services.types import conversion_upload_service
import google.rpc.status_pb2 as status_pb2  # type: ignore
from .transports.base import (
    ConversionUploadServiceTransport,
    DEFAULT_CLIENT_INFO,
)
from .client import ConversionUploadServiceClient
...
class ConversionUploadServiceAsyncClient:
    ...
    _client: ConversionUploadServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = ConversionUploadServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = ConversionUploadServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = (
        ConversionUploadServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    _DEFAULT_UNIVERSE = ConversionUploadServiceClient._DEFAULT_UNIVERSE

    conversion_custom_variable_path = staticmethod(
        ConversionUploadServiceClient.conversion_custom_variable_path
    )
    parse_conversion_custom_variable_path = staticmethod(
        ConversionUploadServiceClient.parse_conversion_custom_variable_path
    )
    common_billing_account_path = staticmethod(
        ConversionUploadServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        ConversionUploadServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(
        ConversionUploadServiceClient.common_folder_path
    )
    parse_common_folder_path = staticmethod(
        ConversionUploadServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        ConversionUploadServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        ConversionUploadServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(
        ConversionUploadServiceClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        ConversionUploadServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        ConversionUploadServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        ConversionUploadServiceClient.parse_common_location_path
    )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return ConversionUploadServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = ConversionUploadServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the conversion upload service async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ConversionUploadServiceTransport,Callable[..., ConversionUploadServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ConversionUploadServiceTransport constructor.
        ...
        """
        self._client = ConversionUploadServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v21.services.ConversionUploadServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.UploadClickConversionsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversions (:class:`MutableSequence[google.ads.googleads.v21.services.types.ClickConversion]`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.UploadClickConversionsResponse:
        ...
        flattened_params = [customer_id, conversions, partial_failure]
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.upload_click_conversions
        ]
    ...
    async def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.UploadCallConversionsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`MutableSequence[google.ads.googleads.v21.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v21.services.types.UploadCallConversionsResponse:
                Response message for
                   [ConversionUploadService.UploadCallConversions][google.ads.googleads.v21.services.ConversionUploadService.UploadCallConversions].
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.upload_call_conversions
        ]
