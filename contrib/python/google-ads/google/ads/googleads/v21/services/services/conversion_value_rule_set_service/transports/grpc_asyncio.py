...
class ConversionValueRuleSetServiceGrpcAsyncIOTransport(
    ...
    def mutate_conversion_value_rule_sets(
        ...
        Returns:
            Callable[[~.MutateConversionValueRuleSetsRequest],
                    Awaitable[~.MutateConversionValueRuleSetsResponse]]:
        ...
        if "mutate_conversion_value_rule_sets" not in self._stubs:
            self._stubs["mutate_conversion_value_rule_sets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.ConversionValueRuleSetService/MutateConversionValueRuleSets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_conversion_value_rule_sets: self._wrap_method(
                self.mutate_conversion_value_rule_sets,
...
__all__ = ("ConversionValueRuleSetServiceGrpcAsyncIOTransport",)
