...
from google.ads.googleads.v21.services.types import custom_audience_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.CustomAudienceService",
...
class CustomAudienceServiceGrpcTransport(CustomAudienceServiceTransport):
    ...
    def mutate_custom_audiences(
        ...
        Creates or updates custom audiences. Operation statuses are
        returned.
        ...
        Returns:
            Callable[[~.MutateCustomAudiencesRequest],
        ...
        if "mutate_custom_audiences" not in self._stubs:
            self._stubs["mutate_custom_audiences"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.CustomAudienceService/MutateCustomAudiences",
                    request_serializer=custom_audience_service.MutateCustomAudiencesRequest.serialize,
                    response_deserializer=custom_audience_service.MutateCustomAudiencesResponse.deserialize,
                )
            )
        return self._stubs["mutate_custom_audiences"]
...
__all__ = ("CustomAudienceServiceGrpcTransport",)
