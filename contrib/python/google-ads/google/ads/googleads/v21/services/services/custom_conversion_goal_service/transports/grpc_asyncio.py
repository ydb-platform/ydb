    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.CustomConversionGoalService",
...
class CustomConversionGoalServiceGrpcAsyncIOTransport(
    CustomConversionGoalServiceTransport
):
    """gRPC AsyncIO backend transport for CustomConversionGoalService.
    ...
    def mutate_custom_conversion_goals(
        ...
        r"""Return a callable for the mutate custom conversion goals method over gRPC.

        Creates, updates or removes custom conversion goals.
        Operation statuses are returned.

        Returns:
            Callable[[~.MutateCustomConversionGoalsRequest],
                    Awaitable[~.MutateCustomConversionGoalsResponse]]:
        ...
        if "mutate_custom_conversion_goals" not in self._stubs:
            self._stubs["mutate_custom_conversion_goals"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.CustomConversionGoalService/MutateCustomConversionGoals",
                    request_serializer=custom_conversion_goal_service.MutateCustomConversionGoalsRequest.serialize,
                    response_deserializer=custom_conversion_goal_service.MutateCustomConversionGoalsResponse.deserialize,
                )
            )
        return self._stubs["mutate_custom_conversion_goals"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.mutate_custom_conversion_goals: self._wrap_method(
                self.mutate_custom_conversion_goals,
...
__all__ = ("CustomConversionGoalServiceGrpcAsyncIOTransport",)
