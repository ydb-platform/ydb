...
from .transports.base import ExperimentArmServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ExperimentArmServiceGrpcTransport
from .transports.grpc_asyncio import ExperimentArmServiceGrpcAsyncIOTransport


class ExperimentArmServiceClientMeta(type):
    """Metaclass for the ExperimentArmService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ExperimentArmServiceTransport]]
    _transport_registry["grpc"] = ExperimentArmServiceGrpcTransport
...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ExperimentArmServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ExperimentArmServiceTransport:
        ...
        Returns:
            ExperimentArmServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ExperimentArmServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ExperimentArmServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ExperimentArmServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ExperimentArmServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the experiment arm service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ExperimentArmServiceTransport,Callable[..., ExperimentArmServiceTransport]]]):
        ...
        ) = ExperimentArmServiceClient._read_environment_variables()
        self._client_cert_source = (
            ExperimentArmServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = ExperimentArmServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ExperimentArmServiceTransport
        )
        if transport_provided:
            # transport is a ExperimentArmServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(ExperimentArmServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ExperimentArmServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ExperimentArmServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., ExperimentArmServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.ExperimentArmServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v21.services.ExperimentArmService",
    ...
    def mutate_experiment_arms(
        self,
        request: Optional[
            Union[experiment_arm_service.MutateExperimentArmsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        operations: Optional[
            MutableSequence[experiment_arm_service.ExperimentArmOperation]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> experiment_arm_service.MutateExperimentArmsResponse:
        r"""Creates, updates, or removes experiment arms. Operation statuses
        are returned.

        List of thrown errors: `AuthenticationError <>`__
        `AuthorizationError <>`__ `ExperimentArmError <>`__
        `HeaderError <>`__ `InternalError <>`__ `QuotaError <>`__
        `RequestError <>`__

        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateExperimentArmsRequest, dict]):
                The request object. Request message for
                [ExperimentArmService.MutateExperimentArms][google.ads.googleads.v21.services.ExperimentArmService.MutateExperimentArms].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.ExperimentArmOperation]):
                Required. The list of operations to
                perform on individual experiment arm.
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateExperimentArmsResponse:
                Response message for experiment arm
                mutate.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_experiment_arms
        ]
