...
from google.ads.googleads.v21.services.types import local_services_lead_service
from .base import LocalServicesLeadServiceTransport, DEFAULT_CLIENT_INFO
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.LocalServicesLeadService",
...
class LocalServicesLeadServiceGrpcAsyncIOTransport(
    LocalServicesLeadServiceTransport
):
    """gRPC AsyncIO backend transport for LocalServicesLeadService.

    This service allows management of LocalServicesLead
    resources.
    ...
    def append_lead_conversation(
        ...
        r"""Return a callable for the append lead conversation method over gRPC.

        RPC to append Local Services Lead Conversation
        resources to Local Services Lead resources.

        Returns:
            Callable[[~.AppendLeadConversationRequest],
                    Awaitable[~.AppendLeadConversationResponse]]:
        ...
        if "append_lead_conversation" not in self._stubs:
            self._stubs["append_lead_conversation"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.LocalServicesLeadService/AppendLeadConversation",
                    request_serializer=local_services_lead_service.AppendLeadConversationRequest.serialize,
                    response_deserializer=local_services_lead_service.AppendLeadConversationResponse.deserialize,
                )
            )
    ...
    def provide_lead_feedback(
        ...
        if "provide_lead_feedback" not in self._stubs:
            self._stubs["provide_lead_feedback"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.LocalServicesLeadService/ProvideLeadFeedback",
