    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.OfflineUserDataJobService",
...
class OfflineUserDataJobServiceGrpcAsyncIOTransport(
    OfflineUserDataJobServiceTransport
):
    """gRPC AsyncIO backend transport for OfflineUserDataJobService.
    ...
    def create_offline_user_data_job(
        ...
        Returns:
            Callable[[~.CreateOfflineUserDataJobRequest],
                    Awaitable[~.CreateOfflineUserDataJobResponse]]:
        ...
        if "create_offline_user_data_job" not in self._stubs:
            self._stubs["create_offline_user_data_job"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.OfflineUserDataJobService/CreateOfflineUserDataJob",
    ...
    def add_offline_user_data_job_operations(
        ...
        Returns:
            Callable[[~.AddOfflineUserDataJobOperationsRequest],
                    Awaitable[~.AddOfflineUserDataJobOperationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "add_offline_user_data_job_operations" not in self._stubs:
            self._stubs["add_offline_user_data_job_operations"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations",
    ...
    def run_offline_user_data_job(
        ...
        if "run_offline_user_data_job" not in self._stubs:
            self._stubs["run_offline_user_data_job"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.OfflineUserDataJobService/RunOfflineUserDataJob",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_offline_user_data_job: self._wrap_method(
                self.create_offline_user_data_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.add_offline_user_data_job_operations: self._wrap_method(
                self.add_offline_user_data_job_operations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.run_offline_user_data_job: self._wrap_method(
