...
class ProductLinkInvitationServiceTransport(abc.ABC):
    """Abstract transport class for ProductLinkInvitationService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_product_link_invitation: gapic_v1.method.wrap_method(
                self.create_product_link_invitation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_product_link_invitation: gapic_v1.method.wrap_method(
                self.update_product_link_invitation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_product_link_invitation: gapic_v1.method.wrap_method(
