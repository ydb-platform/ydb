...
from google.ads.googleads.v21.services.types import reach_plan_service
...
class ReachPlanServiceGrpcTransport(ReachPlanServiceTransport):
    ...
    def list_plannable_locations(
        ...
        if "list_plannable_locations" not in self._stubs:
            self._stubs["list_plannable_locations"] = (
                self._logged_channel.unary_unary(
    ...
    def list_plannable_products(
        ...
        if "list_plannable_products" not in self._stubs:
            self._stubs["list_plannable_products"] = (
                self._logged_channel.unary_unary(
    ...
    def generate_reach_forecast(
        ...
        if "generate_reach_forecast" not in self._stubs:
            self._stubs["generate_reach_forecast"] = (
                self._logged_channel.unary_unary(
    ...
    def list_plannable_user_lists(
        ...
        r"""Return a callable for the list plannable user lists method over gRPC.

        Returns the list of plannable user lists with their plannable
        ...
        Returns:
            Callable[[~.ListPlannableUserListsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_plannable_user_lists" not in self._stubs:
            self._stubs["list_plannable_user_lists"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.ReachPlanService/ListPlannableUserLists",
                    request_serializer=reach_plan_service.ListPlannableUserListsRequest.serialize,
                    response_deserializer=reach_plan_service.ListPlannableUserListsResponse.deserialize,
                )
            )
        return self._stubs["list_plannable_user_lists"]
    ...
    def list_plannable_user_interests(
        ...
        r"""Return a callable for the list plannable user interests method over gRPC.

        Returns the list of plannable user interests. A plannable user
        ...
        Returns:
            Callable[[~.ListPlannableUserInterestsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_plannable_user_interests" not in self._stubs:
            self._stubs["list_plannable_user_interests"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.ReachPlanService/ListPlannableUserInterests",
                    request_serializer=reach_plan_service.ListPlannableUserInterestsRequest.serialize,
                    response_deserializer=reach_plan_service.ListPlannableUserInterestsResponse.deserialize,
                )
            )
        return self._stubs["list_plannable_user_interests"]
