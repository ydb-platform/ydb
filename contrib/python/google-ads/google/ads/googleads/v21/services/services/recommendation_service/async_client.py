...
from google.ads.googleads.v21.services.types import recommendation_service
...
class RecommendationServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v21.services.RecommendationServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v21.services.RecommendationService",
    ...
    async def apply_recommendation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.ApplyRecommendationRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v21.services.types.ApplyRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.ApplyRecommendationResponse:
    ...
    async def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.DismissRecommendationRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v21.services.types.DismissRecommendationRequest.DismissRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.DismissRecommendationResponse:
                Response message for
                   [RecommendationService.DismissRecommendation][google.ads.googleads.v21.services.RecommendationService.DismissRecommendation].
    ...
    async def generate_recommendations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.GenerateRecommendationsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            recommendation_types (:class:`MutableSequence[google.ads.googleads.v21.enums.types.RecommendationTypeEnum.RecommendationType]`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            advertising_channel_type (:class:`google.ads.googleads.v21.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.GenerateRecommendationsResponse:
                Response message for
                   [RecommendationService.GenerateRecommendations][google.ads.googleads.v21.services.RecommendationService.GenerateRecommendations].
