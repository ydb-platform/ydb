...
class RemarketingActionServiceClientMeta(type):
    """Metaclass for the RemarketingActionService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RemarketingActionServiceTransport]]
    _transport_registry["grpc"] = RemarketingActionServiceGrpcTransport
...
class RemarketingActionServiceClient(
    metaclass=RemarketingActionServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RemarketingActionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> RemarketingActionServiceTransport:
        ...
        Returns:
            RemarketingActionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            RemarketingActionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RemarketingActionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RemarketingActionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the remarketing action service client.
        ...
        ) = RemarketingActionServiceClient._read_environment_variables()
        self._client_cert_source = (
            RemarketingActionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            RemarketingActionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, RemarketingActionServiceTransport
        )
        if transport_provided:
            # transport is a RemarketingActionServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(RemarketingActionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RemarketingActionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                RemarketingActionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., RemarketingActionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.RemarketingActionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_remarketing_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateRemarketingActionsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.RemarketingActionOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_remarketing_actions
        ]
