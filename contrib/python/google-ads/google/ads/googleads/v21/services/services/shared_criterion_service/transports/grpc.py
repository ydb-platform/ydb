    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.SharedCriterionService",
...
class SharedCriterionServiceGrpcTransport(SharedCriterionServiceTransport):
    """gRPC backend transport for SharedCriterionService.
    ...
    def mutate_shared_criteria(
        ...
        Creates or removes shared criteria. Operation statuses are
        returned.
        ...
        Returns:
            Callable[[~.MutateSharedCriteriaRequest],
        ...
        if "mutate_shared_criteria" not in self._stubs:
            self._stubs["mutate_shared_criteria"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.SharedCriterionService/MutateSharedCriteria",
                    request_serializer=shared_criterion_service.MutateSharedCriteriaRequest.serialize,
                    response_deserializer=shared_criterion_service.MutateSharedCriteriaResponse.deserialize,
                )
            )
        return self._stubs["mutate_shared_criteria"]
...
__all__ = ("SharedCriterionServiceGrpcTransport",)
