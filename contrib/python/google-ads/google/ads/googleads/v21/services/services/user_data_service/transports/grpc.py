...
from .base import UserDataServiceTransport, DEFAULT_CLIENT_INFO
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v21.services.UserDataService",
...
class UserDataServiceGrpcTransport(UserDataServiceTransport):
    ...
    def upload_user_data(
        ...
        r"""Return a callable for the upload user data method over gRPC.
        ...
        Returns:
            Callable[[~.UploadUserDataRequest],
        ...
        if "upload_user_data" not in self._stubs:
            self._stubs["upload_user_data"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v21.services.UserDataService/UploadUserData",
                request_serializer=user_data_service.UploadUserDataRequest.serialize,
                response_deserializer=user_data_service.UploadUserDataResponse.deserialize,
            )
        return self._stubs["upload_user_data"]
