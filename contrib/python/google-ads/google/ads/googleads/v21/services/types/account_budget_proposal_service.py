...
class MutateAccountBudgetProposalRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v21.services.types.AccountBudgetProposalOperation):
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v21.services.types.MutateAccountBudgetProposalResult):
