...
class MutateAdGroupAssetsRequest(proto.Message):
    ...
    [AdGroupAssetService.MutateAdGroupAssets][google.ads.googleads.v21.services.AdGroupAssetService.MutateAdGroupAssets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            group assets are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.AdGroupAssetOperation]):
...
class AdGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AdGroupAsset):
            Create operation: No resource name is
            expected for the new ad group asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.AdGroupAsset):
...
class MutateAdGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAdGroupAssetResult]):
