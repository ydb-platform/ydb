...
from google.ads.googleads.v21.common.types import policy
...
class MutateAdGroupCriteriaRequest(proto.Message):
    ...
    [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v21.services.AdGroupCriterionService.MutateAdGroupCriteria].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose criteria
            are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.AdGroupCriterionOperation]):
...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AdGroupCriterion):
            Create operation: No resource name is
            expected for the new criterion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.AdGroupCriterion):
    ...
    update: gagr_ad_group_criterion.AdGroupCriterion = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_ad_group_criterion.AdGroupCriterion,
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAdGroupCriterionResult]):
