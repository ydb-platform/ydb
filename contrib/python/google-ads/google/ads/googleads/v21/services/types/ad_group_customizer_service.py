...
class MutateAdGroupCustomizersRequest(proto.Message):
    ...
    [AdGroupCustomizerService.MutateAdGroupCustomizers][google.ads.googleads.v21.services.AdGroupCustomizerService.MutateAdGroupCustomizers].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            group customizers are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.AdGroupCustomizerOperation]):
            Required. The list of operations to perform
            on individual ad group customizers.
...
class AdGroupCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.AdGroupCustomizer):
    ...
    create: gagr_ad_group_customizer.AdGroupCustomizer = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAdGroupCustomizerResult]):
...
class MutateAdGroupCustomizerResult(proto.Message):
    ...
    Attributes:
        ...
        ad_group_customizer (google.ads.googleads.v21.resources.types.AdGroupCustomizer):
            The mutated AdGroupCustomizer with only mutable fields after
