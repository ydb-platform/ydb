...
class MutateAdsRequest(proto.Message):
    ...
    [AdService.MutateAds][google.ads.googleads.v21.services.AdService.MutateAds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ads
            are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.AdOperation]):
...
class AdOperation(proto.Message):
    ...
    Attributes:
        ...
        policy_validation_parameter (google.ads.googleads.v21.common.types.PolicyValidationParameter):
            Configuration for how policies are validated.
        update (google.ads.googleads.v21.resources.types.Ad):
...
class MutateAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAdResult]):
