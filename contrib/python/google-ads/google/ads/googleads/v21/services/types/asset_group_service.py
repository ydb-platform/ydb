...
from google.ads.googleads.v21.resources.types import asset_group
...
class MutateAssetGroupsRequest(proto.Message):
    ...
    [AssetGroupService.MutateAssetGroups][google.ads.googleads.v21.services.AssetGroupService.MutateAssetGroups].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose asset
            groups are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.AssetGroupOperation]):
...
class AssetGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AssetGroup):
            Create operation: No resource name is
            expected for the new asset group

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.AssetGroup):
    ...
    update: asset_group.AssetGroup = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=asset_group.AssetGroup,
...
class MutateAssetGroupsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAssetGroupResult]):
