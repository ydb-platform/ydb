...
class MutateCampaignCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v21.services.types.CampaignCustomizerOperation]):
...
class CampaignCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.CampaignCustomizer):
    ...
    create: gagr_campaign_customizer.CampaignCustomizer = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateCampaignCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCampaignCustomizerResult]):
