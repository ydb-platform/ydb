...
class MutateConversionActionsRequest(proto.Message):
    ...
    [ConversionActionService.MutateConversionActions][google.ads.googleads.v21.services.ConversionActionService.MutateConversionActions].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            conversion actions are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.ConversionActionOperation]):
            Required. The list of operations to perform
            on individual conversion actions.
...
class ConversionActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.ConversionAction):
            Create operation: No resource name is
            expected for the new conversion action.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.ConversionAction):
    ...
    create: gagr_conversion_action.ConversionAction = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_conversion_action.ConversionAction,
    )
    update: gagr_conversion_action.ConversionAction = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_conversion_action.ConversionAction,
...
class MutateConversionActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateConversionActionResult]):
...
class MutateConversionActionResult(proto.Message):
    ...
    Attributes:
        ...
        conversion_action (google.ads.googleads.v21.resources.types.ConversionAction):
            The mutated conversion action with only mutable fields after
