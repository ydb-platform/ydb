...
class MutateConversionGoalCampaignConfigsRequest(proto.Message):
    ...
    [ConversionGoalCampaignConfigService.MutateConversionGoalCampaignConfigs][google.ads.googleads.v21.services.ConversionGoalCampaignConfigService.MutateConversionGoalCampaignConfigs].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose custom
            conversion goals are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.ConversionGoalCampaignConfigOperation]):
...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v21.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateConversionGoalCampaignConfigResult]):
