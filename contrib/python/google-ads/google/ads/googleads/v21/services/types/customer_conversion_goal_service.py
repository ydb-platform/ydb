...
from google.ads.googleads.v21.resources.types import customer_conversion_goal
...
class MutateCustomerConversionGoalsRequest(proto.Message):
    ...
    [CustomerConversionGoalService.MutateCustomerConversionGoals][google.ads.googleads.v21.services.CustomerConversionGoalService.MutateCustomerConversionGoals].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer conversion goals are being modified.
        operations (MutableSequence[google.ads.googleads.v21.services.types.CustomerConversionGoalOperation]):
...
class CustomerConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v21.resources.types.CustomerConversionGoal):
...
class MutateCustomerConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCustomerConversionGoalResult]):
