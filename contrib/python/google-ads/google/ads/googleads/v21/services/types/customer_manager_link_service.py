...
from google.ads.googleads.v21.resources.types import customer_manager_link
...
class MutateCustomerManagerLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v21.services.types.CustomerManagerLinkOperation]):
...
class CustomerManagerLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v21.resources.types.CustomerManagerLink):
...
class MutateCustomerManagerLinkResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCustomerManagerLinkResult]):
