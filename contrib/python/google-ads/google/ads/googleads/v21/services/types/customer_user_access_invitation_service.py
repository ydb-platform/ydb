...
class MutateCustomerUserAccessInvitationRequest(proto.Message):
    ...
    [CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation][google.ads.googleads.v21.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation]

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose access
            invitation is being modified.
        operation (google.ads.googleads.v21.services.types.CustomerUserAccessInvitationOperation):
...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.CustomerUserAccessInvitation):
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v21.services.types.MutateCustomerUserAccessInvitationResult):
            Result for the mutate.
    """

    result: "MutateCustomerUserAccessInvitationResult" = proto.Field(
        proto.MESSAGE,
        number=1,
