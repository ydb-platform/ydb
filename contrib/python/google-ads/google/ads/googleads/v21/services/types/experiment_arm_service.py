...
class ExperimentArmOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.ExperimentArm):
            Create operation

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.ExperimentArm):
    ...
    update: gagr_experiment_arm.ExperimentArm = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_experiment_arm.ExperimentArm,
...
class MutateExperimentArmsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateExperimentArmResult]):
