...
from google.ads.googleads.v21.common.types import additional_application_info
from google.ads.googleads.v21.common.types import criteria
from google.ads.googleads.v21.common.types import dates
from google.ads.googleads.v21.enums.types import frequency_cap_time_unit
from google.ads.googleads.v21.enums.types import reach_plan_age_range
from google.ads.googleads.v21.enums.types import (
    reach_plan_conversion_rate_model,
)
from google.ads.googleads.v21.enums.types import reach_plan_network
from google.ads.googleads.v21.enums.types import (
    reach_plan_plannable_user_list_status,
)
from google.ads.googleads.v21.enums.types import reach_plan_surface
from google.ads.googleads.v21.enums.types import target_frequency_time_unit
from google.ads.googleads.v21.enums.types import user_interest_taxonomy_type
from google.ads.googleads.v21.enums.types import (
...
class GenerateConversionRatesRequest(proto.Message):
    ...
    Attributes:
        ...
        reach_application_info (google.ads.googleads.v21.common.types.AdditionalApplicationInfo):
...
class GenerateConversionRatesResponse(proto.Message):
    ...
    Attributes:
        conversion_rate_suggestions (MutableSequence[google.ads.googleads.v21.services.types.ConversionRateSuggestion]):
...
class ConversionRateSuggestion(proto.Message):
    ...
    Attributes:
        conversion_rate_model (google.ads.googleads.v21.enums.types.ReachPlanConversionRateModelEnum.ReachPlanConversionRateModel):
...
class ListPlannableLocationsResponse(proto.Message):
    ...
    Attributes:
        plannable_locations (MutableSequence[google.ads.googleads.v21.services.types.PlannableLocation]):
...
class ListPlannableProductsResponse(proto.Message):
    ...
    Attributes:
        product_metadata (MutableSequence[google.ads.googleads.v21.services.types.ProductMetadata]):
...
class ProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        plannable_targeting (google.ads.googleads.v21.services.types.PlannableTargeting):
...
class ListPlannableUserListsResponse(proto.Message):
    ...
    Attributes:
        plannable_user_lists (MutableSequence[google.ads.googleads.v21.services.types.PlannableUserList]):
...
class PlannableUserList(proto.Message):
    ...
    Attributes:
        user_list_info (google.ads.googleads.v21.common.types.UserListInfo):
            The user list ID.
        display_name (str):
            The name of the user list.
        user_list_type (google.ads.googleads.v21.enums.types.UserListTypeEnum.UserListType):
            The user list type.
        plannable_status (google.ads.googleads.v21.enums.types.ReachPlanPlannableUserListStatusEnum.ReachPlanPlannableUserListStatus):
...
class PlannableTargeting(proto.Message):
    ...
    Attributes:
        age_ranges (MutableSequence[google.ads.googleads.v21.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange]):
        ...
        genders (MutableSequence[google.ads.googleads.v21.common.types.GenderInfo]):
            Targetable genders for the ad product.
        devices (MutableSequence[google.ads.googleads.v21.common.types.DeviceInfo]):
            ...
            products.
        networks (MutableSequence[google.ads.googleads.v21.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork]):
            Targetable networks for the ad product.
        youtube_select_lineups (MutableSequence[google.ads.googleads.v21.services.types.YouTubeSelectLineUp]):
            Targetable YouTube Select Lineups for the ad
            product.
        surface_targeting (google.ads.googleads.v21.services.types.SurfaceTargetingCombinations):
...
class ListPlannableUserInterestsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        user_interest_taxonomy_types (MutableSequence[google.ads.googleads.v21.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType]):
...
class ListPlannableUserInterestsResponse(proto.Message):
    ...
    Attributes:
        plannable_user_interests (MutableSequence[google.ads.googleads.v21.services.types.PlannableUserInterest]):
...
class PlannableUserInterest(proto.Message):
    ...
    Attributes:
        ...
        user_interest_type (google.ads.googleads.v21.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType):
...
class GenerateReachForecastRequest(proto.Message):
    ...
    Attributes:
        ...
        campaign_duration (google.ads.googleads.v21.services.types.CampaignDuration):
        ...
        cookie_frequency_cap_setting (google.ads.googleads.v21.services.types.FrequencyCap):
            Chosen cookie frequency cap to be applied to each planned
            product. This is equivalent to the frequency cap exposed in
            Google Ads when creating a campaign, it represents the
            maximum number of times an ad can be shown to the same user
        ...
        effective_frequency_limit (google.ads.googleads.v21.services.types.EffectiveFrequencyLimit):
        ...
        targeting (google.ads.googleads.v21.services.types.Targeting):
        ...
        planned_products (MutableSequence[google.ads.googleads.v21.services.types.PlannedProduct]):
            Required. The products to be forecast.
            The max number of allowed planned products is
            15.
        forecast_metric_options (google.ads.googleads.v21.services.types.ForecastMetricOptions):
...
class Targeting(proto.Message):
    ...
    Attributes:
        ...
        age_range (google.ads.googleads.v21.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange):
            Targeted age range.
        ...
        devices (MutableSequence[google.ads.googleads.v21.common.types.DeviceInfo]):
            ...
            [ReachPlanService.ListPlannableProducts][google.ads.googleads.v21.services.ReachPlanService.ListPlannableProducts].
        network (google.ads.googleads.v21.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork):
            ...
            [ReachPlanService.ListPlannableProducts][google.ads.googleads.v21.services.ReachPlanService.ListPlannableProducts].
        audience_targeting (google.ads.googleads.v21.services.types.AudienceTargeting):
            Targeted audiences.
...
class CampaignDuration(proto.Message):
    ...
    Attributes:
        ...
        date_range (google.ads.googleads.v21.common.types.DateRange):
...
class PlannedProduct(proto.Message):
    ...
    Attributes:
        ...
        advanced_product_targeting (google.ads.googleads.v21.services.types.AdvancedProductTargeting):
...
class GenerateReachForecastResponse(proto.Message):
    ...
    Attributes:
        on_target_audience_metrics (google.ads.googleads.v21.services.types.OnTargetAudienceMetrics):
            Reference on target audiences for this curve.
        reach_curve (google.ads.googleads.v21.services.types.ReachCurve):
...
class ReachCurve(proto.Message):
    ...
    Attributes:
        reach_forecasts (MutableSequence[google.ads.googleads.v21.services.types.ReachForecast]):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        cost_micros (int):
            The cost in micros.
        forecast (google.ads.googleads.v21.services.types.Forecast):
            Forecasted traffic metrics for this point.
        planned_product_reach_forecasts (MutableSequence[google.ads.googleads.v21.services.types.PlannedProductReachForecast]):
...
class Forecast(proto.Message):
    ...
    Attributes:
        ...
        effective_frequency_breakdowns (MutableSequence[google.ads.googleads.v21.services.types.EffectiveFrequencyBreakdown]):
        ...
        views (int):
            ...
            specified product and targeting. A view is
            counted when a viewer views a larger portion or
            the entirety of an ad beyond an impression.
...
class PlannedProductReachForecast(proto.Message):
    ...
    Attributes:
        ...
        planned_product_forecast (google.ads.googleads.v21.services.types.PlannedProductForecast):
...
class AudienceTargeting(proto.Message):
    ...
    Attributes:
        user_interest (MutableSequence[google.ads.googleads.v21.common.types.UserInterestInfo]):
            List of audiences based on user interests to
            be targeted.
        user_lists (MutableSequence[google.ads.googleads.v21.common.types.UserListInfo]):
...
class AdvancedProductTargeting(proto.Message):
    ...
    Attributes:
        surface_targeting_settings (google.ads.googleads.v21.services.types.SurfaceTargeting):
            Surface targeting settings for this product.
        target_frequency_settings (google.ads.googleads.v21.services.types.TargetFrequencySettings):
        ...
        youtube_select_settings (google.ads.googleads.v21.services.types.YouTubeSelectSettings):
...
class SurfaceTargetingCombinations(proto.Message):
    ...
    Attributes:
        default_targeting (google.ads.googleads.v21.services.types.SurfaceTargeting):
            Default surface targeting applied to the ad
            product.
        available_targeting_combinations (MutableSequence[google.ads.googleads.v21.services.types.SurfaceTargeting]):
...
class SurfaceTargeting(proto.Message):
    ...
    Attributes:
        surfaces (MutableSequence[google.ads.googleads.v21.enums.types.ReachPlanSurfaceEnum.ReachPlanSurface]):
...
class TargetFrequencySettings(proto.Message):
    ...
    Attributes:
        time_unit (google.ads.googleads.v21.enums.types.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit):
