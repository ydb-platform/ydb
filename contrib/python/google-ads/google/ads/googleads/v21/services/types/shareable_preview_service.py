...
class GenerateShareablePreviewsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            previews request.
        shareable_previews (MutableSequence[google.ads.googleads.v21.services.types.ShareablePreview]):
...
class ShareablePreview(proto.Message):
    ...
    Attributes:
        asset_group_identifier (google.ads.googleads.v21.services.types.AssetGroupIdentifier):
...
class GenerateShareablePreviewsResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.ads.googleads.v21.services.types.ShareablePreviewOrError]):
...
class ShareablePreviewOrError(proto.Message):
    ...
    Attributes:
        ...
        shareable_preview_result (google.ads.googleads.v21.services.types.ShareablePreviewResult):
