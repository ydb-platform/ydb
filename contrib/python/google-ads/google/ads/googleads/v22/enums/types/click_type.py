    ...
    class ClickType(proto.Enum):
        ...
        Values:
            ...
            CLICK_TO_MESSAGE_THIRD_PARTY_CLICK (64):
                Click on message button that navigates the
                user to a third-party messaging app. If the app
                is not installed, the ad will not show on
                Android, and the button will redirect to the app
                install page on iOS.
            CLICK_TO_MESSAGE_LANDING_PAGE_CLICK (65):
                Click on non-button surface of message ad
                that navigates the user to the Google-hosted
                landing page.
        """
