...
from google.ads.googleads.v22.common.types import simulation
from google.ads.googleads.v22.enums.types import simulation_modification_method
from google.ads.googleads.v22.enums.types import simulation_type
...
class BiddingStrategySimulation(proto.Message):
    ...
    Attributes:
        ...
        bidding_strategy_id (int):
            ...
            of the simulation.
        type_ (google.ads.googleads.v22.enums.types.SimulationTypeEnum.SimulationType):
            Output only. The field that the simulation
            modifies.
        modification_method (google.ads.googleads.v22.enums.types.SimulationModificationMethodEnum.SimulationModificationMethod):
        ...
        target_cpa_point_list (google.ads.googleads.v22.common.types.TargetCpaSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_CPA.

            This field is a member of `oneof`_ ``point_list``.
        target_roas_point_list (google.ads.googleads.v22.common.types.TargetRoasSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_ROAS.
    ...
    bidding_strategy_id: int = proto.Field(
        proto.INT64,
        number=2,
    )
