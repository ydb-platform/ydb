...
from google.ads.googleads.v22.common.types import asset_policy
from google.ads.googleads.v22.enums.types import asset_field_type
from google.ads.googleads.v22.enums.types import asset_link_primary_status
from google.ads.googleads.v22.enums.types import (
    asset_link_primary_status_reason,
)
from google.ads.googleads.v22.enums.types import asset_link_status
from google.ads.googleads.v22.enums.types import asset_source
...
class CampaignAsset(proto.Message):
    ...
    Attributes:
        ...
        source (google.ads.googleads.v22.enums.types.AssetSourceEnum.AssetSource):
            Output only. Source of the campaign asset
            link.
        status (google.ads.googleads.v22.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
            Status of the campaign asset.
        primary_status (google.ads.googleads.v22.enums.types.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus):
        ...
        primary_status_details (MutableSequence[google.ads.googleads.v22.common.types.AssetLinkPrimaryStatusDetails]):
            Output only. Provides the details of the
            primary status and its associated reasons.
        primary_status_reasons (MutableSequence[google.ads.googleads.v22.enums.types.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason]):
