...
from google.ads.googleads.v22.enums.types import campaign_criterion_status
...
class CampaignCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v22.enums.types.CampaignCriterionStatusEnum.CampaignCriterionStatus):
        ...
        mobile_application (google.ads.googleads.v22.common.types.MobileApplicationInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        location (google.ads.googleads.v22.common.types.LocationInfo):
            Immutable. Location.

            This field is a member of `oneof`_ ``criterion``.
        device (google.ads.googleads.v22.common.types.DeviceInfo):
            Immutable. Device.

            This field is a member of `oneof`_ ``criterion``.
        ad_schedule (google.ads.googleads.v22.common.types.AdScheduleInfo):
            Immutable. Ad Schedule.

            This field is a member of `oneof`_ ``criterion``.
        age_range (google.ads.googleads.v22.common.types.AgeRangeInfo):
            Immutable. Age range.
        ...
        gender (google.ads.googleads.v22.common.types.GenderInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        income_range (google.ads.googleads.v22.common.types.IncomeRangeInfo):
        ...
        youtube_channel (google.ads.googleads.v22.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        proximity (google.ads.googleads.v22.common.types.ProximityInfo):
            Immutable. Proximity.

            This field is a member of `oneof`_ ``criterion``.
        topic (google.ads.googleads.v22.common.types.TopicInfo):
            Immutable. Topic.

            This field is a member of `oneof`_ ``criterion``.
        listing_scope (google.ads.googleads.v22.common.types.ListingScopeInfo):
            Immutable. Listing scope.

            This field is a member of `oneof`_ ``criterion``.
        language (google.ads.googleads.v22.common.types.LanguageInfo):
            Immutable. Language.

            This field is a member of `oneof`_ ``criterion``.
        ip_block (google.ads.googleads.v22.common.types.IpBlockInfo):
            Immutable. IpBlock.
            ...
            This field is a member of `oneof`_ ``criterion``.
        content_label (google.ads.googleads.v22.common.types.ContentLabelInfo):
            Immutable. ContentLabel.

            This field is a member of `oneof`_ ``criterion``.
        carrier (google.ads.googleads.v22.common.types.CarrierInfo):
            Immutable. Carrier.
        ...
        webpage (google.ads.googleads.v22.common.types.WebpageInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        operating_system_version (google.ads.googleads.v22.common.types.OperatingSystemVersionInfo):
            Immutable. Operating system version.

            This field is a member of `oneof`_ ``criterion``.
        mobile_device (google.ads.googleads.v22.common.types.MobileDeviceInfo):
            Immutable. Mobile Device.

            This field is a member of `oneof`_ ``criterion``.
        location_group (google.ads.googleads.v22.common.types.LocationGroupInfo):
            Immutable. Location Group

            This field is a member of `oneof`_ ``criterion``.
        custom_affinity (google.ads.googleads.v22.common.types.CustomAffinityInfo):
            Immutable. Custom Affinity.

            This field is a member of `oneof`_ ``criterion``.
        custom_audience (google.ads.googleads.v22.common.types.CustomAudienceInfo):
            Immutable. Custom Audience

            This field is a member of `oneof`_ ``criterion``.
        combined_audience (google.ads.googleads.v22.common.types.CombinedAudienceInfo):
            Immutable. Combined Audience.

            This field is a member of `oneof`_ ``criterion``.
        keyword_theme (google.ads.googleads.v22.common.types.KeywordThemeInfo):
            Immutable. Smart Campaign Keyword Theme.

            This field is a member of `oneof`_ ``criterion``.
        local_service_id (google.ads.googleads.v22.common.types.LocalServiceIdInfo):
            Immutable. GLS service campaign criterion.

            This field is a member of `oneof`_ ``criterion``.
        brand_list (google.ads.googleads.v22.common.types.BrandListInfo):
            Immutable. Brand list campaign criterion.

            This field is a member of `oneof`_ ``criterion``.
        life_event (google.ads.googleads.v22.common.types.LifeEventInfo):
            Immutable. Life event campaign criterion.

            This field is a member of `oneof`_ ``criterion``.
        webpage_list (google.ads.googleads.v22.common.types.WebpageListInfo):
            Immutable. Webpage list.
            This criterion is not publicly available.

            This field is a member of `oneof`_ ``criterion``.
        video_lineup (google.ads.googleads.v22.common.types.VideoLineupInfo):
            Immutable. Video lineup criterion.

            This field is a member of `oneof`_ ``criterion``.
        extended_demographic (google.ads.googleads.v22.common.types.ExtendedDemographicInfo):
    ...
    webpage_list: criteria.WebpageListInfo = proto.Field(
        ...
        number=49,
        oneof="criterion",
        message=criteria.WebpageListInfo,
    )
