...
class CustomerSkAdNetworkConversionValueSchema(proto.Message):
    ...
    Attributes:
        ...
        schema (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema):
    ...
    class SkAdNetworkConversionValueSchema(proto.Message):
        ...
        Attributes:
            ...
            fine_grained_conversion_value_mappings (MutableSequence[google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.FineGrainedConversionValueMappings]):
            ...
            postback_mappings (MutableSequence[google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.PostbackMapping]):
        ...
        class FineGrainedConversionValueMappings(proto.Message):
            ...
            Attributes:
                ...
                conversion_value_mapping (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping):
        ...
        class PostbackMapping(proto.Message):
            ...
            Attributes:
                ...
                coarse_grained_conversion_value_mappings (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings):
                    Output only. Conversion value mappings for
                    all coarse grained conversion values.
                lock_window_coarse_conversion_value (google.ads.googleads.v22.enums.types.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue):
        ...
        class CoarseGrainedConversionValueMappings(proto.Message):
            ...
            Attributes:
                low_conversion_value_mapping (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping):
                    Output only. Mapping for "low" coarse
                    conversion value.
                medium_conversion_value_mapping (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping):
                    Output only. Mapping for "medium" coarse
                    conversion value.
                high_conversion_value_mapping (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping):
        ...
        class ConversionValueMapping(proto.Message):
            ...
            Attributes:
                ...
                max_time_post_install_hours (int):
                    ...
                    which a user was last active during the
                    measurement window.
                mapped_events (MutableSequence[google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event]):
        ...
        class Event(proto.Message):
            ...
            Attributes:
                ...
                event_revenue_range (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event.RevenueRange):
                ...
                event_revenue_value (float):
                    ...
                    This field is a member of `oneof`_ ``revenue_rate``.
                event_occurrence_range (google.ads.googleads.v22.resources.types.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event.EventOccurrenceRange):
