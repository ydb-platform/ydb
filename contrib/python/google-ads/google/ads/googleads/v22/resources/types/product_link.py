...
from google.ads.googleads.v22.enums.types import linked_product_type
...
class ProductLink(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v22.enums.types.LinkedProductTypeEnum.LinkedProductType):
            Output only. The type of the linked product.
        data_partner (google.ads.googleads.v22.resources.types.DataPartnerIdentifier):
            Immutable. Data partner link.

            This field is a member of `oneof`_ ``linked_product``.
        google_ads (google.ads.googleads.v22.resources.types.GoogleAdsIdentifier):
            Immutable. Google Ads link.

            This field is a member of `oneof`_ ``linked_product``.
        merchant_center (google.ads.googleads.v22.resources.types.MerchantCenterIdentifier):
            Immutable. Google Merchant Center link.

            This field is a member of `oneof`_ ``linked_product``.
        advertising_partner (google.ads.googleads.v22.resources.types.AdvertisingPartnerIdentifier):
    ...
    merchant_center: "MerchantCenterIdentifier" = proto.Field(
        proto.MESSAGE,
        number=12,
        oneof="linked_product",
        message="MerchantCenterIdentifier",
    )
    advertising_partner: "AdvertisingPartnerIdentifier" = proto.Field(
        proto.MESSAGE,
        number=13,
        oneof="linked_product",
...
class MerchantCenterIdentifier(proto.Message):
    ...
    Attributes:
        merchant_center_id (int):
            Immutable. The customer ID of the Google
            Merchant Center account. This field is required
            and should not be empty when creating a new
            Merchant Center link. It is unable to be
            modified after the creation of the link.

            This field is a member of `oneof`_ ``_merchant_center_id``.
    """
