...
class AccountLinkServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            AccountLinkServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            AccountLinkServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            AccountLinkServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            AccountLinkServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v22.services.AccountLinkServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v22.services.AccountLinkService",
    ...
    async def create_account_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.CreateAccountLinkRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            account_link (:class:`google.ads.googleads.v22.resources.types.AccountLink`):
        ...
        Returns:
            google.ads.googleads.v22.services.types.CreateAccountLinkResponse:
    ...
    async def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.MutateAccountLinkRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v22.services.types.AccountLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateAccountLinkResponse:
