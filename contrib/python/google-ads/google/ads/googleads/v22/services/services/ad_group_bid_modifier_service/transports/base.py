...
class AdGroupBidModifierServiceTransport(abc.ABC):
    """Abstract transport class for AdGroupBidModifierService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_bid_modifiers: gapic_v1.method.wrap_method(
                self.mutate_ad_group_bid_modifiers,
...
__all__ = ("AdGroupBidModifierServiceTransport",)
