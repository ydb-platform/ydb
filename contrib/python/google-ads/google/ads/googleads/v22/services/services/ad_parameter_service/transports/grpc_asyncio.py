...
from google.ads.googleads.v22.services.types import ad_parameter_service
...
class AdParameterServiceGrpcAsyncIOTransport(AdParameterServiceTransport):
    """gRPC AsyncIO backend transport for AdParameterService.
    ...
    def mutate_ad_parameters(
        ...
        Returns:
            Callable[[~.MutateAdParametersRequest],
                    Awaitable[~.MutateAdParametersResponse]]:
        ...
        if "mutate_ad_parameters" not in self._stubs:
            self._stubs["mutate_ad_parameters"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_parameters: self._wrap_method(
                self.mutate_ad_parameters,
