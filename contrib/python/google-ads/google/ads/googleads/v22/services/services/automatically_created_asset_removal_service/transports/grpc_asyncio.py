...
class AutomaticallyCreatedAssetRemovalServiceGrpcAsyncIOTransport(
    AutomaticallyCreatedAssetRemovalServiceTransport
):
    ...
    def remove_campaign_automatically_created_asset(
        ...
        Returns:
            Callable[[~.RemoveCampaignAutomaticallyCreatedAssetRequest],
                    Awaitable[~.RemoveCampaignAutomaticallyCreatedAssetResponse]]:
        ...
        if "remove_campaign_automatically_created_asset" not in self._stubs:
            self._stubs["remove_campaign_automatically_created_asset"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.AutomaticallyCreatedAssetRemovalService/RemoveCampaignAutomaticallyCreatedAsset",
                    request_serializer=automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetRequest.serialize,
                    response_deserializer=automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetResponse.deserialize,
                )
            )
        return self._stubs["remove_campaign_automatically_created_asset"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.remove_campaign_automatically_created_asset: self._wrap_method(
                self.remove_campaign_automatically_created_asset,
...
__all__ = ("AutomaticallyCreatedAssetRemovalServiceGrpcAsyncIOTransport",)
