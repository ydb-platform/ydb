...
class BiddingSeasonalityAdjustmentServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            BiddingSeasonalityAdjustmentServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            BiddingSeasonalityAdjustmentServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            BiddingSeasonalityAdjustmentServiceAsyncClient,
            filename,
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v22.services.BiddingSeasonalityAdjustmentServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v22.services.types.BiddingSeasonalityAdjustmentOperation]`):
