...
from .transports.grpc import BiddingSeasonalityAdjustmentServiceGrpcTransport
...
class BiddingSeasonalityAdjustmentServiceClientMeta(type):
    """Metaclass for the BiddingSeasonalityAdjustmentService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[BiddingSeasonalityAdjustmentServiceTransport]]
    _transport_registry["grpc"] = (
...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BiddingSeasonalityAdjustmentServiceClient: The constructed client.
        """
    ...
    def transport(self) -> BiddingSeasonalityAdjustmentServiceTransport:
        ...
        Returns:
            BiddingSeasonalityAdjustmentServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            BiddingSeasonalityAdjustmentServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = BiddingSeasonalityAdjustmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the bidding seasonality adjustment service client.
        ...
        (
            ...
            BiddingSeasonalityAdjustmentServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            BiddingSeasonalityAdjustmentServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            BiddingSeasonalityAdjustmentServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, BiddingSeasonalityAdjustmentServiceTransport
        )
        if transport_provided:
            # transport is a BiddingSeasonalityAdjustmentServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                BiddingSeasonalityAdjustmentServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BiddingSeasonalityAdjustmentServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.BiddingSeasonalityAdjustmentServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.BiddingSeasonalityAdjustmentService",
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]):
                The request object. Request message for
                [BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments][google.ads.googleads.v22.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.BiddingSeasonalityAdjustmentOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_bidding_seasonality_adjustments
        ]
