...
class BiddingSeasonalityAdjustmentServiceTransport(abc.ABC):
    """Abstract transport class for BiddingSeasonalityAdjustmentService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_bidding_seasonality_adjustments: gapic_v1.method.wrap_method(
                self.mutate_bidding_seasonality_adjustments,
