...
from .transports.grpc_asyncio import CampaignBudgetServiceGrpcAsyncIOTransport
...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignBudgetServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = CampaignBudgetServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CampaignBudgetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CampaignBudgetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignBudgetServiceClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., CampaignBudgetServiceTransport],
            ]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CampaignBudgetServiceTransport,Callable[..., CampaignBudgetServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CampaignBudgetServiceTransport constructor.
        ...
        ) = CampaignBudgetServiceClient._read_environment_variables()
        ...
        self._universe_domain = (
            CampaignBudgetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignBudgetServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CampaignBudgetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignBudgetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignBudgetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignBudgetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CampaignBudgetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_budgets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCampaignBudgetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignBudgetOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCampaignBudgetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_budgets
        ]
