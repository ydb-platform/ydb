    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.CampaignBudgetService",
...
class CampaignBudgetServiceGrpcTransport(CampaignBudgetServiceTransport):
    """gRPC backend transport for CampaignBudgetService.
    ...
    def mutate_campaign_budgets(
        ...
        Creates, updates, or removes campaign budgets. Operation
        statuses are returned.

        List of thrown errors: `AuthenticationError <>`__
        `AuthorizationError <>`__ `CampaignBudgetError <>`__
        ...
        Returns:
            Callable[[~.MutateCampaignBudgetsRequest],
        ...
        if "mutate_campaign_budgets" not in self._stubs:
            self._stubs["mutate_campaign_budgets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.CampaignBudgetService/MutateCampaignBudgets",
                    request_serializer=campaign_budget_service.MutateCampaignBudgetsRequest.serialize,
                    response_deserializer=campaign_budget_service.MutateCampaignBudgetsResponse.deserialize,
                )
            )
        return self._stubs["mutate_campaign_budgets"]
