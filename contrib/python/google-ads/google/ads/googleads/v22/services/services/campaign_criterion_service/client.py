...
from google.ads.googleads.v22.services.types import campaign_criterion_service
import google.rpc.status_pb2 as status_pb2  # type: ignore
from .transports.base import (
    CampaignCriterionServiceTransport,
    DEFAULT_CLIENT_INFO,
)
from .transports.grpc import CampaignCriterionServiceGrpcTransport
...
class CampaignCriterionServiceClientMeta(type):
    """Metaclass for the CampaignCriterionService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CampaignCriterionServiceTransport]]
...
class CampaignCriterionServiceClient(
    metaclass=CampaignCriterionServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CampaignCriterionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CampaignCriterionServiceTransport:
        ...
        Returns:
            CampaignCriterionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignCriterionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = CampaignCriterionServiceClient._DEFAULT_UNIVERSE
            ...
            api_endpoint = CampaignCriterionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignCriterionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the campaign criterion service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CampaignCriterionServiceTransport,Callable[..., CampaignCriterionServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CampaignCriterionServiceTransport constructor.
        ...
        ) = CampaignCriterionServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignCriterionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CampaignCriterionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignCriterionServiceTransport
        )
        if transport_provided:
            # transport is a CampaignCriterionServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(CampaignCriterionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignCriterionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignCriterionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignCriterionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CampaignCriterionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.CampaignCriterionService",
    ...
    def mutate_campaign_criteria(
        ...
        *,
        ...
        `RegionCodeError <>`__ `RequestError <>`__
        `ResourceCountLimitExceededError <>`__ `SizeLimitError <>`__
        `StringFormatError <>`__ `StringLengthError <>`__

        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCampaignCriteriaRequest, dict]):
                The request object. Request message for
                [CampaignCriterionService.MutateCampaignCriteria][google.ads.googleads.v22.services.CampaignCriterionService.MutateCampaignCriteria].
            customer_id (str):
                Required. The ID of the customer
                whose criteria are being modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignCriterionOperation]):
                Required. The list of operations to
                perform on individual criteria.
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCampaignCriteriaResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_criteria
        ]
