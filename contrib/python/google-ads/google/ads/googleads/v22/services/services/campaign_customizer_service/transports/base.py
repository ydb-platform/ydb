...
from google.ads.googleads.v22.services.types import campaign_customizer_service
...
class CampaignCustomizerServiceTransport(abc.ABC):
    """Abstract transport class for CampaignCustomizerService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_customizers: gapic_v1.method.wrap_method(
                self.mutate_campaign_customizers,
...
__all__ = ("CampaignCustomizerServiceTransport",)
