...
from google.ads.googleads.v22.services.types import campaign_label_service
import google.rpc.status_pb2 as status_pb2  # type: ignore
from .transports.base import CampaignLabelServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import CampaignLabelServiceGrpcTransport
from .transports.grpc_asyncio import CampaignLabelServiceGrpcAsyncIOTransport


class CampaignLabelServiceClientMeta(type):
    """Metaclass for the CampaignLabelService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CampaignLabelServiceTransport]]
    _transport_registry["grpc"] = CampaignLabelServiceGrpcTransport
...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CampaignLabelServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CampaignLabelServiceTransport:
        ...
        Returns:
            CampaignLabelServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignLabelServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CampaignLabelServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignLabelServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the campaign label service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CampaignLabelServiceTransport,Callable[..., CampaignLabelServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CampaignLabelServiceTransport constructor.
        ...
        ) = CampaignLabelServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignLabelServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CampaignLabelServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignLabelServiceTransport
        )
        if transport_provided:
            # transport is a CampaignLabelServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(CampaignLabelServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignLabelServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignLabelServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignLabelServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CampaignLabelServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.CampaignLabelService",
    ...
    def mutate_campaign_labels(
        self,
        request: Optional[
            Union[campaign_label_service.MutateCampaignLabelsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        operations: Optional[
            MutableSequence[campaign_label_service.CampaignLabelOperation]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> campaign_label_service.MutateCampaignLabelsResponse:
        r"""Creates and removes campaign-label relationships. Operation
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCampaignLabelsRequest, dict]):
                The request object. Request message for
                [CampaignLabelService.MutateCampaignLabels][google.ads.googleads.v22.services.CampaignLabelService.MutateCampaignLabels].
            customer_id (str):
                Required. ID of the customer whose
                campaign-label relationships are being
                modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignLabelOperation]):
                Required. The list of operations to
                perform on campaign-label relationships.
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCampaignLabelsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_labels
        ]
    ...
    def __enter__(self) -> "CampaignLabelServiceClient":
        return self
