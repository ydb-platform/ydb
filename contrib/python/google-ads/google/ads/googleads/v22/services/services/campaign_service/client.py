...
from .transports.grpc_asyncio import CampaignServiceGrpcAsyncIOTransport
...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def transport(self) -> CampaignServiceTransport:
        ...
        Returns:
            CampaignServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CampaignServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CampaignServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the campaign service client.
        ...
        ) = CampaignServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CampaignServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, CampaignServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CampaignServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., CampaignServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CampaignServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.CampaignService",
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCampaignsRequest, dict]):
                The request object. Request message for
                [CampaignService.MutateCampaigns][google.ads.googleads.v22.services.CampaignService.MutateCampaigns].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCampaignsResponse:
    ...
    def enable_p_max_brand_guidelines(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.EnablePMaxBrandGuidelinesRequest, dict]):
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.EnableOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.EnablePMaxBrandGuidelinesResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.enable_p_max_brand_guidelines
        ]
