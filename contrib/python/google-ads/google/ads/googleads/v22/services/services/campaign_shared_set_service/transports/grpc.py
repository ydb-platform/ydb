...
from google.ads.googleads.v22.services.types import campaign_shared_set_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.CampaignSharedSetService",
...
class CampaignSharedSetServiceGrpcTransport(CampaignSharedSetServiceTransport):
    ...
    def mutate_campaign_shared_sets(
        ...
        if "mutate_campaign_shared_sets" not in self._stubs:
            self._stubs["mutate_campaign_shared_sets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.CampaignSharedSetService/MutateCampaignSharedSets",
...
__all__ = ("CampaignSharedSetServiceGrpcTransport",)
