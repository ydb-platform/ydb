...
from google.ads.googleads.v22.services.types import conversion_action_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.ConversionActionService",
...
class ConversionActionServiceGrpcTransport(ConversionActionServiceTransport):
    ...
    def mutate_conversion_actions(
        ...
        if "mutate_conversion_actions" not in self._stubs:
            self._stubs["mutate_conversion_actions"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.ConversionActionService/MutateConversionActions",
