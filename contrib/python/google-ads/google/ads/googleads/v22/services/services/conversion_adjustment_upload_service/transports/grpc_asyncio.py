...
class ConversionAdjustmentUploadServiceGrpcAsyncIOTransport(
    ConversionAdjustmentUploadServiceTransport
):
    """gRPC AsyncIO backend transport for ConversionAdjustmentUploadService.
    ...
    def upload_conversion_adjustments(
        ...
        r"""Return a callable for the upload conversion adjustments method over gRPC.
        ...
        Returns:
            Callable[[~.UploadConversionAdjustmentsRequest],
                    Awaitable[~.UploadConversionAdjustmentsResponse]]:
        ...
        if "upload_conversion_adjustments" not in self._stubs:
            self._stubs["upload_conversion_adjustments"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.ConversionAdjustmentUploadService/UploadConversionAdjustments",
                    request_serializer=conversion_adjustment_upload_service.UploadConversionAdjustmentsRequest.serialize,
                    response_deserializer=conversion_adjustment_upload_service.UploadConversionAdjustmentsResponse.deserialize,
                )
            )
        return self._stubs["upload_conversion_adjustments"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.upload_conversion_adjustments: self._wrap_method(
                self.upload_conversion_adjustments,
...
__all__ = ("ConversionAdjustmentUploadServiceGrpcAsyncIOTransport",)
