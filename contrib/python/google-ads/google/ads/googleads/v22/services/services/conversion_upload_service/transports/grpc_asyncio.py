    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.ConversionUploadService",
...
class ConversionUploadServiceGrpcAsyncIOTransport(
    ConversionUploadServiceTransport
):
    """gRPC AsyncIO backend transport for ConversionUploadService.
    ...
    def upload_click_conversions(
        ...
        Returns:
            Callable[[~.UploadClickConversionsRequest],
                    Awaitable[~.UploadClickConversionsResponse]]:
        ...
        if "upload_click_conversions" not in self._stubs:
            self._stubs["upload_click_conversions"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.ConversionUploadService/UploadClickConversions",
                    request_serializer=conversion_upload_service.UploadClickConversionsRequest.serialize,
                    response_deserializer=conversion_upload_service.UploadClickConversionsResponse.deserialize,
                )
            )
        return self._stubs["upload_click_conversions"]
    ...
    def upload_call_conversions(
        ...
        Returns:
            Callable[[~.UploadCallConversionsRequest],
                    Awaitable[~.UploadCallConversionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "upload_call_conversions" not in self._stubs:
            self._stubs["upload_call_conversions"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.ConversionUploadService/UploadCallConversions",
                    request_serializer=conversion_upload_service.UploadCallConversionsRequest.serialize,
                    response_deserializer=conversion_upload_service.UploadCallConversionsResponse.deserialize,
                )
            )
        return self._stubs["upload_call_conversions"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.upload_click_conversions: self._wrap_method(
                self.upload_click_conversions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.upload_call_conversions: self._wrap_method(
                self.upload_call_conversions,
                default_timeout=None,
                client_info=client_info,
            ),
        }
...
__all__ = ("ConversionUploadServiceGrpcAsyncIOTransport",)
