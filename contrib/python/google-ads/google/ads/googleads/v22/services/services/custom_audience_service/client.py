...
from google.ads.googleads.v22.services.types import custom_audience_service
from .transports.base import CustomAudienceServiceTransport, DEFAULT_CLIENT_INFO
...
class CustomAudienceServiceClientMeta(type):
    """Metaclass for the CustomAudienceService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CustomAudienceServiceTransport]]
    _transport_registry["grpc"] = CustomAudienceServiceGrpcTransport
...
class CustomAudienceServiceClient(metaclass=CustomAudienceServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomAudienceServiceClient: The constructed client.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomAudienceServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CustomAudienceServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CustomAudienceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomAudienceServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,CustomAudienceServiceTransport,Callable[..., CustomAudienceServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CustomAudienceServiceTransport constructor.
        ...
        ) = CustomAudienceServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomAudienceServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomAudienceServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomAudienceServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CustomAudienceServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomAudienceServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomAudienceServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomAudienceServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CustomAudienceServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.CustomAudienceService",
    ...
    def mutate_custom_audiences(
        ...
        *,
        ...
        r"""Creates or updates custom audiences. Operation statuses are
        returned.

        List of thrown errors: `AuthenticationError <>`__
        `AuthorizationError <>`__ `CustomAudienceError <>`__
        `CustomInterestError <>`__ `FieldError <>`__
        `FieldMaskError <>`__ `HeaderError <>`__ `InternalError <>`__
        `MutateError <>`__ `OperationAccessDeniedError <>`__
        `PolicyViolationError <>`__ `QuotaError <>`__
        `RequestError <>`__

        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCustomAudiencesRequest, dict]):
                The request object. Request message for
                [CustomAudienceService.MutateCustomAudiences][google.ads.googleads.v22.services.CustomAudienceService.MutateCustomAudiences].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CustomAudienceOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCustomAudiencesResponse:
                Response message for custom audience
                mutate.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_custom_audiences
        ]
