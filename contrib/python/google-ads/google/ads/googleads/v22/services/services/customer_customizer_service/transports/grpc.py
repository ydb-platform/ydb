...
from google.ads.googleads.v22.services.types import customer_customizer_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.CustomerCustomizerService",
...
class CustomerCustomizerServiceGrpcTransport(
    ...
    def mutate_customer_customizers(
        ...
        if "mutate_customer_customizers" not in self._stubs:
            self._stubs["mutate_customer_customizers"] = (
