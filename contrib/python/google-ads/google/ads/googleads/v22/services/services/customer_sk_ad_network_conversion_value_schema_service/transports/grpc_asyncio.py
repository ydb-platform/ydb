    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.CustomerSkAdNetworkConversionValueSchemaService",
...
class CustomerSkAdNetworkConversionValueSchemaServiceGrpcAsyncIOTransport(
    CustomerSkAdNetworkConversionValueSchemaServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerSkAdNetworkConversionValueSchemaService.
    ...
    def mutate_customer_sk_ad_network_conversion_value_schema(
        ...
        r"""Return a callable for the mutate customer sk ad network
        ...
        Returns:
            Callable[[~.MutateCustomerSkAdNetworkConversionValueSchemaRequest],
        ...
        if (
            ...
            self._stubs[
                ...
                request_serializer=customer_sk_ad_network_conversion_value_schema_service.MutateCustomerSkAdNetworkConversionValueSchemaRequest.serialize,
                response_deserializer=customer_sk_ad_network_conversion_value_schema_service.MutateCustomerSkAdNetworkConversionValueSchemaResponse.deserialize,
            )
        return self._stubs[
            "mutate_customer_sk_ad_network_conversion_value_schema"
        ]
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_sk_ad_network_conversion_value_schema: self._wrap_method(
                self.mutate_customer_sk_ad_network_conversion_value_schema,
