...
from google.ads.googleads.v22.services.services.experiment_service import pagers
...
class ExperimentServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = ExperimentServiceGrpcAsyncIOTransport
...
class ExperimentServiceClient(metaclass=ExperimentServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ExperimentServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ExperimentServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ExperimentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ExperimentServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = ExperimentServiceClient._read_environment_variables()
        self._client_cert_source = (
            ExperimentServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = ExperimentServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ExperimentServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ExperimentServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ExperimentServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ExperimentServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ExperimentServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.ExperimentServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.ExperimentService",
    ...
    def mutate_experiments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateExperimentsRequest, dict]):
                The request object. Request message for
                [ExperimentService.MutateExperiments][google.ads.googleads.v22.services.ExperimentService.MutateExperiments].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.ExperimentOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateExperimentsResponse:
    ...
    def end_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.EndExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.EndExperiment][google.ads.googleads.v22.services.ExperimentService.EndExperiment].
            experiment (str):
    ...
    def list_experiment_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.ListExperimentAsyncErrorsRequest, dict]):
                The request object. Request message for
                [ExperimentService.ListExperimentAsyncErrors][google.ads.googleads.v22.services.ExperimentService.ListExperimentAsyncErrors].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v22.services.services.experiment_service.pagers.ListExperimentAsyncErrorsPager:
    ...
    def graduate_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.GraduateExperimentRequest, dict]):
                The request object. Request message for
            ...
            experiment (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_budget_mappings (MutableSequence[google.ads.googleads.v22.services.types.CampaignBudgetMapping]):
    ...
    def schedule_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.ScheduleExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.ScheduleExperiment][google.ads.googleads.v22.services.ExperimentService.ScheduleExperiment].
            resource_name (str):
    ...
    def promote_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.PromoteExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.PromoteExperiment][google.ads.googleads.v22.services.ExperimentService.PromoteExperiment].
            resource_name (str):
                Required. The resource name of the
