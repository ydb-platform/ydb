...
from .transports.grpc_asyncio import GoogleAdsFieldServiceGrpcAsyncIOTransport
...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def transport(self) -> GoogleAdsFieldServiceTransport:
        ...
        Returns:
            GoogleAdsFieldServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def google_ads_field_path(
        google_ads_field: str,
    ) -> str:
        """Returns a fully-qualified google_ads_field string."""
    ...
    def parse_google_ads_field_path(path: str) -> Dict[str, str]:
        """Parses a google_ads_field path into its component segments."""
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            GoogleAdsFieldServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = GoogleAdsFieldServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = GoogleAdsFieldServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                GoogleAdsFieldServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GoogleAdsFieldServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the google ads field service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,GoogleAdsFieldServiceTransport,Callable[..., GoogleAdsFieldServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the GoogleAdsFieldServiceTransport constructor.
        ...
        ) = GoogleAdsFieldServiceClient._read_environment_variables()
        self._client_cert_source = (
            GoogleAdsFieldServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            GoogleAdsFieldServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, GoogleAdsFieldServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(GoogleAdsFieldServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or GoogleAdsFieldServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                GoogleAdsFieldServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., GoogleAdsFieldServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.GoogleAdsFieldServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.GoogleAdsFieldService",
    ...
    def get_google_ads_field(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.GetGoogleAdsFieldRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.GetGoogleAdsField][google.ads.googleads.v22.services.GoogleAdsFieldService.GetGoogleAdsField].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v22.resources.types.GoogleAdsField:
    ...
    def search_google_ads_fields(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.SearchGoogleAdsFieldsRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.SearchGoogleAdsFields][google.ads.googleads.v22.services.GoogleAdsFieldService.SearchGoogleAdsFields].
            query (str):
        ...
        Returns:
            google.ads.googleads.v22.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
