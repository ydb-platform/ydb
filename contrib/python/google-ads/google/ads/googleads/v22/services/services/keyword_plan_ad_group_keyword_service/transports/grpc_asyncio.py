    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.KeywordPlanAdGroupKeywordService",
...
class KeywordPlanAdGroupKeywordServiceGrpcAsyncIOTransport(
    KeywordPlanAdGroupKeywordServiceTransport
):
    """gRPC AsyncIO backend transport for KeywordPlanAdGroupKeywordService.
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        if "mutate_keyword_plan_ad_group_keywords" not in self._stubs:
            self._stubs["mutate_keyword_plan_ad_group_keywords"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_keyword_plan_ad_group_keywords: self._wrap_method(
...
__all__ = ("KeywordPlanAdGroupKeywordServiceGrpcAsyncIOTransport",)
