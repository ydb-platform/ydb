...
class KeywordPlanAdGroupServiceClient(
    metaclass=KeywordPlanAdGroupServiceClientMeta
):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            KeywordPlanAdGroupServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                KeywordPlanAdGroupServiceClient._DEFAULT_UNIVERSE
            )
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = KeywordPlanAdGroupServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = KeywordPlanAdGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = KeywordPlanAdGroupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,KeywordPlanAdGroupServiceTransport,Callable[..., KeywordPlanAdGroupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the KeywordPlanAdGroupServiceTransport constructor.
        ...
        ) = KeywordPlanAdGroupServiceClient._read_environment_variables()
        self._client_cert_source = (
            KeywordPlanAdGroupServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            KeywordPlanAdGroupServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, KeywordPlanAdGroupServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                KeywordPlanAdGroupServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanAdGroupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                KeywordPlanAdGroupServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., KeywordPlanAdGroupServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.KeywordPlanAdGroupServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.KeywordPlanAdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateKeywordPlanAdGroupsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_keyword_plan_ad_groups
        ]
