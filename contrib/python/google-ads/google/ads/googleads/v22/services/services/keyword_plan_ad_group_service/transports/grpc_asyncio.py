...
from .base import KeywordPlanAdGroupServiceTransport, DEFAULT_CLIENT_INFO
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.KeywordPlanAdGroupService",
...
class KeywordPlanAdGroupServiceGrpcAsyncIOTransport(
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        r"""Return a callable for the mutate keyword plan ad groups method over gRPC.

        Creates, updates, or removes Keyword Plan ad groups. Operation
        statuses are returned.

        List of thrown errors: `AuthenticationError <>`__
        `AuthorizationError <>`__ `DatabaseError <>`__ `FieldError <>`__
        `FieldMaskError <>`__ `HeaderError <>`__ `InternalError <>`__
        `KeywordPlanAdGroupError <>`__ `KeywordPlanError <>`__
        `MutateError <>`__ `NewResourceCreationError <>`__
        `QuotaError <>`__ `RequestError <>`__
        `ResourceCountLimitExceededError <>`__

        Returns:
            Callable[[~.MutateKeywordPlanAdGroupsRequest],
                    Awaitable[~.MutateKeywordPlanAdGroupsResponse]]:
        ...
        if "mutate_keyword_plan_ad_groups" not in self._stubs:
            self._stubs["mutate_keyword_plan_ad_groups"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups",
                    request_serializer=keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsRequest.serialize,
                    response_deserializer=keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsResponse.deserialize,
                )
            )
        return self._stubs["mutate_keyword_plan_ad_groups"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.mutate_keyword_plan_ad_groups: self._wrap_method(
                self.mutate_keyword_plan_ad_groups,
...
__all__ = ("KeywordPlanAdGroupServiceGrpcAsyncIOTransport",)
