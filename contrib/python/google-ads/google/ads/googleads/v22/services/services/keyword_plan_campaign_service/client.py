...
class KeywordPlanCampaignServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[KeywordPlanCampaignServiceTransport]]
...
class KeywordPlanCampaignServiceClient(
    metaclass=KeywordPlanCampaignServiceClientMeta
):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            KeywordPlanCampaignServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                KeywordPlanCampaignServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = KeywordPlanCampaignServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = KeywordPlanCampaignServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = KeywordPlanCampaignServiceClient._read_environment_variables()
        self._client_cert_source = (
            KeywordPlanCampaignServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            KeywordPlanCampaignServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, KeywordPlanCampaignServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                KeywordPlanCampaignServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanCampaignServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                KeywordPlanCampaignServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.KeywordPlanCampaignServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateKeywordPlanCampaignsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.KeywordPlanCampaignOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_keyword_plan_campaigns
        ]
