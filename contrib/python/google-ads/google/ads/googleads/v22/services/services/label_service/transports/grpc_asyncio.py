    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.LabelService",
...
class LabelServiceGrpcAsyncIOTransport(LabelServiceTransport):
    """gRPC AsyncIO backend transport for LabelService.
    ...
    def mutate_labels(
        ...
        Returns:
            Callable[[~.MutateLabelsRequest],
                    Awaitable[~.MutateLabelsResponse]]:
        ...
        if "mutate_labels" not in self._stubs:
            self._stubs["mutate_labels"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.LabelService/MutateLabels",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_labels: self._wrap_method(
                self.mutate_labels,
...
__all__ = ("LabelServiceGrpcAsyncIOTransport",)
