...
from .transports.grpc_asyncio import PaymentsAccountServiceGrpcAsyncIOTransport
...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            PaymentsAccountServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PaymentsAccountServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                PaymentsAccountServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = PaymentsAccountServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = PaymentsAccountServiceClient._read_environment_variables()
        self._client_cert_source = (
            PaymentsAccountServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            PaymentsAccountServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, PaymentsAccountServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(PaymentsAccountServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or PaymentsAccountServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                PaymentsAccountServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., PaymentsAccountServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.PaymentsAccountServiceClient`.",
                    extra=(
                        {
    ...
    def list_payments_accounts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.ListPaymentsAccountsRequest, dict]):
