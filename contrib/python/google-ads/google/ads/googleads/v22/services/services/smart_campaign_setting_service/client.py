...
class SmartCampaignSettingServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[SmartCampaignSettingServiceTransport]]
...
class SmartCampaignSettingServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            SmartCampaignSettingServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                SmartCampaignSettingServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = SmartCampaignSettingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SmartCampaignSettingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = SmartCampaignSettingServiceClient._read_environment_variables()
        self._client_cert_source = (
            SmartCampaignSettingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            SmartCampaignSettingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, SmartCampaignSettingServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                SmartCampaignSettingServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SmartCampaignSettingServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                SmartCampaignSettingServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.SmartCampaignSettingServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v22.services.SmartCampaignSettingService",
    ...
    def get_smart_campaign_status(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.GetSmartCampaignStatusRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.GetSmartCampaignStatusResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_smart_campaign_status
        ]
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateSmartCampaignSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.SmartCampaignSettingOperation]):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateSmartCampaignSettingsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_smart_campaign_settings
        ]
