...
from google.ads.googleads.v22.services.types import user_data_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.UserDataService",
    ...
    def upload_user_data(
        ...
        if "upload_user_data" not in self._stubs:
            self._stubs["upload_user_data"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.UserDataService/UploadUserData",
