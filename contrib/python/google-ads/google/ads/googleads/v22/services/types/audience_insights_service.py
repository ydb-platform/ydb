...
from google.ads.googleads.v22.common.types import audience_insights_attribute
from google.ads.googleads.v22.common.types import criteria
from google.ads.googleads.v22.common.types import dates
from google.ads.googleads.v22.enums.types import audience_insights_dimension
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    Attributes:
        ...
        baseline_audience (google.ads.googleads.v22.services.types.InsightsAudience):
            Required. A baseline audience for this
            report, typically all people in a region.
        specific_audience (google.ads.googleads.v22.services.types.InsightsAudience):
        ...
        insights_application_info (google.ads.googleads.v22.common.types.AdditionalApplicationInfo):
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v22.services.types.InsightsAudience):
        ...
        data_month (str):
            ...
            days of data.
        dimensions (MutableSequence[google.ads.googleads.v22.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
...
class GenerateAudienceCompositionInsightsResponse(proto.Message):
    ...
    Attributes:
        sections (MutableSequence[google.ads.googleads.v22.services.types.AudienceCompositionSection]):
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v22.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        audience_definition (google.ads.googleads.v22.services.types.InsightsAudienceDefinition):
            Provide a seed audience to get suggestions
            for.

            This field is a member of `oneof`_ ``audience_input``.
        audience_description (google.ads.googleads.v22.services.types.InsightsAudienceDescription):
...
class GenerateSuggestedTargetingInsightsResponse(proto.Message):
    ...
    Attributes:
        suggestions (MutableSequence[google.ads.googleads.v22.services.types.TargetingSuggestionMetrics]):
...
class TargetingSuggestionMetrics(proto.Message):
    ...
    Attributes:
        locations (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
            Suggested location targeting. These attributes all have
            dimension GEO_TARGET_COUNTRY or SUB_COUNTRY_LOCATION
        age_ranges (MutableSequence[google.ads.googleads.v22.common.types.AgeRangeInfo]):
            Suggested age targeting; may be empty
            indicating no age targeting.
        gender (google.ads.googleads.v22.common.types.GenderInfo):
            Suggested gender targeting.  If present, this
            attribute has dimension GENDER.
        parental_status (google.ads.googleads.v22.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).
        user_interests (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadataGroup]):
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v22.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        location_country_filters (MutableSequence[google.ads.googleads.v22.common.types.LocationInfo]):
            ...
            return an error.
        youtube_reach_location (google.ads.googleads.v22.common.types.LocationInfo):
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
...
class ListInsightsEligibleDatesResponse(proto.Message):
    ...
    Attributes:
        ...
        last_thirty_days (google.ads.googleads.v22.common.types.DateRange):
...
class GenerateAudienceOverlapInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        country_location (google.ads.googleads.v22.common.types.LocationInfo):
            Required. The country in which to calculate
            the sizes and overlaps of audiences.
        primary_attribute (google.ads.googleads.v22.common.types.AudienceInsightsAttribute):
...
class GenerateAudienceOverlapInsightsResponse(proto.Message):
    ...
    Attributes:
        primary_attribute_metadata (google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata):
            Metadata for the primary attribute, including
            potential YouTube reach.
        dimension_results (MutableSequence[google.ads.googleads.v22.services.types.DimensionOverlapResult]):
...
class DimensionOverlapResult(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v22.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The dimension of all the attributes in this
            section.
        items (MutableSequence[google.ads.googleads.v22.services.types.AudienceOverlapItem]):
...
class AudienceOverlapItem(proto.Message):
    ...
    Attributes:
        attribute_metadata (google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata):
...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audiences (MutableSequence[google.ads.googleads.v22.services.types.InsightsAudience]):
...
class InsightsAudienceDescription(proto.Message):
    ...
    Attributes:
        country_locations (MutableSequence[google.ads.googleads.v22.common.types.LocationInfo]):
        ...
        audience_description (str):
            ...
            travel".
        marketing_objective (google.ads.googleads.v22.enums.types.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        ...
        parental_status (google.ads.googleads.v22.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (MutableSequence[google.ads.googleads.v22.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        lineups (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsLineup]):
            Lineups representing the YouTube content
            viewed by the audience.
        user_list (google.ads.googleads.v22.common.types.UserListInfo):
            User list to be targeted by the audience.
        topic_audience_combinations (MutableSequence[google.ads.googleads.v22.services.types.InsightsAudienceAttributeGroup]):
...
class InsightsAudienceAttributeGroup(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttribute]):
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (MutableSequence[google.ads.googleads.v22.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (MutableSequence[google.ads.googleads.v22.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v22.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (MutableSequence[google.ads.googleads.v22.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        ...
        metrics (google.ads.googleads.v22.services.types.AudienceCompositionMetrics):
