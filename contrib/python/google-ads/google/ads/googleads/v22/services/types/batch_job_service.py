...
class MutateBatchJobRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            create a batch job.
        operation (google.ads.googleads.v22.services.types.BatchJobOperation):
...
class BatchJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.BatchJob):
...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v22.services.types.MutateBatchJobResult):
...
class AddBatchJobOperationsRequest(proto.Message):
    ...
    Attributes:
        ...
        mutate_operations (MutableSequence[google.ads.googleads.v22.services.types.MutateOperation]):
...
class ListBatchJobResultsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            Number of elements to retrieve in a single page. The default
            and the page_size limit is 1000. A value of 0 or an unset
            page size will be defaulted to 1000. A page size less than 0
            or greater than 1000 will result in an INVALID_PAGE_SIZE
            error.
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v22.services.types.MutateOperationResponse):
