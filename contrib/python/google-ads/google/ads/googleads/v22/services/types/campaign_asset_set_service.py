...
class MutateCampaignAssetSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignAssetSetOperation]):
...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CampaignAssetSet):
    ...
    create: gagr_campaign_asset_set.CampaignAssetSet = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignAssetSetResult]):
...
class MutateCampaignAssetSetResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_asset_set (google.ads.googleads.v22.resources.types.CampaignAssetSet):
