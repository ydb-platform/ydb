...
class MutateCampaignGoalConfigsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignGoalConfigOperation]):
...
class CampaignGoalConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.CampaignGoalConfig):
            Create a new campaign goal config.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.CampaignGoalConfig):
...
class MutateCampaignGoalConfigsResponse(proto.Message):
    ...
    Attributes:
        ...
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignGoalConfigResult]):
