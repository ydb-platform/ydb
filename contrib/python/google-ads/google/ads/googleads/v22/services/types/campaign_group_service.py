...
class MutateCampaignGroupsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v22.services.types.CampaignGroupOperation]):
...
class CampaignGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.CampaignGroup):
            Create operation: No resource name is
            expected for the new campaign group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.CampaignGroup):
...
class MutateCampaignGroupsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignGroupResult]):
...
class MutateCampaignGroupResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_group (google.ads.googleads.v22.resources.types.CampaignGroup):
