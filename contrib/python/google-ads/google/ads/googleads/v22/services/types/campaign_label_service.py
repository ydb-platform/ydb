...
from google.ads.googleads.v22.resources.types import campaign_label
...
class CampaignLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CampaignLabel):
    ...
    create: campaign_label.CampaignLabel = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateCampaignLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignLabelResult]):
