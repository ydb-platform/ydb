...
class ConfigureCampaignLifecycleGoalsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        operation (google.ads.googleads.v22.services.types.CampaignLifecycleGoalOperation):
...
class CampaignLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.CampaignLifecycleGoal):
            Create operation: Create a new campaign
            lifecycle goal. The campaign field should be set
            for this operation.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.CampaignLifecycleGoal):
