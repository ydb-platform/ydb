...
class GenerateCreatorInsightsRequest(proto.Message):
    ...
    class SearchAttributes(proto.Message):
        ...
        Attributes:
            audience_attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttribute]):
            ...
            creator_attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttribute]):
    ...
    class SearchBrand(proto.Message):
        ...
        Attributes:
            brand_entities (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttribute]):
    ...
    class YouTubeChannels(proto.Message):
        ...
        Attributes:
            youtube_channels (MutableSequence[google.ads.googleads.v22.common.types.YouTubeChannelInfo]):
...
class GenerateCreatorInsightsResponse(proto.Message):
    ...
    Attributes:
        creator_insights (MutableSequence[google.ads.googleads.v22.services.types.YouTubeCreatorInsights]):
...
class GenerateTrendingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        search_audience (google.ads.googleads.v22.services.types.SearchAudience):
            An audience to search for trending content
            in.

            This field is a member of `oneof`_ ``criteria``.
        search_topics (google.ads.googleads.v22.services.types.SearchTopics):
...
class YouTubeCreatorInsights(proto.Message):
    ...
    Attributes:
        ...
        creator_channels (MutableSequence[google.ads.googleads.v22.services.types.YouTubeChannelInsights]):
...
class YouTubeChannelInsights(proto.Message):
    ...
    Attributes:
        ...
        country_location (google.ads.googleads.v22.common.types.LocationInfo):
            ...
            associated.
        channel_metrics (google.ads.googleads.v22.services.types.YouTubeMetrics):
            The metrics for a YouTube Channel.
        channel_audience_attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
        ...
        channel_attributes (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
            The attributes associated with the content
            made by a channel.
        top_videos (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
...
class TrendInsight(proto.Message):
    ...
    Attributes:
        ...
        trend (google.ads.googleads.v22.enums.types.InsightsTrendEnum.InsightsTrend):
            ...
            DECLINING).
        related_videos (MutableSequence[google.ads.googleads.v22.common.types.AudienceInsightsAttributeMetadata]):
            Related videos for this topic. Only populated for trends
            using search_topics.
        related_creators (MutableSequence[google.ads.googleads.v22.services.types.YouTubeCreatorInsights]):
