...
class MutateCustomizerAttributesRequest(proto.Message):
    ...
    [CustomizerAttributeService.MutateCustomizerAttributes][google.ads.googleads.v22.services.CustomizerAttributeService.MutateCustomizerAttributes].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customizer attributes are being modified.
        operations (MutableSequence[google.ads.googleads.v22.services.types.CustomizerAttributeOperation]):
...
class CustomizerAttributeOperation(proto.Message):
    r"""A single operation (create, remove) on a customizer
    attribute.
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCustomizerAttributeResult]):
...
class MutateCustomizerAttributeResult(proto.Message):
    ...
    Attributes:
        ...
        customizer_attribute (google.ads.googleads.v22.resources.types.CustomizerAttribute):
