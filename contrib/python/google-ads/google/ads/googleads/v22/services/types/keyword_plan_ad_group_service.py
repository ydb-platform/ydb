...
from google.ads.googleads.v22.resources.types import keyword_plan_ad_group
...
class KeywordPlanAdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.KeywordPlanAdGroup):
            Create operation: No resource name is
            expected for the new Keyword Plan ad group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.KeywordPlanAdGroup):
    ...
    create: keyword_plan_ad_group.KeywordPlanAdGroup = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=keyword_plan_ad_group.KeywordPlanAdGroup,
    )
    update: keyword_plan_ad_group.KeywordPlanAdGroup = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=keyword_plan_ad_group.KeywordPlanAdGroup,
...
class MutateKeywordPlanAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateKeywordPlanAdGroupResult]):
