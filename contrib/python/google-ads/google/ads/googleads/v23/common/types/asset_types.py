...
from google.ads.googleads.v23.common.types import ad_asset
from google.ads.googleads.v23.common.types import criteria
from google.ads.googleads.v23.common.types import feed_common
from google.ads.googleads.v23.enums.types import (
    business_message_call_to_action_type,
)
from google.ads.googleads.v23.enums.types import business_message_provider
from google.ads.googleads.v23.enums.types import (
...
from google.ads.googleads.v23.enums.types import lead_form_call_to_action_type
from google.ads.googleads.v23.enums.types import lead_form_desired_intent
from google.ads.googleads.v23.enums.types import lead_form_field_user_input_type
from google.ads.googleads.v23.enums.types import (
...
from google.ads.googleads.v23.enums.types import mime_type as gage_mime_type
from google.ads.googleads.v23.enums.types import mobile_app_vendor
from google.ads.googleads.v23.enums.types import price_extension_price_qualifier
from google.ads.googleads.v23.enums.types import price_extension_price_unit
from google.ads.googleads.v23.enums.types import price_extension_type
from google.ads.googleads.v23.enums.types import promotion_barcode_type
from google.ads.googleads.v23.enums.types import (
    promotion_extension_discount_modifier,
)
from google.ads.googleads.v23.enums.types import promotion_extension_occasion
...
class ImageAsset(proto.Message):
    ...
    Attributes:
        ...
        mime_type (google.ads.googleads.v23.enums.types.MimeTypeEnum.MimeType):
            MIME type of the image asset.
        full_size (google.ads.googleads.v23.common.types.ImageDimension):
...
class LeadFormAsset(proto.Message):
    ...
    Attributes:
        business_name (str):
            ...
            advertised.
        call_to_action_type (google.ads.googleads.v23.enums.types.LeadFormCallToActionTypeEnum.LeadFormCallToActionType):
        ...
        fields (MutableSequence[google.ads.googleads.v23.common.types.LeadFormField]):
            Ordered list of input fields. This field can
            be updated by reordering questions, but not by
            adding or removing questions.
        custom_question_fields (MutableSequence[google.ads.googleads.v23.common.types.LeadFormCustomQuestionField]):
            Ordered list of custom question fields. This
            field is subject to a limit of 5 qualifying
            questions per form.
        ...
        post_submit_call_to_action_type (google.ads.googleads.v23.enums.types.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType):
        ...
        desired_intent (google.ads.googleads.v23.enums.types.LeadFormDesiredIntentEnum.LeadFormDesiredIntent):
...
class LeadFormField(proto.Message):
    ...
    Attributes:
        input_type (google.ads.googleads.v23.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
            ...
            do you have?".
        single_choice_answers (google.ads.googleads.v23.common.types.LeadFormSingleChoiceAnswers):
...
class LeadFormDeliveryMethod(proto.Message):
    ...
    Attributes:
        webhook (google.ads.googleads.v23.common.types.WebhookDelivery):
            Webhook method of delivery.

            This field is a member of `oneof`_ ``delivery_details``.
    """

    webhook: "WebhookDelivery" = proto.Field(
        proto.MESSAGE,
        number=1,
...
class PromotionAsset(proto.Message):
    ...
    Attributes:
        ...
        discount_modifier (google.ads.googleads.v23.enums.types.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier):
        ...
        redemption_end_date (str):
            ...
            to be redeemed, in yyyy-MM-dd format.
        occasion (google.ads.googleads.v23.enums.types.PromotionExtensionOccasionEnum.PromotionExtensionOccasion):
        ...
        ad_schedule_targets (MutableSequence[google.ads.googleads.v23.common.types.AdScheduleInfo]):
        ...
        terms_and_conditions_uri (str):
            URI to the terms and conditions of the
            promotion.
        percent_off (int):
        ...
        money_amount_off (google.ads.googleads.v23.common.types.Money):
        ...
        orders_over_amount (google.ads.googleads.v23.common.types.Money):
            The amount the total order needs to be for
            the user to be eligible for the promotion.

            This field is a member of `oneof`_ ``promotion_trigger``.
        promotion_barcode_info (google.ads.googleads.v23.common.types.PromotionBarcodeInfo):
            Barcode info used to generate promotion
            barcode for user to be eligible for the
            promotion.

            This field is a member of `oneof`_ ``promotion_trigger``.
        promotion_qr_code_info (google.ads.googleads.v23.common.types.PromotionQrCodeInfo):
            QR code info used to generate promotion QR
            code for user to be eligible for the promotion.
    ...
    terms_and_conditions_text: str = proto.Field(
        proto.STRING,
        number=14,
    )
    terms_and_conditions_uri: str = proto.Field(
        proto.STRING,
        number=15,
    )
    ...
    promotion_barcode_info: "PromotionBarcodeInfo" = proto.Field(
        proto.MESSAGE,
        number=16,
        oneof="promotion_trigger",
        message="PromotionBarcodeInfo",
    )
    promotion_qr_code_info: "PromotionQrCodeInfo" = proto.Field(
        proto.MESSAGE,
        number=17,
        oneof="promotion_trigger",
...
class PromotionBarcodeInfo(proto.Message):
    r"""Barcode info to generate promotion barcode.

    Attributes:
        type_ (google.ads.googleads.v23.enums.types.PromotionBarcodeTypeEnum.PromotionBarcodeType):
            Barcode type used to generate barcode with
            the correct format.
        barcode_content (str):
            Promotion message to be encoded in the
            barcode.
    """

    type_: (
        promotion_barcode_type.PromotionBarcodeTypeEnum.PromotionBarcodeType
    ) = proto.Field(
        proto.ENUM,
        number=1,
        enum=promotion_barcode_type.PromotionBarcodeTypeEnum.PromotionBarcodeType,
    )
    barcode_content: str = proto.Field(
        proto.STRING,
        number=2,
    )
...
class PromotionQrCodeInfo(proto.Message):
    r"""QR code info to generate promotion QR code.

    Attributes:
        qr_code_content (str):
            Promotion message to be encoded in the QR
            code.
    """

    qr_code_content: str = proto.Field(
        proto.STRING,
        number=1,
    )
...
class MobileAppAsset(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v23.enums.types.MobileAppVendorEnum.MobileAppVendor):
...
class CallAsset(proto.Message):
    ...
    Attributes:
        ...
        call_conversion_reporting_state (google.ads.googleads.v23.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
...
class PriceAsset(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v23.enums.types.PriceExtensionTypeEnum.PriceExtensionType):
            Required. The type of the price asset.
        price_qualifier (google.ads.googleads.v23.enums.types.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier):
            The price qualifier of the price asset.
        language_code (str):
            Required. The language of the price asset.
            Represented as BCP 47 language tag.
        price_offerings (MutableSequence[google.ads.googleads.v23.common.types.PriceOffering]):
...
class PriceOffering(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            between 1 and 25, inclusive.
        price (google.ads.googleads.v23.common.types.Money):
...
class CallToActionAsset(proto.Message):
    ...
    Attributes:
        call_to_action (google.ads.googleads.v23.enums.types.CallToActionTypeEnum.CallToActionType):
            Call to action.
    """
...
class LocationAsset(proto.Message):
    ...
    Attributes:
        ...
        business_profile_locations (MutableSequence[google.ads.googleads.v23.common.types.BusinessProfileLocation]):
        ...
        location_ownership_type (google.ads.googleads.v23.enums.types.LocationOwnershipTypeEnum.LocationOwnershipType):
...
class HotelPropertyAsset(proto.Message):
    ...
    Attributes:
        place_id (str):
            Place IDs uniquely identify a place in the
            Google Places database and on Google Maps. See
            https://developers.google.com/places/web-service/place-id
            to learn more.
        hotel_address (str):
...
class BusinessMessageAsset(proto.Message):
    ...
    Attributes:
        message_provider (google.ads.googleads.v23.enums.types.BusinessMessageProviderEnum.BusinessMessageProvider):
            Required. Message provider of the business
            message asset.
        starter_message (str):
            Required. A welcome message to prompt the
            user to initiate a conversation.
        call_to_action (google.ads.googleads.v23.common.types.BusinessMessageCallToActionInfo):
            A call to action for the business message
            asset.

            This field is a member of `oneof`_ ``_call_to_action``.
        whatsapp_info (google.ads.googleads.v23.common.types.WhatsappBusinessMessageInfo):
            Whatsapp.

            This field is a member of `oneof`_ ``message_provider_data``.
        facebook_messenger_info (google.ads.googleads.v23.common.types.FacebookMessengerBusinessMessageInfo):
            Facebook Messenger.

            This field is a member of `oneof`_ ``message_provider_data``.
        zalo_info (google.ads.googleads.v23.common.types.ZaloBusinessMessageInfo):
            Zalo.
    ...
    message_provider: (
        business_message_provider.BusinessMessageProviderEnum.BusinessMessageProvider
    ) = proto.Field(
        proto.ENUM,
        number=1,
        enum=business_message_provider.BusinessMessageProviderEnum.BusinessMessageProvider,
    )
    starter_message: str = proto.Field(
        proto.STRING,
        number=2,
    )
    call_to_action: "BusinessMessageCallToActionInfo" = proto.Field(
        proto.MESSAGE,
        number=3,
        optional=True,
        message="BusinessMessageCallToActionInfo",
    )
    whatsapp_info: "WhatsappBusinessMessageInfo" = proto.Field(
        proto.MESSAGE,
        number=5,
    ...
    facebook_messenger_info: "FacebookMessengerBusinessMessageInfo" = (
        proto.Field(
            ...
            number=6,
            oneof="message_provider_data",
            message="FacebookMessengerBusinessMessageInfo",
        )
    )
    zalo_info: "ZaloBusinessMessageInfo" = proto.Field(
        proto.MESSAGE,
        number=7,
        oneof="message_provider_data",
        message="ZaloBusinessMessageInfo",
    )
...
class WhatsappBusinessMessageInfo(proto.Message):
    ...
    Attributes:
        country_code (str):
            ...
            phone number. Examples: 'US', 'us'.
        phone_number (str):
            Required. Whatsapp phone number of the
            business. Examples: '1234567890',
            '(123)456-7890'.
    """
...
class FacebookMessengerBusinessMessageInfo(proto.Message):
    r"""Facebook Messenger information to use for messaging.

    Attributes:
        page_name (str):
            Required. Facebook page name used for
            starting a chat on Facebook Messenger.
    """

    page_name: str = proto.Field(
        proto.STRING,
        number=1,
    )
...
class ZaloBusinessMessageInfo(proto.Message):
    r"""Zalo information to use for messaging.
    ...
    Attributes:
        oa_id (int):
            ...
            This field is a member of `oneof`_ ``zalo_id``.
        custom_name (str):
            Custom name generated by the advertiser for
            their Zalo Account. These names will usually be
            registered brands or trademarks.

            This field is a member of `oneof`_ ``zalo_id``.
    """

    oa_id: int = proto.Field(
        proto.INT64,
        number=1,
        oneof="zalo_id",
    )
    custom_name: str = proto.Field(
        proto.STRING,
        number=2,
        oneof="zalo_id",
    )
...
class BusinessMessageCallToActionInfo(proto.Message):
    ...
    Attributes:
        call_to_action_selection (google.ads.googleads.v23.enums.types.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType):
            Required. Pre-defined call to action text.
        call_to_action_description (str):
            Required. Text providing a clear value
            proposition of what users expect once they take
            the action. Examples: 'Message us for a quote',
            'Ask our expert team'.
    """

    call_to_action_selection: (
        business_message_call_to_action_type.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType
    ) = proto.Field(
        proto.ENUM,
        number=1,
        enum=business_message_call_to_action_type.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType,
    )
    call_to_action_description: str = proto.Field(
        proto.STRING,
        number=2,
...
class AppDeepLinkAsset(proto.Message):
    ...
    Attributes:
        app_deep_link_uri (str):
            ...
            either a custom scheme uri (e.g.
            mystore://shoes) or universal uri (e.g.
            http://www.mystore.com/shoes).
    """

    app_deep_link_uri: str = proto.Field(
        proto.STRING,
        number=1,
    )
...
class YouTubeVideoListAsset(proto.Message):
    r"""A YouTube video list asset.

    Attributes:
        youtube_videos (MutableSequence[google.ads.googleads.v23.common.types.AdVideoAsset]):
            List of videos. Each is a reference to a
            YouTube video asset. Minimum of 2 videos
            required and maximum of 5 allowed.
    """
