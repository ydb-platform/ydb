...
from google.ads.googleads.v23.enums.types import fixed_cpm_goal
from google.ads.googleads.v23.enums.types import (
    fixed_cpm_target_frequency_time_unit,
)
from google.ads.googleads.v23.enums.types import target_frequency_time_unit
from google.ads.googleads.v23.enums.types import (
...
class MaximizeConversionValue(proto.Message):
    ...
    Attributes:
        ...
        target_roas_tolerance_percent_millis (int):
            The percent of ROAS(return on advertising
            spend) degradation tolerance allowed to increase
            traffic diversity and conversion volume,
            specified in millis (for example, 10,000 = 10%).
            A value of 10,000 means that the advertiser can
            expect ROAS degradation of up to 10% of the
            specified target ROAS.

            This field is a member of `oneof`_ ``_target_roas_tolerance_percent_millis``.
    """
    ...
    target_roas_tolerance_percent_millis: int = proto.Field(
        proto.INT64,
        number=5,
        optional=True,
    )
...
class TargetCpm(proto.Message):
    ...
    Attributes:
        target_frequency_goal (google.ads.googleads.v23.common.types.TargetCpmTargetFrequencyGoal):
...
class TargetCpmTargetFrequencyGoal(proto.Message):
    ...
    Attributes:
        ...
        time_unit (google.ads.googleads.v23.enums.types.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit):
...
class TargetRoas(proto.Message):
    ...
    Attributes:
        ...
        target_roas_tolerance_percent_millis (int):
            ...
            A value of 10,000 means that the advertiser can
            expect ROAS degradation of up to 10% of the
            specified target ROAS. This field is only
...
class FixedCpm(proto.Message):
    ...
    Attributes:
        goal (google.ads.googleads.v23.enums.types.FixedCpmGoalEnum.FixedCpmGoal):
            Fixed CPM bidding goal. Determines the exact
            bidding optimization parameters.
        target_frequency_info (google.ads.googleads.v23.common.types.FixedCpmTargetFrequencyGoalInfo):
            Target frequency bidding goal details.
...
class FixedCpmTargetFrequencyGoalInfo(proto.Message):
    ...
    Attributes:
        ...
        time_unit (google.ads.googleads.v23.enums.types.FixedCpmTargetFrequencyTimeUnitEnum.FixedCpmTargetFrequencyTimeUnit):
            Time window expressing the period over which you want to
            reach the specified target_count.
    """
...
class TargetCpc(proto.Message):
    r"""An automated bidding strategy that sets bids to help get as
    many clicks as possible at the target cost-per-click (CPC) you
    set.
