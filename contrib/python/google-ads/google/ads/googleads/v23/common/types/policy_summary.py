...
from google.ads.googleads.v23.enums.types import policy_approval_status
from google.ads.googleads.v23.enums.types import policy_review_status
...
class PolicySummary(proto.Message):
    ...
    Attributes:
        policy_topic_entries (MutableSequence[google.ads.googleads.v23.common.types.PolicyTopicEntry]):
        ...
        approval_status (google.ads.googleads.v23.enums.types.PolicyApprovalStatusEnum.PolicyApprovalStatus):
