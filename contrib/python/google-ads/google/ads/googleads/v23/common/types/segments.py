...
from google.ads.googleads.v23.enums.types import (
    ad_sub_network_type as gage_ad_sub_network_type,
)
from google.ads.googleads.v23.enums.types import age_range_type
from google.ads.googleads.v23.enums.types import (
    budget_campaign_association_status as gage_budget_campaign_association_status,
)
from google.ads.googleads.v23.enums.types import click_type as gage_click_type
from google.ads.googleads.v23.enums.types import (
...
from google.ads.googleads.v23.enums.types import day_of_week as gage_day_of_week
from google.ads.googleads.v23.enums.types import device as gage_device
from google.ads.googleads.v23.enums.types import (
    external_conversion_source as gage_external_conversion_source,
)
from google.ads.googleads.v23.enums.types import gender_type
from google.ads.googleads.v23.enums.types import (
...
from google.ads.googleads.v23.enums.types import match_type as gage_match_type
from google.ads.googleads.v23.enums.types import (
...
from google.ads.googleads.v23.enums.types import slot as gage_slot
from google.ads.googleads.v23.enums.types import vertical_ads_item_vertical_type
...
class Segments(proto.Message):
    ...
    Attributes:
        ...
        ad_destination_type (google.ads.googleads.v23.enums.types.AdDestinationTypeEnum.AdDestinationType):
            Ad Destination type.
        ad_format_type (google.ads.googleads.v23.enums.types.AdFormatTypeEnum.AdFormatType):
            Ad Format type.
        ad_network_type (google.ads.googleads.v23.enums.types.AdNetworkTypeEnum.AdNetworkType):
            Ad network type.
        ad_group (str):
            Resource name of the ad group.

            This field is a member of `oneof`_ ``_ad_group``.
        ad_sub_network_type (google.ads.googleads.v23.enums.types.AdSubNetworkTypeEnum.AdSubNetworkType):
        ...
        budget_campaign_association_status (google.ads.googleads.v23.common.types.BudgetCampaignAssociationStatus):
            Budget campaign association status.
        campaign (str):
            Resource name of the campaign.

            This field is a member of `oneof`_ ``_campaign``.
        click_type (google.ads.googleads.v23.enums.types.ClickTypeEnum.ClickType):
            Click type.
        conversion_action (str):
            Resource name of the conversion action.

            This field is a member of `oneof`_ ``_conversion_action``.
        conversion_action_category (google.ads.googleads.v23.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        conversion_attribution_event_type (google.ads.googleads.v23.enums.types.ConversionAttributionEventTypeEnum.ConversionAttributionEventType):
            Conversion attribution event type.
        conversion_lag_bucket (google.ads.googleads.v23.enums.types.ConversionLagBucketEnum.ConversionLagBucket):
        ...
        day_of_week (google.ads.googleads.v23.enums.types.DayOfWeekEnum.DayOfWeek):
            Day of the week, for example, MONDAY.
        device (google.ads.googleads.v23.enums.types.DeviceEnum.Device):
            Device to which metrics apply.
        external_conversion_source (google.ads.googleads.v23.enums.types.ExternalConversionSourceEnum.ExternalConversionSource):
        ...
        hotel_check_in_day_of_week (google.ads.googleads.v23.enums.types.DayOfWeekEnum.DayOfWeek):
        ...
        hotel_date_selection_type (google.ads.googleads.v23.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
        ...
        hotel_rate_type (google.ads.googleads.v23.enums.types.HotelRateTypeEnum.HotelRateType):
            Hotel rate type.
        hotel_price_bucket (google.ads.googleads.v23.enums.types.HotelPriceBucketEnum.HotelPriceBucket):
            Hotel price bucket.
        hotel_state (str):
            Hotel state.
        ...
        keyword (google.ads.googleads.v23.common.types.Keyword):
            Keyword criterion.
        landing_page_source (google.ads.googleads.v23.enums.types.LandingPageSourceEnum.LandingPageSource):
        ...
        month_of_year (google.ads.googleads.v23.enums.types.MonthOfYearEnum.MonthOfYear):
        ...
        product_channel (google.ads.googleads.v23.enums.types.ProductChannelEnum.ProductChannel):
            Channel of the product.
        product_channel_exclusivity (google.ads.googleads.v23.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
            Channel exclusivity of the product.
        product_condition (google.ads.googleads.v23.enums.types.ProductConditionEnum.ProductCondition):
        ...
        vertical_ads_event_participant_display_names (str):
            ...
            This field is a member of `oneof`_ ``_vertical_ads_event_participant_display_names``.
        vertical_ads_hotel_class (int):
            The class of the hotel. Generally in the
            range of 1 to 5 stars, but fully customizable in
            the hotel feed.

            This field is a member of `oneof`_ ``_vertical_ads_hotel_class``.
        vertical_ads_listing (str):
            The listing associated with a listing
            impression, click or conversion.

            This field is a member of `oneof`_ ``_vertical_ads_listing``.
        vertical_ads_listing_brand (str):
            The brand associated with a specific listing
            within a Vertical Ads context, for example, the
            brand of a car rental, a vacation home, or an
            event.

            This field is a member of `oneof`_ ``_vertical_ads_listing_brand``.
        vertical_ads_listing_city (str):
            The city where the vertical ads listing is
            located.

            This field is a member of `oneof`_ ``_vertical_ads_listing_city``.
        vertical_ads_listing_country (str):
            The country where the vertical ads listing is
            located.

            This field is a member of `oneof`_ ``_vertical_ads_listing_country``.
        vertical_ads_listing_region (str):
            The region where the vertical ads listing is
            located.
        ...
        vertical_ads_vertical (google.ads.googleads.v23.enums.types.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType):
            Type of vertical ad, such as Vacation
            Rentals, Car Rentals, or Events, used to
            categorize and segment data in the context of
            Vertical Ads.

            This field is a member of `oneof`_ ``_vertical_ads_vertical``.
        recommendation_type (google.ads.googleads.v23.enums.types.RecommendationTypeEnum.RecommendationType):
            Recommendation type.
        search_engine_results_page_type (google.ads.googleads.v23.enums.types.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType):
        ...
        search_term_match_type (google.ads.googleads.v23.enums.types.SearchTermMatchTypeEnum.SearchTermMatchType):
        ...
        match_type (google.ads.googleads.v23.enums.types.MatchTypeEnum.MatchType):
        ...
        slot (google.ads.googleads.v23.enums.types.SlotEnum.Slot):
            Position of the ad.
        conversion_value_rule_primary_dimension (google.ads.googleads.v23.enums.types.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension):
        ...
        sk_ad_network_user_type (google.ads.googleads.v23.enums.types.SkAdNetworkUserTypeEnum.SkAdNetworkUserType):
            iOS Store Kit Ad Network user type.
        sk_ad_network_ad_event_type (google.ads.googleads.v23.enums.types.SkAdNetworkAdEventTypeEnum.SkAdNetworkAdEventType):
            iOS Store Kit Ad Network ad event type.
        sk_ad_network_source_app (google.ads.googleads.v23.common.types.SkAdNetworkSourceApp):
        ...
        sk_ad_network_attribution_credit (google.ads.googleads.v23.enums.types.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit):
            iOS Store Kit Ad Network attribution credit
        sk_ad_network_coarse_conversion_value (google.ads.googleads.v23.enums.types.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue):
        ...
        asset_interaction_target (google.ads.googleads.v23.common.types.AssetInteractionTarget):
        ...
        new_versus_returning_customers (google.ads.googleads.v23.enums.types.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket):
        ...
        adjusted_gender (google.ads.googleads.v23.enums.types.GenderTypeEnum.GenderType):
            ...
            reach stats. These segmentations are only available for
            allowlisted customers.
        search_term_match_source (google.ads.googleads.v23.enums.types.SearchTermMatchSourceEnum.SearchTermMatchSource):
            ...
            (Standard).
        search_term_targeting_status (google.ads.googleads.v23.enums.types.SearchTermTargetingStatusEnum.SearchTermTargetingStatus):
    ...
    ad_sub_network_type: (
        gage_ad_sub_network_type.AdSubNetworkTypeEnum.AdSubNetworkType
    ) = proto.Field(
        proto.ENUM,
        number=204,
    ...
    vertical_ads_hotel_class: int = proto.Field(
        proto.INT64,
        number=206,
        optional=True,
    )
    vertical_ads_listing: str = proto.Field(
        proto.STRING,
        number=207,
        optional=True,
    )
    vertical_ads_listing_brand: str = proto.Field(
        proto.STRING,
        number=208,
        optional=True,
    )
    vertical_ads_listing_city: str = proto.Field(
        proto.STRING,
        number=209,
        optional=True,
    )
    vertical_ads_listing_country: str = proto.Field(
        proto.STRING,
        number=210,
        optional=True,
    )
...
class Keyword(proto.Message):
    ...
    Attributes:
        ...
        info (google.ads.googleads.v23.common.types.KeywordInfo):
            Keyword info.
    """
...
class BudgetCampaignAssociationStatus(proto.Message):
    ...
    Attributes:
        campaign (str):
            ...
            This field is a member of `oneof`_ ``_campaign``.
        status (google.ads.googleads.v23.enums.types.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus):
            Budget campaign association status.
    """
