...
class AndroidPrivacySharedKeyGoogleNetworkType(proto.Message):
    r"""An Android privacy shared key view for Google network type
    key.
    ...
    Attributes:
        ...
        campaign_id (int):
            ...
            share key encoding.
        android_privacy_interaction_type (google.ads.googleads.v23.enums.types.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType):
        ...
        android_privacy_network_type (google.ads.googleads.v23.enums.types.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType):
        ...
        shared_network_type_key (str):
            ...
            encoded shared network type key, including a
            '0x' prefix. This key can be used to do a
            bitwise OR operator with the aggregate
            conversion key to create a full aggregation key
            to retrieve the Aggregate API Report in Android
            Privacy Sandbox.
    """
    ...
    shared_network_type_key: str = proto.Field(
        proto.STRING,
        number=6,
    )
