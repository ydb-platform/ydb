...
from google.ads.googleads.v23.enums.types import invoice_type
from google.ads.googleads.v23.enums.types import month_of_year
from google.ads.googleads.v23.enums.types import (
    regulatory_fee_type as gage_regulatory_fee_type,
)
from google.ads.googleads.v23.enums.types import (
    unit_of_measure as gage_unit_of_measure,
)
...
class Invoice(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v23.enums.types.InvoiceTypeEnum.InvoiceType):
        ...
        service_date_range (google.ads.googleads.v23.common.types.DateRange):
        ...
        account_budget_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.AccountBudgetSummary]):
            Output only. The list of summarized account
            budget information associated with this invoice.
        account_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.AccountSummary]):
            Output only. The list of summarized account
    ...
    class AccountSummary(proto.Message):
        ...
        Attributes:
            ...
            total_amount_micros (int):
                ...
                This field is a member of `oneof`_ ``_total_amount_micros``.
            regulatory_cost_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.RegulatoryCostSummary]):
                Output only. The list of regulatory cost
                information associated with this account.
            adjustment_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.AdjustmentSummary]):
        ...
        regulatory_cost_summaries: MutableSequence[
            "Invoice.RegulatoryCostSummary"
        ] = proto.RepeatedField(
            proto.MESSAGE,
            number=20,
            message="Invoice.RegulatoryCostSummary",
        )
        adjustment_summaries: MutableSequence["Invoice.AdjustmentSummary"] = (
            proto.RepeatedField(
                proto.MESSAGE,
                number=21,
                message="Invoice.AdjustmentSummary",
            )
        )
    ...
    class AccountBudgetSummary(proto.Message):
        ...
        Attributes:
            ...
            total_amount_micros (int):
                ...
                This field is a member of `oneof`_ ``_total_amount_micros``.
            billable_activity_date_range (google.ads.googleads.v23.common.types.DateRange):
            ...
            invalid_activity_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.InvalidActivitySummary]):
                Output only. The list of summarized invalid
                activity credits with original linkages.
            campaign_summaries (MutableSequence[google.ads.googleads.v23.resources.types.Invoice.CampaignSummary]):
                Output only. The list of summarized campaign
                level information associated with this account
                budget.
        """
        ...
        campaign_summaries: MutableSequence["Invoice.CampaignSummary"] = (
            proto.RepeatedField(
                proto.MESSAGE,
                number=23,
                message="Invoice.CampaignSummary",
            )
        )
    ...
    class InvalidActivitySummary(proto.Message):
        ...
        Attributes:
            original_month_of_service (google.ads.googleads.v23.enums.types.MonthOfYearEnum.MonthOfYear):
    ...
    class CampaignSummary(proto.Message):
        r"""Represents campaign level billable cost information
        associated with an account budget.
        ...
        Attributes:
            campaign_description (str):
                Output only. The description of the campaign.
                This is generally the same as the campaign name,
                but may differ.

                This field is a member of `oneof`_ ``_campaign_description``.
            quantity (int):
                Output only. The quantity served for the
                given unit of measure.

                This field is a member of `oneof`_ ``_quantity``.
            unit_of_measure (google.ads.googleads.v23.enums.types.UnitOfMeasureEnum.UnitOfMeasure):
                Output only. The unit of measure for the
                quantity served.

                This field is a member of `oneof`_ ``_unit_of_measure``.
            amount_micros (int):
                Output only. The amount attributable to this campaign for
                the given unit of measure during the service period, in
                micros. The currency code for this amount is the same as the
                Invoice.currency_code.

                This field is a member of `oneof`_ ``_amount_micros``.
        """

        campaign_description: str = proto.Field(
            proto.STRING,
            number=1,
            optional=True,
        )
        ...
        unit_of_measure: (
            gage_unit_of_measure.UnitOfMeasureEnum.UnitOfMeasure
        ) = proto.Field(
            proto.ENUM,
            number=3,
            optional=True,
            enum=gage_unit_of_measure.UnitOfMeasureEnum.UnitOfMeasure,
        )
        amount_micros: int = proto.Field(
            proto.INT64,
            number=4,
    ...
    class RegulatoryCostSummary(proto.Message):
        r"""Represents regulatory cost information associated with an
        account.
        ...
        Attributes:
            regulatory_fee_type (google.ads.googleads.v23.enums.types.RegulatoryFeeTypeEnum.RegulatoryFeeType):
                Output only. The type of regulatory fee.

                This field is a member of `oneof`_ ``_regulatory_fee_type``.
            amount_micros (int):
                Output only. The amount of the regulatory fee, in micros.
                The currency code for this amount is the same as the
                Invoice.currency_code.
        ...
        regulatory_fee_type: (
            gage_regulatory_fee_type.RegulatoryFeeTypeEnum.RegulatoryFeeType
        ) = proto.Field(
            proto.ENUM,
            number=1,
            optional=True,
            enum=gage_regulatory_fee_type.RegulatoryFeeTypeEnum.RegulatoryFeeType,
        )
        amount_micros: int = proto.Field(
            proto.INT64,
            number=2,
    ...
    class AdjustmentSummary(proto.Message):
        r"""Represents adjustment information associated with an account.
        ...
        Attributes:
            adjustment_description (str):
                ...
                adjustment. Example: Incentive Adjustment,
                discount.

                This field is a member of `oneof`_ ``_adjustment_description``.
            amount_micros (int):
                Output only. The amount of the adjustment, in micros. The
                currency code for this amount is the same as the
                Invoice.currency_code.

                This field is a member of `oneof`_ ``_amount_micros``.
        """

        adjustment_description: str = proto.Field(
            proto.STRING,
            number=1,
            optional=True,
        )
