...
from google.ads.googleads.v23.enums.types import local_services_employee_status
from google.ads.googleads.v23.enums.types import local_services_employee_type
...
class LocalServicesEmployee(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v23.enums.types.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus):
            Output only. Employee status, such as DELETED
            or ENABLED.
        type_ (google.ads.googleads.v23.enums.types.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType):
        ...
        fellowships (MutableSequence[google.ads.googleads.v23.resources.types.Fellowship]):
            Output only. The institutions where the
