...
class SharedCriterion(proto.Message):
    ...
    Attributes:
        ...
        negative (bool):
            Immutable. If true, the criterion is
            excluded. If false, the criterion is targeted.
        ...
        mobile_application (google.ads.googleads.v23.common.types.MobileApplicationInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        brand (google.ads.googleads.v23.common.types.BrandInfo):
            Immutable. Brand.

            This field is a member of `oneof`_ ``criterion``.
        webpage (google.ads.googleads.v23.common.types.WebpageInfo):
            Immutable. Webpage.

            This field is a member of `oneof`_ ``criterion``.
        vertical_ads_item_group_rule (google.ads.googleads.v23.common.types.VerticalAdsItemGroupRuleInfo):
    ...
    vertical_ads_item_group_rule: criteria.VerticalAdsItemGroupRuleInfo = (
        proto.Field(
            proto.MESSAGE,
            number=14,
            oneof="criterion",
            message=criteria.VerticalAdsItemGroupRuleInfo,
        )
    )
