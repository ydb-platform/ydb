...
class AccountBudgetProposalServiceAsyncClient:
    ...
    _client: AccountBudgetProposalServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = AccountBudgetProposalServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = (
        AccountBudgetProposalServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    _DEFAULT_ENDPOINT_TEMPLATE = (
        AccountBudgetProposalServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    _DEFAULT_UNIVERSE = AccountBudgetProposalServiceClient._DEFAULT_UNIVERSE

    account_budget_path = staticmethod(
        AccountBudgetProposalServiceClient.account_budget_path
    )
    parse_account_budget_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_account_budget_path
    )
    account_budget_proposal_path = staticmethod(
        AccountBudgetProposalServiceClient.account_budget_proposal_path
    )
    parse_account_budget_proposal_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_account_budget_proposal_path
    )
    billing_setup_path = staticmethod(
        AccountBudgetProposalServiceClient.billing_setup_path
    )
    parse_billing_setup_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_billing_setup_path
    )
    common_billing_account_path = staticmethod(
        AccountBudgetProposalServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(
        AccountBudgetProposalServiceClient.common_folder_path
    )
    parse_common_folder_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        AccountBudgetProposalServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(
        AccountBudgetProposalServiceClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        AccountBudgetProposalServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        AccountBudgetProposalServiceClient.common_location_path
    )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return AccountBudgetProposalServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = AccountBudgetProposalServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the account budget proposal service async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AccountBudgetProposalServiceTransport,Callable[..., AccountBudgetProposalServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AccountBudgetProposalServiceTransport constructor.
        ...
        """
        self._client = AccountBudgetProposalServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.AccountBudgetProposalServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v23.services.AccountBudgetProposalService",
    ...
    async def mutate_account_budget_proposal(
        self,
        request: Optional[
            Union[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.MutateAccountBudgetProposalRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v23.services.types.AccountBudgetProposalOperation`):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateAccountBudgetProposalResponse:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.mutate_account_budget_proposal
        ]
