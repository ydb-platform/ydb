...
from google.ads.googleads.v23.services.types import account_link_service
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.AccountLinkService",
...
class AccountLinkServiceGrpcAsyncIOTransport(AccountLinkServiceTransport):
    """gRPC AsyncIO backend transport for AccountLinkService.
    ...
    def create_account_link(
        ...
        Returns:
            Callable[[~.CreateAccountLinkRequest],
                    Awaitable[~.CreateAccountLinkResponse]]:
        ...
        if "create_account_link" not in self._stubs:
            self._stubs["create_account_link"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.AccountLinkService/CreateAccountLink",
    ...
    def mutate_account_link(
        ...
        Returns:
            Callable[[~.MutateAccountLinkRequest],
                    Awaitable[~.MutateAccountLinkResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "mutate_account_link" not in self._stubs:
            self._stubs["mutate_account_link"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.AccountLinkService/MutateAccountLink",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_account_link: self._wrap_method(
                self.create_account_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_account_link: self._wrap_method(
...
__all__ = ("AccountLinkServiceGrpcAsyncIOTransport",)
