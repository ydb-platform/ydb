...
class AdGroupAdServiceGrpcAsyncIOTransport(AdGroupAdServiceTransport):
    """gRPC AsyncIO backend transport for AdGroupAdService.
    ...
    def mutate_ad_group_ads(
        ...
        Returns:
            Callable[[~.MutateAdGroupAdsRequest],
                    Awaitable[~.MutateAdGroupAdsResponse]]:
        ...
        if "mutate_ad_group_ads" not in self._stubs:
            self._stubs["mutate_ad_group_ads"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.AdGroupAdService/MutateAdGroupAds",
    ...
    def remove_automatically_created_assets(
        ...
        if "remove_automatically_created_assets" not in self._stubs:
            self._stubs["remove_automatically_created_assets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.AdGroupAdService/RemoveAutomaticallyCreatedAssets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_ads: self._wrap_method(
                self.mutate_ad_group_ads,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_automatically_created_assets: self._wrap_method(
