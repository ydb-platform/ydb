...
class AdGroupCriterionCustomizerServiceTransport(abc.ABC):
    """Abstract transport class for AdGroupCriterionCustomizerService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_criterion_customizers: gapic_v1.method.wrap_method(
...
__all__ = ("AdGroupCriterionCustomizerServiceTransport",)
