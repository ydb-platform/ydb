    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.AdGroupCriterionLabelService",
...
class AdGroupCriterionLabelServiceGrpcAsyncIOTransport(
    AdGroupCriterionLabelServiceTransport
):
    """gRPC AsyncIO backend transport for AdGroupCriterionLabelService.
    ...
    def mutate_ad_group_criterion_labels(
        ...
        Returns:
            Callable[[~.MutateAdGroupCriterionLabelsRequest],
                    Awaitable[~.MutateAdGroupCriterionLabelsResponse]]:
        ...
        if "mutate_ad_group_criterion_labels" not in self._stubs:
            self._stubs["mutate_ad_group_criterion_labels"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_criterion_labels: self._wrap_method(
                self.mutate_ad_group_criterion_labels,
...
__all__ = ("AdGroupCriterionLabelServiceGrpcAsyncIOTransport",)
