...
from .transports.grpc import AdGroupCustomizerServiceGrpcTransport
from .transports.grpc_asyncio import (
    AdGroupCustomizerServiceGrpcAsyncIOTransport,
)


class AdGroupCustomizerServiceClientMeta(type):
    """Metaclass for the AdGroupCustomizerService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AdGroupCustomizerServiceTransport]]
    _transport_registry["grpc"] = AdGroupCustomizerServiceGrpcTransport
    ...
    ) -> Type[AdGroupCustomizerServiceTransport]:
...
class AdGroupCustomizerServiceClient(
    metaclass=AdGroupCustomizerServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AdGroupCustomizerServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AdGroupCustomizerServiceTransport:
        ...
        Returns:
            AdGroupCustomizerServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdGroupCustomizerServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdGroupCustomizerServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupCustomizerServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the ad group customizer service client.
        ...
        ) = AdGroupCustomizerServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupCustomizerServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AdGroupCustomizerServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupCustomizerServiceTransport
        )
        if transport_provided:
            # transport is a AdGroupCustomizerServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(AdGroupCustomizerServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupCustomizerServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupCustomizerServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AdGroupCustomizerServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AdGroupCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAdGroupCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.AdGroupCustomizerOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_ad_group_customizers
        ]
    ...
    def __enter__(self) -> "AdGroupCustomizerServiceClient":
        return self
...
__all__ = ("AdGroupCustomizerServiceClient",)
