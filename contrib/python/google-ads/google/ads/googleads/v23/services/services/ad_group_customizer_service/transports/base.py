...
class AdGroupCustomizerServiceTransport(abc.ABC):
    """Abstract transport class for AdGroupCustomizerService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_customizers: gapic_v1.method.wrap_method(
                self.mutate_ad_group_customizers,
...
__all__ = ("AdGroupCustomizerServiceTransport",)
