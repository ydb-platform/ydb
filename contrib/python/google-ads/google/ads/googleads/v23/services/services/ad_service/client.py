...
from .transports.grpc_asyncio import AdServiceGrpcAsyncIOTransport
...
class AdServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = AdServiceGrpcAsyncIOTransport
...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def transport(self) -> AdServiceTransport:
        ...
        Returns:
            AdServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AdServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AdServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the ad service client.
        ...
        ) = AdServiceClient._read_environment_variables()
        self._client_cert_source = AdServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AdServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AdServiceTransport], Callable[..., AdServiceTransport]
            ] = (
                AdServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AdServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AdServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAdsRequest, dict]):
