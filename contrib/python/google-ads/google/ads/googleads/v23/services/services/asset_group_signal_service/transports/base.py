...
class AssetGroupSignalServiceTransport(abc.ABC):
    """Abstract transport class for AssetGroupSignalService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_asset_group_signals: gapic_v1.method.wrap_method(
                self.mutate_asset_group_signals,
...
__all__ = ("AssetGroupSignalServiceTransport",)
