...
from google.ads.googleads.v23.services.types import asset_service
...
class AssetServiceAsyncClient:
    ...
    conversion_action_path = staticmethod(
        AssetServiceClient.conversion_action_path
    )
    ...
    parse_common_folder_path = staticmethod(
        AssetServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        AssetServiceClient.common_organization_path
    )
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, AssetServiceTransport, Callable[..., AssetServiceTransport]
            ]
        ] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.AssetServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v23.services.AssetService",
    ...
    async def mutate_assets(
        self,
        request: Optional[
            Union[asset_service.MutateAssetsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        operations: Optional[
            MutableSequence[asset_service.AssetOperation]
        ] = None,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.MutateAssetsRequest, dict]]):
                The request object. Request message for
                [AssetService.MutateAssets][google.ads.googleads.v23.services.AssetService.MutateAssets]
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v23.services.types.AssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateAssetsResponse:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.mutate_assets
        ]
