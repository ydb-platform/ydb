...
from google.ads.googleads.v23.services.types import asset_set_asset_service
...
class AssetSetAssetServiceTransport(abc.ABC):
    """Abstract transport class for AssetSetAssetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_asset_set_assets: gapic_v1.method.wrap_method(
                self.mutate_asset_set_assets,
