...
from .transports.grpc import BiddingDataExclusionServiceGrpcTransport
...
class BiddingDataExclusionServiceClientMeta(type):
    """Metaclass for the BiddingDataExclusionService client.
...
class BiddingDataExclusionServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BiddingDataExclusionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> BiddingDataExclusionServiceTransport:
        ...
        Returns:
            BiddingDataExclusionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            BiddingDataExclusionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                BiddingDataExclusionServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = (
                BiddingDataExclusionServiceClient.DEFAULT_MTLS_ENDPOINT
            )
        else:
            api_endpoint = BiddingDataExclusionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = BiddingDataExclusionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the bidding data exclusion service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,BiddingDataExclusionServiceTransport,Callable[..., BiddingDataExclusionServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the BiddingDataExclusionServiceTransport constructor.
        ...
        ) = BiddingDataExclusionServiceClient._read_environment_variables()
        self._client_cert_source = (
            BiddingDataExclusionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            BiddingDataExclusionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, BiddingDataExclusionServiceTransport
        )
        if transport_provided:
            # transport is a BiddingDataExclusionServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                BiddingDataExclusionServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BiddingDataExclusionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                BiddingDataExclusionServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.BiddingDataExclusionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v23.services.BiddingDataExclusionService",
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        r"""Creates, updates, or removes data exclusions.
        Operation statuses are returned.

        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateBiddingDataExclusionsRequest, dict]):
                The request object. Request message for
                [BiddingDataExclusionService.MutateBiddingDataExclusions][google.ads.googleads.v23.services.BiddingDataExclusionService.MutateBiddingDataExclusions].
            customer_id (str):
                Required. ID of the customer whose
                data exclusions are being modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.BiddingDataExclusionOperation]):
                Required. The list of operations to
                perform on individual data exclusions.
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateBiddingDataExclusionsResponse:
                Response message for data exclusions
                mutate.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_bidding_data_exclusions
        ]
