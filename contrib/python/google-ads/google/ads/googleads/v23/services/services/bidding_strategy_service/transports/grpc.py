...
from google.ads.googleads.v23.services.types import bidding_strategy_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.BiddingStrategyService",
...
class BiddingStrategyServiceGrpcTransport(BiddingStrategyServiceTransport):
    ...
    def mutate_bidding_strategies(
        ...
        if "mutate_bidding_strategies" not in self._stubs:
            self._stubs["mutate_bidding_strategies"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.BiddingStrategyService/MutateBiddingStrategies",
