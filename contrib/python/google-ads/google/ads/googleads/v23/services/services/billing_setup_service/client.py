...
from google.ads.googleads.v23.services.types import billing_setup_service
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    accrued costs.
    A billing setup is associated with a payments account.
    Billing-related activity for all billing setups associated with
    a particular payments account will appear on a single invoice
    generated monthly.
    ...
    def transport(self) -> BillingSetupServiceTransport:
        ...
        Returns:
            BillingSetupServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = BillingSetupServiceClient._DEFAULT_UNIVERSE
            ...
            api_endpoint = (
                BillingSetupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = BillingSetupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the billing setup service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,BillingSetupServiceTransport,Callable[..., BillingSetupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the BillingSetupServiceTransport constructor.
        ...
        ) = BillingSetupServiceClient._read_environment_variables()
        self._client_cert_source = (
            BillingSetupServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = BillingSetupServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, BillingSetupServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(BillingSetupServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BillingSetupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                BillingSetupServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., BillingSetupServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.BillingSetupServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v23.services.BillingSetupService",
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        r"""Creates a billing setup, or cancels an existing billing setup.
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateBillingSetupRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v23.services.types.BillingSetupOperation):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateBillingSetupResponse:
