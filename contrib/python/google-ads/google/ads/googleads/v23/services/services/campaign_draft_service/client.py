...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def transport(self) -> CampaignDraftServiceTransport:
        ...
        Returns:
            CampaignDraftServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CampaignDraftServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CampaignDraftServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignDraftServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the campaign draft service client.
        ...
        ) = CampaignDraftServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignDraftServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(
            transport, CampaignDraftServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CampaignDraftServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignDraftServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignDraftServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignDraftServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CampaignDraftServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v23.services.CampaignDraftService",
    ...
    def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCampaignDraftsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.MutateCampaignDrafts][google.ads.googleads.v23.services.CampaignDraftService.MutateCampaignDrafts].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.CampaignDraftOperation]):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateCampaignDraftsResponse:
    ...
    def promote_campaign_draft(
        ...
        *,
        ...
        use
        [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v23.services.CampaignDraftService.ListCampaignDraftAsyncErrors]
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.PromoteCampaignDraft][google.ads.googleads.v23.services.CampaignDraftService.PromoteCampaignDraft].
            campaign_draft (str):
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v23.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v23.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
