...
class CampaignDraftServiceGrpcAsyncIOTransport(CampaignDraftServiceTransport):
    """gRPC AsyncIO backend transport for CampaignDraftService.
    ...
    def mutate_campaign_drafts(
        ...
        Returns:
            Callable[[~.MutateCampaignDraftsRequest],
                    Awaitable[~.MutateCampaignDraftsResponse]]:
    ...
    def list_campaign_draft_async_errors(
        ...
        Returns:
            Callable[[~.ListCampaignDraftAsyncErrorsRequest],
                    Awaitable[~.ListCampaignDraftAsyncErrorsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_drafts: self._wrap_method(
                self.mutate_campaign_drafts,
                default_timeout=None,
                client_info=client_info,
            ),
            self.promote_campaign_draft: self._wrap_method(
                self.promote_campaign_draft,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_campaign_draft_async_errors: self._wrap_method(
