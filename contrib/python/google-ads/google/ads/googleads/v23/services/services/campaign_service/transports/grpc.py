...
from google.ads.googleads.v23.services.types import campaign_service
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.CampaignService",
...
class CampaignServiceGrpcTransport(CampaignServiceTransport):
    ...
    def mutate_campaigns(
        ...
        if "mutate_campaigns" not in self._stubs:
            self._stubs["mutate_campaigns"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v23.services.CampaignService/MutateCampaigns",
    ...
    def enable_p_max_brand_guidelines(
        ...
        r"""Return a callable for the enable p max brand guidelines method over gRPC.
        ...
        Returns:
            Callable[[~.EnablePMaxBrandGuidelinesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "enable_p_max_brand_guidelines" not in self._stubs:
            self._stubs["enable_p_max_brand_guidelines"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.CampaignService/EnablePMaxBrandGuidelines",
                    request_serializer=campaign_service.EnablePMaxBrandGuidelinesRequest.serialize,
                    response_deserializer=campaign_service.EnablePMaxBrandGuidelinesResponse.deserialize,
                )
            )
        return self._stubs["enable_p_max_brand_guidelines"]
