...
from google.ads.googleads.v23.services.types import conversion_action_service
...
from .transports.grpc_asyncio import ConversionActionServiceGrpcAsyncIOTransport
...
class ConversionActionServiceClient(
    ...
    def transport(self) -> ConversionActionServiceTransport:
        ...
        Returns:
            ConversionActionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionActionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = ConversionActionServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = ConversionActionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ConversionActionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ConversionActionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the conversion action service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ConversionActionServiceTransport,Callable[..., ConversionActionServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ConversionActionServiceTransport constructor.
        ...
        ) = ConversionActionServiceClient._read_environment_variables()
        ...
        self._universe_domain = (
            ConversionActionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionActionServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(ConversionActionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionActionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ConversionActionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., ConversionActionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.ConversionActionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v23.services.ConversionActionService",
    ...
    def mutate_conversion_actions(
        ...
        request: Optional[
            Union[
                conversion_action_service.MutateConversionActionsRequest, dict
            ]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateConversionActionsRequest, dict]):
                The request object. Request message for
                [ConversionActionService.MutateConversionActions][google.ads.googleads.v23.services.ConversionActionService.MutateConversionActions].
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.ConversionActionOperation]):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateConversionActionsResponse:
