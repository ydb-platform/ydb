...
class ConversionGoalCampaignConfigServiceTransport(abc.ABC):
    """Abstract transport class for ConversionGoalCampaignConfigService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_conversion_goal_campaign_configs: gapic_v1.method.wrap_method(
                self.mutate_conversion_goal_campaign_configs,
