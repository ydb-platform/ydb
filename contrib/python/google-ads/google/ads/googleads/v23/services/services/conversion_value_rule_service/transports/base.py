...
class ConversionValueRuleServiceTransport(abc.ABC):
    """Abstract transport class for ConversionValueRuleService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_conversion_value_rules: gapic_v1.method.wrap_method(
                self.mutate_conversion_value_rules,
...
__all__ = ("ConversionValueRuleServiceTransport",)
