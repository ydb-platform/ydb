...
class CustomerConversionGoalServiceTransport(abc.ABC):
    """Abstract transport class for CustomerConversionGoalService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_conversion_goals: gapic_v1.method.wrap_method(
...
__all__ = ("CustomerConversionGoalServiceTransport",)
