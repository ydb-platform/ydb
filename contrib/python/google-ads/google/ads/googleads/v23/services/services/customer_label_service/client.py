...
from google.ads.googleads.v23.services.types import customer_label_service
...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def transport(self) -> CustomerLabelServiceTransport:
        ...
        Returns:
            CustomerLabelServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomerLabelServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = CustomerLabelServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CustomerLabelServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CustomerLabelServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerLabelServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the customer label service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CustomerLabelServiceTransport,Callable[..., CustomerLabelServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CustomerLabelServiceTransport constructor.
        ...
        ) = CustomerLabelServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerLabelServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(
            transport, CustomerLabelServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CustomerLabelServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerLabelServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerLabelServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomerLabelServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CustomerLabelServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCustomerLabelsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.CustomerLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateCustomerLabelsResponse:
