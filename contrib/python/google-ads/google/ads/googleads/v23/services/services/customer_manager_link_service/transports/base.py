...
class CustomerManagerLinkServiceTransport(abc.ABC):
    """Abstract transport class for CustomerManagerLinkService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_manager_link: gapic_v1.method.wrap_method(
                self.mutate_customer_manager_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.move_manager_link: gapic_v1.method.wrap_method(
