    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.CustomerNegativeCriterionService",
...
class CustomerNegativeCriterionServiceGrpcTransport(
    ...
    """gRPC backend transport for CustomerNegativeCriterionService.
    ...
    def mutate_customer_negative_criteria(
        ...
        Returns:
            Callable[[~.MutateCustomerNegativeCriteriaRequest],
        ...
        if "mutate_customer_negative_criteria" not in self._stubs:
            self._stubs["mutate_customer_negative_criteria"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria",
                    request_serializer=customer_negative_criterion_service.MutateCustomerNegativeCriteriaRequest.serialize,
                    response_deserializer=customer_negative_criterion_service.MutateCustomerNegativeCriteriaResponse.deserialize,
                )
            )
        return self._stubs["mutate_customer_negative_criteria"]
...
__all__ = ("CustomerNegativeCriterionServiceGrpcTransport",)
