...
from .transports.grpc_asyncio import CustomerServiceGrpcAsyncIOTransport
...
class CustomerServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = CustomerServiceGrpcAsyncIOTransport
...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CustomerServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CustomerServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CustomerServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CustomerServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, CustomerServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CustomerServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., CustomerServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CustomerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCustomerRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v23.services.types.CustomerOperation):
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
