...
class CustomerUserAccessServiceGrpcAsyncIOTransport(
    CustomerUserAccessServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerUserAccessService.
    ...
    def mutate_customer_user_access(
        ...
        Returns:
            Callable[[~.MutateCustomerUserAccessRequest],
                    Awaitable[~.MutateCustomerUserAccessResponse]]:
        ...
        if "mutate_customer_user_access" not in self._stubs:
            self._stubs["mutate_customer_user_access"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.CustomerUserAccessService/MutateCustomerUserAccess",
                    request_serializer=customer_user_access_service.MutateCustomerUserAccessRequest.serialize,
                    response_deserializer=customer_user_access_service.MutateCustomerUserAccessResponse.deserialize,
                )
            )
        return self._stubs["mutate_customer_user_access"]

    def _prep_wrapped_messages(self, client_info):
        """Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.mutate_customer_user_access: self._wrap_method(
                self.mutate_customer_user_access,
...
__all__ = ("CustomerUserAccessServiceGrpcAsyncIOTransport",)
