...
from google.ads.googleads.v23.services.types import data_link_service
...
class DataLinkServiceTransport(abc.ABC):
    """Abstract transport class for DataLinkService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_data_link: gapic_v1.method.wrap_method(
                self.create_data_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_data_link: gapic_v1.method.wrap_method(
                self.remove_data_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_data_link: gapic_v1.method.wrap_method(
                self.update_data_link,
                default_timeout=None,
                client_info=client_info,
            ),
        }
