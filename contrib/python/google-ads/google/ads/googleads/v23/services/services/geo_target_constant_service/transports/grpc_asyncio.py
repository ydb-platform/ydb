...
from google.ads.googleads.v23.services.types import geo_target_constant_service
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.GeoTargetConstantService",
...
class GeoTargetConstantServiceGrpcAsyncIOTransport(
    GeoTargetConstantServiceTransport
):
    """gRPC AsyncIO backend transport for GeoTargetConstantService.
    ...
    def suggest_geo_target_constants(
        ...
        Returns:
            Callable[[~.SuggestGeoTargetConstantsRequest],
                    Awaitable[~.SuggestGeoTargetConstantsResponse]]:
        ...
        if "suggest_geo_target_constants" not in self._stubs:
            self._stubs["suggest_geo_target_constants"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.GeoTargetConstantService/SuggestGeoTargetConstants",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.suggest_geo_target_constants: self._wrap_method(
...
__all__ = ("GeoTargetConstantServiceGrpcAsyncIOTransport",)
