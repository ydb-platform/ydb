    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.GoogleAdsFieldService",
...
class GoogleAdsFieldServiceGrpcTransport(GoogleAdsFieldServiceTransport):
    """gRPC backend transport for GoogleAdsFieldService.
        ...
        if "get_google_ads_field" not in self._stubs:
            self._stubs["get_google_ads_field"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.GoogleAdsFieldService/GetGoogleAdsField",
