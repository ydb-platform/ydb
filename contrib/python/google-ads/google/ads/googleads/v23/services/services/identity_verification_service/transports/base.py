...
class IdentityVerificationServiceTransport(abc.ABC):
    """Abstract transport class for IdentityVerificationService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.start_identity_verification: gapic_v1.method.wrap_method(
                self.start_identity_verification,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_identity_verification: gapic_v1.method.wrap_method(
