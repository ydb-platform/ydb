...
from .client import KeywordPlanAdGroupKeywordServiceClient
...
class KeywordPlanAdGroupKeywordServiceAsyncClient:
    ...
    _client: KeywordPlanAdGroupKeywordServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = KeywordPlanAdGroupKeywordServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = (
        KeywordPlanAdGroupKeywordServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    _DEFAULT_ENDPOINT_TEMPLATE = (
        KeywordPlanAdGroupKeywordServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    _DEFAULT_UNIVERSE = KeywordPlanAdGroupKeywordServiceClient._DEFAULT_UNIVERSE

    keyword_plan_ad_group_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.keyword_plan_ad_group_path
    )
    parse_keyword_plan_ad_group_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_keyword_plan_ad_group_path
    )
    ...
    parse_keyword_plan_ad_group_keyword_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_keyword_plan_ad_group_keyword_path
    )
    common_billing_account_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.common_folder_path
    )
    parse_common_folder_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        KeywordPlanAdGroupKeywordServiceClient.parse_common_location_path
    )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return KeywordPlanAdGroupKeywordServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> KeywordPlanAdGroupKeywordServiceTransport:
        ...
        Returns:
            KeywordPlanAdGroupKeywordServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = (
        KeywordPlanAdGroupKeywordServiceClient.get_transport_class
    )
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the keyword plan ad group keyword service async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,KeywordPlanAdGroupKeywordServiceTransport,Callable[..., KeywordPlanAdGroupKeywordServiceTransport]]]):
        ...
        """
        self._client = KeywordPlanAdGroupKeywordServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordServiceAsyncClient`.",
                extra=(
                    {
                        "serviceName": "google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordService",
    ...
    async def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v23.services.types.KeywordPlanAdGroupKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v23.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.mutate_keyword_plan_ad_group_keywords
        ]
