    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService",
...
class KeywordPlanCampaignKeywordServiceGrpcTransport(
    KeywordPlanCampaignKeywordServiceTransport
):
        ...
        if "mutate_keyword_plan_campaign_keywords" not in self._stubs:
            self._stubs["mutate_keyword_plan_campaign_keywords"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords",
...
__all__ = ("KeywordPlanCampaignKeywordServiceGrpcTransport",)
