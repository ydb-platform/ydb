...
from google.ads.googleads.v23.services.types import keyword_plan_service
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.KeywordPlanService",
...
class KeywordPlanServiceGrpcAsyncIOTransport(KeywordPlanServiceTransport):
    """gRPC AsyncIO backend transport for KeywordPlanService.
    ...
    def mutate_keyword_plans(
        ...
        Returns:
            Callable[[~.MutateKeywordPlansRequest],
                    Awaitable[~.MutateKeywordPlansResponse]]:
        ...
        if "mutate_keyword_plans" not in self._stubs:
            self._stubs["mutate_keyword_plans"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.KeywordPlanService/MutateKeywordPlans",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_keyword_plans: self._wrap_method(
...
__all__ = ("KeywordPlanServiceGrpcAsyncIOTransport",)
