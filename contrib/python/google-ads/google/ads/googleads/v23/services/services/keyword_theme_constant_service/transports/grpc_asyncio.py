    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v23.services.KeywordThemeConstantService",
...
class KeywordThemeConstantServiceGrpcAsyncIOTransport(
    KeywordThemeConstantServiceTransport
):
    """gRPC AsyncIO backend transport for KeywordThemeConstantService.
    ...
    def suggest_keyword_theme_constants(
        ...
        Returns:
            Callable[[~.SuggestKeywordThemeConstantsRequest],
                    Awaitable[~.SuggestKeywordThemeConstantsResponse]]:
        ...
        if "suggest_keyword_theme_constants" not in self._stubs:
            self._stubs["suggest_keyword_theme_constants"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.KeywordThemeConstantService/SuggestKeywordThemeConstants",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.suggest_keyword_theme_constants: self._wrap_method(
                self.suggest_keyword_theme_constants,
...
__all__ = ("KeywordThemeConstantServiceGrpcAsyncIOTransport",)
