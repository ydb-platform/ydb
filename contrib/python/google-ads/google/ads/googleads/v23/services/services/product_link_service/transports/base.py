...
class ProductLinkServiceTransport(abc.ABC):
    """Abstract transport class for ProductLinkService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_product_link: gapic_v1.method.wrap_method(
                self.create_product_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_product_link: gapic_v1.method.wrap_method(
                self.remove_product_link,
                default_timeout=None,
                client_info=client_info,
            ),
        }
