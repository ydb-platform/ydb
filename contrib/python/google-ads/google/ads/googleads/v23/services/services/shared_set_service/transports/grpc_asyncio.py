...
class SharedSetServiceGrpcAsyncIOTransport(SharedSetServiceTransport):
    """gRPC AsyncIO backend transport for SharedSetService.
    ...
    def mutate_shared_sets(
        ...
        Creates, updates, or removes shared sets. Operation statuses are
        returned.
        ...
        Returns:
            Callable[[~.MutateSharedSetsRequest],
                    Awaitable[~.MutateSharedSetsResponse]]:
        ...
        if "mutate_shared_sets" not in self._stubs:
            self._stubs["mutate_shared_sets"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_shared_sets: self._wrap_method(
...
__all__ = ("SharedSetServiceGrpcAsyncIOTransport",)
