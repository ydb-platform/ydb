...
class SmartCampaignSettingServiceTransport(abc.ABC):
    """Abstract transport class for SmartCampaignSettingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_smart_campaign_status: gapic_v1.method.wrap_method(
                self.get_smart_campaign_status,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_smart_campaign_settings: gapic_v1.method.wrap_method(
                self.mutate_smart_campaign_settings,
                default_timeout=None,
                client_info=client_info,
            ),
        }
