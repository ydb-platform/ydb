...
class SmartCampaignSuggestServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[SmartCampaignSuggestServiceTransport]]
...
class SmartCampaignSuggestServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            SmartCampaignSuggestServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                SmartCampaignSuggestServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = (
                SmartCampaignSuggestServiceClient.DEFAULT_MTLS_ENDPOINT
            )
        else:
            api_endpoint = SmartCampaignSuggestServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SmartCampaignSuggestServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,SmartCampaignSuggestServiceTransport,Callable[..., SmartCampaignSuggestServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SmartCampaignSuggestServiceTransport constructor.
        ...
        ) = SmartCampaignSuggestServiceClient._read_environment_variables()
        self._client_cert_source = (
            SmartCampaignSuggestServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            SmartCampaignSuggestServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, SmartCampaignSuggestServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                SmartCampaignSuggestServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SmartCampaignSuggestServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                SmartCampaignSuggestServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.SmartCampaignSuggestServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v23.services.SmartCampaignSuggestService",
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.SuggestSmartCampaignBudgetOptionsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v23.services.types.SuggestSmartCampaignBudgetOptionsResponse:
    ...
    def suggest_smart_campaign_ad(
        ...
        *,
        ...
        suggestion_info: Optional[
            smart_campaign_suggest_service.SmartCampaignSuggestionInfo
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.SuggestSmartCampaignAdRequest, dict]):
                The request object. Request message for
            ...
            suggestion_info (google.ads.googleads.v23.services.types.SmartCampaignSuggestionInfo):
                ...
                Required fields: final_url, language_code,
                keyword_themes. Optional but recommended fields to
                improve the quality of the suggestion: business_setting
                and geo_target.
        ...
        Returns:
            google.ads.googleads.v23.services.types.SuggestSmartCampaignAdResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestSmartCampaignAd][google.ads.googleads.v23.services.SmartCampaignSuggestService.SuggestSmartCampaignAd].
        ...
        flattened_params = [customer_id, suggestion_info]
    ...
    def suggest_keyword_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.SuggestKeywordThemesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v23.services.types.SuggestKeywordThemesResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestKeywordThemes][google.ads.googleads.v23.services.SmartCampaignSuggestService.SuggestKeywordThemes].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.suggest_keyword_themes
        ]
