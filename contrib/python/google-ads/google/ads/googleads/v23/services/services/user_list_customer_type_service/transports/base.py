...
class UserListCustomerTypeServiceTransport(abc.ABC):
    """Abstract transport class for UserListCustomerTypeService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_user_list_customer_types: gapic_v1.method.wrap_method(
                self.mutate_user_list_customer_types,
