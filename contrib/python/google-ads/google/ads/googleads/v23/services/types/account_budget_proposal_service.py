...
from google.ads.googleads.v23.resources.types import account_budget_proposal
...
class MutateAccountBudgetProposalRequest(proto.Message):
    ...
    [AccountBudgetProposalService.MutateAccountBudgetProposal][google.ads.googleads.v23.services.AccountBudgetProposalService.MutateAccountBudgetProposal].

    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        operation (google.ads.googleads.v23.services.types.AccountBudgetProposalOperation):
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v23.services.types.MutateAccountBudgetProposalResult):
