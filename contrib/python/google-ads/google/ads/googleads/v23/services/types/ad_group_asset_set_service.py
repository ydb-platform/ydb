...
class MutateAdGroupAssetSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v23.services.types.AdGroupAssetSetOperation]):
...
class AdGroupAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.AdGroupAssetSet):
...
class MutateAdGroupAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAdGroupAssetSetResult]):
...
class MutateAdGroupAssetSetResult(proto.Message):
    ...
    Attributes:
        ...
        ad_group_asset_set (google.ads.googleads.v23.resources.types.AdGroupAssetSet):
