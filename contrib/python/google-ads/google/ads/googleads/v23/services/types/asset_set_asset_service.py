...
class MutateAssetSetAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v23.services.types.AssetSetAssetOperation]):
    ...
    operations: MutableSequence["AssetSetAssetOperation"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class AssetSetAssetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.AssetSetAsset):
    ...
    create: gagr_asset_set_asset.AssetSetAsset = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateAssetSetAssetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAssetSetAssetResult]):
    ...
    results: MutableSequence["MutateAssetSetAssetResult"] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class MutateAssetSetAssetResult(proto.Message):
    ...
    Attributes:
        ...
        asset_set_asset (google.ads.googleads.v23.resources.types.AssetSetAsset):
