...
class MutateBiddingStrategiesRequest(proto.Message):
    ...
    [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v23.services.BiddingStrategyService.MutateBiddingStrategies].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            bidding strategies are being modified.
        operations (MutableSequence[google.ads.googleads.v23.services.types.BiddingStrategyOperation]):
...
class BiddingStrategyOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.BiddingStrategy):
            Create operation: No resource name is
            expected for the new bidding strategy.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.BiddingStrategy):
    ...
    update: gagr_bidding_strategy.BiddingStrategy = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_bidding_strategy.BiddingStrategy,
...
class MutateBiddingStrategiesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateBiddingStrategyResult]):
...
class MutateBiddingStrategyResult(proto.Message):
    ...
    Attributes:
        ...
        bidding_strategy (google.ads.googleads.v23.resources.types.BiddingStrategy):
