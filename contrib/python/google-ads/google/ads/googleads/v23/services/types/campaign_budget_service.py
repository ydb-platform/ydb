...
class CampaignBudgetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.CampaignBudget):
            Create operation: No resource name is
            expected for the new budget.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.CampaignBudget):
    ...
    update: gagr_campaign_budget.CampaignBudget = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_campaign_budget.CampaignBudget,
...
class MutateCampaignBudgetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCampaignBudgetResult]):
...
class MutateCampaignBudgetResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_budget (google.ads.googleads.v23.resources.types.CampaignBudget):
