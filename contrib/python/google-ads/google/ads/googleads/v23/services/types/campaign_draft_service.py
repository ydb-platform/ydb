...
class CampaignDraftOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.CampaignDraft):
            Create operation: No resource name is
            expected for the new campaign draft.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.CampaignDraft):
    ...
    update: gagr_campaign_draft.CampaignDraft = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_campaign_draft.CampaignDraft,
...
class MutateCampaignDraftResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_draft (google.ads.googleads.v23.resources.types.CampaignDraft):
