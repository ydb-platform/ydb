...
class MutateConversionValueRulesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v23.services.types.ConversionValueRuleOperation]):
...
class ConversionValueRuleOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.ConversionValueRule):
            Create operation: No resource name is
            expected for the new conversion value rule.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.ConversionValueRule):
    ...
    update: gagr_conversion_value_rule.ConversionValueRule = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_conversion_value_rule.ConversionValueRule,
...
class MutateConversionValueRulesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateConversionValueRuleResult]):
...
class MutateConversionValueRuleResult(proto.Message):
    ...
    Attributes:
        ...
        conversion_value_rule (google.ads.googleads.v23.resources.types.ConversionValueRule):
