...
from google.ads.googleads.v23.resources.types import custom_audience
...
class MutateCustomAudiencesRequest(proto.Message):
    ...
    [CustomAudienceService.MutateCustomAudiences][google.ads.googleads.v23.services.CustomAudienceService.MutateCustomAudiences].
...
class CustomAudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.CustomAudience):
    ...
    update: custom_audience.CustomAudience = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=custom_audience.CustomAudience,
...
class MutateCustomAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCustomAudienceResult]):
