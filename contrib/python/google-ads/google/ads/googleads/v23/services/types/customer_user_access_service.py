...
from google.ads.googleads.v23.resources.types import customer_user_access
...
class MutateCustomerUserAccessRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v23.services.types.CustomerUserAccessOperation):
...
class CustomerUserAccessOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v23.resources.types.CustomerUserAccess):
...
class MutateCustomerUserAccessResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v23.services.types.MutateCustomerUserAccessResult):
