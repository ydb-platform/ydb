...
from google.ads.googleads.v23.common.types import offline_user_data
from google.ads.googleads.v23.resources.types import offline_user_data_job
...
class CreateOfflineUserDataJobRequest(proto.Message):
    ...
    Attributes:
        ...
        job (google.ads.googleads.v23.resources.types.OfflineUserDataJob):
...
class AddOfflineUserDataJobOperationsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v23.services.types.OfflineUserDataJobOperation]):
...
class OfflineUserDataJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.common.types.UserData):
            Add the provided data to the transaction.
            Data cannot be retrieved after being uploaded.

            This field is a member of `oneof`_ ``operation``.
        remove (google.ads.googleads.v23.common.types.UserData):
    ...
    create: offline_user_data.UserData = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=offline_user_data.UserData,
    )
    remove: offline_user_data.UserData = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=offline_user_data.UserData,
