...
fragmentOutputs.color=vec4f(mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel,1.0);}}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=a);const h={name:e,shader:a};export{h as iblVoxelGrid3dDebugPixelShaderWGSL};
