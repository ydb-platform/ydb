...
<p>Other stuff</p>'''))
  ...
  def testRegressionInToolbarAbout(self):
    html = tr_html.TrHtml(yatest.common.source_path(r'contrib/python/grit/grit/testdata/toolbar_about.html'))
    html.Parse()
  ...
  def testPrivacyHtml(self):
    html = self.HtmlFromFileWithManualCheck(
      yatest.common.source_path(r'contrib/python/grit/grit/testdata/privacy.html'))
  ...
  def testPreferencesHtml(self):
    html = self.HtmlFromFileWithManualCheck(
      yatest.common.source_path(r'contrib/python/grit/grit/testdata/preferences.html'))
  ...
  def AssertNumberOfTranslateables(self, files, num):
    ...
    '''
    for f in files:
      f = yatest.common.source_path(r'contrib/python/grit/grit/testdata/%s' % f)
  ...
  def testOtherHtmlFilesForManualInspection(self):
    ...
    for f in files:
      self.HtmlFromFileWithManualCheck(
        yatest.common.source_path(r'contrib/python/grit/grit/testdata/%s' % f))
  ...
  def testEscapeUnescaped(self):
    ...
    self.assertTrue(unescaped == u'\u00a9\u00a0 & "<hello>"')
  ...
  def testRegressionCjkHtmlFile(self):
    ...
    if False:
      html = self.HtmlFromFileWithManualCheck(yatest.common.source_path(
        r'contrib/python/grit/grit/testdata/ko_oem_enable_bug.html'))
