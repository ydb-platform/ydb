...
class BuildUnittest(unittest.TestCase):
  ...
  def testFindTranslationsWithSubstitutions(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/substitute.grd')
        self.verbose = False
  ...
  def testGenerateDepFile(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/depfile.grd')
        self.verbose = False
        self.extra_verbose = False
    ...
    with open(expected_dep_file) as f:
      ...
      self.assertEqual(deps, [
          yatest.common.source_path('contrib/python/grit/grit/testdata/default_100_percent/a.png'),
          yatest.common.source_path('contrib/python/grit/grit/testdata/grit_part.grdp'),
          yatest.common.source_path('contrib/python/grit/grit/testdata/special_100_percent/a.png'),
      ])
    output_dir.CleanUp()
  ...
  def testGenerateDepFileWithResourceIds(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/substitute_no_ids.grd')
        self.verbose = False
        self.extra_verbose = False
    expected_dep_file = output_dir.GetPath('substitute_no_ids.grd.d')
    builder.Run(DummyOpts(),
        ['-f', yatest.common.source_path('contrib/python/grit/grit/testdata/resource_ids'),
    ...
    with open(expected_dep_file) as f:
      ...
      self.assertEqual(deps[0],
          yatest.common.source_path('contrib/python/grit/grit/testdata/substitute.xmb'))
      self.assertEqual(deps[1],
          yatest.common.source_path('contrib/python/grit/grit/testdata/resource_ids'))
    output_dir.CleanUp()
  ...
  def testAssertTemplateOutputs(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/substitute_tmpl.grd')
        self.verbose = False
        self.extra_verbose = False
  ...
  def testWhitelistStrings(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/whitelist_strings.grd')
        self.verbose = False
        self.extra_verbose = False
    whitelist_file = yatest.common.source_path('contrib/python/grit/grit/testdata/whitelist.txt')
    builder.Run(DummyOpts(), ['-o', output_dir.GetPath(),
                              '-w', whitelist_file])
  ...
  def testWhitelistResources(self):
    ...
    class DummyOpts(object):
      def __init__(self):
        self.input = yatest.common.source_path('contrib/python/grit/grit/testdata/whitelist_resources.grd')
        self.verbose = False
        self.extra_verbose = False
    whitelist_file = yatest.common.source_path('contrib/python/grit/grit/testdata/whitelist.txt')
    builder.Run(DummyOpts(), ['-o', output_dir.GetPath(),
