...
METASCHEMA_PATH = importlib.resources.files(__package__).joinpath("schemas")

EVENT_METASCHEMA_FILEPATH = METASCHEMA_PATH.joinpath("event-metaschema.yml")
EVENT_METASCHEMA = yaml.loads(EVENT_METASCHEMA_FILEPATH.read_text())

EVENT_CORE_SCHEMA_FILEPATH = METASCHEMA_PATH.joinpath("event-core-schema.yml")
EVENT_CORE_SCHEMA = yaml.loads(EVENT_CORE_SCHEMA_FILEPATH.read_text())

PROPERTY_METASCHEMA_FILEPATH = METASCHEMA_PATH.joinpath("property-metaschema.yml")
PROPERTY_METASCHEMA = yaml.loads(PROPERTY_METASCHEMA_FILEPATH.read_text())
