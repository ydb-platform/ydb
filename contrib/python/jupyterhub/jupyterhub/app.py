...
from jinja2 import Environment, PrefixLoader, ChoiceLoader
...
from .handlers.static import CacheControlStaticFilesHandler, LogoHandler, ResourceLoader
    ...
    def init_tornado_settings(self):
        ...
        loader = ChoiceLoader(
            [
                ...
                PrefixLoader({
                    "templates": ResourceLoader([
                        "resfs/file/contrib/python/jupyterhub/share/jupyterhub/templates"
                    ])
                }),
            ]
        )
