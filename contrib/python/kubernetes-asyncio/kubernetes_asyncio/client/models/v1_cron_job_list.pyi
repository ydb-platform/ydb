...
class V1CronJobList:
    ...
    def __init__(self, api_version: str | None = None, items: list[V1CronJob] | None = None, kind: str | None = None, metadata: V1ListMeta | None = None, local_vars_configuration: Any | None = None) -> None: ...
