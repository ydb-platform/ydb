...
class V1DeploymentList:
    ...
    def __init__(self, api_version: str | None = None, items: list[V1Deployment] | None = None, kind: str | None = None, metadata: V1ListMeta | None = None, local_vars_configuration: Any | None = None) -> None: ...
    ...
    @items.setter
    def items(self, items: list[V1Deployment]) -> None: ...
    @property
    def kind(self) -> str: ...
    @kind.setter
