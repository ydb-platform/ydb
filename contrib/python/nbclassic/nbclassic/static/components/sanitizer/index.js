...
var _require = __webpack_require__(197),
  ...
  sep = _require.sep;
var _require2 = __webpack_require__(1866),
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var _require = __webpack_require__(5042),
...
var _require3 = __webpack_require__(1866),
  SourceMapConsumer = _require3.SourceMapConsumer,
  SourceMapGenerator = _require3.SourceMapGenerator;
var _require4 = __webpack_require__(2739),
...
var escapeStringRegexp = __webpack_require__(2604);
...
var Sanitizer = /*#__PURE__*/function () {
  function Sanitizer() {
    ...
    this._generateOptions = function () {
      return {
        ...
        allowedAttributes: {
          '*': ['class', 'dir', 'draggable', 'hidden'].concat(_toConsumableArray(_this._allowNamedProperties ? ['id'] : []), ['inert', 'itemprop', 'itemref', 'itemscope', 'lang', 'spellcheck', 'style', 'title', 'translate']),
          // 'rel' and 'target' were *not* allowed by Google Caja
          a: ['accesskey', 'coords', 'href', 'hreflang'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['rel', 'shape', 'tabindex', 'target', 'type']),
          ...
          blockquote: ['cite'],
          br: ['clear'],
          button: ['accesskey', 'data-commandlinker-args', 'data-commandlinker-command', 'disabled'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['tabindex', 'type', 'value']),
          canvas: ['height', 'width'],
          caption: ['align'],
          ...
          form: ['accept', 'autocomplete', 'enctype', 'method'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['novalidate']),
          h1: ['align'],
          h2: ['align'],
          h3: ['align'],
          h4: ['align'],
          ...
          img: ['align', 'alt', 'border', 'height', 'hspace', 'ismap'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['src', 'usemap', 'vspace', 'width']),
          input: ['accept', 'accesskey', 'align', 'alt', 'autocomplete', 'checked', 'disabled', 'inputmode', 'ismap', 'list', 'max', 'maxlength', 'min', 'multiple'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['placeholder', 'readonly', 'required', 'size', 'src', 'step', 'tabindex', 'type', 'usemap', 'value']),
          ins: ['cite', 'datetime'],
          label: ['accesskey', 'for'],
          legend: ['accesskey', 'align'],
          li: ['type', 'value'],
          map: _this._allowNamedProperties ? ['name'] : [],
          menu: ['compact', 'label', 'type'],
          meter: ['high', 'low', 'max', 'min', 'value'],
          ol: ['compact', 'reversed', 'start', 'type'],
          optgroup: ['disabled', 'label'],
          option: ['disabled', 'label', 'selected', 'value'],
          output: ['for'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : [])),
          p: ['align'],
          pre: ['width'],
          progress: ['max', 'min', 'value'],
          q: ['cite'],
          select: ['autocomplete', 'disabled', 'multiple'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['required', 'size', 'tabindex']),
          source: ['type'],
          table: ['align', 'bgcolor', 'border', 'cellpadding', 'cellspacing', 'frame', 'rules', 'summary', 'width'],
          tbody: ['align', 'char', 'charoff', 'valign'],
          td: ['abbr', 'align', 'axis', 'bgcolor', 'char', 'charoff', 'colspan', 'headers', 'height', 'nowrap', 'rowspan', 'scope', 'valign', 'width'],
          textarea: ['accesskey', 'autocomplete', 'cols', 'disabled', 'inputmode'].concat(_toConsumableArray(_this._allowNamedProperties ? ['name'] : []), ['placeholder', 'readonly', 'required', 'rows', 'tabindex', 'wrap']),
  ...
  return _createClass(Sanitizer, [{
    ...
    key: "setAllowNamedProperties",
    value: function setAllowNamedProperties(allowNamedProperties) {
