#line 1 "../numpy/_core/src/umath/loops.c.src"
...
{
    UNARY_LOOP {
        const npy_float in_r = ((npy_float *)ip1)[0];
        const npy_float in_i = ((npy_float *)ip1)[1];
        const npy_float in_abs = npy_hypotf(in_r, in_i);
        if (NPY_UNLIKELY(npy_isnan(in_abs))) {
            ((npy_float *)op1)[0] = NPY_NANF;
            ((npy_float *)op1)[1] = NPY_NANF;
        }
            ...
            if (npy_isinf(in_r)) {
                if (npy_isinf(in_i)) {
                    ...
                    ((npy_float *)op1)[0] = in_r > 0 ? 1.: -1.;
                    ((npy_float *)op1)[1] = 0.;
                }
            }
            else {
                ((npy_float *)op1)[0] = 0.;
                ((npy_float *)op1)[1] = in_i > 0 ? 1.: -1.;
            }
        }
            ...
            ((npy_float *)op1)[0] = in_r / in_abs;
            ((npy_float *)op1)[1] = in_i / in_abs;
        }
    }
}
...
{
    UNARY_LOOP {
        const npy_double in_r = ((npy_double *)ip1)[0];
        const npy_double in_i = ((npy_double *)ip1)[1];
        const npy_double in_abs = npy_hypot(in_r, in_i);
        if (NPY_UNLIKELY(npy_isnan(in_abs))) {
            ((npy_double *)op1)[0] = NPY_NAN;
            ((npy_double *)op1)[1] = NPY_NAN;
        }
        else if (NPY_UNLIKELY(npy_isinf(in_abs))) {
            if (npy_isinf(in_r)) {
                if (npy_isinf(in_i)) {
                    ...
                    ((npy_double *)op1)[0] = in_r > 0 ? 1.: -1.;
                    ((npy_double *)op1)[1] = 0.;
                }
            }
            else {
                ((npy_double *)op1)[0] = 0.;
                ((npy_double *)op1)[1] = in_i > 0 ? 1.: -1.;
            }
        }
        else if (NPY_UNLIKELY(in_abs == 0)) {
            ((npy_double *)op1)[0] = 0.;
            ...
            ((npy_double *)op1)[0] = in_r / in_abs;
            ((npy_double *)op1)[1] = in_i / in_abs;
        }
    }
}
...
{
    UNARY_LOOP {
        const npy_longdouble in_r = ((npy_longdouble *)ip1)[0];
        const npy_longdouble in_i = ((npy_longdouble *)ip1)[1];
        const npy_longdouble in_abs = npy_hypotl(in_r, in_i);
        if (NPY_UNLIKELY(npy_isnan(in_abs))) {
            ((npy_longdouble *)op1)[0] = NPY_NANL;
            ((npy_longdouble *)op1)[1] = NPY_NANL;
        }
        else if (NPY_UNLIKELY(npy_isinf(in_abs))) {
            if (npy_isinf(in_r)) {
                if (npy_isinf(in_i)) {
                    ...
                    ((npy_longdouble *)op1)[0] = in_r > 0 ? 1.: -1.;
                    ((npy_longdouble *)op1)[1] = 0.;
                }
            }
            else {
                ((npy_longdouble *)op1)[0] = 0.;
                ((npy_longdouble *)op1)[1] = in_i > 0 ? 1.: -1.;
            }
        }
        else if (NPY_UNLIKELY(in_abs == 0)) {
            ((npy_longdouble *)op1)[0] = 0.L;
            ((npy_longdouble *)op1)[1] = 0.L;
        }
        else{
            ((npy_longdouble *)op1)[0] = in_r / in_abs;
            ((npy_longdouble *)op1)[1] = in_i / in_abs;
        }
    }
}
