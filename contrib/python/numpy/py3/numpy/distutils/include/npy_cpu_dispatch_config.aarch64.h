 ...
 */
#define NPY_WITH_CPU_DISPATCH "ASIMDHP ASIMDFHM SVE"
/**
 ...
 */
#define NPY_WITH_CPU_BASELINE_CALL(EXEC_CB, ...) \
NPY__CPU_EXPAND(EXEC_CB(NEON, __VA_ARGS__)) \
NPY__CPU_EXPAND(EXEC_CB(NEON_FP16, __VA_ARGS__)) \
NPY__CPU_EXPAND(EXEC_CB(NEON_VFPV4, __VA_ARGS__)) \
NPY__CPU_EXPAND(EXEC_CB(ASIMD, __VA_ARGS__)) \
...
NPY__CPU_EXPAND(EXEC_CB(ASIMDHP, __VA_ARGS__)) \
NPY__CPU_EXPAND(EXEC_CB(ASIMDFHM, __VA_ARGS__)) \
NPY__CPU_EXPAND(EXEC_CB(SVE, __VA_ARGS__)) \
/*
