...
@attr(operation='create w/empty user agent')
@attr(assertion='succeeds')
def test_bucket_create_bad_ua_empty_aws():
    client = get_client()
    headers = {'User-Agent': ''}
    _add_header_create_bucket(headers, client)
...
@attr(operation='create w/no user agent')
@attr(assertion='succeeds')
def test_bucket_create_bad_ua_none_aws():
    client = get_client()
    remove = 'User-Agent'
    _remove_header_create_bucket(remove, client)
