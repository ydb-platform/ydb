...
from sklearn.metrics._pairwise_distances_reduction._argkmin cimport ArgKmin32
...
cdef class ArgKminClassMode32(ArgKmin32):
    ...
    cdef void _parallel_on_Y_finalize(
        ...
        return
from sklearn.metrics._pairwise_distances_reduction._argkmin cimport ArgKmin64
