...
PyObject* MakePyOutputString(const TString& output,
                             PyObject *resultobj) {
...
class PySentenceIterator : public sentencepiece::SentenceIterator {
  ...
  const TString &value() const override {
    return value_;
  }
...
SWIGINTERN std::vector< TString > sentencepiece_SentencePieceProcessor__EncodeAsPieces(sentencepiece::SentencePieceProcessor const *self,absl::string_view text,bool enable_sampling,int nbest_size,float alpha,bool add_bos,bool add_eos,bool reverse,bool emit_unk_piece){
...
SWIGINTERN TString sentencepiece_SentencePieceProcessor__DecodeIds(sentencepiece::SentencePieceProcessor const *self,std::vector< int > const &ids){
...
SWIGINTERN TString sentencepiece_SentencePieceProcessor__DecodePieces(sentencepiece::SentencePieceProcessor const *self,std::vector< absl::string_view > const &pieces){
...
SWIGINTERN std::vector< TString > sentencepiece_SentencePieceProcessor__DecodeIdsBatch(sentencepiece::SentencePieceProcessor const *self,std::vector< std::vector< int > > const &ins,int num_threads){
    CheckIdsBatch(ins, self->GetPieceSize());
    DEFINE_DECODE_BATCH_FUNC_IMPL(DecodeIds, int, TString);
  }
...
SWIGINTERN std::vector< TString > sentencepiece_SentencePieceProcessor__DecodePiecesBatch(sentencepiece::SentencePieceProcessor const *self,std::vector< std::vector< absl::string_view > > const &ins,int num_threads){
    DEFINE_DECODE_BATCH_FUNC_IMPL(DecodePieces, TString, TString);
  }
SWIGINTERN BytesArray sentencepiece_SentencePieceProcessor__DecodePiecesAsSerializedProtoBatch(sentencepiece::SentencePieceProcessor const *self,std::vector< std::vector< absl::string_view > > const &ins,int num_threads){
    DEFINE_DECODE_BATCH_FUNC_IMPL(DecodePiecesAsSerializedProto, TString,
                                  sentencepiece::util::bytes);
  }
SWIGINTERN std::vector< sentencepiece::ImmutableSentencePieceText > sentencepiece_SentencePieceProcessor__DecodePiecesAsImmutableProtoBatch(sentencepiece::SentencePieceProcessor const *self,std::vector< std::vector< absl::string_view > > const &ins,int num_threads){
    DEFINE_DECODE_BATCH_FUNC_IMPL(DecodePiecesAsImmutableProto, TString,
                                  sentencepiece::ImmutableSentencePieceText);
  }
...
SWIGINTERN std::vector< std::vector< TString > > sentencepiece_SentencePieceProcessor__NBestEncodeAsPieces(sentencepiece::SentencePieceProcessor const *self,absl::string_view text,int nbest_size,bool add_bos,bool add_eos,bool reverse,bool emit_unk_piece){
...
SWIGINTERN std::vector< std::pair< std::vector< TString >,float > > sentencepiece_SentencePieceProcessor__SampleEncodeAndScoreAsPieces(sentencepiece::SentencePieceProcessor const *self,absl::string_view text,int num_samples,float alpha,bool wor,bool include_best,bool add_bos,bool add_eos,bool reverse,bool emit_unk_piece){
...
SWIGINTERN TString sentencepiece_SentencePieceProcessor__Normalize(sentencepiece::SentencePieceProcessor *self,absl::string_view text){
    return self->Normalize(text);
  }
SWIGINTERN std::pair< TString,std::vector< size_t > > sentencepiece_SentencePieceProcessor__NormalizeWithOffsets(sentencepiece::SentencePieceProcessor *self,absl::string_view text){
    std::pair<TString, std::vector<size_t>> result;
...
SWIGINTERN sentencepiece::util::Status sentencepiece_SentencePieceProcessor__OverrideNormalizerSpec(sentencepiece::SentencePieceProcessor *self,std::unordered_map< TString,TString > const &args){
...
SWIGINTERN void sentencepiece_SentencePieceTrainer__TrainFromMap(std::unordered_map< TString,TString > const &args){
    const auto _status = sentencepiece::SentencePieceTrainer::Train(args);
    if (!_status.ok()) throw _status;
    return;
  }
SWIGINTERN void sentencepiece_SentencePieceTrainer__TrainFromMap2(std::unordered_map< TString,TString > const &args,sentencepiece::SentenceIterator *iter){
    const auto _status = sentencepiece::SentencePieceTrainer::Train(args, iter);
    if (!_status.ok()) throw _status;
    return;
  }
SWIGINTERN sentencepiece::util::bytes sentencepiece_SentencePieceTrainer__TrainFromMap3(std::unordered_map< TString,TString > const &args){
    sentencepiece::util::bytes model_proto;
    const auto _status = sentencepiece::SentencePieceTrainer::Train(args, nullptr, &model_proto);
    if (!_status.ok()) throw _status;
    return model_proto;
  }
SWIGINTERN sentencepiece::util::bytes sentencepiece_SentencePieceTrainer__TrainFromMap4(std::unordered_map< TString,TString > const &args,sentencepiece::SentenceIterator *iter){
    sentencepiece::util::bytes model_proto;
...
SWIGINTERN TString sentencepiece_SentencePieceNormalizer__Normalize(sentencepiece::SentencePieceNormalizer *self,absl::string_view text){
    TString result;
    const auto _status = self->Normalize(text, &result);
    if (!_status.ok()) throw _status;
    return result;
  }
SWIGINTERN std::pair< TString,std::vector< size_t > > sentencepiece_SentencePieceNormalizer__NormalizeWithOffsets(sentencepiece::SentencePieceNormalizer *self,absl::string_view text){
    std::pair<TString, std::vector<size_t>> result;
...
SWIGINTERN PyObject *_wrap_ImmutableSentencePieceText_ImmutableSentencePiece__piece(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = (TString *) &((sentencepiece::ImmutableSentencePieceText_ImmutableSentencePiece const *)arg1)->piece();
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_ImmutableSentencePieceText_ImmutableSentencePiece__surface(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = (TString *) &((sentencepiece::ImmutableSentencePieceText_ImmutableSentencePiece const *)arg1)->surface();
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_ImmutableSentencePieceText__text(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = (TString *) &((sentencepiece::ImmutableSentencePieceText const *)arg1)->text();
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceProcessor_IdToPiece(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = (TString *) &((sentencepiece::SentencePieceProcessor const *)arg1)->IdToPiece(arg2);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceProcessor__SampleEncodeAndScoreAsPieces(PyObject *self, PyObject *args) {
  ...
  int ecode10 = 0 ;
  PyObject *swig_obj[10] ;
  std::vector< std::pair< std::vector< TString >,float > > result;
...
SWIGINTERN PyObject *_wrap_SentencePieceProcessor__OverrideNormalizerSpec(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  sentencepiece::SentencePieceProcessor *arg1 = (sentencepiece::SentencePieceProcessor *) 0 ;
  std::unordered_map< TString,TString > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[2] ;
  sentencepiece::util::Status result;
  ...
  arg1 = reinterpret_cast< sentencepiece::SentencePieceProcessor * >(argp1);
  {
    std::unordered_map<TString, TString> *out = nullptr;
    if (PyDict_Check(swig_obj[1])) {
      PyObject *key, *value;
      Py_ssize_t pos = 0;
      out = new std::unordered_map<TString, TString>;
      while (PyDict_Next(swig_obj[1], &pos, &key, &value)) {
        ...
        if (key_ustring.IsAvalable() && value_ustring.IsAvalable()) {
          out->emplace(TString(key_ustring.data(), key_ustring.size()),
            TString(value_ustring.data(), value_ustring.size()));
        } else {
  ...
  {
    try {
      result = sentencepiece_SentencePieceProcessor__OverrideNormalizerSpec(arg1,(std::unordered_map< TString,TString > const &)*arg2);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceTrainer__TrainFromMap(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::unordered_map< TString,TString > *arg1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  {
    try {
      sentencepiece_SentencePieceTrainer__TrainFromMap((std::unordered_map< TString,TString > const &)*arg1);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceTrainer__TrainFromMap2(PyObject *self, PyObject *args) {
  ...
  {
    try {
      sentencepiece_SentencePieceTrainer__TrainFromMap2((std::unordered_map< TString,TString > const &)*arg1,arg2);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceTrainer__TrainFromMap3(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = sentencepiece_SentencePieceTrainer__TrainFromMap3((std::unordered_map< TString,TString > const &)*arg1);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
SWIGINTERN PyObject *_wrap_SentencePieceTrainer__TrainFromMap4(PyObject *self, PyObject *args) {
  ...
  {
    try {
      result = sentencepiece_SentencePieceTrainer__TrainFromMap4((std::unordered_map< TString,TString > const &)*arg1,arg2);
      ReleaseResultObject(resultobj);
    }
    catch (const sentencepiece::util::Status &status) {
      SWIG_exception(ToSwigError(status.code()), status.ToString().c_str());
...
static swig_type_info _swigt__p_std__string = {"_p_std__string", "sentencepiece::util::bytes *|TString *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__unordered_mapT_std__string_std__string_t = {"_p_std__unordered_mapT_std__string_std__string_t", "std::unordered_map< TString,TString > *", 0, 0, (void*)0, 0};
