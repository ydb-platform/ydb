...
from typecode._vendor.pygments.lexer import RegexLexer, DelegatingLexer, bygroups, include, \
    using, this, default, words
from typecode._vendor.pygments.token import Punctuation, \
...
from typecode._vendor.pygments.lexers.html import XmlLexer
