...
from typecode._vendor.pygments.token import Text, Name, String, Operator, Comment, Other
from typecode._vendor.pygments.util import get_int_opt, ClassNotFound
