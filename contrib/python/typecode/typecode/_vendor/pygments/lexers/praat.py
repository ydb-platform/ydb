...
from typecode._vendor.pygments.lexer import RegexLexer, words, bygroups, include
from typecode._vendor.pygments.token import Name, Text, Comment, Keyword, String, Punctuation, Number, \
    Operator
