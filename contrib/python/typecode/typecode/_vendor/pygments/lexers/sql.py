...
from typecode._vendor.pygments.lexer import Lexer, RegexLexer, do_insertions, bygroups, words
from typecode._vendor.pygments.token import Punctuation, Whitespace, Text, Comment, Operator, \
    Keyword, Name, String, Number, Generic, Literal
from typecode._vendor.pygments.lexers import get_lexer_by_name, ClassNotFound

from typecode._vendor.pygments.lexers._postgres_builtins import KEYWORDS, DATATYPES, \
    PSEUDO_TYPES, PLPGSQL_KEYWORDS
from typecode._vendor.pygments.lexers._mysql_builtins import \
    MYSQL_CONSTANTS, \
    MYSQL_DATATYPES, \
    MYSQL_FUNCTIONS, \
    MYSQL_KEYWORDS, \
...
from typecode._vendor.pygments.lexers import _tsql_builtins
