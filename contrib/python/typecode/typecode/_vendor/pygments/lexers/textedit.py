...
from typecode._vendor.pygments.lexer import RegexLexer, include, default, bygroups, using, this
...
class VimLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from typecode._vendor.pygments.lexers._vim_builtins import command, option, auto
        self._cmd = command
        self._opt = option
        self._aut = auto
