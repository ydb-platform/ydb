...
#ifndef Y_ABSL_BASE_INTERNAL_PRETTY_FUNCTION_H_
#define Y_ABSL_BASE_INTERNAL_PRETTY_FUNCTION_H_

// Y_ABSL_PRETTY_FUNCTION
//
...
// differentiate between overload sets.  Y_ABSL_PRETTY_FUNCTION is a portable
// version of these macros which forwards to the correct macro on each compiler.
#if defined(_MSC_VER)
#define Y_ABSL_PRETTY_FUNCTION __FUNCSIG__
#elif defined(__GNUC__)
#define Y_ABSL_PRETTY_FUNCTION __PRETTY_FUNCTION__
#else
#error "Unsupported compiler"
#endif

#endif  // Y_ABSL_BASE_INTERNAL_PRETTY_FUNCTION_H_
