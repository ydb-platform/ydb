...
#ifndef Y_ABSL_LOG_CHECK_H_
#define Y_ABSL_LOG_CHECK_H_

#include "y_absl/log/internal/check_impl.h"
#include "y_absl/log/internal/check_op.h"     // IWYU pragma: export
#include "y_absl/log/internal/conditions.h"   // IWYU pragma: export
#include "y_absl/log/internal/log_message.h"  // IWYU pragma: export
#include "y_absl/log/internal/strip.h"        // IWYU pragma: export
...
#define CHECK(condition) Y_ABSL_LOG_INTERNAL_CHECK_IMPL((condition), #condition)
...
// input.
#define QCHECK(condition) Y_ABSL_LOG_INTERNAL_QCHECK_IMPL((condition), #condition)
...
#define PCHECK(condition) Y_ABSL_LOG_INTERNAL_PCHECK_IMPL((condition), #condition)
...
#define DCHECK(condition) Y_ABSL_LOG_INTERNAL_DCHECK_IMPL((condition), #condition)
...
// `CHECK_OK` and friends validate that the provided `y_absl::Status` or
// `y_absl::StatusOr<T>` is OK.  If it isn't, they print a failure message that
...
#define CHECK_OK(status) Y_ABSL_LOG_INTERNAL_CHECK_OK_IMPL((status), #status)
#define QCHECK_OK(status) Y_ABSL_LOG_INTERNAL_QCHECK_OK_IMPL((status), #status)
#define DCHECK_OK(status) Y_ABSL_LOG_INTERNAL_DCHECK_OK_IMPL((status), #status)
