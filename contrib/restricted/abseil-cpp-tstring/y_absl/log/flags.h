...
#ifndef Y_ABSL_LOG_FLAGS_H_
#define Y_ABSL_LOG_FLAGS_H_
...
//
// To use these commandline flags, the //y_absl/log:flags library must be
// explicitly linked, and y_absl::ParseCommandLine() must be called before the
// call to y_absl::InitializeLog().
//
// To configure the Log library programmatically, use the interfaces defined in
// y_absl/log/globals.h.

#endif  // Y_ABSL_LOG_FLAGS_H_
