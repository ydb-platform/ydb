...
#ifndef Y_ABSL_LOG_STRUCTURED_H_
#define Y_ABSL_LOG_STRUCTURED_H_

#include <ostream>

#include "y_absl/base/config.h"
#include "y_absl/log/internal/structured.h"
...
//
//   void Logger::LogString(y_absl::string_view str, y_absl::LogSeverity severity,
//                          const char *file, int line) {
//     LOG(LEVEL(severity)).AtLocation(file, line) << str;
//   }
//   void Logger::LogStringLiteral(y_absl::string_view str,
//                                 y_absl::LogSeverity severity, const char *file,
//                                 int line) {
//     LOG(LEVEL(severity)).AtLocation(file, line) << y_absl::LogAsLiteral(str);
//   }
inline log_internal::AsLiteralImpl LogAsLiteral(y_absl::string_view s) {
...
#endif  // Y_ABSL_LOG_STRUCTURED_H_
