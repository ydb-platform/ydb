...
#ifndef Y_ABSL_LOG_VLOG_IS_ON_H_
#define Y_ABSL_LOG_VLOG_IS_ON_H_

#include "y_absl/log/absl_vlog_is_on.h"  // IWYU pragma: export
...
// new memory.
#define VLOG_IS_ON(verbose_level) Y_ABSL_VLOG_IS_ON(verbose_level)

#endif  // Y_ABSL_LOG_VLOG_IS_ON_H_
