...
#ifndef Y_ABSL_RANDOM_INTERNAL_GENERATE_REAL_H_
#define Y_ABSL_RANDOM_INTERNAL_GENERATE_REAL_H_

// This file contains some implementation details which are used by one or more
// of the y_absl random number distributions.
...
inline RealType GenerateRealFromBits(uint64_t bits, int exp_bias = 0) {
  ...
  using uint_type = y_absl::conditional_t<std::is_same<real_type, float>::value,
                                        uint32_t, uint64_t>;
...
#endif  // Y_ABSL_RANDOM_INTERNAL_GENERATE_REAL_H_
