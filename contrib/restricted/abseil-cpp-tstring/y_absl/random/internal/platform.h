...
#ifndef Y_ABSL_RANDOM_INTERNAL_PLATFORM_H_
#define Y_ABSL_RANDOM_INTERNAL_PLATFORM_H_
...
//
// Y_ABSL_ARCH_{X86/PPC/ARM} macros determine the platform.
#if defined(__x86_64__) || defined(__x86_64) || defined(_M_AMD64) || \
    defined(_M_X64)
#define Y_ABSL_ARCH_X86_64
#elif defined(__i386) || defined(_M_IX86)
#define Y_ABSL_ARCH_X86_32
#elif defined(__aarch64__) || defined(__arm64__) || defined(_M_ARM64)
#define Y_ABSL_ARCH_AARCH64
#elif defined(__arm__) || defined(__ARMEL__) || defined(_M_ARM)
#define Y_ABSL_ARCH_ARM
#elif defined(__powerpc64__) || defined(__PPC64__) || defined(__powerpc__) || \
    defined(__ppc__) || defined(__PPC__)
#define Y_ABSL_ARCH_PPC
#else
...
// Y_ABSL_RANDOM_INTERNAL_RESTRICT annotates whether pointers may be considered
// to be unaliased.
#if defined(__clang__) || defined(__GNUC__)
#define Y_ABSL_RANDOM_INTERNAL_RESTRICT __restrict__
#elif defined(_MSC_VER)
#define Y_ABSL_RANDOM_INTERNAL_RESTRICT __restrict
#else
#define Y_ABSL_RANDOM_INTERNAL_RESTRICT
#endif

// Y_ABSL_HAVE_ACCELERATED_AES indicates whether the currently active compiler
...
#define Y_ABSL_HAVE_ACCELERATED_AES 0

#if defined(Y_ABSL_ARCH_X86_64)

#if defined(__AES__) || defined(__AVX__)
#undef Y_ABSL_HAVE_ACCELERATED_AES
#define Y_ABSL_HAVE_ACCELERATED_AES 1
#endif

#elif defined(Y_ABSL_ARCH_PPC)
...
#elif defined(Y_ABSL_ARCH_ARM) || defined(Y_ABSL_ARCH_AARCH64)
...
#undef Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH
#define Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH 1
#elif defined(__linux__) && defined(Y_ABSL_ARCH_PPC)
// Or when running linux PPC
#undef Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH
#define Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH 1
#elif defined(__linux__) && defined(Y_ABSL_ARCH_AARCH64)
// Or when running linux AArch64
#undef Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH
#define Y_ABSL_RANDOM_INTERNAL_AES_DISPATCH 1
#elif defined(__linux__) && defined(Y_ABSL_ARCH_ARM) && (__ARM_ARCH >= 8)
...
#endif  // Y_ABSL_RANDOM_INTERNAL_PLATFORM_H_
