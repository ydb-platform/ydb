...
#ifndef Y_ABSL_RANDOM_INTERNAL_SEQUENCE_URBG_H_
#define Y_ABSL_RANDOM_INTERNAL_SEQUENCE_URBG_H_
...
// requirements of [rand.req.urbg], and is solely for testing y_absl
// distributions.
class sequence_urbg {
 public:
...
#endif  // Y_ABSL_RANDOM_INTERNAL_SEQUENCE_URBG_H_
