...
// int MaybeFoo(T& t) {
//   int i = 0;
//   y_absl::utility_internal::IfConstexpr<HasFoo<T>::value>(
//       [&](const auto& fooer) { i = fooer.foo(); }, t);
//   return i;
// }

#ifndef Y_ABSL_UTILITY_INTERNAL_IF_CONSTEXPR_H_
#define Y_ABSL_UTILITY_INTERNAL_IF_CONSTEXPR_H_
...
#endif  // Y_ABSL_UTILITY_INTERNAL_IF_CONSTEXPR_H_
