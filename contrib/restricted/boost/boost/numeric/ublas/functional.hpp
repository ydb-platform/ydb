...
#error #include <boost/numeric/bindings/traits/std_vector.hpp> 
#error #include <boost/numeric/bindings/traits/ublas_vector.hpp> 
#error #include <boost/numeric/bindings/traits/ublas_matrix.hpp> 
#error #include <boost/numeric/bindings/atlas/cblas.hpp> 
#endif 
