...
ORIGINAL_SOURCE(https://github.com/boostorg/type_erasure/archive/boost-1.81.0.tar.gz)
...
PEERDIR(
    ...
    contrib/restricted/boost/vmd
)

ADDINCL(
    GLOBAL contrib/restricted/boost/type_erasure/include
)
...
IF (DYNAMIC_BOOST)
    CFLAGS(
        GLOBAL -DBOOST_TYPE_ERASURE_DYN_LINK
    )
ENDIF()
