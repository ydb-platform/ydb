...
#include <contrib/restricted/google/boringssl/include/openssl/prefix_symbols_internal_c.h>  // IWYU pragma: export
#endif
...
// |BSSL_armcap_P| for unit tests. Any modifications to the value must be
...
#else
// BSSL_armcap_P contains ARM CPU capabilities as a bitmask of the above
// constants. This should only be accessed with |OPENSSL_get_armcap|.
extern uint32_t BSSL_armcap_P;
