...
ADDINCL(GLOBAL contrib/tools/bison/gnulib/src)

IF (OS_WINDOWS)
    ADDINCL(GLOBAL contrib/tools/bison/gnulib/platform/win64)
ELSE ()
    ADDINCL(GLOBAL contrib/tools/bison/gnulib/platform/posix)
ENDIF ()
