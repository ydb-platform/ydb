...
Y_UNIT_TEST_SUITE(TestNext) {
    ...
    Y_UNIT_TEST(RangesListsAndSteps) {
        TestNext("0 0 9-17 * * *", "2021-03-15T08:00:00Z", "2021-03-15T09:00:00Z");
        TestNext("0 0 9-17 * * *", "2021-03-15T20:00:00Z", "2021-03-16T09:00:00Z");
        TestNext("0 0,30 * * * *", "2021-03-15T10:05:00Z", "2021-03-15T10:30:00Z");
        TestNext("0 */15 * * * *", "2021-03-15T10:07:00Z", "2021-03-15T10:15:00Z");
        TestNext("0 0 */6 * * *", "2021-03-15T05:00:00Z", "2021-03-15T06:00:00Z");
        TestNext("0 0 0 1,15 * *", "2021-03-16T00:00:00Z", "2021-04-01T00:00:00Z");
        TestNext("0 0 0 1-7 * *", "2021-03-10T00:00:00Z", "2021-04-01T00:00:00Z");
        TestNext("0 0 0 */10 * *", "2021-03-05T00:00:00Z", "2021-03-11T00:00:00Z");
        TestNext("0 30 9 * * *", "2021-03-15T10:20:30Z", "2021-03-16T09:30:00Z");
        TestNext("0 0 * * * *", "2021-03-15T10:20:30Z", "2021-03-15T11:00:00Z");
        TestNext("15 10 * * *", "2021-03-15T10:20:30Z", "2021-03-16T10:15:00Z");
    }

    Y_UNIT_TEST(MonthsAndNames) {
        TestNext("0 0 0 1 1 *", "2021-06-15T00:00:00Z", "2022-01-01T00:00:00Z");
        TestNext("0 0 0 1 JAN *", "2021-06-15T00:00:00Z", "2022-01-01T00:00:00Z");
        TestNext("0 0 0 1 2-4 *", "2021-06-15T00:00:00Z", "2022-02-01T00:00:00Z");
        TestNext("0 0 0 1 DEC *", "2021-12-31T00:00:00Z", "2022-12-01T00:00:00Z");
        TestNext("0 0 0 29 2 *", "2021-03-01T00:00:00Z", "2024-02-29T00:00:00Z");
    }

    Y_UNIT_TEST(DaysOfWeek) {
        TestNext("0 0 0 * * 1", "2021-03-15T12:00:00Z", "2021-03-22T00:00:00Z");
        TestNext("0 0 0 * * MON", "2021-03-15T12:00:00Z", "2021-03-22T00:00:00Z");
        TestNext("0 0 0 * * 0", "2021-03-15T12:00:00Z", "2021-03-21T00:00:00Z");
        TestNext("0 0 0 * * 7", "2021-03-15T12:00:00Z", "2021-03-21T00:00:00Z");
        TestNext("0 0 0 * * 6-7", "2021-03-15T12:00:00Z", "2021-03-20T00:00:00Z");
        TestNext("0 0 0 * * MON-FRI", "2021-03-19T12:00:00Z", "2021-03-22T00:00:00Z");
        TestNext("0 0 0 * * SAT,SUN", "2021-03-15T12:00:00Z", "2021-03-20T00:00:00Z");
        TestNext("0 0 12 * * 5", "2021-03-15T12:00:00Z", "2021-03-19T12:00:00Z");
    }

    Y_UNIT_TEST(NthWeekdayOfMonth) {
        TestNext("0 0 0 * * 1#1", "2021-03-01T00:00:00Z", "2021-04-05T00:00:00Z");
        TestNext("0 0 0 * * 1#2", "2021-03-01T00:00:00Z", "2021-03-08T00:00:00Z");
        TestNext("0 0 0 * * 5#3", "2021-03-01T00:00:00Z", "2021-03-19T00:00:00Z");
        TestNext("0 0 0 * * 1#-1", "2021-03-01T00:00:00Z", "2021-03-29T00:00:00Z");
        TestNext("0 0 0 * * 3#-2", "2021-03-01T00:00:00Z", "2021-03-24T00:00:00Z");
    }

    Y_UNIT_TEST(LastDaysOfMonthWithTime) {
        // 'L-N' rolling into the next month with an unchanged day number must keep the requested time
        TestNext("59 59 23 L-1 * *", "2026-06-30T03:14:00Z", "2026-07-30T23:59:59Z");
        TestNext("59 59 23 L-1 * *", "2026-09-30T10:00:00Z", "2026-10-30T23:59:59Z");
        TestNext("59 59 23 L-1 * *", "2026-11-30T10:00:00Z", "2026-12-30T23:59:59Z");
        TestNext("59 59 23 L-1 * *", "2026-04-30T10:00:00Z", "2026-05-30T23:59:59Z");
        TestNext("59 59 23 L-1 * *", "2026-07-01T00:00:00Z", "2026-07-30T23:59:59Z");
        TestNext("0 30 12 L-2 * *", "2026-06-29T13:00:00Z", "2026-07-29T12:30:00Z");
        TestNext("59 59 23 L * *", "2021-03-31T10:00:00Z", "2021-03-31T23:59:59Z");
        TestNext("59 59 23 L * *", "2021-04-30T23:59:59Z", "2021-05-31T23:59:59Z");
        TestNext("59 59 23 L * *", "2025-08-31T05:00:00Z", "2025-08-31T23:59:59Z");
        TestNext("0 0 0 L * *", "2021-02-10T00:00:00Z", "2021-02-28T00:00:00Z");
        TestNext("0 0 0 L * *", "2020-02-10T00:00:00Z", "2020-02-29T00:00:00Z");
        TestNext("0 0 0 L-5 * *", "2021-02-10T00:00:00Z", "2021-02-23T00:00:00Z");
        TestNext("30 0 0 L-1 * *", "2025-08-30T00:00:00Z", "2025-08-30T00:00:30Z");
    }

    Y_UNIT_TEST(YearField) {
        TestNext("0 0 0 1 1 * 2030", "2021-01-01T00:00:00Z", "2030-01-01T00:00:00Z");
        TestNext("0 0 0 29 2 * 2024", "2021-01-01T00:00:00Z", "2024-02-29T00:00:00Z");
    }
}
...
Y_UNIT_TEST_SUITE(TestPrev) {
    ...
    Y_UNIT_TEST(MoreCases) {
        TestPrev("0 0 0 * * *", "2021-03-15T10:20:30Z", "2021-03-15T00:00:00Z");
        TestPrev("0 0 9-17 * * *", "2021-03-15T08:00:00Z", "2021-03-14T17:00:00Z");
        TestPrev("0 0,30 * * * *", "2021-03-15T10:05:00Z", "2021-03-15T10:00:00Z");
        TestPrev("0 0 0 1 1 *", "2021-06-15T00:00:00Z", "2021-01-01T00:00:00Z");
        TestPrev("0 0 0 29 2 *", "2021-03-01T00:00:00Z", "2020-02-29T00:00:00Z");
        TestPrev("0 0 0 * * MON", "2021-03-15T12:00:00Z", "2021-03-15T00:00:00Z");
        TestPrev("0 0 0 * * SAT,SUN", "2021-03-15T12:00:00Z", "2021-03-14T00:00:00Z");
        TestPrev("0 0 0 * * 1#-1", "2021-03-01T00:00:00Z", "2021-02-22T00:00:00Z");
        TestPrev("0 0 0 L * *", "2021-02-10T00:00:00Z", "2021-01-31T00:00:00Z");
        TestPrev("0 0 0 LW * *", "2021-05-10T00:00:00Z", "2021-04-30T00:00:00Z");
        TestPrev("0 0 0 15W * *", "2021-05-01T00:00:00Z", "2021-04-15T00:00:00Z");
    }

    Y_UNIT_TEST(LastDaysOfMonthWithTime) {
        // mirror of the TestNext case in the prev direction
        TestPrev("59 59 23 L * *", "2025-08-31T05:00:00Z", "2025-07-31T23:59:59Z");
        TestPrev("30 0 0 L-1 * *", "2025-08-30T00:00:00Z", "2025-07-30T00:00:30Z");
        TestPrev("30 0 0 L-1 * *", "2025-10-30T00:00:00Z", "2025-09-29T00:00:30Z");
        TestPrev("59 59 23 L-1 * *", "2026-06-30T03:14:00Z", "2026-06-29T23:59:59Z");
        TestPrev("0 30 12 L-2 * *", "2026-06-29T13:00:00Z", "2026-06-28T12:30:00Z");
    }
}
