...
namespace NProtobufJson::NOrderedJson {
    struct TJson2ProtoConfig {
        ...
        using TValueVectorizer = std::function<NJson::NOrderedJson::TJsonValue::TArray(const NJson::NOrderedJson::TJsonValue& jsonValue)>;
    ...
    /// @throw yexception
    void MergeJson2Proto(const NJson::NOrderedJson::TJsonValue& json, google::protobuf::Message& proto,
    ...
    /// @throw yexception
    void Json2Proto(const NJson::NOrderedJson::TJsonValue& json, google::protobuf::Message& proto,
                    const TJson2ProtoConfig& config = TJson2ProtoConfig());
    ...
    /// @throw yexception
    template <typename T>
    T Json2Proto(IInputStream& in, const NJson::NOrderedJson::TJsonReaderConfig& readerConfig,
                 const TJson2ProtoConfig& config = TJson2ProtoConfig()) {
        NJson::NOrderedJson::TJsonValue jsonValue;
        NJson::NOrderedJson::ReadJsonTree(&in, &readerConfig, &jsonValue, true);
        T protoValue;
    ...
    T Json2Proto(IInputStream& in, const TJson2ProtoConfig& config = TJson2ProtoConfig()) {
        ...
        NJson::NOrderedJson::TJsonReaderConfig readerConfig;
