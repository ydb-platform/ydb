...
#include <library/cpp/protobuf/json/ordered_maps/json2proto_ordered.h>
...
using namespace NProtobufJson::NOrderedJson;
...
namespace {
    ...
    TString JsonValueToString(const NJson::NOrderedJson::TJsonValue& json) {
...
Y_UNIT_TEST_SUITE(TOrderedJson2ProtoTest) {
    Y_UNIT_TEST(TestFlatOptional){
        {const NJson::NOrderedJson::TJsonValue& json = CreateFlatOrderedJson();
    TFlatOptional proto;
...
#define DEFINE_FIELD(name, value)                                     \
    {                                                                 \
        ...
        const NJson::NOrderedJson::TJsonValue& json = CreateFlatOrderedJson(skippedField); \
        TFlatOptional proto;                                          \
        Json2Proto(json, proto);                                      \
        TFlatOptional modelProto;                                     \
...
Y_UNIT_TEST(TestFlatRepeated){
    {const NJson::NOrderedJson::TJsonValue& json = CreateRepeatedFlatOrderedJson();
TFlatRepeated proto;
Json2Proto(json, proto);
...
#define DEFINE_REPEATED_FIELD(name, ...)                                      \
    {                                                                         \
        THashSet<TString> skippedField;                                       \
        skippedField.insert(#name);                                           \
        const NJson::NOrderedJson::TJsonValue& json = CreateRepeatedFlatOrderedJson(skippedField); \
        TFlatRepeated proto;                                                  \
        Json2Proto(json, proto);                                              \
        TFlatRepeated modelProto;                                             \
...
Y_UNIT_TEST(TestCompositeOptional){
    {const NJson::NOrderedJson::TJsonValue& json = CreateCompositeOrderedJson();
...
#define DEFINE_FIELD(name, value)                                          \
    {                                                                      \
        THashSet<TString> skippedField;                                    \
        skippedField.insert(#name);                                        \
        const NJson::NOrderedJson::TJsonValue& json = CreateCompositeOrderedJson(skippedField); \
        TCompositeOptional proto;                                          \
        Json2Proto(json, proto);                                           \
        TCompositeOptional modelProto;                                     \
...
Y_UNIT_TEST(TestCompositeOptionalStringBuf){
    {NJson::NOrderedJson::TJsonValue json = CreateCompositeOrderedJson();
...
#define DEFINE_FIELD(name, value)                                   \
    {                                                               \
        THashSet<TString> skippedField;                             \
        skippedField.insert(#name);                                 \
        NJson::NOrderedJson::TJsonValue json = CreateCompositeOrderedJson(skippedField); \
...
Y_UNIT_TEST(TestCompositeRepeated) {
    {
        NJson::NOrderedJson::TJsonValue json;
        NJson::NOrderedJson::TJsonValue array;
        array.AppendValue(CreateFlatOrderedJson());
...
#define DEFINE_REPEATED_FIELD(name, ...)                 \
    {                                                    \
        ...
        modelProto.AddPart()->CopyFrom(partModelProto);  \
        array.AppendValue(CreateFlatOrderedJson(skippedField)); \
    }
#include <library/cpp/protobuf/json/ut/repeated_fields.incl>
#undef DEFINE_REPEATED_FIELD
...
class TBytesTransform: public NProtobufJson::IStringTransform {
public:
    int GetType() const override {
        return 0;
    }
...
Y_UNIT_TEST(TestInvalidJson) {
    NJson::NOrderedJson::TJsonValue val{"bad value"};
    TFlatOptional proto;
...
Y_UNIT_TEST(TestValueVectorizer) {
    ...
    }
    {
        ...
        config.ValueVectorizer = [](const NJson::NOrderedJson::TJsonValue& val) -> NJson::NOrderedJson::TJsonValue::TArray {
            Y_UNUSED(val);
            return {NJson::NOrderedJson::TJsonValue("4"), NJson::NOrderedJson::TJsonValue("5"), NJson::NOrderedJson::TJsonValue("6")};
        };
...
Y_UNIT_TEST(TestComplexMapAsObject_EnumStringCaseInsensetive) {
    TestComplexMapAsObject(
        ...
        TJson2ProtoConfig()
                .SetMapAsObject(true)
                .SetEnumValueMode(NProtobufJson::NOrderedJson::TJson2ProtoConfig::EnumCaseInsensetive)
    );
...
Y_UNIT_TEST(TestComplexMapAsObject_EnumStringSnakeCaseInsensitive) {
    TestComplexMapAsObject(
        ...
        TJson2ProtoConfig()
                .SetMapAsObject(true)
                .SetEnumValueMode(NProtobufJson::NOrderedJson::TJson2ProtoConfig::EnumSnakeCaseInsensitive)
    );
} // TestComplexMapAsObject_EnumStringCaseInsensetive
...
Y_UNIT_TEST(TestMergeFlatOptional) {
    ...
    NJson::NOrderedJson::TJsonValue patch;
    patch["I32"] = 5;
    patch["Bool"] = false;
...
Y_UNIT_TEST(TestSimplifiedDuration) {
    ...
    json["Duration"] = "10.1s";
    NProtobufJson::NOrderedJson::Json2Proto(json, simpleDuration, NProtobufJson::NOrderedJson::TJson2ProtoConfig().SetAllowString2TimeConversion(true));
...
Y_UNIT_TEST(TestUnwrappedDuration) {
    ...
    NProtobufJson::NOrderedJson::Json2Proto(json, duration, NProtobufJson::NOrderedJson::TJson2ProtoConfig());
...
Y_UNIT_TEST(TestSimplifiedTimestamp) {
    ...
    NProtobufJson::NOrderedJson::Json2Proto(json, simpleTimestamp, NProtobufJson::NOrderedJson::TJson2ProtoConfig().SetAllowString2TimeConversion(true));
...
Y_UNIT_TEST(TestValue) {
    {
        NJson::NOrderedJson::TJsonValue json = 100.0;
        google::protobuf::Value value;
        NProtobufJson::NOrderedJson::Json2Proto(json, value);
        UNIT_ASSERT(value.has_number_value());
        UNIT_ASSERT_EQUAL(value.number_value(), 100.0);
    }
    {
        NJson::NOrderedJson::TJsonValue json = 100LL;
        google::protobuf::Value value;
        NProtobufJson::NOrderedJson::Json2Proto(json, value);
        UNIT_ASSERT(value.has_number_value());
        UNIT_ASSERT_EQUAL(value.number_value(), 100.0);
    ...
    {
        NJson::NOrderedJson::TJsonValue json = 100ULL;
        google::protobuf::Value value;
        NProtobufJson::NOrderedJson::Json2Proto(json, value);
        UNIT_ASSERT(value.has_number_value());
        UNIT_ASSERT_EQUAL(value.number_value(), 100.0);
    ...
    {
        NJson::NOrderedJson::TJsonValue json = "TestString";
        google::protobuf::Value value;
        NProtobufJson::NOrderedJson::Json2Proto(json, value);
...
Y_UNIT_TEST(TestStruct) {
    ...
    NProtobufJson::NOrderedJson::Json2Proto(json, structProto);
