struct TMessageId {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint64_t));
...
struct TTimestamps {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t));
...
struct TExecTimeStats {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t));
...
struct TWindowFeedback {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(EStatus) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(TMessageId) + sizeof(TMessageId));
...
struct TVDiskCostSettings {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint32_t));
...
struct TMsgQoS {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint32_t) + sizeof(TMessageId) + sizeof(uint64_t) + sizeof(EVDiskQueueId) + sizeof(EVDiskInternalQueueId) + sizeof(TVDiskCostSettings) + sizeof(bool) + sizeof(TWindowFeedback) + sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint64_t) + sizeof(uint32_t) + sizeof(TExecTimeStats) + sizeof(TActorId));
...
struct TVDiskID {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint32_t));
...
struct TLogoBlobID {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t));
...
struct TRangeQuery {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(TLogoBlobID) + sizeof(TLogoBlobID) + sizeof(uint64_t) + sizeof(uint32_t));
...
struct TExtremeQuery {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(TLogoBlobID) + sizeof(uint64_t) + sizeof(uint64_t) + sizeof(uint64_t));
...
struct TTabletData {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(uint64_t) + sizeof(uint32_t));
...
struct TEvVGet {
    ...
    bool SerializeToZeroCopyStream(NProtoBuf::io::ZeroCopyOutputStream *output) const {
        serializeHelper(this, sizeof(TRangeQuery) + sizeof(TVDiskID) + sizeof(bool) + sizeof(bool) + sizeof(uint64_t) + sizeof(TMsgQoS) + sizeof(bool) + sizeof(EGetHandleClass) + sizeof(bool) + sizeof(uint64_t) + sizeof(bool) + sizeof(TTimestamps) + sizeof(uint32_t) + sizeof(TTabletData) + sizeof(TTabletData) + sizeof(TString));
		serializeHelper(ExtremeQueries.data(), sizeof(TExtremeQuery) * ExtremeQueries.size());
    }
};
