...
WITH (AUTO_PARTITIONING_BY_SIZE = DISABLED, AUTO_PARTITIONING_MIN_PARTITIONS_COUNT = 1, AUTO_PARTITIONING_MAX_PARTITIONS_COUNT = 1);
...
ALTER TABLE `current` ADD CHANGEFEED changes WITH (FORMAT="JSON", MODE="NEW_AND_OLD_IMAGES", RETENTION_PERIOD = Interval("PT1M"));
