...
// Replace the root component of an absolute database name with the cluster root.
// A root database maps to the cluster root itself. Relative and empty names
// retain their existing meaning; this does not resolve resource paths.
