    ...
    TBlobDepotAgent::TQuery *TBlobDepotAgent::CreateQuery<TEvBlobStorage::EvPut>(std::unique_ptr<IEventHandle> ev,
        ...
        public:
            ...
            void IssuePuts() {
                ...
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "allocated BlobSeqId", {"Marker", "BDA21"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()},
                    {"BlobSeqId", blobSeqId},
                    {"BlobId", Request.Id});
            ...
            void IssueCommitBlobSeq(bool uncertainWrite) {
                ...
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "IssueCommitBlobSeq", {"Marker", "BDA30"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()},
            ...
            void RemoveBlobSeqFromInFlight() {
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "RemoveBlobSeqFromInFlight", {"Marker", "BDA32"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()});
            ...
            void HandlePutResult(TRequestContext::TPtr /*context*/, TEvBlobStorage::TEvPutResult& msg) {
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "TEvPutResult", {"Marker", "BDA22"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()},
                    {"Msg", msg});
            ...
            void HandleCommitBlobSeqResult(TRequestContext::TPtr /*context*/, NKikimrBlobDepot::TEvCommitBlobSeqResult& msg) {
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "TEvCommitBlobSeqResult", {"Marker", "BDA31"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()},
                    {"Msg", msg});
            ...
            void HandlePrepareWriteS3Result(TRequestContext::TPtr /*context*/, NKikimrBlobDepot::TEvPrepareWriteS3Result& msg) {
                ...
                YDBLOG_COMP_DEBUG(BLOB_DEPOT_AGENT, "starting WriteActor", {"Marker", "BDA54"},
                    {"AgentId", Agent.LogId},
                    {"QueryId", GetQueryId()},
                    {"Key", key});
