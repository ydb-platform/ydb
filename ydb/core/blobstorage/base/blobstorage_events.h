...
namespace NKikimr {
    ...
    struct TEvBlobStorage::TEvControllerRetryConsoleCommit : TEventPB<TEvBlobStorage::TEvControllerRetryConsoleCommit,
        NKikimrBlobStorage::TEvControllerRetryConsoleCommit, TEvBlobStorage::EvControllerRetryConsoleCommit> {
        TEvControllerRetryConsoleCommit() = default;

        TString ToString() const override {
            TStringStream str;
            str << "{TEvControllerRetryConsoleCommit Record # " << Record.DebugString();
            str << "}";
            return str.Str();
        }
    };
    ...
    struct TEvBlobStorage::TEvControllerCommitConfigRequest : TEventPB<TEvBlobStorage::TEvControllerCommitConfigRequest,
        NKikimrBlobStorage::TEvControllerCommitConfigRequest, TEvBlobStorage::EvControllerCommitConfigRequest> {
    ...
    struct TEvBlobStorage::TEvControllerCommitConfigResponse : TEventPB<TEvBlobStorage::TEvControllerCommitConfigResponse,
        ...
        TString ToString() const override {
            TStringStream str;
            str << "{TEvControllerCommitConfigResponse Record# " << Record.DebugString();
            str << "}";
            return str.Str();
        }
    };
    ...
    struct TEvBlobStorage::TEvControllerValidationTimeout : TEventPB<TEvBlobStorage::TEvControllerValidationTimeout,
        NKikimrBlobStorage::TEvControllerValidationTimeout, TEvBlobStorage::EvControllerValidationTimeout> {
        TEvControllerValidationTimeout() = default;

        TEvControllerValidationTimeout(ui32 grpcSenderId) {
            Record.SetGRPCSenderId(grpcSenderId);
        }
    };
