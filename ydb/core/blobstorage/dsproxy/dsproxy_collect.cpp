...
class TBlobStorageGroupCollectGarbageRequest : public TBlobStorageGroupRequestActor {
    ...
    void Handle(TEvBlobStorage::TEvVCollectGarbageResult::TPtr &ev) {
        ...
        A_LOG_LOG_S(PriorityForStatusInbound(status), "DSPC01", "received"
    ...
    void ReplyAndDie(NKikimrProto::EReplyStatus status) override {
        ...
        A_LOG_LOG_S(status == NKikimrProto::OK ? NLog::PRI_INFO : NLog::PRI_NOTICE, "DSPC02", "Result# " << result->Print(false));
