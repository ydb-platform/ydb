...
#define BLOBSTORAGE_PROVIDER(PROBE, EVENT, GROUPS, TYPES, NAMES) \
    ...
    PROBE(PDiskLogWriteComplete, GROUPS("PDisk", "PDiskRequest"), \
      TYPES(TPDiskIdField, ui64, double, double, double, double, double, double, ui64), \
      NAMES("pdisk", "reqId", "creationTimeSec", "costMs", "responseTimeMs", "inputTimeMs", "scheduleTimeMs", "deviceTotalTimeMs", "batchSize")) \
