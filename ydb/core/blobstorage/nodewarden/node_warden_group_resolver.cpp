...
namespace NKikimr::NStorage {
    ...
    public:
        ...
        void Bootstrap() {
            YDBLOG_COMP_INFO(BS_NODE, "TGroupResolverActor::Bootstrap", {"Marker", "NW79"},
                {"GroupId", GroupId});
        ...
        void StartResolving() {
            YDBLOG_COMP_INFO(BS_NODE, "TGroupResolverActor::StartResolving", {"Marker", "NW85"},
                {"GroupId", GroupId});
        ...
        bool IssueQuery() {
            auto issueQueryToNode = [this](ui32 nodeId) {
                YDBLOG_COMP_DEBUG(BS_NODE, "TGroupResolverActor::IssueQuery", {"Marker", "NW80"},
                    {"GroupId", GroupId},
                    {"NodeId", nodeId});
        ...
        void Handle(TEvNodeWardenGroupInfo::TPtr ev) {
            ...
            YDBLOG_COMP_DEBUG(BS_NODE, "TGroupResolverActor::TEvNodeWardenGroupInfo", {"Marker", "NW84"},
                {"GroupId", GroupId},
                {"NodeId", nodeId},
                {"Msg", ev->Get()->ToString()});
        ...
        void ProcessResultAndFinish() {
            if (auto *result = GetResultingGroupInfo()) {
                YDBLOG_COMP_INFO(BS_NODE, "TGroupResolverActor::ProcessResultAndFinish", {"Marker", "NW86"},
                    {"GroupId", GroupId},
                    {"Result", *result});
        ...
        void PassAway() {
            YDBLOG_COMP_INFO(BS_NODE, "TGroupResolverActor::PassAway", {"Marker", "NW81"},
                {"GroupId", GroupId});
        ...
        void Handle(TEvInterconnect::TEvNodeConnected::TPtr ev) {
            YDBLOG_COMP_DEBUG(BS_NODE, "TGroupResolverActor::TEvNodeConnected", {"Marker", "NW82"},
                {"GroupId", GroupId},
        ...
        void Handle(TEvInterconnect::TEvNodeDisconnected::TPtr ev) {
            ...
            YDBLOG_COMP_DEBUG(BS_NODE, "TGroupResolverActor::TEvNodeDisconnected", {"Marker", "NW83"},
                {"GroupId", GroupId},
                {"NodeId", ev->Get()->NodeId});
            QueriesInFlight.erase(nodeId);
