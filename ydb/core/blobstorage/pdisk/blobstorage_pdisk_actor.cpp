...
public:
    ...
    static NActors::NAudit::EAuditableAction PDiskAuditResolver(const NMonitoring::IMonHttpRequest& request) {
        const TCgiParameters &cgi = request.GetPostParams();
        if (cgi.Has("chunkLockByCount") || cgi.Has("chunkLockByColor")) {
            return NActors::NAudit::EAuditableAction::PDiskChunkLock;
        } else if (cgi.Has("chunkUnlock")) {
            return NActors::NAudit::EAuditableAction::PDiskChunkUnlock;
        } else if (cgi.Has("restartPDisk")) {
            return NActors::NAudit::EAuditableAction::PDiskRestart;
        } else if (cgi.Has("stopPDisk")) {
            return NActors::NAudit::EAuditableAction::PDiskStop;
        }
