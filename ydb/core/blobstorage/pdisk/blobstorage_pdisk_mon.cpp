...
#define HISTOGRAM_INIT(field, name) \
    ...
    COUNTER_INIT(PDiskGroup, WriteBufferCompactedTimes, true);
    COUNTER_INIT(PDiskGroup, WriteBufferCompactedBytes, true);
    COUNTER_INIT(PDiskGroup, WriteBufferUncompactedTimes, true);
    COUNTER_INIT(PDiskGroup, WriteBufferUncompactedBytes, true);
