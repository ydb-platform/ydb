...
Y_UNIT_TEST_SUITE(TPDiskTest) {
    ...
    Y_UNIT_TEST(PDiskSlotSizeInUnits) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(testCtx.GetPDisk()->Mon.ExpectedSlotSizeBytes->Val(), 0);
        ...
        // ExpectedSlotSizeBytes: TotalSpaceBytes / 8
        testCtx.TestResponse<NPDisk::TEvChangeExpectedSlotCountResult>(
        ...
        UNIT_ASSERT_VALUES_EQUAL(testCtx.GetPDisk()->Mon.ExpectedSlotSizeBytes->Val(), expectedSlotSizeBytes);
    }
