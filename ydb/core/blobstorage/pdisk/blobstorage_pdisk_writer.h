...
private:
    ...
    public:
        ...
        TBlockDeviceWrite(const TReqId& ReqId, TBuffer::TPtr&& buffer, ui64 StartOffset, ui64 DirtyFrom, ui64 DirtyTo,
            NWilson::TTraceId *TraceId, TActorSystem* actorSystem);
...
public:
    ...
    TSectorWriter(TPDiskMon &mon, IBlockDevice &blockDevice, TDiskFormat &format, ui64 &nonce,
            ...
            TDriveModel *driveModel, bool enableSectorEncryption, bool withDelayedFlush = false)
        : Mon(mon)
