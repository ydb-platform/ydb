...
#define ADD_ICB_CONTROL(controlName, defaultVal, minVal, maxVal, currentValue) {        \
                ...
                ADD_ICB_CONTROL("VDiskControls.MaxInProgressStartupCatchupCount", 0, 0, 10'000, 0);
                ADD_ICB_CONTROL("VDiskControls.MaxInProgressStartupCatchupPerPDiskCount", 0, 0, 10'000, 0);
