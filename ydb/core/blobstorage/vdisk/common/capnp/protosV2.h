...
struct TEvVGet {
    ...
    public:
        ...
        std::string GetSnapshotId() const { return getSnapshotId(); }
    ...
    struct Builder : private NKikimrCapnProto_::TEvVGet::Builder, public Reader {
    private:
    ...
    public:
        ...
        void SetSnapshotId(const std::string& value) { return setSnapshotId(value); }
...
struct TQueryResult {
    ...
    public:
        ...
        uint64_t GetShift() const { return getShift(); }
        uint64_t GetSize() const { return getSize(); }
        std::string GetSuffer() const { return getSuffer(); }
        uint64_t GetCookie() const { return getCookie(); }
    ...
    public:
        ...
        void SetShift(const uint64_t& value) { return setShift(value); }
        void SetSize(const uint64_t& value) { return setSize(value); }
        void SetSuffer(const std::string& value) { return setSuffer(value); }
        void SetCookie(const uint64_t& value) { return setCookie(value); }
...
struct TGroupInfo {
    ...
    public:
        ...
        std::string GetMainKeyId() const { return getMainKeyId(); }
        std::string GetEncryptedGroupKey() const { return getEncryptedGroupKey(); }
    ...
    public:
        ...
        void SetMainKeyId(const std::string& value) { return setMainKeyId(value); }
        void SetEncryptedGroupKey(const std::string& value) { return setEncryptedGroupKey(value); }
        ...
        void SetStoragePoolName(const std::string& value) { return setStoragePoolName(value); }
...
struct TEvVGetResult {
    ...
    struct Builder : private NKikimrCapnProto_::TEvVGetResult::Builder, public Reader {
    private:
