...
namespace NKikimr {
        ...
        : BaseInfo(baseInfo)
    {
        ...
        HullCompFullCompRateSec = 1;
        HullCompThrottlerReadIOPSLimit = 0;
        HullCompThrottlerReadIOPSRate = 0;
        HullCompThrottlerReadIOPSIntervalMs = 60000;
        HullCompThrottlerReadBytesLimit = 0;
        HullCompThrottlerReadBytesRate = 0;
        HullCompThrottlerReadBytesIntervalMs = 60000;
        HullCompThrottlerWriteIOPSLimit = 0;
        HullCompThrottlerWriteIOPSRate = 0;
        HullCompThrottlerWriteIOPSIntervalMs = 60000;
        HullCompThrottlerWriteBytesLimit = 0;
        HullCompThrottlerWriteBytesRate = 0;
        HullCompThrottlerWriteBytesIntervalMs = 60000;
