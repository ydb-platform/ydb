...
namespace NKikimr {
        ...
        , TEventWithRelevanceTracker
    {
        ...
        // Preserve an existing Huge allocation even after the Huge threshold changes.
        // Inline scrub repairs still use RewriteBlob, but follow the current size policy.
        bool RewriteHugeBlob = false;
