...
public:
    ...
    bool Push(const TRec::TVec& records) {
        YDBLOG_COMP_DEBUG(BS_SYNCER, VDISKP(VCtx->VDiskLogPrefix,
            "TIndexSstWriter: Push"), {"Marker", "BSFS20"},
        ...
        YDBLOG_COMP_DEBUG(BS_SYNCER, VDISKP(VCtx->VDiskLogPrefix,
            "TIndexSstWriter: Push"), {"Marker", "BSFS21"},
            {"FreeSpace", freeSpace},
            {"Size", recsSize},
            {"RecordSize", sizeof(TRec)});
    ...
    void OnChunkReserved(ui32 chunkIdx) {
        YDBLOG_COMP_DEBUG(BS_SYNCER, VDISKP(VCtx->VDiskLogPrefix,
            "TIndexSstWriter: OnChunkReserved"), {"Marker", "BSFS22"},
            {"ChunkIdx", chunkIdx},
            {"RecordSize", sizeof(TRec)});
    ...
    void Finish() {
        YDBLOG_COMP_DEBUG(BS_SYNCER, VDISKP(VCtx->VDiskLogPrefix,
            "TIndexSstWriter: Finish"), {"Marker", "BSFS23"},
            {"RecordSize", sizeof(TRec)});
    ...
    std::unique_ptr<TEvAddFullSyncSsts> GenerateCommitMessage(const TActorId sstWriterId) {
        YDBLOG_COMP_DEBUG(BS_SYNCER, VDISKP(VCtx->VDiskLogPrefix,
            "TIndexSstWriter: GenerateCommitMessage"), {"Marker", "BSFS24"},
