        ...
        for (const auto& [chunkIdx, blobs] : chunks) {
            ...
            auto doCheck = [&] {
                if (interval != TDiskPart()) {
                    ...
                    MonGroup.SmallBlobIntervalsRead().Inc();
                    MonGroup.SmallBlobIntervalBytesRead().Add(interval.Size);
                    ...
                    for (TBlobOnDisk *blob : pendingBlobs) {
                        ...
                        if (!intervalReadable) {
                            ...
                            MonGroup.SmallBlobsRead().Inc();
                            MonGroup.SmallBlobBytesRead().Add(interval.Size);
                        }
                        if (blobReadable) {
