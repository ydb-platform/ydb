...
namespace NKikimr::NPrivate {
    ...
    public:
        ...
        void Bootstrap() {
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: bootstrapped;", {"Marker", "BSVSP03"},
        ...
        {
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: sended found parts;", {"Marker", "BSVSP04"},
                {"OriginalBlobId", OriginalBlobId},
        ...
        void PullOriginalPart(ui64 pullingPart) {
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: send vGet for pulling part data;", {"Marker", "BSVSP05"},
                {"OriginalBlobId", OriginalBlobId},
        ...
        void HandleVGetRangeResult(TEvBlobStorage::TEvVGetResult::TPtr &ev) {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: received parts index;", {"Marker", "BSVSP06"},
                {"OriginalBlobId", OriginalBlobId},
        ...
        {
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: " << (forceEnd ? "received force end;" : "send patch result;"), {"Marker", "BSVSP07"},
                {"OriginalBlobId", OriginalBlobId},
        ...
        void HandleVGetResult(TEvBlobStorage::TEvVGetResult::TPtr &ev) {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: received part data;", {"Marker", "BSVSP08"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
                {"OriginalPartId", (ui32)OriginalPartId},
                {"PatchedPartId", (ui32)PatchedPartId},
        ...
        void SendXorDiff() {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: send xor diffs;", {"Marker", "BSVSP14"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
                {"OriginalPartId", (ui32)OriginalPartId},
                {"PatchedPartId", (ui32)PatchedPartId},
        ...
        void SendVPut() {
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: send vPut;", {"Marker", "BSVSP15"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
                {"OriginalPartId", (ui32)OriginalPartId},
                {"PatchedPartId", (ui32)PatchedPartId},
        ...
        void Handle(TEvBlobStorage::TEvVPatchDiff::TPtr &ev) {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: received diff;", {"Marker", "BSVSP09"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
                {"OriginalPartId", (ui32)OriginalPartId},
                {"PatchedPartId", (ui32)PatchedPartId},
        ...
        void Handle(TEvBlobStorage::TEvVPutResult::TPtr &ev) {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: received put result;", {"Marker", "BSVSP10"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
                {"OriginalPartId", (ui32)OriginalPartId},
                {"PatchedPartId", (ui32)PatchedPartId},
        ...
        void Handle(TEvBlobStorage::TEvVPatchXorDiff::TPtr &ev) {
            ...
            YDBLOG_COMP_INFO(BS_VDISK_PATCH, VDiskLogPrefix << " TEvVPatch: received xor diff;", {"Marker", "BSVSP13"},
                {"OriginalBlobId", OriginalBlobId},
                {"PatchedBlobId", PatchedBlobId},
        ...
        void NotifySkeletonAboutDying() {
            ...
            YDBLOG_COMP_DEBUG(BS_VDISK_PATCH, VDiskLogPrefix << " NotifySkeletonAboutDying;", {"Marker", "BSVSP17"});
        ...
        void HandleInStartState(TKikimrEvents::TEvWakeup::TPtr &/*ev*/) {
            ...
            YDBLOG_COMP_ERROR(BS_VDISK_PATCH, VDiskLogPrefix << " " << ErrorReason << ";", {"Marker", "BSVSP11"});
            SendVPatchFoundParts(NKikimrProto::ERROR);
            NotifySkeletonAboutDying();
            Become(&TThis::ErrorState);
        }
        ...
        void HandleInWaitState(TKikimrEvents::TEvWakeup::TPtr &/*ev*/) {
            ...
            YDBLOG_COMP_ERROR(BS_VDISK_PATCH, VDiskLogPrefix << " " << ErrorReason << ";", {"Marker", "BSVSP16"});
            NotifySkeletonAboutDying();
            Become(&TThis::ErrorState);
        }
        ...
        void HandleInDataStates(TKikimrEvents::TEvWakeup::TPtr &/*ev*/) {
            ...
            YDBLOG_COMP_ERROR(BS_VDISK_PATCH, VDiskLogPrefix << " " << ErrorReason << ";", {"Marker", "BSVSP12"});
            SendVPatchResult(NKikimrProto::ERROR);
            NotifySkeletonAboutDying();
            Become(&TThis::ErrorState);
        }
        ...
        void HandleInParityStates(TKikimrEvents::TEvWakeup::TPtr &/*ev*/) {
            ...
            YDBLOG_COMP_ERROR(BS_VDISK_PATCH, VDiskLogPrefix << " " << ErrorReason << ";", {"Marker", "BSVSP20"});
            SendVPatchResult(NKikimrProto::ERROR);
            NotifySkeletonAboutDying();
            Become(&TThis::ErrorState);
        }
