...
TAutoPtr<NKikimrConfig::TChannelProfileConfig> DummyChannelProfileConfig() {
    ...
    channel0->SetErasureSpecies(NKikimr::TBlobStorageGroupType::ErasureNames.at(NKikimr::TBlobStorageGroupType::ErasureMirror3));
    channel0->SetPDiskCategory(0);

    channel1->SetErasureSpecies(NKikimr::TBlobStorageGroupType::ErasureNames.at(NKikimr::TBlobStorageGroupType::ErasureMirror3));
    channel1->SetPDiskCategory(0);

    channel2->SetErasureSpecies(NKikimr::TBlobStorageGroupType::ErasureNames.at(NKikimr::TBlobStorageGroupType::ErasureMirror3));
