...
void TKikimrRunner::InitializeGRpc(const TKikimrRunConfig& runConfig) {
    ...
    if (appConfig.HasGRpcConfig() && appConfig.GetGRpcConfig().GetStartGRpcProxy()) {
        ...
        switch(grpcConfig.GetDefaultCompressionAlgorithm()) {
            ...
            case NKikimrConfig::TGRpcConfig::YDB_GRPC_COMPRESS_ALGORITHMS_COUNT: {
                opts.SetDefaultCompressionAlgorithm(GRPC_COMPRESS_ALGORITHMS_COUNT);
                break;
            }
        }
        ...
        switch(grpcConfig.GetDefaultCompressionLevel()) {
            ...
            case NKikimrConfig::TGRpcConfig::YDB_GRPC_COMPRESS_LEVEL_COUNT: {
                opts.SetDefaultCompressionLevel(GRPC_COMPRESS_LEVEL_COUNT);
                break;
            }
        }
