...
class PropertyGetRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  PropertyGetRequest() : nameSpace(), mapPrefix(), mapPredicate() {
  }
...
class DateColumnStatsData : public virtual ::apache::thrift::TBase {
 public:
  ...
  DateColumnStatsData() : numNulls(0), numDVs(0), bitVectors(), histogram() {
  }
...
class TimestampColumnStatsData : public virtual ::apache::thrift::TBase {
 public:
  ...
  TimestampColumnStatsData() : numNulls(0), numDVs(0), bitVectors(), histogram() {
  }
...
class PartitionsByExprRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  PartitionsByExprRequest() : dbName(), tblName(), expr(), defaultPartitionName(), maxParts(-1), catName(), order(), validWriteIdList(), id(-1LL), skipColumnSchemaForPartition(0), includeParamKeyPattern(), excludeParamKeyPattern() {
  }
...
class AddPartitionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  AddPartitionsRequest() : dbName(), tblName(), ifNotExists(0), needResult(true), catName(), validWriteIdList(), skipColumnSchemaForPartition(0) {
  }
...
class DropPartitionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  DropPartitionsRequest() : dbName(), tblName(), deleteData(0), ifExists(true), ignoreProtection(0), needResult(true), catName(), skipColumnSchemaForPartition(0) {
  }
...
class GetPartitionsByNamesRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  GetPartitionsByNamesRequest() : db_name(), tbl_name(), get_col_stats(0), processorIdentifier(), engine(), validWriteIdList(), getFileMetadata(0), id(-1LL), skipColumnSchemaForPartition(0), includeParamKeyPattern(), excludeParamKeyPattern() {
  }
...
class AbortTxnRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  AbortTxnRequest() : txnid(0), replPolicy(), txn_type((TxnType::type)0), errorCode(0) {
  }
...
class LockRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  LockRequest() : txnid(0), user(), hostname(), agentInfo("Unknown"), zeroWaitReadEnabled(false), exclusiveCTAS(false), locklessReadsEnabled(false) {
  }
...
class CompactionRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  CompactionRequest() : dbname(), tablename(), partitionname(), type((CompactionType::type)0), runas(), initiatorId(), initiatorVersion(), poolName(), numberOfBuckets(0), orderByClause() {
  }
...
class CompactionInfoStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  CompactionInfoStruct() : id(0), dbname(), tablename(), partitionname(), type((CompactionType::type)0), runas(), properties(), toomanyaborts(0), state(), workerId(), start(0), highestWriteId(0), errorMessage(), hasoldabort(0), enqueueTime(0), retryRetention(0), poolname(), numberOfBuckets(0), orderByClause() {
  }
...
class ShowCompactRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  ShowCompactRequest() : id(0), poolName(), dbName(), tbName(), partName(), type((CompactionType::type)0), state(), limit(0), order() {
  }
...
class ShowCompactResponseElement : public virtual ::apache::thrift::TBase {
 public:
  ...
  ShowCompactResponseElement() : dbname(), tablename(), partitionname(), type((CompactionType::type)0), state(), workerid(), start(0), runAs(), hightestTxnId(0), metaInfo(), endTime(0), hadoopJobId("None"), id(0), errorMessage(), enqueueTime(0), workerVersion(), initiatorId(), initiatorVersion(), cleanerStart(0), poolName(), nextTxnId(0), txnId(0), commitTime(0), hightestWriteId(0) {
  }
...
class AbortCompactionRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  AbortCompactionRequest() : type(), poolName() {
  }
...
class AbortCompactionResponseElement : public virtual ::apache::thrift::TBase {
 public:
  ...
  AbortCompactionResponseElement() : compactionId(0), status(), message() {
  }
...
class FindNextCompactRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  FindNextCompactRequest() : workerId(), workerVersion(), poolName() {
  }
...
class NotificationEventRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  NotificationEventRequest() : lastEvent(0), maxEvents(0), catName(), dbName() {
  }
...
class FireEventRequestData : public virtual ::apache::thrift::TBase {
 public:
  ...
  FireEventRequestData() : refreshEvent(0) {
  }
...
class AlterPartitionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  AlterPartitionsRequest() : catName(), dbName(), tableName(), writeId(-1LL), validWriteIdList(), skipColumnSchemaForPartition(0) {
  }
...
class AlterTableRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  AlterTableRequest() : catName(), dbName(), tableName(), writeId(-1LL), validWriteIdList(), processorIdentifier(), expectedParameterKey(), expectedParameterValue() {
  }
...
class PartitionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  PartitionsRequest() : catName(), dbName(), tblName(), maxParts(-1), validWriteIdList(), id(-1LL), skipColumnSchemaForPartition(0), includeParamKeyPattern(), excludeParamKeyPattern() {
  }
...
class GetPartitionsByFilterRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  GetPartitionsByFilterRequest() : catName(), dbName(), tblName(), filter(), maxParts(-1), skipColumnSchemaForPartition(0), includeParamKeyPattern(), excludeParamKeyPattern() {
  }
...
class GetPartitionsPsWithAuthRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  GetPartitionsPsWithAuthRequest() : catName(), dbName(), tblName(), maxParts(-1), userName(), validWriteIdList(), id(-1LL), skipColumnSchemaForPartition(0), includeParamKeyPattern(), excludeParamKeyPattern() {
  }
...
class CompactionAbortedException : public ::apache::thrift::TException {
 public:
  ...
  CompactionAbortedException() : message() {
  }
...
class NoSuchCompactionException : public ::apache::thrift::TException {
 public:
  ...
  NoSuchCompactionException() : message() {
  }
