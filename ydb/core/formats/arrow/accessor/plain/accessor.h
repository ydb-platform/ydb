...
public:
    ...
    static TPlainBuilder<arrow20::BinaryType> MakeBuilderBinary(const ui32 reserveItems = 0, const ui32 reserveData = 0) {
        return TPlainBuilder<arrow20::BinaryType>(reserveItems, reserveData);
    }
