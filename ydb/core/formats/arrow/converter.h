...
private:
    ...
    template <>
    TCell MakeCell<arrow20::FixedSizeBinaryArray>(const std::shared_ptr<arrow20::Array>& column, i64 row) {
        return MakeCellFromView<arrow20::FixedSizeBinaryArray>(column, row);
    }
