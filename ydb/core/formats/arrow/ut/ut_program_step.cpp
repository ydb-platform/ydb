...
Y_UNIT_TEST_SUITE(ProgramStep) {
    ...
    Y_UNIT_TEST(MergeFilterSimple) {
        ...
        AFL_VERIFY(chain->DebugStats() == "[TOTAL:Const:2;Calculation:4;Projection:1;Filter:1;FetchOriginalData:3;AssembleOriginalData:3;FetchIndexData:1;CheckIndexData:1;FetchHeaderData:3;CheckHeaderData:3;StreamLogic:1;];SUB:[FetchOriginalData:1;AssembleOriginalData:1;FetchHeaderData:1;CheckHeaderData:1;];")("debug", chain->DebugStats());
    }
