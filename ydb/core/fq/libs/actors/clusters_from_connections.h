...
NYql::TSolomonClusterConfig CreateSolomonClusterConfig(const TString& name, const TString& authToken, const TString& endpoint, const TString& grpcEndpoint, const TString& accountSignature, const FederatedQuery::Monitoring& monitoring);
