...
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_EMERG(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, EMERG, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_ALERT(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, ALERT, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_CRIT(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, CRIT, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_ERROR(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, ERROR, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_WARN(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, WARN, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_NOTICE(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, NOTICE, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_INFO(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, INFO, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_DEBUG(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, DEBUG, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
#define LOG_FQ_CONTROL_PLANE_CONFIG_AS_TRACE(actorSystem, logRecordStream) LOG_STREAMS_IMPL_AS(actorSystem, TRACE, FQ_CONTROL_PLANE_CONFIG, logRecordStream)
