...
namespace NFq {
    ...
    Y_UNIT_TEST_SUITE(TDatabaseResolverTests) {
            ...
            const TString& error = "")
        {
            ...
            auto httpOutgoingRequestHolder = bootstrap.ExpectEvent<NHttp::TEvHttpProxy::TEvHttpOutgoingRequest>(bootstrap.HttpProxy, NHttp::TEvHttpProxy::TEvHttpOutgoingRequest(httpRequest), &processorActorId);
        ...
        Y_UNIT_TEST(ResolveTwoDataStreamsFirstError) {
            ...
            bootstrap.Send(new IEventHandle(
                ...
                bootstrap.AsyncResolver,
                new NFq::TEvents::TEvEndpointRequest(
                    NYql::IDatabaseAsyncResolver::TDatabaseAuthMap({std::make_pair(requestIdAndDatabaseType1, databaseAuth),
