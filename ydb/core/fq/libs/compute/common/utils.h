...
TString GetV1StatFromV2Plan(TStringBuf plan, double* cpuUsage = nullptr);
...
struct IPlanStatProcessor {
    ...
    virtual TString GetQueryStat(TStringBuf plan, double& cpuUsage) = 0;
    virtual TPublicStat GetPublicStat(TStringBuf stat) = 0;
    virtual THashMap<std::string, i64> GetPlainStat(TStringBuf plan) = 0;
};
