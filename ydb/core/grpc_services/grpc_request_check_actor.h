...
public:
    ...
    void InitializeAttributesFromSchema(const TSchemeBoardEvents::TDescribeSchemeResult& schemeData, const TVector<std::pair<TString, TString>>& rootAttributes) {
        ...
        TPathId domainKey = TPathId(domainDescription.GetDomainKey().GetSchemeShard(), domainDescription.GetDomainKey().GetPathId());
        TPathId resourceDomainKey = TPathId(domainDescription.GetResourcesDomainKey().GetSchemeShard(), domainDescription.GetResourcesDomainKey().GetPathId());
    ...
    void Handle(TEvTxProxySchemeCache::TEvNavigateKeySetResult::TPtr& ev, const TActorContext& ctx) {
        ...
        default:
            ...
            return ReplyUnavailableAndDie(NYql::TIssue("Unknown resource database"));
        }
