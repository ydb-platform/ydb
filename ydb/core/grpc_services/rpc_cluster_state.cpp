...
public:
    ...
    TVector<TQuery> Queries = {
        ...
        {{ "NodeId", "QueryId", {"Query", true}, "AccessCount", "CompiledAt", "UserSID", "LastAccessedAt", "CompilationDurationMs", "Warnings", "Metadata", "QueryType", "Syntax" }, ".sys/compile_cache_queries" },
        ...
        {{ "NodeId", "PDiskId", "Type", "Kind", "Path", "Guid", "BoxId", "SharedWithOS", "ReadCentric", "AvailableSize", "TotalSize", "Status", "StatusChangeTimestamp", "ExpectedSlotCount", "ExpectedSlotSize", "NumActiveSlots", "DecommitStatus", "State", "SlotSizeInUnits", "MaintenanceStatus" }, ".sys/ds_pdisks" },
        ...
        {{ "DiskSpace", "State", "NodeId", "PDiskId", "VSlotId", "GroupId", "GroupGeneration", "FailDomain", "VDisk", "AllocatedSize", "AvailableSize", "Status", "Kind", "FailRealm", "Replicated", "PhantomOnly" }, ".sys/ds_vslots" },
        ...
        {{ "SessionId", "NodeId", "State", {"Query", true}, "QueryCount", "ClientAddress", "ClientPID", "ClientUserAgent", "ClientSdkBuildInfo", "ApplicationName", "SessionStartAt", "QueryStartAt", "StateChangeAt", "UserSID", "TraceId", "DurationUs", "CpuTimeUs", "ComputeMemoryBytes", "TableReadBytes", "SourceReadBytes" }, ".sys/query_sessions" },
