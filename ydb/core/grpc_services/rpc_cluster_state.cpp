...
public:
    ...
    TVector<TQuery> Queries = {
        ...
        {{ "SessionId", "NodeId", "State", {"Query", true}, "QueryCount", "ClientAddress", "ClientPID", "ClientUserAgent", "ClientSdkBuildInfo", "ApplicationName", "SessionStartAt", "QueryStartAt", "StateChangeAt", "UserSID", "TraceId", "DurationUs", "CpuTimeUs", "ComputeMemoryBytes", "ReadIngressBytesRate" }, ".sys/query_sessions" },
