...
namespace {
    ...
    bool CreateTopic(NYdb::TDriver& driver, const TString& topicName, const TString& consumerName) {
        return CreateTopic(driver, topicName, NYdb::NTopic::TCreateTopicSettings().BeginAddConsumer().ConsumerName(consumerName).AddAttribute("_mlp", "1").EndAddConsumer());
    }
    ...
    Y_UNIT_TEST_SUITE(TestSqsTopicHttpProxy) {
        ...
        Y_UNIT_TEST_F(TestSendMessageBadQueueUrl, TFixture) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(GetByPath<TString>(json1, "__type"), "ResourceNotFoundException");
        }
        ...
        Y_UNIT_TEST_F(TestSendMessageTooBig, TFixture) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(GetByPath<TString>(json0, "__type"), "InvalidArgumentException"); // TODO: change value
        }
        ...
        Y_UNIT_TEST_F(TestSendMessageBatchEmpty, TFixture) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(GetByPath<TString>(json, "__type"), "InvalidArgumentException"); // TODO: change value
        }
        ...
        Y_UNIT_TEST_F(TestSendMessageBatchLong, TFixture) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(GetByPath<TString>(json, "__type"), "InvalidArgumentException"); // TODO:change name
        }
