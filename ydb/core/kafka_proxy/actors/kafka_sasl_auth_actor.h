...
private:
    ...
    void SendResponse();
    void SendResponseAndDie(EKafkaErrors errorCode, Ydb::StatusIds_StatusCode status, const TString& errorMessage, const TString& details, const NActors::TActorContext& ctx);
