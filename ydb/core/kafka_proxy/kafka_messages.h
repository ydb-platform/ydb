...
enum EApiKey {
    HEADER = -1, // [] 
    PRODUCE = 0, // [BROKER] 
    FETCH = 1, // [BROKER, CONTROLLER] 
    LIST_OFFSETS = 2, // [BROKER] 
    METADATA = 3, // [BROKER] 
    OFFSET_COMMIT = 8, // [BROKER] 
    OFFSET_FETCH = 9, // [BROKER] 
    FIND_COORDINATOR = 10, // [BROKER] 
    JOIN_GROUP = 11, // [BROKER] 
    HEARTBEAT = 12, // [BROKER] 
    LEAVE_GROUP = 13, // [BROKER] 
    SYNC_GROUP = 14, // [BROKER] 
    DESCRIBE_GROUPS = 15, // [BROKER] 
    LIST_GROUPS = 16, // [BROKER] 
    SASL_HANDSHAKE = 17, // [BROKER, CONTROLLER] 
    API_VERSIONS = 18, // [BROKER, CONTROLLER] 
    CREATE_TOPICS = 19, // [BROKER, CONTROLLER] 
    INIT_PRODUCER_ID = 22, // [BROKER] 
    ADD_PARTITIONS_TO_TXN = 24, // [BROKER] 
    ADD_OFFSETS_TO_TXN = 25, // [BROKER] 
    END_TXN = 26, // [BROKER] 
    TXN_OFFSET_COMMIT = 28, // [BROKER] 
    DESCRIBE_CONFIGS = 32, // [BROKER, CONTROLLER] 
    ALTER_CONFIGS = 33, // [BROKER, CONTROLLER] 
    SASL_AUTHENTICATE = 36, // [BROKER, CONTROLLER] 
    CREATE_PARTITIONS = 37, // [BROKER, CONTROLLER] 
};
...
public:
    ...
    struct MessageMeta {
        static constexpr TKafkaVersions PresentVersions = {1, 2};
...
public:
    ...
    struct MessageMeta {
        static constexpr TKafkaVersions PresentVersions = {3, 13};
...
public:
    ...
    public:
        ...
        public:
            ...
            public:
                struct MessageMeta {
                    static constexpr TKafkaVersions PresentVersions = {8, 13};
                    static constexpr TKafkaVersions FlexibleVersions = {9, Max<TKafkaVersion>()};
                };
                ...
                struct BatchIndexMeta {
                    ...
                    static constexpr const char* About = "The batch index of the record that caused the batch to be dropped.";
                    static const Type Default; // = 0;
            ...
            public:
                struct MessageMeta {
                    static constexpr TKafkaVersions PresentVersions = {10, 13};
                    static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
                };
            ...
            struct CurrentLeaderMeta {
                ...
                static constexpr const char* About = "The leader broker that the producer should use for future requests.";
    ...
    class TNodeEndpoint : public TMessage {
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {10, 13};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        ...
        struct NodeIdMeta {
            ...
            static constexpr const char* About = "The ID of the associated node.";
            static const Type Default; // = 0;
        ...
        struct HostMeta {
            ...
            static constexpr const char* About = "The node's hostname.";
            static const Type Default; // = {""};
        ...
        struct PortMeta {
            ...
            static constexpr const char* About = "The node's port.";
            static const Type Default; // = 0;
        ...
        struct RackMeta {
            ...
            static constexpr const char* About = "The rack of the node, or null if it has not been assigned to a rack.";
            static const Type Default; // = std::nullopt;
        ...
        bool operator==(const TNodeEndpoint& other) const = default;
    };
    ...
    struct NodeEndpointsMeta {
        using ItemType = TNodeEndpoint;
        using ItemTypeDesc = NPrivate::TKafkaStructDesc;
        using Type = std::vector<TNodeEndpoint>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "nodeEndpoints";
        static constexpr const char* About = "Endpoints for all current-leaders enumerated in PartitionProduceResponses, with errors NOT_LEADER_OR_FOLLOWER.";
        static constexpr const TKafkaInt32 Tag = 0;
    ...
    NodeEndpointsMeta::Type NodeEndpoints;
...
public:
    ...
    struct MessageMeta {
        static constexpr TKafkaVersions PresentVersions = {4, 18};
    ...
    class TReplicaState : public TMessage {
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {15, 18};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        };

        TReplicaState();
        ~TReplicaState() = default;
        ...
        struct ReplicaIdMeta {
            ...
            static constexpr const char* About = "The replica ID of the follower, or -1 if this request is from a consumer.";
            static const Type Default; // = -1;
        ...
        struct ReplicaEpochMeta {
            using Type = TKafkaInt64;
            using TypeDesc = NPrivate::TKafkaIntDesc;

            static constexpr const char* Name = "replicaEpoch";
            static constexpr const char* About = "The epoch of this follower, or -1 if not available.";
            static const Type Default; // = -1;
        ...
        ReplicaEpochMeta::Type ReplicaEpoch;

        i32 Size(TKafkaVersion version) const override;
        void Read(TKafkaReadable& readable, TKafkaVersion version) override;
        void Write(TKafkaWritable& writable, TKafkaVersion version) const override;

        bool operator==(const TReplicaState& other) const = default;
    };
    ...
    public:
        ...
        public:
            ...
            struct ReplicaDirectoryIdMeta {
                using Type = TKafkaUuid;
                using TypeDesc = NPrivate::TKafkaUuidDesc;

                static constexpr const char* Name = "replicaDirectoryId";
                static constexpr const char* About = "The directory id of the follower fetching.";
                static constexpr const TKafkaInt32 Tag = 0;
                static const Type Default; // = TKafkaUuid(0, 0);

                static constexpr TKafkaVersions PresentVersions = {17, Max<TKafkaVersion>()};
                static constexpr TKafkaVersions TaggedVersions = VersionsAlways;
                static constexpr TKafkaVersions NullableVersions = VersionsNever;
                static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
            };
            ReplicaDirectoryIdMeta::Type ReplicaDirectoryId;
            ...
            struct HighWatermarkMeta {
                ...
                static constexpr const char* About = "The high-watermark known by the replica. -1 if the high-watermark is not known and 9223372036854775807 if the feature is not supported.";
                static constexpr const TKafkaInt32 Tag = 1;
                static const Type Default; // = 9223372036854775807;

                static constexpr TKafkaVersions PresentVersions = {18, Max<TKafkaVersion>()};
                static constexpr TKafkaVersions TaggedVersions = VersionsAlways;
                static constexpr TKafkaVersions NullableVersions = VersionsNever;
                static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
            };
    ...
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {7, 18};
            static constexpr TKafkaVersions FlexibleVersions = {12, Max<TKafkaVersion>()};
        };
    ...
    struct ReplicaIdMeta {
        ...
        static constexpr TKafkaVersions PresentVersions = {0, 14};
        static constexpr TKafkaVersions TaggedVersions = VersionsNever;
        static constexpr TKafkaVersions NullableVersions = VersionsNever;
        static constexpr TKafkaVersions FlexibleVersions = {12, Max<TKafkaVersion>()};
    };
    ...
    struct ReplicaStateMeta {
        using Type = TReplicaState;
        using TypeDesc = NPrivate::TKafkaStructDesc;

        static constexpr const char* Name = "replicaState";
        static constexpr const char* About = "The state of the replica in the follower.";
        static constexpr const TKafkaInt32 Tag = 1;

        static constexpr TKafkaVersions PresentVersions = {15, Max<TKafkaVersion>()};
        static constexpr TKafkaVersions TaggedVersions = VersionsAlways;
        static constexpr TKafkaVersions NullableVersions = VersionsNever;
        static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
    };
    ReplicaStateMeta::Type ReplicaState;
...
public:
    ...
    public:
        ...
        public:
            ...
            public:
                struct MessageMeta {
                    static constexpr TKafkaVersions PresentVersions = {12, 18};
                    static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
                };
                ...
                struct EpochMeta {
                    ...
                    static constexpr const char* About = "The largest epoch.";
                    static const Type Default; // = -1;
                ...
                struct EndOffsetMeta {
                    ...
                    static constexpr const char* About = "The end offset of the epoch.";
                    static const Type Default; // = -1;
            ...
            struct CurrentLeaderMeta {
                ...
                static constexpr const char* Name = "currentLeader";
                static constexpr const char* About = "The current leader of the partition.";
                static constexpr const TKafkaInt32 Tag = 1;
    ...
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {16, 18};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        };
    ...
    struct NodeEndpointsMeta {
        ...
        static constexpr const char* Name = "nodeEndpoints";
        static constexpr const char* About = "Endpoints for all current-leaders enumerated in PartitionData, with errors NOT_LEADER_OR_FOLLOWER & FENCED_LEADER_EPOCH.";
        static constexpr const TKafkaInt32 Tag = 0;

        static constexpr TKafkaVersions PresentVersions = {16, Max<TKafkaVersion>()};
        static constexpr TKafkaVersions TaggedVersions = VersionsAlways;
        static constexpr TKafkaVersions NullableVersions = VersionsNever;
        static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
    };
...
public:
    ...
    struct MessageMeta {
        static constexpr TKafkaVersions PresentVersions = {1, 10};
    ...
    struct ReplicaIdMeta {
        ...
        static constexpr const char* Name = "replicaId";
        static constexpr const char* About = "The broker ID of the requester, or -1 if this request is being made by a normal consumer.";
        static const Type Default; // = 0;
    ...
    struct TimeoutMsMeta {
        ...
        static constexpr const char* Name = "timeoutMs";
        static constexpr const char* About = "The timeout to await a response in milliseconds for requests that require reading from remote storage for topics enabled with tiered storage.";
        static const Type Default; // = 0;
    ...
    public:
        ...
        public:
            ...
            struct LeaderEpochMeta {
                ...
                static constexpr const char* Name = "leaderEpoch";
                static constexpr const char* About = "The leader epoch associated with the returned offset.";
                static const Type Default; // = -1;
...
public:
    ...
    public:
        ...
        struct NameMeta {
            ...
            static constexpr const char* Name = "name";
            static constexpr const char* About = "The topic name. Null for non-existing topics queried by ID. This is never null when ErrorCode is zero. One of Name and TopicId is always populated.";
            static const Type Default; // = {""};
        ...
        struct TopicIdMeta {
            ...
            static constexpr const char* Name = "topicId";
            static constexpr const char* About = "The topic id. Zero for non-existing topics queried by name. This is never zero when ErrorCode is zero. One of Name and TopicId is always populated.";
            static const Type Default; // = TKafkaUuid(0, 0);
    ...
    struct BrokersMeta {
        ...
        static constexpr const char* About = "A list of brokers present in the cluster.";
...
public:
    ...
    struct MessageMeta {
        static constexpr TKafkaVersions PresentVersions = {2, 10};
    ...
    struct GenerationIdOrMemberEpochMeta {
        using Type = TKafkaInt32;
        using TypeDesc = NPrivate::TKafkaIntDesc;

        static constexpr const char* Name = "generationIdOrMemberEpoch";
        static constexpr const char* About = "The generation of the group if using the classic group protocol or the member epoch if using the consumer protocol.";
        static const Type Default; // = -1;
    ...
    GenerationIdOrMemberEpochMeta::Type GenerationIdOrMemberEpoch;
...
public:
    ...
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {1, 7};
            static constexpr TKafkaVersions FlexibleVersions = {6, Max<TKafkaVersion>()};
        };
    ...
    public:
        ...
        struct MemberEpochMeta {
            using Type = TKafkaInt32;
            using TypeDesc = NPrivate::TKafkaIntDesc;

            static constexpr const char* Name = "memberEpoch";
            static constexpr const char* About = "The member epoch if using the new consumer protocol (KIP-848).";
            static const Type Default; // = -1;
        ...
        MemberEpochMeta::Type MemberEpoch;
...
public:
    ...
    struct KeyTypeMeta {
        ...
        static constexpr const char* About = "The coordinator key type. (group, transaction, share).";
        static const Type Default; // = 0;
...
public:
    ...
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {4, 6};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        };
...
public:
    ...
    public:
        ...
        struct ErrorMessageMeta {
            ...
            static constexpr const char* Name = "errorMessage";
            static constexpr const char* About = "The describe error message, or null if there was no error.";
            static const Type Default; // = std::nullopt;
...
public:
    ...
    struct TypesFilterMeta {
        using ItemType = TKafkaString;
        using ItemTypeDesc = NPrivate::TKafkaStringDesc;
        using Type = std::vector<TKafkaString>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "typesFilter";
        static constexpr const char* About = "The types of the groups we want to list. If empty, all groups are returned with their type.";
    ...
    TypesFilterMeta::Type TypesFilter;
...
public:
    ...
    public:
        ...
        struct GroupTypeMeta {
            using Type = TKafkaString;
            using TypeDesc = NPrivate::TKafkaStringDesc;

            static constexpr const char* Name = "groupType";
            static constexpr const char* About = "The group type name.";
            static const Type Default; // = {""};
...
public:
    ...
    public:
        ...
        class TCreatableTopicConfig : public TMessage {
        public:
            struct MessageMeta {
                static constexpr TKafkaVersions PresentVersions = {2, 7};
                static constexpr TKafkaVersions FlexibleVersions = {5, Max<TKafkaVersion>()};
            ...
            TCreatableTopicConfig();
            ~TCreatableTopicConfig() = default;
            ...
            bool operator==(const TCreatableTopicConfig& other) const = default;
        };
        ...
        struct ConfigsMeta {
            using ItemType = TCreatableTopicConfig;
            using ItemTypeDesc = NPrivate::TKafkaStructDesc;
            using Type = std::vector<TCreatableTopicConfig>;
            using TypeDesc = NPrivate::TKafkaArrayDesc;
...
public:
    ...
    struct Enable2PcMeta {
        using Type = TKafkaBool;
        using TypeDesc = NPrivate::TKafkaBoolDesc;

        static constexpr const char* Name = "enable2Pc";
        static constexpr const char* About = "True if the client wants to enable two-phase commit (2PC) protocol for transactions.";
        static const Type Default; // = false;
    ...
    Enable2PcMeta::Type Enable2Pc;

    struct KeepPreparedTxnMeta {
        using Type = TKafkaBool;
        using TypeDesc = NPrivate::TKafkaBoolDesc;

        static constexpr const char* Name = "keepPreparedTxn";
        static constexpr const char* About = "True if the client wants to keep the currently ongoing transaction instead of aborting it.";
        static const Type Default; // = false;
    ...
    KeepPreparedTxnMeta::Type KeepPreparedTxn;
...
public:
    ...
    struct OngoingTxnProducerIdMeta {
        using Type = TKafkaInt64;
        using TypeDesc = NPrivate::TKafkaIntDesc;

        static constexpr const char* Name = "ongoingTxnProducerId";
        static constexpr const char* About = "The producer id for ongoing transaction when KeepPreparedTxn is used, -1 if there is no transaction ongoing.";
        static const Type Default; // = -1;
    ...
    OngoingTxnProducerIdMeta::Type OngoingTxnProducerId;

    struct OngoingTxnProducerEpochMeta {
        using Type = TKafkaInt16;
        using TypeDesc = NPrivate::TKafkaIntDesc;

        static constexpr const char* Name = "ongoingTxnProducerEpoch";
        static constexpr const char* About = "The epoch associated with the  producer id for ongoing transaction when KeepPreparedTxn is used, -1 if there is no transaction ongoing.";
        static const Type Default; // = -1;
    ...
    OngoingTxnProducerEpochMeta::Type OngoingTxnProducerEpoch;
...
public:
    ...
    class TAddPartitionsToTxnTransaction : public TMessage {
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {4, 5};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        };

        TAddPartitionsToTxnTransaction();
        ~TAddPartitionsToTxnTransaction() = default;
        ...
        struct VerifyOnlyMeta {
            using Type = TKafkaBool;
            using TypeDesc = NPrivate::TKafkaBoolDesc;

            static constexpr const char* Name = "verifyOnly";
            static constexpr const char* About = "Boolean to signify if we want to check if the partition is in the transaction rather than add it.";
            static const Type Default; // = false;
        ...
        VerifyOnlyMeta::Type VerifyOnly;
        ...
        bool operator==(const TAddPartitionsToTxnTransaction& other) const = default;
    };

    struct TransactionsMeta {
        using ItemType = TAddPartitionsToTxnTransaction;
        using ItemTypeDesc = NPrivate::TKafkaStructDesc;
        using Type = std::vector<TAddPartitionsToTxnTransaction>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "transactions";
        static constexpr const char* About = "List of transactions to add partitions to.";
    ...
    TransactionsMeta::Type Transactions;

    struct V3AndBelowTransactionalIdMeta {
        using Type = TKafkaString;
        using TypeDesc = NPrivate::TKafkaStringDesc;

        static constexpr const char* Name = "v3AndBelowTransactionalId";
        static constexpr const char* About = "The transactional id corresponding to the transaction.";
        static const Type Default; // = {""};
    ...
    V3AndBelowTransactionalIdMeta::Type V3AndBelowTransactionalId;

    struct V3AndBelowProducerIdMeta {
        using Type = TKafkaInt64;
        using TypeDesc = NPrivate::TKafkaIntDesc;

        static constexpr const char* Name = "v3AndBelowProducerId";
        static constexpr const char* About = "Current producer id in use by the transactional id.";
        static const Type Default; // = 0;
    ...
    V3AndBelowProducerIdMeta::Type V3AndBelowProducerId;

    struct V3AndBelowProducerEpochMeta {
        using Type = TKafkaInt16;
        using TypeDesc = NPrivate::TKafkaIntDesc;

        static constexpr const char* Name = "v3AndBelowProducerEpoch";
        static constexpr const char* About = "Current epoch associated with the producer id.";
        static const Type Default; // = 0;
    ...
    V3AndBelowProducerEpochMeta::Type V3AndBelowProducerEpoch;

    struct V3AndBelowTopicsMeta {
        using ItemType = TAddPartitionsToTxnTopic;
        using ItemTypeDesc = NPrivate::TKafkaStructDesc;
        using Type = std::vector<TAddPartitionsToTxnTopic>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "v3AndBelowTopics";
        static constexpr const char* About = "The partitions to add to the transaction.";
    ...
    V3AndBelowTopicsMeta::Type V3AndBelowTopics;
...
public:
    ...
    public:
        ...
        struct PartitionErrorCodeMeta {
            using Type = TKafkaInt16;
            using TypeDesc = NPrivate::TKafkaIntDesc;

            static constexpr const char* Name = "partitionErrorCode";
        ...
        PartitionErrorCodeMeta::Type PartitionErrorCode;
    ...
    public:
        ...
        ResultsByPartitionMeta::Type ResultsByPartition;
    ...
    class TAddPartitionsToTxnResult : public TMessage {
    public:
        struct MessageMeta {
            static constexpr TKafkaVersions PresentVersions = {4, 5};
            static constexpr TKafkaVersions FlexibleVersions = VersionsAlways;
        ...
        TAddPartitionsToTxnResult();
        ~TAddPartitionsToTxnResult() = default;
        ...
        TopicResultsMeta::Type TopicResults;

        i32 Size(TKafkaVersion version) const override;
        void Read(TKafkaReadable& readable, TKafkaVersion version) override;
        void Write(TKafkaWritable& writable, TKafkaVersion version) const override;

        bool operator==(const TAddPartitionsToTxnResult& other) const = default;
    };
    ...
    struct ErrorCodeMeta {
        ...
        static constexpr const char* Name = "errorCode";
        static constexpr const char* About = "The response top level error code.";
        static const Type Default; // = 0;
    ...
    struct ResultsByTransactionMeta {
        using ItemType = TAddPartitionsToTxnResult;
        using ItemTypeDesc = NPrivate::TKafkaStructDesc;
        using Type = std::vector<TAddPartitionsToTxnResult>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "resultsByTransaction";
        static constexpr const char* About = "Results categorized by transactional ID.";
    ...
    ResultsByTransactionMeta::Type ResultsByTransaction;

    struct ResultsByTopicV3AndBelowMeta {
        using ItemType = TAddPartitionsToTxnTopicResult;
        using ItemTypeDesc = NPrivate::TKafkaStructDesc;
        using Type = std::vector<TAddPartitionsToTxnTopicResult>;
        using TypeDesc = NPrivate::TKafkaArrayDesc;

        static constexpr const char* Name = "resultsByTopicV3AndBelow";
        static constexpr const char* About = "The results for each topic.";
    ...
    ResultsByTopicV3AndBelowMeta::Type ResultsByTopicV3AndBelow;
...
public:
    ...
    public:
        ...
        struct PartitionsMeta {
            ...
            static constexpr const char* Name = "partitions";
            static constexpr const char* About = "The partitions inside the topic that we want to commit offsets for.";
...
public:
    ...
    struct SessionLifetimeMsMeta {
        ...
        static constexpr const char* About = "Number of milliseconds after which only re-authentication over the existing connection to create a new session can occur.";
        static const Type Default; // = 0;
