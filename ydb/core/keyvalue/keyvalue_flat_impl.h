    ...
    struct TTxInit : public NTabletFlatExecutor::ITransaction {
        ...
        bool Execute(NTabletFlatExecutor::TTransactionContext &txc, const TActorContext &ctx) override {
            ...
            if (txc.DB.GetScheme().GetTableInfo(TABLE_ID) == nullptr) {
                ...
                alter.AddColumn(TABLE_ID, "key", KEY_TAG, NScheme::TSmallBoundedString::TypeId, false, false, false);
                alter.AddColumnToKey(TABLE_ID, KEY_TAG);
                alter.AddColumn(TABLE_ID, "value", VALUE_TAG, NScheme::TString::TypeId, false, false, false);
