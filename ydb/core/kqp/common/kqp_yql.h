...
struct TKqpStreamLookupSettings {
    ...
    static constexpr TStringBuf VectorTopUniqueSettingName = "VectorTopUnique";
    ...
    static bool HasVectorTopUnique(const NNodes::TKqlStreamLookupTable& node);
    static bool HasVectorTopUnique(const NNodes::TCoNameValueTupleList& node);
};
