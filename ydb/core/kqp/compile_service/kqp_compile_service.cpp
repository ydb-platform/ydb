...
private:
    ...
    void HandleConfig(NConsole::TEvConsole::TEvConfigNotificationRequest::TPtr& ev) {
        ...
        bool enableBuildAggregationResultStages = TableServiceConfig.GetEnableBuildAggregationResultStages();
        ...
        if (TableServiceConfig.GetSqlVersion() != defaultSyntaxVersion ||
            ...
            TableServiceConfig.GetEnableBuildAggregationResultStages() != enableBuildAggregationResultStages)
        {
