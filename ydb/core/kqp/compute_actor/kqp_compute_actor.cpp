...
NYql::NDq::IDqAsyncIoFactory::TPtr CreateKqpAsyncIoFactory(
    ...
    NYql::NDq::RegisterDqInputTransformLookupActorFactory(*factory, NKikimr::AppData()->FeatureFlags.GetEnableStreamingQueriesCounters() ? counters->GetKqpCounters() : nullptr);
