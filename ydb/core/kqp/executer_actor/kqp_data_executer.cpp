...
public:
    ...
    TKqpDataExecuter(IKqpGateway::TExecPhysicalRequest&& request, const TString& database,
        ...
        TOutputFormat outputFormat, TKqpRequestCounters::TPtr counters, bool streamResult,
        ...
        : TBase(std::move(request), std::move(asyncIoFactory), federatedQuerySetup, GUCSettings, database, userToken, std::move(outputFormat),
...
IActor* CreateKqpDataExecuter(IKqpGateway::TExecPhysicalRequest&& request, const TString& database, const TIntrusiveConstPtr<NACLib::TUserToken>& userToken,
    TOutputFormat outputFormat, TKqpRequestCounters::TPtr counters, bool streamResult, const NKikimrConfig::TTableServiceConfig& tableServiceConfig,
    ...
    TMaybe<TBatchOperationSettings> batchOperationSettings)
{
    return new TKqpDataExecuter(std::move(request), database, userToken, std::move(outputFormat), counters, streamResult, tableServiceConfig,
