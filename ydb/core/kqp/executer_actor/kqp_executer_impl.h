        ...
        for (auto& [_, stageInfo] : TasksGraph.GetStagesInfo()) {
            ...
            // Scan tasks from shards
                ...
                for (const auto& op : stage.GetTableOps()) {
                    ...
                    // TODO: read settings once - and store the result somewhere to use in Tasks Graph.
