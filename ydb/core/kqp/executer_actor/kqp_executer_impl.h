...
#define KQP_EXECUTER_STLOG(PRIO, MARKER, MESSAGE, ...)                                           \
    STLOG(PRIO, NKikimrServices::KQP_EXECUTER, MARKER, MESSAGE,                           \
        (ActorId, SelfId()),                                                              \
        (TxId, TxId),                                                                     \
        (Ctx, *GetUserRequestContext())                                                   \
        __VA_OPT__(,) __VA_ARGS__)

#define STLOG_T(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_TRACE, MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_D(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_DEBUG, MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_I(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_INFO,  MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_N(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_NOTICE, MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_W(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_WARN,  MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_E(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_ERROR, MARKER, MESSAGE, ##__VA_ARGS__)
#define STLOG_C(MARKER, MESSAGE, ...) KQP_EXECUTER_STLOG(PRI_CRIT,  MARKER, MESSAGE, ##__VA_ARGS__)
