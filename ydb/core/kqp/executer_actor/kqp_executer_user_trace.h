...
// (Read/Write table, Join, Aggregate, Filter). Under each stage span emits a span per task (query ->
// stage -> task tree) carrying its NodeId and per-task stats. No-op when the user channel didn't
// sample the query.
