...
public:
    ...
    void Handle(TEvTxProxySchemeCache::TEvNavigateKeySetResult::TPtr& ev) {
        STLOG_D(KQPSCHEME, "Handle TEvTxProxySchemeCache::TEvNavigateKeySetResult",
        ...
        if (UserToken && !UserToken->GetSerializedToken().empty() && !CheckAlterAccess(*UserToken, resp)) {
            STLOG_E(KQPSCHEME, "Access check failed");
        ...
        if (!domainInfo) {
            STLOG_E(KQPSCHEME, "Got empty domain info");
    ...
    void Handle(NSchemeShard::TEvIndexBuilder::TEvCreateResponse::TPtr& ev) {
        ...
        STLOG_D(KQPSCHEME, "Handle TEvIndexBuilder::TEvCreateResponse",
    ...
    void Handle(NSchemeShard::TEvIndexBuilder::TEvGetResponse::TPtr& ev) {
        ...
        STLOG_D(KQPSCHEME, "Handle TEvIndexBuilder::TEvGetResponse",
    ...
    void HandleAbortExecution(TEvKqp::TEvAbortExecution::TPtr& ev) {
        ...
        STLOG_D(KQPSCHEME, "Got EvAbortExecution",
...
private:
    ...
    void UnexpectedEvent(const TString& state, ui32 eventType) {
        STLOG_C(KQPSCHEME, "TKqpSchemeExecuter, unexpected event",
    ...
    void InternalError(const NYql::TIssues& issues) {
        STLOG_E(KQPSCHEME, issues.ToOneLineString());
