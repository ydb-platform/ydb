...
struct TTaskMeta {
private:
    YDB_OPT(bool, EnableShardsSequentialScan); // ScanFromShards only
...
public:
    ...
    bool ScanTask = false; // true is ScanFromShards
    TActorId ExecuterId;
    ui32 Type = Unknown;
    ...
    TMaybe<TWriteInfo> Writes;             // if not set -> no writes // TODO: not used?
