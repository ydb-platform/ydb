...
private:
    ...
    std::pair<ui32, TKqpTasksGraph::TTaskType::ECreateReason> GetMaxTasksAggregation(const TStageInfo& stageInfo, std::optional<ui32> previousTasksCount, ui32 nodesCount);
