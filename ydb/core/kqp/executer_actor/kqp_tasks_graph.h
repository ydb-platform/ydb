...
struct TTaskInputMeta {
    ...
    NKikimrTxDataShard::TKqpVectorIndexReadSettings* VectorIndexReadSettings = nullptr;
...
private:
    ...
    void BuildVectorIndexReadChannels(const TStageInfo& stageInfo, ui32 inputIndex,
        const TStageInfo& inputStageInfo, ui32 outputIndex,
        const NKqpProto::TKqpPhyCnVectorIndexRead& vectorIndexRead, bool enableSpilling, const NYql::NDq::TChannelLogFunc& logFunc);
