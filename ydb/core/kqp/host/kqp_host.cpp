...
private:
    ...
    void InitYtProvider(TVector<std::function<TFuture<void>()>>& finalizers) {
        ...
        auto [ytState, statWriter] = CreateYtNativeState(FederatedQuerySetup->YtGateway, userName, sessionId, &FederatedQuerySetup->YtGatewayConfig, TypesCtx, MakeCBOOptimizerFactory(), MakeDqHelper());
