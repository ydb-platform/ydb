...
struct TKqpProviderContext : public TBaseProviderContext {
    ...
    double CONSTS_SHUFFLE_LEFT_SIDE_MULT = 0.2;
    double CONSTS_SHUFFLE_LEFT_SIDE_POW = 0.2;
    double CONSTS_SHUFFLE_RIGHT_SIDE_MULT = 0.2;
    double CONSTS_SHUFFLE_RIGHT_SIDE_POW = 0.2;

    double CONSTS_LEFT_SIDE_BYTESIZE_FACTOR = 0.0;
    double CONSTS_RIGHT_SIDE_BYTESIZE_FACTOR = 1e-15;
    double CONSTS_OUTPUT_SIDE_BYTESIZE_FACTOR = 0.0;

    double CONSTS_INTERACTION_MULT = 1.0;
    double CONSTS_INTERACTION_POW = 1.0;

    double CONSTS_MAPJOIN_LEFT_SIDE_MULT = 0.2;
    double CONSTS_MAPJOIN_LEFT_SIDE_POW = 0.2;
    double CONSTS_MAPJOIN_RIGHT_SIDE_MULT = 0.2;
    double CONSTS_MAPJOIN_RIGHT_SIDE_POW = 2.7;
    double CONSTS_MAPJOIN_OUTPUT_MULT = 0.0;
    double CONSTS_MAPJOIN_OUTPUT_POW = 1.0;

    double CONSTS_GRACEJOIN_LEFT_SIDE_MULT = 2.7;
    double CONSTS_GRACEJOIN_LEFT_SIDE_POW = 1.8;
    double CONSTS_GRACEJOIN_RIGHT_SIDE_MULT = 2.7;
    double CONSTS_GRACEJOIN_RIGHT_SIDE_POW = 1.8;
    double CONSTS_GRACEJOIN_OUTPUT_MULT = 0.0;
