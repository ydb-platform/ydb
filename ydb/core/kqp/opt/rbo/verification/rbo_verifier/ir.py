...
def validate_snapshot(snapshot: Snapshot) -> dict[str, dict[str, Column]]:
    ...
    # Admission is stronger than expression typing: supported windows have
    # whole-plan premises. Import here to keep the IR definitions independent
    # of their capability checks during module initialization.
    from .window_admission import validate_window_dataflow
    validate_window_dataflow(snapshot, schemas)
