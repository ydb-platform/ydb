...
using TSetConstraintSettings = NKikimrSchemeOpConstraint::TSetConstraintSettings;
...
public:
    ...
    virtual NThreading::TFuture<TGenericResult> SetConstraint(const TString& cluster, TVector<TSetConstraintSettings>&& settings) = 0;
