...
arrow20::Status TArrowMemoryPool::Allocate(int64_t size, uint8_t** out) {
    Y_ENSURE(size >= 0 && out);
...
arrow20::Status TArrowMemoryPool::Reallocate(int64_t old_size, int64_t new_size, uint8_t** ptr) {
