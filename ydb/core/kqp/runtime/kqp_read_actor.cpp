...
public:
    ...
    void HandleResolve(TEvTxProxySchemeCache::TEvResolveKeySetResult::TPtr& ev) {
        ...
        YQL_ENSURE(Settings->GetIsolationLevel() == NKikimrKqp::EIsolationLevel::ISOLATION_LEVEL_SNAPSHOT_RO && !Settings->HasLockTxId(), "SnapshotReadOnly should not take locks");
