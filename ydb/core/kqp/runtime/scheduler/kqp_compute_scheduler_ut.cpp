...
Y_UNIT_TEST_SUITE(TComputeScheduler) {
    ...
    TVector<TDuration> RunSimulation(TComputeScheduler& scheduler, TArrayRef<THolder<TSchedulerEntity>> handles, TMonotonic start, TDuration tick, TDuration length, TDuration batch) {
