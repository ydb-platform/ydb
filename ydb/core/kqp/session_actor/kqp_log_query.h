...
//
// Multi-part layout (rsyslog $MaxMessageSize=8KB):
//   part==1: envelope + request{event, data, issues, completed fields}.
//   part>1:  envelope + request{data}. Reassemble by req_id/part.
