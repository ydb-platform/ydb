...
Y_UNIT_TEST_SUITE(KqpJsonIndexes) {
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Basic, IsJsonDocument, IsStrict) {
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Ranges, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Methods, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Variables_JsonLiteral, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Variables_YqlParameter, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_AndCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_AndCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_OrCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_OrCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_AndOrCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_AndOrCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_Arithmetic, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JE_All, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = false,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Basic, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Ranges, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Methods, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Between, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_InList, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Variables_JsonLiteral, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Variables_YqlParameter, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_AndCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_AndCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_OrCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_OrCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_AndOrCombinations_Indexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_AndOrCombinations_NonIndexable, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_Arithmetic, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JV_All, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = false,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = true,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JEJV_Methods, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
    ...
    Y_UNIT_TEST_QUAD(JsonCorpus_JEJV_Arithmetic, IsJsonDocument, IsStrict) {
        TPredicateBuilderOptions pOpts = {
            .EnableJsonExists = true,
            .EnableJsonValue = true,
            .EnableNonJsonFilters = false,
...
Y_UNIT_TEST_SUITE(KqpJsonIndexTokens) {
    ...
    Y_UNIT_TEST(JsonValueBetweenAndIn) {
        TestSelectJsonWithIndex("JsonDocument", std::nullopt, [](TQueryClient& db, const auto&) {
            ...
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1') BETWEEN "a" AND "z")", {"\3k1"});
    ...
    Y_UNIT_TEST(JsonValueComparisons) {
        TestSelectJsonWithIndex("JsonDocument", std::nullopt, [](TQueryClient& db, const auto&) {
            ...
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1') = "abc")", {"\3k1" + strSuffix("abc")});
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1' RETURNING Int32) = 5)", {"\3k1" + numSuffix(5)});
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1' RETURNING Bool) = true)", {"\3k1" + trueSuffix});
            ...
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1') == CAST(Data AS Utf8))", {"\3k1"});
            ...
            ValidateTokens(db, R"(JSON_VALUE(Text, '$.k1') == Data)", {"\3k1"});
            // Reversed order
            ValidateTokens(db, R"(Data == JSON_VALUE(Text, '$.k1'))", {"\3k1"});

            // UDF on the JSON_VALUE side - the JSON predicate itself is wrapped, not extractable
            ValidateError(db, R"(String::AsciiToUpper(JSON_VALUE(Text, '$.k1')) == "ABC")");
        });
    }
    ...
    Y_UNIT_TEST(CrossColumnPredicates) {
        ...
        ValidateError(db,
            R"(JSON_VALUE(Text, '$.k1') == JSON_VALUE(Text2, '$.k2'))",
            "Cross-column predicates are not supported");
        ValidateError(db,
            R"(JSON_VALUE(Text2, '$.k1') == JSON_VALUE(Text, '$.k2'))",
            "Cross-column predicates are not supported");
    }
    ...
    Y_UNIT_TEST(JsonFunctionsMisc) {
        TestSelectJsonWithIndex("JsonDocument", std::nullopt, [](TQueryClient& db, const auto&) {
            ...
            ValidateError(db, R"(("prefix:" || JSON_VALUE(Text, '$.k1')) == "prefix:abc")");
            // AND with this non-indexable form + indexable JE
            ValidateTokens(db,
                R"(("prefix:" || JSON_VALUE(Text, '$.k1')) == "prefix:abc" AND JSON_EXISTS(Text, '$.k2'))",
                {"\3k2"});
