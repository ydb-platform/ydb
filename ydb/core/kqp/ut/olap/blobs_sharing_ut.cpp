...
Y_UNIT_TEST_SUITE(KqpOlapBlobsSharing) {
    ...
    public:
        TReshardingTest()
            ...
            Tests::NCommon::TLoggerInit(Kikimr).SetComponents({ NKikimrServices::TX_COLUMNSHARD, NKikimrServices::TX_COLUMNSHARD_SCAN }, "CS").SetPriority(NActors::NLog::PRI_NOTICE).Initialize();
        }
