...
TKikimrSettings MakeLocalIndexOnInsertTestSettings() {
...
Y_UNIT_TEST_SUITE(KqpOlapIndexes) {
    ...
    TString scriptMinMaxIndexOnInsertEnabled = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTable` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`);
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTable` (TYPE TABLE) SET (ACTION=UPSERT_INDEX, NAME=field_mm, TYPE=MIN_MAX, FEATURES=`{"column_name" : "field"}`);
        ------
    ...
    TString scriptMinMaxIndexOnInsertMinBlobBytes = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTable` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.MIN_BLOB_BYTES`=`500`);
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTable` (TYPE TABLE) SET (ACTION=UPSERT_INDEX, NAME=field_mm, TYPE=MIN_MAX, FEATURES=`{"column_name" : "field"}`);
        ------
    ...
    TString scriptAllScalarIndexesOnInsert = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTableAllIdx` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`);
        ------
        SCHEMA:
    ...
    TString scriptCategoryBloomIndexOnInsert = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTableCatBloom` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`, `SCAN_READER_POLICY_NAME`=`SIMPLE`);
        ------
        SCHEMA:
    ...
    TString scriptLocalIndexesOnInsertInCreateTable = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTableLocalIdx` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`, `SCHEME_NEED_ACTUALIZATION`=`true`);
        ------
        DATA:
    ...
    TString scriptLocalIndexesOnInsertViaAddIndex = R"(
        ...
        ------
        SCHEMA:
        ALTER OBJECT `/Root/ColumnTableLocalAdd` (TYPE TABLE) SET (ACTION=UPSERT_OPTIONS, `INSERT_PROMOTE_OPTIONS.ENABLED`=`true`, `INSERT_PROMOTE_OPTIONS.BUILD_INDEXES_ENABLED`=`true`);
        ------
        SCHEMA:
