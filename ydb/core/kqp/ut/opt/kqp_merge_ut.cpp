...
void CreateSimpleDataTypes(TKikimrRunner& kikimr) {
    ...
    result = session.ExecuteDataQuery(R"(
        ...
        REPLACE INTO `/Root/SimpleDataTypes` (col_bool, col_uint64, col_int32,
            ...
            Interval("P1DT1H1M1.111111S"), Decimal("1.11", 35, 9)),
            ...
            Interval("P2DT2H2M2.222S"), Decimal("2.22", 35, 9)),
            ...
            Interval("P101DT10H10M10.101101S"), Decimal("101.101", 35, 9)),
            ...
            Interval("P302DT10H10M10.302302S"), Decimal("302.302", 35, 9))
