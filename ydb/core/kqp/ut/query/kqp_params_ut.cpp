...
Y_UNIT_TEST_SUITE(KqpParams) {
    ...
    Y_UNIT_TEST(ParameterTypes) {
        ...
        auto params = db.GetParamsBuilder()
            ...
            .AddParam("$ParamDate32").Date32(TWideDays(-17158)).Build()
            .AddParam("$ParamDatetime64").Datetime64(TWideSeconds(TInstant::ParseIso8601("2020-01-11 15:04:53").Seconds())).Build()
            .AddParam("$ParamTimestamp64").Timestamp64(TWideMicroseconds(TInstant::ParseIso8601("2020-01-12 21:18:37").MicroSeconds())).Build()
