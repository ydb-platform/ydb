...
Y_UNIT_TEST_SUITE(KqpScheme) {
    ...
    Y_UNIT_TEST(AlterColumnTableTiering) {
        ...
        { // describe table
            ...
            UNIT_ASSERT_VALUES_EQUAL(std::get<TTtlDeleteAction>(ttl->GetTiers()[0].GetAction()).GetApplyAfter(), TDuration::Seconds(10));
        }
        auto query2 = TStringBuilder() << R"(
            --!syntax_v1
...
Y_UNIT_TEST_SUITE(KqpOlapScheme) {
    ...
    Y_UNIT_TEST(AddColumnWithTtl) {
        ...
        }
        {
            ...
            UNIT_ASSERT_VALUES_EQUAL(std::get<TTtlDeleteAction>(evictTier.GetAction()).GetApplyAfter(), TDuration::Seconds(10));
