...
Y_UNIT_TEST_SUITE(KqpScheme) {
    ...
    Y_UNIT_TEST(CreateTableWithPartitionAtKeysComplex) {
        ...
        size_t n = 0;
        const TVector<std::pair<ui64, TString>> expectedRanges = { { 10ul, "" }, { 100ul, "123" }, { 1000ul, "cde" } };
    ...
    Y_UNIT_TEST(AlterIndexImplTable) {
        ...
        constexpr int minPartitionsCount = 10;
        {
            ...
            UNIT_ASSERT_STRING_CONTAINS(
                result.GetIssues().ToString(), "Error: Cannot find table 'db.[/Root/SecondaryKeys/Index/indexImplTable]' because it does not "
    ...
    Y_UNIT_TEST(ResourcePoolClassifiersRankValidation) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(result.GetStatus(), EStatus::GENERIC_ERROR);
        UNIT_ASSERT_STRING_CONTAINS(
            result.GetIssues().ToString(), "Resource pool classifier rank check failed, status: ALREADY_EXISTS, reason: { <main>: Error: "
    ...
    Y_UNIT_TEST(CreateResourcePoolClassifier) {
        ...
        UNIT_ASSERT_VALUES_EQUAL_C(result.GetStatus(), EStatus::SUCCESS, result.GetIssues().ToString());
        UNIT_ASSERT_VALUES_EQUAL(
            FetchResourcePoolClassifiers(kikimr), "{\"resource_pool_classifiers\":[{\"rank\":20,\"name\":\"MyResourcePoolClassifier\","
    ...
    Y_UNIT_TEST(AlterResourcePoolClassifier) {
        ...
        // Test reset
        {
            ...
            UNIT_ASSERT_VALUES_EQUAL_C(result.GetStatus(), EStatus::SUCCESS, result.GetIssues().ToString());
            UNIT_ASSERT_VALUES_EQUAL(
                FetchResourcePoolClassifiers(kikimr), "{\"resource_pool_classifiers\":[{\"rank\":1042,\"name\":\"MyResourcePoolClassifier\","
...
Y_UNIT_TEST_SUITE(KqpOlapScheme) {
    ...
    Y_UNIT_TEST(InvalidColumnInTieringRule) {
        ...
        TTestHelper::TColumnTable testTable;
        testTable.SetName(tableName).SetPrimaryKey({ "id", "id_second" }).SetSharding({ "id" }).SetSchema(schema).SetTTL("created_at",
            "Interval(\"PT1H\")");
        testHelper.CreateTable(testTable);
...
*/
    ...
    Y_UNIT_TEST(AddPgColumnWithStore) {
        ...
        {
            schema.push_back(TTestHelper::TColumnSchema()
                                 .SetName("new_column")
                                 .SetType(NScheme::NTypeIds::Pg)
                                 .SetTypeDesc(NPg::TypeDescFromPgTypeName("pgfloat4")));
...
Y_UNIT_TEST_SUITE(KqpOlapTypes) {
    ...
    Y_UNIT_TEST(Decimal) {
...

        {
            ...
            builder.BeginList();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(1).AddMember("dec").Decimal(TString("10.1")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(2).AddMember("dec").Decimal(TString("inf")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(3).AddMember("dec").Decimal(TString("-inf")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(4).AddMember("dec").Decimal(TString("nan")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(5).AddMember("dec").Decimal(TString("-nan")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(6).AddMember("dec").Decimal(TString("1.1")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(7).AddMember("dec").Decimal(TString("12.1")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(8).AddMember("dec").Decimal(TString("inf")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(9).AddMember("dec").Decimal(TString("-inf")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(10).AddMember("dec").Decimal(TString("2.1")).EndStruct();
            builder.AddListItem().BeginStruct().AddMember("id").Int64(11).AddMember("dec").Decimal(TString("15.1")).EndStruct();
            builder.EndList();
