            ...
            bool ExecuteSoleCommand(const NKikimrBlobStorage::TConfigRequest::TCommand& cmd, TTransactionContext& txc) {
                ...
                switch (cmd.GetCommandCase()) {
                    ...
                    case NKikimrBlobStorage::TConfigRequest::TCommand::kUpdateSettings: {
                        ...
                        for (bool value : settings.GetAllowSlotAllocationOnNonActive()) {
                            Self->AllowSlotAllocationOnNonActive = value;
                            db.Table<T>().Key(true).Update<T::AllowSlotAllocationOnNonActive>(Self->AllowSlotAllocationOnNonActive);
                        }
                        return true;
                    }
