...
struct Schema : NIceDb::Schema {
    ...
    struct State : Table<1> {
        ...
        struct IsOngoingCommit : Column<26, NScheme::NTypeIds::Bool> { static constexpr Type Default = false; };
        ...
        using TColumns = TableColumns<FixedKey, NextGroupID, SchemaVersion, NextOperationLogIndex, DefaultMaxSlots,
              ...
              UseSelfHealLocalPolicy, TryToRelocateBrokenDisksLocallyFirst, YamlConfig, ConfigVersion, IsOngoingCommit>;
    };
