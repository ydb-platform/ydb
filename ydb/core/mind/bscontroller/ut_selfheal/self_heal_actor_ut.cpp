...
TIntrusivePtr<TBlobStorageGroupInfo> CreateGroup(TBlobStorageGroupType::EErasureSpecies erasure =
        ...
        TGroupId groupId = TGroupId::FromValue(0x82000000)) {
...
>>>>>>> d4ac973f208 (Refactor reassign VDisk selection logic in SelfHeal actor (#49761))
...
=======
    Y_UNIT_TEST(StaticGroupUsesPlacementPolicyFromPreviousSettingsUpdate) {
        RunTestCase([&](const TActorId& selfHealId, const TActorId& parentId, TTestActorSystem& runtime) {
            ...
            auto info = CreateGroup(TBlobStorageGroupType::Erasure4Plus2Block, TGroupId::Zero());
            RegisterDiskResponders(runtime, info);
