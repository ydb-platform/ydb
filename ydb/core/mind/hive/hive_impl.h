...
protected:
    ...
    ITransaction* CreateDeleteTablet(NEvHive::TEvDeleteTablet::TPtr& ev);
    ITransaction* CreateDeleteOwnerTablets(NEvHive::TEvDeleteOwnerTablets::TPtr& ev);
    ITransaction* CreateDeleteTabletResult(TEvTabletBase::TEvDeleteTabletResult::TPtr& ev);
    ITransaction* CreateCutTabletHistory(NEvHive::TEvCutTabletHistory::TPtr& ev);
    ...
    ITransaction* CreateUpdateTabletMetrics(NEvHive::TEvTabletMetrics::TPtr& ev);
    ...
    ITransaction* CreateRequestTabletSequence(NEvHive::TEvRequestTabletIdSequence::TPtr event);
    ITransaction* CreateResponseTabletSequence(NEvHive::TEvResponseTabletIdSequence::TPtr event);
    ...
    ITransaction* CreateSeizeTablets(NEvHive::TEvSeizeTablets::TPtr event);
    ITransaction* CreateSeizeTabletsReply(NEvHive::TEvSeizeTabletsReply::TPtr event);
    ITransaction* CreateReleaseTablets(NEvHive::TEvReleaseTablets::TPtr event);
    ITransaction* CreateReleaseTabletsReply(NEvHive::TEvReleaseTabletsReply::TPtr event);
    ITransaction* CreateConfigureSubdomain(NEvHive::TEvConfigureHive::TPtr event);
    ...
    ITransaction* CreateTabletOwnersReply(NEvHive::TEvTabletOwnersReply::TPtr event);
    ITransaction* CreateRequestTabletOwners(NEvHive::TEvRequestTabletOwners::TPtr event);
    ITransaction* CreateUpdateTabletsObject(NEvHive::TEvUpdateTabletsObject::TPtr event);
    ITransaction* CreateUpdateDomain(TSubDomainKey subdomainKey, NEvHive::TEvUpdateDomain::TPtr event = {});
...
protected:
    ...
    void Handle(NEvHive::TEvCreateTablet::TPtr&);
    void Handle(NEvHive::TEvAdoptTablet::TPtr&);
    void Handle(NEvHive::TEvStopTablet::TPtr&);
    void Handle(NEvHive::TEvBootTablet::TPtr&);
    ...
    void Handle(NEvHive::TEvTabletMetrics::TPtr&);
    void Handle(NEvHive::TEvReassignTablet::TPtr&);
    void Handle(NEvHive::TEvInitiateBlockStorage::TPtr&);
    ...
    void Handle(NEvHive::TEvDeleteTablet::TPtr&);
    void Handle(NEvHive::TEvDeleteOwnerTablets::TPtr&);
    void Handle(NEvHive::TEvRequestHiveInfo::TPtr&);
    void Handle(NEvHive::TEvLookupTablet::TPtr&);
    void Handle(NEvHive::TEvLookupChannelInfo::TPtr&);
    void Handle(NEvHive::TEvCutTabletHistory::TPtr&);
    void Handle(NEvHive::TEvDrainNode::TPtr&);
    void Handle(NEvHive::TEvFillNode::TPtr&);
    void Handle(NEvHive::TEvInitiateDeleteStorage::TPtr&);
    void Handle(NEvHive::TEvGetTabletStorageInfo::TPtr&);
    void Handle(NEvHive::TEvLockTabletExecution::TPtr&);
    void Handle(NEvHive::TEvUnlockTabletExecution::TPtr&);
    void Handle(NEvHive::TEvInitiateTabletExternalBoot::TPtr&);
    void Handle(NEvHive::TEvRequestHiveDomainStats::TPtr&);
    void Handle(NEvHive::TEvRequestHiveNodeStats::TPtr&);
    void Handle(NEvHive::TEvRequestHiveStorageStats::TPtr&);
    void Handle(NEvHive::TEvInvalidateStoragePools::TPtr&);
    void Handle(NEvHive::TEvReassignOnDecommitGroup::TPtr&);
    void Handle(NEvHive::TEvRequestTabletIdSequence::TPtr&);
    void Handle(NEvHive::TEvResponseTabletIdSequence::TPtr&);
    void Handle(NEvHive::TEvSeizeTablets::TPtr&);
    void Handle(NEvHive::TEvSeizeTabletsReply::TPtr&);
    void Handle(NEvHive::TEvReleaseTablets::TPtr&);
    void Handle(NEvHive::TEvReleaseTabletsReply::TPtr&);
    void Handle(NEvSubDomain::TEvConfigure::TPtr&);
    void Handle(NEvHive::TEvConfigureHive::TPtr& ev);
    void Handle(NEvHive::TEvInitMigration::TPtr&);
    void Handle(NEvHive::TEvQueryMigration::TPtr&);
    ...
    void Handle(NEvHive::TEvRequestTabletOwners::TPtr& ev);
    void Handle(NEvHive::TEvTabletOwnersReply::TPtr& ev);
    void Handle(NEvHive::TEvUpdateTabletsObject::TPtr& ev);
    ...
    void Handle(NEvHive::TEvUpdateDomain::TPtr& ev);
    void Handle(TEvPrivate::TEvDeleteNode::TPtr& ev);
    void Handle(NEvHive::TEvRequestTabletDistribution::TPtr& ev);
    void Handle(TEvPrivate::TEvUpdateDataCenterFollowers::TPtr& ev);
    void Handle(NEvHive::TEvRequestScaleRecommendation::TPtr& ev);
