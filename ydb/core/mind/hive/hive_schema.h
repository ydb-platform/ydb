...
struct Schema : NIceDb::Schema {
    ...
    struct Node : Table<4> {
        ...
        struct SlotName : Column<10, NScheme::NTypeIds::String> {};

        using TKey = TableKey<ID>;
        using TColumns = TableColumns<ID, Local, Down, Freeze, ServicedDomains, Statistics, Drain, DrainInitiators, Location, SlotName>;
    };
