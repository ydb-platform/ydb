...
{
    static void VerifyDiskIdToPathDeprecated(
        const TString& diskId,
        const TString& path)
    {
        UNIT_ASSERT_VALUES_EQUAL_C(
            DiskIdToPathDeprecated(diskId),
            path,
    ...
    static void VerifyPathNameToDiskId(
        const TString& pathName,
        const TString& diskId)
    {
        UNIT_ASSERT_VALUES_EQUAL_C(
            PathNameToDiskId(pathName),
            diskId,
