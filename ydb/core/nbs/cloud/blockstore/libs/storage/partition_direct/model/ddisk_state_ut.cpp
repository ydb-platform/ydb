...
Y_UNIT_TEST_SUITE(TDDiskStateListTest)
{
    ...
    Y_UNIT_TEST(FilterReadable)
    {
        ...
        UNIT_ASSERT(lowMask.Get(0));
        UNIT_ASSERT(lowMask.Get(1));
        UNIT_ASSERT(lowMask.Get(2));
        ...
        UNIT_ASSERT(midMask.Get(0));
        UNIT_ASSERT(!midMask.Get(1));
        UNIT_ASSERT(midMask.Get(2));
        ...
        UNIT_ASSERT(highMask.Get(0));
        UNIT_ASSERT(!highMask.Get(1));
        UNIT_ASSERT(!highMask.Get(2));
    }
