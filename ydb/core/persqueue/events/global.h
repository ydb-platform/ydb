...
namespace NEvPersQueue {
    ...
    using TEvProposeTransactionAttach = NEvDataShard::TEvProposeTransactionAttach;
    using TEvProposeTransactionAttachResult = NEvDataShard::TEvProposeTransactionAttachResult;
