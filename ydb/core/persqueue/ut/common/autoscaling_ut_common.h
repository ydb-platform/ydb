...
struct TTestReadSession {
    ...
    TTestReadSession(const TString& name, TTopicClient& client, size_t expectedMessagesCount = Max<size_t>(), bool autoCommit = true, std::set<ui32> partitions = {}, bool autoPartitioningSupport = true, TMaybe<TDuration> readLag = {});
