...
/** Alter topic через `CreateAlterTopicOperationActor` с кастомным `IAlterTopicStrategy` (лимит сообщений/сек на партицию, см. pqconfig WriteSpeedInRequestsPerSecond). */
