...
Y_UNIT_TEST_SUITE(TPartitionScaleManagerGraphCmpTest) {
    ...
    std::vector<TPartitionInfo> MultiplRootPartitions(ui32 size) {
        Y_ASSERT(size >= 1);
    ...
    Y_UNIT_TEST(Equal) {
        auto c = ComparePartitionGraphs(MultiplePartitionGraph(5), MultiplRootPartitions(5));
        UNIT_ASSERT(!c.RootPartitionsMismatch);
    }


    Y_UNIT_TEST(ExtraRootPartitionsInTargetTopic) {
        auto c = ComparePartitionGraphs(MultiplePartitionGraph(10), MultiplRootPartitions(5));
        UNIT_ASSERT_C(!c.RootPartitionsMismatch, c.RootPartitionsMismatch->Error);
    }

    Y_UNIT_TEST(ExtraRootPartitionsInSourceTopic) {
        auto c = ComparePartitionGraphs(MultiplePartitionGraph(5), MultiplRootPartitions(10));
        UNIT_ASSERT(c.RootPartitionsMismatch);
    ...
    Y_UNIT_TEST(SplittedTargetTopic) {
        auto c6 = ComparePartitionGraphs(SplittedGraph(6), MultiplRootPartitions(8));
        ...
        auto c9 = ComparePartitionGraphs(SplittedGraph(9), MultiplRootPartitions(8));
