...
{
    DBGTRACE("TPartitionFixture::TestWriteSubDomainOutOfSpace");
...
//    auto ownerCookie = ownerEvent->Response->GetPartitionResponse().GetCmdGetOwnershipResult().GetOwnerCookie();
    ...
    {
        DBGTRACE("wait for TEvPQ::TEvError");
