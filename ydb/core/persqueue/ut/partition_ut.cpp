...
public:
    ...
    ui64 AddTx() {
        return txHelper.MakeAndSendWriteTx({SrcId, {seqNo, seqNo++}}, seqNo++);
    }
    ui64 AddImmediateTx() {
        return txHelper.MakeAndSendImmediateTx({SrcId, {seqNo, seqNo++}}, seqNo++);
    }
    ui64 AddNormalWrite() {
        txHelper.AddAndSendNormalWrite(SrcId, SeqNo, SeqNo++, Owner, MessageNo++);
    }
};
