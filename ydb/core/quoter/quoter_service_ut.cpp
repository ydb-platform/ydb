...
#define OPTIMIZED // release builds and relwithdebinfo builds
    ...
    Y_UNIT_TEST(CancelsHangingResourceResolve) {
        ...
        runtime->Send(new IEventHandle(MakeQuoterServiceID(), sender,
            new TEvQuota::TEvRequest(TEvQuota::EResourceOperator::And,
                {TEvQuota::TResourceLeaf(quoter, "Res", 1)}, TDuration::Max()), 0, 1));
        {
            auto event = runtime->GrabEdgeEventIf<TEvQuota::TEvClearance>(
        ...
        runtime->Send(new IEventHandle(MakeQuoterServiceID(), sender,
            new TEvQuota::TEvRequest(TEvQuota::EResourceOperator::And,
                {TEvQuota::TResourceLeaf(quoter, "Res2", 1)}, TDuration::Max()), 0, 2));
        ...
        runtime->Send(new IEventHandle(MakeQuoterServiceID(), sender,
            new TEvQuota::TEvRequest(TEvQuota::EResourceOperator::And,
                {TEvQuota::TResourceLeaf(quoter, "Res", 1)}, TDuration::Max()), 0, 3));
        {
            auto event = runtime->GrabEdgeEventIf<TEvQuota::TEvClearance>(
        ...
        runtime->Send(new IEventHandle(MakeQuoterServiceID(), sender,
            new TEvQuota::TEvRequest(TEvQuota::EResourceOperator::And,
                {TEvQuota::TResourceLeaf(quoter, "Res2", 1)}, TDuration::Max()), 0, 4));
        {
            auto event = runtime->GrabEdgeEventIf<TEvQuota::TEvClearance>(
