...
const TString TEST_CERT_DER_HEX =
...
Y_UNIT_TEST_SUITE(TX509CertificateReaderTest) {
    ...
    Y_UNIT_TEST(ReadCertAsPEM_ValidCert) {
        auto x509 = X509CertificateReader::ReadCertAsPEM(TEST_CERT_PEM);
    ...
    Y_UNIT_TEST(ReadCertAsDER_ValidCert) {
        TString derBinary = HexDecode(TEST_CERT_DER_HEX);
    ...
    Y_UNIT_TEST(PEMAndDERProduceSameSubjectTerms) {
        auto pemX509 = X509CertificateReader::ReadCertAsPEM(TEST_CERT_PEM);
