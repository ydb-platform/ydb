...
Y_UNIT_TEST_SUITE(TNetUtilTest) {
    ...
    Y_UNIT_TEST(TestParsePeername) {
        {
            auto res = ParsePeername("127.0.0.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("192.168.1.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("255.255.255.255");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("255.255.255.255", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("0.0.0.0");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("0.0.0.0", NAddr::PrintHost(*res));
        }

        {
            auto res = ParsePeername("127.0.0.1:8080");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1:8080", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("192.168.1.1:0");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1:0", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("192.168.1.1:1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1:1", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("10.0.0.1:65535");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("10.0.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("10.0.0.1:65535", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("172.16.0.1:22");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("172.16.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("172.16.0.1:22", NAddr::PrintHostAndPort(*res));
        }

        {
            auto res = ParsePeername("ipv4:127.0.0.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv4:192.168.1.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv4:10.0.0.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("10.0.0.1", NAddr::PrintHost(*res));
        }

        {
            auto res = ParsePeername("ipv4:127.0.0.1:8080");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("127.0.0.1:8080", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv4:192.168.1.1:0");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1:0", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv4:192.168.1.1:3000");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("192.168.1.1:3000", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv4:10.0.0.1:22");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("10.0.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("10.0.0.1:22", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv4:172.16.0.1:65535");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("172.16.0.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("172.16.0.1:65535", NAddr::PrintHostAndPort(*res));
        }

        {
            auto res = ParsePeername("2001:2db8:85a3:7843:dbaf:8a2e:4370:7334");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:2db8:85a3:7843:dbaf:8a2e:4370:7334", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("2001:db8::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("fe89::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("fe89::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("::");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("::ffff:192.0.2.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::ffff:192.0.2.1", NAddr::PrintHost(*res));
        }
        ...
        {
            auto res = ParsePeername("[2001:2db8:85a3:7843:dbaf:8a2e:4370:7334]:1234");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:2db8:85a3:7843:dbaf:8a2e:4370:7334", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:2db8:85a3:7843:dbaf:8a2e:4370:7334]:1234", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("[::1]:8080");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::1]:8080", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("[2001:db8::1]:0");;
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:db8::1]:0", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("[2001:db8::1]:3000");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:db8::1]:3000", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("[fe80::1]:22");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("fe80::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[fe80::1]:22", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("[::]:65535");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::]:65535", NAddr::PrintHostAndPort(*res));

        }
        {
            auto res = ParsePeername("[::ffff:192.0.2.1]:80");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::ffff:192.0.2.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::ffff:192.0.2.1]:80", NAddr::PrintHostAndPort(*res));
        }

        {
            auto res = ParsePeername("ipv6:::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv6:2001:2db8:85a3:7843:dbaf:8a2e:4370:7334");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:2db8:85a3:7843:dbaf:8a2e:4370:7334", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv6:2001:db8::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv6:fe80::1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("fe80::1", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv6:::");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::", NAddr::PrintHost(*res));
        }
        {
            auto res = ParsePeername("ipv6:::ffff:192.0.2.1");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::ffff:192.0.2.1", NAddr::PrintHost(*res));
        }
        ...
        {
            auto res = ParsePeername("ipv6:[::1]:8080");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::1]:8080", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[2001:2db8:85a3:7843:dbaf:8a2e:4370:7334]:1234");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:2db8:85a3:7843:dbaf:8a2e:4370:7334", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:2db8:85a3:7843:dbaf:8a2e:4370:7334]:1234", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[2001:db8::1]:0");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:db8::1]:0", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[2001:db8::1]:3000");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("2001:db8::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[2001:db8::1]:3000", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[fe80::1]:22");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("fe80::1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[fe80::1]:22", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[::]:65535");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::]:65535", NAddr::PrintHostAndPort(*res));
        }
        {
            auto res = ParsePeername("ipv6:[::ffff:192.0.2.1]:80");
            UNIT_ASSERT(res);
            UNIT_ASSERT_STRINGS_EQUAL("::ffff:192.0.2.1", NAddr::PrintHost(*res));
            UNIT_ASSERT_STRINGS_EQUAL("[::ffff:192.0.2.1]:80", NAddr::PrintHostAndPort(*res));
        }
