        ...
        switch (tabletType) {
            case TTabletTypes::DataShard:
                return MakeIntrusive<TYdbMetricsAggregatorImpl<
                    ...
                    NDataShard::EPercentileDetailedCounters_descriptor>>(targetCounterGroup, cumulativeHistoryPolicy);
