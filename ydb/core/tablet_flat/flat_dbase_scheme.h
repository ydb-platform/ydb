...
public:
    ...
    TAlter& AddColumn(ui32 table, const TString& name, ui32 id, ui32 type, bool notNull, bool isSensitive, bool setNotNullInProgress = false, TCell null = { });
    TAlter& AddColumnWithTypeInfo(ui32 table, const TString& name, ui32 id, ui32 type,
            const std::optional<NKikimrProto::TTypeInfo>& typeInfoProto, bool notNull, bool isSensitive, bool setNotNullInProgress = false, TCell null = { });
