...
namespace NTabletFlatExecutor {
    ...
    struct TSeat {
        ...
        void StartEnqueuedSpan() noexcept {
            WaitingSpan = NWilson::TSpan(TWilsonTablet::TabletInternals, Self->TxSpan.GetTraceId(), "Tablet.Transaction.Enqueued");
        }
        ...
        void CreatePendingSpan() noexcept {
            WaitingSpan = NWilson::TSpan(TWilsonTablet::TabletInternals, Self->TxSpan.GetTraceId(), "Tablet.Transaction.Pending");
        }
