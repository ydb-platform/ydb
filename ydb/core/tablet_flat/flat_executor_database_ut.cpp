...
private:
    ...
    void CreateSchema(TDbWrapper& db) {
        ...
        delta.AddColumn(TxTable, "TxId", 1, NScheme::TUint64::TypeId, false, false, false);
        delta.AddColumn(TxTable, "Plan", 2, NScheme::TUint64::TypeId, false, false, false);
        delta.AddColumnToKey(TxTable, 1);

        delta.AddTable("AffectedTable", AffectedTable);
        delta.AddColumn(AffectedTable, "TxId", 1, NScheme::TUint64::TypeId, false, false, false);
        delta.AddColumn(AffectedTable, "Datashard", 2, NScheme::TUint64::TypeId, false, false, false);
        delta.AddColumn(AffectedTable, "Plan", 3, NScheme::TUint64::TypeId, false, false, false);
...
private:
    ...
    void CreateSchema(TDbWrapper& db)
    {
        ...
        delta.AddColumn(Table, "Id", 1, NScheme::TUint32::TypeId, false, false, false);
        delta.AddColumn(Table, "value", 2, NScheme::TUint64::TypeId, false, false, false);
        delta.AddColumn(Table, "large", 3, NScheme::TString::TypeId, false, false, false);
