...
namespace NPage {
    ...
    public:
        ...
        static TPageOffset FromByteOffset(ui64 value) noexcept {
            Y_VERIFY_DEBUG(value < ByteOffsetTag,
    ...
    struct TPageLocation {
        ...
        auto operator<=>(const TPageLocation& rhs) const noexcept {
            ...
            Y_VERIFY(Offset != rhs.Offset || Size == rhs.Size,
                "TPageLocation at same offset but sizes differ (%" PRIu64 " vs %" PRIu64 ")", Size, rhs.Size);
