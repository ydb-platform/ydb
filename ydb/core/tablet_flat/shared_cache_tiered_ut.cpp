...
Y_UNIT_TEST_SUITE(TieredCache) {
    ...
    Y_UNIT_TEST(Touch) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(cache.Dump(), "Tier 0: {1 2b}, {2 3b}; Tier 1: ");
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val() + counters.ActiveBytesTier(1)->Val(), cache.GetSize());
        ...
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page2, 1), TVector<ui32>{});
        ...
        TPage page6{6, 3};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page6, 1), (TVector<ui32>{4}));
    ...
    Y_UNIT_TEST(MoveTouch) {
        ...
        TPage page1{1, 2};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page1, 0), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(cache.Dump(), "Tier 0: {1 2b}; Tier 1: ");
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val() + counters.ActiveBytesTier(1)->Val(), cache.GetSize());
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val(), 2);
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(1)->Val(), 0);
        ...
        TPage page3{3, 3};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page3, 0), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(cache.Dump(), "Tier 0: {1 2b}, {3 3b}; Tier 1: {2 3b}");
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val() + counters.ActiveBytesTier(1)->Val(), cache.GetSize());
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val(), 5);
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(1)->Val(), 3);
        ...
        TPage page4{4, 4};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page4, 0), (TVector<ui32>{1}));
        UNIT_ASSERT_VALUES_EQUAL(cache.Dump(), "Tier 0: {3 3b}, {4 4b}; Tier 1: {2 3b}");
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val() + counters.ActiveBytesTier(1)->Val(), cache.GetSize());
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val(), 7);
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(1)->Val(), 3);
        ...
        TPage page5{5, 2};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page5, 0), (TVector<ui32>{3}));
        UNIT_ASSERT_VALUES_EQUAL(cache.Dump(), "Tier 0: {4 4b}, {5 2b}; Tier 1: {2 3b}");
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val() + counters.ActiveBytesTier(1)->Val(), cache.GetSize());
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(0)->Val(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.ActiveBytesTier(1)->Val(), 3);
    ...
    Y_UNIT_TEST(Touch3Tiers) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page1, 0), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page2, 1), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page3, 2), TVector<ui32>{});
        ...
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 5);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 2);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(2)->Val(), 3);
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 0);
        UNIT_ASSERT_VALUES_EQUAL(caches[2]->GetLimit(), 3);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 7);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(2)->Val(), 3);
        ...
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(2)->Val(), 4);
    }
    ...
    Y_UNIT_TEST(TryMove) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page2, 1), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page3, 0), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page4, 1), TVector<ui32>{});
    ...
    Y_UNIT_TEST(UpdateLimit) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 4);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 6);
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 9);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 6);

        TPage page5{5, 5};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page5, 0), TVector<ui32>{});
        ...
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 11);
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 11);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 2);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 11);

        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page1, 0), TVector<ui32>{3});
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 0);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 6);

        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page1, 0), (TVector<ui32>{1}));
        ...
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page5, 1), (TVector<ui32>{2, 4}));
    ...
    Y_UNIT_TEST(DesiredSize) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 0);

        cache.AddDesiredSize(1, 10);
        UNIT_ASSERT_VALUES_EQUAL(cache.GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 10);
        ...
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 10);

        cache.SubDesiredSize(1, 4);
        UNIT_ASSERT_VALUES_EQUAL(cache.GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 0);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 10);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 6);
        ...
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 6);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 3);

        cache.UpdateLimit(7);
        UNIT_ASSERT_VALUES_EQUAL(cache.GetLimit(), 7);
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 4);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 3);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 3);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 3);

        TPage page1{1, 4};
        UNIT_ASSERT_VALUES_EQUAL(MoveTouch(cache, page1, 1), TVector<ui32>{});
        UNIT_ASSERT_VALUES_EQUAL(cache.GetLimit(), 7);
        UNIT_ASSERT_VALUES_EQUAL(caches[0]->GetLimit(), 3);
        UNIT_ASSERT_VALUES_EQUAL(caches[1]->GetLimit(), 4);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(0)->Val(), 3);
        UNIT_ASSERT_VALUES_EQUAL(counters.LimitBytesTier(1)->Val(), 4);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(0)->Val(), 0);
        UNIT_ASSERT_VALUES_EQUAL(counters.DesiredSizeTier(1)->Val(), 3);
