...
struct TTxInitAllTypesSchema : public ITransaction {
    ...
    bool Execute(TTransactionContext &txc, const TActorContext &) override {
        ...
        txc.DB.Alter()
            .AddColumn(T::TableId, "FloatCol", T::FloatColId, NScheme::NTypeIds::Float, false, false, false)
            .AddColumn(T::TableId, "Int8Col", T::Int8ColId, NScheme::NTypeIds::Int8, false, false, false)
            .AddColumn(T::TableId, "Int16Col", T::Int16ColId, NScheme::NTypeIds::Int16, false, false, false)
            .AddColumn(T::TableId, "Uint16Col", T::Uint16ColId, NScheme::NTypeIds::Uint16, false, false, false)
            .AddColumn(T::TableId, "JsonCol", T::JsonColId, NScheme::NTypeIds::Json, false, false, false);
