...
Y_UNIT_TEST_SUITE(DBase) {
    ...
    TAlter MakeAlter(const ui32 table = 1)
    {
        ...
        alter
            ...
            .AddColumn(table, "key",    1, ETypes::String, false, false, false)
            .AddColumn(table, "arg1",   4, ETypes::Uint64, false, false, false, Cimple(77_u64))
            .AddColumn(table, "arg2",   5, ETypes::String, false, false, false)
    ...
    Y_UNIT_TEST(Defaults)
    {
        ...
        me.To(12).Begin().Apply(
            *TAlter()
                .AddColumn(1, "sub", 2, ETypes::Uint32, false, false, false, Cimple(77_u32))
                .AddColumn(1, "en0", 6, ETypes::String, false, false, false, TCell("", 0))
                .AddColumn(1, "en1", 7, ETypes::String, false, false, false, TCell(large30))
                .AddColumn(1, "en2", 8, ETypes::String, false, false, false, TCell(large35))
                .DropColumn(1, 5)
                .AddColumnToKey(1, 2));
    ...
    Y_UNIT_TEST(Garbage)
    {
        ...
        { /*_ Ressurect column, ** hack allowed only in this UT ** */
            auto raw = TAlter().AddColumn(1, "new", 4, ETypes::Uint64, false, false, false).Flush();
    ...
    Y_UNIT_TEST(WideKey)
    {
        ...
        for (auto keys: { 128, 512, 1024, 4096, 8192, 9999 }) {
            ...
            for (auto sub : xrange(keys)) {
                ...
                alter.AddColumn(1, name, 6 + sub, ETypes::Uint32, false, false, false);
    ...
    void RunVersionChecks(bool compactMemTables, bool compactFinal) {
        ...
        me.To(10)
            ...
            .Apply(*TAlter()
                .AddTable("me_1", table)
                .AddColumn(table, "key",    1, ETypes::Uint64, false, false, false)
                .AddColumn(table, "arg1",   4, ETypes::Uint64, false, false, false, Cimple(10004_u64))
                .AddColumn(table, "arg2",   5, ETypes::Uint64, false, false, false, Cimple(10005_u64))
                .AddColumnToKey(table, 1))
            .Commit();
    ...
    Y_UNIT_TEST(KIKIMR_15506_MissingSnapshotKeys) {
        ...
        me.To(10)
            ...
            .Apply(*TAlter()
                .AddTable("me_1", table)
                .AddColumn(table, "key", 1, ETypes::Uint64, false, false, false)
                .AddColumn(table, "val", 2, ETypes::Uint64, false, false, false, Cimple(0_u64))
                .AddColumnToKey(table, 1)
    ...
    Y_UNIT_TEST(AlterAndUpsertChangesVisibility) {
        ...
        me.To(30).Apply(*TAlter()
                ...
                .AddColumn(table2, "key",    1, ETypes::Uint64, false, false, false)
                .AddColumn(table2, "arg1",   4, ETypes::Uint64, false, false, false, Cimple(20004_u64))
                .AddColumn(table2, "arg2",   5, ETypes::Uint64, false, false, false, Cimple(20005_u64))
        ...
        me.To(41).Apply(*TAlter()
                .DropColumn(table2, 5)
                .AddColumn(table2, "arg3", 6, ETypes::Uint64, false, false, false, Cimple(20006_u64)));
    ...
    Y_UNIT_TEST(DropModifiedTable) {
        ...
        me.To(32).Apply(*TAlter()
                .AddColumn(table1, "arg3",  6, ETypes::Uint64, false, false, false, Cimple(10006_u64)));
