...
namespace {
    ...
    struct TModel {
        ...
        TAlter Build() const
        {
            ...
            bld.AddColumn(TableId, "key", ColId1, NScheme::TSmallBoundedString::TypeId, false, false, false);
            bld.AddColumn(TableId, "value", ColId2, NScheme::TUint32::TypeId, false, false, false);
