...
Y_UNIT_TEST_SUITE(TFlatDatabaseDecimal) {
    ...
    Y_UNIT_TEST(UpdateRead) {
        ...
        db->Alter()
            ...
            .AddColumnWithTypeInfo(tableId, "KeyDecimal229", IdKeyDecimal229, NScheme::NTypeIds::Decimal, makeDecimalTypeInfoProto(22,9), false, false, false)
            .AddColumnWithTypeInfo(tableId, "KeyDecimal356", IdKeyDecimal356, NScheme::NTypeIds::Decimal, makeDecimalTypeInfoProto(35,6), false, false, false)
            .AddColumn(tableId, "KeyInt", IdKeyInt, NScheme::NTypeIds::Int32, false, false, false)
            .AddColumnWithTypeInfo(tableId, "ValueDecimal229", IdValueDecimal229, NScheme::NTypeIds::Decimal, makeDecimalTypeInfoProto(22,9), false, false, false)
            .AddColumnWithTypeInfo(tableId, "ValueDecimal356", IdValueDecimal356, NScheme::NTypeIds::Decimal, makeDecimalTypeInfoProto(35,6), false, false, false)
            .AddColumn(tableId, "ValueInt", IdValueInt, NScheme::NTypeIds::Int32, false, false, false)
