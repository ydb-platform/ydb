        ...
        for (const auto& tableId : TableIds) {
            ...
            if (AddColumnsInFamily) {
                txc.DB.Alter()
                    ...
                    .AddColumn(tableId, "value_family_2", ValueFamily2ColumnId, NScheme::TString::TypeId, false, false, false)
                ...
                txc.DB.Alter()
                    ...
                    .AddColumn(tableId, "value_family_3", ValueFamily3ColumnId, NScheme::TString::TypeId, false, false, false)
