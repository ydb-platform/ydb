        ...
        for (const auto& tableId : TableIds) {
            ...
            if (AddColumnsInFamily) {
                txc.DB.Alter()
                    ...
                    .SetFamily(tableId, FamilyId2, NTable::NPage::ECache::None, NTable::NPage::ECodec::Plain, NTable::NPage::ECacheMode::Regular)
                ...
                txc.DB.Alter()
                    ...
                    .SetFamily(tableId, FamilyId3, NTable::NPage::ECache::None, NTable::NPage::ECodec::Plain, NTable::NPage::ECacheMode::Regular)
