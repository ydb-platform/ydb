...
namespace Tests {
    ...
    void TServer::SetupProxies(ui32 nodeIdx) {
        ...
        }
        {
            ...
            IActor* scriptFinalizeService = NKqp::CreateKqpFinalizeScriptService(Settings->AppConfig->GetQueryServiceConfig().GetFinalizeScriptServiceConfig(), Settings->AppConfig->GetMetadataProviderConfig(), Settings->AppConfig->GetFederatedQueryConfig().GetCommon(), federatedQuerySetupFactory);
