...
#define MERGE_CFG_FROM_SETTINGS(cfg) MERGE_APP_CFG_FROM(cfg, Settings->cfg)
            ...
            //MERGE_CFG_FROM_APP_CFG(QueryServiceConfig); // commented when porting from main
            //MERGE_CFG_FROM_APP_CFG(BridgeConfig); // commented when porting from main
            //MERGE_CFG_FROM_SETTINGS(BridgeConfig); // commented when porting from main
            //MERGE_CFG_FROM_APP_CFG(StatisticsConfig); // commented when porting from main
            //MERGE_CFG_FROM_APP_CFG(SystemTabletBackupConfig); // commented when porting from main
