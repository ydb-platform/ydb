...
namespace Tests {
    ...
    struct TServerSettings: public TThrRefBase, public TTestFeatureFlagsHolder<TServerSettings> {
        ...
        mutable std::optional<std::reference_wrapper<std::vector<std::string>>> AuditLogBackendLines;
        ...
        TServerSettings& SetAuditLogBackendLines(std::vector<std::string>& value) { AuditLogBackendLines = value; return *this; }
