...
static_assert(
    EvEnd < EventSpaceEnd(TKikimrEvents::ES_TX_COLUMNSHARD),
...
struct TEvProposeTransaction
    : public TEventPB<TEvProposeTransaction, NKikimrTxColumnShard::TEvProposeTransaction, EvProposeTransaction> {
...
struct TEvProposeTransactionResult
    : public TEventPB<
...
struct TEvNotifyTxCompletion
    : public TEventPB<TEvNotifyTxCompletion, NKikimrTxColumnShard::TEvNotifyTxCompletion, EvNotifyTxCompletion> {
...
struct TEvWriteResult
    : public TEventPB<TEvWriteResult, NKikimrTxColumnShard::TEvWriteResult, TEvColumnShard::EvWriteResult> {
