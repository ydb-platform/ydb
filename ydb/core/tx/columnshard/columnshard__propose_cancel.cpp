...
public:
    TTxProposeCancel(TColumnShard* self, NEvColumnShard::TEvCancelTransactionProposal::TPtr& ev)
...
private:
    const NEvColumnShard::TEvCancelTransactionProposal::TPtr Ev;
};

void TColumnShard::Handle(NEvColumnShard::TEvCancelTransactionProposal::TPtr& ev, const TActorContext& ctx) {
