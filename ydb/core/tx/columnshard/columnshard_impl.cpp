...
TColumnShard::TColumnShard(TTabletStorageInfo* info, const TActorId& tablet)
    ...
    , BackgroundSessionsManager(std::make_shared<NOlap::NBackground::TSessionsManager>(std::make_shared<NBackground::TAdapter>(SelfId(), (NOlap::TTabletId)TabletID(), *this)))
