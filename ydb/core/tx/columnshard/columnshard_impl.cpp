...
void TColumnShard::StartIndexTask(std::vector<const NOlap::TCommittedData*>&& dataToIndex, const i64 bytesToIndex) {
    ...
    NOlap::NDataFetcher::TRequestInput rInput(
        indexChanges->GetPortionsInfo(), actualIndexInfo, NOlap::NBlobOperations::EConsumer::Indexation, i->GetTaskIdentifier());
...
>>>>>>> parent of f912d95db22 (remove insert table v1 (#19638))
namespace {
