...
IActor* CreatBackupActor(std::shared_ptr<NOlap::NBlobOperations::NTier::TOperator> insertOperator, TActorId senderActorId, TActorIdentity csActorId, ui64 TxId, int PlanStep, ui64 TableId, std::function<void(const NBlobCache::TUnifiedBlobId&)> cb);
