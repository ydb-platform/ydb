...
THistoryCutterCounters::THistoryCutterCounters(const TCommonCountersOwner& sameAs, const TString& componentName)
    ...
    , TriggeredNominations(TBase::GetDeriviative("Nominations/Triggered/Count"))
    ...
    , AuditComparableZero(TBase::GetDeriviative("Audit/Comparable/Zero/Count"))
    , AuditComparableNonzero(TBase::GetDeriviative("Audit/Comparable/Nonzero/Count"))
    , AuditAgreements(TBase::GetDeriviative("Audit/Agreements/Count"))
    , AuditChanged(TBase::GetDeriviative("Audit/Changed/Count"))
    , AuditUndercounts(TBase::GetDeriviative("Audit/Undercounts/Count"))
    , AuditOvercounts(TBase::GetDeriviative("Audit/Overcounts/Count"))
