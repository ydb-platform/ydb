...
TIndexationCounters::TIndexationCounters(const TString& module)
    ...
    HistogramCompactionInputBytes =
        TBase::GetHistogram("CompactionInput/Bytes", NMonitoring::ExponentialHistogram(18, 2, 1024));
    ...
    SplittedPortionLargestColumnSize =
        TBase::GetHistogram("SplittedPortionLargestColumnSize", NMonitoring::ExponentialHistogram(15, 2, 1024));
    SplittedPortionColumnSize =
        TBase::GetHistogram("SplittedPortionColumnSize", NMonitoring::ExponentialHistogram(15, 2, 1024));
