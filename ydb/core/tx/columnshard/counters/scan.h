...
private:
    ...
    std::shared_ptr<TAtomicCounter> AckWaitingCounter = std::make_shared<TAtomicCounter>();
...
public:
    ...
    TString DebugString() const {
        return TStringBuilder() << "FetchAccessorsCount:" << FetchAccessorsCount->Val() << ";"
                                ...
                                << "AckWaiting:" << AckWaitingCounter->Val() << ";"
    ...
    TCounterGuard GetAckWaitingGuard() const {
        return TCounterGuard(AckWaitingCounter);
    }
    ...
    bool InWaiting() const {
        return MergeTasksCount->Val() || AssembleTasksCount->Val() || ReadTasksCount->Val() || ResourcesAllocationTasksCount->Val() ||
               ...
               FilterFetchingGuard->Val() || AbortsGuard->Val() || AccessorsForConstructionGuard->Val() || AckWaitingCounter->Val();
    }
