...
void TCollector::DoSetCache(std::shared_ptr<TLRUCache<std::tuple<TActorId, TInternalPathId, ui64>, TPortionDataAccessor, TNoopDelete, TMetadataSizeProvider>> cache) {
