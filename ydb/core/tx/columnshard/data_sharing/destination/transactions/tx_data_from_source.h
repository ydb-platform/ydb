...
private:
    ...
    THashMap<TLocalPathId, NEvents::TPathIdData> PortionsByPathId;
...
public:
    TTxDataFromSource(NColumnShard::TColumnShard* self, const std::shared_ptr<TDestinationSession>& session, THashMap<NColumnShard::TLocalPathId, NEvents::TPathIdData>&& portionsByPathId, std::vector<NOlap::TSchemaPresetVersionInfo>&& schemas, const TTabletId sourceTabletId);
