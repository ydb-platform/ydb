...
private:
    static inline TFactory::TRegistrator<TTestInitiatorController> Registrator =
        TFactory::TRegistrator<TTestInitiatorController>(GetClassNameStatic());

protected:
    virtual TConclusionStatus
    DoDeserializeFromProto(const NKikimrColumnShardDataSharingProto::TInitiator::TController& /*proto*/) override {
        return TConclusionStatus::Success();
    }
    virtual void DoSerializeToProto(NKikimrColumnShardDataSharingProto::TInitiator::TController& /*proto*/)
        const override {}
