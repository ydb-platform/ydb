...
protected:
    virtual void DoStart(const NColumnShard::TColumnShard& shard, const THashMap<ui64, std::vector<TPortionDataAccessor>>& portions) override;
...
public:
    ...
    void StartCursor(const NColumnShard::TColumnShard& shard, THashMap<ui64, std::vector<std::shared_ptr<TPortionInfo>>> portions, std::vector<NKikimrTxColumnShard::TSchemaPresetVersionInfo> schemeHistory);
