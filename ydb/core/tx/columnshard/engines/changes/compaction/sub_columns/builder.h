...
private:
    using TSparsedBuilder = NArrow::NAccessor::TSparsedArray::TSparsedBuilder<arrow20::BinaryType>;
    using TPlainBuilder = NArrow::NAccessor::TTrivialArray::TPlainBuilder<arrow20::BinaryType>;
