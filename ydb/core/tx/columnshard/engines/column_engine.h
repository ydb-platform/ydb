...
public:
    ...
    virtual std::vector<std::shared_ptr<TTTLColumnEngineChanges>> StartTtl(const std::shared_ptr<NDataLocks::TManager>& dataLocksManager,
        const ui64 memoryUsageLimit) noexcept = 0;
