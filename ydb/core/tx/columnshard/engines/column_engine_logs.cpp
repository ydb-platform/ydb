...
bool TColumnEngineForLogs::LoadColumns(IDbWrapper& db) {
    ...
    {
        NColumnShard::TLoadTimeSignals::TLoadTimer timer = PortionsLoadingTimeCounters.StartGuard("portions_loading_time");
    ...
    {
        NColumnShard::TLoadTimeSignals::TLoadTimer timer = ColumnsLoadingTimeCounters.StartGuard("columns_loading_time");
    ...
    {
        NColumnShard::TLoadTimeSignals::TLoadTimeSignals::TLoadTimer timer = IndexesLoadingTimeCounters.StartGuard("indexes_loading_time");
