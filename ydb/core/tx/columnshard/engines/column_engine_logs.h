...
public:
    ...
    std::vector<TSelectedPortionInfo> Select(TInternalPathId pathId, TSnapshot snapshot,
        ...
        const bool withConflicting, const std::optional<THashSet<TInsertWriteId>>& withUncommittedOnlyForTheseWrites,
        const std::shared_ptr<NLWTrace::TOrbit>& orbit, ui64 txId = 0, ui64 scanId = 0) const override;
