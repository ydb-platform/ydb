...
public:
    ...
    std::vector<std::shared_ptr<TTTLColumnEngineChanges>> StartTtl(const std::shared_ptr<NDataLocks::TManager>& locksManager,
        const ui64 memoryUsageLimit) noexcept override;
