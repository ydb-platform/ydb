...
bool TPathInfo::EraseCommitted(const TCommittedData& data, TVersionCounters* versionCounters) {
...
bool TPathInfo::AddCommitted(TCommittedData&& data, TVersionCounters* versionCounters, const bool load) {
