...
void TColumnShardScan::HandleScan(TEvents::TEvWakeup::TPtr& /*ev*/) {
    ...
    if (TMonotonic::Now() >= GetDeadline()) {
        AFL_ERROR(NKikimrServices::TX_COLUMNSHARD)("fi", FinishInstant)("si", !!ScanIterator)("has_more", ChunksLimiter.HasMore())("in_waiting", ScanCountersPool.InWaiting())("counters_waiting", ScanCountersPool.DebugString())("scan_actor_id", ScanActorId)(
