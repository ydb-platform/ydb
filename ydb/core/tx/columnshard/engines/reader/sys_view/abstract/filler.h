...
private:
    ...
    virtual NAbstract::TGranuleMetaView DoBuildGranuleView(const TGranuleMeta& granule, const NColumnShard::TLocalPathId localPathId, const bool reverse, const TSnapshot& reqSnapshot) const {
        return NAbstract::TGranuleMetaView(granule, localPathId, reverse, reqSnapshot);
    }
public:
    ...
    NAbstract::TGranuleMetaView BuildGranuleView(const TGranuleMeta& granule, const NColumnShard::TLocalPathId localPathId, const bool reverse, const TSnapshot& reqSnapshot) const {
        return DoBuildGranuleView(granule, localPathId, reverse, reqSnapshot);
    }
