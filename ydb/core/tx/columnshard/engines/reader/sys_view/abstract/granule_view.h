...
public:
    TGranuleMetaView(const TGranuleMeta& granule, const TLocalPathId& localPathId, const bool reverse, const TSnapshot& reqSnapshot)
        : PathId(TUnifiedPathId{granule.GetPathId(), localPathId})
    {
