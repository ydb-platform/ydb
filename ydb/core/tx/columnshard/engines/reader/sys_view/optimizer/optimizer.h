...
protected:
    virtual NAbstract::TGranuleMetaView DoBuildGranuleView(const TGranuleMeta& granule, const TLocalPathId localPathId, const bool reverse, const TSnapshot& reqSnapshot) const override {
...
protected:
    virtual NAbstract::TGranuleMetaView DoBuildGranuleView(
        const TGranuleMeta& granule, const TLocalPathId localPathId, const bool reverse, const TSnapshot& reqSnapshot) const override {
        NAbstract::TGranuleMetaView result(granule, localPathId, reverse, reqSnapshot);
        result.FillOptimizerTasks(granule, reverse);
        return result;
    }
