...
#define YDB_CS_DATA_SOURCE(PROBE, EVENT, GROUPS, TYPES, NAMES) \
    ...
    PROBE(ProgramChainFinish, \
        GROUPS("DataSource"), \
        TYPES(ui64, ui64, ui64, ui64, ui32, TString, ui32, TDuration, TDuration, ui32, ui64), \
        NAMES("pathId", "tabletId", "txId", "sourceId", "stepIndex", "name", "programNodeId", "durationMs", "executionDurationMs", "recordsCount", "bytesProcessed")) \
    ...
    PROBE(SourceFinished, \
        GROUPS("DataSource"), \
        TYPES(ui64, ui64, ui64, ui64, ui32, TString, TDuration, ui64, TDuration), \
        NAMES("pathId", "tabletId", "txId", "sourceId", "stepIndex", "name", "totalDurationMs", "totalBytesRead", "totalExecutionTimeMs")) \
