...
#define YDB_CS_DATA_SOURCE(PROBE, EVENT, GROUPS, TYPES, NAMES) \
    ...
    PROBE(StartSourceProcessing, \
        ...
        NAMES("pathId", "tabletId", "txId", "sourceId", "blobBytes", "rawBytes", "totalReservedBytes")) \
    PROBE(Deduplication, \
        GROUPS("DataSource"), \
    ...
    PROBE(ResultSyncPoint, \
        GROUPS("DataSource"), \
        TYPES(ui64, ui64, ui64, ui64, TString, ui32, ui64, TString), \
        NAMES("pathId", "tabletId", "txId", "sourceId", "name", "rowsCount", "totalReservedBytes", "details")) \
