...
#define YDB_CS_SCAN(PROBE, EVENT, GROUPS, TYPES, NAMES)                                                                                       \
    ...
    PROBE(ScanFinished, GROUPS("Scan"), TYPES(ui64, ui64, ui64, ui64, TDuration, ui64, ui64, ui64, ui64, ui64, ui64, ui64),                   \
    ...
    PROBE(ScanFinishSource, GROUPS("Scan"), TYPES(ui64, ui64, ui64, ui64, ui64, ui64, ui64, ui32, ui32, ui64, ui64, ui64, ui64),              \
        NAMES("pathId", "tabletId", "txId", "scanId", "sourceId", "blobBytes", "rawBytes", "filteredRows", "totalRows", "totalReservedBytes", \
            "cacheBytes", "bsBytes", "tierBytes"))                                                                                            \
