...
public:
    ...
    public:
        TBuildContext(const ui64 pathId, const std::shared_ptr<IStoragesManager>& storages, const std::shared_ptr<arrow::Schema>& pkSchema, const ui64 optimizeForManyTable)
            : PathId(pathId)
            , Storages(storages)
            , PKSchema(pkSchema)
