...
std::shared_ptr<arrow20::Schema> TLocalHelper::GetMetaSchema() {
    return std::make_shared<arrow20::Schema>(arrow20::FieldVector({ std::make_shared<arrow20::Field>("1", arrow20::uint64()) }));
}
...
NKikimrTxColumnShard::TLogicalMetadata TLocalHelper::GetMetaProto() {
    ...
    auto batch = arrow20::RecordBatch::Make(schema, 1, columns);
