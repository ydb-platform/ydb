...
std::unique_ptr<NKikimr::TEvDataShard::TEvKqpScan> TBackupSelector::DoBuildRequestInitiator(const TCursor& cursor) const {
    ...
    ev->Record.SetLocalPathId(TablePathId.GetRawInternalPathIdValue());
    ...
    ev->Record.SetScanId(TablePathId.GetRawInternalPathIdValue());
    ev->Record.SetTxId(TablePathId.GetRawInternalPathIdValue());
