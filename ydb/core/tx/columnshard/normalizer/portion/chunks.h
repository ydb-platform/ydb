...
public:
    ...
    public:
        ...
        bool operator<(const TKey& other) const {
            return std::make_tuple(Portion, Chunk, ColumnIdx) <
                   std::make_tuple(other.Portion, other.Chunk, other.ColumnIdx);
        }
    };
    ...
    static inline INormalizerComponent::TFactory::TRegistrator<TChunksNormalizer> Registrator =
        INormalizerComponent::TFactory::TRegistrator<TChunksNormalizer>(GetClassNameStatic());
