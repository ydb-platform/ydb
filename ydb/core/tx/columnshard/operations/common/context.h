...
private:
    ...
    YDB_READONLY_DEF(std::shared_ptr<ISchema>, ActualSchema);
...
public:
    TWritingContext(const ui64 tabletId, const NActors::TActorId& tabletActorId, const std::shared_ptr<ISchema>& actualSchema,
