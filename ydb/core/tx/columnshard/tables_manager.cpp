...
std::optional<TInternalPathId> TTablesManager::ResolveInternalPathIdOptional(
    ...
    if (const auto* internalPathId = SchemeShardLocalToInternal.FindPtr(schemeShardLocalPathId)) {
        ...
        YDB_LOG_WARN("",
            ...
            {"ss_local", schemeShardLocalPathId},
            {"result", "not_found"});
...
void TTablesManager::MoveTablePropose(const TSchemeShardLocalPathId srcSchemeShardLocalPathId) {
    ...
    YDB_LOG_UPDATE_CONTEXT(
        {"scheme_shard_src_local_path_id", srcSchemeShardLocalPathId});
...
void TTablesManager::MoveTableProgress(
    ...
    YDB_LOG_UPDATE_CONTEXT(
        ...
        {"old_path_id", oldSchemeShardLocalPathId},
        {"new_path_id", newSchemeShardLocalPathId});
...
void TTablesManager::CopyTableProgress(NIceDb::TNiceDb& db, const NOlap::TSnapshot& version,
    ...
    YDB_LOG_UPDATE_CONTEXT(
        ...
        {"src_path_id", srcSchemeShardLocalPathId},
        {"dst_path_id", dstSchemeShardLocalPathId});
