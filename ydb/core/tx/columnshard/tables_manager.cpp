...
void TTablesManager::TruncateTableAbortPropose(const TSchemeShardLocalPathId schemeShardLocalPathId) {
    ...
    AFL_VERIFY(SchemeShardLocalToInternal.emplace(schemeShardLocalPathId, it->second).second)("ss_local_path_id", schemeShardLocalPathId)(
        "internal_path_id", it->second);
...
void TTablesManager::MoveTableAbortPropose(const TSchemeShardLocalPathId srcSchemeShardLocalPathId) {
    ...
    AFL_VERIFY(SchemeShardLocalToInternal.emplace(srcSchemeShardLocalPathId, it->second).second)("ss_local_path_id", srcSchemeShardLocalPathId)(
        "internal_path_id", it->second);
