...
public:
    ...
    std::unique_ptr<NTabletFlatExecutor::ITransaction> AddShardingInfoTx(TColumnShard& owner, const ui64 pathId, const ui64 versionId, const NSharding::TGranuleShardingLogicContainer& tabletShardingLogic) const;
};
