...
void TWaitCompactionController::SetTiersSnapshot(TTestBasicRuntime& runtime, const TActorId& tabletActorId, NColumnShard::NTiers::TConfigsSnapshot snapshot) {
    TiersSnapshot = snapshot;
