...
#define YDB_CS(PROBE, EVENT, GROUPS, TYPES, NAMES)                                                                                             \
    PROBE(EvWrite, GROUPS("Write"), TYPES(ui64, TString, ui64, ui64, TDuration, ui64, TString, bool, bool, TString, TString),                  \
        NAMES("tabletId", "sender", "cookie", "txId", "writeTimeout", "size", "modificationType", "isBulk", "success", "status", "reason"))    \
    PROBE(EvWriteResult, GROUPS("Write"), TYPES(ui64, TString, ui64, ui64, TString, bool, TString),                                            \
    ...
    PROBE(TxBlobsWritingFinished, GROUPS("Write"), TYPES(ui64, TDuration, TDuration, TDuration, TDuration),                                    \
    ...
    PROBE(ColumnEngineForLogsSelect, GROUPS("Read"), TYPES(TString, ui64, ui64, ui64, ui64, ui64),                                             \
        NAMES("pathId", "timeOfInsertedSelectMs", "timeOfCommittedSelectMs", "totalPortionsCount", "totalFilteredPortionsCount",               \
            "totalResultSize"))
=======
#define YDB_CS(PROBE, EVENT, GROUPS, TYPES, NAMES) \
    PROBE(EvWrite, \
