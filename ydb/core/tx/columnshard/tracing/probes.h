...
#define YDB_CS(PROBE, EVENT, GROUPS, TYPES, NAMES)                                                                                              \
    ...
    PROBE(                                                                                                                                      \
        WriteDequeued, GROUPS("Write"), TYPES(ui64, ui64, ui64, ui64, TDuration), NAMES("pathId", "tabletId", "txId", "cookie", "queueWaitMs")) \
    ...
    PROBE(WriteFinished, GROUPS("Write"), TYPES(ui64, ui64, ui64, ui64, TString, TString, TDuration, TDuration, TDuration, TDuration,           \
                                              TDuration), NAMES("pathId", "tabletId", "txId", "cookie", "sender", "type", "totalDurationMs",    \
                                                              "transactionTimeMs", "completeTimeMs", "txTotalTimeMs", "writeMs"))               \
