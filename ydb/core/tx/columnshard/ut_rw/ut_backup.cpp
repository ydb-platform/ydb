...
Y_UNIT_TEST_SUITE(Backup) {
    ...
    void TestWaitCondition(
        ...
        const TDuration d = TDuration::Seconds(10)
    ) {
    ...
    Y_UNIT_TEST(ProposeBackup) {
        ...
        auto csControllerGuard =
            NKikimr::NYDBTest::TControllers::RegisterCSControllerGuard<NOlap::TWaitCompactionController>();
...

        {
            ...
            UNIT_ASSERT(
                WriteData(runtime, sender, writeId++, tableId, MakeTestBlob({0, 100}, schema), schema, true, &writeIds)
            );
        ...
        TestWaitCondition(
            ...
            [&]() {
                ...
                WriteData(
                    ...
                    writeId,
                    tableId,
                    MakeTestBlob({writeId * 100, (writeId + 1) * 100}, schema),
                    schema,
                    true,
                    &writeIds
                );
