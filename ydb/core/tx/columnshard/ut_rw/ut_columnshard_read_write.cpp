        ...
        while (!success && TInstant::Now() - start < TDuration::Seconds(30)) {   // Get index stats
            ...
            while (true) {
                ...
                for (ui32 i = 0; i < batchStats->num_rows(); ++i) {
                    ...
                    const auto pathId = NColumnShard::TInternalPathId::FromInternalPathIdValue(static_cast<arrow::UInt64Array&>(*paths).Value(i));
                    ...
                    if (pathId.GetInternalPathIdValue() == tableId) {
