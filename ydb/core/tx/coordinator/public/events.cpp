...
TEvTxCoordinator::TEvCoordinatorStep::TEvCoordinatorStep(
    ui64 step,
    ui64 prevStep,
    ui64 mediatorId,
    ui64 coordinatorId,
    ui64 activeGeneration
) {
    Record.SetStep(step);
...
TEvTxCoordinator::TEvCoordinatorStepResult::TEvCoordinatorStepResult(
...
TEvTxCoordinator::TEvCoordinatorSyncResult::TEvCoordinatorSyncResult(
    ui64 cookie,
    ui64 completeStep,
    ui64 latestKnown,
    ui64 subjectiveTime,
