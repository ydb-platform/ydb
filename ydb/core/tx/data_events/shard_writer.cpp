...
namespace NKikimr::NEvWrite {
    ...
    void TShardWriter::SendWriteRequest() {
        if (ImmediateWrite) {
            ...
            auto ev = MakeHolder<TEvColumnShard::TEvWrite>(SelfId(), ExternalController->GetLongTxId(), NColumnShard::TSchemeShardLocalPathId::FromRawValue(TableId), DedupId, "", WritePartIdx, ModificationType);
