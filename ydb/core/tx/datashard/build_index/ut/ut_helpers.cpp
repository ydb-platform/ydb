...
void CreateFulltextCompactTable(Tests::TServer::TPtr server, TActorId sender, const char* name, const char* keyType, bool gen64)
{
    ...
    options.Columns({
        ...
        {NTableIndex::NFulltext::GenColumn, gen64 ? "Uint64" : "Uint32", true, true},
