...
std::unique_ptr<TExecutionUnit> CreateCheckCommitWritesTxUnit(TDataShard& self, TPipeline& pipeline) {
    return std::unique_ptr<TCheckCommitWritesTxUnit>(new TCheckCommitWritesTxUnit(self, pipeline));
}
