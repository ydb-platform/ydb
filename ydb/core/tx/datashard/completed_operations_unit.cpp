...
public:
    TCompletedOperationsUnit(TDataShard& dataShard, TPipeline& pipeline);
...
TCompletedOperationsUnit::TCompletedOperationsUnit(TDataShard& dataShard, TPipeline& pipeline)
...
EExecutionStatus TCompletedOperationsUnit::Execute(TOperation::TPtr op, TTransactionContext&, const TActorContext&) {
    Pipeline.RemoveActiveOp(op);

    return EExecutionStatus::Executed;
}

void TCompletedOperationsUnit::Complete(TOperation::TPtr, const TActorContext&) {}
