...
std::unique_ptr<TExecutionUnit> CreateCreateCdcStreamUnit(TDataShard& self, TPipeline& pipeline) {
    return std::unique_ptr<TCreateCdcStreamUnit>(new TCreateCdcStreamUnit(self, pipeline));
}
