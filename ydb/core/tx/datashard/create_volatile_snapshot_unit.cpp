...
std::unique_ptr<TExecutionUnit> CreateCreateVolatileSnapshotUnit(
        TDataShard& dataShard,
        TPipeline& pipeline)
{
    return std::unique_ptr<TCreateVolatileSnapshotUnit>(new TCreateVolatileSnapshotUnit(dataShard, pipeline));
}
