...
struct TTxFlags {
    enum Flags : ui64 {
        ...
        PreservedPrivateFlagsMask = ReadOnly | ProposeBlocker | NeedDiagnostics | GlobalReader | GlobalWriter |
                                    KqpDataTransaction | KqpScanTransaction | BlockingImmediateOps |
                                    BlockingImmediateWrites,
    };
};
...
static_assert(
    EvEnd < EventSpaceEnd(TKikimrEvents::ES_TX_DATASHARD),
    "expect EvEnd < EventSpaceEnd(TKikimrEvents::ES_TX_DATASHARD)"
);
struct TEvGetShardState
    : public TEventPB<TEvGetShardState, NKikimrTxDataShard::TEvGetShardState, TEvDataShard::EvGetShardState> {
    TEvGetShardState() {}
...
struct TEvGetShardStateResult
    : public TEventPB<
          TEvGetShardStateResult,
          NKikimrTxDataShard::TEvGetShardStateResult,
...
struct TEvSchemaChanged
    : public TEventPB<TEvSchemaChanged, NKikimrTxDataShard::TEvSchemaChanged, TEvDataShard::EvSchemaChanged> {
    TEvSchemaChanged() {}
...
struct TEvSchemaChangedResult
    : public TEventPB<
          TEvSchemaChangedResult,
          NKikimrTxDataShard::TEvSchemaChangedResult,
...
struct TEvStateChanged
    : public TEventPB<TEvStateChanged, NKikimrTxDataShard::TEvStateChanged, TEvDataShard::EvStateChanged> {
    TEvStateChanged() {}
...
struct TEvStateChangedResult
    : public TEventPB<
          TEvStateChangedResult,
          NKikimrTxDataShard::TEvStateChangedResult,
...
struct TEvProposeTransaction
    : public TEventPB<
          ...
          NKikimrTxDataShard::TEvProposeTransaction,
...
struct TEvCancelTransactionProposal
    : public TEventPB<
          ...
          NKikimrTxDataShard::TEvCancelTransactionProposal,
          TEvDataShard::EvCancelTransactionProposal> {
    TEvCancelTransactionProposal() {}
...
struct TEvProposeTransactionResult
    ...
    bool IsPrepared() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::PREPARED;
    }
    bool IsComplete() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::COMPLETE;
    }
    bool IsTryLater() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::TRY_LATER;
    }
    bool IsExecError() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::EXEC_ERROR;
    }
    bool IsError() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::ERROR;
    }
    bool IsBadRequest() const {
        return GetStatus() == NKikimrTxDataShard::TEvProposeTransactionResult::BAD_REQUEST;
    }

    bool IsForceOnline() const {
        return ForceOnline;
    }
    bool IsForceDirty() const {
        return ForceDirty;
    }
    void SetForceOnline(bool online = true) {
        ForceOnline = online;
    }
    void SetForceDirty(bool dirty = true) {
        ForceDirty = dirty;
    }
    ...
    void AddError(
        ...
        const TStringBuf& keyBuffer = TStringBuf()
    ) {
...
struct TEvProposeTransactionRestart
    : public TEventPB<
          TEvProposeTransactionRestart,
          NKikimrTxDataShard::TEvProposeTransactionRestart,
          TEvDataShard::EvProposeTransactionRestart> {
...
struct TEvProposeTransactionAttach
    : public TEventPB<
          TEvProposeTransactionAttach,
          NKikimrTxDataShard::TEvProposeTransactionAttach,
          TEvDataShard::EvProposeTransactionAttach> {
...
struct TEvProposeTransactionAttachResult
    : public TEventPB<
          TEvProposeTransactionAttachResult,
          NKikimrTxDataShard::TEvProposeTransactionAttachResult,
          TEvDataShard::EvProposeTransactionAttachResult> {
...
struct TEvReturnBorrowedPart
    : public TEventPB<
          TEvReturnBorrowedPart,
          NKikimrTxDataShard::TEvReturnBorrowedPart,
          TEvDataShard::EvReturnBorrowedPart> {
...
struct TEvReturnBorrowedPartAck
    : public TEventPB<
          TEvReturnBorrowedPartAck,
          NKikimrTxDataShard::TEvReturnBorrowedPartAck,
          TEvDataShard::EvReturnBorrowedPartAck> {
...
struct TEvInitSplitMergeDestination
    : public TEventPB<
          TEvInitSplitMergeDestination,
...
struct TEvInitSplitMergeDestinationAck
    : public TEventPB<
...
struct TEvSplitTransferSnapshot
    : public TEventPB<
          TEvSplitTransferSnapshot,
...
struct TEvSplitTransferSnapshotAck
    : public TEventPB<
          TEvSplitTransferSnapshotAck,
...
struct TEvSplitPartitioningChanged
    : public TEventPB<
          TEvSplitPartitioningChanged,
...
struct TEvSplitPartitioningChangedAck
    : public TEventPB<
          TEvSplitPartitioningChangedAck,
...
struct TEvCancelBackup
    : public TEventPB<TEvCancelBackup, NKikimrTxDataShard::TEvCancelBackup, TEvDataShard::EvCancelBackup> {
...
struct TEvCancelRestore
    : public TEventPB<TEvCancelRestore, NKikimrTxDataShard::TEvCancelRestore, TEvDataShard::EvCancelRestore> {
...
struct TEvGetTableStats
    : public TEventPB<TEvGetTableStats, NKikimrTxDataShard::TEvGetTableStats, TEvDataShard::EvGetTableStats> {
...
struct TEvOverloadReady: public TEventPB<TEvOverloadReady, NKikimrTxDataShard::TEvOverloadReady, EvOverloadReady> {
...
struct TEvOverloadUnsubscribe
    : public TEventPB<TEvOverloadUnsubscribe, NKikimrTxDataShard::TEvOverloadUnsubscribe, EvOverloadUnsubscribe> {
...
struct TEvRead: public TEventPB<TEvRead, NKikimrTxDataShard::TEvRead, TEvDataShard::EvRead> {
    using TBase = TEventPB<TEvRead, NKikimrTxDataShard::TEvRead, TEvDataShard::EvRead>;
...
struct TEvReadResult: public TEventPB<TEvReadResult, NKikimrTxDataShard::TEvReadResult, TEvDataShard::EvReadResult> {
    using TBase = TEventPB<TEvReadResult, NKikimrTxDataShard::TEvReadResult, TEvDataShard::EvReadResult>;
...
struct TEvReadAck: public TEventPB<TEvReadAck, NKikimrTxDataShard::TEvReadAck, TEvDataShard::EvReadAck> {
    TEvReadAck() = default;
};

struct TEvReadCancel: public TEventPB<TEvReadCancel, NKikimrTxDataShard::TEvReadCancel, TEvDataShard::EvReadCancel> {
    TEvReadCancel() = default;
};

struct TEvReadColumnsRequest
    : public TEventPB<
          TEvReadColumnsRequest,
          NKikimrTxDataShard::TEvReadColumnsRequest,
          TEvDataShard::EvReadColumnsRequest> {
    TEvReadColumnsRequest() = default;
};

struct TEvReadColumnsResponse
    : public TEventPB<
          TEvReadColumnsResponse,
...
struct TEvGetInfoRequest
    : public TEventPB<TEvGetInfoRequest, NKikimrTxDataShard::TEvGetInfoRequest, TEvDataShard::EvGetInfoRequest> {};

struct TEvGetInfoResponse
    : public TEventPB<TEvGetInfoResponse, NKikimrTxDataShard::TEvGetInfoResponse, TEvDataShard::EvGetInfoResponse> {};

struct TEvListOperationsRequest
    : public TEventPB<
          TEvListOperationsRequest,
          NKikimrTxDataShard::TEvListOperationsRequest,
          TEvDataShard::EvListOperationsRequest> {};

struct TEvListOperationsResponse
    : public TEventPB<
          TEvListOperationsResponse,
...
struct TEvRefreshVolatileSnapshotRequest
    : public TEventPB<
          TEvRefreshVolatileSnapshotRequest,
...
struct TEvRefreshVolatileSnapshotResponse
    : public TEventPB<
          TEvRefreshVolatileSnapshotResponse,
...
struct TEvDiscardVolatileSnapshotResponse
    : public TEventPB<
          TEvDiscardVolatileSnapshotResponse,
...
struct TEvGetS3Upload: public TEventLocal<TEvGetS3Upload, TEvDataShard::EvGetS3Upload> {
    TActorId ReplyTo;
    ui64 TxId;
...
struct TEvStoreS3UploadId: public TEventLocal<TEvStoreS3UploadId, TEvDataShard::EvStoreS3UploadId> {
    TActorId ReplyTo;
    ui64 TxId;
    TString UploadId;
...
struct TEvChangeS3UploadStatus: public TEventLocal<TEvChangeS3UploadStatus, TEvDataShard::EvChangeS3UploadStatus> {
...
struct TEvS3Upload: public TEventLocal<TEvS3Upload, TEvDataShard::EvS3Upload> {
...
struct TEvGetS3DownloadInfo: public TEventLocal<TEvGetS3DownloadInfo, TEvDataShard::EvGetS3DownloadInfo> {
    ui64 TxId;
...
struct TEvStoreS3DownloadInfo: public TEventLocal<TEvStoreS3DownloadInfo, TEvDataShard::EvStoreS3DownloadInfo> {
    ui64 TxId;
...
struct TEvS3DownloadInfo: public TEventLocal<TEvS3DownloadInfo, TEvDataShard::EvS3DownloadInfo> {
    NDataShard::TS3Download Info;
...
struct TEvS3UploadRowsRequest: public TEventLocal<TEvS3UploadRowsRequest, TEvDataShard::EvS3UploadRowsRequest> {
    ui64 TxId;
...
struct TEvS3UploadRowsResponse: public TEventLocal<TEvS3UploadRowsResponse, TEvDataShard::EvS3UploadRowsResponse> {
    ...
    TString ToString() const override {
        return TStringBuilder() << ToStringHeader() << " {"
                                << " Record: " << Record.ShortDebugString() << " Info: " << Info << " }";
    }
};

struct TEvObjectStorageListingRequest
    : public TEventPB<
          TEvObjectStorageListingRequest,
...
struct TEvObjectStorageListingResponse
    : public TEventPB<
          TEvObjectStorageListingResponse,
...
struct TEvEraseRowsRequest
    : public TEventPB<TEvEraseRowsRequest, NKikimrTxDataShard::TEvEraseRowsRequest, TEvDataShard::EvEraseRowsRequest> {
};

struct TEvEraseRowsResponse
    : public TEventPB<
          TEvEraseRowsResponse,
          NKikimrTxDataShard::TEvEraseRowsResponse,
          TEvDataShard::EvEraseRowsResponse> {};

struct TEvConditionalEraseRowsRequest
    : public TEventPB<
          TEvConditionalEraseRowsRequest,
...
struct TEvConditionalEraseRowsResponse
    : public TEventPB<
          TEvConditionalEraseRowsResponse,
...
struct TEvGetRemovedRowVersionsResult
    : public TEventLocal<TEvGetRemovedRowVersionsResult, EvGetRemovedRowVersionsResult> {
...
struct TEvCompactTable
    : public TEventPB<TEvCompactTable, NKikimrTxDataShard::TEvCompactTable, TEvDataShard::EvCompactTable> {
...
struct TEvCompactTableResult
    : public TEventPB<
          TEvCompactTableResult,
    ...
    TEvCompactTableResult(
        ...
        NKikimrTxDataShard::TEvCompactTableResult::EStatus status
    )
     ...
     */
struct TEvCompactBorrowed
    : public TEventPB<TEvCompactBorrowed, NKikimrTxDataShard::TEvCompactBorrowed, EvCompactBorrowed> {
    ...
    static_assert(
        EvCompactBorrowed == EventSpaceBegin(TKikimrEvents::ES_TX_DATASHARD) + 7 * 512 + 60,
        "EvCompactBorrowed event has an unexpected value"
    );
};

struct TEvCompactBorrowedResult
    : public TEventPB<TEvCompactBorrowedResult, NKikimrTxDataShard::TEvCompactBorrowedResult, EvCompactBorrowedResult> {
    ...
    TEvCompactBorrowedResult(ui64 tabletId, const TPathId& pathId)
        ...
        // Sanity check for safe merging to earlier versions
    static_assert(
        EvCompactBorrowedResult == EventSpaceBegin(TKikimrEvents::ES_TX_DATASHARD) + 7 * 512 + 68,
        "EvCompactBorrowedResult event has an unexpected value"
    );
};

struct TEvGetCompactTableStats
    : public TEventPB<
          TEvGetCompactTableStats,
          NKikimrTxDataShard::TEvGetCompactTableStats,
...
struct TEvGetCompactTableStatsResult
    : public TEventPB<
          TEvGetCompactTableStatsResult,
          NKikimrTxDataShard::TEvGetCompactTableStatsResult,
...
struct TEvApplyReplicationChangesResult
    : public TEventPB<
          TEvApplyReplicationChangesResult,
...
struct TEvGetReplicationSourceOffsets
    : public TEventPB<
          TEvGetReplicationSourceOffsets,
...
struct TEvReplicationSourceOffsetsAck
    : public TEventPB<
          TEvReplicationSourceOffsetsAck,
...
struct TEvReplicationSourceOffsetsCancel
    : public TEventPB<
          TEvReplicationSourceOffsetsCancel,
...
struct TEvCdcStreamScanRequest
    : public TEventPB<TEvCdcStreamScanRequest, NKikimrTxDataShard::TEvCdcStreamScanRequest, EvCdcStreamScanRequest> {};

struct TEvCdcStreamScanResponse
    : public TEventPB<TEvCdcStreamScanResponse, NKikimrTxDataShard::TEvCdcStreamScanResponse, EvCdcStreamScanResponse> {
    TEvCdcStreamScanResponse() = default;

    explicit TEvCdcStreamScanResponse(
        const NKikimrTxDataShard::TEvCdcStreamScanRequest& request,
        ui64 tabletId,
