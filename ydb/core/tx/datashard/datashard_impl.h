    ...
    , public NTabletFlatExecutor::TTabletExecutedFlat
{
    ...
    void Handle(NEvDataShard::TEvGetInfoRequest::TPtr& ev);
    void Handle(NEvDataShard::TEvListOperationsRequest::TPtr& ev);
    void Handle(NEvDataShard::TEvGetDataHistogramRequest::TPtr& ev);
    void Handle(NEvDataShard::TEvGetOperationRequest::TPtr& ev);
    ...
    void Handle(NEvDataShard::TEvGetRSInfoRequest::TPtr& ev);
    void Handle(NEvDataShard::TEvGetSlowOpProfilesRequest::TPtr& ev);
