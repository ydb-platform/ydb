...
public:
    ...
    virtual void
    PersistSplitKey(const TPathId& pathId, ui64 sourceId, ui64 splitKeyId, const TString& splitKey, i64 offset) = 0;
...
public:
    ...
    void PersistSplitKey(const TPathId& pathId, ui64 sourceId, ui64 splitKeyId, const TString& splitKey, i64 offset)
        override;
...
public:
    ...
    TReplicatedTableState(const TPathId& pathId, const TVector<NScheme::TTypeInfo>& keyColumnTypes);
