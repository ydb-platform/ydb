...
using TEvExecuteDataQueryRequest = NKikimr::NGRpcService::
    TGrpcRequestOperationCall<Ydb::Table::ExecuteDataQueryRequest, Ydb::Table::ExecuteDataQueryResponse>;

using TEvExecuteSchemeQueryRequest = NKikimr::NGRpcService::
    TGrpcRequestOperationCall<Ydb::Table::ExecuteSchemeQueryRequest, Ydb::Table::ExecuteSchemeQueryResponse>;

using TEvCreateSessionRequest = NKikimr::NGRpcService::
    TGrpcRequestOperationCall<Ydb::Table::CreateSessionRequest, Ydb::Table::CreateSessionResponse>;

using TEvDeleteSessionRequest = NKikimr::NGRpcService::
    TGrpcRequestOperationCall<Ydb::Table::DeleteSessionRequest, Ydb::Table::DeleteSessionResponse>;

using TEvCommitTransactionRequest = NKikimr::NGRpcService::
    TGrpcRequestOperationCall<Ydb::Table::CommitTransactionRequest, Ydb::Table::CommitTransactionResponse>;
...
inline TString CommitTransactionRPC(
...
inline NThreading::TFuture<Ydb::Table::ExecuteDataQueryResponse>
SendRequest(TTestActorRuntime& runtime, Ydb::Table::ExecuteDataQueryRequest&& request, const TString& database = {}) {
...
inline void SendRequest(TTestActorRuntime& runtime, TActorId sender, THolder<NKqp::TEvKqp::TEvQueryRequest> request) {
    runtime.Send(
        new IEventHandle(NKqp::MakeKqpProxyID(runtime.GetNodeId()), sender, request.Release()),
        0,
        /* via actor system */ true
    );
}

inline NKqp::TEvKqp::TEvQueryResponse::TPtr
ExecRequest(TTestActorRuntime& runtime, TActorId sender, THolder<NKqp::TEvKqp::TEvQueryRequest> request) {
...
inline THolder<NKqp::TEvKqp::TEvQueryRequest>
MakeStreamRequest(const TActorId sender, const TString& sql, const bool collectStats = false) {
...
inline auto
KqpSimpleSend(TTestActorRuntime& runtime, const TString& query, bool staleRo = false, const TString& database = {}) {
...
inline TString
KqpSimpleExec(TTestActorRuntime& runtime, const TString& query, bool staleRo = false, const TString& database = {}) {
...
inline TString
KqpSimpleContinue(TTestActorRuntime& runtime, const TString& sessionId, const TString& txId, const TString& query) {
    Y_ABORT_UNLESS(!txId.empty(), "continue on empty transaction");
    auto response = AwaitResponse(
        runtime, SendRequest(runtime, MakeSimpleRequestRPC(query, sessionId, txId, false /* commitTx */))
    );
    if (response.operation().status() != Ydb::StatusIds::SUCCESS) {
        return TStringBuilder() << "ERROR: " << response.operation().status();
    }
...
inline auto
KqpSimpleSendCommit(TTestActorRuntime& runtime, const TString& sessionId, const TString& txId, const TString& query) {
...
inline TString
KqpSimpleCommit(TTestActorRuntime& runtime, const TString& sessionId, const TString& txId, const TString& query) {
...
inline Ydb::Table::ExecuteSchemeQueryRequest MakeSchemeRequestRPC(const TString& sql, const TString& sessionId) {
...
inline NThreading::TFuture<Ydb::Table::ExecuteSchemeQueryResponse>
SendRequest(TTestActorRuntime& runtime, Ydb::Table::ExecuteSchemeQueryRequest&& request, const TString& database = {}) {
