...
Y_UNIT_TEST_SUITE(TxKeys) {
    ...
    static void ComparePointsStr(TTester & t, TString xKey, TString yKey, int cmpExpected) {
        ...
        UNIT_ASSERT(
            (cmpActual < 0 && cmpExpected < 0) || (cmpActual == 0 && cmpExpected == 0) ||
    ...
    static void ComparePointAndRange(
        TTester & t,
        std::pair<ui32, TString> point,
        std::pair<ui32, TString> rBegin,
        std::pair<ui32, TString> rEnd,
        TString includes,
        int cmpExpected
    ) {
...
//
    ...
    Y_UNIT_TEST(ComparePointAndRangeWithNull) {
        ...
        ComparePointAndRangeStr(
            t, nullNull, "'IncFrom 'IncTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Null))", -1
        );
        ...
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'IncFrom 'IncTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Null))", 0
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'IncFrom 'IncTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Null))", 1
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'IncFrom 'IncTo '('key1 (Uint32 '1) (Uint32 '1)) '('key2 (Null) (Null))", -1
        );

        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'IncFrom 'IncTo '('key1 (Uint32 '0) (Uint32 '1)) '('key2 (Null) (Null))", 0
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'IncFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '1)) '('key2 (Null) (Null))", 1
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'ExcFrom 'IncTo '('key1 (Uint32 '0) (Uint32 '1)) '('key2 (Null) (Null))", -1
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'ExcFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '2)) '('key2 (Null) (Null))", 0
        );

        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'IncFrom 'IncTo '('key1 (Null) (Uint32 '0)) '('key2 (Null) (Null))", 0
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'IncFrom 'ExcTo '('key1 (Null) (Uint32 '0)) '('key2 (Null) (Null))", 1
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'ExcFrom 'ExcTo '('key1 (Null) (Uint32 '0)) '('key2 (Null) (Utf8 'a))", 0
        );
    }
    ...
    Y_UNIT_TEST(ComparePointAndRangeWithInf) {
        ...
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'IncFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Void))", 0
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'ExcFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Void))", -1
        );
        ...
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'ExcFrom 'IncTo '('key1 (Null) (Uint32 '0)) '('key2 (Null) (Null))", 0
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 0), "'ExcFrom 'ExcTo '('key1 (Null) (Uint32 '0)) '('key2 (Null) (Null))", 1
        );
        ...
        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'IncFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Void))", 1
        );
        ComparePointAndRangeStr(
            t, Sprintf(null, 1), "'ExcFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '1)) '('key2 (Null) (Void))", 0
        );
        ...
        ComparePointAndRangeStr(
            t, nullNull, "'IncFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Void))", -1
        );
        ComparePointAndRangeStr(
            t, nullNull, "'ExcFrom 'ExcTo '('key1 (Uint32 '0) (Uint32 '0)) '('key2 (Null) (Void))", -1
        );
