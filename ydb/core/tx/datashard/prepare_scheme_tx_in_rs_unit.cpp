...
public:
    TPrepareSchemeTxInRSUnit(TDataShard& dataShard, TPipeline& pipeline);
...
TPrepareSchemeTxInRSUnit::TPrepareSchemeTxInRSUnit(TDataShard& dataShard, TPipeline& pipeline)
...
EExecutionStatus TPrepareSchemeTxInRSUnit::Execute(TOperation::TPtr op, TTransactionContext&, const TActorContext&) {
...
void TPrepareSchemeTxInRSUnit::Complete(TOperation::TPtr, const TActorContext&) {}
