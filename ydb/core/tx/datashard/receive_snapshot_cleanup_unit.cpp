...
public:
    TReceiveSnapshotCleanupUnit(TDataShard& dataShard, TPipeline& pipeline);
...
TReceiveSnapshotCleanupUnit::TReceiveSnapshotCleanupUnit(TDataShard& dataShard, TPipeline& pipeline)
...
EExecutionStatus
TReceiveSnapshotCleanupUnit::Execute(TOperation::TPtr op, TTransactionContext& txc, const TActorContext&) {
...
void TReceiveSnapshotCleanupUnit::Complete(TOperation::TPtr, const TActorContext&) {}
