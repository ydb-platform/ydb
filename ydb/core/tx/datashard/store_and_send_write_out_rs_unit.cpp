...
std::unique_ptr<TExecutionUnit> CreateStoreAndSendWriteOutRSUnit(TDataShard &dataShard,
                                                    TPipeline &pipeline)
{
    return std::unique_ptr<TStoreAndSendWriteOutRSUnit>(new TStoreAndSendWriteOutRSUnit(dataShard, pipeline));
}
