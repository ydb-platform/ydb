...
std::unique_ptr<TExecutionUnit> CreateStoreCommitWritesTxUnit(TDataShard& self, TPipeline& pipeline) {
    return std::unique_ptr<TStoreCommitWritesTxUnit>(new TStoreCommitWritesTxUnit(self, pipeline));
}
