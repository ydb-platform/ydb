...
public:
    struct TOwnedRange {
        ...
        TOwnedRange(TOwnedCellVec leftKey, bool leftInclusive, TOwnedCellVec rightKey, bool rightInclusive) noexcept
    ...
    struct TRange {
        ...
        TRange(TConstArrayRef<TCell> leftKey, bool leftInclusive, TConstArrayRef<TCell> rightKey, bool rightInclusive)
            noexcept
            : LeftKey(leftKey)
            , RightKey(rightKey)
            , LeftInclusive(leftInclusive)
