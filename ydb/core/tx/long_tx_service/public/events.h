...
struct TEvLongTxService {
    ...
    static_assert(TKikimrEvents::ES_LONG_TX_SERVICE == 4207, "expect TKikimrEvents::ES_LONG_TX_SERVICE == 4207");

    static_assert(
        EvEnd < EventSpaceEnd(TKikimrEvents::ES_LONG_TX_SERVICE),
        "expect EvEnd < EventSpaceEnd(TKikimrEvents::ES_LONG_TX_SERVICE)"
    );

    struct TEvBeginTx: TEventPB<TEvBeginTx, NKikimrLongTxService::TEvBeginTx, EvBeginTx> {
        TEvBeginTx() = default;
    ...
    struct TEvBeginTxResult: TEventPB<TEvBeginTxResult, NKikimrLongTxService::TEvBeginTxResult, EvBeginTxResult> {
    ...
    struct TEvCommitTx: TEventPB<TEvCommitTx, NKikimrLongTxService::TEvCommitTx, EvCommitTx> {
        TEvCommitTx() = default;
    ...
    struct TEvCommitTxResult: TEventPB<TEvCommitTxResult, NKikimrLongTxService::TEvCommitTxResult, EvCommitTxResult> {
    ...
    struct TEvRollbackTx: TEventPB<TEvRollbackTx, NKikimrLongTxService::TEvRollbackTx, EvRollbackTx> {
    ...
    struct TEvAttachColumnShardWrites
        : TEventPB<
              TEvAttachColumnShardWrites,
              NKikimrLongTxService::TEvAttachColumnShardWrites,
              EvAttachColumnShardWrites> {
    ...
    struct TEvAttachColumnShardWritesResult
        : TEventPB<
              TEvAttachColumnShardWritesResult,
              NKikimrLongTxService::TEvAttachColumnShardWritesResult,
              EvAttachColumnShardWritesResult> {
    ...
    struct TEvAcquireReadSnapshotResult
        : TEventPB<
              TEvAcquireReadSnapshotResult,
              NKikimrLongTxService::TEvAcquireReadSnapshotResult,
              EvAcquireReadSnapshotResult> {
        TEvAcquireReadSnapshotResult() = default;

            // Success
        explicit TEvAcquireReadSnapshotResult(
    ...
    struct TEvRegisterLock: TEventLocal<TEvRegisterLock, EvRegisterLock> {
        const ui64 LockId;
    ...
    struct TEvUnregisterLock: TEventLocal<TEvUnregisterLock, EvUnregisterLock> {
        const ui64 LockId;
    ...
    struct TEvSubscribeLock: TEventPB<TEvSubscribeLock, NKikimrLongTxService::TEvSubscribeLock, EvSubscribeLock> {
    ...
    struct TEvLockStatus: TEventPB<TEvLockStatus, NKikimrLongTxService::TEvLockStatus, EvLockStatus> {
