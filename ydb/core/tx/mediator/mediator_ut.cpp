...
Y_UNIT_TEST_SUITE(MediatorTest) {
    ...
    public:
        enum EEv {
            EvAddTablet = EventSpaceBegin(TKikimrEvents::ES_PRIVATE),
            EvRemoveTablet,
        };
    ...
    Y_UNIT_TEST_F(BasicTimecastUpdates, TMediatorTestWithWatcher) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(0));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TWatchUpdate(0));
        ...
        runtime.SimulateSleep(TDuration::MilliSeconds(1));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 2u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1000));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TWatchUpdate(1000));
        WatcherState->Updates.clear();
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 1u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010));
        WatcherState->Updates.clear();
        ...
        WaitNoPending();
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 1u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010, {{tabletId, 1009u}}, {}));
        WatcherState->Updates.clear();
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 2u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010, {}, {tabletId}));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TWatchUpdate(1010));
        WatcherState->Updates.clear();
    }
    ...
    Y_UNIT_TEST_F(MultipleTablets, TMediatorTestWithWatcher) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 1u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1030, {{tablet1, 1029}, {tablet2, 1029}, {tablet3, 1029}}, {}));
        WatcherState->Updates.clear();
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->SafeStep, 1020u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 0u);

        blockedPlan1.Unblock();

        runtime.WaitFor("granular and watch update", [&]{ return WatcherState->Updates.size() >= 2; });
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 2u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1030, {}, {tablet1}));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TWatchUpdate(1030));
        WatcherState->Updates.clear();
    ...
    Y_UNIT_TEST_F(TabletAckBeforePlanComplete, TMediatorTestWithWatcher) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010, {{tablet2, 1009}}, {}));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TGranularUpdate(1010, {}, {tablet2}));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[2], TWatchUpdate(1010));
    }
    ...
    Y_UNIT_TEST_F(TabletAckWhenDead, TMediatorTestWithWatcher) {
        ...
        runtime.SimulateSleep(TDuration::MilliSeconds(1));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 1u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010, {{tablet1, 1009}}, {}));
        WatcherState->Updates.clear();
        ...
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates.size(), 2u);
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[0], TGranularUpdate(1010, {}, {tablet1}));
        UNIT_ASSERT_VALUES_EQUAL(WatcherState->Updates[1], TWatchUpdate(1010));
    }
