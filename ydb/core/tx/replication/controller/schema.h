...
struct TControllerSchema: NIceDb::Schema {
    ...
    struct Replications: Table<2> {
        ...
        struct State: Column<5, NScheme::NTypeIds::Uint8> {
            using Type = TReplication::EState;
        };
        struct Issue: Column<6, NScheme::NTypeIds::Utf8> {};
        struct NextTargetId: Column<7, NScheme::NTypeIds::Uint64> {
    ...
    struct Targets: Table<3> {
        ...
        struct Kind: Column<3, NScheme::NTypeIds::Uint8> {
            using Type = TReplication::ETargetKind;
        };
        struct SrcPath: Column<4, NScheme::NTypeIds::Utf8> {};
        struct DstPath: Column<5, NScheme::NTypeIds::Utf8> {};
        struct DstState: Column<6, NScheme::NTypeIds::Uint8> {
            using Type = TReplication::EDstState;
        };
        ...
        using TColumns =
            TableColumns<ReplicationId, Id, Kind, SrcPath, DstPath, DstState, DstPathOwnerId, DstPathLocalId, Issue>;
    };
    ...
    struct SrcStreams: Table<4> {
        ...
        struct State: Column<4, NScheme::NTypeIds::Uint8> {
            using Type = TReplication::EStreamState;
        };
    ...
    using TTables = SchemaTables<SysParams, Replications, Targets, SrcStreams>;
