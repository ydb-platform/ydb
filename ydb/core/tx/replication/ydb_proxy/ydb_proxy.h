...
#undef EV_REQUEST_RESPONSE
    ...
    static_assert(
        EvEnd < EventSpaceEnd(TKikimrEvents::ES_YDB_PROXY),
    ...
    struct TGenericRequest
        ...
        , public TEventLocal<TDerived, EventType> {
...
#undef PROXY_METHOD
    ...
    struct TEvTopicEndPartition
        : public TGenericResponse<TEvTopicEndPartition, EvTopicEndPartition, TEndTopicPartitionResult> {
        using TBase::TBase;
    };
...
#define DEFINE_GENERIC_REQUEST_RESPONSE(name, result_t, ...) \
    ...
    DEFINE_GENERIC_REQUEST_RESPONSE(
        ...
        TString,
        NYdb::NScheme::TDescribePathSettings
    );
    DEFINE_GENERIC_REQUEST_RESPONSE(
        ListDirectory,
        NYdb::NScheme::TListDirectoryResult,
        TString,
        NYdb::NScheme::TListDirectorySettings
    );
    DEFINE_GENERIC_REQUEST_RESPONSE(
        ModifyPermissions,
        NYdb::TStatus,
    ...
    DEFINE_GENERIC_REQUEST_RESPONSE(
        ...
        NYdb::TStatus,
        TString,
        NYdb::NTable::TTableDescription,
        NYdb::NTable::TCreateTableSettings
    );
    ...
    DEFINE_GENERIC_REQUEST_RESPONSE(
        CopyTables,
        NYdb::TStatus,
        TVector<NYdb::NTable::TCopyItem>,
        NYdb::NTable::TCopyTablesSettings
    );
    DEFINE_GENERIC_REQUEST_RESPONSE(
        RenameTables,
        NYdb::TStatus,
        TVector<NYdb::NTable::TRenameItem>,
        NYdb::NTable::TRenameTablesSettings
    );
    DEFINE_GENERIC_REQUEST_RESPONSE(
        DescribeTable,
    ...
    DEFINE_GENERIC_REQUEST_RESPONSE(
        ...
        TString,
        NYdb::NTopic::TDescribeTopicSettings
    );
    DEFINE_GENERIC_REQUEST_RESPONSE(
        DescribeConsumer,
        NYdb::NTopic::TDescribeConsumerResult,
        TString,
        TString,
        NYdb::NTopic::TDescribeConsumerSettings
    );
