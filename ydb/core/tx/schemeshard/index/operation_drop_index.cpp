...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TDropIndexAtMainTable TConfigureParts"},
...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TDropIndexAtMainTable TPropose"},
            {"operationId", OperationId});
    }
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDB_LOG_NOTICE_CTX(context.Ctx, "TDropIndexAtMainTable Propose / index",
            {"path", workingDir},
            {"mainTableName", mainTableName},
            {"name", indexName},
            {"opId", OperationId},
            {"schemeshard", ssId});
        YDB_LOG_DEBUG_CTX(context.Ctx, "TDropIndexAtMainTable Propose",
    ...
    void AbortPropose(TOperationContext& context) override {
        YDB_LOG_NOTICE_CTX(context.Ctx, "TDropIndexAtMainTable AbortPropose",
            {"opId", OperationId},
