...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropTableIndex Propose, path: /, pathId: , operationId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
    ...
    void AbortPropose(TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropTableIndex AbortPropose, opId: , at schemeshard: ",
            {"opId", OperationId},
            {"schemeshard", context.SS->TabletID()});
    }

    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropTableIndex AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
