...
public:
    ...
    bool ProgressState(TOperationContext& context) override {
        ...
        for (ui32 i = 0; i < txState->Shards.size(); ++i) {
            ...
            YDB_LOG_DEBUG_CTX(context.Ctx, "ProgressState SEND TFlatSchemeTransaction with drop snapshot request",
                {"debugHint", DebugHint()},
...
public:
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        for(auto& column: tableInfo->Columns) {
            ...
            YDB_LOG_INFO_CTX(context.Ctx, "HandleReply ProgressState terminating build column process at column",
                {"debugHint", DebugHint()},
                {"atTablet", ssId},
