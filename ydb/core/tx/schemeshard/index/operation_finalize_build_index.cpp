...
public:
    ...
    bool ProgressState(TOperationContext& context) override {
        ...
        for (ui32 i = 0; i < txState->Shards.size(); ++i) {
            ...
            YDBLOG_CTX_DEBUG(context.Ctx, "ProgressState SEND TFlatSchemeTransaction with drop snapshot request",
                {"#_DebugHint()", DebugHint()},
...
public:
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        for(auto& column: tableInfo->Columns) {
            ...
            YDBLOG_CTX_INFO(context.Ctx, "HandleReply ProgressState terminating build column process at column",
                {"#_DebugHint()", DebugHint()},
                {"at_tablet", ssId},
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TFinalizeBuildIndex Propose /",
            {"path", parentPathStr},
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TFinalizeBuildIndex AbortUnsafe",
            {"opId", OperationId},
