...
public:
    ...
    bool ProgressState(TOperationContext& context) override {
        ...
        for (ui32 i = 0; i < txState->Shards.size(); ++i) {
            ...
            YDBLOG_CTX_DEBUG(context.Ctx, "ProgressState SEND TFlatSchemeTransaction with create snapshot request",
                {"#_DebugHint()", DebugHint()},
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TInitializeBuildIndex Propose /",
            {"path", parentPathStr},
    ...
    void AbortPropose(TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TInitializeBuildIndex AbortPropose",
            {"opId", OperationId},
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TInitializeBuildIndex AbortUnsafe",
            {"opId", OperationId},
