...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TInitializeBuildIndex TConfigureParts"},
...
public:
    ...
    bool ProgressState(TOperationContext& context) override {
        ...
        for (ui32 i = 0; i < txState->Shards.size(); ++i) {
            ...
            YDB_LOG_DEBUG_CTX(context.Ctx, "ProgressState SEND TFlatSchemeTransaction to with create snapshot request",
                {"debugHint", DebugHint()},
...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TInitializeBuildIndex TPropose"},
            {"operationId", OperationId});
    }
...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TInitializeBuildIndex TCreateTxShards"},
            {"operationId", OperationId});
    }
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDB_LOG_NOTICE_CTX(context.Ctx, "TInitializeBuildIndex Propose",
            {"path", parentPathStr},
            {"tableName", tableName},
            {"opId", OperationId},
            {"schemeshard", ssId});
