...
private:
    TString DebugHint() const override {
        return TStringBuilder() << "TDropOlapStore TDropParts"
...
private:
    TString DebugHint() const override {
        return TStringBuilder() << "TDropOlapStore TPropose"
                                << " operationId#" << OperationId;
    }
...
private:
    TString DebugHint() const override {
        return TStringBuilder() << "TDropOlapStore TProposedWaitParts"
                                << " operationId#" << OperationId;
    }
...
private:
    TString DebugHint() const override {
        return TStringBuilder() << "TDropOlapStore TProposedDeleteParts"
                                << " operationId#" << OperationId;
    }
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
...

        {
            ...
            if (!checks) {
                ...
                if (path.IsResolved() && path.Base()->IsOlapStore() &&
