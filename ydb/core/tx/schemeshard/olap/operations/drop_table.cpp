...
public:
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        YDBLOG_CTX_INFO(context.Ctx, " HandleReply TEvOperationPlan at schemeshard: , stepId: ",
            {"#_DebugHint()", DebugHint()},
            {"schemeshard", ssId},
            {"stepId", step});
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropColumnTable Propose, path: /, pathId: , opId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
            {"pathId", drop.GetId()},
            {"opId", OperationId},
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropColumnTable AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
