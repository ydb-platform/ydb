...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TAlterUserAttrs Propose, path: /, operationId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
    ...
    bool ProgressState(TOperationContext& context) override {
        YDBLOG_CTX_INFO(context.Ctx, "TAlterUserAttrs ProgressState, opId: , at schemeshard: ",
            {"opId", OperationId},
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        YDBLOG_CTX_INFO(context.Ctx, "TAlterUserAttrs HandleReply TEvOperationPlan, opId: , stepId:, at schemeshard: ",
            {"opId", OperationId},
            {"stepId", step},
            {"schemeshard", ssId});
        ...
        if (txState->State != TTxState::Propose) {
            YDBLOG_CTX_WARN(context.Ctx, "Duplicate PlanStep opId# at schemeshard:  txState is in state#",
                {"opId", OperationId},
                {"schemeshard", ssId},
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TAlterUserAttrs AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
