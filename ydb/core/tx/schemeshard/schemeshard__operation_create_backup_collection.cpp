...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDB_LOG_CTX_NOTICE(context.Ctx, "TCreateBackupCollection Propose: /",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId},
            {"path", rootPathStr},
            {"name", name});
    ...
    void AbortPropose(TOperationContext& context) override {
        YDB_LOG_CTX_NOTICE(context.Ctx, "TCreateBackupCollection AbortPropose:",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId});
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDB_LOG_CTX_NOTICE(context.Ctx, "TCreateBackupCollection AbortUnsafe:",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId},
            {"txId", forceDropTxId});
