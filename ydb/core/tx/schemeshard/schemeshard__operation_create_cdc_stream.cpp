...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDBLOG_CTX_DEBUG(context.Ctx, "DoNewStream: Set CdcPathId, operationId: , cdcPathId: , streamName: , at schemeshard: ",
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        if (streamPath.IsResolved()) {
            txState.CdcPathId = streamPath.Base()->PathId;
            YDBLOG_CTX_DEBUG(context.Ctx, "TNewCdcStreamAtTable: Set CdcPathId, operationId: , cdcPathId: , streamName: , at schemeshard: ",
                {"operationId", OperationId},
                {"cdcPathId", streamPath.Base()->PathId},
