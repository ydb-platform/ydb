...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TCreateExtSubDomain Propose, path/, opId: , at schemeshard: ",
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TCreateExtSubDomain AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
