...
public:
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TCreateFileStore AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
    ...
    TOperationContext& context)
{
    ...
    YDBLOG_CTX_NOTICE(context.Ctx, "TCreateFileStore Propose, path: /, opId: , at schemeshard: ",
        {"path", parentPathStr},
        {"#_name", name},
        {"opId", OperationId},
        {"schemeshard", ssId});
