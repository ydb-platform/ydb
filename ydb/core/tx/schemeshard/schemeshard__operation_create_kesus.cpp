...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TCreateKesus TConfigureParts"},
...
public:
    ...
    bool HandleReply(NKesus::TEvKesus::TEvSetConfigResult::TPtr& ev, TOperationContext& context) override {
        ...
        YDB_LOG_DEBUG_CTX(context.Ctx, "TCreateKesus TConfigureParts HandleReply TEvSetConfigResult at tablet",
            {"operationId", OperationId},
            {"ssId", ssId});
    ...
    bool ProgressState(TOperationContext& context) override {
        auto ssId = context.SS->SelfTabletId();
        YDB_LOG_DEBUG_CTX(context.Ctx, "TCreateKesus TConfigureParts ProgressState at tablet",
            {"operationId", OperationId},
            {"ssId", ssId});
...
private:
    ...
    NActors::NStructuredLog::TStructuredMessage DebugHint() const override {
        return YDB_LOG_CREATE_MESSAGE(
            {"operationKind", "TCreateKesus TPropose"},
            {"operationId", OperationId});
    }
