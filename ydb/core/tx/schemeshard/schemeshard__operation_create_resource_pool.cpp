...
public:
    ...
    static bool IsDestinationPathValid(const std::unique_ptr<TProposeResponse>& result, const TOperationContext& context, const TPath& dstPath, const TString& acl, bool acceptExisted) {
