...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TCreateSolomon Propose, path: /, opId: , channelProfileId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
            {"opId", OperationId},
    ...
    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TCreateSolomon AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
