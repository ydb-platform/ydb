...
using TAffectedESchemeOpCreateSubDomain = TAffectedPathsTraits<NKikimrSchemeOp::EOperationType::ESchemeOpCreateSubDomain>;

namespace NOperation {

template <>
std::optional<TAffectedPaths> GetAffectedPaths<TAffectedESchemeOpCreateSubDomain>(
    TAffectedESchemeOpCreateSubDomain,
    const TTxTransaction& tx,
