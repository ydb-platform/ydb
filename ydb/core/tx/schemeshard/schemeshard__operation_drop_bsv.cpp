...
using TAffectedESchemeOpDropBlockStoreVolume = TAffectedPathsTraits<NKikimrSchemeOp::EOperationType::ESchemeOpDropBlockStoreVolume>;

namespace NOperation {

template <>
std::optional<TAffectedPaths> GetAffectedPaths<TAffectedESchemeOpDropBlockStoreVolume>(
    TAffectedESchemeOpDropBlockStoreVolume,
