...
public:
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        SendTopicCloudEvent(
            BuildCdcStreamModifyScheme(TPath::Init(pathId, context.SS).PathString(), NKikimrSchemeOp::ESchemeOpDropCdcStream),
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        for (const auto& streamPath : streamPaths) {
            ...
            SendTopicCloudEvent(
                BuildCdcStreamModifyScheme(streamPath.PathString(), NKikimrSchemeOp::ESchemeOpDropCdcStream),
                NKikimrScheme::StatusSuccess,
                TString(),
                context.SS,
                context.PeerName,
