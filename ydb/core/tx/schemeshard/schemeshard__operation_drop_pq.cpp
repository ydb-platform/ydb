...
using TAffectedESchemeOpDropPersQueueGroup = TAffectedPathsTraits<NKikimrSchemeOp::EOperationType::ESchemeOpDropPersQueueGroup>;

namespace NOperation {

template <>
std::optional<TAffectedPaths> GetAffectedPaths<TAffectedESchemeOpDropPersQueueGroup>(
    TAffectedESchemeOpDropPersQueueGroup,
