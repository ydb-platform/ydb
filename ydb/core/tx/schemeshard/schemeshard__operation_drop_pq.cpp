...
public:
    ...
    bool HandleReply(TEvPersQueue::TEvDropTabletReply::TPtr& ev, TOperationContext& context) override {
        ...
        YDBLOG_CTX_DEBUG(context.Ctx, "TDropParts HandleReply TEvPersQueue::TEvDropTabletReply operationId#  at tabletId#  message# ",
            {"operationId", OperationId},
            {"tabletId", ssId},
    ...
    bool ProgressState(TOperationContext& context) override {
        auto ssId = context.SS->SelfTabletId();
        YDBLOG_CTX_DEBUG(context.Ctx, "TDropParts ProgressState operationId#  at tablet ",
            {"operationId", OperationId},
            {"#_ssId", ssId});
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TDropPQ Propose, path: /, pathId: , opId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
            {"pathId", drop.GetId()},
            {"opId", OperationId},
