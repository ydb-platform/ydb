...
class TDropParts: public TSubOperationState {
    TString DebugHint() const override {
        return TStringBuilder() << "TDropReplication TDropParts"
                                << " opId# " << OperationId << " ";
    }
...
public:
    ...
    bool HandleReply(NReplication::TEvController::TEvDropReplicationResult::TPtr& ev, TOperationContext& context)
        override {
...
class TPropose: public TSubOperationState {
    TString DebugHint() const override {
        return TStringBuilder() << "TDropReplication TPropose"
                                << " opId# " << OperationId << " ";
    }
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString&, TOperationContext& context) override {
        ...
        const auto path = op.HasId() ? TPath::Init(context.SS->MakeLocalId(op.GetId()), context.SS)
        ...
        const auto txType = Cascade ? TTxState::TxDropReplicationCascade : TTxState::TxDropReplication;
