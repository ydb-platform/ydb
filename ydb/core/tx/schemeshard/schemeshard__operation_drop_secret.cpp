...
using TAffectedESchemeOpDropSecret = TAffectedPathsTraits<NKikimrSchemeOp::EOperationType::ESchemeOpDropSecret>;

namespace NOperation {

template <>
std::optional<TAffectedPaths> GetAffectedPaths<TAffectedESchemeOpDropSecret>(
    TAffectedESchemeOpDropSecret,
