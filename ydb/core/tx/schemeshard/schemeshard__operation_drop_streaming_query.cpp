...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDB_LOG_CTX_NOTICE(context.Ctx, "TDropStreamingQuery Propose: /",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId},
            {"path", parentPathStr},
            {"name", name});
    ...
    void AbortPropose(TOperationContext& context) override {
        YDB_LOG_CTX_NOTICE(context.Ctx, "TDropStreamingQuery AbortPropose:",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId});
    }

    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDB_LOG_CTX_NOTICE(context.Ctx, "TDropStreamingQuery AbortUnsafe:",
            {"TabletID", context.SS->TabletID()},
            {"opId", OperationId},
            {"txId", forceDropTxId});
