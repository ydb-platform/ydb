...
using TAffectedESchemeOpDropView = TAffectedPathsTraits<NKikimrSchemeOp::EOperationType::ESchemeOpDropView>;

namespace NOperation {

template <>
std::optional<TAffectedPaths> GetAffectedPaths<TAffectedESchemeOpDropView>(
    TAffectedESchemeOpDropView,
