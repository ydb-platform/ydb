...
public:
    ...
    bool HandleReply(TEvPrivate::TEvOperationPlan::TPtr& ev, TOperationContext& context) override {
        ...
        YDBLOG_CTX_INFO(context.Ctx, " HandleReply TEvPrivate::TEvOperationPlan, step: , at schemeshard: ",
...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        YDBLOG_CTX_NOTICE(context.Ctx, "TMkDir Propose, path: /, operationId: , at schemeshard: ",
            {"path", parentPathStr},
            {"#_name", name},
            {"operationId", OperationId},
            {"schemeshard", ssId});
        ...
        if (Transaction.HasTempDirOwnerActorId()) {
            YDBLOG_CTX_DEBUG(context.Ctx, "Processing create temp directory with Name: , WorkingDir: , TempDirOwnerActorId: , PathId: ",
                {"Name", name},
    ...
    void AbortPropose(TOperationContext& context) override {
        YDBLOG_CTX_INFO(context.Ctx, "MkDir AbortPropose, opId: , at schemeshard: ",
            {"opId", OperationId},
            {"schemeshard", context.SS->TabletID()});
    }

    void AbortUnsafe(TTxId forceDropTxId, TOperationContext& context) override {
        YDBLOG_CTX_NOTICE(context.Ctx, "TMkDir AbortUnsafe, opId: , forceDropId: , at schemeshard: ",
            {"opId", OperationId},
