...
public:
    ...
    THolder<TProposeResponse> Propose(const TString& owner, TOperationContext& context) override {
        ...
        // A directory generated by a planned operation is a physical write of the plan, not a
        // logical effect; its bindings point at that write.
        const TString name = IsPlanned()
            ? GetPlan().Write(BindingsAs<TMkDirPartBindings>().Target).LeafName
            : Transaction.GetMkDir().GetName();
        ...
        NSchemeShard::TPath parentPath = IsPlanned()
            ? PlannedWritePath(BindingsAs<TMkDirPartBindings>().Container, context)
