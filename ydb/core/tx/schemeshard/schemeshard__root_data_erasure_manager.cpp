...
TRootShredManager::TRootShredManager(TSchemeShard* const schemeShard, const NKikimrConfig::TShredConfig& config)
    : TShredManager(schemeShard)
    , Starter(this)
    , Queue(new TQueue(ConvertConfig(config), Starter))
    , ShredInterval(TDuration::Seconds(config.GetShredIntervalSeconds()))
...
void TRootShredManager::UpdateConfig(const NKikimrConfig::TShredConfig& config) {
...
TRootShredManager::TQueue::TConfig TRootShredManager::ConvertConfig(const NKikimrConfig::TShredConfig& config) {
