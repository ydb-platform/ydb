...
public:
    ...
    virtual void UpdateConfig(const NKikimrConfig::TShredConfig& config) = 0;
    virtual void Start();
    virtual void Stop();
...
public:
    TRootShredManager(TSchemeShard* const schemeShard, const NKikimrConfig::TShredConfig& config);

    void UpdateConfig(const NKikimrConfig::TShredConfig& config) override;
    void Start() override;
    void Stop() override;
...
private:
    static TQueue::TConfig ConvertConfig(const NKikimrConfig::TShredConfig& config);
...
public:
    TTenantShredManager(TSchemeShard* const schemeShard, const NKikimrConfig::TShredConfig& config);
