...
struct TSchemeShard::TTxSyncTenant : public TSchemeShard::TRwTxBase {
    ...
    void DoExecute(TTransactionContext &txc, const TActorContext &ctx) override {
        YDBLOG_CTX_DEBUG(ctx, "TTxSyncTenant DoExecute, pathId: , at schemeshard: ",
            {"pathId", PathId},
    ...
    void DoComplete(const TActorContext &ctx) override {
        YDBLOG_CTX_DEBUG(ctx, "TTxSyncTenant DoComplete, pathId: , at schemeshard: ",
            {"pathId", PathId},
            {"schemeshard", Self->TabletID()});
...
struct TSchemeShard::TTxUpdateTenant : public TSchemeShard::TRwTxBase {
    ...
    void DoExecute(TTransactionContext &txc, const TActorContext &ctx) override {
        ...
        YDBLOG_CTX_DEBUG(ctx, "TTxUpdateTenant DoExecute, msg: , at schemeshard: ",
