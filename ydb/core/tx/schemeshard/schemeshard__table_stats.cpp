...
private:
     ...
     * @param[in] shardIsOversized If true, split is blocked for an oversized shard and should be logged as warning
     */
            ...
            if (shardIsOversized) {
                ...
                LOG_NOTICE_S(
                    ...
                    "Do not request full stats from datashard " << datashardId
                        << " (size " << newPartitionStats.DataSize << ")"
