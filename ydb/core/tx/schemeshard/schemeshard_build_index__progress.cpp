...
public:
    ...
    bool InitiateShards(NIceDb::TNiceDb& db, TIndexBuildInfo& buildInfo) {
        ...
        buildInfo.Cluster2Shards.clear();
        for (const auto& x: table->GetPartitions()) {
<<<<<<< HEAD:ydb/core/tx/schemeshard/schemeshard_build_index__progress.cpp
...
>>>>>>> 873abc2997b (schemeshard: optimize split/merge in-memory update (#38803)):ydb/core/tx/schemeshard/index/build_index__progress.cpp
