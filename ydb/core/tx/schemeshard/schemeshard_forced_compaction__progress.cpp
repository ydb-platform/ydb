...
struct TSchemeShard::TForcedCompaction::TTxProgress: public TRwTxBase {
    ...
    void DoExecute(TTransactionContext &txc, const TActorContext &ctx) override {
        YDB_LOG_DEBUG_CTX(ctx, "][ForcedCompaction] TForcedCompaction::TTxProgress DoExecute ForcedCompactionsDoneShardsToPersist CancellingForcedCompactions",
    ...
    void DoComplete(const TActorContext &ctx) override {
        YDB_LOG_DEBUG_CTX(ctx, "][ForcedCompaction] TForcedCompaction::TTxProgress DoComplete ForcedCompactionsDoneShardsToPersist CancellingForcedCompactions",
            {"selfTabletId", Self->SelfTabletId()},
            {"size", Self->ForcedCompactionsDoneShardsToPersist.size()},
            {"#_size", Self->CancellingForcedCompactions.size()});
