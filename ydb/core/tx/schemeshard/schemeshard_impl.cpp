...
void TSchemeShard::PersistSecret(NIceDb::TNiceDb& db, TPathId pathId, const TSecretInfo& secretInfo) {
    ...
    db.Table<Schema::Secret>().Key(pathId.LocalPathId).Update(
        NIceDb::TUpdate<Schema::Secret::AlterVersion>(secretInfo.AlterVersion),
        NIceDb::TUpdate<Schema::Secret::Description>(serializedDescription));
}
...
void TSchemeShard::PersistSecretRemove(NIceDb::TNiceDb& db, TPathId pathId) {
    ...
    DecrementPathDbRefCount(pathId);
    db.Table<Schema::Secret>().Key(pathId.LocalPathId).Delete();
}
...
void TSchemeShard::PersistSecretAlter(NIceDb::TNiceDb& db, TPathId pathId, const TSecretInfo& secretInfo) {
    ...
    db.Table<Schema::SecretAlterData>().Key(pathId.LocalPathId).Update(
        NIceDb::TUpdate<Schema::SecretAlterData::AlterVersion>(secretInfo.AlterVersion),
        NIceDb::TUpdate<Schema::SecretAlterData::Description>(serializedDescription));
}
...
void TSchemeShard::PersistSecretAlterRemove(NIceDb::TNiceDb& db, TPathId pathId) {
    ...
    db.Table<Schema::SecretAlterData>().Key(pathId.LocalPathId).Delete();
}
