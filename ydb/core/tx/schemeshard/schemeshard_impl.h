...
public:
    ...
    NTabletFlatExecutor::ITransaction* CreateTxProgressExport(TEvPrivate::TEvExportMetadataUploaded::TPtr& ev);
    ...
    void Handle(TEvPrivate::TEvExportMetadataUploaded::TPtr& ev, const TActorContext& ctx);
