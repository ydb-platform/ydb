...
public:
    ...
    void PersistSetColumnConstraintValidationShardStatus(NIceDb::TNiceDb& db, TIndexBuildId operationId, TShardIdx shardIdx, const TValidateColumnConstraintShardStatus& status);
