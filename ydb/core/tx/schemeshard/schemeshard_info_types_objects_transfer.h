...
struct TImportInfo: public TSimpleRefCount<TImportInfo> {
    ...
    struct TItem {
        ...
        TVector<std::pair<::NKikimr::NBackup::TIndexMetadata, Ydb::Table::CreateTableRequest>> MaterializedIndexes;
        ...
        TMaybe<::NKikimr::NBackup::TEncryptionIV> ExportItemIV;
    ...
    TMaybe<::NKikimr::NBackup::TEncryptionIV> ExportIV;
    TMaybe<::NKikimr::NBackup::TSchemaMapping> SchemaMapping;
