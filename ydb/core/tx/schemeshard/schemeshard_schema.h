...
struct Schema: NIceDb::Schema {
    struct Paths: Table<1> {
        ...
        struct StepCreated: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        struct CreateTxId: Column<7, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct StepDropped: Column<8, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        struct DropTxId: Column<9, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct Owner: Column<10, NScheme::NTypeIds::Utf8> {};
        struct ACL: Column<11, NScheme::NTypeIds::String> {};
        struct LastTxId: Column<12, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        ...
        struct ParentOwnerId: Column<16, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
        struct TempDirOwnerActorId
            : Column<17, NScheme::NTypeIds::String> {}; // Only for EPathType::EPathTypeDir.
    ...
    struct MigratedPaths: Table<50> {
        struct OwnerPathId: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalPathId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct ParentOwnerId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct ParentLocalId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct Name: Column<5, NScheme::NTypeIds::Utf8> {};
        struct PathType: Column<6, NScheme::NTypeIds::Uint32> {};
        struct StepCreated: Column<7, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        struct CreateTxId: Column<8, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct StepDropped: Column<9, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        struct DropTxId: Column<10, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct Owner: Column<11, NScheme::NTypeIds::Utf8> {};
        struct ACL: Column<12, NScheme::NTypeIds::String> {};
        struct LastTxId: Column<13, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
    ...
    struct TxInFlight: Table<2> { // not in use
        ...
        struct MinStep: Column<8, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        ...
        using TColumns =
            TableColumns<TxId, TxType, TargetPathId, State, MinStep, ExtraBytes, StartTime, DataTotalSize, PlanStep>;
    };
    ...
    struct TxDependencies: Table<3> {
        ...
        struct DependentTxId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
    ...
    struct Columns: Table<6> {
        ...
        struct DefaultKind: Column<9, NScheme::NTypeIds::Uint32> {
            using Type = ETableColumnDefaultKind;
            static constexpr Type Default = Type::None;
        };
    ...
    struct MigratedColumns: Table<55> {
        ...
        struct DefaultKind: Column<10, NScheme::NTypeIds::Uint32> {
            using Type = ETableColumnDefaultKind;
            static constexpr Type Default = Type::None;
        };
    ...
    struct Shards: Table<7> {
        struct ShardIdx: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        struct TabletId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TTabletId;
        };
        ...
        struct TabletType: Column<5, NScheme::NTypeIds::Uint32> {
            using Type = TTabletTypes::EType;
            static constexpr Type Default = ETabletType::TypeInvalid;
        };
        struct OwnerPathId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
    ...
    struct MigratedShards: Table<52> {
        struct OwnerShardId: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        ...
        struct OwnerPathId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalPathId: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };

        // there can be only 1 schema Tx on a shard at any moment in time
        struct LastTxId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct TabletType: Column<7, NScheme::NTypeIds::Uint32> {
            using Type = TTabletTypes::EType;
            static constexpr Type Default = ETabletType::TypeInvalid;
        };
        ...
        using TColumns =
            TableColumns<OwnerShardId, LocalShardId, TabletId, OwnerPathId, LocalPathId, LastTxId, TabletType>;
    };

    struct ChannelsBinding: Table<28> {
        struct ShardId: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct TablePartitions: Table<8> {
        ...
        struct RangeEnd: Column<3, NScheme::NTypeIds::String> {
            using Type = TString;
        };
        struct DatashardIdx: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct TablePartitionStats: Table<101> { // HACK: Force to use policy with multiple levels
        ...
        struct TableLocalId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        ...
        struct LastAccessTime: Column<9, NScheme::NTypeIds::Uint64> {
            using Type = TInstant::TValue;
        };
        struct LastUpdateTime: Column<10, NScheme::NTypeIds::Uint64> {
            using Type = TInstant::TValue;
        };
        ...
        struct TxCompleteLag: Column<15, NScheme::NTypeIds::Uint64> {
            using Type = TInstant::TValue;
        };
        ...
        struct SearchHeight: Column<30, NScheme::NTypeIds::Uint64> {
            static constexpr ui64 Default = 0;
        };
        struct FullCompactionTs: Column<31, NScheme::NTypeIds::Uint64> {
            static constexpr ui64 Default = 0;
        };
        struct MemDataSize: Column<32, NScheme::NTypeIds::Uint64> {
            static constexpr ui64 Default = 0;
        };
        ...
        struct StoragePoolsStats: Column<33, NScheme::NTypeIds::String> {
            using Type = TString;
        };
    ...
    struct MigratedTablePartitions: Table<56> {
        ...
        struct RangeEnd: Column<4, NScheme::NTypeIds::String> {
            using Type = TString;
        };
        struct OwnerShardIdx: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardIdx: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct PersQueueGroups: Table<9> {
        ...
        using TColumns =
            TableColumns<PathId, TabletConfig, MaxPQPerShard, AlterVersion, NextPartitionId, TotalGroupCount>;
    };
    ...
    struct PersQueueGroupAlters: Table<12> {
        ...
        struct BootstrapConfig: Column<7, NScheme::NTypeIds::String> {
            using Type = TString;
        };
    ...
    struct PersQueues: Table<10> {
        ...
        struct ShardIdx: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        struct AlterVersion: Column<4, NScheme::NTypeIds::Uint64> {};
        struct GroupId: Column<5, NScheme::NTypeIds::Uint32> {};
        struct RangeBegin: Column<6, NScheme::NTypeIds::String> {
            using Type = TString;
        };
        struct RangeEnd: Column<7, NScheme::NTypeIds::String> {
            using Type = TString;
        };
    ...
    struct RTMRPartitions: Table<25> {
        ...
        struct ShardIdx: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct AlterSolomonPartitions: Table<76> {
        ...
        struct ShardOwnerId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct ShardLocalIdx: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct MigratedShardsToDelete: Table<60> {
        struct ShardOwnerId: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct ShardLocalIdx: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
    ...
    struct ShardBackupStatus: Table<17> {
        ...
        using TKey = TableKey<TxId, ShardIdx>;
        using TColumns = TableColumns<TxId, ShardIdx, Explain>;
    };
    ...
    struct MigratedShardBackupStatus: Table<66> {
        ...
        struct OwnerShardId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        struct Explain: Column<4, NScheme::NTypeIds::Utf8> {};

        using TKey = TableKey<TxId, OwnerShardId, LocalShardId>;
        using TColumns = TableColumns<TxId, OwnerShardId, LocalShardId, Explain>;
    };
    ...
    struct TxShardStatus: Table<87> {
        ...
        using TKey = TableKey<TxId, OwnerShardId, LocalShardId>;
        using TColumns = TableColumns<TxId, OwnerShardId, LocalShardId, Success, Error, BytesProcessed, RowsProcessed>;
    };
    ...
    struct SubDomains: Table<18> {
        ...
        struct ResourcesDomainOwnerPathId: Column<18, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
        struct ResourcesDomainLocalPathId: Column<19, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
            static constexpr Type Default = InvalidLocalPathId;
        };
        struct SharedHiveId: Column<20, NScheme::NTypeIds::Uint64> {
            using Type = TTabletId;
            static constexpr Type Default = InvalidTabletId;
        };
        ...
        struct ServerlessComputeResourcesMode: Column<31, NScheme::NTypeIds::Uint32> {
            using Type = EServerlessComputeResourcesMode;
        };
    ...
    struct SubDomainsAlterData: Table<33> {
        ...
        struct PlanResolution: Column<3, NScheme::NTypeIds::Uint64> {};
        struct TimeCastBuckets: Column<4, NScheme::NTypeIds::Uint32> {};
        struct ResourcesDomainOwnerPathId: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
        struct ResourcesDomainLocalPathId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
            static constexpr Type Default = InvalidLocalPathId;
        };
        struct SharedHiveId: Column<7, NScheme::NTypeIds::Uint64> {
            using Type = TTabletId;
            static constexpr Type Default = InvalidTabletId;
        };
        ...
        struct ServerlessComputeResourcesMode: Column<11, NScheme::NTypeIds::Uint32> {
            using Type = EServerlessComputeResourcesMode;
        };
    ...
    struct KesusInfos: Table<26> {
        ...
        struct Config: Column<2, NScheme::NTypeIds::String> {};
        struct Version: Column<3, NScheme::NTypeIds::Uint64> {
            static constexpr ui64 Default = 1;
        };
    ...
    struct AdoptedShards: Table<31> {
        ...
        struct PrevShardIdx: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        struct TabletId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TTabletId;
        };
    ...
    struct TableIndex: Table<38> {
        struct PathId: Column<1, NScheme::NTypeIds::Uint64> {};
        struct AlterVersion: Column<3, NScheme::NTypeIds::Uint64> {};
        struct IndexType: Column<4, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::EIndexType;
            static constexpr Type Default = NKikimrSchemeOp::EIndexTypeInvalid;
        };
        struct State: Column<5, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::EIndexState;
            static constexpr Type Default = NKikimrSchemeOp::EIndexStateInvalid;
        };
    ...
    struct TxInFlightV2: Table<42> {
        ...
        struct TxPartId: Column<2, NScheme::NTypeIds::Uint32> {
            using Type = TSubTxId;
        };
        ...
        struct MinStep: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
        ...
        struct TargetOwnerPathId: Column<11, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
        struct BuildIndexId: Column<12, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct SourceOwnerId: Column<13, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
            static constexpr Type Default = InvalidOwnerId;
        };
        struct SourceLocalPathId: Column<14, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
            static constexpr Type Default = InvalidLocalPathId;
        };
        struct PlanStep: Column<15, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };
    ...
    struct TxDependenciesV2: Table<43> { // has died before release
        ...
        struct DependentTxId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct DependentTxPartId: Column<4, NScheme::NTypeIds::Uint32> {
            using Type = TSubTxId;
        };
    ...
    struct Exports: Table<45> {
        ...
        struct ExportPathId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct State: Column<7, NScheme::NTypeIds::Byte> {};
        struct WaitTxId: Column<8, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct Issue: Column<9, NScheme::NTypeIds::Utf8> {};
        struct ExportOwnerPathId: Column<10, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct DomainPathOwnerId: Column<11, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
    ...
    struct ExportItems: Table<46> {
        ...
        struct SourcePathId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };

        struct State: Column<5, NScheme::NTypeIds::Byte> {};
        struct BackupTxId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct Issue: Column<7, NScheme::NTypeIds::Utf8> {};
        struct SourceOwnerPathId: Column<8, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };

        using TKey = TableKey<ExportId, Index>;
        using TColumns =
            TableColumns<ExportId, Index, SourcePathName, SourcePathId, State, BackupTxId, Issue, SourceOwnerPathId>;
    };
    ...
    struct TableShardPartitionConfigs: Table<47> {
        ...
        using TKey = TableKey<ShardIdx>;
        using TColumns = TableColumns<ShardIdx, PartitionConfig>;
    };

    struct MigratedTableShardPartitionConfigs: Table<57> {
        struct OwnerShardIdx: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardIdx: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };
        struct PartitionConfig: Column<3, NScheme::NTypeIds::String> {};

        using TKey = TableKey<OwnerShardIdx, LocalShardIdx>;
        using TColumns = TableColumns<OwnerShardIdx, LocalShardIdx, PartitionConfig>;
    };
    ...
    struct RevertedMigrations: Table<58> {
        ...
        struct SchemeShardId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TTabletId;
        };
    ...
    struct IndexBuild: Table<69> {
        struct Id: Column<1, NScheme::NTypeIds::Uint64> {
            using Type = TIndexBuildId;
        };
        struct Uid: Column<2, NScheme::NTypeIds::Utf8> {};

        struct DomainOwnerId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct DomainLocalId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct TableOwnerId: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct TableLocalId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct IndexName: Column<7, NScheme::NTypeIds::Utf8> {};
        struct IndexType: Column<8, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::EIndexType;
        };
        ...
        struct InitiateTxId: Column<11, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct InitiateTxStatus: Column<12, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrScheme::EStatus;
        };
        struct InitiateTxDone: Column<13, NScheme::NTypeIds::Bool> {};

        struct LockTxId: Column<14, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct LockTxStatus: Column<15, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrScheme::EStatus;
        };
        ...
        struct ApplyTxId: Column<20, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct ApplyTxStatus: Column<21, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrScheme::EStatus;
        };
        struct ApplyTxDone: Column<22, NScheme::NTypeIds::Bool> {};

        struct UnlockTxId: Column<23, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct UnlockTxStatus: Column<24, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrScheme::EStatus;
        };
        ...
        struct AlterMainTableTxId: Column<31, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };
        struct AlterMainTableTxStatus: Column<32, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrScheme::EStatus;
        };
    ...
    struct IndexBuildColumns: Table<70> {
        ...
        struct ColumnKind: Column<4, NScheme::NTypeIds::Uint8> {
            using Type = EIndexColumnKind;
        };

        using TKey = TableKey<Id, ColumnNo>;
        using TColumns = TableColumns<Id, ColumnNo, ColumnName, ColumnKind>;
    };
    ...
    struct SnapshotTables: Table<71> {
        ...
        struct TableOwnerId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct TableLocalId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };

        using TKey = TableKey<Id, TableOwnerId, TableLocalId>;
        using TColumns = TableColumns<Id, TableOwnerId, TableLocalId>;
    };
    ...
    struct SnapshotSteps: Table<72> {
        ...
        struct StepId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TStepId;
        };

        using TKey = TableKey<Id>;
        using TColumns = TableColumns<Id, StepId>;
    };
    ...
    struct LongLocks: Table<73> {
        ...
        struct PathLocalId: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
        struct LockId: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TTxId;
        };

        using TKey = TableKey<PathOwnerId, PathLocalId>;
        using TColumns = TableColumns<PathOwnerId, PathLocalId, LockId>;
    };
    ...
    struct IndexBuildShardStatus: Table<74> {
        ...
        struct OwnerShardIdx: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardIdx: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };

        struct Range: Column<4, NScheme::NTypeIds::String> {
            using Type = NKikimrTx::TKeyRange;
        };
        struct LastKeyAck: Column<5, NScheme::NTypeIds::String> {
            using Type = TString;
        };

        struct Status: Column<6, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrIndexBuilder::EBuildStatus;
        };
        struct Message: Column<7, NScheme::NTypeIds::Utf8> {};
        struct UploadStatus: Column<8, NScheme::NTypeIds::Uint32> {
            using Type = Ydb::StatusIds::StatusCode;
        };
    ...
    struct RestoreTasks: Table<82> {
        ...
        using TKey = TableKey<OwnerPathId, LocalPathId>;
        using TColumns = TableColumns<OwnerPathId, LocalPathId, Task>;
    };
    ...
    struct Imports: Table<85> {
        ...
        struct DomainPathOwnerId: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct DomainPathLocalId: Column<6, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
    ...
    struct ImportItems: Table<86> {
        ...
        struct DstPathOwnerId: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct DstPathLocalId: Column<5, NScheme::NTypeIds::Uint64> {
            using Type = TLocalPathId;
        };
    ...
    struct LoginSids: Table<93> {
        ...
        struct SidType: Column<2, NScheme::NTypeIds::Uint64> {
            using Type = NLoginProto::ESidType::SidType;
        };
    ...
    struct CdcStream: Table<95> {
        ...
        struct State: Column<4, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::ECdcStreamState;
            static constexpr Type Default = NKikimrSchemeOp::ECdcStreamStateInvalid;
        };
        struct Mode: Column<5, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::ECdcStreamMode;
            static constexpr Type Default = NKikimrSchemeOp::ECdcStreamModeInvalid;
        };
        struct Format: Column<6, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrSchemeOp::ECdcStreamFormat;
            static constexpr Type Default = NKikimrSchemeOp::ECdcStreamFormatInvalid;
        };
    ...
    struct CdcStreamScanShardStatus: Table<103> {
        ...
        struct OwnerShardIdx: Column<3, NScheme::NTypeIds::Uint64> {
            using Type = TOwnerId;
        };
        struct LocalShardIdx: Column<4, NScheme::NTypeIds::Uint64> {
            using Type = TLocalShardIdx;
        };

        struct Status: Column<5, NScheme::NTypeIds::Uint32> {
            using Type = NKikimrTxDataShard::TEvCdcStreamScanResponse::EStatus;
        };

        using TKey = TableKey<OwnerPathId, LocalPathId, OwnerShardIdx, LocalShardIdx>;
        using TColumns = TableColumns<OwnerPathId, LocalPathId, OwnerShardIdx, LocalShardIdx, Status>;
    };
    ...
    struct ExternalTable: Table<104> {
        ...
        using TKey = TableKey<OwnerPathId, LocalPathId>;
        using TColumns =
            TableColumns<OwnerPathId, LocalPathId, SourceType, DataSourcePath, Location, AlterVersion, Content>;
    };
    ...
    struct BuildColumnOperationSettings: Table<107> {
        ...
        using TKey = TableKey<Id, ColumnNo>;
        using TColumns = TableColumns<Id, ColumnNo, ColumnName, DefaultFromLiteral, NotNull, FamilyName>;
    };
