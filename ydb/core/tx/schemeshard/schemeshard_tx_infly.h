...
//    TNotifications Notify; // volatile set of actors that requested completion notification
    ...
    bool IsItActuallyMerge() {
        return TxType == TTxState::TxSplitTablePartition && SplitDescription &&
