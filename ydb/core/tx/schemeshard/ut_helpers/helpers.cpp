    ...
    TEvIndexBuilder::TEvCreateRequest* CreateBuildIndexRequest(ui64 id, const TString& dbName, const TString& src, const TBuildIndexConfig& cfg) {
        ...
        *index.mutable_data_columns() = {cfg.DataColumns.begin(), cfg.DataColumns.end()};
        ...
        case NKikimrSchemeOp::EIndexTypeGlobalVectorKmeansTree: {
            ...
            settings.mutable_vector_settings()->set_vector_type(Ydb::Table::KMeansTreeSettings::VECTOR_TYPE_FLOAT);
            settings.mutable_vector_settings()->set_vector_dimension(42);
            settings.mutable_vector_settings()->set_distance(Ydb::Table::KMeansTreeSettings::DISTANCE_COSINE);
        } break;
        default:
