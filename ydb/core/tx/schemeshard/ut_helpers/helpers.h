...
struct TDescribeOptionsBuilder: public NKikimrSchemeOp::TDescribeOptions {
    TDescribeOptionsBuilder& SetReturnPartitioningInfo(bool value) {
        TDescribeOptions::SetReturnPartitioningInfo(value);
        return *this;
    }
    TDescribeOptionsBuilder& SetReturnPartitionConfig(bool value) {
        TDescribeOptions::SetReturnPartitionConfig(value);
        return *this;
    }
    TDescribeOptionsBuilder& SetBackupInfo(bool value) {
        TDescribeOptions::SetBackupInfo(value);
        return *this;
    }
    TDescribeOptionsBuilder& SetReturnBoundaries(bool value) {
        TDescribeOptions::SetReturnBoundaries(value);
        return *this;
    }
    TDescribeOptionsBuilder& SetShowPrivateTable(bool value) {
        TDescribeOptions::SetShowPrivateTable(value);
        return *this;
    }
};
...
TString TestLs(
    TTestActorRuntime& runtime,
    const TString& path,
    bool returnPartitioningInfo = false,
    NLs::TCheckFunc check = nullptr
);
TString TestLs(
    TTestActorRuntime& runtime,
    const TString& path,
...
void CheckExpectedStatusCode(
    ...
    Ydb::StatusIds::StatusCode result,
    const TString& reason
);
void TestModificationResult(
    TTestActorRuntime& runtime,
    ui64 txId,
    TEvSchemeShard::EStatus expectedStatus = NKikimrScheme::StatusAccepted
);
...
void TestCancelTxTable(
    ...
    // modify acl
TEvTx*
CreateModifyACLRequest(ui64 txId, TString parentPath, TString name, const TString& diffAcl, const TString& newOwner);
void AsyncModifyACL(
    TTestActorRuntime& runtime,
    ui64 txId,
    TString parentPath,
...
void TestModifyACL(
    ...
    const TString& diffAcl,
    const TString& newOwner,
    TEvSchemeShard::EStatus expectedResult = NKikimrScheme::StatusSuccess
);
void TestModifyACL(
    TTestActorRuntime& runtime,
    ui64 schemeShard,
...
TEvTx* UpgradeSubDomainDecisionRequest(
    ui64 txId,
    const TString& parentPath,
    const TString& name,
    NKikimrSchemeOp::TUpgradeSubDomain::EDecision taskType
);
...
void TestCopyTable(
    ...
    const TString& dstName,
    const TString& srcFullName,
    TEvSchemeShard::EStatus expectedResult = NKikimrScheme::StatusAccepted
);
void TestCopyTable(
    TTestActorRuntime& runtime,
    ui64 txId,
    ...
    // move table
TEvTx* MoveTableRequest(
    ui64 txId,
    const TString& srcPath,
    const TString& dstPath,
    ui64 schemeShard = TTestTxConfig::SchemeShard,
...
void TestMoveTable(
    TTestActorRuntime& runtime,
    ui64 txId,
    const TString& srcMove,
    const TString& dstMove,
    const TVector<TExpectedResult>& expectedResults = {NKikimrScheme::StatusAccepted}
);
void TestMoveTable(
    TTestActorRuntime& runtime,
...
void CreateWithIntermediateDirs(TCreateFunc func) {
    ...
    t.Run([&](TTestActorRuntime& runtime, bool& activeZone) {
...

        {
            ...
            TestDescribeResult(DescribePath(runtime, "/MyRoot/Valid/x/y/z"), {NLs::Finished});
            TestDescribeResult(DescribePath(runtime, "/MyRoot/Invalid"), {NLs::PathNotExist});
        }
    });
}
...
void CreateWithIntermediateDirsForceDrop(TCreateFunc func) {
    ...
    t.Run([&](TTestActorRuntime& runtime, bool& activeZone) {
        ...
        {
            TInactiveZone inactive(activeZone);
            TestDescribeResult(DescribePath(runtime, "/MyRoot/x"), {NLs::PathNotExist});
        }
    });
}
...
TPathId TestFindTabletSubDomainPathId(
    ...
    NKikimrScheme::TEvFindTabletSubDomainPathIdResult::EStatus expected =
        NKikimrScheme::TEvFindTabletSubDomainPathIdResult::SUCCESS
);
TPathId TestFindTabletSubDomainPathId(
    TTestActorRuntime& runtime,
    ui64 schemeShard,
...
public:
    ...
    NMiniKQL::IEngineFlat::EStatus
    Propose(bool immediate, bool& activeZone, ui32 txFlags = NDataShard::TTxFlags::Default);
