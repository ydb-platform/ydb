    ...
    , ChannelsCount(opts.NChannels_)
{
    ...
    // The reverse check is not armed here yet -- see UnfulfilledPathDeclarationIsFatal in
    // schemeshard_affected_paths.h for the ten declarations still to classify.
