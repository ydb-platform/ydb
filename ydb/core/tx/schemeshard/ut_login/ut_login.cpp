...
Y_UNIT_TEST_SUITE(TSchemeShardLoginTest) {
    ...
    Y_UNIT_TEST(BanUnbanUser) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(resultLogin2.error(), "User user1 is not permitted to log in, because it is blocked");
    ...
    Y_UNIT_TEST(BanUserWithWaiting) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(resultLogin.error(), "User user1 is not permitted to log in, because it is blocked");
    }
    ...
    Y_UNIT_TEST(AccountLockoutAndAutomaticallyUnlock) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(resultLogin.error(), TStringBuilder() << "User user1 is not permitted to log in, because the count of password attempts has been exceeded");
    ...
    Y_UNIT_TEST(ChangeAccountLockoutParameters) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(resultLogin.error(), TStringBuilder() << "User user2 is not permitted to log in, because the count of password attempts has been exceeded");
    ...
    Y_UNIT_TEST(ResetFailedAttemptCountAfterModifyUser) {
        ...
        blockUser();
        loginUser(TStringBuilder() << "User " << userName << " is not permitted to log in, because the count of password attempts has been exceeded");
        reboot();
        loginUser(TStringBuilder() << "User " << userName << " is not permitted to log in, because the count of password attempts has been exceeded");
