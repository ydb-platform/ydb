...
Y_UNIT_TEST_SUITE(TOlap) {
    ...
    Y_UNIT_TEST(StoreStats) {
        ...
        auto describeResult = DescribePath(runtime, "/MyRoot/OlapStore");
        const auto olapStorePathId = describeResult.GetPathId();

        TestLs(runtime, "/MyRoot/OlapStore", false, NLs::PathExist);
        TestLsPathId(runtime, olapStorePathId, NLs::PathStringEqual("/MyRoot/OlapStore"));
        ...
        describeResult = DescribePath(runtime, "/MyRoot/OlapStore/ColumnTable");
        const auto columnTablePathId = describeResult.GetPathId();
        ...
        TestLsPathId(runtime, columnTablePathId, checkFn);
        UNIT_ASSERT(shardId);
        UNIT_ASSERT(pathId);
    ...
    Y_UNIT_TEST(StoreStatsQuota) {
        ...
        auto describeResult = DescribePath(runtime, "/MyRoot/SomeDatabase/OlapStore");
        const auto olapStorePathId = describeResult.GetPathId();

        TestLs(runtime, "/MyRoot/SomeDatabase/OlapStore", false, NLs::PathExist);
        TestLsPathId(runtime, olapStorePathId, NLs::PathStringEqual("/MyRoot/SomeDatabase/OlapStore"));
        ...
        describeResult = DescribePath(runtime, "/MyRoot/SomeDatabase/OlapStore/ColumnTable");
        const auto columnTablePathId = describeResult.GetPathId();
