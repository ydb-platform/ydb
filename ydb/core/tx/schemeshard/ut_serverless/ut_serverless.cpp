...
Y_UNIT_TEST_SUITE(TSchemeShardServerLess) {
    ...
    Y_UNIT_TEST(StorageBilling) {
        ...
        {
            TString meteringData = R"({"usage":{"start":1600452120,"quantity":59,"finish":1600452179,"type":"delta","unit":"byte*second"},"tags":{"ydb_size":13280},"labels":{"Category":"Generic"},"id":"72057594046678944-3-1600452120-1600452179-13280","cloud_id":"CLOUD_ID_VAL","source_wt":1600452180,"source_id":"sless-docapi-ydb-storage","resource_id":"DATABASE_ID_VAL","schema":"ydb.serverless.v1","folder_id":"FOLDER_ID_VAL","version":"1.0.0"})";
        ...
        {
            TString meteringData = R"({"usage":{"start":1600452180,"quantity":59,"finish":1600452239,"type":"delta","unit":"byte*second"},"tags":{"ydb_size":0},"labels":{"Category":"Generic"},"id":"72057594046678944-3-1600452180-1600452239-0","cloud_id":"CLOUD_ID_VAL","source_wt":1600452240,"source_id":"sless-docapi-ydb-storage","resource_id":"DATABASE_ID_VAL","schema":"ydb.serverless.v1","folder_id":"FOLDER_ID_VAL","version":"1.0.0"})";
            MeteringDataEqual(meteringMessages, meteringData);
        }
    }
    ...
    Y_UNIT_TEST(StorageBillingLabels) {
        ...
        UNIT_ASSERT_C(jsonStr.Contains(R"("labels":{"Category":"Generic","k":"v"})"), jsonStr);
