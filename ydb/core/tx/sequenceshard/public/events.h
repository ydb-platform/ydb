...
static_assert(TKikimrEvents::ES_SEQUENCESHARD == 4216, "Expected TKikimrEvents::ES_SEQUENCESHARD == 4216");
static_assert(
    EvEnd < EventSpaceEnd(TKikimrEvents::ES_SEQUENCESHARD),
...
struct TEvCreateSequenceResult
    : public TEventPB<
          TEvCreateSequenceResult,
          NKikimrTxSequenceShard::TEvCreateSequenceResult,
          EvCreateSequenceResult> {
...
struct TEvAllocateSequenceResult
    : public TEventPB<
          TEvAllocateSequenceResult,
          NKikimrTxSequenceShard::TEvAllocateSequenceResult,
          EvAllocateSequenceResult> {
...
struct TEvDropSequence: public TEventPB<TEvDropSequence, NKikimrTxSequenceShard::TEvDropSequence, EvDropSequence> {
...
struct TEvUpdateSequenceResult
    : public TEventPB<
          TEvUpdateSequenceResult,
          NKikimrTxSequenceShard::TEvUpdateSequenceResult,
          EvUpdateSequenceResult> {
...
struct TEvRestoreSequenceResult
    : public TEventPB<
          ...
          NKikimrTxSequenceShard::TEvRestoreSequenceResult,
          EvRestoreSequenceResult> {
...
struct TEvRedirectSequenceResult
    : public TEventPB<
          TEvRedirectSequenceResult,
          NKikimrTxSequenceShard::TEvRedirectSequenceResult,
          EvRedirectSequenceResult> {
...
struct TEvGetSequence: public TEventPB<TEvGetSequence, NKikimrTxSequenceShard::TEvGetSequence, EvGetSequence> {
