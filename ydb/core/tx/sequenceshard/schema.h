...
struct TSequenceShardSchema: NIceDb::Schema {
    ...
    using TTables = SchemaTables<SysParams, Sequences, SchemeShardRounds>;

    using TSettings = SchemaSettings<ExecutorLogBatching<true>, ExecutorLogFlushPeriod<500 /*500us*/>>;
};
