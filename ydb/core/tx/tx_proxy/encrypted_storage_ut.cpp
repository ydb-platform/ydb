...
Y_UNIT_TEST_SUITE(TStorageTenantTest) {
    ...
    Y_UNIT_TEST(CreateTableOutsideDatabaseFailToStartTabletsButDropIsOk) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(env.GetClient().MkDir("/dc-1", "dir"), NMsgBusProxy::MSTATUS_OK);
        ...
        UNIT_ASSERT_VALUES_EQUAL(
            env.GetClient().CreateTable("/dc-1/dir", tableDesc, TDuration::Seconds(1)), NMsgBusProxy::MSTATUS_INPROGRESS
        );
