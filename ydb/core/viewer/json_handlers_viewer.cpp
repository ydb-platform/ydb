...
void InitViewerGetTopicDataJsonHandler(TJsonHandlers& handlers) {
    handlers.AddHandler("/viewer/get_topic_data", new TJsonHandler<TGetTopicData>(TGetTopicData::GetSwagger()));
}
...
void InitViewerJsonHandlers(TJsonHandlers& jsonHandlers) {
    ...
    InitViewerGetTopicDataJsonHandler(jsonHandlers);
