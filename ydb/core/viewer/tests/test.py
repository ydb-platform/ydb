...
cluster = KiKiMR(KikimrConfigGenerator(extra_feature_flags={
    ...
    enable_proper_auth=True,
    config={
        'domains_config': {
            'security_config': {
                'enforce_user_token_requirement': False,
                'enforce_user_token_check_requirement': True,
                'database_allowed_sids': ['database'],
                'viewer_allowed_sids': ['viewer'],
                'monitoring_allowed_sids': ['monitoring', 'root'],
                'administration_allowed_sids': ['root']
            }
        }
    }))
cluster.start()
