...
public:
    ...
    void Handle(TEvHive::TEvResponseHiveNodeStats::TPtr& ev) {
        LOG_TRACE_S(*TlsActivationContext, NKikimrServices::VIEWER, GetLogPrefix() <<"ProcessNodeIds()");
    ...
    static YAML::Node GetSwagger() {
        TSimpleYamlBuilder yaml({
            .Method = "get",
            .Tag = "viewer",
            .Summary = "Compute information",
            .Description = "Returns information about compute layer of database",
        });
        yaml.AddParameter({
            .Name = "version",
        ...
        yaml.SetResponseSchema(TProtoToYaml::ProtoToYamlSchema<NKikimrViewer::TComputeInfo>());
        return yaml;
    }
};
