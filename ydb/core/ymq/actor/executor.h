...
private:
    STATEFN(AwaitState) {
        switch (ev->GetTypeRewrite()) {
            ...
            hFunc(NSchemeShard::NEvSchemeShard::TEvNotifyTxCompletionResult, HandleResult);
    ...
    void HandleResult(NSchemeShard::NEvSchemeShard::TEvNotifyTxCompletionResult::TPtr& ev);
