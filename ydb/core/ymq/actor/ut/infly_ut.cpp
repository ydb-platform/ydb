...
Y_UNIT_TEST_SUITE(InflyTest) {
    Y_UNIT_TEST(AddMessage) {
        ...
        infly->Add(std::make_unique<TInflyMessage>(1ull, 0ull, TInstant::Seconds(42), 0));
        ...
        infly->Add(std::make_unique<TInflyMessage>(2ull, 0ull, TInstant::Seconds(12), 0));
    ...
    Y_UNIT_TEST(ChangeMesageVisibility) {
        ...
        infly->Add(std::make_unique<TInflyMessage>(1ull, 0ull, TInstant::Seconds(42), 0));
        infly->Add(std::make_unique<TInflyMessage>(2ull, 0ull, TInstant::Seconds(12), 0));
        infly->Add(std::make_unique<TInflyMessage>(5ull, 0ull, TInstant::Seconds(150), 0));
    ...
    Y_UNIT_TEST(ReceiveMessages) {
        TIntrusivePtr<TInflyMessages> infly = MakeIntrusive<TInflyMessages>();
        infly->Add(std::make_unique<TInflyMessage>(1ull, 0ull, TInstant::Seconds(1), 0));
        infly->Add(std::make_unique<TInflyMessage>(2ull, 0ull, TInstant::Seconds(2), 0));
        infly->Add(std::make_unique<TInflyMessage>(3ull, 0ull, TInstant::Seconds(3), 0));
        infly->Add(std::make_unique<TInflyMessage>(4ull, 0ull, TInstant::Seconds(4), 0));
        infly->Add(std::make_unique<TInflyMessage>(5ull, 0ull, TInstant::Seconds(5), 0));
