...
* **_(Experimental)_** Added the `{{ ydb-cli }} admin node config init` [command](/reference/ydb-cli/configs.md) to initialize a directory with node configuration files.
