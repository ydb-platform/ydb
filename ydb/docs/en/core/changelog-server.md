...
* [Topic configuration export to S3](https://github.com/ydb-platform/ydb/pull/18138) and [import from S3](https://github.com/ydb-platform/ydb/pull/18214) are supported.
