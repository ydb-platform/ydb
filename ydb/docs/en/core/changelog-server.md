...
* [Added](https://github.com/ydb-platform/ydb/pull/8065) the ability to omit parameter type declarations in queries using the `DECLARE` operator. Parameter types are now automatically inferred based on their usage in the query.
