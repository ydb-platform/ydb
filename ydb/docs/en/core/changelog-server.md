...
* [Fixed](https://github.com/ydb-platform/ydb/pull/46894) Kafka API Proxy authentication for local users: with `DomainLoginOnly`, users from the root domain could not access tenant databases.
