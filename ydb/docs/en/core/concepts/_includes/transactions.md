...
For more information about transactions with tables and topics in {{ ydb-short-name }}, see [Transactions with topics and tables](../datamodel/topic.md#topic-transactions) and [Working with topics](../../reference/ydb-sdk/topic.md).
