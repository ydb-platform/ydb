...
* [YDB UI](../../reference/ydb-ui/index.md) — the **Query** tab on the database page ([query form](../../reference/ydb-ui/ydb-monitoring.md#tenant_scheme)), when run without selecting an explicit transaction mode in the settings.
...
* [YDB UI](../../reference/ydb-ui/index.md) — choose a transaction mode in the execution settings on the **Query** tab.
