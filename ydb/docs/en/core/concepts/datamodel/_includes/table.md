...
## Row-oriented tables {#row-orineted_table}
...
#### AUTO_PARTITIONING_PARTITION_SIZE_MB {##auto_partitioning_by_size_mb}
...
#### AUTO_PARTITIONING_MAX_PARTITIONS_COUNT {#auto_partitioning_max_parririons_count}
...
## Column-oriented tables {#olap-data-types}
{% note warning %}
