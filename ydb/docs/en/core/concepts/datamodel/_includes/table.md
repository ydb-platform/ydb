...
* Type: `Uint64`.
* Default value: `2048 MiB` (`2 GiB`).

The desired partition size threshold in mebibytes. Recommended values range from `10 MiB` to `2048 MiB`. If this threshold is exceeded, a shard may split.
