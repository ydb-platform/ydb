...
* You can configure compression individually for each column when [creating](../../../yql/reference/syntax/create_table/index.md#compression) a columnar table or [change](../../../yql/reference/syntax/alter_table/columns.md#compression) it later.
* You can also configure encoding for each column when [creating](../../../yql/reference/syntax/create_table/index.md#encoding) a columnar table or [change](../../../yql/reference/syntax/alter_table/columns.md#encoding) it later.
