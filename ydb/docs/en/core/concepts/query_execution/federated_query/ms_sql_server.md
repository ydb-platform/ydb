...
<<<<<<< HEAD:ydb/docs/en/core/concepts/federated_query/ms_sql_server.md
...
>>>>>>> fb12d3cafd2 (DOCSUP-124714: Переводы Февраля - 3. Организация процесса перевода (1 архив) (1 шт.) (#35225)):ydb/docs/en/core/concepts/query_execution/federated_query/ms_sql_server.md
