...
Queries to [topics](../datamodel/topic.md) allow processing unbounded data streams. Since the data stream is infinite, such a query does not terminate after obtaining a result but runs until explicitly cancelled. There are two types of such queries.
