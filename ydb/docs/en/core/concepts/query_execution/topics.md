...
For reading and writing messages to [topics](../datamodel/topic.md), the familiar YQL constructs are used: [SELECT](../../yql/reference/syntax/select/index.md) for reading and [INSERT](../../yql/reference/syntax/insert_into.md) for writing.
...
For more details about supported formats: [{#T}](../../dev/streaming-query/streaming-query-formats.md).

### Using the reader {#consumer-usage}
