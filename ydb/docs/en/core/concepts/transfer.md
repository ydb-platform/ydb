...
Current transfer parameters, including the lambda function text, can be viewed in the [{{ ydb-ui-name }}](../reference/ydb-ui/index.md) and in the [description](../reference/ydb-cli/commands/scheme-describe.md) of the transfer instance.
