...
Guides are primarily found in role-specific folders like ["Cluster Administration"](../../devops/index.md), ["For Application Developers"](../../dev/index.md), and ["For Security Engineers"](../../security/index.md), as well as in the ["Troubleshooting"](../../troubleshooting/index.md) section.
