...
4. A **primary reviewer** picks the pull request from the [inbound list](https://github.com/ydb-platform/ydb/pulls?q=is%3Aopen+is%3Apr+label%3Adocumentation+draft%3Afalse) and provides the initial set of feedback and suggestions.
