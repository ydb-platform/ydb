...
For an NBS-like block workload through Direct Block Groups, PersistentBuffer, and DDisk, see [{#T}](load-actors-nbs-dbg-like.md). `StorageLoad` exercises the DSProxy/VDisk blob-storage path.
...
| `MaxInFlightWriteBytes` | Maximum total bytes in concurrent write requests; zero means unlimited. |
...
| `ReadHardRateDispatcher`  | Setting up the [parameters of load with hard rate](#hard-rate-dispatcher) for read requests. If this parameter is set than the value of `ReadIntervals` is ignored.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `MaxInFlightReadBytes` | Maximum total bytes in concurrent read requests; zero means unlimited. |
...
| `InitialAllocation`       | Setting up the [parameters for initial data allocation](#initial-allocation). It defines the amount of data to be written before the start of the main load cycle. This data can be read by read requests along with the data written in the main load cycle.                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Parameter             | Description                                                                                                                                                             |
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `RequestsPerSecondAtStart`  | Requests per second at the moment of load start. If load duration limit is not set then the request rate will remain the same and equal to the value of this parameter. |
| `RequestsPerSecondOnFinish` | Requests per second at the moment of load finish.                                                                                                                       |
