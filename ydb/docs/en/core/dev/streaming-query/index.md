...
- [Data delivery guarantees](guarantees.md) — level of guarantees, observed anomalies in windowed aggregation, and recommendations.
...
- [Watermarks](watermarks.md) — a mechanism for tracking time progress in the data stream.
