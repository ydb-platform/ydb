...
- [Writing to tables](table-writing.md) — how streaming queries write into {{ ydb-short-name }} tables in real time
- [Data enrichment](enrichment.md) — enriching the stream using lookup data
- [Topic read/write formats](streaming-query-formats.md) — supported formats when working with topics and usage examples
- [Delivery guarantees](guarantees.md) — guarantee levels, observed anomalies in window aggregation, and recommendations
...
- [Description of streaming queries](../../concepts/streaming-query.md)
