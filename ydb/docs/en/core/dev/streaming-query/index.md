...
- [Local and external topics](../../concepts/query_execution/topics.md#local-external-topics) — accessing topics in the current and another database in YQL queries
...
- [Watermarks](watermarks.md) — tracking time progress in a data stream
