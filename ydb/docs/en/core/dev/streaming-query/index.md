...
- [Using local and external topics](local-and-external-topics.md) — accessing topics of the current and another database in YQL queries
...
- [Data enrichment](enrichment.md) — ways to enrich data in a stream using reference tables.
