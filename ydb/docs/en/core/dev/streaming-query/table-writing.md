...
- [INSERT INTO](../../yql/reference/syntax/insert_into.md) — use UPSERT INTO instead. INSERT INTO is not used because under at-least-once delivery it would duplicate rows on retries.
