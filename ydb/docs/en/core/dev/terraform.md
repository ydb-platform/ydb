...
* `auto_partitioning_partition_size_mb` — (optional) setting the value of [auto-partitioning by size](../concepts/datamodel/table.md#auto_partitioning_partition_size_mb) in mebibytes.
