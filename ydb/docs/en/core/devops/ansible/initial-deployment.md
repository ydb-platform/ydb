...
The value of the `ydb_database_groups` variable in the `vars` sets the number of [storage groups](https://ydb.tech/docs/en/concepts/glossary#storage-group) for the database.
