...
If you can restore a cluster using the [export/import](#s3) or [dump/restore](#files) commands, it is recommended to use these methods.

Detailed information, including a recovery guide, is available in the [{#T}](./system-tablet-backup.md) section.
