...
## System tablet backup {#system-tablet-backup}

The system tablet backup mechanism for [Hive](../../concepts/glossary.md#hive), [BSController](../../concepts/glossary.md#ds-controller), and [SchemeShard](../../concepts/glossary.md#scheme-shard) provides incremental copying of cluster metadata to the cluster's local file system.
...
If you can recover the cluster using [export/import](#s3) or [dump/restore](#files), it is recommended to use those methods.
