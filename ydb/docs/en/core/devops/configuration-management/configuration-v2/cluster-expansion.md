...
After successfully adding a dynamic node to the cluster, information about it will be available on the [cluster monitoring page in the {{ ydb-ui-name }}](../../../reference/ydb-ui/ydb-monitoring.md).
...
8. Ensure that new static nodes are displayed on the [cluster monitoring page in the {{ ydb-ui-name }}](../../../reference/ydb-ui/ydb-monitoring.md).
...
10. Ensure that added storage groups are displayed on the [cluster monitoring page in the {{ ydb-ui-name }}](../../../reference/ydb-ui/ydb-monitoring.md).

Removing static nodes from the {{ ydb-short-name }} cluster is performed according to the [documented decommissioning procedure](node-removal.md#remove-static-node).
