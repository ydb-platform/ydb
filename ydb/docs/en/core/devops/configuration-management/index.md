...
* [{#T}](configuration-v1/index.md) — section about configuration V1, used in {{ ydb-short-name }}.
* [{#T}](configuration-v2/index.md) — section about configuration V2, experimental functionality for {{ ydb-short-name }} versions 25.1 and above.
