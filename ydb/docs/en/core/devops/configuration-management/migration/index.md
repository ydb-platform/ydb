...
{{ ydb-short-name }} supports two configuration management mechanisms: [V1](../configuration-v1/index.md) and [V2](../configuration-v2/config-overview.md) (experimental, available from version 25.1). Key differences between them are described in the article [Comparing configurations V1 and V2](../compare-configs.md).
