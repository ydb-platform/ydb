...
* Choose one of the available options for deploying {{ ydb-short-name }} executables:
  ...
  * `ydb_git_version`: automatically download a {{ ydb-short-name }} build from the [CI/CD system](https://github.com/ydb-platform/ydb/actions/workflows/build-and-test-ondemand.yml) by Git commit hash. For example, `c1de4531c5316c46d92b602b83b0c5b8b5e5e8c8`.
