...
To enable Kafka API with topics, add the `kafka_proxy_config` section to the configuration file (see [configuring Kafka API](../../../reference/configuration/kafka_proxy_config)).
