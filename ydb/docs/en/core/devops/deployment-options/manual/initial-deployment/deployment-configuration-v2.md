...
The unsecured operation mode of {{ ydb-short-name }} is designed for test tasks, mainly related to the development and testing of {{ ydb-short-name }} software. In unsecured mode:
