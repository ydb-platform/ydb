...
For more information about hardware requirements, see the [{#T}](../../../../devops/concepts/system-requirements.md) section.
...
After completing the preparatory steps, you can proceed to deploying the system. Choose the instruction according to your configuration:
