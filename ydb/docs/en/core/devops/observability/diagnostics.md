...
* `--no-sanitize` — allows you to get a full report by disabling the cleanup of user table names, columns, and queries (which are stripped by default).
