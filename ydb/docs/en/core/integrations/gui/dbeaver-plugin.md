...
3. The connection settings page for {{ ydb-name }} will open. Fill in the fields:
   ...
   | **Monitoring URL** | URL of the [{{ ydb-short-name }} YDB UI](../../reference/ydb-ui/index.md) with the database path, used for the dashboard (optional) | `http://ydb.example.com:8765/monitoring/tenant?name=%2FRoot%2Fdatabase` |
