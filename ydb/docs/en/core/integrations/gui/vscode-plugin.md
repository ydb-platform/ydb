...
- **Tables** — tables (row and column-oriented), organized by subdirectories according to the path in {{ ydb-short-name }}.
...
- **New Row Table** / **New Column Table** — create a row or column-oriented table.
...
| `ydb_yql_help` | `query`, `connection?` | Search YQL documentation (requires RAG to be enabled, see [#rag](#rag)) |
