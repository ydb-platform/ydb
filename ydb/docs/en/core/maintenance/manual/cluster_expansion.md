...
Once you have added the dynamic node to the cluster, the information about it becomes available on the [cluster monitoring page in the {{ ydb-ui-name }}](../../reference/ydb-ui/ydb-monitoring.md).
...
1. Format the disks that will be used to store the {{ ydb-short-name }} data by following the [procedure for the cluster deployment step](../../devops/deployment-options/manual/initial-deployment/deployment-preparation.md#prepare-disks)

2. Edit the [cluster's configuration file](../../devops/deployment-options/manual/initial-deployment/deployment-configuration-v1.md#config):
...
7. Make sure that all the new static nodes now show up on the [cluster monitoring page in the {{ ydb-ui-name }}](../../reference/ydb-ui/ydb-monitoring.md).
...
11. Make sure that all the new storage groups now show up on the [cluster monitoring page in the {{ ydb-ui-name }}](../../reference/ydb-ui/ydb-monitoring.md).
