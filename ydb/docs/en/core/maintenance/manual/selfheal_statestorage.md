...
You can check that the changes have been applied in the `CMS` section of the cluster [YDB UI](../../reference/ydb-ui/index.md) (available on port 8765): go to the `Sentinel` tab to view the status of Sentinel and Self Heal State Storage.
