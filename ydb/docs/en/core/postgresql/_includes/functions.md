...
Square root|
```sql
sqrt(2) → 1.414{{ ydb-ports.grpcs }}623730951
```||
...
path '((0,0),(1,0),(1,1))' * point(cosd(45), sind(45)) → ((0,0),(0.7071067811865475,0.7071067811865475),(0,1.414{{ ydb-ports.grpcs }}62373095))
```||
||geometric_type / point → geometric_type|
...
path '((0,0),(1,0),(1,1))' / point(cosd(45), sind(45)) → ((0,0),(0.7071067811865476,-0.7071067811865476),(1.414{{ ydb-ports.grpcs }}623730951,0))
```||
...
```sql
box(circle '<(0,0),2>') → (1.414{{ ydb-ports.grpcs }}62373095,1.414{{ ydb-ports.grpcs }}62373095),(-1.414{{ ydb-ports.grpcs }}62373095,-1.414{{ ydb-ports.grpcs }}62373095)
```||
||box ( point ) → box|
