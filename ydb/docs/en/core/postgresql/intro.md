...
| `pg_dump` + `pg-convert` import | [YDB tools dump/restore](../reference/ydb-cli/export-import/tools-dump.md) or [data ingestion integrations](../integrations/ingestion/index.md) |
