...
| --- | --- |
| psql, pgAdmin, or PostgreSQL drivers | [{{ ydb-short-name }} CLI](../reference/ydb-cli/index.md), [YDB UI](../reference/ydb-ui/index.md), [{{ ydb-short-name }} SDK](../reference/ydb-sdk/index.md), or the [JDBC driver](https://github.com/ydb-platform/ydb-jdbc-driver) |
