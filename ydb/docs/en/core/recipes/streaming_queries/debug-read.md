...
When developing streaming queries, it can be useful to quickly see what data is coming into a [topic](../../concepts/datamodel/topic.md) without creating a full streaming query. To do this, run a regular `SELECT` from the topic.
