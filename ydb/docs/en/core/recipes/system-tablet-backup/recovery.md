...
The tablet to be recovered must be put into Recovery mode. In this mode, the tablet starts and is accessible via the [YDB UI](../../reference/ydb-ui/index.md), but **does not work normally** and **does not read data from the distributed storage**, allowing recovery operations to be performed. Other tablets will continue to operate normally, allowing the cluster to keep functioning, but some control-plane operations may be unavailable.
...
1. Determine the ID of the system tablet to be recovered. The tablet ID can be found in the Tablets section of the [YDB UI](../../reference/ydb-ui/index.md).
...
5. Make sure that:
   ...
   - The recovery form is available in the tablet's App in the [YDB UI](../../reference/ydb-ui/index.md).
...
1. Determine which host the tablet is running on in Recovery mode. To do this, open the [YDB UI](../../reference/ydb-ui/index.md) and find the node where the tablet is running.
...
1. Open the App of the tablet being restored in the [YDB UI](../../reference/ydb-ui/index.md).
...
4. Make sure that:
   ...
   - The recovery form is absent in the tablet's App in [YDB UI](../../reference/ydb-ui/index.md).
