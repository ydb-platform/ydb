...
- Java
  ...
  - JDBC
    ...
    In Spring Boot, ORM, and other third-party frameworks around JDBC, the connection is specified with the same JDBC connection string as above (for example, `spring.datasource.url`).
