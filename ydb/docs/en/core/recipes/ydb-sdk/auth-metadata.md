...
- Java
  ...
  - JDBC
    ...
    public void work() throws SQLException {
        ...
        // The useMetadata option can also be specified directly in the JDBC URL
    ...
    In Spring Boot, ORM, and other third-party frameworks around JDBC, pass the same JDBC URL and parameters (`useMetadata` in the URL or in data source properties) as in the example above.
