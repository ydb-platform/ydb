  ...
  - Native SDK
    ...
    public class MetadataAuthExample {
        public static void main(String[] args) throws Exception {
            ...
            // Token is requested from the virtual machine metadata service or function in Yandex Cloud
