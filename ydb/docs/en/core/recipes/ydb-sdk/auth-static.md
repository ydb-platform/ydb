...
- Go
  ...
  - database/sql
    ...
    You can also pass the login and password explicitly when initializing the driver through the connector using the special option `ydb.WithStaticCredentials`:
