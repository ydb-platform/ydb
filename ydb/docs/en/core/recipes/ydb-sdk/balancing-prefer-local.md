...
Below are code examples for setting the balancing algorithm option "prefer nearest datacenter" in different {{ ydb-short-name }} SDKs.
...
- C++
  ...
  - Native SDK
    ...
    {{ ydb-short-name }} C++ SDK uses the `prefer_local_dc` algorithm (prefer nearest datacenter) by default.
...
- Go
  ...
  - database/sql
    ...
    Example code for setting the balancing algorithm "prefer nearest datacenter":
...
- Java
  ...
  - JDBC
    ...
    Specify the local datacenter via `localDatacenter` in the JDBC URL — see [JDBC driver properties](../../reference/languages-and-apis/jdbc-driver/properties.md).
    ...
    public class JdbcPreferLocalExample {
        public static void main(String[] args) throws SQLException {
            // JDBC driver does not support automatic detection of the nearest DC.
