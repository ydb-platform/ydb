...
Below are code examples for explicitly setting the "uniform random choice" balancing algorithm in different {{ ydb-short-name }} SDKs.
...
- Python
  ...
  - Native SDK
    ...
    driver_config = ydb.DriverConfig(
        ...
        use_all_nodes=True,  # uniform random selection
    )
...
- Java
  ...
  - JDBC
    ...
    Balancing when selecting a new session is configured on the native transport side within the driver; if necessary, use the same parameters as in the native SDK via [JDBC connection settings](../../reference/languages-and-apis/jdbc-driver/properties.md).
