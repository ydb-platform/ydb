...
- JavaScript
  ...
  To enable logs, set the environment variable `DEBUG` to a filter value for SDK events - `DEBUG=ydbjs:*`.
...
- PHP
  ...
  YDB-PHP-SDK includes loggers in the `YdbPlatform\Ydb\Logger` namespace:
