...
- Go
  ...
  - Native SDK
    ...
    {% cut "Via environment variable `YDB_LOG_SEVERITY_LEVEL`" %}
  ...
  {% include [overlay](_includes/debug-logs-go-appendix.md) %}
    ...
    {% cut "Connect custom implementation of the logger `github.com/ydb-platform/ydb-go-sdk/v3/log.Logger`" %}
    ...
    {% cut "Implement custom logging package" %}
    ...
    {% cut "Implement retrieve information about server errors `IterateByIssues`" %}
