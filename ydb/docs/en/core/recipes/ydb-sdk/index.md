...
This section contains code recipes in different programming languages for solving various common tasks using {{ ydb-short-name }} SDK.
...
- [Configuring table row TTL](ttl.md)
