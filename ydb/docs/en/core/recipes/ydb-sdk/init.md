...
To connect to {{ ydb-short-name }} you must specify required parameters (see the [Connecting to the {{ ydb-short-name }} server](../../concepts/connect.md) section for more details) and optional ones that determine the driver’s behavior at runtime.
...
- Go
  ...
  - database/sql
    ...
    Registering the `database/sql` driver occurs at the moment the specific driver package is imported using the underscore symbol:
    ...
    public class InitExample {
        public static void main(String[] args) {
            ...
            try (GrpcTransport transport = GrpcTransport.forConnectionString(connectionString).build();
                ...
                // Retry context for resilient query execution
  ...
  - JDBC
    ...
    public class JdbcInitExample {
        public static void main(String[] args) throws SQLException {
            // The driver tech.ydb.jdbc.YdbDriver must be in the classpath for auto-loading via DriverManager
