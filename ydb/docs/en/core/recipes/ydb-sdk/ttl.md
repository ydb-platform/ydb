...
This section contains recipes for configuring the TTL of a table with {{ ydb-short-name }} SDK.
...
To enable eviction, you need an [external data source](../../concepts/datamodel/external_data_source.md) object that describes a connection to an external storage. You can create an external data source object via [YQL](../../yql/reference/recipes/ttl.md#enable-tiering-on-existing-tables) and the {{ ydb-short-name }} CLI.
