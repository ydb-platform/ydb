...
- Java
  ...
  - JDBC
    ...
    In Spring Boot, Hibernate, JOOQ, and other frameworks on top of JDBC, the driver also seeks to optimize **large** sequences of inserts and updates: when necessary, **UPSERT**, `INSERT`, `UPDATE`, `DELETE` are automatically **grouped into batches** on the driver side (including for large ORM batches).
