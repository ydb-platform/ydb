...
- Python
  ...
  To use the structure in the example below, create a `items_struct_type = ydb.StructType()` that specifies the types of all fields. To pass a list of such structures, wrap it in `ydb.ListType`: `ydb.ListType(items_struct_type)`.
