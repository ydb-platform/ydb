...
| `enable_local_min_max_index` | Local [min_max indexes](../../yql/reference/syntax/create_table/min_max_index.md) for column-oriented tables; disabled by default in YDB 26.2 |
