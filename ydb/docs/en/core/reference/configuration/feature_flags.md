...
>>>>>>> 7e5ca7d4883 (Auto-translate docs from PR #38700 (#48134))
...
| `enable_changefeeds_export`, `enable_changefeeds_import` | Support for change streams (changefeed) in backup and restore operations |
