...
| Flag | Function |
| --- | --- |
| `enable_json_index` | [JSON indexes](../../dev/json-indexes.md) for faster search in JSON fields |
...
| `enable_strict_acl_check` | Prohibition on granting privileges to non-existent users and on deleting users who have been granted privileges |
