...
|| `min_period_between_balance` | MinPeriodBetweenBalance | Number of seconds (real number) | Minimum time period between two auto-balancing iterations. Does not apply to emergency balancing. | 0.2 ||
...
|| `min_period_between_emergency_balance` | MinPeriodBetweenEmergencyBalance | Number of seconds (real number) | Similar to `min_period_between_balance`, but for emergency balancing. | 0.1 ||
