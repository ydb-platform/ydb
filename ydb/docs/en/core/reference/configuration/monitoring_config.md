...
The `monitoring_config` section of the {{ ydb-short-name }} configuration file configures [YDB Monitoring](../ydb-ui/ydb-monitoring.md). The parameters below control [authentication](../../security/authentication.md) on individual YDB Monitoring pages.
