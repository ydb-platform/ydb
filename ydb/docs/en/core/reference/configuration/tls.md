...
{{ ydb-short-name }} exposes a separate HTTP network port for running the [YDB UI](../../reference/ydb-ui/index.md), exposing [metrics](../../devops/observability/monitoring.md), and other miscellaneous endpoints.
