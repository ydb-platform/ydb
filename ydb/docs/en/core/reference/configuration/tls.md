...
[{{ ydb-short-name }} actor system interconnect](../../concepts/glossary.md#actor-system-interconnect) is a specialized protocol for data exchange between {{ ydb-short-name }} nodes.
...
[{{ ydb-short-name }} main API](../../reference/ydb-sdk/overview-grpc-api.md) is based on [gRPC](https://grpc.io/). It is used for external interaction with client applications that work directly with {{ ydb-short-name }} via [SDK](../../reference/ydb-sdk/index.md) or [CLI](../../reference/ydb-cli/index.md).
