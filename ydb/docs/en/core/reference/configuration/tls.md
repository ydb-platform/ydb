...
[The actor system interconnect of {{ ydb-short-name }}](../../concepts/glossary.md#actor-system-interconnect) is a specialized protocol for exchanging data between {{ ydb-short-name }} nodes.
...
{{ ydb-short-name }} can send [tracing data](../../reference/observability/tracing/setup.md) to an external collector via gRPC.
