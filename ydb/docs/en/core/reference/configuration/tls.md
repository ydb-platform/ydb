...
[Actor system interconnect {{ ydb-short-name }}](../../concepts/glossary.md#actor-system-interconnect) is a specialized protocol for exchanging data between {{ ydb-short-name }} nodes.
