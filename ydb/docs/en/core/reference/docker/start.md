...
With the parameters specified in the example above and running Docker locally, [{{ ydb-ui-name }}](../ydb-ui/index.md) {{ ydb-short-name }} will be available at [http://localhost:8765](http://localhost:8765).
