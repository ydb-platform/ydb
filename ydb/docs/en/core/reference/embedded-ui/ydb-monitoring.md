...
```text
http://<endpoint>:{{ ydb-ports.mon }}/monitoring/cluster
```
...
```text
http://<endpoint>:{{ ydb-ports.mon }}/monitoring/node/<node-id>/
```
...
```text
http://<endpoint>:{{ ydb-ports.mon }}/monitoring/tenant/healthcheck?name=<tenant-path>
```
