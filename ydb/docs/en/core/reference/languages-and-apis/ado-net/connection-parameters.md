...
| MaxSendMessageSize             | Maximum size of outgoing messages in bytes. By default, the server limit is 64 MB (64,000,000 bytes); larger messages are rejected with the `ResourceExhausted` error. The server limit can be configured separately. | 67108864 (64 MiB)          |
| MaxReceiveMessageSize          | Maximum size of incoming messages, bytes.                                                                                                                                                                                                                                       | 67108864 (64 MiB)          |
