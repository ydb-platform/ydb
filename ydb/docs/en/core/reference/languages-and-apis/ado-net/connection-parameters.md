...
| MaxSendMessageSize             | Maximum size of outgoing messages in bytes. Note: a 64 MiB limit applies on the server; larger messages are rejected with the `ResourceExhausted` error.                                                                                                                         | 67108864 (64 MiB)          |
