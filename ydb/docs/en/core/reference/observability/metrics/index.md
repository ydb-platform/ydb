...
| `topic.partition.lag_messages_max`<br/>`GAUGE`, pieces | The maximum difference (across all partitions) of the last offset in the partition and the last commited offset.<br/>Label:<br/>- _topic_ – topic name.<br/>- _consumer_ – name of the consumer |
