...
| `topic.partition.committed_lag_messages_max`<br/>`GAUGE`, pieces | The maximum (across all partitions) number of messages after last committed offset.<br/>Метки:<br/>- _topic_ – topic name.<br/>- _consumer_ – name of the consumer |
| `topic.partition.committed_read_lag_milliseconds_max`<br/>`GAUGE`, milliseconds | The maximum (across all partitions) difference between the current time and the write time of the last committed message.<br/>Label:<br/>- _topic_ – topic name.<br/>- _consumer_ – name of the consumer |
...
| `topic.partition.lag_messages_max`<br/>`GAUGE`, pieces | The maximum difference (across all partitions) of the last offset in the partition and the last committed offset.<br/>Label:<br/>- _topic_ – topic name.<br/>- _consumer_ – name of the consumer |
