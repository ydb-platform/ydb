Before running the examples, configure access to the SQS API (in the Open Source version, disable the authentication requirement, see the section on [authentication](../auth.md)).
