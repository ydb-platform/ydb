...
After successful authentication, the client is assigned a security identifier [SID](../../../../concepts/glossary.md#access-sid), which has all the [rights](../../../../concepts/glossary.md#access-right) assigned to the corresponding identifier. The method of generating the SID depends on the [authentication](#authentication) mode. Schema and data rights are not granted automatically — see [authorization](../../../../security/authorization.md).
