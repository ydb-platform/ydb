...
After successful authentication, the client is assigned a security identifier [SID](../../../../concepts/glossary.md#access-sid), which has all the [permissions](../../../../concepts/glossary.md#access-right) assigned to the corresponding identifier. The method of forming the SID depends on the [authentication](#authentication) mode. Permissions to schema and data are not granted automatically — see [authorization](../../../../security/authorization.md).
