...
| Command / subcommand | Brief description |
|--- | ---
| [admin cluster bootstrap](../commands/cluster/bootstrap.md) | Initializing a prepared [cluster](../../../concepts/glossary.md#cluster) |
| [admin cluster bridge failover](../commands/bridge/failover.md) | Emergency failover when [pile](../../../concepts/glossary.md#pile) is unavailable |
| [admin cluster bridge list](../commands/bridge/list.md) | State list of each [pile](../../../concepts/glossary.md#pile) in [bridge mode](../../../concepts/bridge.md) |
| [admin cluster bridge rejoin](../commands/bridge/rejoin.md) | Returning a [pile](../../../concepts/glossary.md#pile) to the [cluster](../../../concepts/glossary.md#cluster) after maintenance or recovery |
| [admin cluster bridge switchover](../commands/bridge/switchover.md) | Planned `PRIMARY` [pile](../../../concepts/glossary.md#pile) switchover |
| [admin cluster bridge takedown](../commands/bridge/takedown.md) | Removing a [pile](../../../concepts/glossary.md#pile) from the [cluster](../../../concepts/glossary.md#cluster) for maintenance |
