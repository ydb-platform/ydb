...
See the description of the get token command:
...
By default, the command asks for confirmation before outputting the token, because the token will be printed to the console:
