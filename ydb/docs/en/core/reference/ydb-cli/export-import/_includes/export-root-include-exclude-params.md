...
`--exclude STRING`: Pattern ( [PCRE](https://www.pcre.org/original/doc/html/pcrepattern.html)) to exclude paths from export. Paths are specified relative to `root-path`. This parameter can be specified multiple times for different patterns.
