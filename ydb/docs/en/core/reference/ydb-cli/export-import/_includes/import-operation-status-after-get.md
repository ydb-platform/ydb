...
Completion of the import is tracked by the change of the "progress" attribute:

- In the `pretty` output mode (default), a successfully completed operation is reflected by the value "Done" in the pseudographics-highlighted field `progress`:
