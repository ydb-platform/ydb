...
A [cluster configuration](../../../../devops/configuration-management/configuration-v2/config-overview.md) is restored separately using the following steps:
...
[Database configuration](../../../../devops/configuration-management/configuration-v2/config-overview.md) is restored separately using the following steps:
