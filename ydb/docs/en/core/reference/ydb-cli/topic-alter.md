...
| `--content-based-deduplication` | Enables or disables content-based message deduplication for the topic.<br/>Possible values: `true` or `false`. When enabled, messages with identical content are treated as duplicates. |
