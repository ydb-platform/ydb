...
| `--retention-storage-mb`       | The maximum storage size, specified in MB. When the limit is reached, the oldest data will be deleted. Not supported in topics with autopartitioning enabled.<br/>The default value is `0` (no limit).                                                                                                                                                                                                                                 |
