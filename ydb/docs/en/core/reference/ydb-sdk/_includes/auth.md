...
- Python
  ...
  Static Credentials | [ydb.auth_with_static_credentials(endpoint: str, database: str, user: str, password: str)](https://github.com/ydb-platform/ydb-python-sdk/blob/main/examples/static-credentials/example.py) |
