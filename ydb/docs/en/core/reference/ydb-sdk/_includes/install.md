...
Instructions for building from source code are provided in the source code repositories on GitHub, links to which are given on the [{{ ydb-short-name }} SDK - Overview](../index.md) page.
