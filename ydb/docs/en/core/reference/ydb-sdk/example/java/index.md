...
* [Authentication](../../recipes/auth.md##auth-provider) provider. Unless explicitly specified, an [anonymous connection](../../../../concepts/auth.md) is used.
* [Session pool](../../recipes/session-pool-limit.md) settings
