...
The request was canceled on the server. For example, a user canceled a long-running query in the [{{ ydb-ui-name }}](../ydb-ui/index.md), or the query included the [cancel_after](../../dev/timeouts.md#cancel) timeout option.
