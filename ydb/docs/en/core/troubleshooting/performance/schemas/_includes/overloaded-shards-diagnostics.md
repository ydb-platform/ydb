1. Use the {{ ydb-ui-name }} or Grafana to see if the {{ ydb-short-name }} nodes are overloaded:
    ...
    - In the [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md):
...
1. To pinpoint the schema issue, use the [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md) or [{{ ydb-short-name }} CLI](../../../../reference/ydb-cli/index.md):
