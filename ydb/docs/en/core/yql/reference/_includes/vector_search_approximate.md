...
{{ ydb-short-name }} supports vector searching for vector types `Float`, `Float16`, `BFloat16`, `Int8`, `Uint8`, and `Bit`. Consequently, it is possible to apply scalar quantization to transform data from `Float` to any of these types.
