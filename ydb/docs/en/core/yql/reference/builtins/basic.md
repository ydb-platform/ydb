...
* `RandomUuid()`: [Uuid version 4](https://tools.ietf.org/html/rfc4122#section-4.4). For primary keys in {{ ydb-short-name }} tables, consider the value generators in the [`Uuid` module](../udf/list/uuid.md).
