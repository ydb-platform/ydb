  * common parameters for all vector indexes:
    ...
    * `distance` - [distance function](../../../reference/udf/list/knn.md#distance-and-similarity-functions-functions-distance) (`cosine`, `manhattan`, or `euclidean`), mutually exclusive with `similarity`
	  * `similarity` - [similarity function](../../../reference/udf/list/knn.md#distance-and-similarity-functions-functions-distance) (`inner_product` or `cosine`), mutually exclusive with `distance`
