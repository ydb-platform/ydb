...
* `supported_codecs`: List of [codecs](../../../concepts/topic.md#message-codec) supported by the consumer.
...
* `supported_codecs`: List of [codecs](../../../concepts/topic.md#message-codec) supported by the topic. Value type: `String`.
