...
* `AS DO BEGIN ... END DO` — the full text of the new streaming query, including all necessary SQL statements. Restrictions on the query text are given in {#T}, see [below](#examples) for query text examples.
