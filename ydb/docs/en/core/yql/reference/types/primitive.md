...
| Type | Description | Notes |
| ----- | ----- | ----- |
| `Date` | Date, precision to the day | Range of values: From 00:00 01.01.1970 to 00:00 01.01.2106. Internal representation: Unsigned 16-bit integer |
| `Datetime` | Date/time, precision to the second | Range of values: From 00:00 01.01.1970 to 00:00 01.01.2106. Internal representation: Unsigned 32-bit integer |
| `Timestamp` | Date/time, precision to the microsecond | Range of values: From 00:00 01.01.1970 to 00:00 01.01.2106. Internal representation: Unsigned 64-bit integer |
