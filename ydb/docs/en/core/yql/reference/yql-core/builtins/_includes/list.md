...
Show whether the list contains the specified element. In this case, NULLs are considered equal to each other, and with a NULL input list, the result is always false.
