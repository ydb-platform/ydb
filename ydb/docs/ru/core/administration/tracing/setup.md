...
Ниже приведено описание каждой секции в конфигурации трассировки {{ ydb-short-name }}. Пример полной конфигурации приведен в секции [{#T}](./setup.md#complete-configuration).
