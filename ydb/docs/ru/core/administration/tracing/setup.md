...
Секция `external_throttling` не является обязательной, в случае ее отсутствия все trace-id в запросах **будут игнорироваться** (никакие внешние трассы не будут продолжаться).
