...
Уровни 14 и 15 являются аналогами уровня `TRACE` в [логах](../../maintenance/embedded_monitoringl/logs.md), в данном уровне трасса может включать в себя отладочные спаны, аттрибуты или события.
