...
Дата выхода 27 июня 2025. Для обновления до версии **2.23.0** перейдите в раздел [Загрузки](downloads/index.md#ydb-cli).
...
* [Команды](./reference/ydb-cli/commands/workload/index.md) `{{ ydb-cli }} workload` теперь работают с абсолютными путями.
* Улучшения в интерактивном режиме выполнения запросов `{{ ydb-cli }}`:
  * Улучшены inline-подсказки.
  * Добавлено автодополнение именованных выражений (имён столбцов таблицы).
