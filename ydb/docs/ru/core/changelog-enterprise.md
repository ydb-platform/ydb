...
Версия включает в себя все доработки, содержащиеся в сборке 25.4.1.15, см. [описание изменений](./changelog-server.md#25-4-1-15).
...
Версия включает в себя все доработки, содержащиеся в сборке 25.3.1.27, см. [описание изменений](./changelog-server.md#25-3-1-27). Кроме того, включены все [дополнительные исправления](#25-2-1-ent-13-extras), перечисленные ниже для версии 25.2.1.ent.13.
...
Версия включает в себя все доработки, содержащиеся в сборке 25.2.1.26, см. [описание изменений](./changelog-server.md#25-2-1-26). Кроме того, версия включает в себя ряд дополнительных доработок, портированных из актуальной версии 26.1.
...
* Реализован набор исправлений в индексном доступе (StreamIndexLookup), устраняющий возможность проявления редких ситуаций потенциального "зависания" выполняемых запросов.
