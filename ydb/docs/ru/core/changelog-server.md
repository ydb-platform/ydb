...
* [Исправлено](https://github.com/ydb-platform/ydb/pull/46894) аутентификация через Kafka API Proxy для локальных пользователей: при `DomainLoginOnly` пользователи из корневого домена не могли работать с тенантными базами.
