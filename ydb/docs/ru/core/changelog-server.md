...
* [Добавлена](https://github.com/ydb-platform/ydb/pull/8065) возможность не указывать типы параметров в запросах с помощью оператора `DECLARE`. Теперь типы параметров определяются автоматически на основе их использования в запросе.
