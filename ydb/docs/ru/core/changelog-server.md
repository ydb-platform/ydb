...
* [Устранена](https://github.com/ydb-platform/ydb/pull/15334) ошибка, приводившая к сбою при выполнении запросов, возвращающих списки с несколькими входными параметрами и индексами.
