...
* Поддерживаются [экспорт и импорт колоночных таблиц](https://github.com/ydb-platform/ydb/issues/26498) через S3-совместимые хранилища. Функциональность отключена флагом.
...
* Добавлены [min-max-индексы](./yql/reference/syntax/create_table/min_max_index.md?version=main) для колоночных таблиц. Функциональность отключена флагом.
...
* Добавлено [онлайн-построение уникальных вторичных индексов](https://github.com/ydb-platform/ydb/pull/35981). Функциональность отключена флагом.
