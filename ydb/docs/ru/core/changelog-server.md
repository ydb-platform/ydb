...
* [Добавлены](https://github.com/ydb-platform/ydb/issues/15586) системные представления содержащие информацию о [сущностях управления доступом](https://ydb.tech/docs/ru/dev/system-views#auth).
* [Добавлены] системные представления информация о загрузке реплик [партиций](https://ydb.tech/docs/en/dev/system-views#partitions) строковых таблиц.
...
* [Добавлена]((https://github.com/ydb-platform/ydb/issues/7054)) поддержка потока изменений(changefeed) при выполнении операций резервного копирования и восстановления.
