...
* [Добавлены](https://github.com/ydb-platform/ydb/issues/15586) системные представления, содержащие информацию о [сущностях управления доступом](../dev/system-views#auth).
* [Добавлены] системные представления информация о загрузке реплик [партиций](../dev/system-views#partitions) строковых таблиц.
* [Добавлена](https://github.com/ydb-platform/ydb/issues/7054) поддержка потока изменений(changefeed) при выполнении операций резервного копирования и восстановления. которая может быть включена администратором кластера с помощью настроек `enable_changefeeds_export` и `enable_changefeeds_import` в [динамической конфигурации кластера](./maintenance/manual/dynamic-config#obnovlenie-dinamicheskoj-konfiguracii). 
* * [Добавлена](https://github.com/ydb-platform/ydb/issues/12724) поддержка представлений (VIEW) при выполнении операций резервного копирования и восстановления, которая может быть включена администратором кластера с помощью настройки `enable_view_export` в [динамической конфигурации кластера](./maintenance/manual/dynamic-config#obnovlenie-dinamicheskoj-konfiguracii).
...
* Добавлены новые параметры в команды [CREATE USER](../yql/reference/syntax/create-user) и [ALTER USER](../yql/reference/syntax/alter-user):
  * 'HASH' -  
...
* Улучшено управление 
* **_(Experimental)_** [Added](https://github.com/ydb-platform/ydb/pull/8400) new implementation for tablet administration via `ydbd admin tablet`.
...
* _Сделано для ФСТЭК, не хотим анонсировать на всех?_ [Добавлены](https://github.com/ydb-platform/ydb/pull/14173) динамические конфигурации для баз данных.
...
* [Исправлено](https://github.com/ydb-platform/ydb/pull/11059) большое время отклика на чтениях во время и после перешардирования таблиц.
* [Исправлена](https://github.com/ydb-platform/ydb/pull/9723) ошибка, возникающая при чтении из асинхронных реплик.
* [Исправлены] редкие зависания, возникающие в момент первичного сканирования [CDC](./dev/cdc).
* [Исправлена] ошибка инварианта
* 
* 
