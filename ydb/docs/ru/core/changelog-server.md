...
* Старый блокировки преобразуются в shared блокировки из-за ограничений диапазона блокировок.
...
* [Исправлена](https://github.com/db-platform/db/pull/15233) проблема с утечкой значения счетчика для userInfo, которая могла приводить к ошибке чтение `too big in flight`.
* [Исправлен](https://github.com/ydb-platform/db/pull/15467) сбой прокси-сервера из-за дублирования топиков в запросе.
