...
* [Для колоночных таблиц доступны экспорт и импорт резервных копий, включая S3-совместимое хранилище](https://ydb.tech/docs/ru/recipes/import-export-column-tables.md?version=v26.3).
...
* Для колоночных таблиц используется обновлённая стратегия компактизации, которая эффективнее организует данные.
* Для колоночных таблиц можно запускать принудительный компакшн с помощью `ALTER TABLE ... COMPACT`.
...
* Добавлен настраиваемый предел числа хранимых операций принудительного компакшна. Завершённые и отменённые операции могут удаляться автоматически после достижения предела.
