...
* [Исправлено](https://github.com/ydb-platform/ydb/pull/1835) аварийное завершение отладочной сборки и сообщение о неожиданном результате, в случае остановки таблеток даташарда во время работы некоторых операций.
