...
* Исправлена проблема повышенного потребления CPU актором топиков `PERSQUEUE_PARTITION_ACTOR`.
...
* Исправлена ошибка отображения метрики количества партиций в топике, количестко партиций отображалось некорректно.
...
* Исправлена ошибка  INTERNAL_ERROR (has already committed) в стриминговых запросах.
* Исправлены утечки памяти в C++ SDK.
