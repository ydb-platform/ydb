...
* <!-- YDBFEATURES-28: нужна ссылка на документацию --> Кластер сохраняет работоспособность при недоступности CMS.
...
* <!-- YDBFEATURES-117: нужна ссылка на документацию --> Поддержано зеркалирование автопартиционированных топиков в асинхронной репликации; см. также [автопартиционирование топиков в CDC](./concepts/cdc.md?version=v26.1#topic-partitions).
...
* Реализована обработка ответов S3 `SlowDown` (троттлинг) при операциях GET, PUT и DELETE в федеративных запросах.
* В CLI поддерживается аутентификация по файлу токена (`--token-file`).

#### Исправления ошибок

* [Исправлено](https://github.com/ydb-platform/ydb/pull/33620) Fix fluentbit docs (CredentialsYcServiceAccountKey).
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34024) YQ-5083: WM: add SQL text tracking and debug logging to workload serv….
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34620) Fixed commit of offset in federation installation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34667) YQ-5091 rename PQ partitions balancer and fix registration.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34780) Fix v2 with BSC/Console Protocol enabled by default and other V2 fixes.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34816) Change dstool human-readable size to GB instead of GiB.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34856) fix the sequencer issue on multiple origin tasks.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34906) Fix stream RETURNING for UPDATE and interactive queries.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34915) Fixes for SET/DROP DEFAULT.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34947) Add test shard error statistics in mon page.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34958) Fix auth tokens expire time in ticket parser.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34961) YQ-5142 fixed s3 files flush in block output.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/34978) fix invalid groups on hive timeout.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35003) YQ-5089: WM: Fixed query execution after tenant recreation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35040) Fix race in FormatHandler tests.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35047) generic lookup ut: fix racing.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35091) Fixed TSAN error in tests.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35094) Suppress TSAN data race in grpcio PollerCompletionQueue.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35112) Fixed transfer stress tests.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35187) grpc service: fix uaf in ydb over fq [alternative].
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35255) Fix bad variant access to NodeWardenStorageConfig response.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35273) error message has been fixed for column tables.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35274) space watcher leak has been fixed.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35343) Fix #34935.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35344) fix u-a-f in TFakeActor/TFakeCA.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35437) metaservice: fix path mutation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35465) Fix data shred stopping after some iterations.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35469) pq_composite: fix potential verify failure.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35548) YQ-5157 fixed failing after unsuccessful lease update.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35553) Fix check status of ticket parsing.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35636) YQ-5161 fixed race with PQ / Solomon gateway.
...
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35702) github-34117 Shared reading / local kesus: fix PendingDescribe flags.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35735) enhance error handling for invalid acl change.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35739) Move proto to protos subdir to fix  sync to arcadia.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35745) Fixed ydb/services/ydb/backup_ut/BackupRestore.BackupRestoreTransfer_….
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35787) YQ-5164 fix streaming query info not found after create.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35793) async ca/checkpointing: fix stall on full input and empty checkpoint.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/35831) YQ-5143  Row dispatcher counters fix.
...
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36084) Fix tiny ydb harmonizer logic.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36114) Fixed topic partition quota wait time.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36156) Fix default log level setting doc.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36217) Fix cross-database quota interference in Kesus quoter proxy.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36220) YQ-5187 fixed hanging in PQ read session.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36265) fix disk space coding.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36292) Fix scan executer hang on empty table queries with LIMIT.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36360) rd: properly handle duplicated json keys.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36363) Fix use after move in RD.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36365) disk usage has been fixed.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36394) Fix race in mock_pq_gateway.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36395) rd ut: fix tsan error (adds forgotten mutex).
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36612) avoid use after move.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36614) avoid use after move.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36692) Fix TLI deferred LOCKS_BROKEN flush by counting only participating shards.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36816) Fix workload stock init description.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36835) [Optimizers] Disable blocks on column limit..
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36907) Fix datashard's statistic after TRUNCATE TABLE.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/36935) [Optimizer] Fix constant folding.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37021) fix storage balancer.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37051) YDBREQUESTS-7455 Fix incompatibility.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37106) fq checkpoint storage: fix u-a-f.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37130) YQ-5016 fixed streaming query timeout overflow.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37145) Fix thread-safety and token expiry parsing in IAM credentials provider.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37189) Fixed sending AlterLogin requests to SchemeShard after getting error from PasswordHasher.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37285) Fixed a bug in http_gateway.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37319) avoid use after move.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37321) generic lookup: don't ABORT on external errors (arrow parsing/etc).
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37435) Revert "Fixed topic partition quota wait time.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37442) Fix compatibility test (after disable deduplication).
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37556) Fix AddBlobsFromBody key index for FindPos with multiple blobs.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37570) YQ-5215 abort query if partition count changed.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37618) Fix Coverity 106585: avoid use-after-move in PreProcessImmediateTx.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37668) Fixed size_t overflow with null password.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37776) LOGBROKER-10362 Fix memory usage.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37798) [C++ SDK] Fixed coverity issues.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37811) fix handling of hive pipe resets.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37873) Revert commit 685cab5 in discovery.cpp.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37947) Fix state storage web ui.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/37948) YQ-5223 fixed group by hop over DQ replicate.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38014) Fix typo in Kubernetes deployment documentation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38033) Disable change data collection (CDC) for IsBuildInProgress columns.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38490) Fix segfault during update.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38544) Fix to Shuffle elimination when used with HashJoinMode pragma.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38589) fix unbind allocator when extracting top k vector.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38669) solomon ds minor fixes and optimizations.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38674) read config implementation, backpressure/memory accounting improvements and MetricsQueue actor leaks fixed.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38760) fix unitialized fields.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38790) schemeshard: fix altered migrated table indexes.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38801) Fix TRangesBuilder AddRange.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38806) fix use after move warning in the TMonitoringProxy CLOUD-247389.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38807) fix potential mem leak on shutdown CLOUD-243603.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/38810) Fix shutdown flag not setted LOGBROKER-10370.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39188) Fix dry run scenario when overlay item is being deleted from config.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39337) fix duplicated results in scan query on delivery problem.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39459) Fix static self-heal by cleaning vdisks properly and support node deletion.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39465) improved paths limit error for federated s3 queries.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39481) fix reassign actor getting stuck.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39506) fix sdk: fixed self thread join in iam cred provider.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39579) Fixed parsing incorrect ACL strings.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39687) Restrict viewer HTTP endpoints access from database to viewer/admin SIDs and enforce database scope for database-only tokens.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39798) Fix trash OOM on blob depot load.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/39842) YQ-5295 Reconnect fix in shared reading.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40172) pq rd read actor: fix duplicated offset dump.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40464) Fix issue 34933.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40559) Fix storage groups hive request ordering.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40584) fix(viewer_groups): group Limit and Usage calculation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40603) LOGBROKER-10370 Fix stopping grpc server.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40724) fix(viewer_database_stats): group StorageTotal calculation.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40761) generic provider: improve error handling.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40774) Fix SpaceColor to EFlag mapping in viewer.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40885) Optimize CPU of PQ tablet with many partitions.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40912) Fixed the loss of receiving a ReadSet ACK.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/40996) Fix verify failed pdisk.NumActiveSlots == numActiveSlots.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41031) NPB fix umu.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41034) fix self thread join and preserved backwards compatibiliy.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41069) SchemeShard: add drop table test for forced compaction and fix ProcessForcedCompactionQueues.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41424) configs_dispatcher: skip notifying yaml subscribers when yaml is unchanged.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41673) YQ-5231 Fix skip data on new queries(force refresh).
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41680) Fix the invariant that there are not empty chunks in TRope.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41681) fix TQueryBase crash after stream query cancel.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41695) Fix release node name.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41721) YQ-5352 fixed empty compile error in group by hop.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41760) fix u-a-f TryEnqueueOneShard.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41824) Fix indexes ids.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41895) generic provider: fix iam cloud auth.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/41930) Fix path to GlobalPoolTotalBytes and others.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/42005) fix use of moved ev->TraceId.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/42146) YQ-5356 Fix retry limit error.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/42268) Fix dstool cluster balance to address VDisk and PDisk size in units.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/42716) YQ-5302 enabled switch optimization for extract members.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/43068) YQ-5376 fixed local CDC reading form YQL.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/43082) YQ-5380 disabled local topics deduplication.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/43446) [HIVE] don't change state to Stopped for locked tablets on load.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/43570) YQ-5394 fixed internal error in solomon writer.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/43791) YQ-5399 fixed invalid executor id value on KQP node page.
* [Исправлено](https://github.com/ydb-platform/ydb/pull/44340) fixes for quick remote cancel in the query service.
