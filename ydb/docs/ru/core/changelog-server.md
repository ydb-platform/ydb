...
* [Исправлена](https://github.com/ydb-platform/ydb/pull/24278) ошибка, из-за которой при записи сообщений Kafka с использованием форматов батча v0 и v1 сохранялось только первое сообщение из батча, а остальные сообщения игнорировались.
