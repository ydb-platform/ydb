...
* [Исправлена](https://github.com/ydb-platform/ydb/pull/14516) ошибка, которая приводила к блокировке при подтверждении набора данных до завершения волатильной распределенной транзакции.
