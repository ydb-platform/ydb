...
* [Для колоночных таблиц доступны экспорт и импорт резервных копий, включая S3-совместимое хранилище](./recipes/backup/import-export-column-tables.md?version=main).
