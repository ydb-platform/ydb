...
* Поддерживаются [экспорт и импорт колоночных таблиц](https://github.com/ydb-platform/ydb/issues/26498) через S3-совместимые хранилища. Таблицы с большим количеством колонок не поддерживаются. Возможность по умолчанию отключена и может быть включена администратором кластера.
