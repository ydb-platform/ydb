...
* Поддерживаются [экспорт и импорт колоночных таблиц](./recipes/import-export-column-tables.md?version=v26.2) через S3-совместимые хранилища.
...
* Потоковые запросы могут читать [пользовательские атрибуты сообщений топика](./concepts/query_execution/topics.md?version=main).
