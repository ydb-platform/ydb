...
* Потоковая обработка и поставка данных теснее интегрированы в ядро: [трансфер «топик → таблица»](./concepts/transfer.md?version=v25.4), потоковые запросы стали доступны пользователям при включении 'EnableStreamingQueries'.
...
* Добавлена поддержка конфигурации 2 ДЦ с синхронной записью данных (режим `Bridge`); доступно в {{ ydb-short-name }} Enterprise.
* Улучшения топиков:
...
* Добавлена возможность [задать приоритеты](./devops/concepts/maintenance-without-downtime#priority) задачам обслуживания в [системе управления кластером](./concepts/glossary#cms).
