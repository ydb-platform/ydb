...
* [Реализована](https://github.com/ydb-platform/ydb/issues/9748) возможность переключения функциональных флагов в рантайме. Флаги, для которых в [proto файле](https://github.com/ydb-platform/ydb/blob/main/ydb/core/protos/feature_flags.proto#L60) не указан параметр `(RequireRestart) = true`, будут применяться без необходимости рестарта.
...
* Исправлена сортировка строк на вкладке Запросы, где данные некорректно сортировались как строковые значения.
