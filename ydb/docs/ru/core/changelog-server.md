...
* QueryService поддерживает выдачу результатов запросов в формате Apache Arrow; эта возможность включена по умолчанию.
...
* Поддерживаются [экспорт и импорт колоночных таблиц](https://ydb.tech/docs/ru/core/recipes/backup/import-export-column-tables?version=main) через S3-совместимые хранилища.
* Добавлены [экспорт и импорт строковых таблиц](https://ydb.tech/docs/ru/core/reference/ydb-cli/export-import/export-nfs?version=main) через локальную файловую систему, в том числе через файловые системы, подключённые по NFS.
...
* Добавлены [min-max-индексы](https://ydb.tech/docs/ru/core/yql/reference/syntax/create_table/min_max_index?version=main) для колоночных таблиц.
