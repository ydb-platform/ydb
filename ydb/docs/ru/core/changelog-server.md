...
* [Исправлена](https://github.com/ydb-platform/ydb/pull/16637) проблема, которая приводила к ошибке при вставке данных с помощью Upsert в строковые таблицы с дефолтными значениями.
* [Устранена](https://github.com/ydb-platform/ydb/pull/16637) ошибка, которая приводила к сбою при выполнении запросов, возвращающих списки с несколькими входными параметрами и индексами.
