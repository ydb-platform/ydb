...
* Добавлена стратегия компакции Tiling++ для колоночных таблиц. Она выбирается параметром `default_compaction_preset`.
...
* Для подходящих сканирований колоночных таблиц включён Trivial Reader.
