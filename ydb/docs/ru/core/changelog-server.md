...
* Исправлены проблемы совместимости с танком.
* Исправлены проблемы влияющие на стабильность работы.
...
* Устранено излишнее логирование даташарда.

**Функциональность:**
* Добавлены ANSI-настройки для обобщенного интерфейса выполнения запроса.
...
* Добавлены гистограммы времени выполнения grpc запросов.
