...
* [Оптимизировано](https://github.com/ydb-platform/ydb/pull/2083) использование ресурсов репликами Schemeboard. Особенно заметно при наличии изменений таблиц с большим числом партиций. 

**Исправления ошибок:**

* Исправлена ошибка, возникавшая в некоторых ситуациях записи в топик с пустым producer_id при выключенной дедупликации.
* [Устранена](https://github.com/ydb-platform/ydb/pull/3165) гонка между процессами слияния таблиц и сжатия данных.
* [Исправлена](https://github.com/ydb-platform/ydb/pull/2169) ошибка частичной фиксации накопленных изменений при использовании  распределенных транзакций.
* Исправлена ошибка отображения метрики количества партиций в топике.
* Исправлена проблема, приводящая к падению процесса YDB из за ошибочного состояния сессии записи в топик.
* Исправлены внутренние серверные ошибки BlobStorageController. 
