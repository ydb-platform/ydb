...
* Добавлено [удержание snapshot](https://github.com/ydb-platform/ydb/pull/36668) для длительных аналитических запросов к колоночным таблицам, чтобы данные snapshot не удалялись до завершения запроса. Возможность по умолчанию отключена и может быть включена администратором кластера.
