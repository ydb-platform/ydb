...
domains_config:
  domain:
    - name: Root
      scheme_limits:
        max_paths: 50000              # Максимальное количество объектов схемы (таблиц, директорий)
        max_table_columns: 500        # Максимум столбцов в таблице
        max_table_indices: 50         # Максимум индексов в таблице
        max_shards: 300000            # Максимум шардов в базе
      storage_pool_types:
        - kind: ssd
