...
Отдельно существуют [локальные индексы](../glossary.md#local-index): вспомогательные структуры, которые хранятся вместе с данными таблицы и применяются при чтении на стороне хранилища, не материализуя отдельную индексную таблицу (см. раздел [Локальные индексы](#local-skip-index) ниже).
...
## Локальные индексы {#local-skip-index}

[Локальные индексы](../query_execution/local_indexes.md) — вспомогательные структуры, хранящиеся вместе с данными таблицы и применяемые при чтении на стороне хранилища. Они не материализуют отдельную индексную таблицу. Сейчас реализованы [Блум-индексы](../../dev/bloom-skip-indexes.md) и [min_max-индекс](../../dev/min_max-skip-index.md).
