...
В отличие от вторичных индексов, оптимизирующих поиск по равенству или диапазону, полнотекстовые индексы позволяют масштабируемо выполнять текстовый поиск по словам и фразам (а при использовании N-грамм — и по подстрокам). См. также: [Полнотекстовый поиск](../fulltext_search.md).
