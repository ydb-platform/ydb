...
В настоящее время одновременное использование [столбцовых таблиц](../glossary.md#column-oriented-table) и [строковых таблиц](../glossary.md#row-oriented-table) таблиц возможно только в транзакциях Read-Only. Поддержка пишущих транзакций находится в разработке.
