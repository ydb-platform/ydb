...
{{ ydb-short-name }} поддерживает транзакции с участием таблиц и/или топиков. Таким образом, в рамках транзакции можно производить операции чтения и записи как с таблицами, так и с топиками. Операции с топиками в транзакции всегда выполняются с уровнем *Serializable*.
