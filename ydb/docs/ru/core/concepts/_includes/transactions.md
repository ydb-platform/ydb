...
{{ ydb-short-name }} поддерживает транзакции с участием таблиц и/или топиков. Таким образом, можно транзакционно перекладывать данные из таблиц в топики и в обратном направлении, а также между топиками, чтобы данные не терялись и не дублировались даже в случае непредвиденных обстоятельств. Операции с топиками в транзакции всегда выполняются с уровнем *Serializable*.
