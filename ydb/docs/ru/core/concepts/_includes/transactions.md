...
**Гарантии.** Низкая задержка и высокая пропускная способность за счёт чтения с локальных реплик. Согласованность данных на уровне ключа внутри  **одного** запроса; между **разными** запросами в одной транзакции согласованность **не** гарантируется.
