...
Подробнее о транзакционных операциях при работе с топиками см. в [{#T}](../datamodel/topic.md#topic-transactions) и [Работа с топиками](../../reference/ydb-sdk/topic.md).
