...
* Для вытеснения данных в приватное S3-совместимое хранилище настройте [внешний источник данных](../datamodel/external_data_source.md) с `AUTH_METHOD="AWS"` и используйте [CREATE SECRET](../../yql/reference/syntax/create-secret.md) в параметрах `AWS_ACCESS_KEY_ID_SECRET_PATH` и `AWS_SECRET_ACCESS_KEY_SECRET_PATH`.
