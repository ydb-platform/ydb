...
Процесс асинхронной репликации можно завершить, без возможности возобновить. Завершение асинхронной репликации используется в конце процедуры миграциии между базами данных. При завершении:
