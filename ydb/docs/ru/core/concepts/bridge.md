...
![Диаграмма состояний кластера](_assets/bridge_pile_states.drawio.png)
...
Аналогично выполняется переключение и в случае, когда отказавший pile был в любом другом состоянии, а назначаемый PRIMARY pile был в одном из допустимых состояний (PRIMARY, SYNCHRONIZED, PROMOTED).
