...
Для строковых таблиц фильтр Блума можно включить для первичного ключа: это ускоряет множественные точечные запросы по ключу за счёт снижения числа операций ввода-вывода, ценой увеличения потребления памяти.
