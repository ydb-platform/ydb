...
* Поддерживается возможность задавать сжатие и кодирование данных индивидуально для каждой колонки. Подробнее в разделе [{#T}](../../../yql/reference/syntax/create_table/index.md#параметры-запроса).
