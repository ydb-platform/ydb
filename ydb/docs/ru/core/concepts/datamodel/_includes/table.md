...
При принятии решения о разделении партиции по нагрузке или об объединении нескольких партиций по нагрузке, YDB рассматривает CPU нагрузку и на лидера данной партиции, и на все её реплики.
