...
- **Восстановление по цепочке**: Восстановление к состоянию на момент выбранной резервной копии (обычно самой поздней в актуальной цепочке — см. [`RESTORE`](../../yql/reference/syntax/restore-backup-collection.md)).
