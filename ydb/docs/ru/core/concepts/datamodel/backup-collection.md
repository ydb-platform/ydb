...
Каталог `.backups` создаётся автоматически при создании первой коллекции резервных копий. Не создавайте этот каталог вручную. После его создания вы можете управлять таблицами резервных копий внутри него (например, при экспорте или импорте резервных копий).
