...
Когда {{ydb-short-name}} обращается ко внешним системам — например, для получения данных из объектных хранилищ или внешних СУБД через [федеративные запросы](../federated_query/index.md) или для [асинхронной репликации](../async-replication.md) или [трансфера данных](../transfer.md) в другую базу {{ydb-short-name}}, — возникает задача аутентификации во внешних системах. Для её решения аутентификационные данные, требующие особого обращения, такие как пароли и токены, можно хранить в специальных схемных объектах — секретах.
