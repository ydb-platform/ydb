...
* [Переименование таблицы в YQL](../../yql/reference/yql-core/syntax/alter_table)
...
У каждой группы колонок есть собственное имя, уникальное в рамках таблицы. Состав групп колонок устанавливается при [создании таблицы](../../yql/reference/yql-core/syntax/create_table#column-family), а также может быть [изменен](../../yql/reference/yql-core/syntax/alter_table#column-family) позднее. Удаление групп колонок из существующей таблицы не предусмотрено.
