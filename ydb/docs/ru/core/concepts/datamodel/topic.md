...
Для работы с топиками можно использовать [YQL запросы](../query_execution/topics.md), с привычными конструкциями: [SELECT](../../yql/reference/syntax/select/index.md) для чтения сообщений из топика, [INSERT](../../yql/reference/syntax/insert_into.md) для записи сообщений в топик.
