...
Типичный пример использования — обмен сообщениями между микросервисами. Читать из топика с использованием разделяемого (общего) читателя можно по протоколу [Amazon SQS](../../reference/sqs-api/index.md).
