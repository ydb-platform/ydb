...
Также поддерживаются запросы на [YQL](../../yql/reference/index.md), которые используют привычные SQL-конструкции: [SELECT](../../yql/reference/syntax/select/index.md) для чтения сообщений из топика, [INSERT](../../yql/reference/syntax/insert_into.md) для записи сообщений. См. [SQL-синтаксис над топиками](../query_execution/topics.md).
