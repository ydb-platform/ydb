...
|`Float64`|`Double`||
|`Date`|`Date`||
|`Date32`|`Date`|Допустимый диапазон дат с 1970-01-01 и до 2105-12-31. При выходе значения за границы диапазона оно заменяется на `NULL`.|
|`DateTime`|`DateTime`|Допустимый диапазон значений времени с 1970-01-01 00:00:00 и до 2105-12-31 23:59:59. При выходе значения за границы диапазона оно заменяется на `NULL`.|
|`DateTime64`|`Timestamp`|Допустимый диапазон значений времени с 1970-01-01 00:00:00 и до 2105-12-31 23:59:59. При выходе значения за границы диапазона оно заменяется на `NULL`.|
|`String`|`String`||
