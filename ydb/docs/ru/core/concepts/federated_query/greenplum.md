...
В этом разделе описана основная информация про работу с внешней базой данных [Greenplum](https://greenplum.org). Поскольку Greenplum основан на технологии PostgreSQL, некоторые моменты совпадают, поэтому некоторые ссылки могут вести на документацию по PostgreSQL.
