...
При работе с S3-совместимым хранилищем данных с помощью [внешних источников данных](../../datamodel/external_data_source.md) удобно быстро просматривать файлы, проверять права доступа, пути и параметры хранения данных до создания [внешних таблиц](../../datamodel/external_table.md).
