...
**Корневая база данных кластера** – это системная база данных, создаваемая для нужд {{ ydb-short-name }} в корне схемы кластера. Эта база данных содержит служебную информацию, например [пользователей](#access-user), [права](#access-right) и [уровни доступа](#access-level), тенантные базы данных, и т.д.
