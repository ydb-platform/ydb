...
#### Console (управление БД) {#console-databases}

**Console** — это системная таблетка, которая управляет [базами данных](#database) кластера, отвечает за хранение [динамической конфигурации](../devops/configuration-management/configuration-v1/dynamic-config.md) и её доставку на узлы, обеспечивая надежное сохранение и распространение настроек. Таблетка Console единственна на весь кластер.
