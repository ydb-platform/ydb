...
Механизм обработки непрерывно поступающих данных в реальном времени, обеспечивающий мгновенную реакцию и постоянное обновление результатов. Подробно описан в статье [{#T}](streaming-query.md)
