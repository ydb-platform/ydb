...
**Владелец** - [субъект доступа](#access-subject) (пользователь или группа) имеющий полный объем прав на конкретный [объект доступа](#access-object). Для владельца не проверяются [списки разрешений](#access-control-list) на данный объект доступа.
