...
**Режим bridge** — это особая топология кластера, в рамках которой данные хранятся с синхронной репликацией между несколькими [pile](#pile). Особенности режима описаны в [{#T}](topology.md#bridge).
...
>>>>>>> 658c024538f (Initial virtual groups (#27211))
