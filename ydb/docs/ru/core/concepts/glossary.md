...
Отдельно выделяются специальные виды **вторичного индекса**: [векторный индекс](#vector-index) и [локальный Bloom skip индекс](#local-bloom-skip-index).
