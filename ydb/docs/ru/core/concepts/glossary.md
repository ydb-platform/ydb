...
### Отпимизатор запросов {#optimizer}

[**Оптимизатор запросов**](https://en.wikipedia.org/wiki/Query_optimization) - модуль YDB, который оптимизирует планы выполнения запросов. Он описан более подробно в отдельной статье [{#T}](optimizer.md).
