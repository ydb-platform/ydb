...
Возможности {{ ydb-short-name }} по приближенному векторному поиску (ANN search) с помощью векторных индексов описаны в отдельной статье [{#T}](../dev/vector-indexes.md).
