...
**Режим bridge** — это особый режим работы кластера, при котором данные хранятся с синхронной репликацией между несколькими [pileми](#pile). Особенности режима описаны в [{#T}](topology.md#bridge), а также в [{#T}](bridge.md).
### Таблица {#table}
...
**SchemeBoard** - распределенный сервис, предназначенный для хранения метаданных в виде пар ключ-значение. Используется в том числе для хранения информации о [схемах](#schema).
