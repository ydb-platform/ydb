...
### Аудитный лог {#audit-log}

Поток записей, фиксирующих события и операции, значимые для контроля безопасности при работе с кластером {{ ydb-short-name }}. В отличие от технических логов, которые помогают в обнаружении сбоев и устранении неполадок, аудитный лог предоставляет данные значимые для безопасности. Он служит источником информации, отвечая на вопросы: кто что сделал, когда и откуда.

См. подробности в статье [Аудитный лог](../security/audit-log.md).
