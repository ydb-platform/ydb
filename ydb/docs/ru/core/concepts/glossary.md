...
**Корневая база данных кластера** – это системная база данных, создаваемая для нужд {{ ydb-short-name }} в корне схемы кластера. Эта база данных содержит служебную информацию, например пользователей, права и уровни доступа, тенантные базы данных, и т.д.
