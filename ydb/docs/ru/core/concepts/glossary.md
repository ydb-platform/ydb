...
**Системные представления** являются неотъемлемой частью системы и предназначены для отслеживания состояния отдельных баз данных и всего кластера. 
Они располагаются в директории `.sys`, которая находится в корне каждой базы данных. 
Системные представления баз данных описаны подробно в [{#T}](../dev/system-views.md), а системные представления кластера и управление доступом к ним - в [{#T}](../devops/observability/system-views.md).
