...
|Тип группы|Статическая|Динамическая|
|---|---|---|
|Физическая|Специальная группа хранения предназначенная для хранения данных [системных таблеток](#txallocator)|Обычные группы хранения, применяются для хранения данных по умолчанию|
...
**Виртуальная группа хранения** или **virtual storage group** — это [группа хранения](#storage-group), хранящая свои данные в других группах хранения.

Виртуальные группы помогают решить главный недостаток физических групп: они позволяют более гибко управлять дисковой подсистемой кластера, в частности уменьшать её. Это становится возможным благодаря механизму декомиссии: он позволяет скопировать данные с физической группы на виртуальную, а затем удалить физическую.
