...
В целях горизонтального масштабирования, топик разделен на отдельные элементы.
**Партиция**, **раздел**,  **partition** — это единица параллелизма внутри топика. Сообщения внутри партиции топика упорядочены.
