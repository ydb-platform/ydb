...
**Корень схемы кластера** — это корневой элемент [пространства имен {{ ydb-short-name }}](datamodel/cluster-namespace.md), дочерними элементами которого выступают [базы данных](#database).
