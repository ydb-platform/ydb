...
Подробнее об устройстве StateStorage и связанных подсистем — в разделе [{#T}](metadata-distribution.md).
...
Подробнее об устройстве Board и связанных подсистем — в разделе [{#T}](metadata-distribution.md).
...
Подробнее об устройстве SchemeBoard и связанных подсистем — в разделе [{#T}](metadata-distribution.md).
