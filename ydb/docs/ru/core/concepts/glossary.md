...
**Экземпляр трансфера** — это именованная сущность, хранящая настройки [трансфера](transfer.md) (настройки подключения, правило преобразование данных и т.д.). Также с его помощью можно получить информацию о состоянии трансфера: [ошибки](transfer.md#error-handling) и т.д.
