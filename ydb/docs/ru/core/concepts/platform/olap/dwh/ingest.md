...
- [JDBC-драйвер](../../../../reference/languages-and-apis/jdbc-driver/index.md) и [нативные SDK](../../../../reference/languages-and-apis/index.md) — с их помощью можно подключить любые приложения или пайплайны, включая Apache Spark, Apache NiFi и любые другие решения, поддерживающие технологию JDBC.
