...
<<<<<<< HEAD:ydb/docs/ru/core/concepts/federated_query/ms_sql_server.md
...
>>>>>>> 513440ae1e0 (DOCSUP-119247: Рефакторинг выполнения запросов (#29906)):ydb/docs/ru/core/concepts/query_execution/federated_query/ms_sql_server.md
