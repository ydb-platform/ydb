...
Для словарной нормализации слов при полнотекстовом поиске доступен [SuperLemmer](../../dev/fulltext-indexes.md#superlemmer), оптимизированный прежде всего для русского языка. Он доступен только в [Корпоративной СУБД Яндекса](../../downloads/yandex-enterprise-database.md).
