...
{{ ydb-short-name }} выполняет каждую ветвь по своему индексу, извлекает из каждой пул кандидатов и объединяет их ранжирования. Доступны два способа объединения:
...
* [Гибридный поиск](../../dev/hybrid-search.md)
