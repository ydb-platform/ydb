...
Механизм спиллинга в {{ ydb-short-name }} включает два основных уровня: бэкенд - сервис для хранения данных на диске, и фронтенд - компоненты, которые взаимодействуют с этим сервисом и управляют памятью.
