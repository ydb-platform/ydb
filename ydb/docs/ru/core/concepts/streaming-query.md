...
Потоковые запросы создаются один раз и работают постоянно. Данные непрерывно поступают в топик, «протекают» через запрос и записываются в приёмник — другой топик или таблицу.
