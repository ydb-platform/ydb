...
- `JOIN` двух потоков;
- обогащение из локальных таблиц {{ ydb-short-name }};
- чтение/запись локальных топиков без использования [внешних источников данных](../concepts/datamodel/external_data_source.md).
