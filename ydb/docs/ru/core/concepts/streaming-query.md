...
Потоковые запросы обеспечивают гарантию at-least-once. Это гарантируется повторной обработкой данных с последнего сохраненного чекпоинта с дедупликацией при вставке в топик.
