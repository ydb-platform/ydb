...
Стиминговые запросы обеспечивают гарантия exactly-once. Это гарантируется повторными обработкой данных с последнего сохраненного чекпойнта с дедупликации при ставке в топик.
