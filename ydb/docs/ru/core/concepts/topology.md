...
- `block-8-2`. Восемь частей данных, две части чётности и два handoff-VDisk занимают двенадцать независимых доменов отказа. Группа переживает два отказа с идеальной избыточностью 1.25. Резервные домены выбираются по требованиям к восстановлению. См. [конфигурацию и требования к версиям](block-8-2.md).
...
| `block-8-2`, переживает отказ 2 стоек | 1.25 | 12 (плюс резерв для конкретного развёртывания) | Стойка | Дата-центр | 1 | 12 |
