...
Блобовый интерфейс позволяет хранить *блобы* (бинарные фрагменты размером от 1 байта до 10 МиБ) с уникальным идентификатором. Подсистема также предоставляет примитивы DDisk и PersistentBuffer для прямого блочного доступа. Эти пути используют общую инфраструктуру управления устройствами и размещения, но имеют разные контракты данных и репликации.
