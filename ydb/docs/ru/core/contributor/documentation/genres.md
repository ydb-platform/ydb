...
Практические руководства по {{ ydb-short-name }} теперь в основном расположены в профильных разделах документации, хотя похожий контент может также появляться в папках, специфичных для роли.
