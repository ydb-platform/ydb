...
- **[Для разработчиков приложений](../../dev/index.md).** Папка для разработчиков приложений, работающих с {{ ydb-short-name }}. В основном состоит из [практических руководств](genres.md#guide) и [теории](genres.md#theory).
...
Машинообработаемая модель структуры документации находится в файле [`.ruler/DOCUMENTATION_MODEL.yaml`](../../.ruler/DOCUMENTATION_MODEL.yaml). Эта модель используется документаторскими скиллами, AI-агентами и другими автоматизированными инструментами для:

- Валидации размещения нового контента в правильных разделах
- Анализа структуры PR-ов с документацией
- Понимания целевой аудитории и жанра статей
- Генерации документации по шаблонам

Если вы разработчик документаторского скилла или работаете с автоматизацией, смотрите этот файл как источник истины о структуре документации.