...
- **Диаграммы.** Предпочитайте встроенные диаграммы [Mermaid](https://github.com/diplodoc-platform/mermaid-extension), если это возможно. Если используется сторонний инструмент для диаграмм, сохраните исходный файл в ту же папку `_assets` рядом с изображением для будущих правок. Убедитесь, что диаграммы хорошо выглядят как в светлой, так и в тёмной теме.
