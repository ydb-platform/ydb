...
Максимальное потребление на узле доступно в виде [сенсора](../devops/observability/monitoring.md) `Hive/MAX(BalanceUsageMax)` в подгруппе `tablets`.
...
- [Hive web-viewer](../reference/ydb-ui/hive.md)
