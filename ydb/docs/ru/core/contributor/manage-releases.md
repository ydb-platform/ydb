...
Информацию о текущих активные мажорных и минорных ветках можно найти у [команды {{ ydb-short-name }}](https://github.com/orgs/ydb-platform/teams/engineering) или найти в закрепленном сообщении чата YDB Releases, если являетесь участником команды.
...
2. Внесите информацию о фиче в релизную таблицу (выберите актуальный релиз):

   * укажите тикет, в котором велась разработка,
   * укажите, является ли фича обратно совместимой,
   * добавьте тикет на включение фичи на кластерах,
   * приложить и согласуйте тест-план,
