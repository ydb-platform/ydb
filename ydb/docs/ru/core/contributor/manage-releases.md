...
* **Исправление бага**. Изменение, направленное на устранение конкретной ошибки. Не считается исправлением ошибки полностью переписанные с нуля подсистемы.
* **Исправление критического бага**. Срочное исправление серьезной проблемы, которое требуется немедленно выкатить в продакшн. Без срочного исправления критических багов высока вероятность наступления серьезных негативных последствий.
