...
2. Названия параметров должны состоять из нескольких слов, причём главным должно быть последнее, а каждое предшествующее слово должно уточнять последующее. Например:
