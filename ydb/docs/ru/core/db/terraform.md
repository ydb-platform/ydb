...
Для применения изменений в terraform ресурсе используются следующие команды:
...
Для удобства использования (рекомендация) файлы terraform стоит именовать следующим образом:
