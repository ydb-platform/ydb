...
* Для таблиц с нецелочисленным или составным первичным ключом автоматически создаются системная колонка `__ydb_row_id` и уникальный индекс `uniq__ydb_row_id` (см. [Типы первичного ключа](#primary-key)).
