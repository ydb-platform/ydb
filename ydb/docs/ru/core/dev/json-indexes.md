...
Пакетные операции (`BATCH UPDATE` и `BATCH DELETE`) для таблиц с JSON-индексами не поддерживаются: при попытке выполнения такого запроса над таблицей, для которой создан JSON-индекс, будет возвращена ошибка.
...
**Примеры ограничений, применяемых через JSON-индекс:**
...
**Примеры ограничений, которые не могут быть применены через JSON-индекс:**
