...
min_max-индекс полезен, когда значения индексируемой колонки обладают локальностью внутри хранимых фрагментов: например, это временные метки, монотонно растущие идентификаторы, уровни статусов, цены или другие значения, которые естественно группируются после загрузки или компакции.
