...
- Сопоставьте метрики со стадиями и каналами в структуре — узкое место часто совпадает с тяжёлой стадией или каналом.
