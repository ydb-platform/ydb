...
Колонки диаграммы описаны в [Расположении информации на плане](layout.md).
...
Рассмотрим CPU на примере стадии ```0``` из раздела [Структура плана запроса](structure.md). Здесь «потребление» — использование процессорного времени на полезную работу. Простой стадии не даёт вклада в CPU; при работе вклады [задач](../../concepts/glossary.md#task) суммируются обычным агрегированием.
