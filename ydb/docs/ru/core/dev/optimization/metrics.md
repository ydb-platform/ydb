...
- для объёма (данные, память) — подписи интерфейса `KB`, `MB`, `GB` и т.д. с двоичными множителями 2¹⁰, 2²⁰, 2³⁰; в стандартной записи это КиБ, МиБ, ГиБ соответственно;
...
- Сравните полосы `Statistics` и `Timeline` — найдите [стадии](../../concepts/glossary.md#processing-stage) с наибольшим CPU, памятью или трафиком.
