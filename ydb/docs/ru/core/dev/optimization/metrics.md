...
- Сопоставьте метрики со стадиями и каналами на графе — узкое место часто совпадает с тяжёлой стадией или каналом.
- Сравните оценки `EXPLAIN` с фактическими метриками `ANALYZE`.
