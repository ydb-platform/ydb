...
- BroadcastJoin - один из входов операции реплицируется на все вычислительные таски, выполняющие операцию
- ShuffleJoin - оба входа распределяются на вычислительные таски по ключу соединения
