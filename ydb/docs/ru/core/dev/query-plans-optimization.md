...
- {{ ydb-short-name }} CLI
  ...
  Получить план запроса через {{ ydb-short-name }} [CLI](../reference/ydb-cli/index.md) можно с помощью следующей команды:
  ```
