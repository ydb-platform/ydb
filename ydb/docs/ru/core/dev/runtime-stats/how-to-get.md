...
Для получения графического плана выполнения запроса в {{ ydb-short-name }} UI необходимо включить настройку ```Experiments | Execution plan```
