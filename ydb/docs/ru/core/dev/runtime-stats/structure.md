...
На данном графике два разных случая. Первый - это небольшое количество данных. Если посмотреть на степени параллельности (третий по счёту столбец), то можно заметить, что:
