...
Без индекса запрос по полю, не входящему в первичный ключ, выполняет полное сканирование таблицы (FullScan) — чтение и проверку каждой строки. Например, для таблицы:
