...
- [Использование локальных и внешних топиков](local-and-external-topics.md)
...
- [Обогащение данных](enrichment.md) — способы обогащения данных в потоке с использованием справочников.
...
- [Водяные знаки](watermarks.md) — механизм отслеживания прогресса времени в потоке данных.
