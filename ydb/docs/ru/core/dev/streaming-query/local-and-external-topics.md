...
Все сценарии использования потоквых запросов работают одинаково с локальными{#local-topics} и внешними {#external-topics} топиками. Один и тот же запрос может одновременно читать локальный топик, писать во внешний и наоборот.
