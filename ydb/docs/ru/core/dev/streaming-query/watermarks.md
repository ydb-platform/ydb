...
Сейчас водяной знак вычисляется как время записи события в топик, уменьшенное на 5 секунд. Более тонкая настройка параметров водяного знака может быть произведена в секции [WITH](../../../core/yql/reference/syntax/select/with.md) при чтении из источника.
