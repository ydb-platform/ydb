...
При потоковой обработке важно различать момент возникновения события и момент его обработки системой. Эти моменты могут существенно отличаться из-за сетевых задержек, буферизации на стороне источника или временной недоступности отправителя. Для корректной работы временных окон агрегации, таких как [HoppingWindow](../../yql/reference/syntax/select/group-by.md#group-by-hopping_window), системе необходимо знать время возникновения каждого события.
