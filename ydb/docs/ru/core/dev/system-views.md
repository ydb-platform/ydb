...
Системное представление `streaming_queries` содержит информацию о текущих [потоковых запросах](../concepts/streaming_query/index.md) (как запущенных, так и остановленных).
