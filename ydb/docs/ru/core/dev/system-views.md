...
Текст запроса ограничен 10 кибибайтами.
...
| `Query` | Текст запроса. Если запрос больше 10 КиБ, он обрезается.<br/>Тип: `Utf8`. |
...
| `IsTruncated` | Флаг, указывающий, был ли текст запроса обрезан из-за превышения лимита в 10 КиБ.<br/>Тип: `Bool`. |
