...
Для разграничения доступа к служебной информации, хранящихся в них, вы можете назначать отдельные списки прав на различные системные представления, а также на каталог `.sys`.
