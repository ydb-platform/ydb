...
* **Жёсткий лимит размера партиции на уровне кластера** — по умолчанию **2 ГБ**. Если размер партиции превышает этот лимит, она разделится, если только не достигнут [`AUTO_PARTITIONING_MAX_PARTITIONS_COUNT`](auto/index.md#auto-sharding-limits) или [лимит числа шардов таблицы в базе](../../../concepts/limits-ydb.md#schema-object).
