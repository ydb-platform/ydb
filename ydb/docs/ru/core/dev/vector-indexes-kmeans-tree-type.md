...
При использовании покрывающего индекса в таблицу `indexImplPostingTable` копируются указанные колонки из индексируемой таблицы. Вот так будет выглядеть таблица, если при создании покрывающего индекса указать колонку `embedding`:
