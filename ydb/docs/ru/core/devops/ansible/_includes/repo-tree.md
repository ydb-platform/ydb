...
├── 3-nodes-mirror-3-dc-fq / 9-nodes-mirror-3-dc-fq / 8-nodes-block-4-2-fq #
│   ├── #содержимое аналогично директориям без суффиксов -fq
│   ├── #конфигурационные файлы адаптированы для функции Federated Query
│   ├── #дополнительные файлы:
│   └── files
│       └── fq_config.yaml #Конфигурационный файл fq-connector-go.
