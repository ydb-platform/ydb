...
Значение переменной `ydb_database_groups` в разделе `vars` задает количество [групп хранения](https://ydb.tech/docs/ru/concepts/glossary#storage-group) для создаваемой базы данных.
