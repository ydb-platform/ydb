...
Подробнее про настройку NFS для резервного копирования и восстановления см. рецепт [Резервное копирование и восстановление через NFS](../recipes/ydb-cli/nfs-backup.md).
