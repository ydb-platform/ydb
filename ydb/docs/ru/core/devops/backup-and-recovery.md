...
Подробнее про операции резервного копирования и восстановления можно прочитать в разделе [Резервное копирование и восстановление через NFS](_includes/backup_and_recovery/nfs-backups.md).
