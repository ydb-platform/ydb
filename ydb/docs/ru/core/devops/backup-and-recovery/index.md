...
|| [Резервное копирование системных таблеток](#system-tablet-backup) | Файловая система кластера | Полные и инкрементальные копии | Да, кроме отказа оборудования в кластере | Защита от повреждения метаданных кластера в рабочей среде ||
|#
...
Механизм резервного копирования системных таблеток, таких как [Hive](../../concepts/glossary.md#hive), [BSController](../../concepts/glossary.md#bs-controller) и [SchemeShard](../../concepts/glossary.md#scheme-shard), обеспечивает инкрементальное копирование метаданных кластера на локальную файловую систему хостов кластера. Это позволяет повысить отказоустойчивость, защищая кластер от повреждения метаданных в основном хранилище.
