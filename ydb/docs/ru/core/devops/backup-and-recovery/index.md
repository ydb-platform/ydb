...
|| [Резервное копирование системных таблеток](#system-tablet-backup) | Файловая система кластера | Полные и инкрементальные копии | Нет | Защита от повреждения метаданных кластера в рабочей среде ||
|#
