...
|| [Import/Export NFS через {{ ydb-short-name }} CLI](#nfs) | Файловая система | Полные копии | [Да*](#nfs-warning) | Миграция больших объемов данных, архивирование, передача рабочих данных ||
...
{% note warning "Особенности NFS-бэкапов" %}
