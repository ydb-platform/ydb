...
|| [Резервное копирование системных таблеток](#system-tablet-backup) | Файловая система кластера | Полные и инкрементальные копии | Да, кроме отказа железа в кластере | Защита от повреждения метаданных кластера в рабочей среде ||
|#
...
Механизм резервного копирования системных таблеток, например, [Hive](../../concepts/glossary.md#hive), [BSController](../../concepts/glossary.md#bs-controller), [SchemeShard](../../concepts/glossary.md#scheme-shard), обеспечивает инкрементальное копирование метаданных кластера на файловую систему кластера, что позволяет повысить отказоустойчивость, защищая кластер от повреждений метаданных, хранящихся в основном хранилище.

Резервное копирование системных таблеток лучше всего подходит для рабочих сред, требующих максимальной отказоустойчивости. Для более простых сценариев, таких как разовые миграции или среды разработки, рассмотрите возможность использования команд [dump/restore](#files).
