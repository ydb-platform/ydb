...
- [Рецептах для коллекций резервных копий](../../recipes/backup/backup-collections/index.md) — типовые сценарии и примеры
...
Механизм резервного копирования системных таблеток обеспечивает инкрементальное копирование метаданных кластера на локальную файловую систему хостов кластера.

Концептуальную информацию и принцип работы см. в [Концепциях резервного копирования](../../concepts/backup.md#system-tablet-backup).

Пошаговые инструкции по включению и восстановлению см. в [Рецептах для резервного копирования системных таблеток](../../recipes/backup/system-tablet-backup/index.md).
