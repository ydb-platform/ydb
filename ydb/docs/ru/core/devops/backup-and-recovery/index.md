...
|| [Резервное копирование системных таблеток](#system-tablet-backup) | Файловая система кластера | Полные и инкрементальные копии | Да, кроме отказа оборудования в кластере | Восстановление метаданных кластера, когда другие способы восстановления недоступны ||
|#
