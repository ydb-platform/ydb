...
Добавление дисков увеличивает ёмкость хранилища кластера и используется, когда текущих дисков недостаточно под данные или планируется рост нагрузки. Общие сценарии расширения кластера описаны в разделе [{#T}](../../../devops/configuration-management/configuration-v1/cluster-expansion.md).
