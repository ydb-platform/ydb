...
В этом разделе описано, как добавить новый жёсткий диск в кластер {{ ydb-short-name }}, развёрнутый по топологии `3-nodes-mirror-3-dc` (конфигурация V2), с помощью Ansible.
