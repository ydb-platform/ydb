...
Цель — подобрать конфигурацию так, чтобы данные гарантированно поместились и в кластере остался рабочий запас.

Для описания конфигурации будем использовать два параметра:
