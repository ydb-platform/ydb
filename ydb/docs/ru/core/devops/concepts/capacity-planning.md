...
2. Определите размер слота:
    ...
    Данная формула применима для дисков объёмом от ~839 ГБ (800 ГиБ). Использование дисков меньшего размера не рекомендуется, если необходимо достижение оптимальной производительности. Подробнее о требованиях к дисковой подсистеме читайте в разделе [{#T}](system-requirements.md).
