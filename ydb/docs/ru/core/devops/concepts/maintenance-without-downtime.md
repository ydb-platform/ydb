...
Если кластер использует bridge mode конфигурацию, то все лимиты устанавливаются для каждого pile независимо и все проверки доступности выполняются для каждого pile независимо.
