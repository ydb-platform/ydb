...
Во внештатных ситуациях (например, при риске выхода из строя целых стоек или сегментов датацентра), когда любой перезапуск узла несет риск деградации системы, есть возможность приостановить новые работы по обслуживанию кластера с помощью параметра `disable_maintenance` в [конфигурации CMS](../../reference/configuration/cms_config.md).
