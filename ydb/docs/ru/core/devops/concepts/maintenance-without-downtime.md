...
Для `block-8-2` режим максимальной доступности CMS допускает не более одного недоступного или заблокированного VDisk в затронутой группе, режим сохранения доступности — не более двух. Уже имеющиеся отказы учитываются в этом ограничении. Дождитесь восстановления перед следующей операцией. См. [обслуживание и статусы Block82](../../concepts/block-8-2.md).
