...
Во внештатных ситуациях, например, когда любой перезапуск узла несет риск деградации системы, есть возможность приостановить новые работы по обслуживанию кластера в [конфигурации CMS](../../reference/configuration/cms_config.md).
