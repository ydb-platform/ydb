...
Внутри этих объектов работают три механизма: SelfHeal для динамических групп хранения, отдельный SelfHeal для статической группы хранения и общий SelfHeal для State Storage, Board и SchemeBoard. В документации эти механизмы сгруппированы в два раздела: SelfHeal хранилища (для динамических и статической групп) и SelfHeal подсистем распространения метаданных (для State Storage, Board и SchemeBoard).
...
- [SelfHeal подсистем распространения метаданных](selfheal-metadata-distribution.md)
