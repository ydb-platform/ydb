...
| **Рекомендуемое использование** | Продакшн использование для всех версий {{ ydb-short-name }}.                             | Экспериментальное использование на кластерах версии 25.1 и выше.                                |
...
Использование конфигурации V1 является рекомендуемым для всех кластеров {{ ydb-short-name }}.
