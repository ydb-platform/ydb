...
В этом разделе документации описан способ конфигурации кластеров {{ ydb-short-name }} под названием V2, являющаяся экспериментальным способом конфигурирования кластеров {{ ydb-short-name }} версий {{ ydb-short-name }} v25.1 и выше.
