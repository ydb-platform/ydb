...
После остановки проверьте на вкладке **Nodes** [страницы мониторинга кластера](../../../reference/ydb-ui/ydb-monitoring.md#node_list_page), что удалённый узел больше не отображается в списке. Если узел всё ещё присутствует в списке (возможно, со статусом **Disconnected**), убедитесь, что процесс был остановлен именно на нужном хосте и что он не настроен на автоматический перезапуск (например, службой `systemd` или супервизором), и при необходимости остановите его там же.
