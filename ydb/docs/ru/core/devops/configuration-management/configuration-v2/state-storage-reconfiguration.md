...
Проверить, что изменения применились, можно в разделе `CMS` в [YDB UI](../../../reference/ydb-ui/index.md) кластера (доступен на порту 8765): перейдите на вкладку `Tablets` и убедитесь по репликам таблеток подсистем метаданных, что конфигурация подхватилась.
