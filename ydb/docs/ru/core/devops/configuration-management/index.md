...
* [{#T}](configuration-v1/index.md) — раздел о конфигурации V1
* [{#T}](configuration-v2/index.md) — раздел о конфигурации V2, экспериментальной функциональности для версий {{ ydb-short-name }} 25.1 и выше.
