...
- `--user` — пользователь для подключения к базе данных.
- `--password-file` — путь к файлу с паролем. Опустите это, чтобы ввести пароль вручную.
>>>>>>> 0af27640ee9 ([Backport MAIN] PR #40812 [YDBDOCS-2154] пофиксить https://github.com/ydb-platform/ydb/issues/40178 (#41297)):ydb/docs/ru/core/devops/deployment-options/ansible/initial-deployment/deployment-configuration-v1.md
