...
В этом разделе документации {{ ydb-short-name }} рассматриваются различные аспекты наблюдаемости (observability), специфичные для кластеров, [развёрнутых с помощью Ansible](../initial-deployment/index.md).
