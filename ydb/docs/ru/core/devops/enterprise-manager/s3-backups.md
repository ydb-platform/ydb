...
Эта статья описывает настройку автоматического резервного копирования через YDB EM. Общую информацию о способах резервного копирования в {{ ydb-short-name }} см. в разделах [{#T}](../../concepts/backup.md) и [{#T}](../backup-and-recovery/index.md).
