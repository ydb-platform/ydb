...
**Что делать:** Это общий алерт системы самодиагностики, в сообщении будет указана причина, по которой сработал алерт. Подробнее про механизм Health Check в можно прочитать [здесь] (../../reference/ydb-sdk/health-check-api.md)
