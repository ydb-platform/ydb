...
Сбор минидампов поддерживается только на Linux. На других платформах функциональность отсутствует.
...
## Проверка наличия встроенного Breakpad {#check}

Узнать, собран ли бинарь `ydbd` со встроенным Breakpad, можно по информации о совместимости версий: при наличии встроенного Breakpad в неё добавляется строка `HasInternalBreakpad: true`.
