...
#### Как выбрать из строковой или колоночной таблицы строчки по заданному списку ключей? {#explicit-keys}
...
#### Как экранировать кавычки JSON-строк при добавлении их в строковую таблицу? {#escaping-quotes}

{% include [not_allow_for_olap](../../_includes/not_allow_for_olap_note.md) %}

Рассмотрим пример c двумя возможными вариантами добавления JSON-строки в строковую таблицу:
...
#### Как обновить только те значения, ключей которых нет в строковой таблице? {#update-non-existent}

{% include [not_allow_for_olap](../../_includes/not_allow_for_olap_note.md) %}

Можно использовать операцию `LEFT JOIN`, чтобы пометить отсутствующие в строковой таблице ключи, после чего обновить их значения:
...
`UPSERT`, `UPDATE`, `INSERT` и другие SQL-операторы модификации данных не поддерживается для колоночных таблиц.

{% include [ways_to_add_data_to_olap](../../_includes/ways_add_data_to_olap.md) %}
