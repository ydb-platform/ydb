...
Команда создание колоночной таблицы отличается от команды создания строковой таблицы только в двух последних строках, где указаны ключ партиционирования и колоночный режим хранения.
