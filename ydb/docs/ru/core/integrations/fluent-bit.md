...
В разделе представлена реализация интеграции между инструментом захвата логов [FluentBit](https://fluentbit.io) с последующим сохранением для просмотра или анализа в {{ ydb-short-name }}.
...
Нетрудно заметить, что команда создание колоночной таблицы отличается от команды создания строковой таблицы только в двух последних строках, где указаны ключ партиционирования и колоночный режим хранения.
