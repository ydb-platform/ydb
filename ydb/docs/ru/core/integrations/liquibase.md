...
Вы также можете указать любое значение в поле `value`. Данные будут автоматически преобразованы в требуемые типы с учетом строгой типизации в {{ ydb-short-name }}.

Таблица форматирования типов для загрузки в таблицу:

| YDB тип                                 | Ожидаемый формат описания                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Bool`                                  | true или false                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
