...
Changeset `createTable` отвечает за создание таблицы. Описание типов из SQL стандарта сопоставляется с примитивными типами YDB. К примеру тип bigint будет конвертирован в Int64.
...
Таблица сопоставления описания типов Liquibase с [табличными типами](https://ydb.tech/docs/ru/yql/reference/types/primitive) YDB:
...
`loadData`, `loadUpdateData` - загрузка данных из CSV файлов. loadUpdate загружает командой UPSERT. Данные будут автоматически приведены к нужным типам, учитывая строгую типизацию YDB.
