# Поддержка диалекта {{ ydb-short-name }} в инструменте миграции Liquibase
...
Table of comparison of Liquibase types descriptions with [{{ ydb-short-name }} type](https://db.tech/docs/en/yql/reference/types/primitive) {{ ydb-short-name }}:
