...
В примерах вывода CLI подписи `Mb` и `Kb` сохранены в том виде, в котором их выводит команда. Здесь они обозначают двоичные единицы объёма: МиБ и КиБ соответственно.
