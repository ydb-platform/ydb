...
Миграция изнутри PostgreSQL: расширение копирует данные в {{ ydb-short-name }} параллельно, с возобновлением.

Подробнее про инструмент: [ydb-pg-extension](https://github.com/ydb-platform/ydb-pg-extension/blob/main/docs/migration.md).
