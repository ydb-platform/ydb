...
1. Выполнить [последовательный перезапуск всех существующих статических узлов кластера](../maintenance-without-outages.md#rolling-restart), с ожиданием инициализации и восстановления работы каждого перезапускаемого узла.

1. Выполнить [последовательный перезапуск всех существующих динамических узлов](../maintenance-without-outages.md#rolling-restart) кластера.
