...
## Подготовьте диски для добавления

На каждом серевере кластера создайте разделы на новых дисках и очистите диски встроенной в `ydbd` командой:
...
* [Добавление диска с помощью конфигурации V1](disk-add-configuration-v1.md)
* [Добавление диска с помощью конфигурации V2](disk-add-configuration-v2.md)
