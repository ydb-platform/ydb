...
1. Если ранее в кластере использовалось [управление конфигурацией через CMS](../../devops/configuration-management/configuration-v1/cms.md), выгрузите существующие настройки в формате YAML. Для этого выполните следующую команду:
...
Дополнительные возможности конфигурирования описаны на страницах [селекторы](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md) и [временная конфигурация](../../devops/configuration-management/configuration-v1/dynamic-config-volatile-config.md).
...
2. Получив конфигурацию, узел [генерирует конечную конфигурацию](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md#selectors-resolve) для своего набора [лейблов](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md#selectors-intro).
...
* Использование более 30 различных [лейблов](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md) в [селекторах](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md) может привести к задержкам при валидации конфигурации в десятки секунд, т.к. {{ ydb-short-name }} необходимо проверить валидность каждой возможной конечной конфигурации. При этом количество значений одного лейбла влияет намного меньше.
