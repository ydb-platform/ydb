...
1. Откройте [мониторинг](../../reference/ydb-ui/ydb-monitoring/monitoring_main.md) и убедитесь, что VDisk в нерабочем состоянии.
...
1. Откройте [мониторинг](../../reference/ydb-ui/ydb-monitoring/) и убедитесь, что PDisk в рабочем состоянии.
1. Получите `[NodeId:PDiskId]` нужного диска с помощью утилиты [{{ ydb-short-name }} DSTool](../../reference/ydb-dstool/index.md):
