...
Убедитесь, что у вас есть развернутый [кластер](../../concepts/glossary.md#cluster) YDB. Инструкции по развертыванию доступны в разделе [Первоначальное развёртывание](../../devops/deployment-options/manual/initial-deployment.md).
...
### 4. Установка YDB DSTool

Для выполнения декомиссии необходимо установить утилиту `ydb-dstool`. Инструкции по установке доступны в [документации по установке YDB DSTool](../../reference/ydb-dstool/install.md).
