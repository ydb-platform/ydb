...
| Импорт через `pg_dump` + `pg-convert` | [YDB tools dump/restore](../reference/ydb-cli/export-import/tools-dump.md) или [интеграции для поставки данных](../integrations/ingestion/index.md) |
