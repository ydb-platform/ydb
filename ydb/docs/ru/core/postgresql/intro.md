...
| --- | --- |
| psql, pgAdmin или драйверы PostgreSQL | [{{ ydb-short-name }} CLI](../reference/ydb-cli/index.md), [YDB UI](../reference/ydb-ui/index.md), [{{ ydb-short-name }} SDK](../reference/ydb-sdk/index.md) или [JDBC-драйвер](https://github.com/ydb-platform/ydb-jdbc-driver) |
