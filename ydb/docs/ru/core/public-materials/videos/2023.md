...
* Улучшение в конфигурации [акторной системы](https://www.youtube.com/live/vzKoEVvESi0?si=lUXHWelTVeizKONE). [{{ team.kriukov.name }}]({{ team.kriukov.profile }}) ({{ team.kriukov.position }})
