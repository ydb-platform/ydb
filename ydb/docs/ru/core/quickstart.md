...
- Docker
   ...
   2. Запустите Docker контейнер:
      ...
      | [`GRPC_TLS_PORT`](https://github.com/ydb-platform/ydb/blob/8dde59cd0af86737d07a1cd8ff19811a2bd2b663/ydb/tests/library/harness/kikimr_port_allocator.py#L183)                | `int`      | `2137`                 | `09.12.2020`(21.1?)          | `GPRC TLS` порт                                                                                                                                                                        |
      ...
      | [`YDB_KQP_RESULT_ROWS_LIMIT`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L69)             | `int`      | `1000`                 | `28.12.2021`(22.1?)          | задает лимит строк                                                                                                                                                                     |
      | [`YDB_YQL_SYNTAX_VERSION`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L70)                | `int`      | `1`                    | `28.12.2021`(22.1?)          | задает версию синтаксиса языка `YQL`                                                                                                                                                   |
      | [`YDB_KQP_FORCE_NEW_ENGINE`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L71)              | `0` or `1` | `1`                    | `13.09.2022`(22.5?)          | задает использование нового движка `KPQ`                                                                                                                                               |
      | [`YDB_DEFAULT_LOG_LEVEL`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L73)                 | `string`   | `NOTICE`               | `06.06.2022`(22.3?)          | задает уровень логирования. Доступные значения уровней: `CRIT`, `ERROR`, `WARN`, `NOTICE`, `INFO`.                                                                                     |
      | [`YDB_ADDITIONAL_LOG_CONFIGS`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L48)            | `string`   | `None`                 | `22.09.2020`(22.5?)          | задает дополнительные уровни логирования: `уровень`:`значение уровная`. Если необходимо ввести несколько уровней, то их необходимо вводить через запятую.                              |  
      | [`YDB_PQ_TOPICS_ARE_FIRST_CLASS_CITIZEN`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L77) <br> [`YDB_PQ_CLUSTER_TABLE_PATH`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L78) <br>  [`YDB_PQ_VERSION_TABLE_PATH`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L79) <br> [`YDB_PQ_ROOT`](https://github.com/ydb-platform/ydb/blob/b1c590828b222c839dedecd8e6e79413ef5b7eec/ydb/tests/library/harness/kikimr_config.py#L80) <br/>| `0` or `1` <br> `string` <br> `string` <br> `string` <br/>| `1` <br> `None` <br> `None` <br> `None` <br/> | `31.05.2022`(22.3?) | нужны для федерации logbroker, в ydb обычном не используются          |  
