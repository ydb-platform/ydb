...
Чтобы проверить, что Блум-индекс действительно сокращает объём чтения, выполните один и тот же селективный запрос на таблице с достаточным объёмом данных до и после создания индекса и сравните время выполнения и объём прочитанных данных.
