...
В таблице перечислены способы переноса **данных** из реляционных СУБД в {{ ydb-short-name }}. Ниже — [рекомендации по выбору инструмента](#how-to-choose): когда нужна готовая таблица, когда схему создаёт утилита, и что лучше для строковых и колоночных таблиц.

| Способ | [PostgreSQL](from/postgresql/index.md) | [Greenplum](from/greenplum/index.md) | [MySQL / MariaDB](from/mysql/index.md) | [Microsoft SQL Server](from/mssql/index.md) | [ClickHouse](from/clickhouse/index.md) | [Oracle Database](from/oracle/index.md) |
| --- | --- | --- | --- | --- | --- | --- |
| [Через промежуточный CSV](../../reference/ydb-cli/export-import/import-file.md) | [да](from/postgresql/cli-import-file.md) | [да](from/greenplum/cli-import-file.md) | [да](from/mysql/cli-import-file.md) | [да](from/mssql/cli-import-file.md) | [да](from/clickhouse/cli-import-file.md) | [да](from/oracle/cli-import-file.md) |
| [Через промежуточный Parquet](../../reference/ydb-cli/export-import/import-file.md) | [да](from/postgresql/cli-import-parquet.md) | [да](from/greenplum/cli-import-parquet.md) | [да](from/mysql/cli-import-parquet.md) | [да](from/mssql/cli-import-parquet.md) | [да](from/clickhouse/cli-import-parquet.md) | [да](from/oracle/cli-import-parquet.md) |
