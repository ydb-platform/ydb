...
Пошаговый рецепт — перенос данных из **Greenplum** в {{ ydb-short-name }} с помощью [Федеративные запросы](../../../../concepts/query_execution/federated_query/import_and_export.md).
