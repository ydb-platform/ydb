...
Через промежуточный [CSV](../../reference/ydb-cli/export-import/import-file.md) и [Parquet](../../reference/ydb-cli/export-import/import-file.md) подходят, когда данные сначала выгружаются из источника в файл, а затем загружаются в {{ ydb-short-name }} командой `ydb import file`.
...
* Через промежуточный [CSV](../../reference/ydb-cli/export-import/import-file.md) и [Parquet](../../reference/ydb-cli/export-import/import-file.md);
