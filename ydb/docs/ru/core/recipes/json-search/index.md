...
Перед запуском примеров убедитесь, что на кластере включена поддержка JSON-индексов с помощью соответствующих [параметров](../../reference/configuration/feature_flags.md).
