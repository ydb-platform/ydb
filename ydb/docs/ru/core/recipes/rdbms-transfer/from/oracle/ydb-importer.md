...
Пошаговый рецепт: **Oracle Database** → {{ ydb-short-name }} через [ydb-importer](../../tools/ydb-importer.md).
...
Подробнее: [импорт из JDBC](../../../../integrations/data-migration/import-jdbc.md), [sample-oracle.xml](https://github.com/ydb-platform/ydb-importer/blob/main/scripts/sample-oracle.xml).
...
Вложенные таблицы Oracle (nested tables) не поддерживаются. BLOB выносятся в отдельные таблицы — см. [ограничения ydb-importer](../../../../integrations/data-migration/import-jdbc.md#blob).
