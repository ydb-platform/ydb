...
Пошаговый рецепт: **PostgreSQL** → {{ ydb-short-name }} через [ydb-pg-extension](../../tools/ydb-pg-extension.md).

## Подготовка {#prerequisites}

{% include notitle [ydb-pg-extension](../../_includes/tools/ydb-pg-extension-about.md) %}
