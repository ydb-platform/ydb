...
- `false` — внутренние пользователи могут существовать как на уровне кластера, так и на уровне каждой отдельной базы данных (могут добавляться в [тенантные базы данных](../../concepts/glossary.md#database)).
