...
| Идентификатор, добавляемый к имени пользователя в [SID](../../concepts/glossary.md#access-sid), позволяющий отличать пользователей из AccessService каталога от пользователей аутентифицируемых с помощью других провайдеров.
