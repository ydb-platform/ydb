...
| `enable_local_min_max_index`                             | Локальные [min_max-индексы](../../yql/reference/syntax/create_table/min_max_index.md) для колоночных таблиц; в YDB 26.2 по умолчанию выключены |
