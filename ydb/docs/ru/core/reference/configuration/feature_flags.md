...
| `enable_node_broker_long_lease`                          | Продление аренды [динамических узлов](../../concepts/glossary.md#dynamic) в [Node Broker](../../concepts/glossary.md#node-broker) на срок [`lease_duration`](node_broker_config.md) сверх конца следующей эпохи |
