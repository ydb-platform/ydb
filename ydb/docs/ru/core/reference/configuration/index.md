...
Лимит памяти для колоночных таблиц указывает максимальное фиксированное количество памяти, которые операции и кэш могут использовать.

Лимиты колоночных таблиц могут настраиваться двумя способами:

- Процентом от жёсткого лимита памяти, доступного для процесса;
- Фиксированным размером в байтах.
