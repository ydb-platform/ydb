...
Для кеш-компонентов колоночных таблиц лимит памяти является фиксированным.
...
- KQP;
- Компонент чтения колоночных таблиц;
- Компонент компактизации колоночных таблиц.
...
Для компонентов-активностей колоночных таблиц лимит памяти является фиксированным.
...
| `column_tables_compaction_limit_percent`&nbsp;/<br/>`column_tables_compaction_limit_bytes` | 20% | Лимит памяти для операций компактизации колоночных таблиц. |
