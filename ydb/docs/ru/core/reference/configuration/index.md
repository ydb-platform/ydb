...
`special_chars` | Специальные символы, которые можно использовать в пароле. Можно использовать только символы из списка `!@#$%^&*()_+{}\|<>?=` | Пустой список. Эквивалент всем возможным символам: `!@#$%^&*()_+{}\|<>?=`
