...
Параметры безопасности можно задать в разделе [`domains_config`](#domains-config), однако этот вариант является устаревшим и не рекомендуется к использованию.
