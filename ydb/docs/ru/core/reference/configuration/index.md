...
Изменение политики сложности пароля влияет только на создании новых пользователей и изменении существующих паролей. При усложнении политики сложности паролей изменять существующие пароли не требуется, они будут приниматься в текущем виде.
