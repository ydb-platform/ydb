...
#### Регистрация динамического узла {#dynamic-node-registration}
...
При запуске динамического узла, в его параметрах запуска нужно указать пути до клиентских сертификатов.
