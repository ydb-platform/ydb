...
- Внутренний буфер логов имеет следующие ограничения по размеру:
  - Общий размер по умолчанию: 10 МиБ (10 &ast; 1024 &ast; 1024 байт)
  - Размер гранулы по умолчанию: 64 КиБ (1024 &ast; 64 байт)
  - Максимальный размер сообщения: 1 КиБ (1024 байт)
