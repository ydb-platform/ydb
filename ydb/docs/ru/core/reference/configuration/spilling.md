...
- При старте процесса все существующие файлы спиллинга в указанной директории удаляются автоматически. Файлы спиллинга имеют специальный формат имени, включающий идентификатор сессии, который генерируется один раз при запуске процесса ydbd. При старте нового процесса удаляются все файлы из директории спиллинга, которые соответствуют формату имени, но имеют отличный от текущего идентификатор сессии.
