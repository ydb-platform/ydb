...
Если спиллинг включён, а директория `root` отсутствует или недоступна для записи, узел базы данных не запустится. Убедитесь, что `root` существует и доступен на всех узлах базы данных до включения спиллинга.
