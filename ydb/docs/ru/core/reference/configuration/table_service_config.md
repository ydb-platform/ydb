...
Спиллинг включен по умолчанию. Следующие параметры управляют включением и отключением различных типов спиллинга.
...
**Тип:** `string`
**По умолчанию:** `"All"`
**Описание:** Включает спиллинг на узлах базы данных. При установке значения `"None"` спиллинг не функционирует на узлах базы данных.
