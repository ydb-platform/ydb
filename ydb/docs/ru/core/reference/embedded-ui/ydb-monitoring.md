...
Страница также содержит таблицу в том же формате, что и на вкладке [Storage](#storage_list) главной страницы — сводная информация о группах хранения, в данном случае по выбранной группе.
