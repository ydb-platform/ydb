...
В левом верхнем углу отображается название кластера с соответствующим индикатором состояния работы всего кластера.

Ниже представлена вкладка [overview](ссылка на подраздел) с [индикаторами](#colored_indicator) информации о состоянии кластера:
 
* **CPU** - состояние процессора; 
* **Storage** - занято/доступно всего места на дисках;
* **Memory** - использование оперативной памяти узлами тенанта;
* **Network** - использование сетевого подключения. 
...
* **Name** - название базы данных. При нажатии можно перейти на вкладку страницы [Database](#databses_page);
...
![Nodes_list](_assets/nodes_list.png)
...
![Databse_diagnostic](_assets/database-page-diagnostics.png)
