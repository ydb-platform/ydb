...
В левом верхнем углу показано название кластера и его [индикатор состояния](#colored_indicator).
...
Сверху находится вкладка с поиском по названию базы данных, справа можно выбрать **All**  - "все доступные" или **With problems** - "с проблемами",  правее отображается индикатор количества баз данных.
...
На вкладке отображается таблица со списком рабочих узлов и их параметрами.
...
Многие компоненты YDB выполнены в виде таблеток. Система может перемещать таблетки между узлами. На любом из узлов может выполняться некоторое количество таблеток. На вкладке видна таблица со всеми рабочими таблетками.
