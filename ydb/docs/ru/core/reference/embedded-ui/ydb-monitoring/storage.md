...
Страница открывается при переходе по **Group ID** с вкладки [Storage](tab-storage.md#storage_list).
...
Страница также содержит таблицу в том же формате, что и на вкладке [Storage](tab-storage.md#storage_list) главной страницы — сводная информация о группах хранения, в данном случае по выбранной группе.
