...
| `MaxSendMessageSize`             | Максимальный размер исходящих сообщений в байтах. По умолчанию на сервере действует лимит 64 МБ (64 000 000 байт); большие сообщения отклоняются ошибкой `ResourceExhausted`. Серверный лимит настраивается отдельно. | `67108864 (64 МиБ)`          |
| `MaxReceiveMessageSize`          | Максимальный размер входящих сообщений, байт.                                                                                                                                                                                                                                               | `67108864 (64 МиБ)`          |
