...
| `MaxSendMessageSize`             | Максимальный размер исходящих сообщений в байтах. Примечание: на сервере действует лимит `64 МиБ`; большие сообщения отклоняются ошибкой `ResourceExhausted`.                                                                                                                                  | `67108864 (64 МиБ)`          |
