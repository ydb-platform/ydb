...
3. Если ничего из вышеперечисленного не задано, тип серверной части будет определен на основе типа значения CLR ([Common Language Runtime — Википедия](https://ru.wikipedia.org/wiki/Common_Language_Runtime)).
