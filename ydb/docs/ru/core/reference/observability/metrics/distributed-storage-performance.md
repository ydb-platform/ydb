...
Стоимость запроса измеряется в условных единицах, которые по физическому смыслу близки к наносекундам, и вычисляется по линейной формуле:
