...
| Total burst duration | Совокупное время, в течение которого VDisk'и находились в состоянии [underflow](distributed-storage-performance.md#burstDetection). Если значение метрики больше 0, то в системе наблюдаются всплески нагрузки | мс |
