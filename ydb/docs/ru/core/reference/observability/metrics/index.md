...
`topic.write.discarded_bytes`<br/>`RATE`, байты | Объём данных, пропущенных сервером при записи из-за дедупликации.<br/>Метки:<br/>- _topic_ – название топика.
...
`topic.write.discarded_messages`<br/>`RATE`, байты | Количество сообщений, пропущенных сервером при записи из-за дедупликации.<br/>Метки:<br/>- _topic_ – название топика.
