...
`grpc.topic.stream_write.uncommitted_bytes`<br/>`RATE`, байты | Количество байт, записанных методом `Ydb::TopicService::StreamWrite`, в рамках транзакций, но еще не опубликованных.<br/>Метки:<br/>- _topic_ – название топика.
...
`grpc.topic.stream_write.uncommitted_messages`<br/>`RATE`, штуки | Количество сообщений, записанных методом   `Ydb::TopicService::StreamWrite` в рамках транзакаций, но еще не опубликованных.<br/>Метки:<br/>- _topic_ – название топика.
