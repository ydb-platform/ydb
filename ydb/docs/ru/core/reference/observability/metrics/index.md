...
`topic.write.discarded_messages`<br/>`RATE`, байты | Колическтво сообщений, пропущенных сервером на записи при дедупликации.<br/>Метки:<br/>- _topic_ – название топика.
