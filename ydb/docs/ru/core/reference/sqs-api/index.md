...
Есть ограничение на количество сообщений, которые можно записать в партицию FIFO-топика, — 1000 сообщений в секунду. Если требуется записывать в топик больше сообщений, следует увеличить количество партиций. Ограничение на топик вычисляется как 1000 сообщений/сек/партиция × количество партиций. Например, чтобы записывать 10 тыс. сообщений в секунду, создайте топик с 10 партициями.
