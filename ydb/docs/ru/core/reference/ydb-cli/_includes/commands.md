...
[workload fulltext init](../workload-fulltext.md#init) | Создание и инициализация [таблиц](../../../concepts/glossary.md#table) для `Fulltext` нагрузки
[workload fulltext import files](../workload-fulltext.md#load-files) | Импорт полнотекстовых данных из файлов в `Fulltext` нагрузке
[workload fulltext import generator](../workload-fulltext.md#load-generator) | Генерация синтетических текстовых данных с помощью модели цепи Маркова в `Fulltext` нагрузке
[workload fulltext run select](../workload-fulltext.md#run-select) | Выполнение полнотекстовых поисковых запросов в `Fulltext` нагрузке
[workload fulltext run upsert](../workload-fulltext.md#run-upsert) | Вставка или обновление документов в [таблице](../../../concepts/glossary.md#table) в `Fulltext` нагрузке
[workload fulltext clean](../workload-fulltext.md#cleanup) | Удаление [таблиц](../../../concepts/glossary.md#table), созданных на этапе инициализации `Fulltext` нагрузки
[workload fulltext model](../workload-fulltext.md#model) | Построение модели цепи Маркова из текстового датасета для `Fulltext` нагрузки
