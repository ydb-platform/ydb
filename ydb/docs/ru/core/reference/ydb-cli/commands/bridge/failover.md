...
- Команда требует административных прав. На кластере с включённой обязательной аутентификацией аутентификация по логину и паролю в аварийном состоянии кластера не работает — используйте аутентификацию по клиентским сертификатам. Подробнее см. [{#T}](../../../../devops/deployment-options/manual/bridge-management.md#emergency-auth).
