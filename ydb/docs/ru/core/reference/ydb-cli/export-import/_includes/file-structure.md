...
При выгрузке в S3-совместимое объектное хранилище с указанием общего префикса создаётся файл `SchemaMapping/mapping.json`. В этом файле содержится отображение путей выгружаемых объектов в соответствующие префиксы S3 относительно общего префикса.
