...
- [Выгрузка на сетевую файловую систему хостов кластера {{ ydb-short-name }} `export nfs`](../export-nfs.md)
- [Загрузка из сетевой файловой системы хостов кластера {{ ydb-short-name }} `import nfs`](../import-nfs.md)
