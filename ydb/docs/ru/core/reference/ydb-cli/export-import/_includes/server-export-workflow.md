...
4. Данные каждой таблицы записываются из копии в хранилище назначения (S3-совместимое объектное хранилище или смонтированная в кластере файловая система) в формате [файловой структуры выгрузки](../file-structure.md) с параллельной записью из разных узлов кластера.
