...
`--import-data`: более эффективный способ загрузки данных с расслабленными гарантиями консистентности. В данном режиме не поддерживаются глобальные вторичные индексы.
