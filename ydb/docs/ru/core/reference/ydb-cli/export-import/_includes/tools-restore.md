...
1) Скопировать сохраненную статическую конфигурацию на локальные диски узлов.
2) Загрузить сохраненную динамическую конфигурацию с помощью команды `{{ ydb-cli }} admin cluster config replace`.
3) Перезапустить узлы кластера.
...
1) Скопировать сохраненную статическую конфигурацию на локальные диски узлов.
2) Загрузить сохраненную динамическую конфигурацию с помощью команды `{{ ydb-cli }} admin database config replace`.
