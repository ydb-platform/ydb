...
`--wait-nodes-duration DURATION`: Продолжительность ожидания доступных динамических узлов восстанавливаемых баз данных. Если продолжительность 0, то ожидание отсутствует.
...
`--wait-nodes-duration DURATION`: Продолжительность ожидания доступных динамических узлов восстанавливаемой базы данных. Если продолжительность 0, то ожидание отсутствует.
