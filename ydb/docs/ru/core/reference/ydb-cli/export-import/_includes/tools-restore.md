...
`--import-data`: более эффективный способ загрузки данных с ослабленными гарантиями консистентности. В данном режиме не поддерживаются глобальные вторичные индексы.
