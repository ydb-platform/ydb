...
В этом разделе рассматриваются все операции по созданию, управлению и восстановлению из [коллекций резервных копий](ru/core/concepts/backup/collections.md). Полный справочник по синтаксису команд см. в [Синтаксис коллекций резервных копий YQL](ru/core/yql/reference/syntax/backup-collections.md).
