...
| `--scale <значение>`      | Scale factor. См. спецификацию TPC-DS, глава 3. Поддерживаются и дробные значения, хотя это и не описано в спецификации TPC-DS. Для масштабов `1`, `10`, `100`, `1000` заданы канонические ответы (см. описание опции `--check-canonical`).                                                                                                                                                                        | 1                      |
