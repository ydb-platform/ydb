...
Данный вид нагрузки предназначен для оценки производительности и полноты точного и приближённого [векторного поиска](../../concepts/query_execution/vector_search.md).
