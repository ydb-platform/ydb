...
- C++
  ...
  OIDC/OAuth | `NYdb::CreateOidcCredentialsProviderFactory(config)`; см. примеры [с параметрами командной строки](https://github.com/ydb-platform/ydb/blob/main/ydb/public/sdk/cpp/examples/auth/oidc/console_params/main.cpp) и [с конфигурационным файлом](https://github.com/ydb-platform/ydb/blob/main/ydb/public/sdk/cpp/examples/auth/oidc/file_config/main.cpp). Поддерживаются Static, Client Credentials и Device Authorization. |
