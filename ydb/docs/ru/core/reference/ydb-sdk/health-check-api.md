...
**Действия при срабатывании:** В [YDB Embedded UI](../embedded-ui/ydb-monitoring.md) перейти на страницу базы данных, выбрать вкладку `Storage`, по известному `id` группы проверить проверить конфигурацию нод и дисков на нодах.
