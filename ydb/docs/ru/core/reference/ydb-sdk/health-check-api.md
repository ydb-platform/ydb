...
- Go
  ...
  Функциональность на данный момент не поддерживается в Go SDK. Для проверки состояния базы данных используйте [{{ ydb-short-name }} CLI](../../reference/ydb-cli/commands/discovery-whoami.md) или C++ SDK.
...
- Go
  ...
  Функциональность на данный момент не поддерживается в Go SDK.
