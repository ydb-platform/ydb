...
- Apache Arrow
  ...
  *Типы семейства pg*
  ...
  Все типы семейства `pg` возвращаются как тип Arrow `string` в формате текстового представления значений.
