...
В данном разделе описаны доступные форматы представления данных:

- [Protobuf](format-protobuf.md) — формат по умолчанию, данные возвращаются построчно с автоматической конвертацией в нативные типы языка программирования.
...
Состав возвращаемой схемы зависит от формата данных и описан на странице каждого формата.
