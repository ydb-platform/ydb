...
Страница открывается при переходе по **Group ID** с вкладки [Storage](tab-storage.md#storage_list) [главной страницы](monitoring_main.md).
...
См. также: [страница Databases](database.md), [страница Nodes](nodes.md), [страница Tablets](tablets.md).
