...
| __Атрибуты владения и разрешений__  |                                                                                                                                                                                                                        |
...
| __Атрибуты компонента SchemeShard__ |                                                                                                                                                                                                                        |
...
| Ключ                    | Описание                                                                                                                                                                                                                                                                                                        |
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `file_backend`          | Сохранять аудитный лог в файл на каждом узле кластера.<br/>Необязательный.                                                                                                                                                                                                                                      |
...
| `unified_agent_backend` | Направить аудитный лог в Unified Agent. Необходимо также описать секцию `uaclient_config` в [конфигурации кластера](../reference/configuration/index.md).<br/>Необязательный.                                                                                                                                   |
...
|  `stderr_backend`       | Направить аудитный лог в стандартный вывод ошибок `stderr`.<br/>Необязательный.                                                                                                                                                                                                                                 |
