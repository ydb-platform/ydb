...
Simple bind - это способ аутентификации с использованием логина и пароля. В качестве логина используется параметр конфигурации `bind_dn`, пароль записывается в параметре `bind_password`. Такой способ легок в использовании, но требует хранения пароля в текстовом виде в файле конфигурации.
