...
[Субъект доступа](../concepts/glossary.md#access-subject) идентифицируется строкой вида `<login>[@<subsystem>]`. Такая строка называется SID (Security Identifier). SID'ы записываются в правилах [ACL](../concepts/glossary.md#access-acl) на [объектах доступа](../concepts/glossary.md#access-object).
...
У каждого объекта доступа есть [владелец](../concepts/glossary.md#access-owner). [Владельцем объекта](../concepts/glossary.md#access-owner) по умолчанию становится [субъект доступа](../concepts/glossary.md#access-subject), создавший [объект доступа](../concepts/glossary.md#access-object).
