...
* {{ ydb-short-name }} в роли сервера:
  ...
  * HTTP — для работы с [{{ ydb-ui-name }}](../../reference/ydb-ui/index.md), публикации [метрик](../../devops/observability/monitoring.md) и других вспомогательных конечных эндпоинтов.
