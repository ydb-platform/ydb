# Энергосберегающий режим процессора
...
{{ ydb-short-name }} как высокопроизводительная распределенная СУБД требует стабильной и предсказуемой производительности процессора. Энергосберегающие режимы, разработанные для клиентских устройств, не подходят для серверных рабочих нагрузок, где важна постоянная доступность и минимальная задержка.
...
Однако для продакшн-сред с высокой нагрузкой рекомендуется строго следовать приведенным рекомендациям.
