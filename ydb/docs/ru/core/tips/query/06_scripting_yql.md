...
Использование устаревшего Scripting Service вместо современного Query Service приводит к следующим проблемам:

- **Устаревший функционал**: Scripting Service не получает новых возможностей и улучшений, развитие сосредоточено на Query Service
...
Перейти на использование Query Service:
...
- Отсутствие лимита на количество строк
- Стриминг данных
...
Scripting Service считается устаревшим. Все новые проекты должны использовать Query Service. Query Service стал production-ready с версии {{ ydb-short-name }} 24.3.
