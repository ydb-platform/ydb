...
Информация о работе распределённого хранилища содержится в нескольких взаимосвязаных таблицах, каждая из которых отвечает за описание своей сущности, а именно:
* PDisk
* VSlot
* Group
* Storage Pool
...
| Guid                  | Uint64    |          | Уникальный идентификатор, генерируемый случайно при добавлении диска в систему, предназначенный для преотвращения потери данных в случае перемены дисков местами |
...
| VDiskKind      | String  |          | Предустаноленная настройка режима работы всех VDisk для данного пула хранения                               |
