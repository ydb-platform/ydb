1. Используйте вкладку **Diagnostics** во [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md) для анализа загрузки процессора во всех пулах ресурсов:

    1. Откройте [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md), перейдите на вкладку **Databases** и нажмите на требуемую базу данных.
