1. Используйте вкладку **Diagnostics** в [YDB UI](../../../../reference/ydb-ui/index.md) для анализа загрузки процессора во всех пулах ресурсов:

    1. Откройте [YDB UI](../../../../reference/ydb-ui/index.md), перейдите на вкладку **Databases** и нажмите на требуемую базу данных.
