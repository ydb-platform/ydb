...
* Из-за перегруженной партиции таблицы:
    ...
    3. Локальная база данных шарда перегружена: например, слишком много транзакций уже находится в обработке, количество данных в [MemTable](../../../../core/concepts/glossary.md#memtable-memtable) слишком выросло или [компакшн](../../../../core/concepts/glossary.md#компакшн-compaction) не успевает за нагрузкой. В этом случае шард может начать отклонять часть новых запросов, даже если лимит по числу in-flight транзакций на уровне data shard ещё не достигнут.
