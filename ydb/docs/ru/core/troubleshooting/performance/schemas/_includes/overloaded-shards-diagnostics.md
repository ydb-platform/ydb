1. Используйте {{ ydb-ui-name }} или Grafana, чтобы проверить, не перегружены ли узлы {{ ydb-short-name }}:
    ...
    - Во [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md):
...
1. Чтобы точно определить проблему со схемой, используйте [{{ ydb-ui-name }}](../../../../reference/ydb-ui/index.md) или [{{ ydb-short-name }} CLI](../../../../reference/ydb-cli/index.md):
