...
Ниже представлена справочная информация по типам узлов, а пример анализа конкретного плана запроса можно посмотреть [здесь](../dev/query-execution-optimization/query-plans-optimization.md).
