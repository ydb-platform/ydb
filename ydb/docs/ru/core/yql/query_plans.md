...
Ниже представлена справочная информация по типам узлов, а пример разбора плана запроса можно посмотреть в разделе [План выполнения запроса](../dev/optimization/plans.md).
