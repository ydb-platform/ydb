  * общие параметры для всех векторных индексов:
    ...
    * `distance` - [функция расстояния](../../udf/list/knn.md#функции-расстояния-и-сходства-functions-distance) (`cosine`, `manhattan` или `euclidean`), взаимосключающий с `similarity`;
    * `similarity` - [функция схожести](../../udf/list/knn.md#функции-расстояния-и-сходства-functions-distance) (`inner_product` или `cosine`), взаимосключающий с `distance`;
