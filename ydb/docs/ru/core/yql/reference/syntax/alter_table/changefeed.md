...
* `USER_SIDS` — включение-выключение выгрузки идентификаторов безопасности [SID](../../../../concepts/glossary.md#sid-access-sid) в формируемых [записях CDC](../../../../concepts/cdc.md#record-structure). По умолчанию выключено.
* `TRACE_IDS` — включение-выключение идентификатора трассировки OpenTelemetry в формируемых [записях CDC](../../../../concepts/cdc.md#record-structure). По умолчанию выключено.
