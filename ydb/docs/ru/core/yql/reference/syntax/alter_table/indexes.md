...
* Обновление векторного индекса: модифицировать основную таблицу можно, но существующий индекс не обновится. Нужно построить новый индекс, чтобы учесть изменения. При необходимости, можно [атомарно заменить](../../../../reference/ydb-cli/commands/_includes/secondary_index.md#переименование-вторичного-индекса-rename) существующий индекс на вновь построенный.
* Построение индекса для векторов c [битовым квантованием](../../../../yql/reference/udf/list/knn.md#функции-преобразования-вектора-в-бинарное-представление-functions-convert).
