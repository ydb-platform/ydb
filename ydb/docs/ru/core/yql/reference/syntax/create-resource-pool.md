...
- Все запросы в пуле суммарно могут потребить не более 80% доступной памяти на узле. Если суммарное потребление памяти превысит этот лимит, запросы будут завершены со статусом `OVERLOADED`.
