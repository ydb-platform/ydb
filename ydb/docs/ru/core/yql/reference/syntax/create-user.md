...
Администратор базы данных может создать заблокированного пользователя. Без указания `NOLOGIN` и `LOGIN` пользователь создается незаблокированным.
...
Опция явно указывает, что пользователь создается незаблокированным. Без указания `NOLOGIN` и `LOGIN` пользователь создается незаблокированным.
