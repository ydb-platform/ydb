...
* `<index_columns>` — список колонок, по которым строится индекс; количество колонок зависит от типа таблицы и типа индекса. На [строковых таблицах](../../../../concepts/glossary.md#row-oriented-table) индексируемые колонки `bloom_filter` должны образовывать левый префикс [первичного ключа](../../../../concepts/glossary.md#primary-key).
