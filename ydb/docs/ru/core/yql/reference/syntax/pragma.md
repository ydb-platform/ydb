...
Каждый относительный префикс отсчитывается от корня базы данных, даже если ранее уже был задан другой префикс. Пустой глобальный префикс указывает на корень базы данных.
