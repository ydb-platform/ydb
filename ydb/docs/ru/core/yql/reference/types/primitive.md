...
{{ ydb-short-name }} поддерживает [базовые](#datetime-basic) и [расширенные](#datetime-extended) типы дат, которые отличаются диапазоном возможных значений.

#|
|| Тип | Описание | Размер (байты) | Значения | Примечания ||

||
`Date`
|
Дата, точность до дней
|
4
|
...
`Datetime`
|
Дата и время, точность до секунд
|
4
|
с 00:00 01.01.1970 до 00:00 01.01.2106
...
`Timestamp`
|
Дата и время, точность до микросекунд
|
8
|
с 00:00 01.01.1970 до 00:00 01.01.2106
...
`Interval`
|
Интервал времени (знаковый), точность до микросекунд
|
8
|
...
`Interval64`
|
Интервал времени с точностью до микросекунд
|
8
|
...
`TzDate`
|
Дата с указанием временной зоны, точность до дней
|
...
`TzDateTime`
|
Дата и время с указанием временной зоны, точность до секунд
|
...
`TzTimestamp`
|
Дата и время с указанием временной зоны, точность до микросекунд
|
