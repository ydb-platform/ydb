...
{% if feature_map_tables %}Допустимо в качестве первичного ключа в строковых таблицах{% endif %}
    ||
...
8
|
{% if feature_map_tables %}Допустим в качестве первичного ключа в строковых таблицах{% else %}—{% endif %} Не поддерживается в колоночных таблицах
||
