...
Тип `Interval` поддерживает литералы только в формате, соответствующем стандарту ([ISO 8601](https://ru.wikipedia.org/wiki/ISO_8601)), но имеются некоторые отличия:
