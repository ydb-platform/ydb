...
ListTopSort эффективнее, чем последовательные ListTop и ListSort (так как ListTop может уже частично отсортировать список для поиска нужных значений), однако ListTop эффективнее ListTopSort, в случае если сортировка не нужна.
