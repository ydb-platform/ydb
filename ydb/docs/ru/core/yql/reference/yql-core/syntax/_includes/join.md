...
Выполнение любых видов `JOIN` между строковыми и колоночными таблицами не поддерживается, так как механизм транзакций между разными видами таблиц не реализован.
