...
|-------------------------|-------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| `bypass_artifact_cache` | `true`/`false`    | Управляет кешированием на [стороне YT](https://yt.yandex-team.ru/docs/user-guide/data-processing/operations/operations-options#fajly) |
