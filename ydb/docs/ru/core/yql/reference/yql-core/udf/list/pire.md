...
Чтобы избежать компиляции регулярного выражения на каждой строке [строковой](../../../../concepts/datamodel/table.md#row-oriented-tables) или [колоночной](../../../../concepts/datamodel/table.md#column-oriented-tables) таблицы, необходимо обернуть вызов функции в [именованное выражение](../../syntax/expressions.md#named-nodes):
