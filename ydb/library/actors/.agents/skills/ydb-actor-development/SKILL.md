...
description: "Implement, debug, or review NActors event protocols, actor lifetime, coroutine handlers, actor-system subsystems, and shutdown, including actor-based tablets. Use when these mechanisms are involved; ordinary business logic in an actor does not require this skill."
---
...
- Subsystem interfaces, registration, mocks, dependencies, and lifecycle hooks: [subsystems](../../../../../docs/en/core/contributor/actor-system/subsystems.md).
...
Select tests from the affected component. Add runtime tests when changing runtime guarantees, and component tests when changing a component protocol. Follow active build instructions for the target.
