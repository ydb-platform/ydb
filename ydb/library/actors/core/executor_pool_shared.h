...
namespace NActors {
    ...
    public:
        ...
        TExecutorThreadCtx *GetSharedThread(i16 poolId);
        ...
        bool MoveHalfThread(i16 from, i16 to);
    ...
    private:
        ...
        std::vector<bool> UseOwnThreadByPool;
        std::vector<TBasicExecutorPool*> Pools;

        i16 PoolCount;

        i16 SharedThreadCount;
        std::unique_ptr<TExecutorThreadCtx[]> Threads;
