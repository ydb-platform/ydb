...
Y_UNIT_TEST_SUITE(ActorException) {
    ...
    class TActorBootstrapExceptionActor : public TActorBootstrapped<TActorBootstrapExceptionActor> {
    public:
        TActorBootstrapExceptionActor(TManualEvent& done)
            : Done(done)
        {
            SetExceptionHandler([this](const auto& e) {
    ...
    class TActorHandlerExceptionActor : public TActor<TActorHandlerExceptionActor> {
    public:
