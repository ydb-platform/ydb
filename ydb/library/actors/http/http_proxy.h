...
struct TEvHttpProxy {
    ...
    struct TEvAuditProbe : NActors::TEventLocal<TEvAuditProbe, EvAuditProbe> {
        bool WithAck = false;
        TEvAuditProbe(bool withAck = false)
            : WithAck(withAck)
        {}
    };

    struct TEvAuditAck : NActors::TEventLocal<TEvAuditAck, EvAuditAck> {};
};
