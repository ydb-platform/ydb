...
namespace NActors {
    ...
    void TInterconnectSessionTCP::SetNewConnection(TEvHandshakeDone::TPtr& ev) {
        ...
        OutOfBandStream = Params.AllowRdmaSendReceive
    ...
    void TInterconnectSessionTCP::GenerateTraffic() {
        ...
        while (Socket) {
            ...
            if (Params.AllowRdmaSendReceive) {
                canWriteData = (OutgoingStream || OutOfBandStream) && !RdmaWriteInFlight;
            } else if (UringContext) {
    ...
    std::optional<ui32> TInterconnectSessionTCP::MakePacket(bool data, TMaybe<ui64> pingMask) {
        ...
        const bool usePreallocatedInternalStream = Params.AllowRdmaSendReceive;
