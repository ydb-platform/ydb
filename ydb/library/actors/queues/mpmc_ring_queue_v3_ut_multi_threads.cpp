...
Y_UNIT_TEST_SUITE(MPMCRingQueueV3MultiThreadsTests) {

    template <ui32 SizeBits>
    using TCases = TTestCases<TMPMCRingQueueV3WithStats<SizeBits>, TIdAdaptor<TMPMCRingQueueV3WithStats<SizeBits>>>;
    ...
    Y_UNIT_TEST(BasicPushPopMultiThreads) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(
                collector.Stats.SuccessFastPush,
    ...
    Y_UNIT_TEST(BasicProducingConsuming) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(collector.Stats.SuccessFastPush, ThreadCount * ItemsPerThread);
