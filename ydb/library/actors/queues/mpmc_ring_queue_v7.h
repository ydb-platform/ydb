...
// OBSERVE
    ...
    NThreading::TPadded<TUI32Buffer> OvertakenQueue;
    ui32 ReadersCount = 0;
    ...
    TMPMCRingQueueV7(ui32 readersCount)
    ...
    std::optional<ui32> TryPop() {
        ui64 overtakenSlots = OvertakenQueue.Count.load(std::memory_order_acquire);
        while(overtakenSlots) {
            ...
            SpinLockPause();
            overtakenSlots = OvertakenQueue.Count.load(std::memory_order_acquire);
        }
