...
struct AggregationMethodOneNumber
{
    ...
    static void insertKeyIntoColumns(const Key & key, const std::vector<ColPtr> & key_columns, const Sizes & /*key_sizes*/, const std::vector<arrow20::Type::type>& /*typeIds*/)
    {
...
struct AggregationMethodString
{
    ...
    template <typename ColPtr>
    static void insertKeyIntoColumns(const StringRef & key, const std::vector<ColPtr> & key_columns, const Sizes &, const std::vector<arrow20::Type::type>& /*typeIds*/)
    {
