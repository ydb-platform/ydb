...
struct TRound {
    ...
    static constexpr TRes Call(arrow20::compute::KernelContext*, TArg arg, arrow20::Status*) {
...
struct TRoundToExp2 {
    ...
    Call(arrow20::compute::KernelContext*, TArg arg, arrow20::Status*) {
    ...
    template <typename TRes, typename TArg>
    static constexpr EnableIfFloat32<TRes> Call(arrow20::compute::KernelContext*, TArg arg, arrow20::Status*) {
        static_assert(std::is_same_v<TRes, TArg>, "");
