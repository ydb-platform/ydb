...
$sales_detail = (SELECT d_year
             ...
             ,cs_ext_sales_price - COALESCE(cr_return_amount,$zero_7_2) AS sales_amt
       ...
       SELECT d_year
             ...
             ,ss_ext_sales_price - COALESCE(sr_return_amt,$zero_7_2) AS sales_amt
       ...
       SELECT d_year
             ...
             ,ws_ext_sales_price - COALESCE(wr_return_amt,$zero_7_2) AS sales_amt
