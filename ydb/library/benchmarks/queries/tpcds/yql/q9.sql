...
$avg_ss_net_paid_1_20 = (select avg(ss_net_paid)
    from {{store_sales}} as store_sales
    where ss_quantity between 1 and 20);
...
$avg_ss_net_paid_21_40 = (select avg(ss_net_paid)
    from {{store_sales}} as store_sales
    where ss_quantity between 21 and 40);
...
$avg_ss_net_paid_41_60 = (select avg(ss_net_paid)
    from {{store_sales}} as store_sales
    where ss_quantity between 41 and 60);
...
$avg_ss_net_paid_61_80 = (select avg(ss_net_paid)
    from {{store_sales}} as store_sales
    where ss_quantity between 61 and 80);
...
$avg_ss_net_paid_81_100 = (select avg(ss_net_paid)
    from {{store_sales}} as store_sales
    where ss_quantity between 81 and 100);


select case when $count_1_20 > 74129
            then $avg_ss_ext_discount_amt_1_20
            else $avg_ss_net_paid_1_20 end bucket1 ,
       case when $count_21_40 > 122840
            then $avg_ss_ext_discount_amt_21_40
            else $avg_ss_net_paid_21_40 end bucket2,
       case when $count_41_60 > 56580
            then $avg_ss_ext_discount_amt_41_60
            else $avg_ss_net_paid_41_60 end bucket3,
       case when $count_61_80 > 10097
            then $avg_ss_ext_discount_amt_61_80
            else $avg_ss_net_paid_61_80 end bucket4,
       case when $count_81_100 > 165306
            then $avg_ss_ext_discount_amt_81_100
            else $avg_ss_net_paid_81_100 end bucket5
