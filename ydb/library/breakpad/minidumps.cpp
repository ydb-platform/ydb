...
public:
    void SetupOpts(NLastGetopt::TOpts& opts) override {
        opts.AddLongOption("breakpad-minidumps-path", "Path for minidumps generated by interanl breakpad")
            .RequiredArgument("PATH").Handler1T<TString>([](const TString& path) {
            Minidumper.Init(path.c_str());
        });
        opts.AddLongOption("breakpad-minidumps-script", "Script for process minidumps generated by interanl breakpad")
