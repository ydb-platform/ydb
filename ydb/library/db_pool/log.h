...
#define LOG_F(logRecordStream) LOG_F_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_A(logRecordStream) LOG_A_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_C(logRecordStream) LOG_C_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_E(logRecordStream) LOG_E_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_W(logRecordStream) LOG_W_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_N(logRecordStream) LOG_N_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_I(logRecordStream) LOG_I_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_D(logRecordStream) LOG_D_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
#define LOG_T(logRecordStream) LOG_T_AS(::NActors::TActivationContext::ActorSystem(), LogPrefix() << logRecordStream)
