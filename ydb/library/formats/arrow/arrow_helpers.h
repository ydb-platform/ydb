...
TString DebugString(std::shared_ptr<arrow20::Array> array, const ui32 position, const NKikimr::NScheme::TTypeInfo* logicalType = nullptr);
...
inline std::shared_ptr<arrow20::Table> ClaimMemoryOwnership(const std::shared_ptr<arrow20::Table>& table, [[maybe_unused]] arrow20::MemoryPool* pool = arrow20::default_memory_pool()) {
