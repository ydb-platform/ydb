...
TConclusion<std::shared_ptr<arrow20::Scalar>> TSerializer::DeserializeFromStringWithPayload(const TString& data, const std::shared_ptr<arrow20::DataType>& dataType) {
    AFL_VERIFY(dataType);
