...
void TTpcBaseWorkloadParams::ConfigureOpts(NLastGetopt::TOpts& opts, const ECommandType commandType, int workloadType) {
    ...
    case TWorkloadParams::ECommandType::Init:
        opts.AddLongOption("float-mode", "Float mode. Can be float, decimal or decimal_ydb. If set to 'float' - float will be used, 'decimal' means use decimal with cannonical size and 'decimal_ydb' means, that all floats will be converted to decimal(22,9) becourse YDB suuports only this type.")
