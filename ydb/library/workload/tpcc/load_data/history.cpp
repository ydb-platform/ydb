...
THistoryLoadQueryGenerator::THistoryLoadQueryGenerator(TLoadParams& params, ui32 partNum, TLog& log, ui64 seed)
    : TLoadQueryGenerator(params, ETablesType::history, log, seed)
    , PartNum(partNum)
{
