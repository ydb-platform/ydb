...
TWarehouseLoadQueryGenerator::TWarehouseLoadQueryGenerator(TLoadParams& params, TLog& log, ui64 seed)
    : TLoadQueryGenerator(params, ETablesType::warehouse, log, seed)
{
    WarehouseId = 1;
}
