...
TDqComputeStorage::TDqComputeStorage(TTxId txId, std::function<void()> wakeUpCallback, std::function<void(const TString&)> errorCallback, TActorSystem* actorSystem) : ActorSystem_(actorSystem) {
