...
public:
    ...
    bool IsSourceEmpty() override {
        return IsSourceEmptyNV();
    }

    bool IsSourceEmptyNV() {
        return SourceEmpty;
    }
    ...
    TUnboxedValue* GetDenseInputBufferNV() {
        return InputBuffer.data();
    }

    TUnboxedValue* GetDenseOutputBufferNV() {
        auto result = OutputBuffer.data();
        return result;
    }

    EFillState ProcessInput(EFillState sourceState) override {
        return ProcessInputNV(sourceState);
    }

    EFillState ProcessInputNV(EFillState sourceState) {
...
public:
    ...
    EFillState ProcessInput(EFillState fetchResult) override {
        return ProcessInputNV(fetchResult);
    }

    EFillState ProcessInputNV(EFillState fetchResult) {
...
public:
    ...
    TGenerateResult DoGenGetValues(
        [[maybe_unused]] const TCodegenContext& ctx, [[maybe_unused]] Value* statePtr, [[maybe_unused]] BasicBlock*& block) const override
    {
        ...
        auto isDrainingMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::IsDrainingNV>() : GetMethodPtr<&TWideAggregationState::IsDrainingNV>());
        auto isSourceEmptyMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::IsSourceEmptyNV>() : GetMethodPtr<&TWideAggregationState::IsSourceEmptyNV>());
        auto getInputBufferMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::GetDenseInputBufferNV>() : GetMethodPtr<&TWideAggregationState::GetDenseInputBufferNV>());
        auto getOutputBufferMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::GetDenseOutputBufferNV>() : GetMethodPtr<&TWideAggregationState::GetDenseOutputBufferNV>());
        auto processInputMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::ProcessInputNV>() : GetMethodPtr<&TWideAggregationState::ProcessInputNV>());
        const auto drainMethodAddr = ConstantInt::get(Type::getInt64Ty(context),
            BlockMode ? GetMethodPtr<&TBlockAggregationState::TryDrainNV>() : GetMethodPtr<&TWideAggregationState::TryDrainNV>());
