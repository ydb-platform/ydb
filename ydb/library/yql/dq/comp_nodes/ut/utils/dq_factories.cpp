...
TComputationNodeFactory GetDqNodeFactory(TComputationNodeFactory customFactory) {
    ...
    // The remaining 5 fields use their own default initializers:
    //   ChunkSizeLimit=48_MB, ArrayBufferMinFillPercentage={}, BufferPageAllocSize={},
    //   MemoryQuotaManager=nullptr, ChannelQuotaManager=nullptr.
