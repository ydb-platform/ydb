...
//     std::function<void(TVector<std::shared_ptr<TRelOptimizerNode>>&, TStringBuf, const TExprNode::TPtr, const TOptimizerStatistics&)> providerCollect = [](auto& rels, auto label, auto node, auto stats) {
//         Y_UNUSED(node);
