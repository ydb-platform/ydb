...
NNodes::TExprBase DqPeepholeOptimizeWideFromBlocks(const NNodes::TExprBase& node, TExprContext&);
NNodes::TExprBase DqPeepholeOptimizeWideToBlocks(const NNodes::TExprBase& node, TExprContext&);
