...
TExprBase DqBuildAggregationResultStage(TExprBase node, TExprContext& ctx, IOptimizationContext& optCtx, const TDoNotCreateScalarPrecomputeForAggResult &options) {
    Y_UNUSED(optCtx);
...
TExprBase DqBuildScalarPrecompute(TExprBase node, TExprContext &ctx, IOptimizationContext &optCtx, const TParentsMap &parentsMap,
                                  bool allowStageMultiUsage, const TDoNotCreateScalarPrecomputeForAggResult &options) {
