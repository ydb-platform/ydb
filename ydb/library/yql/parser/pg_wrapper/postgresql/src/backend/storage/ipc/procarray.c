 ...
 */
static __thread TransactionId cachedXidIsNotInProgress = InvalidTransactionId;
 ...
 */
static __thread GlobalVisState GlobalVisSharedRels;
static __thread GlobalVisState GlobalVisCatalogRels;
static __thread GlobalVisState GlobalVisDataRels;
static __thread GlobalVisState GlobalVisTempRels;
 ...
 */
static __thread TransactionId ComputeXidHorizonsResultLastXmin;
...
TransactionIdIsInProgress(TransactionId xid)
{
	...
	static __thread TransactionId *other_xids;
...
KnownAssignedXidsCompress(KAXCompressReason reason, bool haveLock)
{
	...
	static __thread unsigned int transactionEndsCounter;
	static __thread TimestampTz lastCompressTs;
