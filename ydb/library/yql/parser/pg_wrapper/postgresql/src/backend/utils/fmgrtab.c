...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 6169, 1, false, true, "pg_stat_get_replication_slot", pg_stat_get_replication_slot },
...
const Oid fmgr_last_builtin_oid = 6204;

const uint16 fmgr_builtin_oid_index[6205] = {
