...
extern __thread PGDLLIMPORT RmgrData RmgrTable[];
 ...
 */
extern __thread PGDLLIMPORT bool ArchiveRecoveryRequested;
extern __thread PGDLLIMPORT bool InArchiveRecovery;
