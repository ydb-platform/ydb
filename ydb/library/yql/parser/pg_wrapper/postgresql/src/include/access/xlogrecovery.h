...
extern __thread PGDLLIMPORT bool recoveryTargetInclusive;
extern __thread PGDLLIMPORT int recoveryTargetAction;
extern __thread PGDLLIMPORT int recovery_min_apply_delay;
extern __thread PGDLLIMPORT char *PrimaryConnInfo;
extern __thread PGDLLIMPORT char *PrimarySlotName;
extern __thread PGDLLIMPORT char *recoveryRestoreCommand;
extern __thread PGDLLIMPORT char *recoveryEndCommand;
extern __thread PGDLLIMPORT char *archiveCleanupCommand;

/* indirectly set via GUC system */
extern __thread PGDLLIMPORT TransactionId recoveryTargetXid;
extern __thread PGDLLIMPORT char *recovery_target_time_string;
extern __thread PGDLLIMPORT TimestampTz recoveryTargetTime;
...
extern __thread PGDLLIMPORT TimeLineID recoveryTargetTLI;

/* Have we already reached a consistent database state? */
extern __thread PGDLLIMPORT bool reachedConsistency;

/* Are we currently in standby mode? */
extern __thread PGDLLIMPORT bool StandbyMode;
