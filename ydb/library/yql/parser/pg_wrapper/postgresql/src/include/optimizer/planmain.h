...
extern __thread PGDLLIMPORT double cursor_tuple_fraction;
 ...
 */
extern __thread PGDLLIMPORT int from_collapse_limit;
extern __thread PGDLLIMPORT int join_collapse_limit;
