...
extern PGDLLIMPORT const int backslash_quote;
extern PGDLLIMPORT const bool escape_string_warning;
extern PGDLLIMPORT const bool standard_conforming_strings;
