...
extern __thread PGDLLIMPORT int max_logical_replication_workers;
extern __thread PGDLLIMPORT int max_sync_workers_per_subscription;
extern __thread PGDLLIMPORT int max_parallel_apply_workers_per_subscription;
