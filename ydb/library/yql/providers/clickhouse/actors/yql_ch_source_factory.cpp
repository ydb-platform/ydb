...
void RegisterClickHouseReadActorFactory(TDqAsyncIoFactory& factory, IStructuredTokenCredentialsFactory::TPtr credentialsFactory, IHTTPGateway::TPtr gateway) {
