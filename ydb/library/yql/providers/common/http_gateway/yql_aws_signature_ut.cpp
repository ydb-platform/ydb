...
Y_UNIT_TEST_SUITE(TAwsSignature) {
    ...
    Y_UNIT_TEST(SignWithTime) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(signature1.GetContentType(), "application/json");
        UNIT_ASSERT_VALUES_EQUAL(signature2.GetContentType(), "application/json");
        UNIT_ASSERT_VALUES_EQUAL(signature3.GetContentType(), "application/json");
        UNIT_ASSERT_VALUES_EQUAL(signature4.GetContentType(), "application/json");
        UNIT_ASSERT_VALUES_EQUAL(signature1.GetXAmzContentSha256(), "12ae32cb1ec02d01eda3581b127c1fee3b0dc53572ed6baf239721a03d82e126");
