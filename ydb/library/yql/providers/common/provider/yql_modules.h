...
public:
    ...
    virtual bool ApplyConfigFlag(const TPosition& pos, const TString& flagName, TExprContext& ctx, const TVector<TStringBuf>& args, TUserDataTable& crutches) const = 0;
...
public:
    ...
    static bool ApplyConfigFlag(const TPosition& pos, const TString& flagName, TExprContext& ctx, const TVector<TStringBuf>& args, TUserDataTable& crutches);
    static TVector<IYqlModule::TDatafileTraits> GetUsedFilenamePaths(const TString& moduleName);
