...
public:
    explicit TDefaultStructuredTokenCredentialsFactory(ISecuredServiceAccountCredentialsFactory::TPtr saFactory)
...
{
    return std::make_shared<TDefaultStructuredTokenCredentialsFactory>(std::move(saFactory));
}
