    ...
    Y_UNIT_TEST_QUAD(Lookup, MultiMatches, Fullscan) {
        ...
        connectorMock->ExpectReadSplits()
            ...
            .Result()
                .AddResponse(
                    MakeRecordBatch(
                        MakeArray<arrow20::UInt64Builder, uint64_t>("id", {0, 1, 1, 2}, arrow20::uint64()),
                        MakeArray<arrow20::UInt64Builder, uint64_t>("optional_id", {100, 101, 101, 103}, arrow20::uint64()), // the last value is intentionally wrong
                        MakeArray<arrow20::StringBuilder, std::string>("string_value", {"a", "b", "ba", "c"}, arrow20::utf8())
                    ),
                    NewSuccess()
                )
        ;
                    ...
                    .Result()
                        .AddResponse(
                            MakeRecordBatch(
                                ...
                                MakeArray<arrow20::UInt64Builder, uint64_t>("optional_id", {100, 101, 103}, arrow20::uint64()), // the last value is intentionally wrong
