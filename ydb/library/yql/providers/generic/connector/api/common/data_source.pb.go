...
const (
	EDataSourceKind_DATA_SOURCE_KIND_RESERVED EDataSourceKind = 0
...
func (x *TDataSourceInstance) GetKind() EDataSourceKind {
	...
	return EDataSourceKind_DATA_SOURCE_KIND_RESERVED
}
...
var file_ydb_library_yql_providers_generic_connector_api_common_data_source_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x88, 0x02, 0x0a, 0x13, 0x54, 0x44, 0x61,
	...
	0x54, 0x6c, 0x73, 0x2a, 0x50, 0x0a, 0x0f, 0x45, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x1d, 0x0a, 0x19, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x53,
	0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x52, 0x45, 0x53, 0x45, 0x52,
	0x56, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x43, 0x4c, 0x49, 0x43, 0x4b, 0x48, 0x4f,
	0x55, 0x53, 0x45, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x50, 0x4f, 0x53, 0x54, 0x47, 0x52, 0x45,
	0x53, 0x51, 0x4c, 0x10, 0x02, 0x42, 0x49, 0x5a, 0x47, 0x61, 0x2e, 0x79, 0x61, 0x6e, 0x64, 0x65,
...
var file_ydb_library_yql_providers_generic_connector_api_common_data_source_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ydb_library_yql_providers_generic_connector_api_common_data_source_proto_goTypes = []interface{}{
	...
	(*TCredentials)(nil),        // 1: NYql.NConnector.NApi.TCredentials
	(*TDataSourceInstance)(nil), // 2: NYql.NConnector.NApi.TDataSourceInstance
	(*TCredentials_TBasic)(nil), // 3: NYql.NConnector.NApi.TCredentials.TBasic
	(*TEndpoint)(nil),           // 4: NYql.NConnector.NApi.TEndpoint
}
var file_ydb_library_yql_providers_generic_connector_api_common_data_source_proto_depIdxs = []int32{
	3, // 0: NYql.NConnector.NApi.TCredentials.basic:type_name -> NYql.NConnector.NApi.TCredentials.TBasic
	0, // 1: NYql.NConnector.NApi.TDataSourceInstance.kind:type_name -> NYql.NConnector.NApi.EDataSourceKind
	4, // 2: NYql.NConnector.NApi.TDataSourceInstance.endpoint:type_name -> NYql.NConnector.NApi.TEndpoint
	1, // 3: NYql.NConnector.NApi.TDataSourceInstance.credentials:type_name -> NYql.NConnector.NApi.TCredentials
