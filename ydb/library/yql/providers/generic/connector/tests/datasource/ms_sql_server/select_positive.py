        ...
        schema = Schema(
            columns=ColumnList(
                ...
                Column(
                    ...
                    data_source_type=DataSourceType(my=ms_sql_server.TinyInt()),
                ),
                Column(
                    name='col_02_tinyint_unsigned',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UINT8),
                    data_source_type=DataSourceType(my=ms_sql_server.TinyIntUnsigned()),
                ),
                Column(
                    name='col_03_smallint',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.INT16),
                    data_source_type=DataSourceType(my=ms_sql_server.SmallInt()),
                ),
                Column(
                    name='col_04_smallint_unsigned',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UINT16),
                    data_source_type=DataSourceType(my=ms_sql_server.SmallIntUnsigned()),
                ),
                Column(
                    name='col_05_mediumint',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.INT32),
                    data_source_type=DataSourceType(my=ms_sql_server.MediumInt()),
                ),
                Column(
                    name='col_06_mediumint_unsigned',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UINT32),
                    data_source_type=DataSourceType(my=ms_sql_server.MediumIntUnsigned()),
                ),
                Column(
                    name='col_07_integer',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.INT32),
                ...
                Column(
                    ...
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UINT32),
                    data_source_type=DataSourceType(my=ms_sql_server.IntegerUnsigned()),
                ),
                Column(
                    name='col_09_bigint',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.INT64),
                    data_source_type=DataSourceType(my=ms_sql_server.BigInt()),
                ),
                Column(
                    name='col_10_bigint_unsigned',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UINT64),
                    data_source_type=DataSourceType(my=ms_sql_server.BigIntUnsigned()),
                ),
                Column(
                    name='col_11_float',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.FLOAT),
                    data_source_type=DataSourceType(my=ms_sql_server.Float()),
                ),
                Column(
                    name='col_12_double',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.DOUBLE),
                    data_source_type=DataSourceType(my=ms_sql_server.Double()),
                ),
                Column(
                    name='col_13_date',
                ...
                Column(
                    ...
                    data_source_type=DataSourceType(my=ms_sql_server.Char()),
                ),
                Column(
                    name='col_17_varchar',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.UTF8),
                    data_source_type=DataSourceType(my=ms_sql_server.VarChar()),
                ),
                Column(
                    name='col_18_tinytext',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.TinyText()),
                ),
                Column(
                    name='col_19_text',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.Text()),
                ),
                Column(
                    name='col_20_mediumtext',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.MediumText()),
                ),
                Column(
                    name='col_21_longtext',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.LongText()),
                ),
                # Don't be surprised - binary types look like UTF8 strings in Go
                Column(
                    name='col_22_binary',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.Binary()),
                ),
                Column(
                    name='col_23_varbinary',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.VarBinary()),
                ),
                Column(
                    name='col_24_tinyblob',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.TinyBlob()),
                ),
                Column(
                    name='col_25_blob',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.Blob()),
                ),
                Column(
                    name='col_26_mediumblob',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.MediumBlob()),
                ),
                Column(
                    name='col_27_longblob',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.STRING),
                    data_source_type=DataSourceType(my=ms_sql_server.LongBlob()),
                ),
                Column(
                    name='col_28_bool',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.BOOL),
                    data_source_type=DataSourceType(my=ms_sql_server.Bool()),
                ),
                Column(
                    name='col_29_json',
                    ydb_type=makeOptionalYdbTypeFromTypeID(Type.JSON),
                    data_source_type=DataSourceType(my=ms_sql_server.Json()),
                ),
            )
        )
