...
// Data plane operations: Read/write sessions, commit offset
class ITopicDataClient : public TThrRefBase {
public:
    using TPtr = TIntrusivePtr<ITopicDataClient>;
...
class ITopicClient : public ITopicDataClient {
public:
