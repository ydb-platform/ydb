...
namespace {
    struct TPushdownSettings: public NPushdown::TSettings {
            ...
            : NPushdown::TSettings(NLog::EComponent::ProviderGeneric)
        {
            ...
            Enable(EFlag::ExpressionAsPredicate | EFlag::ArithmeticalExpressions | EFlag::ImplicitConversionToInt64 | EFlag::StringTypes | EFlag::LikeOperator | EFlag::ImplicitConversionSignedAndUnsignedInt);
        }
    };
