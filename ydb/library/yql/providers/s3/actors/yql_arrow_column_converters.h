...
TColumnConverter BuildColumnConverter(
    ...
    const std::shared_ptr<arrow20::DataType>& originalType,
    const std::shared_ptr<arrow20::DataType>& targetType,
...
void BuildColumnConverters(
    std::shared_ptr<arrow20::Schema> outputSchema,
...
std::shared_ptr<arrow20::RecordBatch> ConvertArrowColumns(
    std::shared_ptr<arrow20::RecordBatch> batch,
    std::vector<TColumnConverter>& columnConverters);

bool S3ConvertArrowOutputType(NUdf::EDataSlot slot, std::shared_ptr<arrow20::DataType>& type, NKikimr::NMiniKQL::TType* itemType = nullptr);
bool S3ConvertArrowOutputType(NKikimr::NMiniKQL::TType* itemType, std::shared_ptr<arrow20::DataType>& type);
