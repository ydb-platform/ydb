...
public:
    ...
    void FillSourceSettings(const TExprNode& node, ::google::protobuf::Any& protoSettings, TString& sourceType, TMaybe<size_t> maxPartitions, TExprContext& ctx) override {
