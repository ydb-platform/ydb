...
TDataProviderInitializer GetS3DataProviderInitializer(IHTTPGateway::TPtr gateway, std::shared_ptr<IStructuredTokenCredentialsFactory> credentialsFactory, NActors::TActorSystem* actorSystem, TS3Configuration::TSetupper configurationInit) {
