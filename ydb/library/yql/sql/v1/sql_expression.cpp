...
TNodePtr TSqlExpression::SubExpr(const TRule_con_subexpr& node, const TTrailingQuestions& tail) {
    ...
    switch (node.Alt_case()) {
        ...
        case TRule_con_subexpr::kAltConSubexpr2: {
            ...
            Token(token);
            TPosition pos(Ctx.Pos());
            switch (token.GetId() << 16 + token.GetIsAntlr4()) {
                case SQLv1Antlr4Lexer::TOKEN_NOT << 16 + 1: opName = "Not"; break;
                case SQLv1Antlr4Lexer::TOKEN_PLUS << 16 + 1: opName = "Plus"; break;
                case SQLv1Antlr4Lexer::TOKEN_MINUS << 16 + 1: opName = Ctx.Scoped->PragmaCheckedOps ? "CheckedMinus" : "Minus"; break;
                case SQLv1Antlr4Lexer::TOKEN_TILDA << 16 + 1: opName = "BitNot"; break;
                default:
    ...
    if (node.HasBlock2()) {
        ...
        switch (cond.Alt_case()) {
            ...
            case TRule_cond_expr::kAltCondExpr4: {
                ...
                const bool symmetric = alt.HasBlock3() && (alt.GetBlock3().GetToken1().GetIsAntlr4() && alt.GetBlock3().GetToken1().GetId() == SQLv1Antlr4Lexer::TOKEN_SYMMETRIC);
    ...
    while (begin != end) {
        ...
        switch (tokenId << 16 + isAntlr4) {
            ...
            case SQLv1Antlr4Lexer::TOKEN_SLASH << 16 + 1:
                ...
                break;
            case SQLv1Antlr4Lexer::TOKEN_PERCENT << 16 + 1:
    ...
    while (begin != end) {
        ...
        switch (begin->GetBlock1().Alt_case()) {
            case TRule_neq_subexpr_TBlock2_TBlock1::kAlt1: {
                ...
                bool isAntlr4 =  begin->GetBlock1().GetAlt1().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_SHIFT_LEFT) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
                opName = "ShiftLeft";
            ...
            case TRule_neq_subexpr_TBlock2_TBlock1::kAlt3: {
                ...
                bool isAntlr4 = begin->GetBlock1().GetAlt3().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_ROT_LEFT) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
                opName = "RotLeft";
            ...
            case TRule_neq_subexpr_TBlock2_TBlock1::kAlt5: {
                ...
                bool isAntlr4 = begin->GetBlock1().GetAlt5().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_AMPERSAND) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
                opName = "BitAnd";
            ...
            case TRule_neq_subexpr_TBlock2_TBlock1::kAlt6: {
                ...
                bool isAntlr4 = begin->GetBlock1().GetAlt6().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_PIPE) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
                opName = "BitOr";
            ...
            case TRule_neq_subexpr_TBlock2_TBlock1::kAlt7: {
                ...
                bool isAntlr4 = begin->GetBlock1().GetAlt7().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_CARET) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
                opName = "BitXor";
    ...
    while (begin != end) {
        ...
        switch (begin->GetBlock1().Alt_case()) {
            case TRule_cond_expr::TAlt5::TBlock1::TBlock1::kAlt1: {
                ...
                auto tokenId = begin->GetBlock1().GetAlt1().GetToken1().GetId();
                bool isAntlr4 = begin->GetBlock1().GetAlt1().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_EQUALS) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
            ...
            case TRule_cond_expr::TAlt5::TBlock1::TBlock1::kAlt2: {
                ...
                bool isAntlr4 = begin->GetBlock1().GetAlt2().GetToken1().GetId();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_EQUALS2) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
            ...
            case TRule_cond_expr::TAlt5::TBlock1::TBlock1::kAlt3: {
                ...
                auto tokenId = begin->GetBlock1().GetAlt3().GetToken1().GetId();
                bool isAntlr4 = begin->GetBlock1().GetAlt3().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_NOT_EQUALS) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
            ...
            case TRule_cond_expr::TAlt5::TBlock1::TBlock1::kAlt4: {
                ...
                auto isAntlr4 = begin->GetBlock1().GetAlt4().GetToken1().GetIsAntlr4();
                if (isAntlr4 && tokenId != SQLv1Antlr4Lexer::TOKEN_NOT_EQUALS2) {
                    Error() << "Unsupported binary operation token: " << tokenId;
                    return {};
                }
