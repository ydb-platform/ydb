...
inline bool operator!= (NDB::StringRef lhs, NDB::StringRef rhs)
{
    return !(lhs == rhs);
}
...
struct StringRefHash {
    size_t operator() (NDB::StringRef x) const
    {
...
{
    template <>
    struct hash<NDB::StringRef> : public NDB::StringRefHash {};
}


namespace ZeroTraits
{
    inline bool check(const NDB::StringRef & x) { return 0 == x.size; }
    inline void set(NDB::StringRef & x) { x.size = 0; }
}
