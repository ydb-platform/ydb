...
void transformTypesRecursively(
    DataTypes & types,
    std::function<void(DataTypes &, std::unordered_set<TypeIndex> &)> transform_simple_types,
    std::function<void(DataTypes &, std::unordered_set<TypeIndex> &)> transform_complex_types);
