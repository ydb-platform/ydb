...
IF (OS_LINUX AND CLANG AND NOT WITH_VALGRIND)
    ...
    CFLAGS (
       -DARCADIA_BUILD -DOS_LINUX -DUSE_ARROW=0 -DUSE_PARQUET=0 -DUSE_ORC=0 -DUSE_AVRO=0 -DUSE_UNWIND=0 -DDBMS_VERSION_MAJOR=21 -DDBMS_VERSION_MINOR=18 -DDBMS_VERSION_PATCH=0
