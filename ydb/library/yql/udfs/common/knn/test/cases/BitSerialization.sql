...
from (
    select
        ListFromRange(0, 130, 3) as `element_count`,
        ListFromRange(0, 130) as `element_idx`,
        [1.0f, -1.0f] as `base_value`
)
flatten list by (`element_count`, `element_idx`, `base_value`)
...
);  -- expected \0b11001101\0b00001100\0b00000111\5\10
