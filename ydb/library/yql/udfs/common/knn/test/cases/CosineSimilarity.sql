...
select Knn::CosineSimilarity($lazy_vector1, $lazy_vector2);

--lazy vector + fixed size vector
select Knn::CosineSimilarity($lazy_vector1, $vector2);
select Knn::CosineSimilarity($vector1, $lazy_vector2);

--good deserialized vector
$deserialized_vector2 = Knn::FromBinaryString(Knn::ToBinaryString($vector2));
select Knn::CosineSimilarity($vector1, $deserialized_vector2);
