...
$vector_binary_str = Knn::ToBinaryString($vector, "floatbyte");
...
--fixed size vector
$vector1 = Knn::ToBinaryString([1.0f, 2.0f, 3.0f], "floatbyte");
$vector2 = Knn::ToBinaryString([4.0f, 5.0f, 6.0f], "floatbyte");
