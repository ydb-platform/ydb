...
select Knn::InnerProductSimilarity($bitvector_1_00, $bitvector_1_00);
select Knn::InnerProductSimilarity($bitvector_1_04, $bitvector_1_04);
select Knn::InnerProductSimilarity($bitvector_1_08, $bitvector_1_08);
select Knn::InnerProductSimilarity($bitvector_1_16, $bitvector_1_16);
select Knn::InnerProductSimilarity($bitvector_1_24, $bitvector_1_24);
select Knn::InnerProductSimilarity($bitvector_1_32, $bitvector_1_32);
select Knn::InnerProductSimilarity($bitvector_1_40, $bitvector_1_40);
select Knn::InnerProductSimilarity($bitvector_1_48, $bitvector_1_48);
select Knn::InnerProductSimilarity($bitvector_1_56, $bitvector_1_56);
select Knn::InnerProductSimilarity($bitvector_1_60, $bitvector_1_60);
...
select Knn::InnerProductSimilarity($bitvector_00, $bitvector_00);
select Knn::InnerProductSimilarity($bitvector_04, $bitvector_04);
select Knn::InnerProductSimilarity($bitvector_08, $bitvector_08);
select Knn::InnerProductSimilarity($bitvector_16, $bitvector_16);
select Knn::InnerProductSimilarity($bitvector_24, $bitvector_24);
select Knn::InnerProductSimilarity($bitvector_32, $bitvector_32);
select Knn::InnerProductSimilarity($bitvector_40, $bitvector_40);
select Knn::InnerProductSimilarity($bitvector_48, $bitvector_48);
select Knn::InnerProductSimilarity($bitvector_56, $bitvector_56);
select Knn::InnerProductSimilarity($bitvector_60, $bitvector_60);
