...
Y_UNIT_TEST_SUITE(Utils) {
    Y_UNIT_TEST(CreateSecureCookieIncludesPartitionedAttribute) {
        UNIT_ASSERT_STRINGS_EQUAL(
            CreateSecureCookie("cookie_name", "cookie_value", 42),
            "cookie_name=cookie_value; Path=/; Secure; HttpOnly; SameSite=None; Partitioned; Max-Age=42"
        );
    }

    Y_UNIT_TEST(ClearSecureCookieIncludesPartitionedAttribute) {
        UNIT_ASSERT_STRINGS_EQUAL(
            ClearSecureCookie("cookie_name"),
            "cookie_name=; Path=/; Secure; HttpOnly; SameSite=None; Partitioned; Max-Age=0"
        );
    }
