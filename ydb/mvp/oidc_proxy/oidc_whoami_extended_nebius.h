...
private:
    static void SetError(NJson::TJsonValue& root, const TStringBuf section, const TStringBuf key, const TStringBuf value);
    ...
    void RequestDone();
    TProxiedResponseParams CreateResponseParams(NHttp::THttpIncomingResponsePtr response, const NJson::TJsonValue& json) const;
