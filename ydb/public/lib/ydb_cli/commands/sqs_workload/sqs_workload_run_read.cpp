...
TCommandWorkloadSqsRunRead::TCommandWorkloadSqsRunRead() : TWorkloadCommand("read", {}, "Read workload") {}
...
int TCommandWorkloadSqsRunRead::Run(TConfig& config) { return Scenario.Run(config); }
