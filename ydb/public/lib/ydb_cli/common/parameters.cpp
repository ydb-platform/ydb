        ...
        case EBatchMode::Iterative:
            if (InputParamNames.empty()) {
                ...
                switch (InputFormat) {
                    ...
                    case EDataFormat::Csv:
                    case EDataFormat::Tsv: {
                        CsvParser.BuildParams(std::move(*data), *paramBuilder, TCsvParser::TParseMetadata{});
                        break;
                    }
                    default:
                ...
                for (const auto &name: InputParamNames) {
                    ...
                    switch (InputFormat) {
                        ...
                        case EDataFormat::Tsv: {
                            ...
                            CsvParser.BuildValue(std::move(*data), valueBuilder, type, TCsvParser::TParseMetadata{});
            ...
            while (true) {
                ...
                switch (InputFormat) {
                    ...
                    case EDataFormat::Tsv: {
                        ...
                        CsvParser.BuildValue(std::move(*data), valueBuilder, type.GetProto().list_type().item(), TCsvParser::TParseMetadata{});
                        break;
                    }
                    default:
                        Y_ABORT_UNLESS(false, "Unexpected input format");
