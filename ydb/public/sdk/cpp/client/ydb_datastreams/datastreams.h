...
namespace NYdb::NDataStreams::V1 {
    ...
    public:
        TPartitioningSettingsBuilder(TCreateStreamSettings& parent): Parent_(parent) {}
        ...
        TCreateStreamSettings& EndConfigurePartitioningSettings() {
            return Parent_;
        }

    private:
        TCreateStreamSettings& Parent_;
    };
