...
public:
    ...
    // Reset committed offsets for a consumer on all topic partitions
    // (including inactive). Not atomic across partitions; drops any active
    // read session for this consumer.
