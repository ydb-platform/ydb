...
void TCloseHandle::operator()(void* value) const noexcept {
    if (value != nullptr) {
...
class TFileTokenCacher final: public ITokenCacher {
public:
...
std::optional<TTokenCache> TFileTokenCacher::Read() const {
    with_lock (Mutex_) {
...
void TFileTokenCacher::Write(const TTokenCache& cache) {
    with_lock (Mutex_) {
