...
namespace NYdb::Ymq::V1 {
    ...
    public:
        ...
        TAsyncGetQueueUrlResult GetQueueUrl(const std::string &queueName, TGetQueueUrlSettings settings) {
        ...
        TAsyncCreateQueueResult CreateQueue(const std::string &queueName, TCreateQueueSettings settings) {
            return CallImpl<Ydb::Ymq::V1::YmqService,
        ...
        TAsyncSendMessageResult SendMessage(const std::string &queueUrl, const std::string &body, TSendMessageSettings settings) {
            return CallImpl<Ydb::Ymq::V1::YmqService,
    ...
    TAsyncGetQueueUrlResult TYmqClient::GetQueueUrl(const std::string& path, TGetQueueUrlSettings& settings) {
