...
namespace NYdb::Ymq::V1 {
    ...
    public:
        ...
        TAsyncGetQueueUrlResult GetQueueUrl(const std::string& queueName, TGetQueueUrlSettings& getQueueUrlSettings);
        TAsyncCreateQueueResult CreateQueue(const std::string& queueName, TCreateQueueSettings& createQueueSettings);
