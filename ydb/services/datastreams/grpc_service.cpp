...
#define ADD_REQUEST(NAME, CB, ATTR, LIMIT_TYPE, AUDIT_MODE) \
    ...
    ADD_REQUEST(PutRecord, DoDataStreamsPutRecordRequest, YdsProcessAttr, RuYds, TAuditMode::Modifying(TAuditMode::TLogClassConfig::Dml))
    ADD_REQUEST(PutRecords, DoDataStreamsPutRecordsRequest, YdsProcessAttr, RuYds, TAuditMode::Modifying(TAuditMode::TLogClassConfig::Dml))
    ADD_REQUEST(GetRecords, DoDataStreamsGetRecordsRequest, nullptr, RuYds, TAuditMode::NonModifying())
