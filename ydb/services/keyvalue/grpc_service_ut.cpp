...
public:
            ...
            TAutoPtr<TLogBackend> logBackend = {})
    {
        ...
        ServerSettings->RegisterGrpcService<NKikimr::NGRpcService::TKeyValueV1GRpcService>("keyvalue");
        ServerSettings->RegisterGrpcService<NKikimr::NGRpcService::TKeyValueV2GRpcService>("keyvalue");
