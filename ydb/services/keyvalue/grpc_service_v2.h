...
class TKeyValueV2GRpcService
        : public NYdbGrpc::TGrpcServiceBase<Ydb::KeyValue::V2::KeyValueService>
{
public:
    TKeyValueV2GRpcService(NActors::TActorSystem* actorSystem, TIntrusivePtr<NMonitoring::TDynamicCounters> counters,
            NActors::TActorId grpcRequestProxyId);
    ~TKeyValueV2GRpcService();
