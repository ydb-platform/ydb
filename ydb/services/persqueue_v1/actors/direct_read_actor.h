...
private:
    STFUNC(StateFunc) {
        switch (ev->GetTypeRewrite()) {
            ...
            HFunc(TEvPQProxy::TEvDirectReadDataSessionConnected, Handle); // from CachingService
    ...
    void Handle(TEvPQProxy::TEvDirectReadDataSessionConnected::TPtr& ev, const TActorContext& ctx);
