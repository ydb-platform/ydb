...
namespace NKikimr::NSqsTopic::V1 {
    ...
    class TSendMessageReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::SendMessageResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::SendMessageResult GetResult(const NKikimrClient::TSqsResponse& resp) override {
            Ydb::SqsTopic::V1::SendMessageResult result;
    ...
    private:
        NKikimr::NSQS::TSendMessageRequest* GetRequest(TSqsRequest& requestHolder) override {
            ...
            SetQueueName(result, GetProtoRequest());
    ...
    class TReceiveMessageReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ReceiveMessageResult> {
        using TBase = TReplyCallback<NKikimr::NSQS::TReceiveMessageResponse, Ydb::SqsTopic::V1::ReceiveMessageResult>;
    public:
        ...
        Ydb::SqsTopic::V1::ReceiveMessageResult GetResult(const NKikimrClient::TSqsResponse& resp) override {
            Ydb::SqsTopic::V1::ReceiveMessageResult result;

            for (const auto& srcMessage: GetResponse(resp).GetMessages()) {
                Ydb::SqsTopic::V1::Message dstMessage;
                ...
                for (const auto& srcAttribute: srcMessage.GetMessageAttributes()) {
                    Ydb::SqsTopic::V1::MessageAttribute dstAttribute;
    ...
    class TReceiveMessageActor : public TBaseRpcRequestActor<TEvSqsTopicReceiveMessageRequest, NKikimr::NSQS::TReceiveMessageRequest, class TReceiveMessageReplyCallback> {
    public:
    ...
    template <typename T>
    void AddAttribute(Ydb::SqsTopic::V1::GetQueueAttributesResult& result, const TString& name, T value) {
        result.Mutableattributes()->emplace(name, std::to_string(value));
    };

    template<>
    void AddAttribute<TString>(Ydb::SqsTopic::V1::GetQueueAttributesResult& result, const TString& name, TString value) {
        result.Mutableattributes()->emplace(name, value);
    };

    template <>
    void AddAttribute(Ydb::SqsTopic::V1::GetQueueAttributesResult& result, const TString& name, bool value) {
    ...
    class TGetQueueAttributesReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::GetQueueAttributesResult> {
    public:
        TGetQueueAttributesReplyCallback (
            ...
            : TReplyCallback<
                NKikimr::NSQS::TGetQueueAttributesResponse,
                Ydb::SqsTopic::V1::GetQueueAttributesResult>(request)
    ...
    private:
        ...
        Ydb::SqsTopic::V1::GetQueueAttributesResult GetResult(const NKikimrClient::TSqsResponse& resp) override {
            Ydb::SqsTopic::V1::GetQueueAttributesResult result;
    ...
    class TGetQueueAttributesActor : public TBaseRpcRequestActor<
            TEvSqsTopicGetQueueAttributesRequest,
    ...
    class TListQueuesReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ListQueuesResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::ListQueuesResult GetResult(const NKikimrClient::TSqsResponse& resp) override {
            Ydb::SqsTopic::V1::ListQueuesResult result;
    ...
    class TDeleteMessageReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::DeleteMessageResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::DeleteMessageResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::DeleteMessageResult result;
            return result;
        }
    };

    class TDeleteMessageActor : public TRpcRequestActor<
            TEvSqsTopicDeleteMessageRequest,
    ...
    class TPurgeQueueReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::PurgeQueueResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::PurgeQueueResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::PurgeQueueResult result;
            return result;
        }
    };

    class TPurgeQueueActor : public TRpcRequestActor<
            TEvSqsTopicPurgeQueueRequest,
    ...
    class TDeleteQueueReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::DeleteQueueResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::DeleteQueueResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::DeleteQueueResult result;
            return result;
        }
    };

    class TDeleteQueueActor : public TRpcRequestActor<
            TEvSqsTopicDeleteQueueRequest,
    ...
    class TChangeMessageVisibilityReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ChangeMessageVisibilityResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::ChangeMessageVisibilityResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::ChangeMessageVisibilityResult result;
            return result;
        }
    };

    class TChangeMessageVisibilityActor : public TRpcRequestActor<
            TEvSqsTopicChangeMessageVisibilityRequest,
    ...
    class TSetQueueAttributesReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::SetQueueAttributesResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::SetQueueAttributesResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::SetQueueAttributesResult result;
    ...
    class TSetQueueAttributesActor : public TRpcRequestActor<
            TEvSqsTopicSetQueueAttributesRequest,
    ...
    class TListDeadLetterSourceQueuesReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ListDeadLetterSourceQueuesResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::ListDeadLetterSourceQueuesResult GetResult(const NKikimrClient::TSqsResponse& response) override {
            Ydb::SqsTopic::V1::ListDeadLetterSourceQueuesResult result;
    ...
    class TListDeadLetterSourceQueuesActor : public TRpcRequestActor<
            TEvSqsTopicListDeadLetterSourceQueuesRequest,
    ...
    class TSendMessageBatchReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::SendMessageBatchResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::SendMessageBatchResult GetResult(const NKikimrClient::TSqsResponse& response) override {
            Ydb::SqsTopic::V1::SendMessageBatchResult result;
    ...
    class TSendMessageBatchActor : public TRpcRequestActor<
            TEvSqsTopicSendMessageBatchRequest,
    ...
    class TDeleteMessageBatchReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::DeleteMessageBatchResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::DeleteMessageBatchResult GetResult(const NKikimrClient::TSqsResponse& response) override {
            Ydb::SqsTopic::V1::DeleteMessageBatchResult result;
    ...
    class TDeleteMessageBatchActor : public TRpcRequestActor<
            TEvSqsTopicDeleteMessageBatchRequest,
    ...
    class TChangeMessageVisibilityBatchReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ChangeMessageVisibilityBatchResult> {
    public:
        using TReplyCallback::TReplyCallback;
    ...
    private:
        ...
        Ydb::SqsTopic::V1::ChangeMessageVisibilityBatchResult GetResult(const NKikimrClient::TSqsResponse& response) override {
            Ydb::SqsTopic::V1::ChangeMessageVisibilityBatchResult result;
    ...
    class TChangeMessageVisibilityBatchActor : public TRpcRequestActor<
            TEvSqsTopicChangeMessageVisibilityBatchRequest,
    ...
    class TListQueueTagsReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::ListQueueTagsResult> {
    public:
        TListQueueTagsReplyCallback (
                std::shared_ptr<NKikimr::NGRpcService::IRequestOpCtx> request)
            : TReplyCallback<
                NKikimr::NSQS::TListQueueTagsResponse,
                Ydb::SqsTopic::V1::ListQueueTagsResult>(request)
        {
        }
    ...
    private:
        ...
        Ydb::SqsTopic::V1::ListQueueTagsResult GetResult(const NKikimrClient::TSqsResponse& resp) override {
            Ydb::SqsTopic::V1::ListQueueTagsResult result;
    ...
    class TListQueueTagsActor : public TBaseRpcRequestActor<
            TEvSqsTopicListQueueTagsRequest,
    ...
    class TTagQueueReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::TagQueueResult> {
    public:
        TTagQueueReplyCallback (
                std::shared_ptr<NKikimr::NGRpcService::IRequestOpCtx> request)
            : TReplyCallback<
                NKikimr::NSQS::TTagQueueResponse,
                Ydb::SqsTopic::V1::TagQueueResult>(request)
        {
        }
    ...
    private:
        ...
        Ydb::SqsTopic::V1::TagQueueResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::TagQueueResult result;
            return result;
        }
    };

    class TTagQueueActor : public TBaseRpcRequestActor<
            TEvSqsTopicTagQueueRequest,
    ...
    class TUntagQueueReplyCallback : public TReplyCallback<
            ...
            Ydb::SqsTopic::V1::UntagQueueResult> {
    public:
        TUntagQueueReplyCallback (
                std::shared_ptr<NKikimr::NGRpcService::IRequestOpCtx> request)
            : TReplyCallback<
                NKikimr::NSQS::TUntagQueueResponse,
                Ydb::SqsTopic::V1::UntagQueueResult>(request)
        {
        }
    ...
    private:
        ...
        Ydb::SqsTopic::V1::UntagQueueResult GetResult(const NKikimrClient::TSqsResponse&) override {
            Ydb::SqsTopic::V1::UntagQueueResult result;
            return result;
        }
    };

    class TUntagQueueActor : public TBaseRpcRequestActor<
            TEvSqsTopicUntagQueueRequest,
...
#define DECLARE_RPC(name) template<> IActor* TEvSqsTopic##name##Request::CreateRpcActor(NKikimr::NGRpcService::IRequestOpCtx* msg) { \
