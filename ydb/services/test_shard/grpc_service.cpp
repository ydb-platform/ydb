...
#define SETUP_TESTSHARD_METHOD(methodName, methodCallback, rlMode, requestType, auditMode) \
    SETUP_METHOD(methodName, methodCallback, rlMode, requestType, TestShard, testshard, auditMode)

    SETUP_TESTSHARD_METHOD(CreateTestShard, DoCreateTestShard, Rps, TESTSHARD_CREATETESTSHARD, TAuditMode::Modifying(TAuditMode::TLogClassConfig::ClusterAdmin));
    SETUP_TESTSHARD_METHOD(DeleteTestShard, DoDeleteTestShard, Rps, TESTSHARD_DELETETESTSHARD, TAuditMode::Modifying(TAuditMode::TLogClassConfig::ClusterAdmin));
