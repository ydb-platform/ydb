...
3. Закодировать тест. Как первый шаг, можно скопировать пример из [core/test_example.py](core/test_example.py)
...
Примеры использования фикстур можно посмотреть в [core/test_example.py](core/test_example.py)
