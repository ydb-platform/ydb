...
class TestPgTTL(TestPgBase, TestTTLBase):
    @pytest.mark.parametrize(
        "table_name, pk_types, all_types, index, ttl, unique, sync",
        [
            ("table_pgint4_0__SYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgint4", "", "SYNC"),
            ("table_pgint4_0__ASYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgint4", "", "ASYNC"),
            (
            ...
            ("table_pgint8_0__SYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgint8", "", "SYNC"),
            ("table_pgint8_0__ASYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgint8", "", "ASYNC"),
            (
            ...
            ("table_pgdate_0__SYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgdate", "", "SYNC"),
            ("table_pgdate_0__ASYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgdate", "", "ASYNC"),
            (
            ...
            ("table_pgtimestamp_0__SYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgtimestamp", "", "SYNC"),
            ("table_pgtimestamp_0__ASYNC", pk_pg_types, {**pk_pg_types, **non_pk_pg_types}, pk_pg_types, "pgtimestamp", "", "ASYNC"),
            (
