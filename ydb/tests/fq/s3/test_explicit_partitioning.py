...
class TestS3(TestYdsBase):
    ...
    def test_partitioned_by(self, kikimr, s3, client, runtime_listing):
...
Pear,15,33'''
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_projection(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Banana,3,100'''
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_pruning(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Pear,15,33'''
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_no_schema_columns_except_partitioning_ones(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_projection_date(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Banana,3,100'''
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_no_paritioning_columns(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
    ...
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_projection_integer_type_validation(self, kikimr, s3, client, column_type, is_correct, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Banana,3,100'''
    ...
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_projection_enum_type_invalid_validation(self, kikimr, s3, client, column_type, is_correct, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Banana,3,100'''
    ...
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_projection_date_type_validation(self, kikimr, s3, client, column_type, is_correct, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
...
Banana,3,100'''
    ...
    @pytest.mark.parametrize("client", [{"folder_id": "my_folder"}], indirect=True)
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_raw_format(self, kikimr, s3, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
    ...
    @pytest.mark.parametrize("runtime_listing", [False, True])
    def test_parquet(self, kikimr, s3, blocks, client, runtime_listing):
        resource = boto3.resource(
            "s3",
            endpoint_url=s3.s3_url,
            aws_access_key_id="key",
