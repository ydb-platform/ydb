...
from ydb.tests.fq.streaming.base import kikimr
...
class TestStreamingInYdb(TestYdsBase):
    ...
    @pytest.mark.parametrize(
        "kikimr", [{"local_checkpoints": False}, {"local_checkpoints": True}], indirect=True, ids=["sdk_checkpoints", "local_checkpoints"])
