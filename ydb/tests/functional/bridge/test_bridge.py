...
class TestBridgeBasic(BridgeKiKiMRTest):
    ...
    def test_failover(self):
        ...
        self.wait_for_cluster_state(self.secondary_bridge_client, {"r1": PileState.NOT_SYNCHRONIZED, "r2": PileState.PRIMARY})
    ...
    def test_takedown(self):
        ...
        self.update_cluster_state(self.bridge_client, updates)
        self.wait_for_cluster_state(self.bridge_client, {"r1": PileState.PRIMARY, "r2": PileState.SUSPENDED})
    ...
    def test_rejoin(self):
        ...
        self.update_cluster_state(self.bridge_client, updates)
        self.wait_for_cluster_state(self.bridge_client, {"r1": PileState.PRIMARY, "r2": PileState.NOT_SYNCHRONIZED})
