    ...
    def do_load_and_test(self, req, generations):
        ...
        if len(generations) > 0:
            wait_tablets_state_by_id(
                self.cluster.client,
                TabletStates.Active,
                tablet_ids=list(generations.keys()),
                timeout_seconds=3,
        ...
        assert_that(len(generations) + number_of_tablets == len(actual_tablet_info))
