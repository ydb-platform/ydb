...
def test_meta_support_links_combines_node_and_host_groups(meta_support_links_env):
    assert_multiple_logging_support_links_response(
        ...
        [
            ("Node Logs", f'{{node="{NODE_ID}", host="{HOST_NAME}", __workspace__="{WORKSPACE_NAME}", __bucket__="ydb"}}'),
            ("Host Logs", f'{{host="{HOST_NAME}", node="{NODE_ID}", __workspace__="{WORKSPACE_NAME}", __bucket__="ydb"}}'),
        ],
    )
...
def test_meta_support_links_skips_additional_and_foreign_identity_params_for_logging(meta_support_links_env):
    assert_multiple_logging_support_links_response(
        ...
        [
            ("Node Logs", f'{{node="{NODE_ID}", host="{HOST_NAME}", custom_label="kept", __workspace__="{WORKSPACE_NAME}", __bucket__="ydb"}}'),
            ("Host Logs", f'{{host="{HOST_NAME}", node="{NODE_ID}", custom_label="kept", __workspace__="{WORKSPACE_NAME}", __bucket__="ydb"}}'),
        ],
    )
