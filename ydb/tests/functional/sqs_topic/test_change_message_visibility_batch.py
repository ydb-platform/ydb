...
class TestSqsTopicChangeMessageVisibilityBatch(KikimrSqsTopicTestBase):
    def test_change_message_visibility_batch_invalid_receipt_handle(self):
        queue_name = self._make_queue_name('change_message_visibility_batch_invalid_receipt_handle')
    ...
    def test_change_message_visibility_batch_fifo_queue(self):
        self._create_fifo_queue('change_message_visibility_batch_fifo_queue')
