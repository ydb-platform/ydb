...
class Daemon(object):
    def __init__(
        ...
        cwd,
        timeout,
        stdin_file=yatest_common.work_path('dev/stdin'),
        stdout_file=yatest_common.work_path('dev/stdout'),
        stderr_file=yatest_common.work_path('dev/stderr'),
