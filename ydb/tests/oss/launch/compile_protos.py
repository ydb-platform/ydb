...
def build_ydb_protos( ydb_repo_root, proto_dir='ydb', strict_mode=False):
    ...
    include_paths = [ 'contrib/libs/googleapis-common-protos',
...
if __name__ == '__main__':
    ...
    parser.add_argument('directory', help='Directory inside YDB repo to scan for .proto files', default='ydb')
    args = parser.parse_args()
    build_ydb_protos( args.source_root, args.directory, args.strict_mode )
