...
class OrchestratorAggregatedSafetyCheck:
    ...
    agent_source_class_name — agent catalog slot name (e.g. "unified_agent_verify_failed"); matched against the agent-reported check["name"] field. See UnifiedAgentVerifyFailedAggregated._row_matches_class.
    """
