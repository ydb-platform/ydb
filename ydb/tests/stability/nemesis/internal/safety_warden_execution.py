"""Run safety wardens: one executor task per (slot_name, warden) pair."""
...
def build_safety_runs_from_pairs(
    pairs: List[Tuple[str, Any]],
    log_prefix: str,
) -> List[SafetyWardenRun]:
    """One callable per warden; warden instances are already built (see collect_*_safety_warden_pairs)."""
