...
if __name__ == '__main__':
    ...
    parser.add_argument('--sqs-endpoint', default=None, required=True, help='A SQS endpoint to use')
    args = parser.parse_args()
    with Workload(args.endpoint, args.database, args.duration, args.sqs_endpoint) as workload:
        workload.loop()
