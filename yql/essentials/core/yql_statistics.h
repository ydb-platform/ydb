...
public:
    void Add(TVector<TString> joinLabels, NDq::TOrderingsStateMachine::TLogicalOrderings shufflings) {
        ...
        ShufflingOrderingsByJoinLabels.emplace_back(joinLabels, shufflings);
    }
    ...
    TMaybe<NDq::TOrderingsStateMachine::TLogicalOrderings> GetShufflingOrderigsByJoinLabels(
        ...
        for (const auto& [joinLabels, shufflings]: ShufflingOrderingsByJoinLabels) {
...
private:
    TVector<std::pair<TVector<TString>, NDq::TOrderingsStateMachine::TLogicalOrderings>> ShufflingOrderingsByJoinLabels;
};
