...
public:
        ...
        , InputsDescr_(ToValueDescr(inputItems))
    {
        ...
        // Можно выкинуть эти ридеры???
        // Надо ридеры и конверторы научить читать массивы??
...
{
using TBaseComputation = TMutableComputationNode<TBlockMapJoinCoreWraper>;
using TJoinState = TBlockJoinState;
...
private:
    ...
    private:
        NUdf::EFetchStatus WideFetch(NUdf::TUnboxedValue* output, ui32 width) {
            // выкачать правый стрим
            // преобразовать колонки в строки
            ...
            // Right stream всегда < Left stream????
