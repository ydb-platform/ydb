...
Y_UNIT_TEST_LLVM(TestStruct) {
    ...
    const auto pgmReturn = pb.NewList(dataType, {pb.Member(structObj, "x"),
...
Y_UNIT_TEST_LLVM(TestMapUnwrapThrowMessage) {
    ...
    const auto pgmReturn = pb.Map(list,
                                  [&](TRuntimeNode item) {
                                      return pb.Sub(data2, pb.Unwrap(item, pb.Concat(pb.NewDataLiteral<NUdf::EDataSlot::String>("a"),
...
Y_UNIT_TEST_LLVM(TestCoalesce) {
    ...
    pgmReturn = pb.AddMember(pgmReturn, "A", pb.Coalesce(pb.NewOptional(data1), data2));
    pgmReturn = pb.AddMember(pgmReturn, "B", pb.Coalesce(pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<ui32>::Id), data2));
    pgmReturn = pb.AddMember(pgmReturn, "C", pb.Coalesce(pb.NewOptional(data2), pb.NewOptional(data3)));
    pgmReturn = pb.AddMember(pgmReturn, "D", pb.Coalesce(pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<ui32>::Id), pb.NewOptional(data3)));
    pgmReturn = pb.AddMember(pgmReturn, "E", pb.Coalesce(pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<ui32>::Id), pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<ui32>::Id)));
...
Y_UNIT_TEST_LLVM(TestZip) {
    ...
    const auto list2 = pb.NewList(pb.NewDataType(NUdf::TDataType<char*>::Id), {pb.NewDataLiteral<NUdf::EDataSlot::String>("Q"),
...
Y_UNIT_TEST_LLVM(TestSubstring) {
    ...
    const auto list = pb.NewList(dataType, {pb.NewTuple({start1, count1}),
