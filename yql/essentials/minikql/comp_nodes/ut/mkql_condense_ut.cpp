...
Y_UNIT_TEST_LLVM(TestCondenseInterrupt) {
    ...
    const auto pgmReturn = pb.FromFlow(pb.Condense(pb.ToFlow(list), pb.NewDataLiteral<bool>(false),
                                                   [&](TRuntimeNode, TRuntimeNode state) { return pb.If(state, pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<bool>::Id), pb.NewDataLiteral<bool>(false)); },
                                                   [&](TRuntimeNode item, TRuntimeNode state) { return pb.Or({pb.Unwrap(item, pb.NewDataLiteral<NUdf::EDataSlot::String>(""), "", 0, 0), state}); }));
...
Y_UNIT_TEST_LLVM(TestCondense1Interrupt) {
    ...
    const auto pgmReturn = pb.FromFlow(pb.Condense1(pb.ToFlow(list),
                                                    [&](TRuntimeNode item) { return pb.Unwrap(item, pb.NewDataLiteral<NUdf::EDataSlot::String>(""), "", 0, 0); },
                                                    [&](TRuntimeNode, TRuntimeNode state) { return pb.If(state, pb.NewDataLiteral<bool>(false), pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<bool>::Id)); },
                                                    [&](TRuntimeNode item, TRuntimeNode state) { return pb.And({pb.Unwrap(item, pb.NewDataLiteral<NUdf::EDataSlot::String>(""), "", 0, 0), state}); }));
...
Y_UNIT_TEST_LLVM(TestCondenseInterruptEndlessStream) {
    ...
    const auto pgmReturn = pb.Condense(pb.SourceOf(pb.NewStreamType(pb.NewNull().GetStaticType())), pb.NewDataLiteral<ui32>(0U),
                                       [&](TRuntimeNode, TRuntimeNode state) { return pb.If(pb.AggrLess(state, pb.NewDataLiteral<ui32>(123456U)), pb.NewDataLiteral<bool>(false), pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<bool>::Id)); },
                                       [&](TRuntimeNode, TRuntimeNode state) { return pb.AggrAdd(pb.NewDataLiteral<ui32>(1U), state); });
...
Y_UNIT_TEST_LLVM(TestCondense1InterruptEndlessFlow) {
    ...
    const auto pgmReturn = pb.FromFlow(pb.Condense1(pb.SourceOf(pb.NewFlowType(pb.NewNull().GetStaticType())),
                                                    [&](TRuntimeNode) { return pb.NewDataLiteral<ui32>(0U); },
                                                    [&](TRuntimeNode, TRuntimeNode state) { return pb.If(pb.AggrLess(state, pb.NewDataLiteral<ui32>(123456U)), pb.NewDataLiteral<bool>(false), pb.NewEmptyOptionalDataLiteral(NUdf::TDataType<bool>::Id)); },
                                                    [&](TRuntimeNode, TRuntimeNode state) { return pb.AggrAdd(pb.NewDataLiteral<ui32>(1U), state); }));
