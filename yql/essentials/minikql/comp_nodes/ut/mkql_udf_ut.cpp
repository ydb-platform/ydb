...
public:
                                 ...
                                 bool typesOnly)
    {
        ...
        builder.OptionalArgs(1).Args(2)->Add<char*>().Add<NYql::NUdf::TOptional<bool>>().Name("NewOptionalArg");
                                 ...
                                 bool typesOnly)
    {
        ...
        switch (Build) {
            case EBuilds::A:
                ...
                break;
            case EBuilds::B:
                builder.OptionalArgs(1).Args()->Add<char*>().Add<NYql::NUdf::TOptional<bool>>().Name("AlwaysWriteFractionalSeconds");
                builder.Returns(
