...
Y_UNIT_TEST_LLVM(TestConcatItemsToKey) {
    ...
    const auto pgmReturn = pb.Collect(pb.NarrowMap(pb.WideCondense1(pb.ExpandMap(pb.ToFlow(list),
                                                                    ...
                                                                    [&](TRuntimeNode::TList items) -> TRuntimeNode::TList { return {items.front(), pb.AggrConcat(pb.AggrConcat(items.front(), pb.NewDataLiteral<NUdf::EDataSlot::String>(": ")), items.back())}; },
                                                                    [&](TRuntimeNode::TList items, TRuntimeNode::TList state) { return pb.AggrNotEquals(items.front(), state.front()); },
                                                                    [&](TRuntimeNode::TList items, TRuntimeNode::TList state) -> TRuntimeNode::TList { return {state.front(), pb.AggrConcat(pb.AggrConcat(state.back(), pb.NewDataLiteral<NUdf::EDataSlot::String>(", ")), items.back())}; }),
...
Y_UNIT_TEST_LLVM(TestSwitchByBoolFieldAndDontUseKey) {
    ...
    const auto pgmReturn = pb.Collect(pb.NarrowMap(pb.WideCondense1(pb.ExpandMap(pb.ToFlow(list),
                                                                    ...
                                                                    [&](TRuntimeNode::TList items, TRuntimeNode::TList state) -> TRuntimeNode::TList { return {pb.AggrConcat(pb.AggrConcat(state.front(), pb.NewDataLiteral<NUdf::EDataSlot::String>("; ")), items[1U])}; }),
