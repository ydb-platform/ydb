...
inline Value* GenIsBadDateTime(Value* val, LLVMContext& context, BasicBlock* block) {
    static_assert(TDateType::Features & (NYql::NUdf::DateType | NYql::NUdf::TzDateType), "Date type expected");
    if constexpr (TDateType::Features & NYql::NUdf::ExtDateType) {
        auto lt = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SLT, val,
                                  ConstantInt::get(Type::getInt64Ty(context), NUdf::MIN_TIMESTAMP64), "lt", block);
        auto ge = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SGT, val,
                                  ConstantInt::get(Type::getInt64Ty(context), NUdf::MAX_TIMESTAMP64), "ge", block);
        return BinaryOperator::CreateOr(lt, ge, "or", block);
    } else {
        auto lt = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SLT, val,
                                  ConstantInt::get(Type::getInt64Ty(context), 0), "lt", block);
        auto ge = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SGE, val,
                                  ConstantInt::get(Type::getInt64Ty(context), NUdf::MAX_TIMESTAMP), "ge", block);
        return BinaryOperator::CreateOr(lt, ge, "or", block);
    }
}
...
inline Value* GenIsBadInterval(Value* val, LLVMContext& context, BasicBlock* block) {
    ...
    constexpr i64 upperBound = (TDateType::Features & NYql::NUdf::ExtDateType)
                                   ? (NUdf::MAX_INTERVAL64 + 1)
                                   : (i64)NUdf::MAX_TIMESTAMP;
    auto le = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SLE, val,
                              ConstantInt::get(Type::getInt64Ty(context), lowerBound), "le", block);
    auto ge = CmpInst::Create(Instruction::ICmp, ICmpInst::ICMP_SGE, val,
                              ConstantInt::get(Type::getInt64Ty(context), upperBound), "ge", block);
...
template <typename TSrc>
inline Value* GenToScaledDate(Value* value, LLVMContext& context, BasicBlock* block);

template <typename TDst>
inline Value* GenFromScaledDate(Value* value, LLVMContext& context, BasicBlock* block);

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TDate>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TDate>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TDatetime>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TDatetime>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTimestamp>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TTimestamp>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTimestamp>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<TScaledDate, NUdf::TDataType<NUdf::TTimestamp>::TLayout>(value, context, block);
}

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TInterval>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TInterval>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TInterval>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<TScaledDate, NUdf::TDataType<NUdf::TInterval>::TLayout>(value, context, block);
}

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzDate>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzDate>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DateScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzDatetime>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzDatetime>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DatetimeScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzTimestamp>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TTzTimestamp>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzTimestamp>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<TScaledDate, NUdf::TDataType<NUdf::TTzTimestamp>::TLayout>(value, context, block);
}

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TDate32>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TDate32>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DateScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TDatetime64>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TDatetime64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DatetimeScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTimestamp64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TTimestamp64>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTimestamp64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<TScaledDate, NUdf::TDataType<NUdf::TTimestamp64>::TLayout>(value, context, block);
}

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzDate32>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzDate32>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DateScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzDatetime64>>(Value* value, LLVMContext& context, BasicBlock* block) {
...
template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzDatetime64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    const auto div = BinaryOperator::CreateSDiv(value, ConstantInt::get(value->getType(), DatetimeScale), "div", block);
...
template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TTzTimestamp64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TTzTimestamp64>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TTzTimestamp64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<TScaledDate, NUdf::TDataType<NUdf::TTzTimestamp64>::TLayout>(value, context, block);
}

template <>
inline Value* GenToScaledDate<NUdf::TDataType<NUdf::TInterval64>>(Value* value, LLVMContext& context, BasicBlock* block) {
    return StaticCast<NUdf::TDataType<NUdf::TInterval64>::TLayout, TScaledDate>(value, context, block);
}

template <>
inline Value* GenFromScaledDate<NUdf::TDataType<NUdf::TInterval64>>(Value* value, LLVMContext& context, BasicBlock* block) {
