...
template <typename T1, typename T2,
          std::enable_if_t<std::is_unsigned<T1>::value &&
                               std::is_unsigned<T2>::value,
                           bool>
              Aggr>
...
template <typename TLeft, typename TRight, bool Aggr>
struct TDiffDateGreater: public TCompareArithmeticBinary<typename TLeft::TLayout, typename TRight::TLayout,
                                                         TDiffDateGreater<TLeft, TRight, Aggr>>,
                         public TAggrGreater {
    ...
    static Value* Gen(Value* left, Value* right, const TCodegenContext& ctx, BasicBlock*& block)
    {
        ...
        return std::is_same<TLeft, TRight>::value
                   ...
                   : GenGreater<TScaledDate, TScaledDate, Aggr>(
...
template <typename TLeft, typename TRight, bool Aggr>
struct TAggrTzDateGreater: public TCompareArithmeticBinaryWithTimezone<TLeft, TRight,
                                                                       TAggrTzDateGreater<TLeft, TRight, Aggr>>,
                           public TAggrGreater {
    static bool Do(TLeft left, TRight right)
    {
        return Greater<TLeft, TRight, Aggr>(left, right);
