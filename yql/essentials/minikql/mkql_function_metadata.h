...
public:
    ...
    explicit TKernelFamily(const arrow20::compute::FunctionOptions* functionOptions = nullptr)
...
public:
    explicit TKernelFamilyBase(const arrow20::compute::FunctionOptions* functionOptions = nullptr);
