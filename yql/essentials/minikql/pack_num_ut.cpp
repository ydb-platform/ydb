...
auto TEST_DATA_UI32 = std::to_array<ui32>({
    0,
    0x80,
    0x4000,
    0x8000,
...
auto TEST_DATA_UI64 = std::to_array<ui64>({
    0ull,
    0x80ull,
    0x4000ull,
    0x8000ull,
