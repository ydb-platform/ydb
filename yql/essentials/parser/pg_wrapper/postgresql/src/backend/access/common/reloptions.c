...
static const const relopt_enum_elt_def StdRdOptIndexCleanupValues[] =
{
...
static const const relopt_enum_elt_def gistBufferingOptValues[] =
{
...
static const const relopt_enum_elt_def viewCheckOptValues[] =
{
