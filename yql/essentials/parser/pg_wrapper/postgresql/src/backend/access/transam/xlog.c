...
__thread int			wal_compression = WAL_COMPRESSION_NONE;
...
__thread bool		log_checkpoints = true;
__thread int			sync_method = DEFAULT_SYNC_METHOD;
__thread int			wal_level = WAL_LEVEL_REPLICA;
...
__thread int			wal_decode_buffer_size = 512 * 1024;
__thread bool		track_wal_io_timing = false;
...
static __thread TimeLineID openLogTLI = 0;
 ...
 */
static __thread XLogRecPtr LocalMinRecoveryPoint;
static __thread TimeLineID LocalMinRecoveryPointTLI;
