...
/* GUCs */
__thread int			recovery_prefetch = RECOVERY_PREFETCH_TRY;
...
static __thread int	XLogPrefetchReconfigureCount = 0;
...
static __thread XLogPrefetchStats *SharedStats;
...
XLogPrefetcherAllocate(XLogReaderState *reader)
{
	...
	static __thread HASHCTL hash_table_ctl = {
