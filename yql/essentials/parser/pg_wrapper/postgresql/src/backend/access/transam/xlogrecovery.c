...
__thread TimestampTz recoveryTargetTime;
 ...
 */
static __thread bool StandbyModeRequested = false;
 ...
 * checkpoint record.
 */
static __thread XLogRecPtr CheckPointLoc = InvalidXLogRecPtr;
static __thread TimeLineID CheckPointTLI = 0;
static __thread XLogRecPtr RedoStartLSN = InvalidXLogRecPtr;
static __thread TimeLineID RedoStartTLI = 0;
...
static __thread XLogPrefetcher *xlogprefetcher = NULL;
...
static __thread XLogRecPtr backupStartPoint;
static __thread XLogRecPtr backupEndPoint;
static __thread bool backupEndRequired = false;
...
static __thread char *primary_image_masked = NULL;
...
static __thread XLogRecoveryCtlData *XLogRecoveryCtl = NULL;
