...
__thread char	   *XLogArchiveLibrary = "";
...
static __thread PgArchData *PgArch = NULL;
static __thread const ArchiveModuleCallbacks *ArchiveCallbacks;
static __thread ArchiveModuleState *archive_module_state;
...
static __thread struct arch_files_state *arch_files = NULL;
...
{
	static __thread time_t last_pgarch_start_time = 0;
