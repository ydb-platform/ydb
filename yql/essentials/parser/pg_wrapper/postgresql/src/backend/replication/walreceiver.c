 ...
 */
static __thread TimestampTz wakeup[NUM_WALRCV_WAKEUPS];
...
{
	static __thread XLogRecPtr writePtr = 0;
	static __thread XLogRecPtr flushPtr = 0;
	XLogRecPtr	applyPtr;
	TimestampTz now;
...
XLogWalRcvSendHSFeedback(bool immed)
{
	...
	static __thread bool primary_has_standby_xmin = true;
