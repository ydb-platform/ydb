...
/* GUC variables */
__thread int			max_wal_senders = 10;	/* the maximum number of concurrent
									 * walsenders */
...
ProcessStandbyReplyMessage(void)
{
	...
	static __thread XLogRecPtr prevWritePtr = InvalidXLogRecPtr;
	static __thread XLogRecPtr prevFlushPtr = InvalidXLogRecPtr;
	static __thread XLogRecPtr prevApplyPtr = InvalidXLogRecPtr;
...
XLogSendLogical(void)
{
	 ...
	 * spinlock.
	 */
	static __thread XLogRecPtr flushPtr = InvalidXLogRecPtr;
