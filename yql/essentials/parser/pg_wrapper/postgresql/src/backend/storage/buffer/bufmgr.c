 ...
 */
__thread int			effective_io_concurrency = DEFAULT_EFFECTIVE_IO_CONCURRENCY;
 ...
 */
__thread int			maintenance_io_concurrency = DEFAULT_MAINTENANCE_IO_CONCURRENCY;

/*
 * GUC variables about triggering kernel writeback for buffers written; OS
 * dependent defaults are set via the GUC mechanism.
 */
__thread int			checkpoint_flush_after = DEFAULT_CHECKPOINT_FLUSH_AFTER;
__thread int			bgwriter_flush_after = DEFAULT_BGWRITER_FLUSH_AFTER;
__thread int			backend_flush_after = DEFAULT_BACKEND_FLUSH_AFTER;
