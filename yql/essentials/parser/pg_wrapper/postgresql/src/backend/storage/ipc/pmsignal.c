 ...
 */
static __thread int	num_child_inuse;	/* # of entries in PMChildInUse[] */
static __thread int	next_child_inuse;	/* next slot to try to assign */
static __thread bool *PMChildInUse;		/* true if i'th flag slot is assigned */
