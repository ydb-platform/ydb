 ...
 */
__thread int			max_predicate_locks_per_xact;	/* in guc_tables.c */
__thread int			max_predicate_locks_per_relation;	/* in guc_tables.c */
__thread int			max_predicate_locks_per_page;	/* in guc_tables.c */
...
static __thread dlist_head *FinishedSerializableTransactions;
