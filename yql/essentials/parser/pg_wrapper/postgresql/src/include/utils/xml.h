...
extern __thread PGDLLIMPORT int xmlbinary;	/* XmlBinaryType, but int for guc enum */

extern __thread PGDLLIMPORT int xmloption;	/* XmlOptionType, but int for guc enum */
