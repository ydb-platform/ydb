...
// Opt-in overloads accept a separate prefix snapshot selected at the table reference.
TNodePtr BuildTableKey(TPosition pos, const TString& service, const TDeferredAtom& cluster, const TDeferredAtom& name, const TViewDescription& view, TTablePathPrefix prefix);
TNodePtr BuildTableKeys(TPosition pos, const TString& service, const TDeferredAtom& cluster, const TString& func, const TVector<TTableArg>& args, TTablePathPrefix prefix);
