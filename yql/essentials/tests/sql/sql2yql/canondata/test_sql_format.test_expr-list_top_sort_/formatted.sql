...
SELECT
    ...
    ListTopSortAsc($list, 4),
    ListTopSortAsc($list, 5),
...
SELECT
    ...
    ListTopSortDesc($list, 4),
    ListTopSortDesc($list, 5),
...
SELECT
    ...
    ListSort(ListTop($list, 4)),
    ListSort(ListTop($list, 5)),
...
SELECT
    ...
    ListSort(ListTopAsc($list, 4)),
    ListSort(ListTopAsc($list, 5)),
...
SELECT
    ...
    ListSort(ListTopDesc($list, 4)),
    ListSort(ListTopDesc($list, 5)),
