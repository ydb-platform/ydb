...
extern "C" [[noreturn]] void ThrowBadDecimal();
...
// first argument should be NYql::NUdf::EDataSlot casted to int
extern "C" [[noreturn]] void ThrowBadTz(int slot, EBadTzReason reason);
