...
TPartitionResult TDownloadStageOperationManager::PartitionOperationImpl(const TPrepareOperationStageContext& context) {
...
TGenerateTasksResult TDownloadStageOperationManager::GenerateTasksImpl(
