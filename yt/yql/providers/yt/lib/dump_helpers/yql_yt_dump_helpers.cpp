...
TString MakeDumpPath(const TString& srcPath, const TString& cluster, const TYqlOperationOptions& opOptions, const TYtSettings::TConstPtr& configuration, bool exists) {
    ...
    if (exists) {
        ...
        root = NonExistentTableDumpPrefix;
    }
