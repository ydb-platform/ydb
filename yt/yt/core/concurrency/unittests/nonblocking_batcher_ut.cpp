...
TEST(TNonblockingBatcherTest, Simple)
{
    ...
    ASSERT_FALSE(e2.IsSet());
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2, 3}));
    batcher->Enqueue(10);
    batcher->Enqueue(11);
    ASSERT_FALSE(e2.IsSet());
    batcher->Enqueue(12);
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({10, 11, 12}));
    batcher->Enqueue(0);
    batcher->Enqueue(1);
    batcher->Enqueue(2);
    auto e3 = batcher->DequeueBatch();
    ASSERT_TRUE(e3.IsSet());
    ASSERT_EQ(e3.BlockingGet().ValueOrThrow(), std::vector<int>({0, 1, 2}));
}
...
TEST(TNonblockingBatcherTest, Duration)
{
    ...
    ASSERT_TRUE(e1.IsSet());
    ASSERT_FALSE(e2.IsSet());
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>{1});
    batcher->Enqueue(2);
    ASSERT_FALSE(e2.IsSet());
    batcher->Enqueue(3);
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({2, 3}));
}
...
TEST(TNonblockingBatcherTest, Dequeue)
{
    ...
    EnqueueAll(batcher, {1, 2, 3, 4, 5});
    {
        ...
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2}));
    }
    {
        auto e = batcher->DequeueBatch();
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({3, 4}));
    }
    {
        auto e = batcher->DequeueBatch();
        ...
        Sleep(overTimeout);
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({5}));
    }
    EnqueueAll(batcher, {6, 7, 8});
    {
        auto e = batcher->DequeueBatch();
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({6, 7}));
    }
    {
        auto e = batcher->DequeueBatch();
        ASSERT_FALSE(e.IsSet());
        ...
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({8, 9}));
    }
    {
        auto e = batcher->DequeueBatch();
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({10, 11}));
    }
}
...
TEST(TNonblockingBatcherTest, Drop)
{
    ...
    ASSERT_FALSE(e2.IsSet());
    batcher->Drop();
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2}));
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>());
    batcher->Enqueue(10);
    auto e3 = batcher->DequeueBatch();
    ASSERT_FALSE(e3.IsSet());
    batcher->Drop();
    ASSERT_TRUE(e3.IsSet());
    ASSERT_EQ(e3.BlockingGet().ValueOrThrow(), std::vector<int>());
}
...
TEST(TNonblockingBatcherTest, EnqueueTimeout)
{
    ...
    Sleep(overTimeout);
    {
        ...
        Sleep(overTimeout);
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({1}));
    }
}
...
TEST(TNonblockingBatcherTest, SumLimiter)
{
    ...
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2, 3, 4}));
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({5, 6}));
    ASSERT_EQ(e3.BlockingGet().ValueOrThrow(), std::vector<int>({7, 8}));
    ASSERT_EQ(e4.BlockingGet().ValueOrThrow(), std::vector<int>({9, 10}));
    ASSERT_EQ(e5.BlockingGet().ValueOrThrow(), std::vector<int>({1, 9}));
}
...
TEST(TNonblockingBatcherTest, CompositeLimiterLimiter)
{
    ...
    ASSERT_TRUE(e5.IsSet());
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2, 3}));
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({4, 5, 6}));
    ASSERT_EQ(e3.BlockingGet().ValueOrThrow(), std::vector<int>({7, 8}));
    ASSERT_EQ(e4.BlockingGet().ValueOrThrow(), std::vector<int>({9, 10}));
    ASSERT_EQ(e5.BlockingGet().ValueOrThrow(), std::vector<int>({1, 9}));
}
...
TEST(TNonblockingBatcherTest, UpdateLimiter)
{
    ...
    EnqueueAll(batcher, {1, 2, 3, 3, 2});
    {
        auto e = batcher->DequeueBatch();
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({1, 2, 3}));
    }
    batcher->UpdateBatchLimiter(TLimiter(TBatchSizeLimiter{3}, TSumLimiter{4}));
    {
        ...
        Sleep(overTimeout);
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({3, 2}));
    }
    ...
    EnqueueAll(batcher, {5, 6, 7});
    {
        auto e = batcher->DequeueBatch();
        ASSERT_TRUE(e.IsSet());
        ASSERT_EQ(e.BlockingGet().ValueOrThrow(), std::vector<int>({5, 6, 7}));
    }
}
...
TEST(TNonblockingBatcherTest, NoEmptyBatches)
{
    ...
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({1}));
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({2}));
}
...
TEST(TNonblockingBatcherTest, AllowEmptyBatches)
{
    ...
    Sleep(overTimeout);
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e1.BlockingGet().ValueOrThrow(), std::vector<int>({}));
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({}));
}
...
TEST(TNonblockingBatcherTest, IncompleteBatchAfterDeque)
{
    ...
    auto e2 = batcher->DequeueBatch();
    ASSERT_TRUE(e2.IsSet());
    ASSERT_EQ(e2.BlockingGet().ValueOrThrow(), std::vector<int>({3, 4}));
}
...
TEST(TNonblockingBatcherTest, Drain)
{
    ...
    ASSERT_FALSE(batch.BlockingGet().IsOK());
