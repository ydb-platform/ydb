...
struct IAdaptiveHedgingManager
    : public TRefCounted
{
    //! Will register request and schedule invocation of its corresponding secondary request.
    ...
    //! Will return a set of statistics accumulated since last call to this method.
