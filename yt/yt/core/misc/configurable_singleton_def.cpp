...
TSingletonTraits TSingletonConfigHelpers::GetSingletonTraits(const std::string& singletonName) {
    return GetOrCrash(TSingletonManagerImpl::Get()->Singletons(), singletonName);
}
