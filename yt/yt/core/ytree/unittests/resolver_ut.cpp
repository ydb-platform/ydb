...
TEST(TYPathResolverTest, GetInt64)
{
...
TEST(TYPathResolverTest, GetUint64)
{
...
TEST(TYPathResolverTest, GetBoolean)
{
...
TEST(TYPathResolverTest, GetDouble)
{
...
TEST(TYPathResolverTest, GetString)
{
...
TEST(TYPathResolverTest, GetAny)
{
...
TEST(TYPathResolverTest, Attribute)
{
...
TEST(TYPathResolverTest, InvalidYPath)
{
...
TEST(TYPathResolverTest, InvalidYson)
{
