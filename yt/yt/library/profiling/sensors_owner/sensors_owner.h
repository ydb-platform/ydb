...
public:
    ...
    const TSensorsOwner& WithTag(TStringBuf name, TStringBuf value) const;
    const TSensorsOwner& WithRequiredTag(TStringBuf name, TStringBuf value) const;
    const TSensorsOwner& WithExcludedTag(TStringBuf name, TStringBuf value) const;
    const TSensorsOwner& WithAlternativeTag(TStringBuf name, TStringBuf value, int alternativeTo) const;
    ...
    const TSensorsOwner& WithPrefix(TStringBuf prefix) const;
    ...
    void Increment(TStringBuf name, i64 delta) const;
    ...
    const TEventTimer& GetTimer(TStringBuf name) const;
    ...
    const TSummary& GetSummary(TStringBuf name, ESummaryPolicy policy) const;
